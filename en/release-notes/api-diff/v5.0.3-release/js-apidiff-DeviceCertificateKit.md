...
|New API |NA|Class name: CertResult;<br>API declaration: ERR_PARAMETER_CHECK_FAILED = 19020003<br>DIfferences: ERR_PARAMETER_CHECK_FAILED = 19020003|api/@ohos.security.cert.d.ts|
...
|New API |NA|Class name: CertChainValidationParameters;<br>API declaration: trustSystemCa?: boolean;<br>DIfferences: trustSystemCa?: boolean;|api/@ohos.security.cert.d.ts|
...
|New API |NA|Class name: certificateManagerDialog;<br>API declaration: function openAuthorizeDialog(context: common.Context): Promise\<string>;<br>DIfferences: function openAuthorizeDialog(context: common.Context): Promise\<string>;|api/@ohos.security.certManagerDialog.d.ts|
...
|New API |NA|Class name: CMErrorCode;<br>API declaration: CM_ERROR_STORE_PATH_NOT_SUPPORTED = 17500009<br>DIfferences: CM_ERROR_STORE_PATH_NOT_SUPPORTED = 17500009|api/@ohos.security.certManager.d.ts|
...
|New API |NA|Class name: certificateManager;<br>API declaration: export enum CertAlgorithm<br>DIfferences: export enum CertAlgorithm|api/@ohos.security.certManager.d.ts|
|New API |NA|Class name: CertAlgorithm;<br>API declaration: INTERNATIONAL = 1<br>DIfferences: INTERNATIONAL = 1|api/@ohos.security.certManager.d.ts|
|New API |NA|Class name: CertAlgorithm;<br>API declaration: SM = 2<br>DIfferences: SM = 2|api/@ohos.security.certManager.d.ts|
...
|New API |NA|Class name: CertStoreProperty;<br>API declaration: certAlg?: CertAlgorithm;<br>DIfferences: certAlg?: CertAlgorithm;|api/@ohos.security.certManager.d.ts|
...
|New overloaded interface method with subsumptive parameter type ranges|Class name: X509Cert;<br>API declaration: getIssuerName(): DataBlob;<br>DIfferences: getIssuerName(): DataBlob;|Class name: X509Cert;<br>API declaration: getIssuerName(encodingType: EncodingType): string;<br>DIfferences: getIssuerName(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
|New overloaded interface method with subsumptive parameter type ranges|Class name: X509Cert;<br>API declaration: toString(): string;<br>DIfferences: toString(): string;|Class name: X509Cert;<br>API declaration: toString(encodingType: EncodingType): string;<br>DIfferences: toString(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
|New overloaded interface method with subsumptive parameter type ranges|Class name: X509CRLEntry;<br>API declaration: getCertIssuer(): DataBlob;<br>DIfferences: getCertIssuer(): DataBlob;|Class name: X509CRLEntry;<br>API declaration: getCertIssuer(encodingType: EncodingType): string;<br>DIfferences: getCertIssuer(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
|New overloaded interface method with subsumptive parameter type ranges|Class name: X509CRL;<br>API declaration: getIssuerName(): DataBlob;<br>DIfferences: getIssuerName(): DataBlob;|Class name: X509CRL;<br>API declaration: getIssuerName(encodingType: EncodingType): string;<br>DIfferences: getIssuerName(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
|New overloaded interface method with subsumptive parameter type ranges|Class name: X509CRL;<br>API declaration: toString(): string;<br>DIfferences: toString(): string;|Class name: X509CRL;<br>API declaration: toString(encodingType: EncodingType): string;<br>DIfferences: toString(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
|New overloaded interface method with subsumptive parameter type ranges|Class name: X500DistinguishedName;<br>API declaration: getName(): string;<br>DIfferences: getName(): string;|Class name: X500DistinguishedName;<br>API declaration: getName(encodingType: EncodingType): string;<br>DIfferences: getName(encodingType: EncodingType): string;|api/@ohos.security.cert.d.ts|
