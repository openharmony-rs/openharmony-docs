...
The following uses [DAYU200](https://gitcode.com/openharmony/vendor_hihope/tree/master/rk3568) as an example to illustrate charging idle state customization.
...
2. Create a target folder by referring to the [default folder of battery idle state configuration](https://gitcode.com/openharmony/powermgr_thermal_manager/tree/master/services/native/profile), and install it in `//vendor/hihope/rk3568/thermal`. The content is as follows:
...
## Reference
During development, you can refer to the [default charging idle state configuration](https://gitcode.com/openharmony/powermgr_thermal_manager/blob/master/services/native/profile/thermal_service_config.xml).
