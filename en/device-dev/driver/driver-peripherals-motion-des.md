...
**NOTE**<br>The following table lists the C++ function interfaces generated by the IDL interface description. For details about the interface declaration, see the IDL file [/drivers/interface/motion/v1_0/](https://gitcode.com/openharmony/drivers_interface/tree/master/motion).
...
The following describes how to develop a user-mode motion driver based on the HDF. For details, see [motion_if_driver.cpp](https://gitcode.com/openharmony/drivers_peripheral/blob/master/motion/hdi_service/motion_if_driver.cpp).
