...
The LMS module of the OpenHarmony LiteOS-A kernel provides the following APIs. For more details, see [API reference](https://gitcode.com/openharmony/kernel_liteos_m/blob/master/components/lms/los_lms.h).
