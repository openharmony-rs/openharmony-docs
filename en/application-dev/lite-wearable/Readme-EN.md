# Lite Wearable Application Development Fundamentals
...
- FA Model Application Configuration File<!--application-configuration-file-fa-->
...
- FA Model Application Components<!--fa-model-application-components-->
    ...
    - [Application- or Component-Level Configuration (FA Model)](../application-models/application-component-configuration-fa.md)
    ...
    - [Context (FA Model)](../application-models/application-context-fa.md)

    - [Want (FA Model)](../application-models/want-fa.md)
...
- Application Component Interaction Between the FA Model and Stage Model <!--fa-stage-interaction-->
