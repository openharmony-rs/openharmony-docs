...
| --------------- | ------------------- | ---- | ---------------------|
| batterySOC                                | number                                         | Yes  | Battery state of charge (SoC) of the device, in unit of percentage. The value range is [0, 100].<br>**Atomic service API**: This API can be used in atomic services since API version 12.                          |
