...
<!--Tester: @wanghong1997-->
<!--Adviser: @fang-jinxu-->
<!-- md-trans-meta sourceCommit=417fc360382b810eaca71d157c09ed3f2422bbbb translatedAt=2026-06-10T02:10:12.647Z pushedAt=2026-06-10T05:56:30.858Z -->
...
* **COMMON_EVENT_LOCKED_BOOT_COMPLETED<sup>(deprecated)</sup>** (reserved, not supported yet) indicates that the guidance is complete and the system is loaded, but the screen is still locked.
  ...
  > **NOTE**
  >
  > This event is supported since API version 7 and deprecated since API version 9. You are advised to use [COMMON_EVENT_LOCKED_BOOT_COMPLETED](commonEventManager-definitions.md#common_event_locked_boot_completed) instead.
