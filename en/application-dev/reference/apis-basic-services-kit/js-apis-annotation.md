...
**Widget capability**: This API can be used in ArkTS widgets since API version 22. This API applies only to ArkTS-Dyn.

**Atomic service API:** This API can be used in atomic services since API version 22. This API applies only to ArkTS-Dyn.
...
**Start version for ArkTS-Sta:** 26.0.0
...
系统提供的API告警屏蔽功能，允许开发者通过注解的方式来抑制API调用时产生的告警。该功能可应用于类、函数、变量、类型、接口等API元素上。After the corresponding annotation is added to the source code, the compiler automatically suppresses the corresponding warning based on the preset rules.
