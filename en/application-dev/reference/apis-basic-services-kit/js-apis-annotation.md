...
<!--Tester: @jiyong_sd-->
<!--Adviser: @fang-jinxu-->
<!-- md-trans-meta sourceCommit=896110e7291cdc3a48a03f8f59c185f12348fb57 translatedAt=2026-07-29T01:28:57.026Z pushedAt=2026-07-29T11:55:39.811Z -->

This module defines the annotation types of OpenHarmony ArkTS APIs, such as the minimum available version of the lifecycle and suppressing warnings generated by APIs. It helps developers identify and manage API features such as compatibility and warning suppression. This module addresses issues such as version compatibility warnings, permission warnings, and multi-device adaptation warnings encountered during cross-version development and third-party SDK integration. Annotations are used to suppress unnecessary warnings, improving code maintainability and development efficiency.
...
>
> When a warning is matched by multiple suppression rules, only the suppression rule closest to the code generating the warning takes effect.
...
| ---------------------- | ---- | ------------------------------ |
| COMPATIBILITY     | compatibility    | Compatibility warning. This warning is generated when the start version of the API called is later than the compatible SDK version set for the project. It is recommended that this warning be suppressed when version check or compatibility processing has been performed. Suppressing this warning without proper handling may cause devices running earlier versions to malfunction. |
| SYSCAP     | syscap    | Multi-device warning. This warning is generated when the system capability obtained by calling the API is not supported on the target device. |
| PERMISSION     | permission    | Permission warning. This warning is generated when an API that requires permissions is called but the corresponding permissions are not declared in the configuration file.<br/>**Since:** 26.0.0 |