...
Suppresses warnings generated by APIs. This annotation capability is provided by the system and can be used on classes, functions, variables, types, and APIs. After the corresponding annotation is added to the source code, the compiler automatically suppresses the corresponding warning based on the preset rules. This module can be used to temporarily ignore certain warnings in specific scenarios or prevent the compiler from generating interfering warnings. This helps you focus on key issues and improve development efficiency.
