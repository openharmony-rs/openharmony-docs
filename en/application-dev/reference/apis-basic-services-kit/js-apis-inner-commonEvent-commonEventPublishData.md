...
| --------------------- | -------------------- | ---- | ---- | ---------------------------- |
| bundleName            | string               | No | Yes | Bundle name of the subscriber, which is used to specify the subscriber to whom the common event is published.<br>**Atomic service API**: This API can be used in atomic services since API version 11.|
...
| subscriberPermissions | Array\<string>       | No | Yes | Subscriber permissions. Only subscribers with the specified permissions can receive the common event.<br>**Atomic service API**: This API can be used in atomic services since API version 11.            |
...
| parameters            | {[key: string]: any} | No | Yes | Additional information about the common event transferred by the publisher. Custom parameters are configured in a key-value pair format.<br>**Atomic service API**: This API can be used in atomic services since API version 11.      |
