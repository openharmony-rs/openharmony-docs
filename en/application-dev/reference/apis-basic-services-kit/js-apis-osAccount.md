...
| Type                              | Description                                                      |
| ---------------------------------- | ---------------------------------------------------------- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise used to return all the [constraints](appendix-osAccount-constraints.md) enabled for the OS account.|
...
| -------- | ---------------------------------------- | ---- | ---------------------------------------------------------------------------------------------- |
| localId  | number                                   | Yes  | ID of the target OS account.                                                                                   |
| callback | AsyncCallback&lt;Array&lt;string&gt;&gt; | Yes  | Callback used to return the result. If the operation is successful, **err** is **null** and **data** is a list of all [constraints](appendix-osAccount-constraints.md) enabled for the OS account. Otherwise, **err** is an error object.|
...
| constraints                    | Array&lt;string&gt;                                          | No| No | [Constraints](appendix-osAccount-constraints.md) of the OS account. By default, no value is passed in.|
