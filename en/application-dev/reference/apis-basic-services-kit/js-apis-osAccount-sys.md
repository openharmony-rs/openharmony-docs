...
| freezingTime | number                       | No   | Yes  | Freezing time, the default value is **-1**.    |
...
| nextPhaseFreezingTime<sup>12+</sup> | number | No   | Yes  | Next freezing time, the default value is **undefined**.|
...
| freezingTime | number      | No   | Yes  | Freezing time. This parameter is left empty by default.     |
| nextPhaseFreezingTime<sup>12+</sup> | number | No   | Yes  | Next freezing time, the default value is **undefined**.|
