...
| ------------- | ---- | ------------ |
| MENU_PANEL | 1    | The menu panel can serve as a primary panel to display the functions that the current application can provide, succh as translation and search.|
