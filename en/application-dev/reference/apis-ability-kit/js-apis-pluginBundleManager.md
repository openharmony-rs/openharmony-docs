...
<!--Tester: @menghaiyang-->
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=f6aebb5feee7366b8f8186d7dd8d5c650b89a049 translatedAt=2026-09-03T12:27:16.576Z pushedAt=2026-09-05T10:47:30.929Z -->
...
// Replace with the actual plugin file path.
...
| Type | Description |
| -------------- | --------------- |
| Promise\<void> | Promise object, which returns no result. |
...
// Replace it with the actual plugin Bundle name.
...
| Type                                                         | Description                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| Promise<Array\<[PluginBundleInfo](js-apis-bundleManager-pluginBundleInfo.md#pluginbundleinfo-1)>> | Promise object used to return the list of all local plugin information installed for the current application. |
