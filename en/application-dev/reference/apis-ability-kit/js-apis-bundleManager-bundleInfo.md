...
<!--Tester: @memghaiyang-->
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=850c7d4f71d6bc50d82f299a21bb9cea3a266f3d translatedAt=2026-09-03T11:11:44.429Z pushedAt=2026-09-05T10:47:30.559Z -->
...
| Name     | Type          | Read-Only| Optional| Description                       |
| --------- | -------------- | ---- | ---- | --------------------------- |
| appId     | string         | Yes  | No  | App ID, which uniquely identifies an app. For details, see [What Is appId?](../../quick-start/common-problem-of-application.md#what-is-appid).<br>**Atomic service API**: This API can be used in atomic services since API version 11.                |
