...
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=69bb003cf68ef836c8871de61d00c1b8f0451be5 translatedAt=2026-09-03T08:50:46.289Z pushedAt=2026-09-05T10:47:30.113Z -->
...
| -- | -- | -- |
| [OH_AbilityRuntime_ModularObjectExtensionInfo*](capi-abilityruntime-oh-abilityruntime-modularobjectextensioninfo8h.md) | OH_AbilityRuntime_ModObjExtensionInfoHandle | Indicates the information handle of a single ModularObjectExtensionAbility. This handle points to the complete information of a ModularObjectExtensionAbility, including the launch mode, process mode, thread mode, component name ([AbilityBase_Element](capi-abilitybase-element.md)), and disabled state. |
| [OH_AbilityRuntime_AllModularObjectExtensionInfos*](capi-abilityruntime-oh-abilityruntime-allmodularobjectextensioninfos8h.md) | OH_AbilityRuntime_AllModObjExtensionInfosHandle | Indicates the handle of the information set of all ModularObjectExtensionAbility instances in the current application. This handle points to a set that contains multiple [OH_AbilityRuntime_ModObjExtensionInfoHandle](capi-abilityruntime-oh-abilityruntime-modularobjectextensioninfo8h.md) handles. You can obtain the number of elements in the set through [OH_AbilityRuntime_GetCountFromAllModObjExtensionInfos](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getcountfromallmodobjextensioninfos), and traverse the set by index through [OH_AbilityRuntime_GetModObjExtensionInfoByIndex](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getmodobjextensioninfobyindex) to obtain the information of each ModularObjectExtensionAbility. After use, release the set through [OH_AbilityRuntime_ReleaseAllExtensionInfos](#oh_abilityruntime_releaseallextensioninfos). |

### Enumerated value

| Name | typedef Keyword | Description |
| -- | -- | -- |
| [OH_AbilityRuntime_LaunchMode](#oh_abilityruntime_launchmode) | OH_AbilityRuntime_LaunchMode | Defines the launch mode of a ModularObjectExtensionAbility. |
| [OH_AbilityRuntime_ProcessMode](#oh_abilityruntime_processmode) | OH_AbilityRuntime_ProcessMode | Defines the process mode of a ModularObjectExtensionAbility. |
| [OH_AbilityRuntime_ThreadMode](#oh_abilityruntime_threadmode) | OH_AbilityRuntime_ThreadMode | Defines the thread mode of a ModularObjectExtensionAbility. |
...
| [AbilityRuntime_ErrorCode OH_AbilityRuntime_GetModularObjectExtensionInfoDisableState(OH_AbilityRuntime_ModObjExtensionInfoHandle extensionInfo, bool *isDisabled)](#oh_abilityruntime_getmodularobjectextensioninfodisablestate) | Gets the disabled state from the specified ModularObjectExtensionAbility information. |
| [AbilityRuntime_ErrorCode OH_AbilityRuntime_AcquireSelfModularObjectExtensionInfos(OH_AbilityRuntime_AllModObjExtensionInfosHandle *outOwnedAllExtensionInfos)](#oh_abilityruntime_acquireselfmodularobjectextensioninfos) | Gets the information of all registered ModularObjectExtensionAbility instances in the current application. This API returns a handle to the information set of all registered ModularObjectExtensionAbility instances in the current application. Developers can traverse each ModularObjectExtensionAbility information in the set through [OH_AbilityRuntime_GetCountFromAllModObjExtensionInfos](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getcountfromallmodobjextensioninfos) and [OH_AbilityRuntime_GetModObjExtensionInfoByIndex](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getmodobjextensioninfobyindex), and then obtain the launch mode, process mode, thread mode, and other attributes of each ModularObjectExtensionAbility. |
| [AbilityRuntime_ErrorCode OH_AbilityRuntime_ReleaseAllExtensionInfos(OH_AbilityRuntime_AllModObjExtensionInfosHandle *allExtensionInfos)](#oh_abilityruntime_releaseallextensioninfos) | Releases the ModularObjectExtensionAbility information set obtained through [OH_AbilityRuntime_AcquireSelfModularObjectExtensionInfos](capi-modular-object-extension-manager-h.md#oh_abilityruntime_acquireselfmodularobjectextensioninfos). When the ModularObjectExtensionAbility information set is no longer needed, you must call this API to release the related resources to avoid memory leaks. |
| [AbilityRuntime_ErrorCode OH_AbilityRuntime_GetCountFromAllModObjExtensionInfos(OH_AbilityRuntime_AllModObjExtensionInfosHandle allExtensionInfos, size_t *count)](#oh_abilityruntime_getcountfromallmodobjextensioninfos) | Gets the number of ModularObjectExtensionAbility information entries contained in the ModularObjectExtensionAbility information set. The returned count can be used to determine the upper limit of the index when traversing the set, and works with [OH_AbilityRuntime_GetModObjExtensionInfoByIndex](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getmodobjextensioninfobyindex) to access each ModularObjectExtensionAbility information in the set one by one. |
| [AbilityRuntime_ErrorCode OH_AbilityRuntime_GetModObjExtensionInfoByIndex(OH_AbilityRuntime_AllModObjExtensionInfosHandle allExtensionInfos, size_t index, OH_AbilityRuntime_ModObjExtensionInfoHandle *extensionInfo)](#oh_abilityruntime_getmodobjextensioninfobyindex) | Gets the specified ModularObjectExtensionAbility information from the ModularObjectExtensionAbility information set by index. The valid range of the index is [0, count), where count can be obtained through [OH_AbilityRuntime_GetCountFromAllModObjExtensionInfos](capi-modular-object-extension-manager-h.md#oh_abilityruntime_getcountfromallmodobjextensioninfos). The obtained ModularObjectExtensionAbility information handle can be used to query the launch mode, process mode, thread mode, and other attributes of the ModularObjectExtensionAbility. |
...
| Value | Description |
| -- | -- |
| OH_ABILITY_RUNTIME_LAUNCH_MODE_IN_PROCESS = 0 | Indicates that the ModularObjectExtensionAbility is started in the caller (client) process. In this mode, the ModularObjectExtensionAbility shares the same process with the caller, which is suitable for scenarios that do not require process isolation. |
| OH_ABILITY_RUNTIME_LAUNCH_MODE_CROSS_PROCESS = 1 | Indicates that the ModularObjectExtensionAbility can be started across processes. In this mode, the ModularObjectExtensionAbility runs in an independent process and is isolated from the caller process, which is suitable for scenarios that require process-level isolation to improve stability and security. |
...
| Value | Description |
| -- | -- |
| OH_ABILITY_RUNTIME_PROCESS_MODE_BUNDLE = 0 | Indicates that all ModularObjectExtensionAbility instances of the same application share a process. All instances run in the same process, reducing system resource consumption. |
| OH_ABILITY_RUNTIME_PROCESS_MODE_TYPE = 1 | Indicates that ModularObjectExtensionAbility instances with the same Ability name share a process. ModularObjectExtensionAbility instances with the same Ability name are assigned to the same process, while instances with different Ability names run in different processes. |
| OH_ABILITY_RUNTIME_PROCESS_MODE_INSTANCE = 2 | Indicates that each ModularObjectExtensionAbility instance exclusively occupies a process. Each ModularObjectExtensionAbility instance has an independent process space, achieving maximum process isolation, and is suitable for scenarios with extremely high requirements on stability and security. |
...
| Value | Description |
| -- | -- |
| OH_ABILITY_RUNTIME_THREAD_MODE_BUNDLE = 0 | Indicates that all ModularObjectExtensionAbility instances of the same application share a thread. All instances are executed sequentially in the same thread, minimizing resource overhead. However, avoid blocking other instances due to a single instance. |
| OH_ABILITY_RUNTIME_THREAD_MODE_TYPE = 1 | Indicates that ModularObjectExtensionAbility instances with the same Ability name share a thread. Instances with the same Ability name share a thread, while instances with different Ability names use different threads, striking a balance between resource consumption and concurrency performance. |
...
| [OH_AbilityRuntime_LaunchMode](capi-modular-object-extension-manager-h.md#oh_abilityruntime_launchmode) *launchMode | Pointer to [OH_AbilityRuntime_LaunchMode](capi-modular-object-extension-manager-h.md#oh_abilityruntime_launchmode), used to receive the launch mode. |

**Return**

| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Result code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode): the interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode): extensionInfo or launchMode is empty. |
...
| -- | -- |
| [OH_AbilityRuntime_ModObjExtensionInfoHandle](capi-abilityruntime-oh-abilityruntime-modularobjectextensioninfo8h.md) extensionInfo | Information handle of the target ModularObjectExtensionAbility. |
| [OH_AbilityRuntime_ProcessMode](capi-modular-object-extension-manager-h.md#oh_abilityruntime_processmode) *processMode | Pointer to [OH_AbilityRuntime_ProcessMode](capi-modular-object-extension-manager-h.md#oh_abilityruntime_processmode), used to receive the process mode. |
...
| -- | -- |
| [OH_AbilityRuntime_ModObjExtensionInfoHandle](capi-abilityruntime-oh-abilityruntime-modularobjectextensioninfo8h.md) extensionInfo | Information handle of the target ModularObjectExtensionAbility. |
| [AbilityBase_Element](capi-abilitybase-element.md) *element | Pointer to [AbilityBase_Element](capi-abilitybase-element.md), used to receive the component name. |

**Return**

| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Result code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode): the interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode): extensionInfo or element is empty. |
...
| -- | -- |
| [OH_AbilityRuntime_ModObjExtensionInfoHandle](capi-abilityruntime-oh-abilityruntime-modularobjectextensioninfo8h.md) extensionInfo | Information handle of the target ModularObjectExtensionAbility. |
| bool *isDisabled | Pointer to a boolean value, used to receive the disabled state. true indicates that it is disabled and other applications are not allowed to connect; false indicates that it is not disabled and other applications are allowed to connect. |

**Return**

| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Returns a specific error code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode) The interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode) extensionInfo or isDisabled is empty. |
...
| Parameter | Description |
| -- | -- |
| [OH_AbilityRuntime_AllModObjExtensionInfosHandle](capi-abilityruntime-oh-abilityruntime-allmodularobjectextensioninfos8h.md) *allExtensionInfos | Pointer to the handle of the ModularObjectExtensionAbility information set to be released. After the release, the pointer is set to null. |

**Return**

| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Result code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode) The interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode) allExtensionInfos is empty. |
...
| Parameter | Description |
| -- | -- |
| [OH_AbilityRuntime_AllModObjExtensionInfosHandle](capi-abilityruntime-oh-abilityruntime-allmodularobjectextensioninfos8h.md) allExtensionInfos | Handle of the ModularObjectExtensionAbility information set. |
| size_t *count | Pointer to size_t, used to receive the count of ModularObjectExtensionAbility information. |

**Return**

| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Result code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode): The interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode): allExtensionInfos or count is empty. |
...
| size_t index | Index of the target ModularObjectExtensionAbility information in the collection. The value must be less than the number of ModularObjectExtensionAbility information items in the collection. |
...
| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Result code.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode): the API call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode): allExtensionInfos or extensionInfo is empty,<br>         or index is greater than or equal to the number of ModularObjectExtensionAbility information items in the collection. |
...
| Type | Description |
| -- | -- |
| [AbilityRuntime_ErrorCode](capi-ability-runtime-common-h.md#abilityruntime_errorcode) | Returns specific error codes.<br>         [ABILITY_RUNTIME_ERROR_CODE_NO_ERROR](capi-ability-runtime-common-h.md#abilityruntime_errorcode) The interface call is successful.<br>         [ABILITY_RUNTIME_ERROR_CODE_PARAM_INVALID](capi-ability-runtime-common-h.md#abilityruntime_errorcode) Invalid parameter.<br>         [ABILITY_RUNTIME_ERROR_CODE_INTERNAL](capi-ability-runtime-common-h.md#abilityruntime_errorcode) Internal error. |
