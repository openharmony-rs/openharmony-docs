...
| Type                 | Description                                                        |
| --------------------- | ------------------------------------------------------------ |
| Promise\<image.PixelMap> | Promise used to return the [PixelMap](../apis-image-kit/js-apis-image.md).|
...
| bundleName  | string                                   | Yes   | Bundle name.                               |
| abilityName | string                                   | Yes   | Ability name.                                |
| callback   | AsyncCallback\<image.PixelMap> | Yes  | Callback used to return the [PixelMap](../apis-image-kit/js-apis-image.md).|
