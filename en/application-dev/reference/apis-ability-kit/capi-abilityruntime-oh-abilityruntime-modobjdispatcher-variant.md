...
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=b64fba1a3bfa56ac6a22a458a141c3f45d9c160b translatedAt=2026-09-03T08:31:30.386Z pushedAt=2026-09-05T10:47:30.063Z -->
...
| uint64_t reserved1 | Reserved field 1. Reserved space for future versions. The caller should initialize it to 0 and should not read or modify it.<br>**Since:** 26.0.0 |
| uint64_t reserved2 | Reserved field 2. Reserved space for future versions. The caller should initialize it to 0 and should not read or modify it.<br>**Since:** 26.0.0 |
| uint64_t reserved3 | Reserved field 3. Reserved space for future versions. The caller should initialize it to 0 and should not read or modify it.<br>**Since:** 26.0.0 |
