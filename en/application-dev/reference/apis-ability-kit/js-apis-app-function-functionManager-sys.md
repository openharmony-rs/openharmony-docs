...
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=938bc44e514b9eed279585f3283eccb3aaf0ac72 translatedAt=2026-09-03T10:48:55.351Z pushedAt=2026-09-05T10:47:30.487Z -->
...
| ---------- | ---- | --- | ------------------ |
| context | [Context](js-apis-inner-application-context.md) | No | Application context information used when a Function is invoked.<br>**Note:** Currently, only [UIAbilityContext](js-apis-inner-application-uiAbilityContext.md) is supported. |
...
| ------------- | ------- | ---- | ---  |----------------- |
| success      | boolean  | Yes   | Yes   | Whether the call is successful (at the business logic level). true: the call is successful, and the data field contains the returned data; false: the call fails, and the errorCode and errorMsg fields contain the error information. |
| data    | any  | Yes   | No   | Data returned when the call is successful. The type follows the return value type defined by Function. This field has a value only when success is true. Default value: undefined. |
| errorCode     | number  | Yes   | No   | Error code when the call fails. This field has a value only when success is false. Default value: undefined. |
| errorMsg  | string  | Yes   | No   | Error description when the call fails. This field has a value only when success is false. Default value: undefined. |
...
| Type                               | Description                       |
| ---------------------------------- | -------------------------- |
| Promise\<Array\<[FunctionInfo](js-apis-inner-application-FunctionInfo-sys.md#functioninfo)>> | Promise object used to return the list of available Functions, including the namespace, name, version, description, input/output mode, and so on. |
...
| options | [InvokeOptions](#invokeoptions) | No | Optional parameters for invoking the Function. Default value: see the default values of the specific properties in [InvokeOptions](#invokeoptions). |

**Return value**

| Type | Description |
| -------- | -------- |
| Promise\<[InvokeResult](#invokeresult)\> | Promise object. Returns the result of the Function invocation. |
