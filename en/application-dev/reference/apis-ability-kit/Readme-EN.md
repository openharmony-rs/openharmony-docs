...
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=47a73aabc3853c13d66a6464817200dc78a4d828 translatedAt=2026-09-03T12:39:04.512Z pushedAt=2026-09-07T12:06:34.059Z -->
...
- ArkTS APIs<!--ability-arkts-->
  - Stage Model<!--stage-model-->
    ...
    - [@ohos.app.ability.AgentUIExtensionAbility (UI-based Agent Extension Component)](js-apis-agent-agentUIExtensionAbility.md)
    ...
    - [@ohos.app.ability.appMemoryOptimizer (Application Memory Optimizer)](js-apis-app-ability-appMemoryOptimizer.md)
    ...
    - [@ohos.app.ability.common (Ability Common Module)](js-apis-app-ability-common.md)
    - [@ohos.app.ability.CompletionHandler (Application Launch Result Handler)](js-apis-app-ability-completionHandler.md)
    - [@ohos.app.ability.CompletionHandlerForAtomicService (Atomic Service Launch Result Handler)](js-apis-app-ability-CompletionHandlerForAtomicService.md)
    - [@ohos.app.ability.CompletionHandlerForAbilityStartCallback (Application Launch Result Callback Handler)](js-apis-app-ability-CompletionHandlerForAbilityStartCallback.md)
    ...
    - [@ohos.app.ability.EmbeddedUIExtensionAbility (ExtensionAbility for Cross-Process UI Embedding)](js-apis-app-ability-embeddedUIExtensionAbility.md)
    ...
    - [@ohos.app.ability.insightIntent (Basic Definitions of InsightIntent Framework)](js-apis-app-ability-insightIntent.md)
    - [@ohos.app.ability.InsightIntentContext (Intent Execution Context)](js-apis-app-ability-insightIntentContext.md)
    ...
    - [@ohos.app.ability.insightIntentProvider (Intent Provider Management)](js-apis-app-ability-insightIntentProvider.md)
    ...
    - [@ohos.app.ability.systemConfiguration (System Environment Module)](js-apis-app-ability-systemConfiguration.md)
    ...
    - [@ohos.app.ability.UIExtensionContentSession (UI Operation Class with UI Extension Capability)](js-apis-app-ability-uiExtensionContentSession.md)
    - [@ohos.app.ability.sendableContextManager (Sendable Context Management)](js-apis-app-ability-sendableContextManager.md)
    - [@ohos.app.ability.scriptManager (Script Management)](js-apis-app-ability-scriptManager.md)
    ...
    - [@ohos.app.agent.agentConstant (Agent Constants)](js-apis-app-agent-agentConstant.md)
    ...
    - [@ohos.app.ability.autoStartupManager (Auto-Startup Management) (System API)](js-apis-app-ability-autoStartupManager-sys.md)
    - [@ohos.app.ability.common (Ability Common Module) (System API)](js-apis-app-ability-common-sys.md)
     - [@ohos.app.ability.contextConstant (Context-related Constants) (System API)](js-apis-app-ability-contextConstant-sys.md)
    - [@ohos.app.ability.dialogSession (dialogSession) (System API)](js-apis-app-ability-dialogSession-sys.md)
    - [@ohos.app.ability.insightIntent (Basic Definitions of InsightIntent Framework) (System API)](js-apis-app-ability-insightIntent-sys.md)
    ...
    - [@ohos.app.ability.UIExtensionContentSession (UI Operation Class of UI-based Extension Ability)(system API)](js-apis-app-ability-uiExtensionContentSession-sys.md)
    - [@ohos.app.cli.cliManager (CLI Tool Management)(System API)](js-apis-app-cli-cliManager-sys.md)
    <!--DelEnd-->
  ...
  - FA Model<!--fa-model-->
    ...
    - [@ohos.ability.particleAbility (ParticleAbility Module)](js-apis-ability-particleAbility.md)
    ...
    - app<!--app-->
      ...
      - [Context (Context Base Class of the FA Model)](js-apis-inner-app-context.md)
      - [ProcessInfo](js-apis-inner-app-processInfo.md)
  - Both Models (Recommended)<!--both-models-->
    - [@ohos.abilityAccessCtrl (Application Access Control)](js-apis-abilityAccessCtrl.md)
    ...
    - [@ohos.app.ability.Configuration (Environment Variables)](js-apis-app-ability-configuration.md)
    - [@ohos.app.ability.ConfigurationConstant (Constants Related to Environment Variables)](js-apis-app-ability-configurationConstant.md)
    ...
    - [@ohos.app.ability.hyperSnapManager (Application Quick Startup Management)](js-apis-app-ability-hyperSnapManager.md)
    ...
    - [@ohos.abilityToolAccessCtrl (Tool Access Control) (System API)](js-apis-abilityToolAccessCtrl-sys.md)
    ...
    - [@ohos.app.agent.AgentExtensionAbility (Agent Extension Component) (System API)](js-apis-app-agent-agentExtensionAbility-sys.md)
    - [@ohos.app.agent.agentManager (Agent Component Management) (System API)](js-apis-app-agent-agentManager-sys.md)
    - [@ohos.app.agent.agentConstant (Agent Constants) (System API)](js-apis-app-agent-agentConstant-sys.md)
    ...
    - [@ohos.app.businessAbilityRouter (Service Routing Module) (System API)](js-apis-businessAbilityRouter-sys.md)
    - [@ohos.application.uriPermissionManager (URI Permission Management) (System API)](js-apis-uripermissionmanager-sys.md)
    <!--DelEnd-->
    - [@ohos.bundle.bundleManager (Bundle Management Module)](js-apis-bundleManager.md)
    - [@ohos.bundle.defaultAppManager (Default Application Management)](js-apis-defaultAppManager.md)
    - [@ohos.bundle.launcherBundleManager (launcherBundleManager Module)](js-apis-launcherBundleManager.md)
    - [@ohos.bundle.overlay (overlay Feature Module)](js-apis-overlay.md)
    - [@ohos.bundle.pluginBundleManager (pluginBundleManager module)](js-apis-pluginBundleManager.md)
    - [@ohos.bundle.shortcutManager (shortcutManager Module)](js-apis-shortcutManager.md)
    - [@ohos.bundle.skillManager (skillManager Module)](js-apis-skillManager.md)
    <!--Del-->
    - [@ohos.bundle.appControl (appControl Module) (System API)](js-apis-appControl-sys.md)
    - [@ohos.bundle.appDomainVerify (Application Domain Name Verification) (System API)](js-apis-appDomainVerify-sys.md)
    - [@ohos.bundle.bundleManager (Bundle Management Module) (System API)](js-apis-bundleManager-sys.md)
    - [@ohos.bundle.bundleMonitor (bundleMonitor Module) (System API)](js-apis-bundleMonitor-sys.md)
    - [@ohos.bundle.bundleResourceManager (bundleResourceManager Module) (System API)](js-apis-bundleResourceManager-sys.md)
    - [@ohos.bundle.defaultAppManager (Default Application Management) (System API)](js-apis-defaultAppManager-sys.md)
    - [@ohos.bundle.distributedBundleManager (distributedBundleManager Module) (System API)](js-apis-distributedBundleManager-sys.md)
    - [@ohos.bundle.freeInstall (freeInstall Module) (System API)](js-apis-freeInstall-sys.md)
    - [@ohos.bundle.installer (installer Module) (System API)](js-apis-installer-sys.md)
    - [@ohos.bundle.launcherBundleManager (launcherBundleManager Module) (System API)](js-apis-launcherBundleManager-sys.md)
    - [@ohos.bundle.overlay (overlay Module) (System API)](js-apis-overlay-sys.md)
    - [@ohos.bundle.shortcutManager (shortcutManager Module) (System API)](js-apis-shortcutManager-sys.md)
  ...
  - Dependent Elements and Definitions<!--ability-api-interface-depend-->
    ...
    - application<!--ability-arkts-application-->
      ...
      - [AgentExtensionContext](js-apis-inner-application-agentExtensionContext.md)
      ...
      - [Context (Context Base Class of the Stage Model)](js-apis-inner-application-context.md)
      ...
      - [KioskStatus (Kiosk Status Information)](js-apis-application-KioskStatus.md)
      ...
      - [CliToolEvent (System API)](js-apis-inner-application-cliToolEvent-sys.md)
      ...
      - [ToolEventCallback (System API)](js-apis-inner-application-toolEventCallback-sys.md)
      - [ToolInfo (System API)](js-apis-inner-application-ToolInfo-sys.md)
    ...
    - wantAgent<!--wantagent-->
      ...
      - [WantAgentInfo (System API)](js-apis-inner-wantAgent-wantAgentInfo-sys.md)
      <!--DelEnd-->
  - APIs No Longer Maintained<!--ability-arkts-dep-->
    - [@ohos.ability.dataUriUtils (DataUriUtils Module)](js-apis-ability-dataUriUtils.md)
    ...
    - [@ohos.wantAgent (WantAgent Module) (System API)](js-apis-wantAgent-sys.md)
    <!--DelEnd-->
    - [@ohos.bundle (Bundle Module)](js-apis-Bundle.md)
    <!--Del-->
    - [@ohos.bundle (Bundle Module) (System API)](js-apis-Bundle-sys.md)
    - [@ohos.bundle.innerBundleManager (innerBundleManager Module) (System API)](js-apis-Bundle-InnerBundleManager-sys.md)
...
- C APIs<!--ability-c-->
  ...
  - Structs<!--ability-struct-->
    ...
    - [OH_AbilityRuntime_ChildProcessInfoHandle](capi-nativechildprocess-info.md)
    - [OH_AbilityRuntime_ChildProcessInfosHandle](capi-nativechildprocess-infos.md)
...
- Error Codes<!--ability-arkts-errcode-->
  ...
  - [Error Codes of Bundle Management Quick Fix Commands](bm-quickfix-errorcode.md)
  ...
  - [Tool Access Control Error Codes](errorcode-abilityToolAccessCtrl-sys.md)
