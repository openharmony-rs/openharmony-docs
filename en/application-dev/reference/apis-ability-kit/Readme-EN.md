...
- ArkTS APIs<!--ability-arkts-->
  - Stage Model<!--stage-model-->
    ...
    - [@ohos.app.ability.AbilityStage (Component Manager)](js-apis-app-ability-abilityStage.md)
    ...
    - [@ohos.app.ability.AtomicServiceOptions (EmbeddableUIAbility Startup Options)](js-apis-app-ability-atomicServiceOptions.md)
