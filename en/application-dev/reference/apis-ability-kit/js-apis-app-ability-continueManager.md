...
<!--Tester: @hanjiawei-->
<!--Adviser: @hu-zhiqiong-->
<!-- md-trans-meta sourceCommit=c2c8e45a3dace8f341bfcf47c6f4bc4dd6f05f00 translatedAt=2026-09-09T03:08:53.169Z pushedAt=2026-09-09T03:48:35.935Z -->
...
export default class MigrationAbility extends UIAbility {
    ...
    onCreate(want: Want, launchParam: AbilityConstant.LaunchParam): void {
        ...
        if (launchParam.launchReason === AbilityConstant.LaunchReason.PREPARE_CONTINUATION) {
            ...
            // If the application migration data is large, add a loading page here (displaying loading, etc.).
            // Handle application custom redirection, timing, and other issues.
            // ...
        }
    }
}
...
export default class MigrationAbility extends UIAbility {
    ...
    onCreate(want: Want, launchParam: AbilityConstant.LaunchParam): void {
        ...
        if (launchParam.launchReason === AbilityConstant.LaunchReason.PREPARE_CONTINUATION) {
            ...
            // If the application migration data is large, add a loading page here (display loading on the page).
            // Handle application custom redirection, timing, and other issues.
            // ...
        }
    }
