...
<!--Adviser: @HelloCrease-->
<!-- md-trans-meta sourceCommit=cbad1cf505608b4be1b9d2f86822e337e90a4c7f translatedAt=2026-09-09T03:24:23.441Z pushedAt=2026-09-09T03:46:09.886Z -->
...
export default class MyAbilityStage extends AbilityStage {
  onLaunchFromHyperSnap(): void {
    ...
    // Add the initialization logic for quick launch here.
  }
}
```
...
export default class MyAbilityStage extends AbilityStage {
  async onAboutToCreateAbilityAsync(): Promise<void> {
    ...
    // Only after initialization is complete will the Ability continue to be created.
  }
}
```
