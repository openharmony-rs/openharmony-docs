...
| callback | Callback\<BundleChangedInfo>| Yes  | [AsyncCallback](../apis-basic-services-kit/js-apis-base.md#asynccallback) used to return the result. If the operation is successful, **err** is **undefined** and **data** is the app change information obtained. Otherwise, **err** is an error object.|
...
| callback | Callback\<BundleChangedInfo>| No  | [AsyncCallback](../apis-basic-services-kit/js-apis-base.md#asynccallback) used to return the result. If the operation is successful, **err** is **undefined** and **data** is the app change information obtained. Otherwise, **err** is an error object.|
