...
| Type | Description |
| -------- | -------- |
| Promise<Array<[AgentCard](./js-apis-inner-application-AgentCard.md#agentcard-1)>> | Promise object that returns an array of all AgentCards on the device. |
...
| Type | Description |
| -------- | -------- |
| Promise<Array<[AgentCard](./js-apis-inner-application-AgentCard.md#agentcard-1)>> | Promise object that returns an array of all AgentCards in the specified bundleName. |
...
| Type | Description |
| -------- | -------- |
| Promise<[AgentCard](./js-apis-inner-application-AgentCard.md#agentcard-1)> | Promise object that returns the specified AgentCard. |
...
let bundleName = 'com.example.myapplication';
// Set the ID of the agent to query.
...
| agentId  | string                                | Yes  | agentId of the [AgentExtensionAbility](js-apis-app-agent-agentExtensionAbility.md). |
| callback | [AgentExtensionConnectCallback](js-apis-inner-application-agentExtensionConnectCallback-sys.md) | Yes  | Connection callback, which includes the callback interfaces for receiving data from the [AgentExtensionAbility](js-apis-app-agent-agentExtensionAbility.md) server, security authentication data, and the disconnection event. |

**Return value**

| Type                       | Description                         |
| -------------------------- | ---------------------------- |
| Promise\<[AgentProxy](js-apis-inner-application-agentProxy-sys.md)> | Promise object that returns the AgentProxy object, which is used to send data or security authentication requests from the client to the AgentExtensionAbility server. |
      ...
      Row() {
        ...
        Button('connect ability')
          ...
          .onClick(() => {
            ...
            // Set the ID of the agent to connect.
            let agentId: string = 'test';
            try {
              // Connect to the AgentExtensionAbility.
...
| Name    | Type                                              | Mandatory | Description           |
| --------- | ------------------------------------------------- | ---- | ------------ |
| agentCard | [AgentCard](./js-apis-inner-application-AgentCard.md#agentcard-1) | Yes   | AgentCard information to update. |
...
| Name       | Type   | Mandatory | Description                               |
| ---------- | ------ | --------- | ----------------------------------------- |
| bundleName | string | Yes       | Bundle name of the AgentCard.             |
| agentId    | string | Yes       | Agent ID of the AgentCard.                |
...
| Name | Type                                             | Mandatory | Description           |
| ------ | ------------------------------------------------ | ---- | ------------ |
| proxy  | [AgentProxy](js-apis-inner-application-agentProxy-sys.md) | Yes   | Proxy object corresponding to the [AgentExtensionAbility](js-apis-app-agent-agentExtensionAbility.md) to be disconnected. The corresponding proxy object is returned when [connectAgentExtensionAbility](#agentmanagerconnectagentextensionability) is called to connect to the [AgentExtensionAbility](js-apis-app-agent-agentExtensionAbility.md). |
    ...
    Column() {
      Row() {
        ...
        Button('connect ability')
          ...
          .onClick(() => {
            try {
              // Disconnect the AgentExtensionAbility.
...
| Name    | Type   | Mandatory | Description                  |
| ------- | ------ | --------- | ---------------------------- |
| agentId | string | Yes       | Identifier of the AgentCard. |
...
> **NOTE**
>
> - This API cannot be called in a multithreaded environment or a child process. Calling it in a multithreaded environment causes a CppCrash; calling it in a child process returns error code 16000050.
...
| callback | [ConnectOptions](js-apis-inner-ability-connectOptions.md)      | Yes   | Callback of the ConnectOptions type, used to return the information about successful connection, failed connection, and disconnection.  |

**Return value**

| Type | Description |
| ---- | ------------------------------------------------------------ |
| number | Connection ID, which identifies the connection between the current AgentExtensionAbility and the ServiceExtensionAbility. This connection ID can be used to disconnect the connection by calling [disconnectServiceExtensionAbility](#agentmanagerdisconnectserviceextensionability). |
...
| -------------- | ----------------------------------------------------------- | --------- | ---------------------------------------------- |
| context    | [AgentExtensionContext](js-apis-inner-application-agentExtensionContext.md) | Yes   | Context of the current Agent extension ability, including AgentCard information.    |
| connectId  | number                                                        | Yes   | Connection ID returned by [connectServiceExtensionAbility](#agentmanagerconnectserviceextensionability), used to identify the target connection to be disconnected. |
