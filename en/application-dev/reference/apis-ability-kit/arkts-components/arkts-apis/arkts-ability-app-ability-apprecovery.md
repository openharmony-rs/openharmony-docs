...
| [saveAppState](arkts-ability-apprecovery-saveappstate-f.md) | Saves the ability state, which will be used for recovery. This API can be used together with the APIs of [errorManager](arkts-ability-app-ability-errormanager.md). |
