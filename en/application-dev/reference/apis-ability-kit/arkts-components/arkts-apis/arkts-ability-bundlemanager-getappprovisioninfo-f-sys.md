...
| Type | Description |
| --- | --- |
| Promise&lt;[AppProvisionInfo](arkts-ability-bundlemanager-appprovisioninfo-t-sys.md)&gt; | Promise used to return the provision profile obtained. |
