...
| -- | -- |
| [AbilityBase_Element](capi-abilitybase-abilitybase-element.md) element | Element struct. |

**Returns**:

| Type | Description |
| -- | -- |
| [AbilityBase_Want*](capi-abilitybase-abilitybase-want.md) | Pointer to Want. |
...
| -- | -- |
| [AbilityBase_Want](capi-abilitybase-abilitybase-want.md)* want | Pointer to Want. |
| [AbilityBase_Element](capi-abilitybase-abilitybase-element.md)* element | Pointer to the Element struct. |
