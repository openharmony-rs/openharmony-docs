...
| [flags](js-apis-app-ability-wantConstant.md#flags) | number | No| Yes | How the Want object will be handled. The value is of the enumeration type [Flags](js-apis-app-ability-wantConstant.md#flags). A numeric value should be passed by default.<br>For example, if the value is 0x00000001 (**wantConstant.Flags.FLAG_AUTH_READ_URI_PERMISSION**), the receiver is temporarily granted the permission to read the data pointed to by the URI.|
