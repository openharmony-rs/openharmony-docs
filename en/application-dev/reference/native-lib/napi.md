...
The APIs exported from the Node-API standard library feature usage and behaviors based on [Node.js](https://nodejs.org/docs/latest-v12.x/api/n-api.html) and have incorporated [extended capabilities](#node-api-extended-symbols).
...
|FUNC|napi_create_ark_runtime|Creates a basic runtime environment.|12|
...
Destroys the ArkTS runtime environment.
