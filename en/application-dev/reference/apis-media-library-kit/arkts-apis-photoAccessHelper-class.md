...
| gridLevel    | [GridLevel](arkts-apis-photoAccessHelper-e.md#gridlevel23)   | No  | Yes| Level of the grid when the user exits last time.<br>**Model restriction**: This API can be used only in the stage model.<br>**Atomic service API**: This API can be used in atomic services since API version 23.|
