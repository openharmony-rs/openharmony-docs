...
| [bool OH_ArkUI_IsBuiltInGesture(ArkUI_GestureRecognizer* recognizer)](#oh_arkui_isbuiltingesture) | - | Obtains whether a gesture is a system built-in gesture.|
...
Obtains whether a gesture is a system built-in gesture.
