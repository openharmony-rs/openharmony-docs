...
<!-- md-trans-meta sourceCommit=0864e245a917a6438a134fc4698ad4144bd5f322 translatedAt=2026-09-22T09:02:45.768Z pushedAt=2026-09-22T10:30:39.921Z -->
...
| float startMargin | Distance between the divider and the start edge of the **Picker** container.<br>Default value: **0**<br>Unit: vp<br>Value range: The sum of **startMargin** and **endMargin** must not exceed the width of the **Picker** container.<br>Setting the style parameter for the divider-style indicator fails when the value is less than 0. If the sum of **startMargin** and **endMargin** exceeds the container width, the default value **0** is used. Percentages are not supported. |
