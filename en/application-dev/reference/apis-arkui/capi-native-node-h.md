...
| [int32_t OH_ArkUI_NativeModule_RemoveAdoptedChild(ArkUI_NodeHandle node, ArkUI_NodeHandle child)](#oh_arkui_nativemodule_removeadoptedchild) | - | Removes a previously adopted affiliate node.|
...
| NODE_SWIPER_CURVE = 1001006 | Defines the animation curve for the swiper. This attribute can be set, reset, and obtained as required through APIs. If this attribute is not set or reset, the animation curve type is [interpolatingSpring](../../reference/apis-arkui/js-apis-curve.md#curvesinterpolatingspring10)(-1, 1, 328, 34). If this attribute is set incorrectly, the default value **ARKUI_CURVE_LINEAR** is used.<br>Format of the [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md) parameter for setting the attribute:<br> .value[0].i32: animation curve. The parameter type is [ArkUI_AnimationCurve](capi-native-type-h.md#arkui_animationcurve). The default value is **ARKUI_CURVE_LINEAR**.<br> Format of the return value [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md):<br> .value[0].i32: animation curve. The parameter type is [ArkUI_AnimationCurve](capi-native-type-h.md#arkui_animationcurve). The default value is **ARKUI_CURVE_LINEAR**.|
...
| [ArkUI_NodeHandle](capi-arkui-nativemodule-arkui-node8h.md) child | Pointer to an **ArkUI_NodeHandle**, representing the node to be removed. |
