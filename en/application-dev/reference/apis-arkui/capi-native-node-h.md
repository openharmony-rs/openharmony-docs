...
|NODE_WIDTH_LAYOUTPOLICY = 105|Sets the width layout policy of a component. The attributes can be set, reset, and obtained.<br>Format of the [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md) parameter for setting the attribute:<br> .value[0].i32: layout policy. The parameter type is [ArkUI_LayoutPolicy](capi-native-type-h.md#arkui_layoutpolicy).<br>Format of the return value [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md):<br>.value[0].i32: layout policy. The parameter type is [ArkUI_LayoutPolicy](capi-native-type-h.md#arkui_layoutpolicy).<br>**Since**: 21|
...
|NODE_POSITION_EDGES = 107|Sets the position of the component relative to the boundary of the container content area. This attribute can be set, reset, and obtained as required through APIs.<br>Format of the [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md) parameter for setting the attribute:<br> .object: position of the component relative to the boundary of the container content area. The parameter type is [ArkUI_PositionEdges](capi-arkui-nativemodule-arkui-positionedges.md).<br>Format of the return value [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md):<br> .object: position of the component relative to the boundary of the container content area. The parameter type is [ArkUI_PositionEdges](capi-arkui-nativemodule-arkui-positionedges.md).<br>**Since**: 21|
|NODE_PIXEL_ROUND = 109|Sets the pixel rounding policy of the component. This attribute can be set, reset, and obtained as required through APIs.<br>Format of the [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md) parameter for setting the attribute:<br>.object: pixel rounding policy of the component. The parameter type is [ArkUI_PixelRoundPolicy](capi-arkui-nativemodule-arkui-pixelroundpolicy.md).<br>Format of the return value [ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md):<br>.object: pixel rounding policy of the component. The parameter type is [ArkUI_PixelRoundPolicy](capi-arkui-nativemodule-arkui-pixelroundpolicy.md).<br>**Since**: 21|
...
| NODE_SCROLL_EVENT_ON_WILL_START_DRAGGING | Defines the callback function for the start of dragging a scroll container component. This event is triggered when the dragging of a scroll container component is about to start.<br> When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br> [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) does not contain parameters.<br>**Since**: 21   |
| NODE_SCROLL_EVENT_ON_DID_STOP_DRAGGING | Defines the callback function for the end of dragging a scroll container component. This event is triggered when the dragging of a scroll container component ends.<br> When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br> [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) contains the following parameters:<br> <b>ArkUI_NodeComponentEvent.data[0].i32</b>: whether to trigger the sliding animation after the dragging ends.<br>**Since**: 21 |
| NODE_SCROLL_EVENT_ON_WILL_START_FLING | Defines the callback function for the start of the sliding animation of a scroll container component. This event is triggered when the sliding animation of a scroll container component is about to start.<br> When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br> [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) does not contain parameters.<br>**Since**: 21   |
| NODE_SCROLL_EVENT_ON_DID_STOP_FLING | Defines the callback for the end of the scrolling animation of the scroll container component. Condition for triggering the event: The scrolling animation of the scroll container component ends.<br> When the event callback occurs, the union type in the [ArkUI_NodeEvent](capi-arkui-nativemodule-arkui-nodeevent.md) object is [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md).<br> [ArkUI_NodeComponentEvent](capi-arkui-nativemodule-arkui-nodecomponentevent.md) does not contain parameters.<br>**Since**: 21   |
...
>
> - Attributes such as NODE_BORDER_COLOR, NODE_TEXT_RADIAL_GRADIENT, and NODE_TEXT_LINEAR_GRADIENT in TextArea cannot enable the color inversion algorithm.
...
| Name| Description|
| -- | -- |
| uiContext | Pointer to the UI instance object.<br>  If the value is null, this function applies to the entire application process.|
| forceDark | Whether to use the color inversion capability. The value true indicates that the component uses the color inversion capability, and the value false indicates that the component does not use the color inversion capability.|
