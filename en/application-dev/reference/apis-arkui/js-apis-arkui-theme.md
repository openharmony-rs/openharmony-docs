...
| compForegroundPrimary         | [ResourceColor](arkui-ts/ts-types.md#resourcecolor) | No  | No  | Foreground color.<br>**Affected components**: [QRCode](./arkui-ts/ts-basic-components-qrcode.md)<br>**Atomic service API**: This API can be used in atomic services since API version 12.           |
