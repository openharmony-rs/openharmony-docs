...
Sets a custom theme as the default, application-level theme so that it is applied to components in the application. It is recommended that you use this API in the completion callback of windowStage.[loadContent](./arkts-apis-window-WindowStage.md#loadcontent9) during the **onWindowStageCreate** phase. For implementation details, see [Setting Custom Theme Colors for Application Components](../../ui/theme_skinning.md#setting-custom-theme-colors-for-application-components).
