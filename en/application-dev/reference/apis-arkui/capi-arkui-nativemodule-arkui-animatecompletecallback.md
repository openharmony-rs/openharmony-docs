...
<!-- md-trans-meta sourceCommit=4d06e6d604d64a9b64c2360f42cbd3fd13c9290b translatedAt=2026-09-18T11:21:39.099Z pushedAt=2026-09-20T07:38:30.758Z -->
...
| void\* userData                                                                  | Pointer to the user-defined data passed upon the animation playback completion callback. Ensure that **userData** is still valid when the animation playback completion callback is triggered to avoid undefined behavior caused by a dangling pointer. If this parameter is set to **NULL**, the callback function will not receive the **userData** parameter. |
