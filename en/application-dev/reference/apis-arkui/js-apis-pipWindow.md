...
| contentWidth        | number                                                                     | No | Yes| Width of the original content, in px. It is used to determine the aspect ratio of the PiP window. When a **PiPController** is created using **typeNode** (that is, the **contentNode** parameter is passed using [PiPWindow.create()](#pipwindowcreate12)), the default value is **1920** if this parameter is not specified. When a **PiPController** is created without using **typeNode** (that is, the **contentNode** parameter is not passed using [PiPWindow.create()](#pipwindowcreate)), the default value is the width of [XComponent](arkui-ts/ts-basic-components-xcomponent.md) if this parameter is not specified.<br>**Atomic service API**: This API can be used in atomic services since API version 12.                                                            |
| contentHeight       | number                                                           | No | Yes| Height of the original content, in px. It is used to determine the aspect ratio of the PiP window. When a **PiPController** is created using **typeNode** (that is, the **contentNode** parameter is passed using [PiPWindow.create()](#pipwindowcreate12)), the default value is **1080** if this parameter is not specified. When a **PiPController** is created without using **typeNode** (that is, the **contentNode** parameter is not passed using [PiPWindow.create()](#pipwindowcreate)), the default value is the height of [XComponent](arkui-ts/ts-basic-components-xcomponent.md) if this parameter is not specified.<br>**Atomic service API**: This API can be used in atomic services since API version 12.                                                            |
