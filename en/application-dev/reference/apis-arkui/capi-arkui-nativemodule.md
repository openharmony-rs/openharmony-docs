...
<!-- md-trans-meta sourceCommit=ebfe2f6580b6a20ff6c2028463724b35bb4af90c translatedAt=2026-09-22T09:30:44.499Z pushedAt=2026-09-23T08:11:34.882Z -->
...
Provides ArkUI animation callbacks for native-side implementations. For details, see [Animation Overview](../../ui/ndk-use-animation.md).
...
The preceding APIs are applicable to scenarios where ArkTS pages are integrated on the native side and input events, drag operations, gestures, animations, and UI nodes are processed and managed. They help you implement ArkUI page interaction and component tree management in native modules.
...
| [grid.h](capi-grid-h.md) | Defines the enumerations and APIs related to the **Grid** component. |
| [list.h](capi-list-h.md) | Defines the enumerations and APIs related to the **List** component. |
| [navigation_router.h](capi-navigation-router-h.md) | Defines the enumerations and APIs related to the **Navigation** or **Router** component. |
| [scroll.h](capi-scroll-h.md) | Defines the enumerations related to the **Scroll** component. |
| [swiper.h](capi-swiper-h.md) | Defines the enumerations and APIs related to the **Swiper** component. |
| [water_flow.h](capi-water-flow-h.md) | Defines the enumerations and APIs related to the **WaterFlow** component. |
...
| [native_interface.h](capi-native-interface-h.md) | Declares a unified entry for the **NativeModule** APIs. |
...
| [native_node_napi.h](capi-native-node-napi-h.md) | Declares the APIs used to convert FrameNodes on the ArkTS side into **ArkUI_NodeHandle**. |
| [native_type.h](capi-native-type-h.md) | Defines the common types for **NativeModule**. |
| [native_type_visual.h](capi-native-type-visual-h.md) | Defines the visual types for **NativeModule**. |
