...
| font-size | &lt;length&gt; | 30px | No| Font size.<br>|
| letter-spacing | &lt;length&gt; | 2px | No| Letter spacing for a text style.|
...
| width | &lt;length&gt;&nbsp;\|&nbsp;&lt;percentage&gt;<sup>5+</sup> | 0px | No| Component width.<br>Unit: px<br>If this attribute is not set, the default value **0** is used.|
| height | &lt;length&gt;&nbsp;\|&nbsp;&lt;percentage&gt;<sup>5+</sup> | 0px | No| Component height.<br>Unit: px<br>If this attribute is not set, the default value **0** is used.|
...
| line-height<sup>10+</sup> | number | 0px | No| Text line height.<br>Unit: px<br>If this attribute is not set, the text line height is adaptive.|
