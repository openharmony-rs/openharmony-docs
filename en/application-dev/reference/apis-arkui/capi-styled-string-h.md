...
Obtains the glyph index range generated by the specified character index range and the actual character index range. For example, the glyph index range of a Chinese character is [0, 1] in Chinese text, and a Chinese character occupies three characters. Therefore, the corresponding character index range is [0, 3]. If the specified character index range is [0, 1], but one third of a Chinese character cannot be parsed, the actual character index range is [0, 3].
...
Obtains the character index range generated by the specified glyph index range and the actual glyph index range. For example, the glyph index range is [0, 7] in Chinese text, and a Chinese character occupies three characters. Therefore, the corresponding character index range is [0, 11]. If the specified index range is [0, 11], but there are only seven glyphs, the actual glyph index range is [0, 7].
