...
<!-- md-trans-meta sourceCommit=9fc8de61c9856085ad7066dda1e30828589acb6a translatedAt=2026-06-09T03:15:36.953Z pushedAt=2026-06-09T08:56:42.374Z -->
...
- Events are bound to components. When a component meets the event triggering condition, the corresponding event callback in the JavaScript is executed to implement the interaction between the UI and the JavaScript logic layer of the page.
...
>  **NOTE**
>  Events not listed in the preceding table do not support bubbling, such as the [change event](js-components-basic-input.md#events). For details, see the description of the specific component.
