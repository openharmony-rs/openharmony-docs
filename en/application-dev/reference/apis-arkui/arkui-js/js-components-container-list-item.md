...
<!-- md-trans-meta sourceCommit=b9b716c1423f6952b7169df5eb4de15f02019de4 translatedAt=2026-06-10T02:06:42.719Z pushedAt=2026-06-10T02:28:25.492Z -->
...
| -------- | -------- | -------- |
| sticky | {&nbsp;state:&nbsp;boolean&nbsp;} | Callback event for a sticky component.<br/>**state:&nbsp;false**: The current item is not in the sticky state.<br/>**state:&nbsp;true**: The current item is in the sticky state.<br/>Note: This event can be registered only when the item is configured with the **sticky** attribute. |
