...
>
> - You should first call [canIUse()](../common/js-apis-syscap.md#caniuse) to check whether the current device supports SystemCapability.Window.SessionManager and corresponding APIs.
>
...
> **NOTE**
>
> Before calling this API, you are advised to load the page by using [loadContent](../apis-arkui/arkts-apis-window-WindowStage.md#loadcontent9) or [setUIContent](arkts-apis-window-Window.md#setuicontent9-1). If the application's main window has not finished page loading and you call this API directly, the splash screen will remain displayed. If the system window, application child window, modal window, or global floating window has not finished page loading and you call this API directly, the window will be brought to the foreground but will not be visible.
...
> **NOTE**
>
> Before calling this API, you are advised to load the page by using [loadContent](../apis-arkui/arkts-apis-window-WindowStage.md#loadcontent9) or [setUIContent](arkts-apis-window-Window.md#setuicontent9-1). If the application's main window has not finished page loading and you call this API directly, the splash screen will remain displayed. If the system window, application child window, or global floating window has not finished page loading and you call this API directly, the window will be brought to the foreground but will not be visible.
...
| Name| Type| Mandatory| Description|
| -------- | ------------------------- | -- | ------------------------ |
| width    | number                    | Yes| New width of the window, in px. The value must be an integer. If a floating-point number is passed in, the value is rounded down. A negative value is invalid, and error code 401 will be reported.|
| height   | number                    | Yes| New height of the window, in px. The value must be an integer. If a floating-point number is passed in, the value is rounded down. A negative value is invalid, and error code 401 will be reported.|
| callback | AsyncCallback&lt;void&gt; | Yes| Callback used to return the result.               |
...
- In the floating window mode ([window.WindowStatusType.FLOATING](arkts-apis-window-e.md#windowstatustype11)) under the [freeform window](../../windowmanager/window-terminology.md#freeform-window) state, only the avoid area of the fixed soft keyboard type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_KEYBOARD**) is available.
- In the floating window mode of the main window in the non-freeform window state, only the avoid area of the system bar type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_SYSTEM**) is available.
- In other scenarios, the main window can obtain the calculated avoid area through this API only when it is not in the floating window mode or the device type is phone or tablet. Otherwise, the obtained avoid area is empty.
- In the non-freeform window state or non-floating window mode, the child window can obtain the calculated avoid area through this API only when its position and size are the same as those of the main window. Otherwise, the obtained avoid area is empty.

Global floating window, modal window, or system window:
- This API can be called to obtain the avoid area only after [setSystemAvoidAreaEnabled](#setsystemavoidareaenabled18) is called to enable avoid area obtaining. Otherwise, the obtained avoid area is empty.
...
Main window/Child window:
- When the main window is in the floating window mode (window.WindowStatusType.FLOATING](arkts-apis-window-e.md#windowstatustype11)) under a non-[freeform window](../../windowmanager/window-terminology.md#freeform-window) state, only the avoid area of the system bar type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_SYSTEM**) is available.
- In other scenarios, the main window can obtain the calculated avoid area through this API only when it is not in the floating window mode or the device type is phone or tablet. Otherwise, the obtained avoid area is empty.
- In the non-freeform window state or non-floating window mode, the child window can obtain the calculated avoid area through this API only when its position and size are the same as those of the main window. Otherwise, the obtained avoid area is empty.

Global floating window, modal window, or system window:
- This API can be called to obtain the calculated avoid area only after [setSystemAvoidAreaEnabled](#setsystemavoidareaenabled18) is called to enable avoid area obtaining. Otherwise, the obtained avoid area is empty.
...
Since OpenHarmony 5.0.2, this API neither takes effect nor returns an error on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. When the device exits the freeform window state, this API takes effect. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API can be properly called.
...
Since OpenHarmony 5.0.2, this API neither takes effect nor returns an error on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API can be properly called.
...
**Device behavior differences**: Before <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on 2-in-1 devices but returns error code 801 on other devices.

Since <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on 2-in-1 devices and on other devices in desktop mode. In other scenarios, this API neither takes effect nor returns an error.
...
The return value does not indicate that the status bar and <!--RP15-->three-button navigation bar<!--RP15End--> are shown or hidden. The setting does not take effect when the main window is in non-full-screen or non-maximized mode (such as floating window or split-screen mode). It takes effect once the main window enters full-screen or maximized mode.
...
Since OpenHarmony 5.0.0, this API neither takes effect nor returns an error on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API can be properly called.
...
Main window/Child window:
- When the callback is triggered in the floating window mode ([window.WindowStatusType.FLOATING](arkts-apis-window-e.md#windowstatustype11)) under the [freeform window](../../windowmanager/window-terminology.md#freeform-window) state, only the avoid area of the fixed soft keyboard type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_KEYBOARD**) is available.
- When the callback is triggered in the floating window mode of the main window in the non-freeform window state, only the avoid area of the system bar type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_SYSTEM**) is available.
- When the callback is triggered in the main window in other scenarios, the calculated avoid area is returned only when the window is not in the floating window mode or the device type is phone or tablet. Otherwise, an empty avoid area is returned.
- When the callback is triggered in the child window in the non-freeform window state or non-floating window mode, the calculated avoid area of the child window is returned only when the position and size of the child window are the same as those of the main window. Otherwise, an empty avoid area is returned.

Global floating window, modal window, or system window:
- The calculated avoid area is returned only when the callback is triggered after [setSystemAvoidAreaEnabled](#setsystemavoidareaenabled18) is called to enable avoid area obtaining. Otherwise, an empty avoid area is returned.
...
| callback | Callback&lt;[AvoidAreaOptions](arkts-apis-window-i.md#avoidareaoptions12)&gt; | Yes  | Callback used to return the result. return the current avoid area and avoid area type.|
...
For details about how to set the soft keyboard to the fixed or floating state, see [changeFlag](../apis-ime-kit/js-apis-inputmethodengine.md#changeflag10).
...
Unsubscribes from the event indicating that the soft keyboard in the fixed state is about to show. For details about how to set the input method panel to the fixed or floating state, see [changeFlag](../apis-ime-kit/js-apis-inputmethodengine.md#changeflag10).
...
Unsubscribes from the event indicating that the show animation of the soft keyboard in the fixed state is completed, For details about how to set the input method panel to the fixed or floating state, see [changeFlag](../apis-ime-kit/js-apis-inputmethodengine.md#changeflag10).
...
Unsubscribes from the event indicating that the hide animation of the soft keyboard in the fixed state is completed, For details about how to switch the input method panel from the fixed state to the floating state, see [changeFlag](../apis-ime-kit/js-apis-inputmethodengine.md#changeflag10).
...
Subscribes to window visibility status change events. The visibility returned by this API may be different from that perceived by human eyes in the following scenarios:
- If the shadow area of a non-main window is blocked, the window will be considered as partially visible even though it is completely visible to human eyes. (You can use [setWindowShadowEnabled](arkts-apis-window-Window.md#setwindowshadowenabled20) and [setWindowShadowRadius](arkts-apis-window-Window.md#setwindowshadowradius17) to set whether to display the shadow area and the shadow radius, respectively.)
- If the upper-layer window has a transparency effect (any degree of transparency other than fully opaque), the lower-layer window will not be blocked and is visible.
- When a window is set with an irregularly shaped window mask through the [setWindowMask](arkts-apis-window-Window.md#setwindowmask12) API, the mask does not affect the calculation of the window's visibility state. The window remains visible. Even if the mask is fully set to 0, the window's visibility state is still calculated based on its original rectangular size.
- Most windows with animation effects do not block lower-layer windows. For example, when you drag a floating window on a mobile phone, the lower-layer window returned remains visible.
...
| callback | Callback&lt;[OcclusionState](arkts-apis-window-e.md#occlusionstate22)&gt; | Yes  | Callback invoked when the window visibility status changes. For details, see [Window Visibility Status](arkts-apis-window-e.md#occlusionstate22).|
...
Before <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API returns error code 801.
...
| -------- | ------------------------------ | ---- | -------------------------------------------------------- |
| type     | string                         | Yes  | Event type. The value is fixed at **'windowWillClose'**, indicating the window close event.|
| callback | Callback&lt;void, Promise&lt;boolean&gt;&gt; | No  | Callback invoked when the close button in the top-right corner of the window is clicked. It does not return any parameter. The internal logic of the callback function requires a return value of the Promise&lt;boolean&gt; type. In the returned Promise function, **resolve(true)** means not to close the window, and **resolve(false)** or **reject** means to continue to close the window.|
...
- Since <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on 2-in-1 devices, and on tablets when the [free window](../../windowmanager/window-terminology.md#freeform-window) or [desktop mode](../../windowmanager/window-terminology.md#desktop-mode) is enabled. In other scenarios, this API returns error code 801.
...
When the setting is valid, it affects only the physical screen where the window is displayed. It does not apply to virtual screens (for example, casting/mirroring screens).
...
Since API version 22, if a virtual screen is created by calling [createVirtualScreen](js-apis-display.md#displaycreatevirtualscreen16) with **supportsFocus** set to **false**, windows on this virtual screen cannot call this API to change their focusability. Attempting to do so will result in error code 1300002.
...
- Hides the caller window if it is a child window or a global floating window. The child window or floating window cannot be restored in the dock. You can call [showWindow()](#showwindow9) to restore it.
...
**Device behavior differences**: This API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API neither takes effect nor returns an error.
...
Sets the size limits for the current window. This API returns the result using a promise asynchronously.
...
Before <!--RP2-->OpenHarmony 6.0<!--RP2End-->, this API can be called properly on 2-in-1 devices but returns error code 801 on other devices.

Since <!--RP2-->OpenHarmony 6.0<!--RP2End-->, this API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API returns error code 801.
...
**Device behavior differences**: This API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, this API neither takes effect nor returns an error. Once the device enters the freeform window mode, this API takes effect. On a device that does not support freeform windows, this API neither takes effect nor returns an error.
...
Before OpenHarmony 5.1.0, this API can be called properly on 2-in-1 devices but returns error code 801 on other devices.

Since OpenHarmony 5.1.0, this API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API returns error code 801.
...
| Type                                 | Description                                                        |
| ------------------------------------- | ------------------------------------------------------------ |
| [DecorButtonStyle](arkts-apis-window-i.md#decorbuttonstyle14) | Button style on the decoration bar of the current window. The decoration button area is located in the top-right corner of the window.|
...
**Device behavior differences**: This API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window). On a device that does not support freeform windows, this API neither takes effect nor returns an error.
...
Creates a child window under the main window, another child window, or global floating window. This API uses a promise to return the result.
...
Sets a new parent window for the current child window. The new parent window can be a main window, another child window, or a global floating window in the same process. This API uses a promise to return the result.
...
Before OpenHarmony 5.1.0, this API can be called properly on 2-in-1 devices and tablets, but returns error code 801 on other devices.

Since OpenHarmony 5.1.0, this API can be called properly on phones, tablets, and 2-in-1 devices, but returns error code 801 on other devices.
...
Before <!--RP16-->OpenHarmony 6.0<!--RP16End-->, this API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state. On a device that supports freeform windows but is not in the freeform window state, or on a device that does not support freeform windows, this API returns error code 801.

Since <!--RP16-->OpenHarmony 6.0<!--RP16End-->, this API can be called properly on phones, tablets, and 2-in-1 devices, but returns error code 801 on other devices.
...
Before <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on a device that supports [freeform windows](../../windowmanager/window-terminology.md#freeform-window) and is in the freeform window state (except for phone, on which calling this API returns error code 801). On a device that supports freeform windows but is not in the freeform window state, this API neither takes effect nor returns an error. On a device that does not support freeform windows, this API returns error code 801.

Since <!--RP1-->OpenHarmony 6.1<!--RP1End-->, this API can be called properly on phones, tablets, and 2-in-1 devices without reporting errors. (If the device is in the [freeform window](../../windowmanager/window-terminology.md#freeform-window) state, this API takes effect. If the device is not in the freeform window state, this API neither takes effect nor returns an error. This API will take effect once the device enters the freeform window state.) On other devices, this API returns error code 801.
...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 12. You are advised to use promise-based [setWindowSystemBarProperties()](#setwindowsystembarproperties9) instead.
...
The return value does not indicate that the status bar and <!--RP15-->three-button navigation bar<!--RP15End--> are shown or hidden. This API does not take effect when it is called by a child window. The setting does not take effect in non-full-screen mode (such as floating window or split-screen mode).

> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 12. You are advised to use promise-based [setWindowSystemBarEnable()](#setwindowsystembarenable9) instead.
...
> **NOTE**
>
> This API is supported since API version 9 and deprecated since API version 12. You are advised to use promise-based [setWindowLayoutFullScreen()](#setwindowlayoutfullscreen9) instead.
...
Main window/Child window:
- In the floating window mode (**window.WindowStatusType.FLOATING**) under the [freeform window](../../windowmanager/window-terminology.md#freeform-window) state, only the avoid area of the fixed soft keyboard type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_KEYBOARD**) is available.
- In the floating window mode of the main window in the non-freeform window state, only the avoid area of the system bar type ([AvoidAreaType](arkts-apis-window-e.md#avoidareatype7) is **TYPE_SYSTEM**) is available.
- In other scenarios, the main window can obtain the calculated avoid area through this API only when it is not in the floating window mode or the device type is phone or tablet. Otherwise, the obtained avoid area is empty.
- In the non-freeform window state or non-floating window mode, the child window can obtain the calculated avoid area through this API only when its position and size are the same as those of the main window. Otherwise, the obtained avoid area is empty.
...
| -------- |-----------------------------------------------| ---- | ------------------------------------------------------------ |
| type     | [AvoidAreaType](arkts-apis-window-e.md#avoidareatype7)              | Yes  | Type of the avoid area.|
| callback | AsyncCallback&lt;[AvoidArea](arkts-apis-window-i.md#avoidarea7)&gt; | Yes  | Callback used to return the result. The window content avoid area is returned.                            |
...
| Type                                     | Description                               |
|-----------------------------------------| ----------------------------------- |
| Promise&lt;[AvoidArea](arkts-apis-window-i.md#avoidarea7)&gt; | Promise used to return the window content avoid area.|
...
| callback | Callback&lt;[AvoidArea](arkts-apis-window-i.md#avoidarea7)&gt; | Yes  | Callback used to return the result. return the current avoid area.                            |
