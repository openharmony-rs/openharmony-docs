...
If **setWindowLimits** has not been called, you can call [getWindowLimits](#getwindowlimits11) to obtain the system size limits.
...
| :----------- | :---------------------------- | :--- | :----------------------------- |
| windowLimits | [WindowLimits](arkts-apis-window-i.md#windowlimits11) | Yes  | Target size limits, in px.|
| isForcible | boolean | Yes  | Whether to forcibly set the window size limits. <br>If this parameter is set to **true**, the minimum window width and height are the smaller value between the system constraints and 40 vp, and the maximum window width and height are subject to system constraints. <br>If this parameter is set to **false**, both the minimum and maximum values for window width and height are subject to system constraints.|
