...
> **NOTE**
>
> - For non-2-in-1 devices: When the window's brightness setting is active, system brightness controls (Control Panel or shortcut keys) are disabled.
> - For 2-in-1 devices:
