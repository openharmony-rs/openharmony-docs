...
| struct [OH_PixelmapNative](_ark_u_i___native_module.md#oh_pixelmapnative) | Defines an **OH_PixelmapNative** object on the native side using Image Kit. | 
