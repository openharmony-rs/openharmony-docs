...
| disabled | boolean | false | No| Whether the component is disabled. If it is disabled, it cannot respond to user interaction. The value **true** indicates that the component is disabled, and **false** indicates the oppsite.|
...
| if | boolean | - | Whether the element is added or removed. The value **true** indicates that the element is added. The value **false** indicates that the element is removed.|
| show | boolean | - | Whether the element is displayed or hidden. The value **true** indicates that the element is displayed. The value **false** indicates that the element is hidden.|
