...
| letter-spacing | &lt;length&gt; | 0px | No| Letter spacing for a text style.|
...
<div class="container">
    <text class="line_height">
        <span>This is the text with line height set.</span>
    </text>
        <text class="letter_spacing">This is the text with letter spacing set.</text>
    ...
    <text class="text_over_flow">This is the text too long to show in full.</text>
</div>
```
