...
The **\<span>** child component of [\<text>](js-service-widget-basic-text.md) is used as a text modifier.
...
For details, see [Example](js-service-widget-basic-text.md#example).
