...
| onDidDisappear<sup>19+</sup> | Callback&lt;void&gt; | No| Yes| Event callback after the dialog box disappears.<br>**NOTE**<br>The normal sequence is as follows: onWillAppear >> onDidAppear >> onWillDisappear >> onDidDisappear.<br>**Atomic service API**: This API can be used in atomic services since API version 19.|
