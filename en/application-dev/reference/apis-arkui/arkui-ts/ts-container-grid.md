...
### Example 17: Dragging a GridItem by Dragging an Event

This example demonstrates how to drag a GridItem to the edge of the grid and automatically scroll the grid through the [dragging event](./ts-universal-events-drag-drop.md).
For details about **GridDataSource** and the complete code, see [Example 2: Implementing a Scrollable Grid with Scroll Events](#example-2-implementing-a-scrollable-grid-with-scroll-events).
