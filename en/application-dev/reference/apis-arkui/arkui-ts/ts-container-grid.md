...
Triggered when a grid item starts to be dragged. A return value **void** indicates that dragging is not allowed.
...
struct GridExample {
  ...
  build() {
    Column({ space: 5 }) {
      ...
      Text('Use of GridLayoutOptions: onGetRectByIndex').fontColor(0x000000).fontSize(14).width('90%')
