...
> **NOTE**
> 
> This API is deprecated since API version 18. You are advised to use [showDatePickerDialog](../js-apis-arkui-UIContext.md#showdatepickerdialog) in [UIContext](../js-apis-arkui-UIContext.md) instead.
>
> Since API version 10, you can use the [showDatePickerDialog](../js-apis-arkui-UIContext.md#showdatepickerdialog) API in [UIContext](../js-apis-arkui-UIContext.md), which ensures that the date picker dialog box is shown in the intended UI instance.
...
>  **NOTE**
>
> For clarity in UI execution context, you are advised to use the [showDatePickerDialog](../js-apis-arkui-UIContext.md#showdatepickerdialog) API in [UIContext](../js-apis-arkui-UIContext.md).
