...
<!-- md-trans-meta sourceCommit=89346475f8d3330eb3cf2dc1d1fe16bf74dc4998 translatedAt=2026-09-01T12:05:10.780Z -->
...
| ------ | ------------------------------------------ | ---- | ---- | -------- |
| width  | [Length](ts-types.md#length)               | No   | Yes | Caret size. Percentage is not supported.<br>Default value: '2vp' |
| color  | [ResourceColor](ts-types.md#resourcecolor) | No   | Yes   | Caret color.<br>Default value: '#ff007dff', which indicates blue. |
...
| Type                                         | Description       |
| --------------------------------------------- | ----------- |
| [PositionWithAffinity](#positionwithaffinity12) | Character position information. When [LayoutManager](#layoutmanager12) is not bound to a component, an invalid value is returned. |
...
| Name    | Type   | Mandatory   | Description                 |
| ------ | ------ | ---- | -------------------- |
| x | number | Yes    | X coordinate relative to the component.<br>Unit: [px](ts-pixel-units.md#basic-pixel-units) |
| y | number | Yes    | Y coordinate relative to the component.<br>Unit: [px](ts-pixel-units.md#basic-pixel-units) |

**Return value**

| Type                                          | Description        |
| --------------------------------------------- | ----------- |
| [PositionWithAffinity](#positionwithaffinity12) \| undefined | Character position information. When [LayoutManager](#layoutmanager12) is not bound to the component, this API returns undefined.|
...
Compared with [getCharacterPositionAtCoordinate](#getcharacterpositionatcoordinate24), this API supports specifying the encoding type (UTF-8 or UTF-16) used for the character position through the encoding parameter.
...
| x | number | Yes | Horizontal coordinate relative to the component.<br>Unit: [px](ts-pixel-units.md#basic-pixel-units) |
| y | number | Yes | Vertical coordinate relative to the component.<br>Unit: [px](ts-pixel-units.md#basic-pixel-units) |
| encoding | [TextEncoding](#textencoding) | No | Encoding type used by the character position. In UTF-8 encoding, the character position is in bytes; in UTF-16 encoding, the character position is in UTF-16 code units.<br>Default value: TextEncoding.TEXT_ENCODING_UTF8 |
...
Compared with [getGlyphRangeForCharacterRange](#getglyphrangeforcharacterrange24), this interface supports specifying the encoding type (UTF-8 or UTF-16) used for the character range through the encoding parameter.
...
| ------ | ------ | ---- | -------------------- |
| charRange | [TextRange](#textrange12) | Yes    | Character range of the text.|
| encoding | [TextEncoding](#textencoding) | No | Encoding type used by the character range. In UTF-8 encoding, the character index is in bytes; in UTF-16 encoding, the character index is in UTF-16 code units.<br>Default value: TextEncoding.TEXT_ENCODING_UTF8 |

**Return value**

| Type                                         | Description       |
| --------------------------------------------- | ----------- |
|  Array&lt;[TextRange](#textrange12)&gt; \| undefined | The array contains two elements. The first element is the glyph range, and the second element is the actual character range.<br>When the returned range is an abnormal value, the elements in the range are -1.<br>When [LayoutManager](#layoutmanager12) is not bound to the component, this interface will return undefined.|
...
| Type                                          | Description        |
| --------------------------------------------- | ----------- |
| Array&lt;[TextRange](#textrange12)&gt; \| undefined | The array contains two elements: the first element is the character range, and the second element is the actual glyph range.<br>When the returned range is an abnormal value, the elements in the range are -1.<br>When the [LayoutManager](#layoutmanager12) is not bound to a component, this API returns undefined.|
...
Compared with [getCharacterRangeForGlyphRange](#getcharacterrangeforglyphrange24), this API supports specifying the encoding type (UTF-8 or UTF-16) used for the character range through the **encoding** parameter.
...
| ------ | ------ | ---- | -------------------- |
| glyphRange | [TextRange](#textrange12) | Yes    | Glyph range of the text.|
| encoding | [TextEncoding](#textencoding) | No | Encoding type used for the character range. With UTF-8 encoding, the character index is in bytes; with UTF-16 encoding, the character index is in UTF-16 code units.<br>Default value: TextEncoding.TEXT_ENCODING_UTF8 |

**Return value**

| Type                                         | Description       |
| --------------------------------------------- | ----------- |
| Array&lt;[TextRange](#textrange12)&gt; \| undefined | The array contains two elements. The first element is the character range, and the second element is the actual glyph range.<br>When the returned range is an abnormal value, the elements in the range are -1.<br>When [LayoutManager](#layoutmanager12) is not bound to a component, this interface returns undefined.|
...
| Type                                      | Description      |
| ---------------------------------------- | -------- |
| [LineMetrics](#linemetrics12) | Line information, text style information, and font attribute information.<br>When the line number is less than 0 or exceeds the actual number of lines, an invalid value is returned. When [LayoutManager](#layoutmanager12) is not bound to the component, an invalid value is returned. |
...
| Type                        | Description       |
| --------------------------- | ----------- |
| Array\<[TextBox](#textbox14)\> | Array of rectangular areas. When [LayoutManager](#layoutmanager12) is not bound to a component, an empty array is returned.|
...
| Name     | Type                  | Read-Only| Optional| Description                     |
| --------- | --------------------- | ---- | ---- | ------------------------ |
| position  | number                | No  | No  | Index of the glyph or character relative to the component. The value is an integer. |
| affinity  | [Affinity](#affinity12) | No   | No   | Position affinity, which indicates the tendency of the caret position at glyph boundaries. For details about the values, see the Affinity enum. |
...
| Name          | Type             | Read-Only  | Optional | Description    |
| ------------ |---------------------| ---- | ---- | ------ |
| CUT  | [TextMenuItemId](#textmenuitemid12) |  Yes  |  No | Default cut, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| COPY  | [TextMenuItemId](#textmenuitemid12) |  Yes  |  No  | Default copy, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| PASTE | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Default paste, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| SELECT_ALL   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Default select all, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| COLLABORATION_SERVICE   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Collaboration service, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| CAMERA_INPUT   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No   | Camera input, a first-level menu item.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
| AI_WRITER<sup>13+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | <!--RP1--><!--RP1End-->Polishes, summarizes, and formats the selected text, a first-level menu item. This menu item depends on the large model capability; otherwise, it does not take effect.<br>**Atomic service API:** This API can be used in atomic services since API version 13. |
| TRANSLATE<sup>15+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Translation, a first-level menu item. Provides translation service for the selected text.<br>**Atomic service API:** This API can be used in atomic services since API version 15. |
| SHARE<sup>18+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Share, a first-level menu item. Provides share service for the selected text and opens the share window to share the selected text content.<br>**Atomic service API:** This API can be used in atomic services since API version 18. |
| SEARCH<sup>18+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Search, a first-level menu item. Provides search service for the selected text and opens the browser to search the selected text content.<br>**Atomic service API:** This API can be used in atomic services since API version 18. |
| url<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Open link, a first-level menu item. Provides a jump service for the selected URL and opens the browser to search or the application page.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| email<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | New email, a first-level menu item. Provides a jump service for the selected email address and opens the email application.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| phoneNumber<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Call, a first-level menu item. Provides a jump service for the selected phone number and opens the dialing page.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| address<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Navigate, a first-level menu item. Provides a jump service for the selected address and opens the map application.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| dateTime<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | New schedule, a first-level menu item. Provides a jump service for the selected date and time and opens the new schedule page.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| askAI<sup>20+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | <!--RP2--><!--RP2End-->Provides AI query capability for the selected text, a first-level menu item. This menu item depends on the large model capability; otherwise, it does not take effect.<br>**Atomic service API:** This API can be used in atomic services since API version 20. |
| autoFill<sup>23+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Auto fill, a first-level menu item. Tapping it expands the second-level menu item "Password vault". It is supported only by [Search](ts-basic-components-search.md), [TextInput](ts-basic-components-textinput.md), [TextArea](ts-basic-components-textarea.md), or [RichEditor](ts-basic-components-richeditor.md).<br>**Atomic service API:** This API can be used in atomic services since API version 23. |
| passwordVault<sup>23+</sup>   | [TextMenuItemId](#textmenuitemid12)   | Yes    | No    | Password vault, a second-level menu item. Tapping this menu item opens the password vault application, which provides the capability of auto-filling account and password. It is supported only by [Search](ts-basic-components-search.md), [TextInput](ts-basic-components-textinput.md), [TextArea](ts-basic-components-textarea.md), or [RichEditor](ts-basic-components-richeditor.md).<br>**Atomic service API:** This API can be used in atomic services since API version 23.<br>**Model constraint:** This API can be used only in the stage model. |
### of
...
| Name | Type                             | Mandatory| Description                                                        |
| ------- | --------------------------------- | ---- | ------------------------------------------------------------ |
| id | [ResourceStr](ts-types.md#resourcestr) | Yes | Menu item identifier, used to create a TextMenuItemId object to identify the menu option. |

**Return value**

| Type             |       Description      |
| ------- | --------------------------------- |
| [TextMenuItemId](#textmenuitemid12) | Menu item identifier object created based on the passed-in ID, used to identify a menu option. |
...
| Name | Type                             | Mandatory| Description                                                        |
| ------- | --------------------------------- | ---- | ------------------------------------------------------------ |
| id | [TextMenuItemId](#textmenuitemid12) | Yes | TextMenuItemId object to compare. |
...
| Name | Type                             | Mandatory| Description  |
| ------- | --------------------------------- | ---- | --------------------------------- |
| menuItems | Array<[TextMenuItem](#textmenuitem12)> | Yes | Menu items to be displayed.<br>**Note:** <br>Modifications to the name, icon, and shortcut key hint of the default menu items do not take effect. |
...
| Name | Type                             | Mandatory| Description  |
| ------- | --------------------------------- | ---- | --------------------------------- |
| menuItem | [TextMenuItem](#textmenuitem12) | Yes | Menu item.<br>**Note:** <br>Since API version 23, for a first-level menu item that supports an expandable second-level menu, such as auto-fill, only the system default logic is executed, and user-defined logic is not executed. |
...
| Name | Value | Description |
| ------- | ---- | ------------------- |
| NONE | 0 | Disables incremental update and uses full layout rendering. |
| PARAGRAPH_CACHE | 1 | Enables incremental update and uses paragraph-level cache. This policy takes effect only when the styled string object bound to the text remains unchanged. If the styled string object changes, the cache cannot be hit. |
...
| Name   | Type                                                   | Read-Only| Optional| Description                                                   |
| ------- | ----------------------------------------------------------- | ---- | ---- | ------------------------------------------------------------ |
| deleteOffset  | number | No   | No | Position index of the value to delete, starting from 0. |
...
| Name| Type | Read-Only| Optional| Description |
| ------ | -------- | ---- | ---- | ------------------------------------------- |
| types   | [TextDataDetectorType](#textdatadetectortype11)[] | No | No  | Sets the entity types for text recognition. When **types** is set to **null** or **[]**, all types of entities are recognized; otherwise, only the specified types of entities are recognized.<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
...
| decoration<sup>12+</sup>  | [DecorationStyleInterface](ts-universal-styled-string.md#decorationstyleinterface)| No | Yes   | Sets the decoration line style of the entity after text recognition succeeds.<br>Default value:<br>{<br>&nbsp;type:&nbsp;TextDecorationType.Underline,<br>&nbsp;color:&nbsp;the same as the entity color,<br>&nbsp;style:&nbsp;TextDecorationStyle.SOLID&nbsp;<br>}<br>**Atomic service API:** This API can be used in atomic services since API version 12. |
...
| Name    | Type                                            | Read-Only| Optional| Description                                                    |
| -------- | ------------------------------------------------ | ---- | ---- | -------------------------------------------------------- |
| offset | number | No | No | Start index of the preview text content, starting from 0. |
...
| Name    | Type                                            | Read-Only| Optional| Description                                                    |
| -------- | ------------------------------------------------ | ---- | ---- | -------------------------------------------------------- |
| fontWeightConfigs | [FontWeightConfigs](#fontweightconfigs24) | No | Yes | Font weight configuration. The default value inherits [FontWeightConfigs](#fontweightconfigs24).<br>**Model constraint:** This interface can only be used in the Stage model. |
...
| Name| Type| Read-Only| Optional| Description|
| -- | -- | -- | -- | -- |
| onWillChange | Callback<[StyledStringChangeValue](#styledstringchangevalue12), boolean> | No | Yes | Callback invoked before the text content changes.<br>Default value: null, which means no callback is triggered.<br>The value true means that the text content change is allowed, and false means that the text content change is blocked. |
| onDidChange | [OnDidChangeCallback](#ondidchangecallback12) | No | Yes | Callback invoked after the text content change is complete.<br>Default value: null, which means no callback is triggered. |
...
| previewText | [StyledString](ts-universal-styled-string.md#styledstring) | No | Yes | Styled string of the preview content.<br>Default value: null, indicating no preview content.<br> This property is used to represent the temporary uncommitted input content in voice input, camera input, and input method preview text scenarios.|
...
| Name| Value| Description|
| ------- | ---- | ------------------- |
| NONE | 0 | Default state, no automatic case conversion is performed. |
...
| Type                                      | Description     |
| ---------------------------------------- | ------- |
| [LayoutManager](#layoutmanager12) | Layout manager object used to obtain text layout information, such as the number of lines, line metrics, and glyph positions. |
...
| Name  | Type  | Mandatory  | Description               |
| ----- | ------ | ---- | ------------------- |
| styledString | [StyledString](ts-universal-styled-string.md#styledstring) | Yes | Styled string.<br>**Note:** <br>The subclass [MutableStyledString](ts-universal-styled-string.md#mutablestyledstring) of StyledString can also be used as the input parameter value. |
...
| thicknessScale<sup>20+</sup> | number | No   | Yes   | Scale ratio of the decoration line thickness.<br>Default value: 1.0<br>Value range: [0, +∞) <br>**Note:** Negative values are processed as the default value.<br> **Atomic service API:** This API can be used in atomic services since API version 20. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[LineMetrics](../../apis-arkgraphics2d/js-apis-graphics-text.md#linemetrics) | Describes the measurement information of a single line in the text layout. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[Affinity](../../apis-arkgraphics2d/js-apis-graphics-text.md#affinity) | Enumerates the affinity modes. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[TextBox](../../apis-arkgraphics2d/js-apis-graphics-text.md#textbox) | Describes the rectangle that contains the text. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[Paragraph](../../apis-arkgraphics2d/js-apis-graphics-text.md#paragraph) | Implements a carrier that stores the text content and style. It supports operations such as layout and drawing. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[RectHeightStyle](../../apis-arkgraphics2d/js-apis-graphics-text.md#rectheightstyle) | Enumerates the rectangle height styles. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.graphics.text').default.[RectWidthStyle](../../apis-arkgraphics2d/js-apis-graphics-text.md#rectwidthstyle) | Enumerates the rectangle width styles. |
...
| previewText  | [PreviewText](#previewtext12) | No   | Yes   | Preview text content information.<br>Default value: undefined, indicating no preview text content. |
...
| Name | Type  | Mandatory  | Description |
| ------- | ------ | ---- | ----- |
| options | [LinearGradientOptions](../arkui-ts/ts-universal-attributes-gradient-color.md#lineargradientoptions18) | Yes | Options for displaying a linear gradient.<br>The default value of direction in [LinearGradientOptions](../arkui-ts/ts-universal-attributes-gradient-color.md#lineargradientoptions18) is processed as NONE in [GradientDirection](ts-appendix-enums.md#gradientdirection). |
...
| Name| Type| Read-Only| Optional| Description|
| -------- | -------- | -------- | -------- | -------- |
| color | [ResourceColor](ts-types.md#resourcecolor)  | No | Yes | Sets the background color of the text during dragging.<br>Default value: follows the theme. With the default theme, white is displayed in light mode and black in dark mode. |
...
| Name                   | Value  | Description                  |
| --------------------- | -------  | ------------------- |
| MITER_JOIN            | 0  | Sharp corner. |
| ROUND_JOIN            | 1  | Rounded corner. |
...
| Type                             | Description  |
| --------------------------------- | --------------------------------- |
| import('../api/@ohos.inputMethod.ExtraConfig').[InputMethodExtraConfig](../../apis-ime-kit/js-apis-inputmethod-extraconfig.md#inputmethodextraconfig) | Represents the extension configuration of an input method. |
...
**Device behavior differences:** The actual device types supported by this API (phone, PC/2-in-1 device, tablet, TV, and car) are fewer than those supported by its system capability (phone, PC/2-in-1 device, tablet, TV, car, and wearable). Due to hardware capability restrictions, calling this API on wearables results in a runtime exception indicating that the API is undefined.
...
| Name  | Type                              | Mandatory | Description   |
| ------- | --------------------------------- | ---- | --------------------------------- |
| menuItems | Array<[TextMenuItem](#textmenuitem12)> | Yes   | Menu items currently displayed.<br/>**NOTE** <br/>Modifications to the name, icon, and shortcut prompt of the default menu items do not take effect. |
