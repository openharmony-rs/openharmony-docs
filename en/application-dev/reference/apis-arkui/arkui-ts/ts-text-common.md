...
Triggered before the menu is displayed after the text selection area changes. Menu data can be configured within this callback. The input parameters and return values contain only level-1 menu items.
