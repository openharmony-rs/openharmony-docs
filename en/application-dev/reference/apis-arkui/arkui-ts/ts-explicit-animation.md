...
| ---------- | ---------------|---------- | -------------- | ---------------------------------------- |
| duration   | number         |  No | Yes| Animation duration, in ms.<br>Default value: **1000**<br>Note: 1. The maximum animation duration for an ArkTS card is 1,000 ms; values exceeding this limit are clamped to 1,000 ms.<br>2. To stop the animation of a property, change the property value in an animation closure with a duration of 0.<br>3. Values less than 0 are clamped to **0**.<br>4. Floating-point values are floored to integers. For example, if the value set is 1.2, **1** will be used.<br>5. The **duration** parameter does not take effect when [springMotion](../js-apis-curve.md#curvesspringmotion9), [responsiveSpringMotion](../js-apis-curve.md#curvesresponsivespringmotion9), and [interpolatingSpring](../js-apis-curve.md#curvesinterpolatingspring10) are configured for **curve**.<br>**Widget capability**: This API can be used in ArkTS widgets since API version 9.<br>**Atomic service API**: This API can be used in atomic services since API version 11.|
