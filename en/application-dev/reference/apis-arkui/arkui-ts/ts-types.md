...
| family | string \| [Resource](#resource)                              | No  |  Yes | Font family. Use commas (,) to separate multiple fonts. The priority of the fonts follows the specified order. Example: **'Arial, HarmonyOS Sans'**. Supported fonts include **'HarmonyOS Sans'** and custom fonts registered via [loadFontSync](../../apis-arkgraphics2d/js-apis-graphics-text.md#loadfontsync).|
