...
<!-- md-trans-meta sourceCommit=3ddb6f7d5458e03f96ae5f64e626eb2fb03d26f6 translatedAt=2026-09-01T11:58:12.308Z -->
...
| Type                    | Description                                     |
| --------------------- | -------------------------------------- |
|import('../api/arkui/Graphics').[LengthMetricsUnit](../js-apis-arkui-graphics.md#lengthmetricsunit12)   | Length attribute unit. |
...
| Type                    | Description                                     |
| --------------------- | -------------------------------------- |
|import('../api/arkui/Graphics').[ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12)   | Blended color. |
...
| -------- | -------- | -------- | -------- |
| top    | [Length](#length) | No | Top padding, which is the distance from the element within the component to the top of the component.  |
| right  | [Length](#length) | No | Right padding, which is the distance from the element within the component to the right boundary of the component. |
| bottom | [Length](#length) | No | Bottom padding, which is the distance from the element within the component to the bottom of the component.  |
| left   | [Length](#length) | No | Left padding, which is the distance from the element within the component to the left boundary of the component. |
...
| Type | Description |
| ---- | ---------------- |
| [EdgeWidths](#edgewidths9) | Width of the component border in different directions. |
...
| Name | Type | Mandatory | Description |
| -------- | -------- | -------- | -------- |
| topLeft     | [Length](#length) | No | Corner radius of the top-left of the component. |
| topRight    | [Length](#length) | No | Corner radius of the top-right of the component. |
| bottomLeft  | [Length](#length) | No | Corner radius of the bottom-left of the component. |
| bottomRight | [Length](#length) | No | Corner radius of the bottom-right of the component. |
...
| position | [Position](#position) | No | No | Position of the top-left corner of the target element in the [component coordinate system](../../../ui/arkui-glossary.md#component-coordinate-system) relative to the parent element. |
...
| dashGap<sup>12+</sup>  | [EdgeWidths](#edgewidths9)&nbsp;\|&nbsp;[LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12)&nbsp;\|&nbsp;[LocalizedEdgeWidths](#localizededgewidths12) | No|Yes  | Sets the gap between dashed line segments. This takes effect only when the border style is dashed.<br/>Percentage values are not supported.<br/>**Atomic service API:** Since API version 12, this interface is supported in atomic services.<br/>**Model constraint:** This interface is only used in the stage model.<br/>**Card capability:** This interface is not supported in ArkTS cards.|
...
| Name | Type | Read-Only | Optional | Description |
| ----------- | ------------------------------------------ | ---- | -------- | ------------------------------------------------------------ |
| strokeColor | [ResourceColor](ts-types.md#resourcecolor) | No | Yes | Color of the internal icon. Default value: **Color.White** |
| size | [Length](ts-types.md#length) | No | Yes | Size of the internal icon, in vp. The default size is the same as the width of the check box component.<br>Percentage values are not supported. If an invalid value is set, the default value is used. |
| strokeWidth | [Length](ts-types.md#length) | No | Yes | Thickness of the internal icon, in vp. Percentage values are not supported. If an invalid value is set, the default value is used. Default value: **2** |
...
| Name  | Type                  | Read-Only  |   Optional                            | Description                                                        |
| ------ | ----------------------|----------------- | --------------------- | ------------------------------------------------------------ |
| width  | [EdgeOutlineWidths](#edgeoutlinewidths11)&nbsp;\|&nbsp;[Dimension](#dimension10)| No | Yes | Sets the outer outline width. Percentages are not supported.<br/>Default value: 0. In the outer outline effect, width is mandatory; otherwise, the outer outline is not displayed.  |
| color  | [EdgeColors](#edgecolors9)&nbsp;\|&nbsp;[ResourceColor](#resourcecolor)&nbsp;\|&nbsp;[LocalizedEdgeColors](#localizededgecolors12)<sup>12+</sup> | No | Yes | Sets the outer outline color.<br/>Default value: Color.Black                    |
| radius | [OutlineRadiuses](#outlineradiuses11)&nbsp;\|&nbsp;[Dimension](#dimension10)| No | Yes | Sets the corner radius of the outer outline. Percentages are not supported.<br/>Default value: 0<br/>Maximum effective value: component width/2 + outlineWidth or component height/2 + outlineWidth.  |
| style  | [EdgeOutlineStyles](#edgeoutlinestyles11)&nbsp;\|&nbsp;[OutlineStyle](ts-universal-attributes-outline.md#outlinestyle)| No | Yes | Sets the outer outline style.<br/>Default value: OutlineStyle.SOLID             |
...
| [Percentage](#percentage10)        | Must be specified in percentage units, for example, '10%'. |
| [Resource](#resource) | Size referenced from system or app resources.|
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }px               | Must be specified in the px pixel unit, for example, '10px'. |
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }vp \| number | A number or vp pixel unit must be specified, for example, 10 or '10vp'. |
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }fp            | Specified in fp pixel units, for example, '10fp'. |
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }lpx             | Must be specified in lpx pixel unit, for example, '10lpx'. |
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }%               | Must be specified in percentage unit, such as '10%'. |
...
| Type                   | Description                                    |
| --------------------- | -------------------------------------- |
| { number }deg               | Must be specified in deg units, for example, '10deg'. |
...
| Name   | Type | Read-only | Optional | Description       |
| ------ | ------|--------|--------| ---------- |
| x | [Dimension](#dimension10) | No | No | X-axis coordinate of the touch point. |
| y | [Dimension](#dimension10) | No | No | Y-axis coordinate of the touch point. |
...
| startMargin | [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) | No  | Yes | Distance between the divider and the start edge of the menu side. |
| endMargin  | [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12)| No  | Yes | Distance between the divider and the end edge of the menu side. |
...
| Name | Type | Read-only | Optional | Description |
| ---- | ------ | ---- | ---- | ---- |
| isConsiderDescendants | boolean | No | Yes | Whether to search for the focus in descendant nodes during custom next-focus processing for accessibility.<br/>The value **true** means to search for the focus in descendant nodes during custom next-focus processing for accessibility; the value **false** means not to search for the focus in descendant nodes during custom next-focus processing for accessibility.<br/>Default value: **false** |
...
| onAction | [VoidCallback](#voidcallback12) | No | No | Callback for handling the custom action. |
