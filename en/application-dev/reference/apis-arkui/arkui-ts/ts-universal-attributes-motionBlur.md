...
<!-- md-trans-meta sourceCommit=39ca26def5c22dc659f3dc0b76ef62a29421e77a translatedAt=2026-09-02T11:55:53.061Z -->
...
|   Name   |    Type                                                     |  Mandatory |     Description                                                      |
| ---------- | ---------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| motionBlur | Optional\<[MotionBlurOptions](#motionbluroptions) | Yes | Defines the motion blur parameters.<br>When the value of motionBlur is undefined, the previously set value remains unchanged. |
...
| anchor | [MotionBlurAnchor](#motionbluranchor) | No    | No    | Anchor point coordinates of the motion blur. They must be consistent with the anchor point (centerX/centerY) of the animation [scale](ts-universal-attributes-transformation.md#scale) attribute; otherwise, unexpected effects may occur. |
