...
>
> - If a new node needs to respond to hit testing, set [HitTestMode](./ts-appendix-enums.md#hittestmode9) for the node. If the new node has multiple levels, you only need to set **HitTestMode** for the root node.
...
| -------------------- | -------- | ---------------------------------------- | ---------------------------------------- |
| value | [HitTestMode](./ts-appendix-enums.md#hittestmode9) | Yes| Hit test mode for a component.|
