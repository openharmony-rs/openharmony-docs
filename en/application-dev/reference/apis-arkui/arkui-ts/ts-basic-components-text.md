...
| maxLines | Sets the maximum number of lines for text.|
| minLineHeight<sup>22+</sup> | Sets the minimum line height of the text.|
| minLines<sup>22+</sup> | Sets the minimum number of lines for text.|
...
| Name| Type                      | Mandatory| Description          |
| ------ | -------------------------- | ---- | -------------- |
| value  | number&nbsp;\|&nbsp;[ResourceStr](ts-types.md#resourcestr) | Yes  | Letter spacing.<br>Default value: **0**<br>Unit: [fp](ts-pixel-units.md#basic-pixel-units)<br>The [Resource](ts-types.md#resource) type is supported since API version 20.|
...
Sets text line height in multiple mode.

The line height equals the input parameter **value** multiplied by **fontHeight**.

>  **NOTE**
>  
>  If [lineHeight](ts-basic-components-text.md#lineheight) or [lineSpacing](ts-basic-components-text.md#linespacing12) is set together with a valid **lineHeightMultiple** value, only **lineHeightMultiple** takes effect. When its value less than 0, **lineHeightMultiple** does not take effect. The line height and spacing are determined by [lineHeight](ts-basic-components-text.md#lineheight) and [lineSpacing](ts-basic-components-text.md#linespacing12).
...
| Name| Type                                                        | Mandatory| Description            |
| ------ | ------------------------------------------------------------ | ---- | ---------------- |
| value  | number&nbsp;\|&nbsp;undefined | Yes  | Line height multiple.<br>Value range: [0, +∞)<br>**NOTE**<br>- Values less than 0 does not take effect.<br>- Value **0** functions the same as **1**, leaving line height unchanged.<br>- Decimal values are supported.|

### lineSpacing<sup>12+</sup>

lineSpacing(value: LengthMetrics)

Sets the line spacing for the text. If the value specified is less than or equal to 0, the default value **0** is used.
...
Sets the maximum line height of the text. If the value is less than or equal to 0, the maximum line height is unrestricted.
...
| Name| Type                        | Mandatory| Description                        |
| ------ | ---------------------------- | ---- | ---------------------------- |
| value  | [Length](ts-types.md#length) | Yes  | Indent of the first line text.<br>Default value: **0**<br>Unit: [fp](ts-pixel-units.md#basic-pixel-units)<br>The value must be greater than or equal to 0. If the value is a negative number, the default value is used.|
