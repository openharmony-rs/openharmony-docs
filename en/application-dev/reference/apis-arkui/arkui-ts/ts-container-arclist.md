...
The chained animation effect takes effect only when a prerequisite is satisfied: the edge effect of **ArcList** is of the [EdgeEffect.Spring](ts-appendix-enums.md#edgeeffect) type.
