...
If [nextFocus](#nextfocus18) is not configured, the default focus navigation order when pressing the Tab key is: M->A->B->C. After [nextFocus](#nextfocus18) is configured, the focus navigation order changes to: M->D->F->B.
