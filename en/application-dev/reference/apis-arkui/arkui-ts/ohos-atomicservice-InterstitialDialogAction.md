...
<!--Tester: @tinygreyy-->
<!--Adviser: @zengyawen-->
<!-- md-trans-meta sourceCommit=0a95cd1273144a621a30581e6795a956395abedc translatedAt=2026-08-26T06:21:48.150Z pushedAt=2026-08-26T09:20:29.337Z -->
...
export default class EntryAbility extends UIAbility {
  ...
  onWindowStageCreate(windowStage: window.WindowStage): void {
    ...
    windowStage.getMainWindow((err, data) => {
      ...
      windowClass = data;
      console.info('Succeeded in obtaining the main window. Data: ' + JSON.stringify(data));
      // Set the window to non-full-screen mode.
