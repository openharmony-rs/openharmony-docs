...
| message   | [PopupTextOptions](#popuptextoptions)                        | No | No | Message of the popup.<br>**NOTE**<br>**fontWeight** is not available for messages.<br> By default, no message is displayed.<br>**Atomic service API**: This API can be used in atomic services since API version 12.|
