...
<!-- md-trans-meta sourceCommit=9895f5cb14cc8e06de013c306a32d770061ce9ce translatedAt=2026-08-27T01:38:20.590Z pushedAt=2026-08-27T02:34:46.681Z -->

The **Popup** component is used to display popups in a specific style. It supports flexible combinations of icons, text, and buttons, and is suitable for scenarios such as notification prompts, information confirmation, and warning prompts. With customizable style options, it enables consistent popup interaction experiences to be implemented quickly.
...
| message   | [PopupTextOptions](#popuptextoptions)                        | No  | No  | Content of the popup.<br>By default, no content is displayed.<br>**NOTE**<br>**fontWeight** is not available for **message**.<br>**Atomic service API**: This API can be used in atomic services since API version 12. |
...
| onClose   | () => void                                                   | No   | Yes  | Callback for the popup close button.<br>By default, no callback is set for the close button.<br>**Atomic service API**: This API can be used in atomic services since API version 12. |
...
| direction<sup>12+</sup> | [Direction](ts-appendix-enums.md#direction)                                             | No                                | Yes                               | Layout direction of the popup content. For details about the available enums, see [Direction](ts-appendix-enums.md#direction).<br>Default value: **Direction.Auto**<br>**Atomic service API**: This API can be used in atomic services since API version 12. |
| maxWidth<sup>18+</sup> | [Dimension](ts-types.md#dimension10)                                             | No                                | Yes                               | Maximum width of the popup. Custom width display is supported.<br>**NOTE**<br>1. When a resource type is used, the parameter type must be consistent with the type of the **maxWidth** attribute itself.<br>2. **maxWidth** is of the [Dimension](ts-types.md#dimension10) type, which supports the number type and the percentage string type. The number type supports float and integer, for example, `$r('app.float.maxWidth')` and `$r('app.integer.maxWidth')`; the percentage string is, for example, '50%'.<br>3. When the type is **Resource** and no unit is set, the default unit is px.<br>Default value: **400vp**<br>**Atomic service API**: This API can be used in atomic services since API version 18. |
...
| borderRadius | [Length](ts-types.md#length) \| [BorderRadiuses](ts-types.md#borderradiuses9) | No   | Yes | Rounded corner of the icon. Unit: vp.<br>Default value: **$r('sys.float.ohos_id_corner_radius_default_s')**  |
