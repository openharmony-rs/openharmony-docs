...
|:---------:|:----------------------:|-----| ------ |-----------|
| multiStack | [MultiNavPathStack](#multinavpathstack) | No  | No| Navigation stack.|
| navDestination | [NavDestinationBuildFunction](#navdestinationbuildfunction) | No| No| Routing rules for loading the target page.|
| onNavigationModeChange | [OnNavigationModeChangeCallback](#onnavigationmodechangecallback) | No| Yes| Callback invoked when the mode of the **MultiNavigation** component changes.|
| onHomeShowOnTop | [OnHomeShowOnTopCallback](#onhomeshowontopcallback) | No| Yes| Callback invoked when the home page is on the top of the navigation stack.|
