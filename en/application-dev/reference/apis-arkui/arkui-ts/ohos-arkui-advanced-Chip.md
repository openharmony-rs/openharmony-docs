...
<!-- md-trans-meta sourceCommit=ae37e4757ba2bd5134f71ef8986a73d15665e66d translatedAt=2026-08-26T06:25:11.347Z pushedAt=2026-08-26T09:20:29.342Z -->
...
struct Index {
  ...
  build() {
    Column({ space: 10 }) {
      ...
      // Tap "Activate/Deactivate" to control the activation and deactivation of the chip.
...
struct ChipMaterialExample {
  private chipOptions: ChipOptions = {
    ...
    allowClose: false,
    // Set the background color in the normal state to transparent; otherwise, it conflicts with the system material.
    ...
    // Set the background color in the activated state to transparent; otherwise, it conflicts with the system material.
