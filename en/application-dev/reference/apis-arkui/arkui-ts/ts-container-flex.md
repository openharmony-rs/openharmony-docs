...
> - The **Flex** component involves a secondary layout process during rendering. Therefore, in scenarios with strict performance requirements, you are advised to use [Column](ts-container-column.md) or [Row](ts-container-row.md) instead. For best practices, see [Using Layout Components Properly](https://developer.huawei.com/consumer/en/doc/harmonyos-guides/arkts-layout-optimization-guidance#using-layout-components-properly).
