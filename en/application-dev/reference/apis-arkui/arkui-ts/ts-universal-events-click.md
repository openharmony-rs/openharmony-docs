...
When triggered by keyboard or gamepad input, the event's [SourceTool](ts-gesture-settings.md#sourcetool9) is **Unknown**.
...
When triggered by keyboard or gamepad input, the event's **SourceTool** is **Unknown**.
