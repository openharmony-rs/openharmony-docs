...
| ------- | ------------------------------------------------- | ---- | ------------------------------------------------------------ |
| options | [DistortionComponentOptions](#distortioncomponentoptions)  | No  | Spatial distortion options, used to configure the spatial distortion effect of the component. If this parameter is not set or is set to **undefined**, the component is rendered normally without any distortion effect.                                           |
