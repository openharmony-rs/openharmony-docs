...
| options<sup>12+</sup> | [KeyboardOptions](#keyboardoptions12) \| undefined<sup>23+</sup>      | No  | Whether to support keyboard avoidance.<br>When undefined is passed, avoidance is not supported by default.|
...
| Name| Type                                                        | Mandatory| Description                                    |
| ------ | ------------------------------------------------------------ | ---- | ---------------------------------------- |
| color  | [Optional](ts-universal-attributes-custom-property.md#optionalt12)\<[ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12)> | Yes  | Color of the scrollbar.<br>Default value: **'#66182431'**, displayed as gray.<br>Note: If an abnormal value is set, the default value is used.|
...
This API depends on the lineHeight attribute of [RichEditorTextStyle](#richeditortextstyle). When the value of lineHeight is less than the actual height of the text rendered under the current font size, the fallbackLineSpacing property takes effect.
...
| Name | Type                                                        | Mandatory| Description                                                        |
| ------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value | [SelectedDragPreviewStyle](ts-text-common.md#selecteddragpreviewstyle23) \| undefined | Yes  | Drag and preview style. If this attribute is set to undefined, the style will be reset.|
...
| textDirection<sup>23+</sup> | [TextDirection](ts-text-common.md#textdirection22) |  No | Yes| Sets the text direction.<br>Default value: TextDirection.DEFAULT<br>**Atomic service API**: This API can be used in atomic services since API version 23.|
...
### Example 34: Deleting Characters at the End of the Text Box
Starting from API version 23, this example uses the [deleteBackward](#deletebackward23) event to delete the character before the caret using the custom keyboard in the editing state.
...
struct RichEditorExample {
  ...
  // Customize the delete key on the keyboard.
  @Builder
  CustomKeyboardBuilder() {
    Column() {
      Button('DELETE')
        ...
        .fontSize(16)
        .onClick(() => {
          // Call the deleteBackward interface to delete characters.
...
In this example, the [includeFontPadding](#includefontpadding23) attribute is used to add an inner margin to the top of the first line and the bottom of the last line, and the [fallbackLineSpacing](#fallbacklinespacing23) attribute is used to implement line height adaptation, dynamic adjustment based on the actual text height.
...
struct RichEditorExample {
  ...
  build() {
    Column() {
      ...
      Row() {
        Button ('Enable text line adaptation')
          .onClick(() => {
          ...
          .height("10%")
          .margin({ right: 10 })
        Button ('Disable text line adaptation.')
          .onClick(() => {
      ...
      Row() {
        Button ('Increase the margin of the first and last lines of a paragraph.')
          .onClick(() => {
          ...
          .height("10%")
          .margin({ right: 10 })
        Button ('Increase the margin of the first and last lines of the closed paragraph.')
          .onClick(() => {
...
### Example 36: Enabling Punctuation Compression at the Beginning of a Line
In this example, the [compressLeadingPunctuation](#compressleadingpunctuation23) attribute is used to set line leading punctuation compression.
...
struct CompressLeadingPunctuationDemo {
  ...
  build() {
    Column() {
      ...
      Column() {
        Button ("Enable punctuation compression at the beginning of a line").onClick (() => {
          this.compressLeadingPunctuation = true
        }).margin({ top: 10 })
        Button ("Disable punctuation compression at the beginning of a line.").onClick (() ==> {
...
### Example 37: Setting the Drag and View Style
In this example, the [selectedDragPreviewStyle](#selecteddragpreviewstyle23) interface is used to set the drag and view style.
...
### Example 38: Setting the Single-Line Mode

In this example, the single-line mode is set by calling [singleLine](#singleline23).
...
struct SingleLineDemo {
  ...
  exampleText: string ='This is an example text.\nThis is an example text.\nThis is an example text.'
  ...
  build() {
    Column() {
      ...
      Row() {
        Button ('Switch to Single-Line Mode').onClick ((event: ClickEvent) => {
          this.enableSingleLine = true
        }).margin(5)
        Button ('Switch to the multi-line mode').onClick ((event: ClickEvent) => {
