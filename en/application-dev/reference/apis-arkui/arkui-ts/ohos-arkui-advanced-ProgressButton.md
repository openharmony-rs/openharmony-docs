...
The component is a text-based download button with a progress indicator that shows the download progress.
...
| enable                            | boolean                                                       | Yes| \@Prop | Whether the button can be clicked.<br> **true**: yes<br> **false**: no<br>**Atomic service API**: This API can be used in atomic services since API version 11.                     |
| colorOptions<sup>18+</sup>         | [ProgressButtonColorOptions](#progressbuttoncoloroptions18)   | No| \@Prop | Color options of the button. This parameter is used to customize the color of each part of the button (progress indicator, stroke, text, and background). This parameter is passed in when a custom color is required. If it is not passed, the default color scheme is used.<br>**Atomic service API**: This API can be used in atomic services since API version 18.                                                                            |
