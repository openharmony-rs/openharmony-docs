...
This example demonstrates how to set the **anchorPosition** attribute in [ContextMenuOptions](#contextmenuoptions10) to control the pop-up position of the menu relative to the top-left corner of the bound component.

The **attribute** is added to **ContextMenuOptions** since API version 20.
