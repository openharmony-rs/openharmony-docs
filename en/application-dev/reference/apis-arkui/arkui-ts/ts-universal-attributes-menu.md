...
Configures menu item information, which is inherited from [ContextMenuOptions](#contextmenuoptions10).
...
| [LocalizedBorderRadiuses](ts-types.md#localizedborderradiuses12) | Corner radius of a component's border.|
