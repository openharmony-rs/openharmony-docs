...
<!-- md-trans-meta sourceCommit=924f6df4b9051b04b0f13dec8e04905b92655514 translatedAt=2026-08-24T06:53:10.284Z pushedAt=2026-08-25T07:34:42.016Z -->
...
| ---- | ------ | ---- | ------- |
| params   | Record\<string, Object \| undefined \| null\> | No    | Construction parameters received when the component is reused. This parameter is supported only by the reuse callback of a V1 component. If this parameter is not passed, the reuse callback has no input parameter. |
...
1. Start the app and create the custom component **Child** to trigger **\@ComponentInit** and **\@ComponentAppear**. After **Child** executes **build()**, **\@ComponentBuilt** is triggered.
...
struct Child {
  ...
  @ComponentInit
  myInit() {
    // After the custom component is created, the myInit method is triggered.
  ...
  build() {
    Column() {
      Button('change').onClick(() => {
        // Toggle the display state of the Child component to trigger recycling or reuse of the component.
