...
| ARKUI_PRE_DRAG_STATUS_CANCELED_BEFORE_DRAG = 6 | A drop animation is terminated.|
...
| char* key | Key value returned after successful data setting. The length of the string must be no less than UDMF_KEY_BUFFER_LEN.|
