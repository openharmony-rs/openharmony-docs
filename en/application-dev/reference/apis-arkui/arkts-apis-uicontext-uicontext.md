...
Obtains the DialogPresenter object, which can be used to manage the display, update, and close of dialog boxes.
...
| Type                           | Description                 |
| ----------------------------- | ------------------- |
| [DialogPresenter](arkts-apis-uicontext-dialogpresenter.md) | DialogPresenter instance, which can be used to manage and display dialogs.|
