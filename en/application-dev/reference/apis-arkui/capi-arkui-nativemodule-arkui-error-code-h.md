...
| ARKUI_ERROR_CODE_NODE_IS_NOT_IN_ADOPTED_CHILDREN = 106210 | The node is not an auxiliary node accepted by the target node. For details about the error code, see [106210 The Node Is Not an Affiliated Node Adopted by the Parent Node](errorcode-adopt.md#106210-the-node-is-not-an-affiliated-node-adopted-by-the-parent-node).<br>**Since:** 22 |
