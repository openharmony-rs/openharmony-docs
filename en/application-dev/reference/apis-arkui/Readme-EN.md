...
<!-- md-trans-meta sourceCommit=59e7773ac0ad5cb4923625e28815dece9f2c16e6 translatedAt=2026-09-18T01:11:24.076Z pushedAt=2026-09-18T01:17:11.872Z -->
...
- ArkTS API<!--arkui-arkts-->
  - UI<!--ui-->
    ...
    - @ohos.arkui.UIContext (UIContext)<!--js-apis-arkui-uicontext-->
      ...
      <!--Del-->
      - [Module Description (System API)](arkts-apis-uicontext-sys.md)
      <!--DelEnd-->
      ...
      <!--Del-->
      - [Class (LuminanceSampler) (System API)](arkts-apis-uicontext-luminancesampler-sys.md)
      <!--DelEnd-->
      ...
      - [Interfaces (Others)](arkts-apis-uicontext-i.md)
      <!--Del-->
      - [Interfaces (Others) (System API)](arkts-apis-uicontext-i-sys.md)
      <!--DelEnd-->
    ...
    - [@ohos.arkui.uiMaterial (System Material)](arkts-apis-uimaterial.md)
    ...
    <!--Del-->
    - [@ohos.curves (Interpolation Calculation) (System API)](js-apis-curve-sys.md)
    <!--DelEnd-->
    ...
    - [@ohos.promptAction (Dialog Box)](js-apis-promptAction.md)
    <!--Del-->
...
- ArkTS Components<!--arkui-declarative-comp-->
  ...
  - [Universal Attributes](arkui-ts/ts-component-general-attributes.md)
    ...
    - Visual Effects and Blur<!--visual-effect-property-->
      ...
      <!--Del-->
      - [Spatial Effect (System API)](arkui-ts/ts-universal-attributes-spatial-effect-sys.md)
  ...
  - Scrolling and Swiping<!--scroll-and-swipe-->
  ...
  - Buttons and Selection<!--buttons-and-selections-->
    ...
    - [Picker Common APIs](arkui-ts/ts-picker-common.md)
  ...
  - Canvas Drawing<!--canvas-drawing-->
    ...
    - [Common Canvas Drawing Properties](arkui-ts/ts-components-canvas-common-property.md)
    - [Common Canvas Rendering Methods](arkui-ts/ts-components-canvas-common-method.md)
  - Graphics Drawing<!--graphic-drawing-->
    ...
    - [Common Attributes for Graphics Drawing](arkui-ts/ts-drawing-components-common.md)
  - Rendering and Drawing<!--rendering-drawing-->
  ...
  - Dialog Boxes<!--dialog-boxes-->
    ...
    <!--Del-->
    - [Alert Dialog Box (AlertDialog) (System API)](arkui-ts/ts-methods-alert-dialog-box-sys.md)
    <!--DelEnd-->
    - [Action Sheet (ActionSheet)](arkui-ts/ts-methods-action-sheet.md)
    <!--Del-->
    - [Action Sheet (ActionSheet) (System API)](arkui-ts/ts-methods-action-sheet-sys.md)
    <!--DelEnd-->
    - [Custom Dialog Box (CustomDialog)](arkui-ts/ts-methods-custom-dialog-box.md)
    <!--Del-->
    - [Custom Dialog Box (CustomDialog) (System API)](arkui-ts/ts-methods-custom-dialog-box-sys.md)
    <!--DelEnd-->
    - [Calendar Picker Dialog Box (CalendarPickerDialog)](arkui-ts/ts-methods-calendarpicker-dialog.md)
    <!--Del-->
    - [Calendar Picker Dialog Box (CalendarPickerDialog) (System API)](arkui-ts/ts-methods-calendarpicker-dialog-sys.md)
    <!--DelEnd-->
    - [Date Picker Dialog Box (DatePickerDialog)](arkui-ts/ts-methods-datepicker-dialog.md)
    <!--Del-->
    - [Date Picker Dialog Box (DatePickerDialog) (System API)](arkui-ts/ts-methods-datepicker-dialog-sys.md)
    <!--DelEnd-->
    - [Time Picker Dialog Box (TimePickerDialog)](arkui-ts/ts-methods-timepicker-dialog.md)
    <!--Del-->
    - [Time Picker Dialog Box (TimePickerDialog) (System API)](arkui-ts/ts-methods-timepicker-dialog-sys.md)
    <!--DelEnd-->
  ...
  - AtomicService<!--atomic-services-->
    ...
    <!--Del-->
    - [AtomicServiceMenuBar (System API)](arkui-ts/ohos-atomicservice-AtomicServiceMenuBar-sys.md)
  ...
  - Custom Component<!--custom-comp-->
    ...
    - Custom Component Decorators<!--custom-component-decorator-->
      - [@Component: Custom Component](arkui-ts/ts-custom-component-decorator-component.md)
    ...
    - Component Extension Decorators<!--arkts-extend-component-decorator-->
      ...
      - [\@Builder Decorator: Custom Builder Function](arkui-ts/ts-universal-builder-dynamic.md)
      - [\@BuilderParam Decorator: Referencing the \@Builder Function](arkui-ts/ts-universal-builderparam-dynamic.md)
      - [@Extend: Extended Component Styles](arkui-ts/ts-custom-component-decorator-extend.md)
      - [@LocalBuilder Decorator: Maintaining Component Relationships](arkui-ts/ts-universal-localbuilder.md)
      - [\@Require Decorator: Validating Constructor Input Parameters](arkui-ts/ts-universal-require-dynamic.md)
      - [\@Reusable: Reusing Components](arkui-ts/ts-custom-component-decorator-reusable.md)
      - [@ReusableV2: Component Reuse V2](arkui-ts/ts-custom-component-decorator-reusablev2.md)
  ...
  - State Management and Rendering Control<!--state-management-and-rendering-control-->
    ...
    <!--Del-->
    - [Storage (System API)](arkui-ts/ts-state-management-storage-sys.md)
    <!--DelEnd-->
    ...
    - State Management V1 Decorators<!--v1-state-management-decorator-->
      - [@Consume: Implementing Two-Way Synchronization with Descendant Components](arkui-ts/ts-state-management-consume.md)
      - [@Link: Two-Way Synchronization Between Parent and Child Components](arkui-ts/ts-state-management-link.md)
      - [@LocalStorageLink: Bidirectional Data Synchronization with LocalStorage](arkui-ts/ts-state-management-localstoragelink.md)
      - [@LocalStorageProp: Unidirectional Data Synchronization with LocalStorage](arkui-ts/ts-state-management-localstorageprop.md)
      - [@ObjectLink: Observing Property Changes in Nested Class Objects](arkui-ts/ts-state-management-objectlink.md)
      - [@Observed: Observing Property Changes in Nested Class Objects](arkui-ts/ts-state-management-observed.md)
      - [@Prop: Implementing One-Way Synchronization from Parent to Child Components](arkui-ts/ts-state-management-prop.md)
      - [@Provide: Implementing Two-Way Synchronization with Descendant Components](arkui-ts/ts-state-management-provide.md)
      - [@State: State Owned by Component](arkui-ts/ts-state-management-state.md)
      - [@StorageLink: Bidirectional Data Synchronization with AppStorage](arkui-ts/ts-state-management-storagelink.md)
      - [@StorageProp: Unidirectional Data Synchronization with AppStorage](arkui-ts/ts-state-management-storageprop.md)
      - [@Track: Implementing Class Object Property-Level Updates](arkui-ts/ts-state-management-track.md)
      - [@Watch: Getting Notified of State Variable Changes](arkui-ts/ts-state-management-watch.md)
    - State Management V2 Decorators<!--v2-state-management-decorator-->
      - [@Computed: Declaring Computed Properties](arkui-ts/ts-state-management-computed.md)
      - [@Consumer: Synchronizing Across Component Levels in a Two-Way Manner](arkui-ts/ts-state-management-consumer.md)
      - [@Event: Standardizing Component Output](arkui-ts/ts-state-management-event.md)
      - [@Local: Representing the Internal State of Components](arkui-ts/ts-state-management-local.md)
      - [@Monitor: Listening for Value Changes of the State Variables](arkui-ts/ts-state-management-monitor.md)
      - [@ObservedV2: Observing Class Property Changes](arkui-ts/ts-state-management-observedv2.md)
      - [@Once: Implementing Initialization Once](arkui-ts/ts-state-management-once.md)
      - [@Param: Inputting External Parameters to Components](arkui-ts/ts-state-management-param.md)
      - [@Provider: Synchronizing Across Component Levels in a Two-Way Manner](arkui-ts/ts-state-management-provider.md)
      - [@SyncMonitor: Synchronous Listening for Value Changes of the State Variables](arkui-ts/ts-state-management-syncmonitor.md)
      - [@Trace: Observing Class Property Changes](arkui-ts/ts-state-management-trace.md)
      - [@Type: Marking Types of Class Properties](arkui-ts/ts-state-management-type.md)
    <!--Del-->
  ...
  - Reactive Environment Variables<!--responsive-env-system-property-->
    ...
    - [\@CustomEnv: Custom Environment Variable](arkui-ts/ts-custom-env-property.md)
  ...
  - Other Categories<!--other-->
    ...
    - [DynamicComponent (System API)](arkui-ts/ts-container-dynamic-component-sys.md)
    - [SecurityUIExtensionComponent (System API)](arkui-ts/ts-container-security-ui-extension-component-sys.md)
    - [UnionEffectContainer (System API)](arkui-ts/ts-container-unioneffectcomponent-sys.md)
    - [DistortionComponent (System API)](arkui-ts/ts-container-distortioncomponent-sys.md)
  <!--DelEnd-->
  - Deprecated Components and APIs<!--arkui-declarative-comp-dep-->
    <!--Del-->
...
- C API<!--arkui-c-->
  ...
  - Header Files<!--arkui-headerfile-->
    ...
    - [native_node.h](capi-native-node-h.md)
      - [ArkUI_NodeAttributeType (Basic Attribute)](capi-native-node-h-nodeattributetype-base.md)
      - [ArkUI_NodeAttributeType (General Attribute)](capi-native-node-h-nodeattributetype-common.md)
      - [ArkUI_NodeAttributeType (Layout Attribute)](capi-native-node-h-nodeattributetype-layoutattributes.md)
      - [ArkUI_NodeAttributeType (Layout Component Attribute)](capi-native-node-h-nodeattributetype-layoutcomponent.md)
      - [ArkUI_NodeAttributeType (Animation and Visual Effect Attributes)](capi-native-node-h-nodeattributetype-animator.md)
      - [ArkUI_NodeAttributeType (Interaction Attribute)](capi-native-node-h-nodeattributetype-interaction.md)
      - [ArkUI_NodeAttributeType (Form Component Attribute)](capi-native-node-h-nodeattributetype-form.md)
      - [ArkUI_NodeAttributeType (Scrollable Container Component Attribute)](capi-native-node-h-nodeattributetype-scrollablecontainer.md)
      - [ArkUI_NodeAttributeType (Navigation Component Attribute)](capi-native-node-h-nodeattributetype-navigationrelatedcomponents.md)
      - [ArkUI_NodeAttributeType (Information Display Component Attribute)](capi-native-node-h-nodeattributetype-informationdisplay.md)
      - [ArkUI_NodeAttributeType (Information Selection Component Attribute)](capi-native-node-h-nodeattributetype-informationselection.md)
      - [ArkUI_NodeAttributeType (Accessibility Attribute)](capi-native-node-h-nodeattributetype-accessibility.md)
      - [ArkUI_NodeAttributeType (Text Display Component Attribute)](capi-native-node-h-nodeattributetype-text.md)
      - [ArkUI_NodeAttributeType (Text Input Component Attribute)](capi-native-node-h-nodeattributetype-textinputcategory.md)
      - [ArkUI_NodeAttributeType (Rich Text Component Attribute)](capi-native-node-h-nodeattributetype-richeditor.md)
      - [ArkUI_NodeAttributeType (Image Component Attribute)](capi-native-node-h-nodeattributetype-image.md)
      - [ArkUI_NodeAttributeType (XComponent Attribute)](capi-native-node-h-nodeattributetype-xcomponent.md)
      - [ArkUI_NodeAttributeType (EmbeddedComponent Attribute)](capi-native-node-h-nodeattributetype-embeddedcomponent.md)
      - [ArkUI_NodeAttributeType (Others)](capi-native-node-h-nodeattributetype-other.md)
  ...
  - Structs<!--arkui-struct-->
    ...
    - [ArkUI_NodeBorderRadius](capi-arkui-nativemodule-arkui-nodeborderradiusoption.md)
...
- Error Codes<!--arkui-arkts-errcode-->
  - UI<!--arkui-ui-arkts-errcode-->
    ...
    - [Environment Variable Error Codes](errorcode-env.md)
