...
| Name                                  | Type| Read-Only| Optional| Description                                                        |
| -------------------------------------- | -------- | ---- | ---- | ------------------------------------------------------------ |
| statusBarColor                         | string   |  No |  Yes  | Status bar background color. If this parameter is used as an input parameter, its value is a hexadecimal RGB or ARGB color, which is case-insensitive, for example, **'#00FF00'** or **'#FF00FF00'**. If this parameter is used as a return value, its value is always in ARGB format, for example, **'#FF00FF00'**. The default value is the color configured in the system.<br> **System capability**: SystemCapability.WindowManager.WindowManager.Core|
...
| navigationBarColor                     | string   |  No |  Yes  | Background color of the three-button navigation bar. If this parameter is used as an input parameter, its value is a hexadecimal RGB or ARGB color, which is case-insensitive, for example, **'#00FF00'** or **'#FF00FF00'**. If this parameter is used as a return value, its value is always in ARGB format, for example, **'#FF00FF00'**. The default value is the color configured in the system.<br><!--RP13--><!--RP13End--> **System capability**: SystemCapability.WindowManager.WindowManager.Core|
