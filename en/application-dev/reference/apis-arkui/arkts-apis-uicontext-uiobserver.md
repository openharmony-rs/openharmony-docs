...
> **NOTE**
>
> - This method and [off('navDestinationUpdate')](#offnavdestinationupdate11) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
>
...
> **NOTE**
>
> - This method and [off('navDestinationUpdate')](#offnavdestinationupdate11-1) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
| type     | string                                                       | Yes  | Event type. The value is fixed at **'navDestinationUpdate'**, which indicates [NavDestination](arkui-ts/ts-basic-components-navdestination.md) component state changes.|
| options  | { navigationId: [ResourceStr](arkui-ts/ts-types.md#resourcestr) } | Yes  | ID of the target [Navigation](arkui-ts/ts-basic-components-navigation.md) component.                                  |
| callback | Callback\<observer.[NavDestinationInfo](js-apis-arkui-observer.md#navdestinationinfo)\>        | No  |Listener callback to unregister. When no specific callback is specified, all listener callbacks for NavDestination state changes on the Navigation specified by **options** are unregistered.                |
...
> **NOTE**
>
> - This method and [off('navDestinationUpdateByUniqueId')](#offnavdestinationupdatebyuniqueid20) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
> **NOTE**
>
> - This method and [off('routerPageUpdate')](#offrouterpageupdate11) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
> **NOTE**
>
> - This method and [off('densityUpdate')](#offdensityupdate12) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
> **NOTE**
>
> - This method and [off('navDestinationSwitch')](#offnavdestinationswitch12) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
> **NOTE**
>
> - This method and [off('navDestinationSwitch')](#offnavdestinationswitch12-1) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| type     | string                                                       | Yes  | Event type. The value is fixed at **'tabContentUpdate'**, indicating [TabContent](arkui-ts/ts-container-tabcontent.md) page switch events.|
| callback | Callback\<observer.[TabContentInfo](js-apis-arkui-observer.md#tabcontentinfo12)\> | No  | Target listener to unregister. If this parameter is not passed, all listener callbacks for TabContent page switch events on all Tabs components are unregistered.|
...
| type     | string                                                       | Yes  | Event type. The value is fixed at **'tabContentUpdate'**, indicating [TabContent](arkui-ts/ts-container-tabcontent.md) page switch events.|
| options  | observer.[ObserverOptions](js-apis-arkui-observer.md#observeroptions12) | Yes  | ID of the target [Tabs](arkui-ts/ts-container-tabs.md) component.|
| callback | Callback\<observer.[TabContentInfo](js-apis-arkui-observer.md#tabcontentinfo12)\> | No  | Target listener to unregister. If this parameter is not passed, all listener callbacks for TabContent page switch events on the Tabs component specified by **options** are unregistered.|
...
> **NOTE**
>
> - This method and [off('tabChange')](#offtabchange22) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
> **NOTE**
>
> - This method and [off('tabChange')](#offtabchange22-1) must be used in pairs.
>
> - Before the component is destroyed (for example, in the **aboutToDisappear** lifecycle callback), you must call the **off** method to release listener resources.
>
> - Failure to call **off** in a timely manner may cause memory leaks and unnecessary resource usage.
...
| -------- | ----------------------------------------------------- | ---- | ------------------------------------------------------------------------ |
| type     | string                                                | Yes  | Event type. The value is fixed at **'textChange'**, indicating text input field changes events.|
| identity | observer.[ObserverOptions](js-apis-arkui-observer.md#observeroptions12) | Yes  | ID of the text input component listened on.|
...
| Name  | Type                        | Mandatory| Description                                                        |
| -------- | ---------------------------- | ---- | ------------------------------------------------------------ |
| callback | Callback\<[SwiperContentInfo](./arkts-apis-uicontext-i.md#swipercontentinfo22)> | No  | Target listener to unregister. If this parameter is not passed, all listener callbacks for content switch events on all Swiper components are unregistered.|
...
| callback | Callback\<[SwiperContentInfo](./arkts-apis-uicontext-i.md#swipercontentinfo22)\> | No  | Target listener to unregister. If this parameter is not passed, all listener callbacks for content switch events on the Swiper component specified by **config** are unregistered.|
...
Registers a callback that is triggered when the size of the visible router page changes. This API is suitable for scenarios where you need to respond to Router page size changes, such as dynamically adjusting UI layouts based on page size, recalculating component dimensions, or optimizing display effects.
...
Registers a callback that is triggered when the size of the visible navigation destination changes. This API is suitable for scenarios where you need to respond to NavDestination page size changes, such as dynamically adjusting UI layouts based on page size, recalculating component dimensions, or optimizing display effects.
...
Registers a callback for listening to the size change of a visible **NavDestination** component that belongs to a specified **Navigation** component. This API is suitable for scenarios where you need to listen for NavDestination size changes on a specific Navigation component when there are multiple Navigation components. For example, in a complex page containing multiple independent Navigation containers, you can use **uniqueId** to precisely control the listening scope.
