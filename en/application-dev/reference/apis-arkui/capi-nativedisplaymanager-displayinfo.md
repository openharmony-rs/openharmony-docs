...
| uint32_t availableWidth | Width of the available area on the screen of the display, in px. The value is a non-negative integer.|
| uint32_t availableHeight | Height of the available area on the screen of the display, in px. The value is a non-negative integer.|
