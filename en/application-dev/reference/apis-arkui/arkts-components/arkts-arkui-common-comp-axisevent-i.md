...
Describes the axis event object. Inherits from [BaseEvent](arkts-arkui-common-comp-baseevent-i.md).

**Inheritance/Implementation:** AxisEvent extends [BaseEvent](arkts-arkui-common-comp-baseevent-i.md)
