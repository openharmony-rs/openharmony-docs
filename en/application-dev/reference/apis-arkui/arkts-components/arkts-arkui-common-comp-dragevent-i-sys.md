...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| onAnimationFinished | [Callback](arkts-arkui-common-comp-callback-i.md)&lt;void&gt; | Yes | Callback triggered after the drag framework animation ends. |
...
**Type:** [DragAnimationType](arkts-arkui-common-comp-draganimationtype-e-sys.md)
