...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| callback | [OnWaterFlowScrollIndexCallback](arkts-arkui-waterflow-comp-onwaterflowscrollindexcallback-t.md) &#124; undefined | Yes | Callback for the **onScrollIndex** event. |
