...
Defines the gesture event information. Inherits from [BaseEvent](arkts-arkui-common-comp-baseevent-i.md).

**Inheritance/Implementation:** GestureEvent extends [BaseEvent](arkts-arkui-common-comp-baseevent-i.md)
