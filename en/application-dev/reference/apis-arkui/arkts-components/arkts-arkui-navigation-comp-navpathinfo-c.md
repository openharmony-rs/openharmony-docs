...
| onPop | import('../api/@ohos.base').Callback&lt;[PopInfo](arkts-arkui-navigation-comp-popinfo-i.md)&gt; | No | Callback returned when [pop](arkts-arkui-navigation-comp-navpathstack-c.md#pop-1), [popToName](arkts-arkui-navigation-comp-navpathstack-c.md#poptoname-1), or [popToIndex](arkts-arkui-navigation-comp-navpathstack-c.md#poptoindex-1) is called on the navigation destination page. It is triggered only when the **result** parameter is set in [pop](arkts-arkui-navigation-comp-navpathstack-c.md#pop-1), [popToName](arkts-arkui-navigation-comp-navpathstack-c.md#poptoname-1), or [popToIndex](arkts-arkui-navigation-comp-navpathstack-c.md#poptoindex-1).<br>**Since:** 11 |
...
Unique ID of the navigation destination page. This ID is system-generated and globally unique. It can be obtained using the [getPathStack](arkts-arkui-navigation-comp-navpathstack-c.md#getpathstack) API and should not be manually reassigned.
...
Callback returned when [pop](arkts-arkui-navigation-comp-navpathstack-c.md#pop-1), [popToName](arkts-arkui-navigation-comp-navpathstack-c.md#poptoname-1), or [popToIndex](arkts-arkui-navigation-comp-navpathstack-c.md#poptoindex-1) is called on the navigation destination page. It is triggered only when the **result** parameter is set in [pop](arkts-arkui-navigation-comp-navpathstack-c.md#pop-1), [popToName](arkts-arkui-navigation-comp-navpathstack-c.md#poptoname-1), or [popToIndex](arkts-arkui-navigation-comp-navpathstack-c.md#poptoindex-1).

**Type:** import('../api/@ohos.base').Callback&lt;[PopInfo](arkts-arkui-navigation-comp-popinfo-i.md)&gt;
