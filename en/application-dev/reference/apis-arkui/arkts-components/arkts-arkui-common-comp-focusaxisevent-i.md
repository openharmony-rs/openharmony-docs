...
Describes the focus axis event object. Inherits from [BaseEvent](arkts-arkui-common-comp-baseevent-i.md).

**Inheritance/Implementation:** FocusAxisEvent extends [BaseEvent](arkts-arkui-common-comp-baseevent-i.md)
