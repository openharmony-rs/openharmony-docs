...
Gradual transition from the menu preview to the final drag preview with opacity and size animations. Disabled when **DISABLE_SCALE** is set in [DragPreviewMode](arkts-arkui-common-comp-dragpreviewmode-e.md). Suitable for significant visual differences between preview images.
