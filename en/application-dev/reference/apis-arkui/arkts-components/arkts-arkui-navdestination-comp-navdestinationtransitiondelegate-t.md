...
| --- | --- | --- | --- |
| operation | [NavigationOperation](arkts-arkui-navigation-comp-navigationoperation-e.md) | Yes | Type of navigation operation for the current page transition. |
...
| Type | Description |
| --- | --- |
| Array&lt;[NavDestinationTransition](arkts-arkui-navdestination-comp-navdestinationtransition-i.md)&gt; &#124; undefined | Array of custom animations for the **NavDestination** page. If **undefined** is returned, the default system animation is used. |
