...
| event | [HoverEvent](arkts-arkui-common-comp-hoverevent-i.md) | Yes | Mouse hover event object, which contains the detailed information about the hover event (such as the mouse position). |
