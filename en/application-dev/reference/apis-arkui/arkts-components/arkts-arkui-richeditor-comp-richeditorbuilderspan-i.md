...
Callback triggered when the BuilderSpan is attached to **RichEditor**. The callback receives a [BuilderSpanInfo](arkts-arkui-richeditor-comp-builderspaninfo-i.md) object containing the id and offset.

**Type:** Callback&lt;[BuilderSpanInfo](arkts-arkui-richeditor-comp-builderspaninfo-i.md)&gt;
