...
| extraInfo | [SwiperAnimationEvent](arkts-arkui-swiper-comp-swiperanimationevent-i.md) | Yes | Extra information of the animation, including the offset of the currently displayed element and target element relative to the start position of the **Swiper** along the main axis, and the hands-off velocity. |
