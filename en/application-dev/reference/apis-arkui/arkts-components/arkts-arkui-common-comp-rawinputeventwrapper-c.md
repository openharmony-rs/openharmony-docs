...
> not provide valid values: the trigger object [target](arkts-arkui-common-comp-eventtarget-i.md), coordinates relative to the component
> [x](arkts-arkui-common-comp-mouseevent-i.md#x) and [y](arkts-arkui-common-comp-mouseevent-i.md#y), [getCurrentLocalPosition](arkts-arkui-common-comp-touchobject-i.md#getcurrentlocalposition)
> and [stopPropagation](arkts-arkui-common-comp-touchevent-i.md#stoppropagation) methods, [preventDefault](arkts-arkui-common-comp-touchevent-i.md#preventdefault) and
> [getHistoricalPoints](arkts-arkui-common-comp-touchevent-i.md#gethistoricalpoints) methods of **TouchEvent**, as well as the [metaKey](arkts-arkui-common-comp-keyevent-i.md#metakey)
> attribute and [getModifierKeyState](arkts-arkui-common-comp-keyevent-i.md#getmodifierkeystate) method of **KeyEvent**.
