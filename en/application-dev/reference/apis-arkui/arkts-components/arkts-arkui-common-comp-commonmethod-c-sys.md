...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | [EdgeLightParams](arkts-arkui-common-comp-edgelightparams-i-sys.md) &#124; undefined | Yes | Edge light effect parameters. Defines the position, length, intensity, color, and thickness of the light effect. If params is undefined, the edge light effect is removed. |
...
| Name | Type | Mandatory | Description |
| --- | --- | --- | --- |
| params | [SpatialEffectParams](arkts-arkui-common-comp-spatialeffectparams-i-sys.md) &#124; undefined | Yes | Spatial effect parameters. |
...
| options | [GravityCenterOptions](arkts-arkui-common-comp-gravitycenteroptions-i-sys.md) | No | Gravitational center parameter. GRAVITY_UNION. |
