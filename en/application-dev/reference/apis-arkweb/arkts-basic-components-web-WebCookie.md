...
>
> - This API is supported since API version 8 and deprecated since API version 23. You are advised to use [WebCookieManager](./arkts-apis-webview-WebCookieManager.md) instead.
>
