...
| --- | --- | --- | --- |
| result | [PinVerifyResult](arkts-arkweb-web-comp-pinverifyresult-e.md) | Yes | PIN authentication result. If successful, the Web component allows subsequent page operations; if failed, page navigation or content loading may be blocked. |
