...
| Type | Description |
| --- | --- |
| [ContextMenuDataMediaType](arkts-arkweb-web-comp-contextmenudatamediatype-e.md) | Media type of the web element, including image, video, audio, and other types, used to distinguish the type of web element tapped by the user. |
...
| Type | Description |
| --- | --- |
| number | Obtains the editable flag of the web element. See [ContextMenuEditStateFlags](arkts-arkweb-web-comp-contextmenueditstateflags-e.md). |
...
| Type | Description |
| --- | --- |
| [ContextMenuInputFieldType](arkts-arkweb-web-comp-contextmenuinputfieldtype-e.md) | Type of the web element input field, including text, password, email, and other types. It is used to identify the type of the input element that currently has focus. |
...
| Type | Description |
| --- | --- |
| [ContextMenuMediaType](arkts-arkweb-web-comp-contextmenumediatype-e.md) | Media type of the web page element. |
...
| Type | Description |
| --- | --- |
| [ContextMenuSourceType](arkts-arkweb-web-comp-contextmenusourcetype-e.md) | Type of the trigger source for the context menu event, including right-click, long press, and other trigger methods. |
