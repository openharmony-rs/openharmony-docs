...
| --- | --- | --- | --- |
| controller | [WebviewController](arkts-arkweb-web-comp-webviewcontroller-t.md) | Yes | **WebviewController** object of the **Web** component. If opening a new window is not needed, set it to **null**. |
