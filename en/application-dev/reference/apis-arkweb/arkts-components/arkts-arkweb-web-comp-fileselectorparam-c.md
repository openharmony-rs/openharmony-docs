...
| Type | Description |
| --- | --- |
| Array&lt;Array&lt;[AcceptableFileType](arkts-arkweb-web-comp-acceptablefiletype-i.md)&gt;&gt; | File type information, which is a two-dimensional array structure containing detailed information about multiple groups of optional file types. Corresponds to the types attribute of the HTML option. |
...
| Type | Description |
| --- | --- |
| [FileSelectorMode](arkts-arkweb-web-comp-fileselectormode-e.md) | Mode of the file selector. |
