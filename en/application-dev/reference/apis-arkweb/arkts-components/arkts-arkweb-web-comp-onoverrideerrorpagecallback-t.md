...
| --- | --- | --- | --- |
| errorPageEvent | [OnErrorReceiveEvent](arkts-arkweb-web-comp-onerrorreceiveevent-i.md) | Yes | Information returned when an error occurs during web page loading. |
