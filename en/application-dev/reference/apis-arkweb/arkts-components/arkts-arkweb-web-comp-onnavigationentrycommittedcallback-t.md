...
| --- | --- | --- | --- |
| loadCommittedDetails | [LoadCommittedDetails](arkts-arkweb-web-comp-loadcommitteddetails-i.md) | Yes | Detailed information about the web page that has been submitted for redirection. |
