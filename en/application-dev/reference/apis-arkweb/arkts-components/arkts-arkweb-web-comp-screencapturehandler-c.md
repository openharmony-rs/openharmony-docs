...
| --- | --- | --- | --- |
| config | [ScreenCaptureConfig](arkts-arkweb-web-comp-screencaptureconfig-i.md) | Yes | Screen capture configuration, which is used to set screen capture related parameters. |
