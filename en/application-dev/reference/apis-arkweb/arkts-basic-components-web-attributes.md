...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=d96db6dbe792bc577106b8fe7b2f1f6d0125cb3e translatedAt=2026-09-09T03:09:44.425Z pushedAt=2026-09-09T04:24:15.437Z -->
...
| type   | [ScrollDirectionalLockType](./arkts-basic-components-web-e.md#scrolldirectionallocktype) | Yes   | Sets the scenarios in which the **Web** component expects scroll direction locking. **ALL** indicates that scroll locking is supported in all scenarios, and **NESTED_SCROLL** indicates that scroll locking is supported in nested scrolling scenarios. |
...
| Name | Type | Mandatory | Description |
| ------ | --------- | ---- | ---- |
| mode | [WebKeyboardAppearanceMode](./arkts-basic-components-web-e.md#webkeyboardappearancemode)| Yes   | Keyboard appearance. When undefined or null is passed in, the system immersive mode is followed.|
