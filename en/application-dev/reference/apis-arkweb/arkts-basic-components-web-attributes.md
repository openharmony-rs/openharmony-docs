...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=4180bb2e440d5dee76207e80672383a5f25809b4 translatedAt=2026-08-07T04:34:58.488Z pushedAt=2026-08-11T12:11:17.443Z -->
...
| Name               | Type   | Mandatory  | Description           |
| ------------------ | ------- | ---- | --------------- |
| overviewModeAccess | boolean | Yes | Whether to load web pages in overview mode.<br>The value **true** means to use overview mode, and **false** means not to use it.<br>The value is **false** when undefined or null is passed in. |
...
| Name                | Type   | Mandatory  | Description        |
| ------------------- | ------- | ---- | ------------ |
| horizontalScrollBar | boolean | Yes | Sets whether to display the horizontal scrollbar.<br>The value **true** indicates to display it, and **false** indicates not to display it.<br>The value is **false** when undefined or null is passed. |
