...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=1f6cc3ba85c864561fe81db43629f4f14168f7b4 translatedAt=2026-08-25T13:04:08.477Z pushedAt=2026-08-26T11:32:19.013Z -->
...
Obtains the cookies corresponding to the specified URL.
...
> 
> - To obtain usable cookies, you are advised to pass a complete URL to fetchCookieSync.
> 
> - fetchCookieSync is used to obtain all cookies. Each cookie value is separated by "; ", but a specific cookie value cannot be obtained individually.
...
| ------ | ------ | ---- | :------------------------ |
| url    | string | Yes   | URL for which the cookies are to be obtained. A complete URL is recommended. |
...
| Name | Type   | Mandatory | Description                      |
| ------ | ------ | ---- | :------------------------ |
| url    | string | Yes  | URL of the cookies to obtain. A complete URL is recommended. |
| incognito    | boolean | No   | The value true means to obtain the in-memory cookies of the webview in Privacy Mode, and false means to obtain the cookies in non-Privacy Mode.<br>Default value: false.<br>If undefined or null is passed in, error code 401 is thrown. |
| includePartitionedCookies | boolean | No | Whether to allow obtaining first-party partitioned cookies. The value true means allowed, and false means not allowed.<br>Default value: false.<br>If undefined or null is passed in, error code 401 is thrown. |
...
Obtains the cookies corresponding to a specified URL. This API uses an asynchronous callback to return the result.
...
| ------ | ------ | ---- | :------------------------ |
| url    | string | Yes   | URL for which the cookies are to be obtained. A complete URL is recommended. |
| callback | AsyncCallback\<string> | Yes | Callback Function used to obtain the cookies. |
...
Obtains the cookies corresponding to a specified URL. This API uses a promise to return the result.
...
| Type  | Description                     |
| ------ | ------------------------- |
| Promise\<string> | Promise used to return the cookies corresponding to the specified URL. |
...
| ------ | ------ | ---- | :------------------------ |
| url    | string | Yes   | URL of the cookies to obtain. A complete URL is recommended. |
| incognito    | boolean | Yes   | The value true indicates obtaining the in-memory cookies of the webview in Privacy Mode, and false indicates obtaining cookies in non-Privacy Mode. <br>Passing undefined or null throws error code 401. |
| includePartitionedCookies | boolean | Yes | Whether to allow obtaining first-party partitioned cookies. The value true indicates allowed, and false indicates not allowed. <br>Passing undefined or null throws error code 401. |
...
| Name | Type | Mandatory | Description |
| --------- | ------- | -- | -------------------------------------- |
| incognito | boolean | Yes | true indicates obtaining all cookies of the webview in privacy mode, and false indicates all cookies in normal non-privacy mode. |
...
> **NOTE**
>
> - In configCookieSync, you can specify a domain name in the URL so that in-page requests also carry cookies.
>
...
| url    | string | Yes   | URL of the cookie to set. A complete URL is recommended. |
| value  | string | Yes  | Cookie value to set.     |
| incognito    | boolean | Yes   | Whether to set the cookie in incognito mode. The value **true** means to set the cookie in incognito mode, and **false** means the opposite. |
...
> **NOTE**
>
> - In configCookie, you can specify a domain name in the URL so that in-page requests also carry the cookies.
>
> - Cookies are periodically saved to the disk every 30 seconds. You can also use [saveCookieAsync](#savecookieasync) for force storage.
>
> - The value parameter must follow the format of the Set-Cookie HTTP response header. It is a key-value pair in the form of "key=value", optionally followed by a cookie property list separated by "; " (for example, "key=value; Max-Age=100").
...
| url    | string | Yes   | URL of the cookie to set. A complete URL is recommended. |
| value  | string | Yes  | Cookie value to set.     |
| callback | AsyncCallback\<void> | Yes | Callback Function used to return the result of setting the cookie. |
...
| Type  | Description                     |
| ------ | ------------------------- |
| Promise\<void> | Promise used to return whether the cookie is successfully set for the specified URL. |
...
| Name  | Type                  | Mandatory| Description                                              |
| -------- | ---------------------- | ---- | :------------------------------------------------- |
| callback | AsyncCallback\<void> | Yes | Callback used to indicate whether the cookies are saved successfully. |
...
| Type            | Description                                     |
| ---------------- | ----------------------------------------- |
| Promise\<void> | Promise used to return whether the cookies are saved successfully. |
...
| Type   | Description                                  |
| ------- | -------------------------------------- |
| boolean | The value **true** means that cookies exist, and **false** means the opposite. |
...
| Type            | Description                                     |
| ---------------- | ----------------------------------------- |
| Promise\<void> | Promise used to return the result of clearing all cookies. |
...
| Type            | Description                                     |
| ---------------- | ----------------------------------------- |
| Promise\<void> | Promise used to return the result of clearing all session cookies. |
...
| Type  | Description                     |
| ------ | ------------------------- |
| string | Cookies value corresponding to the specified URL. |
