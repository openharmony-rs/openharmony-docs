...
Implements a **NativeMediaPlayerBridge** object to bridge the web page media player and the ArkWeb kernel. This object is a return value type of the [CreateNativeMediaPlayerCallback](./arkts-apis-webview-t.md#createnativemediaplayercallback12) callback.
