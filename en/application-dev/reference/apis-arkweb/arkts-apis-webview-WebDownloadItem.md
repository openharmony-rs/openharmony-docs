...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=5191f5de3eca0919d8d5e44823dbef1bf6b74270 translatedAt=2026-09-09T03:13:24.579Z pushedAt=2026-09-09T04:23:11.894Z -->
...
| Type  | Description                     |
| ------ | ------------------------- |
| number | Total length of the file to be downloaded. -1 indicates that the total size is unknown. Unit: byte. |
...
| Type  | Description                     |
| ------ | ------------------------- |
| [WebDownloadState](./arkts-apis-webview-e.md#webdownloadstate11) | Download state.|
...
| Type  | Description                     |
| ------ | ------------------------- |
| WebDownloadItem | **WebDownloadItem** object.|
...
| Name| Type                  | Mandatory| Description                            |
| ------ | ---------------------- | ---- | ------------------------------|
| downloadPath   | string     | Yes  | Path of the download file (including the file name). The path length is the same as that in file management, with a maximum of 255 bytes. |
