...
| ERR_ADD_INVALID_PARAM     | 7    | Invalid parameter passed when adding a widget.  |
...
| ERR_MAX_SYSTEM_TEMP_FORMS       | 16    | The number of system temporary widgets exceeds the upper limit.  |
