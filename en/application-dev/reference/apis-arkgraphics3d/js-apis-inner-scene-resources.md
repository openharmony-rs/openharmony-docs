...
| Type| Description|
| ---- | ---- |
| Object \| null \| undefined | Special effect property value. If the current effect type does not contain the property that matches the input propertyName, the obtaining fails and **null** is returned. If the optional property corresponding to the propertyName is not set, **undefined** is returned.|
