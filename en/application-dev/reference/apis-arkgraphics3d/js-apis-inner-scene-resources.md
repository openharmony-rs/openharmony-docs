...
<!--Tester: @zhangyue283-->
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=943c6a9d177f6e87860158abc76387727f97f346 translatedAt=2026-08-25T13:20:11.981Z pushedAt=2026-08-26T07:04:06.759Z -->
...
function stop(): void {
  ...
  scene.then(async (result: Scene) => {
    if (result && result.animations && result.animations[0]) {
      let anim: Animation = result.animations[0];
      // Stop playing the animation and set its progress to 0.
      anim.stop();
    }
  });
}
...
| Name | Type | Read Only | Optional | Description |
| ---- | ---- | ---- | ---- | ---- |
| surfaceId | string | Yes | No | Stream ID, consisting of numeric characters. The value must be an integer greater than 0. |

## Effect<sup>21+</sup>

Effect type, which inherits from [SceneResource](#sceneresource). It is obtained from the [createEffect](js-apis-inner-scene.md#createeffect21) API.
