...
Obtains a profile instance. **HidHostProfile** and **PanProfile** are added in API version 9.
...
| callback | Callback&lt;[StateChangeParam](#statechangeparamdeprecated)&gt; | Yes   | Callback used to return the connection state change.                              |
