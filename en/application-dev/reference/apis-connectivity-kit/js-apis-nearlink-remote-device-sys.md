...
Cancels an ongoing pairing request. This API uses a promise to return the result.
...
| Name| Type| Mandatory| Description|
| -------- | -------- | -------- | -------- |
| callback | Callback&lt;[PairingRequestParam](js-apis-nearlink-remote-device.md#pairingrequestparam)&gt; | No| Callback used to return the pairing request field.<br>If this parameter is specified, the current callback is unregistered. If this parameter is not set, all callbacks corresponding to the event are unsubscribed.| 
