...
- Method 1: Configure a certificate for connection. The key fields in [WifiDeviceConfig](#wifideviceconfig) are configured as follows:
 ...
 - Method 2: Configure preSharedKey for connection. The key fields in [WifiDeviceConfig](#wifideviceconfig) are configured as follows:
...
**Parameters**
  ...
  | callback | Callback&lt;[WifiP2pLinkedInfo](#wifip2plinkedinfo)&gt; | Yes| Callback used to return the P2P connection changes.|
...
**Parameters**
  ...
  | callback | Callback&lt;[WifiP2pDevice](#wifip2pdevice)&gt; | Yes| Callback used to return the P2P device changes.|
