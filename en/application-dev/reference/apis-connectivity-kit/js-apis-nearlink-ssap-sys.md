...
Reads a server descriptor. This method can only be used after a connection is successfully established by calling [connect](js-apis-nearlink-ssap.md#connect). This API uses a promise to return the result.
