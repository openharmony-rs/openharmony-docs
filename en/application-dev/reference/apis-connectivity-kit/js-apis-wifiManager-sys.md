...
Adds and registers a DNS-SD (DNS Service Discovery, DNS-based service discovery) local P2P service description.
...
Adds and registers a UPnP local P2P service description.
