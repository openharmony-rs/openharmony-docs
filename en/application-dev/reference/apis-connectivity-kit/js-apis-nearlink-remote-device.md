...
| Name| Type| Mandatory| Description|
| -------- | -------- | -------- | -------- |
| callback | Callback&lt;[PairingStateParam](#pairingstateparam)&gt; | No| Callback used to return the result of the pairing status change event.<br>If this parameter is specified, the current callback is unregistered. If this parameter is not set, all callbacks corresponding to the event are unregistered.|
...
| Name| Type| Mandatory| Description|
| -------- | -------- | -------- | -------- |
| callback | Callback&lt;[ConnectionStateParam](#connectionstateparam)&gt; | No| Callback used to return the result of the connection status change event.<br>If this parameter is specified, the current callback is unregistered. If this parameter is not set, all callbacks corresponding to the event are unregistered.|
...
| Name| Type| Mandatory| Description|
| -------- | -------- | -------- | -------- |
| callback | Callback&lt;[AcbStateParam](#acbstateparam)&gt; | No| Callback used to return the result of the logical link connection status change event.<br>If this parameter is specified, the current callback is unregistered. If this parameter is not set, all callbacks corresponding to the event are unregistered.|
...
| Name| Type| Read-Only| Optional| Description|
| -------- | -------- | -------- | -------- | -------- |
| address | string | No| No| Device address, indicating that the connection status with the device has changed. The address format is **11:22:33:AA:BB:FF**.|
...
| reasonMsg | string | No| Yes| Reason details. This field is used only for log information and is not used for logic processing. If no reason details are available, this field is an empty string by default.|
...
| CONNECTION_FAIL_ACB_CONNECTION | 4 | ACB connection failed. The possible cause is the remote device is powered off or the device is too far away.|
...
| Name| Type| Read-Only| Optional| Description|
| -------- | -------- | -------- | -------- | -------- |
| address | string | No| No| Device address, indicating that the pairing status with the device changes. The address format is 11:22:33:AA:BB:FF.|
