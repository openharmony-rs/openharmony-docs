...
| [key: string] | Object | No | Yes | Custom parameters.<br/>- isFullScreen: Type boolean. Custom parameter for splash ads, used to identify whether the returned ad is full-screen. true indicates a full-screen ad, and false indicates a half-screen ad.<br/>- biddingInfo: Type Object. Used to obtain real-time bidding related results.<br/>- biddingInfo.price: Type number. The eCPM (Effective Cost Per Mille) of this ad, which is the ad revenue per thousand impressions.<br/>- biddingInfo.cur: Type string. The currency of the price for this ad. Supported currencies: CNY, USD, EUR, GBP, and JPY.<br/>- biddingInfo.nurl: Type string. The URL for the media to report the successful bidding result.<br/>- biddingInfo.lurl: Type string. The URL for the media to report the failed bidding result and notify other DSPs of the successful bidding result. |