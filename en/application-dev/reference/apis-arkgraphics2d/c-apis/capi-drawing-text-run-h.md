...
| -- | -- |
| OH_Drawing_Run* run | Pointer to an [OH_Drawing_Run](capi-drawing-oh-drawing-run.md) object. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Canvas* canvas | Pointer to an [OH_Drawing_Canvas](capi-drawing-oh-drawing-canvas.md) object. |
| OH_Drawing_Run* run | Pointer to an [OH_Drawing_Run](capi-drawing-oh-drawing-run.md) object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Rect* | Returns the pointer to an [OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md) object. Call [OH_Drawing_DestroyRunImageBounds](capi-drawing-text-run-h.md#oh_drawing_destroyrunimagebounds) to      release this pointer when the object is no longer needed. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Rect* rect | Pointer to the image boundary, which is an [OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md) object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Array* | Returns the pointer to an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object of a glyph array in a run. Call      [OH_Drawing_DestroyRunGlyphs](capi-drawing-text-run-h.md#oh_drawing_destroyrunglyphs) to release this pointer when the object is no longer needed. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Array* glyphs | Pointer to the glyph array, which is an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Array* | Returns the pointer to an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object of a glyph position array in a run. Call      [OH_Drawing_DestroyRunPositions](capi-drawing-text-run-h.md#oh_drawing_destroyrunpositions) to release this pointer when the object is no longer needed. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Array* positions | Pointer to the glyph position array, which is an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Point* | Returns the pointer to an [OH_Drawing_Point](capi-drawing-oh-drawing-point.md) object, which holds the positions of individual glyphs in      the run. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Font* | Returns the pointer to an [OH_Drawing_Font](capi-drawing-oh-drawing-font.md) object in a run. Call [OH_Drawing_FontDestroy](capi-drawing-font-h.md#oh_drawing_fontdestroy) to      release this pointer when the object is no longer needed. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_TextDirection | Returns the text direction of a run. 0: TEXT_DIRECTION_RTL, which means right-to-left; 1:       TEXT_DIRECTION_LTR, which means left-to-right. For details, see [OH_Drawing_TextDirection](capi-drawing-text-typography-h.md#oh_drawing_textdirection). |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Array* | Returns the pointer to an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object of a glyph advance array in a run. Call      [OH_Drawing_DestroyRunGlyphAdvances](capi-drawing-text-run-h.md#oh_drawing_destroyrunglyphadvances) to release this pointer when the object is no longer needed. |
...
| Parameter | Description |
| -- | -- |
| OH_Drawing_Array* advances | Pointer to the glyph advance array, which is an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object. |
...
| Type | Description |
| -- | -- |
| OH_Drawing_Point* | Returns the pointer to an [OH_Drawing_Point](capi-drawing-oh-drawing-point.md) object, which holds the advance of individual glyphs in      the run. x indicates the advance, and y is a reserved field and defaults to 0. |
