...
| Type| Description|
| -- | -- |
| [OH_Drawing_Array](capi-drawing-oh-drawing-array.md)* | Returns the pointer to an [OH_Drawing_Array](capi-drawing-oh-drawing-array.md) object of a glyph position array in a run. Call [OH_Drawing_DestroyRunGlyphAdvances](capi-drawing-text-run-h.md#oh_drawing_destroyrunglyphadvances) to release this pointer when the object is no longer needed.|
