...
| [OH_Drawing_ErrorCode OH_Drawing_PathIsInverseFillType(const OH_Drawing_Path* path, bool* isInverse)](#oh_drawing_pathisinversefilltype) | Checks whether the fill type of the path is the inverse type.<br>The inverse type is **PATH_FILL_TYPE_INVERSE_WINDING** and **PATH_FILL_TYPE_INVERSE_EVEN_ODD** in [OH_Drawing_PathFillType](capi-drawing-path-h.md#oh_drawing_pathfilltype).|
| [OH_Drawing_ErrorCode OH_Drawing_PathToggleInverseFillType(OH_Drawing_Path* path)](#oh_drawing_pathtoggleinversefilltype) | Toggles the fill type of the path to the inverse type.<br>The inverse type is **PATH_FILL_TYPE_INVERSE_WINDING** and **PATH_FILL_TYPE_INVERSE_EVEN_ODD** in [OH_Drawing_PathFillType](capi-drawing-path-h.md#oh_drawing_pathfilltype).|
...
The inverse type is **PATH_FILL_TYPE_INVERSE_WINDING** and **PATH_FILL_TYPE_INVERSE_EVEN_ODD** in [OH_Drawing_PathFillType](capi-drawing-path-h.md#oh_drawing_pathfilltype).
...
| bool* isInverse | Whether the fill type is the inverse type. It as an output parameter. **true** if the fill type is the inverse type; **false** otherwise.|
