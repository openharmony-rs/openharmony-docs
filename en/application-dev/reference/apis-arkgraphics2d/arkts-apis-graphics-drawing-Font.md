...
<!--Tester: @nobuggers-->
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=8ed03ffe90bb2522b0df0e44ac852e6dea1907ea translatedAt=2026-08-25T13:11:47.965Z pushedAt=2026-08-26T04:02:55.225Z -->
...
| Name    | Type                                               | Mandatory | Description                    |
| ------   | ------------------------------------------------   | ---- | ---------------------- |
|   text   |    string                                          | Yes   | Indicates the text string encoded in UTF-8 format.|
|byteLength|    number                                          | Yes   | Indicates the byte length of the text path to be obtained. The corresponding text path is obtained based on the minimum value between the passed byte length and the actual text byte size.|
|    x     |    number                                          | Yes   | Indicates the X coordinate of the text in the drawing area with the origin as the start position. The unit is physical pixels (px).|
|    y     |    number                                          | Yes   | Indicates the Y coordinate of the text in the drawing area with the origin as the start position. The unit is physical pixels (px).|

**Return value**

| Type   | Description             |
| ------ | ---------------- |
| [Path](arkts-apis-graphics-drawing-Path.md) | Returns the obtained text path outline. Returns undefined if the path object fails to be created. |
