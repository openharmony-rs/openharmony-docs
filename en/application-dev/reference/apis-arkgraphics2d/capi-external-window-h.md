...
| [OHScalingMode](#ohscalingmode) | OHScalingMode | Scaling mode. |
...
| [int32_t OH_NativeWindow_NativeObjectReference(void *obj)](#oh_nativewindow_nativeobjectreference) | Increments the reference count of a NativeObject.<br>This interface requires coordination with [OH_NativeWindow_NativeObjectUnreference](#oh_nativewindow_nativeobjectunreference); otherwise, a memory leak will occur.<br>This interface is non-thread-safe. |
...
| [int32_t OH_NativeWindow_CreateNativeWindowFromSurfaceId(uint64_t surfaceId, OHNativeWindow **window)](#oh_nativewindow_createnativewindowfromsurfaceid) | Creates the corresponding OHNativeWindow by surfaceId.<br>This interface requires coordination with [OH_NativeWindow_DestroyNativeWindow](#oh_nativewindow_destroynativewindow); otherwise, a memory leak will occur.<br>If OHNativeWindow is released concurrently, use [OH_NativeWindow_NativeObjectReference](#oh_nativewindow_nativeobjectreference) and [OH_NativeWindow_NativeObjectUnreference](#oh_nativewindow_nativeobjectunreference) to increment and decrement the reference count of OHNativeWindow.<br>The surface obtained by surfaceId must be created in the current process; it cannot be obtained across processes.<br>This interface is non-thread-safe. |
...
| [int32_t OH_NativeWindow_GetLastFlushedBufferV2(OHNativeWindow *window, OHNativeWindowBuffer **buffer,int *fenceFd, float matrix[16])](#oh_nativewindow_getlastflushedbufferv2) | Obtains from OHNativeWindow the OHNativeWindowBuffer last returned to the buffer queue. The difference from OH_NativeWindow_GetLastFlushedBuffer lies in the matrix.<br>This interface requires coordination with [OH_NativeWindow_NativeObjectUnreference](#oh_nativewindow_nativeobjectunreference); otherwise, a memory leak will occur.<br>This interface is non-thread-safe. |
...
| [int32_t OH_NativeWindow_Set3DMetadataValue(OHNativeWindow *window, OH_NativeBuffer_3D_MetadataKey metadataKey, int32_t size, uint8_t *metadata)](#oh_nativewindow_set3dmetadatavalue) | Sets the 3D metadata property value for OHNativeWindow.<br>This interface is non-thread-safe. |
| [int32_t OH_NativeWindow_Get3DMetadataValue(OHNativeWindow *window, OH_NativeBuffer_3D_MetadataKey metadataKey, int32_t *size, uint8_t **metadata)](#oh_nativewindow_get3dmetadatavalue) | Obtains the 3D metadata property value of OHNativeWindow.<br>This interface is non-thread-safe. |
...
| SET_TIMEOUT | Set the timeout waiting time for the local window to request buffers. The default value is 3000 milliseconds when not manually set. The variable parameter in the function is [input] int32_t timeout, in milliseconds. |
| GET_TIMEOUT | Get the timeout waiting time for the local window to request buffers. The default value is 3000 milliseconds when not manually set. The variable parameter in the function is [output] int32_t *timeout, in milliseconds. |
...
| GET_BUFFERQUEUE_SIZE | Get the buffer queue size. The variable parameter in the function is [output] int32_t \*size.<br/>**Since Version:** 12 |
...
| Name| Description|
| -- | -- |
| void* pSurface | A pointer to the producer ProducerSurface, of type sptr\<OHOS::Surface>. |
...
| Name| Description|
| -- | -- |
| void* pSurfaceBuffer | A pointer to the producer buffer, of type sptr\<OHOS\:\:SurfaceBuffer\>. |
...
Creates an OHNativeWindowBuffer instance. Each call produces a new OHNativeWindowBuffer instance.<br>This interface requires coordination with [OH_NativeWindow_DestroyNativeWindowBuffer](#oh_nativewindow_destroynativewindowbuffer); otherwise, a memory leak will occur.<br>This interface is non-thread-safe.
...
Applies for an OHNativeWindowBuffer through the OHNativeWindow object, used for content production.<br>When calling this interface, you need to set the width and height of the OHNativeWindow through [SET_BUFFER_GEOMETRY](#nativewindowoperation).<br>If the width and height are not set, the default width and height set by the consumer will be used.<br>This interface requires coordination with [OH_NativeWindow_NativeWindowFlushBuffer](#oh_nativewindow_nativewindowflushbuffer); otherwise, memory will be exhausted.<br>When fenceFd is no longer used, the user needs to close it.<br>This interface is non-thread-safe.
...
| [Region](capi-nativewindow-region.md) region | A Region struct that represents a dirty region whose content has been updated.<br>The maximum number of Region.rectNumber is 1000. When rectNumber ≤ 0 or rectNumber > 1000, the entire buffer is used as the dirty region.<br>The coordinate origin of Region.rect is the lower-left corner of the buffer. |
...
| matrix |  Indicates the retrieved 4\*4 transformation matrix. |
...
| Type| Description|
| -- | -- |
| [BufferHandle](capi-nativewindow-bufferhandle.md)* | Returns a pointer to the [BufferHandle](capi-nativewindow-bufferhandle.md) structure instance. |
...
Increments the reference count of a NativeObject.<br>This interface requires coordination with [OH_NativeWindow_NativeObjectUnreference](#oh_nativewindow_nativeobjectunreference); otherwise there will be a memory leak.<br>This interface is a non-thread-safe type interface.
...
| [OHNativeWindow](capi-nativewindow-nativewindow.md) *window | Pointer to an **OHNativeWindow** instance.|
| uint32_t sequence | Sequence of the producer buffer.|
| int32_t size | Size of the OHHDRMetaData array. The maximum supported value is 3000. If the value exceeds this limit, NATIVE_ERROR_INVALID_ARGUMENTS is returned. |
...
| int32_t size | Size of the uint8_t vector. The maximum supported value is 3000. If it exceeds this value, NATIVE_ERROR_INVALID_ARGUMENTS is returned. |
...
| Type| Description|
| -- | -- |
| int32_t | The return value 0 indicates that the execution succeeds. For other return values, see [OHNativeErrorCode](capi-graphic-error-code-h.md#ohnativeerrorcode). |
...
Creates the corresponding OHNativeWindow by surfaceId.<br>This interface requires coordination with [OH_NativeWindow_DestroyNativeWindow](#oh_nativewindow_destroynativewindow); otherwise, a memory leak will occur.<br>If OHNativeWindow is released concurrently, you need to increment and decrement the reference count of OHNativeWindow through [OH_NativeWindow_NativeObjectReference](#oh_nativewindow_nativeobjectreference) and [OH_NativeWindow_NativeObjectUnreference](#oh_nativewindow_nativeobjectunreference).<br>The surface obtained by surfaceId must be created in the current process and cannot be obtained across processes.<br>This interface is non-thread-safe.
...
| [OHNativeWindowBuffer](capi-nativewindow-nativewindowbuffer.md) **buffer | Double pointer to an **OHNativeWindowBuffer** instance.|
| int *fenceFd | Pointer to a file descriptor.|
| matrix |  Represents the retrieved 4*4 transformation matrix. |
...
| -- | -- |
| [OHNativeWindow](capi-nativewindow-nativewindow.md) *window | Pointer to an [OHNativeWindow](capi-nativewindow-nativewindow.md) instance.|
| [OH_NativeBuffer_MetadataKey](capi-buffer-common-h.md#oh_nativebuffer_metadatakey) metadataKey | Metadata type of OHNativeWindow. Its value is obtained from [OH_NativeBuffer_MetadataKey](capi-buffer-common-h.md#oh_nativebuffer_metadatakey). |
...
| metadata |  Pointer to a uint8_t vector. |
...
| int32_t *size | Size of the uint8_t vector. For details about the value range, see [OH_NativeBuffer_MetadataKey](capi-buffer-common-h.md#oh_nativebuffer_metadatakey).|
| metadata |  Double pointer to a uint8_t vector. |
...
| -- | -- |
| [OHNativeWindow](capi-nativewindow-nativewindow.md)* window | Pointer to the **OHNativeWindow** struct instance.|
| [Region](capi-nativewindow-region.md) region | A Region struct that represents a dirty region whose content has been updated.<br>The maximum number of Region.rectNumber is 1000. When rectNumber is less than or equal to 0 or greater than 1000, the entire buffer is used as the dirty region.<br>Region.rect uses the lower-left corner of the buffer as the coordinate origin. |
...
| Type| Description|
| -- | -- |
| int32_t | Returns NATIVE_ERROR_OK when execution succeeds.<br>Returns NATIVE_ERROR_INVALID_ARGUMENTS when window or buffer is a null pointer.<br>Returns NATIVE_ERROR_UNKNOWN when the surface member of window is a null pointer.<br>For other return values, see [OHNativeErrorCode](capi-graphic-error-code-h.md#ohnativeerrorcode). |
...
| Type| Description|
| -- | -- |
| int32_t | Returns NATIVE_ERROR_OK when the execution is successful.<br>Returns NATIVE_ERROR_INVALID_ARGUMENTS when window is a null pointer.<br>Returns NATIVE_ERROR_UNKNOWN when the surface member of window is a null pointer.<br>For other return values, see [OHNativeErrorCode](capi-graphic-error-code-h.md#ohnativeerrorcode). |
...
Sets the 3D metadata property value for OHNativeWindow.
...
Obtains the 3D metadata property value of an OHNativeWindow.
...
| Type | Description |
| -- | -- |
| int32_t | Returns NATIVE_ERROR_OK when the execution is successful.<br>Returns NATIVE_ERROR_INVALID_ARGUMENTS when window, metadata, or size is a null pointer.<br>Returns NATIVE_ERROR_UNKNOWN when copying or allocating memory fails, or obtaining the 3D metadata fails.<br>Returns NATIVE_ERROR_UNSUPPORTED when an unsupported metadataKey is passed in.<br>For other return values, see [OHNativeErrorCode](capi-graphic-error-code-h.md#ohnativeerrorcode). |