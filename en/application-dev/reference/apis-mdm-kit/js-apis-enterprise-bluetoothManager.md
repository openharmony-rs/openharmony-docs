...
Adds Bluetooth devices to the trustlist. After adding devices to this list, the current device will only be allowed to connect to Bluetooth devices in the list. It is recommended that the MAC addresses added to the array comply with the Bluetooth MAC address specifications (for example, 00:1A:2B:3C:4D:5E).
...
Adds Bluetooth devices to the blocklist. The current device cannot connect to the disallowed Bluetooth devices. It is recommended that the MAC addresses added to the array comply with the Bluetooth MAC address specifications (for example, 00:1A:2B:3C:4D:5E).
