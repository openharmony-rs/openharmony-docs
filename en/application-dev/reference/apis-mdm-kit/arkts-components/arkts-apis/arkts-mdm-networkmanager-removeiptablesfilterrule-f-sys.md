# removeIptablesFilterRule (System API)
...
| filterRule | [RemoveFilterRule](arkts-mdm-networkmanager-removefilterrule-i-sys.md) | Yes | Network packet filtering rule to remove. |
