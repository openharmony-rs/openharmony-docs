...
| Name     | Type                       | Read-Only| Optional     | Description        |
| -------- | -------------------------|----|---------| ------------- |
| name   | string | No |  No      | Name of the media key status attribute. Common names include the media key expiration time and content protection level. The available names are determined by the DRM solution.     |
