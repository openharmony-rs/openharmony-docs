...
| [bool OH_MediaKeySystem_IsSupported2(const char *name, const char *mimeType)](#oh_mediakeysystem_issupported2) | - | Checks whether the device supports the specifed DRM solution and MIME type. You can use the [OH_MediaKeySystem_IsSupported](#oh_mediakeysystem_issupported) API to check whether the device supports the DRM solution specified by **name**.|
