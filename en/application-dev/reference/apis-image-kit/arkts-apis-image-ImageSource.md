...
This API applies only to images that are in JPEG, PNG, and HEIF<sup>12+</sup> format and contain the Exif information. (The supported formats may vary depending on the hardware.)
...
This API applies only to images that are in JPEG, PNG, or HEIF<sup>12+</sup> format and contain the Exif information. (The supported formats may vary depending on the hardware.)
