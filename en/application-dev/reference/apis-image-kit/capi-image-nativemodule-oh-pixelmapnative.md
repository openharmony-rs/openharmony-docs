...
| bool, bool | shouldFlipHorizontally, shouldFlipVertically | Whether the PixelMap is flipped horizontally or vertically.| [OH_PixelmapNative_Flip](capi-pixelmap-native-h.md#oh_pixelmapnative_flip) | Flips a PixelMap based on a given angle.|
