...
| :------------ | :------------ | :------------ | :------------ |
|  sourceImage | [image.PixelMap](arkts-apis-image-PixelMap.md)  | Yes | Input image, which must be allocated in DMA memory. For details, see [PixelMap Memory Types](../../media/image/image-allocator-type.md#pixelmap-memory-types).|
