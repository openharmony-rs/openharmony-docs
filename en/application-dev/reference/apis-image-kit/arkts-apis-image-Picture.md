...
Composites an HDR image and returns PixelMap of the image. Composition options (such as PixelMapFormat) are supported. This API uses a promise to return the result.
