...
- Header file<!--imagekit-headerfile-->
    ...
    - [image_packer_native.h(System API)](capi-image-packer-native-h-sys.md)
    - [picture_native.h](capi-picture-native-h.md)
    - [picture_native.h(System API)](capi-picture-native-h-sys.md)
    - [image_native.h](capi-image-native-h.md)
    - [image_common.h](capi-image-common-h.md)
    - [image_common.h(System API)](capi-image-common-h-sys.md)
    - [image_source_native.h](capi-image-source-native-h.md)
    - [image_source_native.h(System API)](capi-image-source-native-h-sys.md)
...
- Struct<!--imagekit-struct-->
    ...
    - [OH_DecomposeOptions(System API)](capi-image-nativemodule-oh-decomposeoptions-sys.md)
