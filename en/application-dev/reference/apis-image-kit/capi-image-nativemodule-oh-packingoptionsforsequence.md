...
| uint32_t * | disposalTypes | Number of frames.| [OH_PackingOptionsForSequence_GetDisposalTypes](capi-image-packer-native-h.md#oh_packingoptionsforsequence_getdisposaltypes) | Obtains the disposal type array of images during encoding.|
