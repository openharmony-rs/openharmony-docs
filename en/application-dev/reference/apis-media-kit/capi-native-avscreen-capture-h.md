...
| -- | -- |
| [OH_AVScreenCapture_UserSelectionInfo](capi-avscreencapture-oh-avscreencapture-userselectioninfo.md) *selection | Pointer to the OH_AVScreenCapture_UserSelectionInfo instance.|
| uint64_t** displayIds | Double pointer to the array of display IDs selected by the user. The memory of the **displayIds** parameter is managed by **OH_AVScreenCapture_UserSelectionInfo** and does not need to be manually released.|
