...
Sets a source of streaming media that can be pre-downloaded, downloads the media data, and temporarily stores the data in the memory. This API uses a promise to return the result. For details about how to use the API, see [Video Playback](../../media/media/video-playback.md).
...
The input parameter values must be in the range of 320 x 320 to 1920 x 1080 (in px).
