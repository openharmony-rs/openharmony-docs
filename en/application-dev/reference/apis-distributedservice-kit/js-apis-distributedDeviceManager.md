...
**Example**
  ...
  try {
    // Create a DeviceManager instance.
    let dmInstance = distributedDeviceManager.createDeviceManager('ohos.samples.jsHelloWorld');
    // Unregister the callback for failed device discovery events.
