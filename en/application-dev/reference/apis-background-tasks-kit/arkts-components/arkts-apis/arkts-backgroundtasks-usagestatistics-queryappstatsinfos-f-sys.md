...
| Type | Description |
| --- | --- |
| Promise&lt;[AppStatsMap](arkts-backgroundtasks-usagestatistics-appstatsmap-t-sys.md)&gt; | the promise returned by queryAppStatsInfos. the [AppStatsMap](arkts-backgroundtasks-usagestatistics-appstatsmap-t-sys.md) objects containing the usage information about each application. |
