...
| priorityNotificationType<sup>23+</sup>  | PriorityNotificationType | No| Yes| Notification priority type, which is used to determine whether to highlight the notification background and pin the notification on top.|
