...
[Notification content](../../notification/notification-glossary.md#notification-content).
...
| additionalText | string |  No  |  Yes  | Additional content of the notification, which supplements the [notification content](../../notification/notification-glossary.md#notification-content) and is not displayed in the [notification center](../../notification/notification-glossary.md#notification-center).<br>Empty by default. The size does not exceed 3072 bytes, and the overflowing part will be truncated.   |
...
| briefText      | string |  No  | No  | Notification summary, which is a summary of the [notification content](../../notification/notification-glossary.md#notification-content) and is not displayed in the notification center.<br>It must not be an empty string, with a size not exceeding 1024 bytes. The overflowing part will be truncated.   |
...
| -------------- | -------------------------------------------- | ---- | --- |------------------------------------|
| expandedTitle  | string                                       | No  | No  | Title when the notification is expanded.<br>It cannot be an empty string. The size does not exceed 1024 bytes, and the excess part will be truncated.    |
| picture        | [image.PixelMap](../apis-image-kit/arkts-apis-image-PixelMap.md) |  No  |  No  | Right icon displayed after notification expansion.<br>The total bytes of the icon pixel must not exceed 2 MB (the total bytes of the icon pixel are obtained through [getPixelBytesNumber](../apis-image-kit/arkts-apis-image-PixelMap.md#getpixelbytesnumber7)). |
| briefText      | string                                       |  No  |  No  | Notification summary content, which is a summary of the [notification content](../../notification/notification-glossary.md#notification-content) and is not displayed in the notification center.<br>Must not be empty, with a size not exceeding 1024 bytes. The overflowing part will be truncated. |


## NotificationSystemLiveViewContent

Describes the [system live view](../../notification/notification-glossary.md#system-live-view) [notification content](../../notification/notification-glossary.md#notification-content), which is used to display real-time status information in the live view. Third-party applications are not supported to directly create this type of notification. After the system agent creates a system live view type notification, a third-party application can publish a notification with the same ID to update the specified content. This API is inherited from [NotificationBasicContent](#notificationbasiccontent).
...
| capsule<sup>11+</sup>        | [NotificationCapsule](#notificationcapsule11)   | No  | Yes  | Capsule of the [live view notification](../../notification/notification-glossary.md#live-view-notification). Empty by default.            |
...
Describes the [notification button](../../notification/notification-glossary.md#notification-button), which is used to display an interactive button in the live view.

> **NOTE**
>
> The actual display effect depends on the device capabilities and the [notification center](../../notification/notification-glossary.md#notification-center) UI style.
...
Describes the [notification progress](../../notification/notification-glossary.md#notification-progress), which is used to display progress bar information in the live view.
