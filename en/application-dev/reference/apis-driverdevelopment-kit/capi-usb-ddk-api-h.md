...
|---------------------------------------------------| -- |
| uint64_t deviceId                                 | Device ID.|
| uint8_t configIndex                               | Configuration index, which corresponds to **bConfigurationValue** in the USB protocol.|
...
| -- | -- |
| uint64_t interfaceHandle | Interface operation handle.|
| uint8_t settingIndex | Index of the alternate setting, which corresponds to **bAlternateSetting** in the USB protocol.|
