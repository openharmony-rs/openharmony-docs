...
|---------------------------------------------------| -- |
| uint64_t deviceId                                 | Device ID.|
| uint8_t configIndex                               | Configuration index, which corresponds to the **bConfigurationValue** field in the USB protocol.|
...
| -- | -- |
| uint64_t interfaceHandle | Interface operation handle.|
| uint8_t settingIndex | Alternate setting index, which corresponds to the **bAlternateSetting** field in the USB protocol.|
