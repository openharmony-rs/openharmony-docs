...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=f06a169dc1400433102b72453f209e2bc8cae977 translatedAt=2026-09-15T10:27:01.814Z pushedAt=2026-09-16T07:50:15.641Z -->
...
Obtains the key corresponding to the index in the key-value pair data.
...
| -- | -- |
| [const OH_PreferencesValue](capi-preferences-oh-preferencesvalue.md) *object | Pointer to the target [OH_PreferencesValue](capi-preferences-oh-preferencesvalue.md) instance.|
| const uint8_t *value | Pointer to the blob value that needs to be set. |
| uint32_t count | Size of the blob data that needs to be set. |
