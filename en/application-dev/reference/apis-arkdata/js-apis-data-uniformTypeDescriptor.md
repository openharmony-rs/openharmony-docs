...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=fadd7d812e259ee0411353f410f7f8f5e48ebdff translatedAt=2026-09-15T13:56:53.373Z pushedAt=2026-09-16T07:50:15.757Z -->
...
try {
  ...
  // Check whether the type belongs to the specified type.
...
// If no preset data type is found for ".myts" and "general.plain-text", return the dynamic type generated based on the input parameters.
try {
...
// If no preset data type is found for "image/myimage" and "general.image", return the dynamic type generated based on the input parameters.
try {
...
// If no preset data type is found based on ".myts" and "general.plain-text", return the dynamic type list generated based on the input parameter information.
try {
...
// If no preset data type is found based on "image/myimage" and "general.image", return the dynamic type list generated from the input parameters.
try {
