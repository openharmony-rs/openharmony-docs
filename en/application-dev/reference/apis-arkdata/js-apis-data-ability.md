...
<!--Tester: @logic42-->
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=ec3ee6f2135b09d43881ba0cd492287e282bb1e7 translatedAt=2026-09-15T11:53:35.459Z pushedAt=2026-09-16T07:50:15.718Z -->
...
| dataAbilityPredicates | [DataAbilityPredicates](#dataabilitypredicates) | Yes | Predicate. |
...
| Type| Description|
| -------- | -------- |
| [DataAbilityPredicates](#dataabilitypredicates) | **DataSharePredicates** object with a left parenthesis. |
...
| Type| Description|
| -------- | -------- |
| [DataAbilityPredicates](#dataabilitypredicates) | **DataSharePredicates** object with a right parenthesis. |
...
**Example**
  ...
  // Only matches the "NAME" field whose value is "Lisa".
...
**Example**
  ...
  ```js
  // Sort by the "NAME" field first, then by the "AGE" field if the values are the same, and finally by "SALARY".
  ...
  async onCreate(): Promise<void> {
    ...
    try {
      ...
      const SQL_CREATE_TABLE =
        'CREATE TABLE IF NOT EXISTS EMPLOYEE (ID INTEGER PRIMARY KEY AUTOINCREMENT, NAME TEXT NOT NULL, AGE INTEGER, SALARY REAL, CODES BLOB)'; // Create the table SQL statement.
