...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=5f9641223852d0ea4cd267be46368b149768fb5b translatedAt=2026-09-15T13:41:14.296Z pushedAt=2026-09-16T07:50:15.752Z -->
...
| shareOptions | [ShareOptions](#shareoptions12) | No | Yes | Usage scope of the [UnifiedData](#unifieddata) within a device. This is an optional field, and the default value is CROSS_APP.<br/>**Atomic service API:** Since API version 12, this API is supported in atomic services. |
...
// Since API version 26.0.0, URI authorization policies are supported.
...
| data        | [UnifiedData](#unifieddata)  \| null  |  Yes    | Data obtained when the progress reaches 100. null is returned when the progress has not reached 100. |
...
For details about how to use it, see [Asynchronous Data Acquisition by Drag-and-Drop](../apis-arkui/arkui-ts/ts-universal-events-drag-drop.md#example-3-obtaining-data-asynchronously-through-drag-and-drop).
...
| Type                    | Description                                |
|-----------------------|-----------------------------------|
| [UnifiedData](#unifieddata) \| null | When the delayed load handler is triggered, returns the **UnifiedData** object generated based on the receiver information for data transfer. If the data cannot be generated or generation fails, null is returned. |
...
| Type                    | Description                                |
|-----------------------|-----------------------------------|
| Promise&lt;[UnifiedData](#unifieddata) \| null&gt; | Promise object. When resolved, returns the UnifiedData object generated based on the receiver information or null; when rejected, returns the error information. |
