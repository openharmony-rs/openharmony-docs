...
<!--Tester: @logic42-->
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=907647a53d1fa96d552e502adcd2943b693c72f8 translatedAt=2026-09-15T08:54:08.787Z pushedAt=2026-09-16T07:50:15.605Z -->
...
| PLAIN_TEXT<sup>22+</sup> | 2 | No encryption is required.|
...
| Name | Value | Description |
|------|---|--------------------|
| CONFLICT_POLICY_DEFAULT | 0 | Default conflict policy, which is executed according to the device-cloud sync mode [SyncMode](arkts-apis-data-relationalStore-e.md#syncmode). |
...
Enumerates the device sync result codes. Use the enum name rather than the enum value.
