...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=d05740bbf86a3147f9ceb31afcfe5ead7b55b98a translatedAt=2026-09-15T12:42:24.646Z pushedAt=2026-09-16T07:50:15.730Z -->
...
| Name      | Type                                                        | Read-Only| Optional| Description          |
| ---------- | ----------------------------------------------------------- | ---- | ---- | -------------- |
| uri        | string                                                      | No| No  | URI to be operated, with a maximum of 256 bytes. The value is fixed in the format of **"datashareproxy://{*bundleName*}/{*path*}"**, in which **bundleName** indicates the bundle name of the publisher application, and **path** can be set to any value but must be unique in the same application.|
...
| maxValueLength  | [DataProxyMaxValueLength](#dataproxymaxvaluelength)  | No | Yes   | Maximum allowed length of the value of the shared configuration. If not filled, the default value is **MAX_LENGTH_4K**, that is, the maximum allowed length of the value of the shared configuration is 4096 bytes.<br>**Since:** 26.0.0 |
