...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=3ebabd84e8026ac3f14cc696973485dbda29e0f7 translatedAt=2026-09-15T13:49:34.134Z pushedAt=2026-09-16T07:50:15.754Z -->
...
| details | Record<string, number \| string \| Uint8Array> | No   | Yes   | Dictionary type object. The key is of the string type, and the value can contain data of the number (numeric type), string (string type), or Uint8Array (binary data) type. This is an optional field, and the default value is an empty dictionary object.|
...
Defines a file URI typed data, which is used to describe the URI address information of a file. Once a **FileUri** object is created, it can be used in scenarios such as file dragging and file sharing. It supports controlling file access permissions through **uriAuthorizationPolicies**, enabling cross-application file data transfer and permission management.
...
let fileUri: uniformDataStruct.FileUri = {
  ...
  // Since API version 26.0.0, URI authorization policy is supported.
  uriAuthorizationPolicies: [
    unifiedDataChannel.UriPermission.WRITE
  ]
};
...
| details | Record<string, number \| string \| Uint8Array> | No   | Yes   | Dictionary type object whose key is of the string type and whose value can contain data of the number (numeric type), string (string type), or Uint8Array (binary byte array) type. Optional field, and the default value is an empty dictionary object.|
