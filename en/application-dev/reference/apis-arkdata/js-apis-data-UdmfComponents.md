...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=fadd7d812e259ee0411353f410f7f8f5e48ebdff translatedAt=2026-09-15T13:37:37.963Z pushedAt=2026-09-16T07:50:15.751Z -->
...
struct Index {
  ...
  // Control the card display state.
  ...
  build() {
    Column() {
      // Display the button. Tapping it shows the content card.
      Button('show card')
        .onClick(() => {
