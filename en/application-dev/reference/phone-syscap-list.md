...
> **NOTE**
>
> This list outlines the minimum system capabilities supported by the current version of phones. You can refer to the **default.json** file in the SDK for details.
> When developing applications for the current version of phones using the APIs corresponding to the system capabilities listed, you can call these APIs directly without needing to perform a **canIUse()** check beforehand.
