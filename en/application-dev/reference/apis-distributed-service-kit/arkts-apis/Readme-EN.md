...
- [@ohos.cooperate](arkts-distributedservice-cooperate.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [activateCooperate(system api)](arkts-distributedservice-cooperate-activatecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [activateCooperateWithOptions(system api)](arkts-distributedservice-cooperate-activatecooperatewithoptions-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deactivate(system api)](arkts-distributedservice-cooperate-deactivate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [deactivateCooperate(system api)](arkts-distributedservice-cooperate-deactivatecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getCooperateSwitchState(system api)](arkts-distributedservice-cooperate-getcooperateswitchstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getCrossingSwitchState(system api)](arkts-distributedservice-cooperate-getcrossingswitchstate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [off(system api)](arkts-distributedservice-cooperate-off-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [on(system api)](arkts-distributedservice-cooperate-on-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [prepare(system api)](arkts-distributedservice-cooperate-prepare-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [prepareCooperate(system api)](arkts-distributedservice-cooperate-preparecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [unprepare(system api)](arkts-distributedservice-cooperate-unprepare-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [unprepareCooperate(system api)](arkts-distributedservice-cooperate-unpreparecooperate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CooperateMessage(system api)](arkts-distributedservice-cooperate-cooperatemessage-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [CooperateOptions(system api)](arkts-distributedservice-cooperate-cooperateoptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [MouseLocation(system api)](arkts-distributedservice-cooperate-mouselocation-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedDeviceManager(Device Management)](arkts-distributedservice-distributeddevicemanager.md)
  ...
  <!--Del-->
  - [DeviceIconInfo(system api)](arkts-distributedservice-distributeddevicemanager-deviceiconinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceIconInfoFilterOptions(system api)](arkts-distributedservice-distributeddevicemanager-deviceiconinfofilteroptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceIdentification(system api)](arkts-distributedservice-distributeddevicemanager-deviceidentification-i-sys.md)<!--DelEnd-->
  - [DeviceManager](arkts-distributedservice-distributeddevicemanager-devicemanager-i.md)
  <!--Del-->
  - [DeviceManager(system api)](arkts-distributedservice-distributeddevicemanager-devicemanager-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceProfileInfo(system api)](arkts-distributedservice-distributeddevicemanager-deviceprofileinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceProfileInfoFilterOptions(system api)](arkts-distributedservice-distributeddevicemanager-deviceprofileinfofilteroptions-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [NetworkIdQueryFilter(system api)](arkts-distributedservice-distributeddevicemanager-networkidqueryfilter-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ServiceProfileInfo(system api)](arkts-distributedservice-distributeddevicemanager-serviceprofileinfo-i-sys.md)<!--DelEnd-->
...
- [@ohos.distributedHardware.deviceManager(Device Management)](arkts-distributedservice-distributedhardware-devicemanager.md)
  ...
  <!--Del-->
  - [AuthInfo(system api)](arkts-distributedservice-devicemanager-authinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AuthParam(system api)](arkts-distributedservice-devicemanager-authparam-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceInfo(system api)](arkts-distributedservice-devicemanager-deviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceManager(system api)](arkts-distributedservice-devicemanager-devicemanager-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [PublishInfo(system api)](arkts-distributedservice-devicemanager-publishinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SubscribeInfo(system api)](arkts-distributedservice-devicemanager-subscribeinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [AuthForm(system api)](arkts-distributedservice-devicemanager-authform-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceStateChangeAction(system api)](arkts-distributedservice-devicemanager-devicestatechangeaction-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceType(system api)](arkts-distributedservice-devicemanager-devicetype-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DiscoverMode(system api)](arkts-distributedservice-devicemanager-discovermode-e-sys.md)<!--DelEnd-->
  <!--Del-->
  - [ExchangeFreq(system api)](arkts-distributedservice-devicemanager-exchangefreq-e-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedHardware.hardwareManager(Distributed Hardware Manager)](arkts-distributedservice-distributedhardware-hardwaremanager.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [resumeDistributedHardware(system api)](arkts-distributedservice-hardwaremanager-resumedistributedhardware-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopDistributedHardware(system api)](arkts-distributedservice-hardwaremanager-stopdistributedhardware-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [HardwareDescriptor(system api)](arkts-distributedservice-hardwaremanager-hardwaredescriptor-i-sys.md)<!--DelEnd-->
  <!--Del-->
...
- [@ohos.distributedsched.abilityConnectionManager(Ability Connection Manager)](arkts-distributedservice-distributedsched-abilityconnectionmanager.md)
  ...
  <!--Del-->
  - [createStream(system api)](arkts-distributedservice-abilityconnectionmanager-createstream-f-sys.md)<!--DelEnd-->
  - [destroyAbilityConnectionSession](arkts-distributedservice-abilityconnectionmanager-destroyabilityconnectionsession-f.md)
  <!--Del-->
  - [destroyStream(system api)](arkts-distributedservice-abilityconnectionmanager-destroystream-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [getSurfaceId(system api)](arkts-distributedservice-abilityconnectionmanager-getsurfaceid-f-sys.md)<!--DelEnd-->
  - [off](arkts-distributedservice-abilityconnectionmanager-off-f.md)
  <!--Del-->
  - [off(system api)](arkts-distributedservice-abilityconnectionmanager-off-f-sys.md)<!--DelEnd-->
  - [on](arkts-distributedservice-abilityconnectionmanager-on-f.md)
  <!--Del-->
  - [on(system api)](arkts-distributedservice-abilityconnectionmanager-on-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [sendImage(system api)](arkts-distributedservice-abilityconnectionmanager-sendimage-f-sys.md)<!--DelEnd-->
  - [sendMessage](arkts-distributedservice-abilityconnectionmanager-sendmessage-f.md)
  <!--Del-->
  - [setSurfaceId(system api)](arkts-distributedservice-abilityconnectionmanager-setsurfaceid-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startStream(system api)](arkts-distributedservice-abilityconnectionmanager-startstream-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopStream(system api)](arkts-distributedservice-abilityconnectionmanager-stopstream-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [updateSurfaceParam(system api)](arkts-distributedservice-abilityconnectionmanager-updatesurfaceparam-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ConnectOptions(system api)](arkts-distributedservice-abilityconnectionmanager-connectoptions-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [EventCallbackInfo(system api)](arkts-distributedservice-abilityconnectionmanager-eventcallbackinfo-i-sys.md)<!--DelEnd-->
  - [PeerInfo](arkts-distributedservice-abilityconnectionmanager-peerinfo-i.md)
  <!--Del-->
  - [StreamParam(system api)](arkts-distributedservice-abilityconnectionmanager-streamparam-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [SurfaceParam(system api)](arkts-distributedservice-abilityconnectionmanager-surfaceparam-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [FlipOptions(system api)](arkts-distributedservice-abilityconnectionmanager-flipoptions-e-sys.md)<!--DelEnd-->
  - [StartOptionParams](arkts-distributedservice-abilityconnectionmanager-startoptionparams-e.md)
  <!--Del-->
  - [StartOptionParams(system api)](arkts-distributedservice-abilityconnectionmanager-startoptionparams-e-sys.md)<!--DelEnd-->
  <!--Del-->
