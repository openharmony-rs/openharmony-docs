...
- Header file<!--audiokit-headerfile-->
    ...
    - [native_audio_suite_base.h(System API)](capi-native-audio-suite-base-h-sys.md)
    - [native_audio_suite_engine.h](capi-native-audio-suite-engine-h.md)
    - [native_audio_suite_engine.h(System API)](capi-native-audio-suite-engine-h-sys.md)
