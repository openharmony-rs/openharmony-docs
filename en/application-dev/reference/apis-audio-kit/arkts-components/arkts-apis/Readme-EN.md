...
- [@ohos.multimedia.audio(Audio Renderer, Capturer And Management)](arkts-audio-multimedia-audio.md)
  <!--Del-->
...
- [@ohos.multimedia.audioHaptic(Audio Haptic)](arkts-audio-multimedia-audiohaptic.md)
...
- [@ohos.multimedia.systemSoundManager(System Sound Management)](arkts-audio-multimedia-systemsoundmanager.md)
  <!--Del-->
...
- multimedia<!--arkts-audiokit-multimedia-->
  <!--Del-->
  - [ringtonePlayer(Ringtone Player)](arkts-audio-ringtoneplayer.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [systemTonePlayer(System Tone Player)](arkts-audio-systemtoneplayer.md)<!--DelEnd-->
    <!--Del-->
