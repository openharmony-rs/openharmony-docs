...
| [OH_MIDIDeviceInformation](capi-ohmidi-oh-midideviceinformation.md) info | Information about the opened device.<br> **Note**: This object is valid only within this callback. To persist specific properties (such as the ID or name), make a copy of the device information.                                                          <!--no_check-->