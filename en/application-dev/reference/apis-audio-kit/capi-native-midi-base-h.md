...
**File to include**: <ohmidi/native_midi_base.h>
...
| -- | -- | -- |
| [OH_MIDIEvent](capi-ohmidi-oh-midievent.md) | OH_MIDIEvent | Describes a generic MIDI event structure, Event data is transmitted in the Universal MIDI Packets (UMP) format. The original byte stream (MIDI 1.0) data needs to be converted into the UMP format before being filled into this struct.|
