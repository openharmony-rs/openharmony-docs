...
| Name      | Type                         | Mandatory  | Description            |
| -------- | --------------------------- | ---- | -------------- |
| callback | AsyncCallback&lt;number&gt; | Yes | Callback used to return the result. If the mouse cursor size is obtained successfully, err is undefined and number is the obtained mouse cursor size, which ranges from [1, 7]; otherwise, err is an error object. |
