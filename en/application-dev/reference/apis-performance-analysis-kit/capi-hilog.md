...
<!--Tester: @yufeifei-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=48c44b3f03c9c1250a72b0a46979c66c1ffcf3e3 translatedAt=2026-09-16T10:55:07.355Z pushedAt=2026-09-20T09:01:52.257Z -->
...
Use cases: You can use the APIs of this module when you need to record runtime logs for problem locating, process tracking, and behavior analysis during application development. DEBUG logs are used to record debugging information and track business processes and runtime status. INFO logs are used to record key business node information in abnormal situations, such as no network signal or login failure. When an exception or error occurs, WARN, ERROR, and FATAL logs are used to record fault information for quickly locating the root cause of the problem.
