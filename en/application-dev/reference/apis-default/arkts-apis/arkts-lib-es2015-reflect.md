...
| [getOwnPropertyDescriptor](arkts-reflect-getownpropertydescriptor-f.md) | Gets the own property descriptor of the specified object. An own property descriptor is one that is defined directly on the object and is not inherited from the object's prototype. |
| [getPrototypeOf](arkts-reflect-getprototypeof-f.md) | Returns the prototype of an object. |
| [has](arkts-reflect-has-f.md) | Equivalent to `propertyKey in target`. |
