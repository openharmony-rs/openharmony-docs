...
**Parameters**
  ...
  | Name    | Type         | Mandatory  | Description                                      |
  | ------- | ----------- | ---- | ---------------------------------------- |
  | exclusive  | boolean | No  | Whether to apply an exclusive lock. The value **true** means an exclusive lock, and the value **false** (default) means a shared lock.     |
...
Applies an exclusive lock or a shared lock on a file in non-blocking mode.
