...
| const char * OH_MD_KEY_LANGUAGE | Pointer to the key that describes the language of a media file. The value type is char *.<br>**Since**: 10<br>**System capability**: SystemCapability.Multimedia.Media.CodecBase|
...
| AAC_PROFILE_HE = 3 | AAC profile of the high efficiency level. <!--Del-->(This specification is not available yet.)<!--DelEnd--><br>**Since**: 14|
| AAC_PROFILE_HE_V2 = 4 | AAC profile of the high efficiency V2 level. <!--Del-->(This specification is not available yet.)<!--DelEnd--><br>**Since**: 14|
