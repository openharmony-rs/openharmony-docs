...
| -- | -- | -- |
| [MediaKeySession](../apis-drm-kit/capi-drm-mediakeysession.md) | MediaKeySession | Describes the fields for MediaKeySession.|
...
| [OH_AVCodec *OH_AudioCodec_CreateByName(const char *name)](#oh_audiocodec_createbyname) | Creates an audio codec instance based on a codec name. To use this function, you must know the exact name of the codec, which can be obtained by calling [OH_AVCapability_GetName](capi-native-avcapability-h.md#oh_avcapability_getname).|
| [OH_AVErrCode OH_AudioCodec_Destroy(OH_AVCodec *codec)](#oh_audiocodec_destroy) | Clears the internal resources of an audio codec and destroys the codec instance. Do not repeatedly destroy the instance. Otherwise, the program may crash.|
