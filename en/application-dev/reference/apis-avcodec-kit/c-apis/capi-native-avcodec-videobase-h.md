...
| Type | Description |
| -- | -- |
| OH_AVErrCode | Result code.      <br>Returns [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode) if the operation is successful.      <br>Returns [AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode) if the roiStr or outCount pointer is NULL. |
...
| Type | Description |
| -- | -- |
| OH_AVErrCode | Result code.      <br>Returns [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode) if the operation is successful.      <br>Returns [AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode) if roiStr, outOwnedFormats, or outCount is NULL. |
