...
| surfaceId | string | Yes | Display window ID. For details about how to obtain **surfaceId**, see [getXComponentSurfaceId](../../apis-arkui/arkts-components/arkts-arkui-xcomponent-comp-xcomponentcontroller-c.md#getxcomponentsurfaceid). |
