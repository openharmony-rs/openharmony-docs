...
| [GameController_ErrorCode](capi-game-controller.md#gamecontroller_errorcode) [OH_GamePad_DestroyPressedButton](capi-game-controller.md#oh_gamepad_destroypressedbutton) ([GamePad_PressedButton](capi-game-controller.md#gamepad_pressedbutton) \*\*pressedButton) | Destroys a [GamePad_PressedButton](capi-game-controller.md#gamepad_pressedbutton) instance when it is no longer used.| 
