...
| Name| Description                                     |
| -- |-----------------------------------------|
| [OH_QoS_GewuCreateSessionResult](capi-qos-oh-qos-gewucreatesessionresult.md) | Gewu session creation result.                              |
| [OH_QoS_GewuSubmitRequestResult](capi-qos-oh-qos-gewusubmitrequestresult.md) | Result of a Gewu request.|
