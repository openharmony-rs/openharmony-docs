...
Provides APIs for symmetric key operations. It is a child class of [Key](arkts-cryptoarchitecture-cryptoframework-key-i.md). Its objects need to be passed to [init()](arkts-cryptoarchitecture-cryptoframework-cipher-i.md#init-3) of the [Cipher](arkts-cryptoarchitecture-cryptoframework-cipher-i.md) instance in symmetric encryption and decryption.
