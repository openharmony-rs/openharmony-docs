...
Provides APIs for key operations. Before performing cryptographic operations (such as encryption and decryption), you need to construct a child class object of **Key** and pass it to [init()](arkts-cryptoarchitecture-cryptoframework-cipher-i.md#init-3) of the [Cipher](arkts-cryptoarchitecture-cryptoframework-cipher-i.md) instance.
