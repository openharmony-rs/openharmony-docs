...
<!-- md-trans-meta sourceCommit=95b635b2657acaf53c78b86c96c7e9bdaf7f7668 translatedAt=2026-09-02T02:25:53.791Z pushedAt=2026-09-02T07:01:22.440Z -->
...
- After **Detach** is called, the obtained **inputMethodProxy** pointer cannot be used again; all operations will return **IME_ERR_DETACHED**. Example: This code is returned when any API is called after **Detach**. Check the lifecycle state and use the object only between **Attach** and **Detach**; otherwise, call **Attach** again. This object is an opaque type. It cannot directly access its internal members or perform memory operations (such as malloc/free).
