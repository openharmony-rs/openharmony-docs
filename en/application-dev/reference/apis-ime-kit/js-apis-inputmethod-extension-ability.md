...
<!-- md-trans-meta sourceCommit=45a57f3f903726589c6d2dc15c0c20588a3e5446 translatedAt=2026-09-11T09:32:02.994Z pushedAt=2026-09-14T01:52:44.836Z -->
...
To use the following APIs, you need to create a child class that inherits from **InputMethodExtensionAbility** and then override or use them in the child class.
...
| ------ | ----------- | ---- | ------------------------------- |
| want   | [Want](../apis-ability-kit/js-apis-app-ability-want.md) | Yes   | Want type information related to the current Extension, including the Ability name, bundle name, and so on. |
...
- **inputMethodEngine.getInputMethodAbility()**: Obtains the input method ability object.
