...
<!-- md-trans-meta sourceCommit=0733e78bfc70b2294390ca2e490b16a13e0e2a7a translatedAt=2026-08-20T09:37:41.085Z pushedAt=2026-08-21T06:50:43.259Z -->
...
| [Camera_ErrorCode OH_PreviewOutput_SetLogViewAssistEnable(Camera_PreviewOutput* previewOutput, bool enable)](#oh_previewoutput_setlogviewassistenable) | - | Enables or disables view assist.<br>This API can be called only after [OH_CaptureSession_CommitConfig()](capi-capture-session-h.md#oh_capturesession_commitconfig) is called. |
...
| Type | Description |
| -- | -- |
| bool | Whether view assist is supported. The value **true** indicates that it is supported, and **false** indicates the opposite. |
...
Enables or disables view assist.<br> This API can be called only after [OH_CaptureSession_CommitConfig()](capi-capture-session-h.md#oh_capturesession_commitconfig) is called.
...
| bool enable | Whether to enable view assist for preview. The value **true** indicates that it is enabled, and **false** indicates the opposite. |
