...
| typedef struct [RawFile](#rawfile-1) [RawFile](#rawfile-1) | Provides access to rawfiles.| 
...
| int [OH_ResourceManager_ReadRawFile](#oh_resourcemanager_readrawfile) (const [RawFile](#rawfile-1) \*rawFile, void \*buf, size_t length) | Reads data of the specified length from the current position in a rawfile.| 
| int [OH_ResourceManager_SeekRawFile](#oh_resourcemanager_seekrawfile) (const [RawFile](#rawfile-1) \*rawFile, long offset, int whence) | Searches for the data read/write position in a rawfile based on the specified offset.| 
| long [OH_ResourceManager_GetRawFileSize](#oh_resourcemanager_getrawfilesize) ([RawFile](#rawfile-1) \*rawFile) | Obtains the length of the rawfile, in long.| 
| long [OH_ResourceManager_GetRawFileRemainingLength](#oh_resourcemanager_getrawfileremaininglength) (const [RawFile](#rawfile-1) \*rawFile) | Obtains the remaining length of the rawfile, in long.| 
| void [OH_ResourceManager_CloseRawFile](#oh_resourcemanager_closerawfile) ([RawFile](#rawfile-1) \*rawFile) | Closes a [RawFile](#rawfile-1) and releases all associated resources.| 
| long [OH_ResourceManager_GetRawFileOffset](#oh_resourcemanager_getrawfileoffset) (const [RawFile](#rawfile-1) \*rawFile) | Obtains the current offset of a rawfile, in long.| 
| bool [OH_ResourceManager_GetRawFileDescriptor](#oh_resourcemanager_getrawfiledescriptor) (const [RawFile](#rawfile-1) \*rawFile, [RawFileDescriptor](_raw_file_descriptor.md) &amp;descriptor) | Opens a rawfile based on the specified offset (in long) and file length (in long) and obtains the file descriptor.| 
...
| [RawFile](#rawfile-1) \* [OH_ResourceManager_OpenRawFile](#oh_resourcemanager_openrawfile) (const [NativeResourceManager](#nativeresourcemanager) \*mgr, const char \*fileName) | Opens a rawfile and reads the data in it.| 
...
Closes a [RawFile](#rawfile-1) and releases all associated resources.
...
| Name| Description| 
| -------- | -------- |
| rawFile | Pointer to the [RawFile](#rawfile-1).| 
...
Pointer to the [RawFile](#rawfile-1) opened. You can use [OH_ResourceManager_CloseRawFile](#oh_resourcemanager_closerawfile) to close the rawfile and release resources. If the operation fails or **mgr** or **fileName** is empty, a null pointer is returned.
