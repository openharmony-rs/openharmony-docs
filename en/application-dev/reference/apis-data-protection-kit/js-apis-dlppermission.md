...
>**NOTE**
>
> This API is enabled by the [MDM](../../mdm/mdm-kit-intro.md) kit and is used for 2B devices. For 2C and 2D devices, this API is inapplicable. Calling it returns **false**.
