...
| onStateChange<sup>11+</sup> | (state: [AVCastPickerState](js-apis-avCastPickerParam.md#avcastpickerstate)) => void | No| - | Callback invoked when the casting state changes.|
## Events
