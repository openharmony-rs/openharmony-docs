...
- ArkTS APIs<!--avsession-arkts-->
  ...
  - application
    ...
    <!--DelEnd-->
  - @ohos.multimedia.avMusicTemplate (Audio Template)<!--apis-avsession-avmusictemplate-->
    - [Module Description](arkts-apis-avMusicTemplate.md)
  ...
  <!--Del-->
  - [@ohos.multimedia.avMusicTemplate (Audio Template) (System API)](js-apis-avMusicTemplate-sys.md)
  <!--DelEnd-->
...
- Error Codes<!--avsession-arkts-errcode-->
  ...
  - [Audio Template Error Codes](errorcode-avmusictemplate.md)
