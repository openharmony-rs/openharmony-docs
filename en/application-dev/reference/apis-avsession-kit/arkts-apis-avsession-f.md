...
| Type                      | Description                              |
|----------------------------|-----------------------------------|
| Promise\<boolean> | Promise used to return the result. The value **true** indicates that the device supports the desktop lyrics feature, and **false** indicates the opposite.|
