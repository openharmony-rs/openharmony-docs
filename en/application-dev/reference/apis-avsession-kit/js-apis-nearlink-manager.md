...
| Type| Description|
| -------- | -------- |
| boolean | Checks whether the current device supports NearLink. The value **true** indicates that the device supports NearLink, and **false** indicates the opposite.|
