...
| NETCONN_MAX_RTT_NUM   4  | Length of the **rtt** array of the [NetConn_ProbeResultInfo](capi-netconnection-netconn-proberesultinfo.md) member variable.<br>**Since**: 20| 
