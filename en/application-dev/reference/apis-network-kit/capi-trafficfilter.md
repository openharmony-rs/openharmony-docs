...
<!-- md-trans-meta sourceCommit=d0b95f416429e26cbb3c18cf15b3c9ebd60914ce translatedAt=2026-09-23T01:42:13.829Z pushedAt=2026-09-24T06:00:14.162Z -->
...
| [net_trafficfilter_type.h](capi-net-trafficfilter-type-h.md) | Declares the common types and error codes required for network traffic filtering and redirection. This header file defines the matching condition structs for IP address, port, MAC address, interface, TCP flags, and connection tracking used in traffic filtering and redirection, the configuration structs for packet filtering rules, redirection rules, and NFQueue configuration, as well as the packet descriptor, packet processing decision, packet copy mode, and error codes returned by operations.<br> Applicable to constructing parameters and parsing return values when calling APIs such as [OH_TrafficFilter_CreateRedirector](capi-net-trafficfilter-h.md#oh_trafficfilter_createredirector) or [OH_TrafficFilter_CreatePacketController](capi-net-trafficfilter-h.md#oh_trafficfilter_createpacketcontroller). |
