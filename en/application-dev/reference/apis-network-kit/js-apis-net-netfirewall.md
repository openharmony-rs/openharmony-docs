...
> **Description**
> 
> 1. The priority of firewall rules is described as follows (there is no requirement on the calling sequence of [setNetFirePolicy](#netfirewallsetnetfirewallpolicy) and [addNetFirewallRule](#netfirewalladdnetfirewallrule)):<br>
