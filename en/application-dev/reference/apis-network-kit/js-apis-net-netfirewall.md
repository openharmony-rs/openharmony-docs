...
| isEnabled   | boolean                                                     | No|No|Whether to enable the firewall rule. The value **true** means to enable the firewall rule, and the value **false** means the opposite.                                                    |
...
| Name      | Type                                      | Read-Only|Optional| Description         |
| -----------| -------------------------------------------|------|----|---------- |
| isOpen     | boolean                                    | No  |No|Whether to enable or disable the firewall. The value **true** means to enable the firewall, and the value **false** means the opposite.|
