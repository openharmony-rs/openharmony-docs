...
httpRequest.request(// Customize EXAMPLE_URL in extraData on your own. It is up to you whether to add parameters to the URL.
  "EXAMPLE_URL",
  {
    ...
    usingProxy: false, // Optional. The system proxy is used by default. If this parameter is set to false, the proxy is not used. This parameter is supported since API 10.
...
> **NOTE**
> If the data output by console.info() contains a newline character, the newline character will be rendered as a line break.
>
...
| -------- | ---------------------------------------------- | ---- | ---------------------- |
| url      | string                                         | Yes  | URL for initiating an HTTP request. Example: https://www.test.com|
...
let options: http.HttpRequestOptions = {
    ...
    connectTimeout: 60000 // Optional. The default value is 60000, in ms.
    usingProtocol: http.HttpProtocol.HTTP1_1, // Optional. The default protocol type is automatically specified by the system.
    usingProxy: false, // Optional. The system proxy is used by default. If this parameter is set to false, no proxy is used. This parameter is supported since API version 10.
};
...
| Type                                  | Description                             |
| :------------------------------------- | :-------------------------------- |
| Promise<[HttpResponse](#httpresponse)> | Promise object, which returns the response result of the request.|
...
For details about the following error codes, please refer to "Universal Error Codes" and HTTP error codes.<br>
The HTTP error code mapping is in the format of 2300000 + Curl error code. For more common error codes, see [Curl Error Codes](https://curl.se/libcurl/c/libcurl-errors.html).
...
let options: http.HttpRequestOptions = {
    ...
    connectTimeout: 60000 // Optional. The default value is 60000, in ms.
    usingProtocol: http.HttpProtocol.HTTP1_1, // Optional. The default protocol type is automatically specified by the system.
    usingProxy: false, // Optional. The system proxy is used by default. If this parameter is set to false, the proxy is not used. This parameter is supported in API version 10 and later.
};
...
| Name  | Type                   | Mandatory| Description                             |
| -------- | ----------------------- | ---- | --------------------------------- |
| type     | string                  | Yes  | Event to be subscribed to. The value is fixed to 'headersReceive'. headersReceive: event indicating that the response header is received.|
| callback | Callback\<ArrayBuffer\> | Yes  | Callback used to return the result. When the subscription is successful, the value of err is undefined, and the value of data is the obtained HTTP streaming data of the ArrayBuffer type. Otherwise, the value of err is an error object.|
...
| priority<sup>9+</sup>        | number                          | No | Yes | Priority of an HTTP/HTTPS request. A larger value indicates a higher priority. The value ranges from 1 to 1000. The default value is 1. If the value is out of the range, the default value is used.<br>**Atomic service API**: This API can be used in atomic services since API version 11.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| usingProtocol<sup>9+</sup>   | [HttpProtocol](#httpprotocol9)  | No | Yes | Protocol version used by the HTTP request. If this parameter is not specified, the system automatically negotiates the most suitable protocol version. If HTTP3 is specified, HTTP3 can be enabled only when the [TlsConfig](https://gitcode.com/openharmony/docs/blob/master/en/application-dev/reference/apis-network-kit/js-apis-http.md) is used to specify the TLS version to 1.3 and the target domain name supports HTTP3. Otherwise, the protocol version will be degraded.<br>**Atomic service API**: This API can be used in atomic services since API version 11.<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| maxLimit<sup>11+</sup>   | number   | No| Yes| Maximum number of bytes in a response.<br>The default value is 5 x 1024 x 1024, in bytes. The maximum value is 100 x 1024 x 1024, in bytes.<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
Performance measurement (unit: ms).
...
| Name  | Type                                          | Read Only| Optional|Description                   |
| -------- | ---------------------------------------------- | ---- | --- | ---------------------- |
|  receiveSize        | number | No  | No | Size of the received data (unit: byte).  |
| totalSize| number | No  | No| Total size of the data to be received (unit: byte).|
...
| Name  | Type                                          | Read Only| Optional|Description                   |
| -------- | ---------------------------------------------- | ---- | --- | ---------------------- |
| sendSize        | number | No  | No | Size of the data to be sent each time (unit: byte). |
| totalSize | number | No  | No| Total size of the data to be sent (unit: byte).|
...
| Name  | Type                                   | Mandatory| Description      |
| -------- | --------------------------------------- | ---- | ---------- |
| cacheSize | number | No| Response cache size, in bytes. The value ranges from 1 x 1024 x 1024 to 10 x 1024 x 1024, that is, from 1 MB to 10 MB. The default value is 10 MB. If the value is greater than 10 MB, it will be set to 10 MB. If the value is less than 1 MB, it will be set to 1 MB.|
