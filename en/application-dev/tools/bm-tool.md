...
- userId = 102: indicates the system account with the ID of 102. This account is created by the system account management module.<!--Del--> You can create an account by calling the createOsAccountForDomain API.<!--DelEnd--> Only system apps can create accounts. Apps installed under the account with the ID of 100 are not displayed under the account with the ID of 102. If required, you need to reinstall the apps under the account with the ID of 102. When the account with the ID of 102 is created, the system installs pre-installed system apps under the account.
