...
- In the first phase, the system promptly delivers an image that has undergone lightweight processing, offering a balance between reduced quality and swift image availability. Your application receives a [PhotoAsset](../../reference/apis-media-library-kit/arkts-apis-photoAccessHelper-PhotoAsset.md) object (see: PhotoAsset) via callback, and can call media library APIs through this object to read or save the image to storage.
