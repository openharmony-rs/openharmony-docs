...
<!-- md-trans-meta sourceCommit=444d4b7458e1317b3c2f1a471488b9c4b8344c2e translatedAt=2026-06-03T07:05:51.131Z pushedAt=2026-06-03T10:15:36.458Z -->
...
- Image Development (ArkTS)<!--image-arkts-dev-->
  ...
  - Image Decoding<!--image-decoding-arts-->
    ...
    - [Region Decoding and Downsampling (ArkTS)](image-region-and-downsampling.md)

    - [Using ImageSource to Obtain RAW Data](image-raw-data.md)
...
- Image Development (C/C++)<!--image-native-->
  ...
  - Image Decoding<!--image-decoding-c-->
    ...
    - [Region Decoding and Downsampling (C/C++)](image-region-and-downsampling-c.md)
...
- FAQs About Image Kit<!--image-faqs-->
  ...
  - [Common Crash and Error Issues in Image Kit](image-faqs/image-common-mistakes.md)
