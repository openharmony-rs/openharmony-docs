...
<!-- md-trans-meta sourceCommit=5b3ab60fe000eb4bad70440a3e7f30019a2671f9 translatedAt=2026-09-18T02:44:10.690Z pushedAt=2026-09-18T08:52:42.820Z -->
...
> **NOTE**
>
> - `isRecordingAvailable` checks whether a specified recording request can be started, and does not return the details of the current recording streams.
...
> - The information returned by `getCurrentAudioCapturerInfoArray` may include internal system recording streams. You can determine whether a recording stream belongs to the microphone occupation scenario that the current service needs to identify based on `capturerInfo.source` and the service scenario.
