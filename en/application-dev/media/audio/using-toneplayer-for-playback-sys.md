...
<!-- md-trans-meta sourceCommit=b8179ddefd55f69157fab19cdf0a8474af82997d translatedAt=2026-09-18T04:18:38.813Z pushedAt=2026-09-18T10:34:56.573Z -->
...
| TONE_TYPE_DIAL_S | 10 | DTMF tone of the * key. |
| TONE_TYPE_DIAL_P | 11 | DTMF tone of the # key. |
...
1. Create a TonePlayer instance.
   ...
   let audioRendererInfo: audio.AudioRendererInfo = {
    ...
    rendererFlags: 0 // Playback stream behavior flag. Set it to 0.
   };
...
let audioRendererInfo: audio.AudioRendererInfo = {
     usage: audio.StreamUsage.STREAM_USAGE_DTMF, // Audio stream usage: dial tone. Configure it based on the service scenario. For details, see StreamUsage.
     rendererFlags: 0 // Playback stream behavior flag. Set it to 0.
   };
// Call in promise mode.
async function playTone(type: audio.ToneType): Promise<void> {
  ...
  try {
    ...
    // Stop the tone currently being played.
    await tonePlayerPromise.stop();
  } catch (err) {
