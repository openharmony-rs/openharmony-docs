...
<!-- md-trans-meta sourceCommit=52ebed4256e7f42a40d1e7038352f0397c621558 translatedAt=2026-09-18T02:35:08.784Z pushedAt=2026-09-18T08:41:12.457Z -->
...
Previously, recording concurrency across different recording stream types between different apps in the system was subject to strict [audio focus strategy control](audio-playback-concurrency.md#audio-focus-strategy), and simultaneous recording was generally not supported.
...
1. Whether multiple audio streams can obtain audio input data simultaneously during concurrent recording depends on the [audio focus strategies](audio-playback-concurrency.md#audio-focus-strategy) of the respective recording stream types. You need to ensure proper focus adaptation.
