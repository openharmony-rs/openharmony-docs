...
4. Call [OH_AVImageGenerator_FetchFrameByTime()](../../reference/apis-media-kit/capi-avimage-generator-h.md#oh_avimagegenerator_fetchframebytime) to obtain the video frame at a specified time, which is an OH_PixelmapNative object.
   ...
   ```
5. Call [OH_AVImageGenerator_Release()](../../reference/apis-media-kit/capi-avimage-generator-h.md#oh_avimagegenerator_release) to destroy the instance and release resources.
   ```c
   // Release the OH_AVImageGenerator resource.
   OH_AVImageGenerator_Release(generator);
   ```
