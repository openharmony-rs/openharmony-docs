...
To implement background playback, an application needs to use the capabilities of [Background Tasks Kit](../../task-management/background-task-overview.md) to request a continuous task to avoid being suspended.
