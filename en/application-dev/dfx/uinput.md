...
# Simulate a three-finger swipe. The first finger touches down at (300, 900) and moves to (300, 2000), the second finger touches down at (600, 900) and moves to (600, 2000), and the third finger touches down at (900, 900) and moves to (900, 2000). The total movement duration is 200 ms. After the movement, the fingers stay on the screen for 1000 ms before lifting.
