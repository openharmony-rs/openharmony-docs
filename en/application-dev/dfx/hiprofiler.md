...
Obtains the GPU usage information.
...
| report_gpu_info | bool | Whether to display the GPU usage of a specified process.| The value **true** means to display the GPU data of a specified process (PID needs to be set), and <b class="+ topic/ph hi-d/b " id="b997320020619">false</b> means the opposite.|


### cpu-plugin

Obtains the CPU usage information.
...
Obtains the disk I/O usage information of the entire device.
...
Obtains the frame rate of an application process.
