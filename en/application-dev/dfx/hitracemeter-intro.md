...
This topic describes how to use the HitraceMeter APIs. You can call them to log traces, and then use the trace collection APIs provided by [hitrace](hitrace.md) or [hidebug](hidebug-guidelines.md#obtaining-application-trace-records) to obtain the trace information generated during application running. In this way, you can learn about the application running process, thread, timestamp, and CPU information for performance profiling and optimization.
