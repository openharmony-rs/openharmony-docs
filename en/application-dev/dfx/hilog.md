...
The local time is displayed in milliseconds.
...
This log indicates that the number of logs printed by process com.example.myapplication exceeds the threshold. Before 17:02:34.219, 3091 lines of logs are discarded due to overload control and are not printed.
...
This log indicates that the number of logs generated by domain ID 02C02 exceeds the threshold. Before 17:02:34.219, 108 logs are discarded due to threshold-crossing control and are not printed.
