...
| ReleaseType | Release type of the SDK used for application packing.| 23 | No| This field is displayed only for application processes. For details, see **releaseType** in [ApplicationInfo](../reference/apis-ability-kit/js-apis-bundleManager-applicationInfo.md#applicationinfo-1).|
