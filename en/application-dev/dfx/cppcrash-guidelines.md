...
Preinstalled:Yes <- Whether the application is pre-installed.
Foreground:Yes <- Whether the application is in the foreground or background.
...
Process name:./crasher_cpp <- Name of the faulty process.
Process life time:1s  <- Life time of the faulty process.
Process Memory(kB): 11902(Rss)     <- Memory usage of the faulty process.
...
HiTraceId:a92ab1c7eae68fa  <- HiTraceId. (Optional. If the fault thread does not have HiTraceId, it is not printed.)
Process name:./crasher_cpp             <- Name of the faulty process.
Process life time:2s                   <- Life time of the faulty process.
Process Memory(kB): 11902(Rss)     <- Memory usage of the faulty process.
Device Memory(kB): Total 1935820, Free 516244, Available 1205608 <- Device memory status (optional).
