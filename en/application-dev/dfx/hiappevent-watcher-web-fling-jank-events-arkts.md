...
<!--Tester: @gcw_KuLfPSbe-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=0eccf7ebed426c6515856583f4203fa316300125 translatedAt=2026-07-30T02:58:14.500Z pushedAt=2026-07-30T07:31:13.833Z -->
     ...
     onReceive: (domain: string, appEventGroups: Array<hiAppEvent. AppEventGroup>) => {
       ...
       for (const eventGroup of appEventGroups) {
         ...
         for (const eventInfo of eventGroup.appEventInfos) {
           ...
           // Obtain the ID of the web page where jank occurs.
           ...
           //webIdToUrlMap is a defined variable that maps webId to URL, used to query the web page where frame drops occur by the web_id obtained from the system side.
...
4. Edit the **entry > src > main > ets > pages > Index.ets** file in the project, and add the navigation route stack **navPathStack** and the page route map **PageMap** to manage page redirection and declare the target web page (ArkWebPage). Sample code:
   ...
   ``` TypeScript
   // A button navigates to a web scenario prone to sliding jank, triggering the ArkWeb fling jank event.
