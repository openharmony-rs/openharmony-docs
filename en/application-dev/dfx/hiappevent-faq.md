...
- If you have the permission to access the **/data/app/el2/100/log/*application bundle name*** directory on the device, you can manually delete the **external_log** files.
