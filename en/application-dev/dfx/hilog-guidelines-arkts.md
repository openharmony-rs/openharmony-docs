...
<!--Tester: @yufeifei-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=dc655e6395c7b7043d69f321d97f334b4b91f3b5 translatedAt=2026-07-30T03:02:29.931Z pushedAt=2026-07-30T08:28:05.895Z -->
       ...
       Row() {
         Column() {
           ...
           Button($r('app.string.HiLogArkTS_Button'))
             ...
             .width('40%')
             .height('5%')
             // Bind the onClick event to the button. When the button is tapped, a log is printed. Note: A release HAP package cannot print DEBUG-level logs by default.
             .onClick(() => {
               //isLoggable checks whether the domain ID and tag meet the current log level for printing. It is recommended to check the return value.
               ...
               // Set the minimum log level for app log printing. After the setting takes effect, logs below the WARN level cannot be printed.
               ...
               // Set the minimum log level for the app log PREFER_OPEN_LOG policy. After the setting takes effect, logs at or above the INFO level can be printed.
           ...
           Button($r('app.string.SandboxLogArkTS_Button'))
             ...
             // Bind the onClick event to the button. When the button is tapped, a log is printed. Note: A release HAP package cannot print DEBUG-level logs by default.
             .onClick(() => {
               // Set the log output type to SHARE_SANDBOX_WITH_CONSOLE to output to both the public sandbox and the console.
               ...
               // Obtain the log files written within the last 2 minutes in the sandbox directory.
