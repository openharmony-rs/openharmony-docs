...
- Unit test capability: provides basic APIs and running mechanisms for automated tests. For details, see [JsUnit User Guide](unittest-guidelines.md). The main features are as follows:
...
- UI test capability: provides automated UI test features. UI test scripts are developed based on JSUnit. For details, see [UITest User Guide](uitest-guidelines.md). The main features are as follows:
...
- Performance test capability: provides automated white-box performance test features. Performance test scripts are developed based on JSUnit. For details, see [PerfTest User Guide](perftest-guideline.md). The main features are as follows:
