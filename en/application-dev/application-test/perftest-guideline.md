...
<!--Del-->
For details about the PerfTest project example, see [White-Box Performance Test Example](https://gitcode.com/openharmony/applications_app_samples/tree/master/code/DocsSample/Test/perftest).
<!--DelEnd-->
