...
In addition to ArkTS APIs, you can use C/C++ APIs for user directory access. For details about the APIs, see [oh_environment.h](../reference/apis-core-file-kit/capi-oh-environment-h.md).
