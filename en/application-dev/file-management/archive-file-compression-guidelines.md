...
<!--Tester: @zheng1368-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=51a4d474cf496c221e08074148023a74c0addf3b translatedAt=2026-08-26T04:29:01.030Z pushedAt=2026-08-28T03:17:19.192Z -->
...
{
    // Obtain the input file path and the output archive file path.
    size_t argc = 2;
    ...
    // Set a progress callback to obtain compression progress information.
...
static napi_value ZipFileDecompress(napi_env env, napi_callback_info info)
{
    ...
    // Decompress all files in the archive file to the specified directory.
