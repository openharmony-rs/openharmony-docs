...
2. Create a **DocumentSelectOptions** instance.
   ...
   // Set the type of the documents to select. The default value is FILE. This parameter can be used on 2-in-1 devices but does not take effect on other devices.
