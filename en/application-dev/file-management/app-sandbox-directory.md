...
3. There are files of different encryption levels in **el1/** and **el5/**.
    ...
    Encryption Level 5 (EL5):
     ...
     - EL5 directories are not generated by default unless the permissions for access to the EL5 database are configured. For details, refer to [Using an EL5 Database](../database/encrypted-estore-guidelines.md).
