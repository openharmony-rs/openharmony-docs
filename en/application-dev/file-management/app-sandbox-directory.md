...
3. Third-level directories **el1/** to **el5/**: different file encryption types.
    ...
    Encryption Level 5 (EL5):
     ...
     - EL5 directories are not generated by default unless the permissions for access to the EL5 database are configured. For details, see [Using an EL5 Database (ArkTS)](encrypted-estore-guidelines.md)
