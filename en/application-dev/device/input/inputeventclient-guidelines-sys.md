...
The following table lists common APIs for event injection. For details, see [@ohos.multimodalInput.inputEventClient](../../reference/apis-input-kit/js-apis-inputeventclient-sys.md).
