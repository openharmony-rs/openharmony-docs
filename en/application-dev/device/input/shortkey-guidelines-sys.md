...
The following table lists common APIs for event injection. For details, see [@ohos.multimodalInput.shortKey](../../reference/apis-input-kit/js-apis-shortKey-sys.md).
