...
The following table lists the APIs for creating and deleting event listening. For details, see [oh_input_manager.h](../../reference/apis-input-kit/capi-oh-input-manager-h.md).
