...
- Example (using asynchronous APIs):
  ...
  async function signMessageBySegment(priKey: cryptoFramework.PriKey, plainText: Uint8Array) {
    ...
    let textSplitLen = 64; // Set the length of the data to be passed each time. In this example, the value is 64.
    ...
    // Pass null here because all the plaintext has been passed by segment.
  ...
  async function verifyMessageBySegment(pubKey: cryptoFramework.PubKey, plainText: Uint8Array,
    ...
    // Pass null in the first parameter of verify() because all the plaintext has been passed by segment.
