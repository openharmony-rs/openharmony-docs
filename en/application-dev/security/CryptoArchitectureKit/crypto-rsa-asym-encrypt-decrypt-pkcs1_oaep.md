...
- Example (using asynchronous APIs):
  ...
  async function rsaUseSpecDecryptOAEPPromise() {
    ...
    // Set pSource for RSA encryption/decryption in PKCS1-OAEP mode.
    ...
    // Set and get the Cipher specifications after the initialization.
    cipher.setCipherSpec(cryptoFramework.CipherSpecItem.OAEP_MGF1_PSRC_UINT8ARR, pSource);
    let retP = cipher.getCipherSpec(cryptoFramework.CipherSpecItem.OAEP_MGF1_PSRC_UINT8ARR);
    // Check whether the pSource you get is the same as the one you set.
