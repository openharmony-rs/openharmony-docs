...
Allows an application to access the images/videos in a user public directory.
...
Allows an application to save images and videos to the user public directory within up to 30 minutes after obtaining the permission.
