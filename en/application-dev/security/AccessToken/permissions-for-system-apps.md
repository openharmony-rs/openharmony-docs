...
Allows an application to call the storage_manager API for managing volume encryption.
...
Allows an application to call the storage_manager API for managing optical disc burning.
