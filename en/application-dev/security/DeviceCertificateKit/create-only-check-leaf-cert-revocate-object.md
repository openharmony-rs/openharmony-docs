...
5. Construct the [cert.CertChainValidationParameters](../../reference/apis-device-certificate-kit/js-apis-cert.md#certchainvalidationparameters11) a parameter object for certificate chain verification.
