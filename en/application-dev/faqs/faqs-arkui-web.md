...
Use the **JavaScriptProxy** method in ArkTs to register the object in ArkTS with the window object of HTML5, and then use the window object to call this method in HTML5. In the following example, the **testObj** object in ArkTS is registered with the HTML5 window object under the alias **testObjName**. Then in HTML5, **window.testObjName** can then be used to access the object.
