...
Before developing applications based on the [stage model](application-configuration-file-overview-stage.md), you need to have a basic understanding of the application design mechanism and application package structure.
