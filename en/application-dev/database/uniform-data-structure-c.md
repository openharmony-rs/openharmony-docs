...
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=bed4448494720f3be3d1109ceb94048202c4d1d7 translatedAt=2026-08-20T06:23:30.694Z pushedAt=2026-08-20T12:09:31.554Z -->

## When to Use

Uniform data structs are provided for some common UTD data types defined in [utd.h](../reference/apis-arkdata/capi-utd-h.md). For example, the system-defined home screen icon type (whose standardized data type identifier is `OH_UdsAppItem`) clearly defines the related description information.
...
For details about the APIs, see the uniform data struct APIs defined in [uds.h](../reference/apis-arkdata/capi-uds-h.md).
