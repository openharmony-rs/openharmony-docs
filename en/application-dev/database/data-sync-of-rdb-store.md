...
<!--Tester: @logic42-->
<!--Adviser: @ge-yafang-->
<!-- md-trans-meta sourceCommit=81165a532e10b3d1517ed6f395ac6f3808130ce3 translatedAt=2026-09-14T08:34:07.635Z pushedAt=2026-09-14T11:57:16.456Z -->
...
| Name | Description |
| -------- | -------- |
| setDistributedTables(tables: Array&lt;string&gt;, callback: AsyncCallback&lt;void&gt;): void | Sets distributed synchronization tables. Only the multi-device collaborative table schema is supported. |
...
| obtainDistributedTableName(device: string, table: string, callback: AsyncCallback&lt;string&gt;): void | Obtains the table name on a specified device based on the local database table name. Only the multi-device collaborative table schema is supported. |
