...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=a1a66e5c6f23403599f8c889ccfd4d206a6e4cd7 translatedAt=2026-09-21T02:20:44.371Z pushedAt=2026-09-21T13:37:18.627Z -->
...
// ...
  onWindowStageCreate(windowStage: window.WindowStage): void {
    windowStage.loadContent('pages/Index', (err, data) => {
      ...
      // Create a Web dynamic component (UIContext must be passed in). It can be created at any time after loadContent.
...
export class MyNodeController extends NodeController {
  ...
  // A method that must be overridden. It builds the node tree and returns the node to be mounted in the corresponding NodeContainer.
...
// Custom API for obtaining the NodeController.
...
// ...
  onWindowStageCreate(windowStage: window.WindowStage): void {
    windowStage.loadContent('pages/Index', (err, data) => {
      ...
      // Create an empty Web dynamic component (UIContext needs to be passed in). It can be created at any time after loadContent.
...
export class MyNodeController extends NodeController {
  ...
  // Method that must be overridden. It builds the node tree and returns the node to be mounted in the corresponding NodeContainer.
  // Call it when the NodeContainer is created or call rebuild() to refresh.
  makeNode(uiContext: UIContext): FrameNode | null {
    console.info('uiContext is undefined : ' + (uiContext === undefined));
    if (this.rootNode !== null) {
  ...
  // Called when the NodeContainer bound to the controller appears.
  aboutToAppear() {
    console.info('aboutToAppear');
  }

  // Called when the NodeContainer bound to the controller disappears.
  aboutToDisappear() {
    console.info('aboutToDisappear');
  }
...
export class MyNodeController extends NodeController {
  ...
  // Method that must be overridden. It is used to build the node tree and return the node to be mounted in the corresponding NodeContainer.
  // Call it when the NodeContainer is created or call rebuild() to refresh.
  makeNode(uiContext: UIContext): FrameNode | null {
    console.info('uiContext is undefined : ' + (uiContext === undefined));
    if (this.rootNode !== null) {
