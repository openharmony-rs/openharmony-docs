...
2. Refer to <!--RP1-->Native Access to the App Sandbox<!--RP1End--> to access the dmp file in the app sandbox. You can also copy the file from the sandbox path where the dmp file is stored to a path that can be viewed. Example:
