...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=b0b2c896e2b3fdb267fb7000f3a2655a0ee2a486 translatedAt=2026-09-21T02:05:06.384Z pushedAt=2026-09-21T10:28:50.073Z -->
...
**Solution**
  ...
  * After the forwarding succeeds, open `http://localhost:9222/json` using the Chrome on the PC. Change `9222` in the URL to the actual TCP port number.

    - If the web page has content, port forwarding is successful. In this case, wait for the debugged page to appear on the Chrome debugging page. See [Waiting for the Page to Be Debugged](#waiting-for-the-page-to-be-debugged).<br/>
