...
<!--Tester: @ghiker-->
<!--Adviser: @HelloShuo-->
<!-- md-trans-meta sourceCommit=058631a952847490cd69834d7fb662ea9b641f0d translatedAt=2026-09-20T07:10:49.390Z pushedAt=2026-09-20T08:47:12.335Z -->
...
Since API version 22, you can use the [setLazyInitializeWebEngine()](../reference/apis-arkweb/arkts-apis-webview-WebCookieManager.md#setlazyinitializewebengine22) API to delay ArkWeb kernel initialization, so that when calling configCookieSync() to set the value of a single cookie to **value=test** for “www\.example.com”, ArkWeb kernel initialization is skipped, thereby reducing the [configCookieSync()](../reference/apis-arkweb/arkts-apis-webview-WebCookieManager.md#configcookiesync11) API call time. For details about features and usage of other cookie-related APIs, see [WebCookieManager()](../reference/apis-arkweb/arkts-apis-webview-WebCookieManager.md).
...
> **NOTE**
>
> Cookies are saved to disk every 30 seconds. You can also use the [saveCookieAsync](../reference/apis-arkweb/arkts-apis-webview-WebCookieManager.md#savecookieasync) API to forcibly save cookies to disk. (Even if **saveCookieAsync** is called, session cookies are not written to disk in PCs/2-in-1 devices and tablets.)
