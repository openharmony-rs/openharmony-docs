...
- [About This Kit](content-embed-kit-overview.md)
- [Client-Server Interaction Process](client-server-interaction-process.md)
- [Server Application Development](content-embed-server-guidelines.md)
