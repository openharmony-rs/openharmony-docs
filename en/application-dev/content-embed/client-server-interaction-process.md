...
3. Start the OE Extension: When embedding or editing an OE document, the OE client application must call OE framework APIs to notify the OE server to start the OE Extension component.
