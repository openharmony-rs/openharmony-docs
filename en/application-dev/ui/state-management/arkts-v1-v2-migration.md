...
<!-- md-trans-meta sourceCommit=c4eacd7749f17b808b6e998528fa58a7554f7518 translatedAt=2026-09-21T11:49:35.423Z pushedAt=2026-09-23T09:38:19.265Z -->
...
<!--RP2-->
To help applications developed based on V1 migrate smoothly to V2, this document provides [migration guidance from state management V1 to V2](./arkts-v1-v2-migration-inner-component.md), covering common scenarios encountered during migration so that you can adapt flexibly to your own business needs. In addition, for the [mixed-use scenario of state management V1 and V2](./arkts-v1-v2-mixusage-before-api-version.md) that may arise during the transitional migration phase, this document explains the rules and practical methods for mixing V1 and V2 components, and provides targeted solutions based on the differences before and after API version 19, helping you achieve gradual refactoring.
<!--RP2End-->
...
| No computing capability| [@Computed](./arkts-new-computed.md) | State management V1 does not provide computed property capabilities. State management V2 can use \@Computed to avoid repeated calculation. For details, see [Repeated Calculation -> @Computed Property](./arkts-v1-v2-migration-inner-component.md#repeated-calculation---computed-property).|
