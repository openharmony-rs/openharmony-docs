...
**collections** provide ArkTS container sets for high-performance data passing in concurrent scenarios. FFor details, see [@arkts.collections (ArkTS Collections)](../../reference/apis-arkts/arkts-apis-arkts-collections.md).
