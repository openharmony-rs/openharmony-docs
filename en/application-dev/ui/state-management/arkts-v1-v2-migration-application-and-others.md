...
- You can manually trigger persistence operations by calling the [PersistenceV2.save](../../reference/apis-arkui/js-apis-StateManagement.md#save) and [PersistenceV2.globalConnect](./arkts-new-persistencev2.md) APIs.
