...
- The custom component decorated with @ReusableV2 remains frozen during recycling, meaning UI updates and [\@Monitor](./arkts-new-monitor.md) callbacks cannot be triggered. Unlike the [freezeWhenInactive](./arkts-custom-components-freezeV2.md) flag, no delayed refresh occurs after the frozen state is released.
