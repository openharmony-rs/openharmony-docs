...
1. Adopt state management V2 decorators.
   ...
   It is recommended that **Repeat** be used with the decorators of state management V2. (The lazy loading mode can be used only with V2 decorators. For details, see [How It Works](../rendering-control/arkts-new-rendering-control-repeat.md#how-it-works).) If you are currently using state management V1, migrate to V2.
...
4. Configure lazy loading.
  ...
  **Repeat** supports full loading and lazy loading.

  - Full loading renders all child components (similar to [ForEach](../rendering-control/arkts-rendering-control-foreach.md)). For details, see [Lazy Loading Disablement](../rendering-control/arkts-new-rendering-control-repeat.md#lazy-loading-disablement).

  - Lazy loading dynamically renders child components in the screen and preload areas (requires the use of container components, similar to **LazyForEach**). For details, see [How It Works](../rendering-control/arkts-new-rendering-control-repeat.md#how-it-works).
