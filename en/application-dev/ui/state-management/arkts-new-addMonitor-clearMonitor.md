...
## Overview
The [\@Monitor](./arkts-new-monitor.md) decorator, when declared within an [\@ObservedV2](./arkts-new-observedV2-and-trace.md) or [\@ComponentV2](./arkts-create-custom-components.md#componentv2) decorated class, automatically applies the same listener callback to all instances of that class. These \@Monitor decorated callbacks are static and cannot be removed.
