...
The [makeV1Observed](../../reference/apis-arkui/js-apis-stateManagement.md#makev1observed19) API encapsulates non-observable objects into observable objects of V1. **makeV1Observed** has the same capability as \@Observed, and its return value can be used to initialize \@ObjectLink.
