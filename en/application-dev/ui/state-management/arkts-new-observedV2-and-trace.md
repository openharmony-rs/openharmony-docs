...
| --------------------- | ------------------------------------------------------------ |
| Parameters           | N/A                                                          |
| Supported type         | Member properties in classes in any of the following types: Member properties in classes in any of the following types: number, string, boolean, class, [Array](#decorating-an-array-of-a-built-in-type-with-trace), [Date](#decorating-a-property-of-the-date-type-with-trace), [Map](#decorating-a-property-of-the-map-type-with-trace), and [Set](#decorating-a-property-of-the-set-type-with-trace).|
