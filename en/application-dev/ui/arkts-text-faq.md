...
@Component
struct Index {
  @State message: string = 'Mixed Hello World! Chinese and English digits in multiple lines 1282378283 ~';
...
struct TextExample {
  ...
  static getEmojiImg(emojis: string[]): Resource[] { // Return emoji image resources based on parsed codes.
    ...
    for (let i = 0; i < emojis.length; i++) {
      switch (emojis[i]) { // Replace $r("...") with the image resource you use.
