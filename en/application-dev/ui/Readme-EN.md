...
- UI Development (ArkTS-based Declarative Development Paradigm)<!--arkts-ui-development-->
  ...
  - Basic Syntax of UI Paradigms<!--arkts-ui-paradigm-basic-syntax-->
    ...
    - [@Reusable Decorator: Reusing Components](state-management/arkts-reusable.md)
  - UI Paradigm State Management<!--arkts-state-management-->
    ...
    - State Management V1<!--arkts-state-management-v1-->
      ...
      - Other State Management Features<!--arkts-other-state-mgmt-functions-->
        ...
        - [Freezing a Custom Component](state-management/arkts-custom-components-freeze.md)
      - [MVVM](state-management/arkts-mvvm.md)
      - [Best Practices for State Management](state-management/arkts-state-management-best-practices.md)
      - [Proper Use of State Management](state-management/properly-use-state-management-to-develope.md)
