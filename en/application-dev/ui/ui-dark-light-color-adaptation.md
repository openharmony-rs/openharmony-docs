...
> - If color inversion is required in cross-process scenarios, the [UIExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-uiExtensionAbility.md) and [its host](../reference/apis-arkui/js-apis-arkui-uiExtension.md) must be adapted at the same time.
