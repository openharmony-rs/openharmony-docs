...
The property animation refers to the continuous visual effect generated on the UI when the value of an animatable property changes. It is implemented by setting continuous value changes of a property to the property API that can cause the UI re-render.
