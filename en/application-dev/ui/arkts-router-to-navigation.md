...
Each subpage also needs to be configured in the system configuration file **router_map.json** (see [System Routing Table](arkts-navigation-navigation.md#system-routing-table)).
