...
- [Navigation transition](./arkts-navigation-jump.md#navigation-examples): used during page navigation, where one page disappears and another page appears. For example, it can be used for switching from a level-1 menu page to a level-2 details page.
