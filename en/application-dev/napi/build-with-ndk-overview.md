...
By default, the OpenHarmony NDK uses CMake as the build system. To simplify your configuration process, the NDK provides the configuration file <!--RP2-->[ohos.toolchain.cmake](#introduction-to-ohostoolchaincmake)<!--RP2End--> that complies with the OpenHarmony toolchain to predefine CMake variables.
