...
> **NOTE**
> 
> After an application is moved to the background, its lifecycle changes vary depending on the device type. For details, see [Differentiated Lifecycle Behaviors Across Different Devices](../windowmanager/window-overview.md#differentiated-lifecycle-behaviors-across-different-devices).
