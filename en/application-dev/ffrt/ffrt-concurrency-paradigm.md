...
<!--Tester: @lotsof-->
<!--Adviser: @jinqiuheng-->
<!-- md-trans-meta sourceCommit=99de6ea4cb9fbb5492225360bd6bd82121ebd7c1 translatedAt=2026-08-24T11:39:04.077Z pushedAt=2026-08-25T08:21:28.747Z -->
...
1. **Complex task dependency**: In many applications, tasks have complex dependencies with one another. The task graph represents task dependencies by using directed graphs to clearly manage and schedule tasks.

2. **Dynamic task scheduling**: When task dependencies and execution order need to be determined dynamically based on runtime conditions, the graph-based concurrency paradigm can flexibly adjust task scheduling to ensure tasks execute in the correct order.
