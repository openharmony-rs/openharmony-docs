...
-   [How to教程](https://gitcode.com/openharmony/docs/blob/master/zh-cn/contribute/template/tutorial-template.md)：贡献至`contribute/tutorial`文件夹下。
-   [FAQ](https://gitcode.com/openharmony/docs/blob/master/zh-cn/contribute/template/faq-template.md)：贡献至`contribute/faqs`文件夹下。
