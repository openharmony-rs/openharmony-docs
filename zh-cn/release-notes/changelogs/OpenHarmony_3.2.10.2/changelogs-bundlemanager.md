...
API9的ApplicationInfo结构体[bundleManager/applicationInfo.d.ts](https://gitcode.com/openharmony/interface_sdk-js/blob/master/api/bundleManager/ApplicationInfo.d.ts)字段变更，新增systemApp字段，删除entryDir字段。
...
API9的HapModuleInfo结构体[bundleManager/hapModuleInfo.d.ts](https://gitcode.com/openharmony/interface_sdk-js/blob/master/api/bundleManager/HapModuleInfo.d.ts)字段变更，删除moduleSourceDir字段。
