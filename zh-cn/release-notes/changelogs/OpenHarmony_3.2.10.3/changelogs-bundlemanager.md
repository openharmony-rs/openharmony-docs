...
API9的包管理分布式查询模块名称变更，由ohos.bundle.distributedBundle变更为[ohos.bundle.distributedBundleManager](https://gitcode.com/openharmony/interface_sdk-js/blob/master/api/@ohos.bundle.distributedBundleManager.d.ts)，接口未发生变更。
