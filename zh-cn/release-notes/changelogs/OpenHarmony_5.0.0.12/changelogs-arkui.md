...
[@Require装饰器：校验构造传参](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/ui/state-management/arkts-require.md)
...
[自定义组件成员属性访问限定符使用限制](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/ui/state-management/arkts-custom-components-access-restrictions.md)
