...
```
repo init -u git@gitcode.com:openharmony/manifest.git -b refs/tags/OpenHarmony-v3.1.2-Release --no-repo-verify
repo sync -c
...
```
repo init -u https://gitcode.com/openharmony/manifest.git -b refs/tags/OpenHarmony-v3.1.2-Release --no-repo-verify
repo sync -c
repo forall -c 'git lfs pull'
```
...
| 应用子系统 | -&nbsp;修复通知管理界面相关的问题（[I5FLLB](https://gitcode.com/openharmony/applications_systemui/issues/I5FLLB)）<br/>-&nbsp;修复备忘录的一些缺陷问题（[5FJGJ](https://gitcode.com/openharmony/applications_notes/issues/I5FJGJ)）（[I5FJ9L](https://gitcode.com/openharmony/applications_notes/issues/I5FJ9L)）（[I5FJCS](https://gitcode.com/openharmony/applications_notes/issues/I5FJCS)） |
...
| ISSUE | 问题描述 | 修复链接 |
| -------- | -------- | -------- |
| I5FZTU | 修复组件linux&nbsp;kernel&nbsp;5.10上的CVE-2022-21125、CVE-2022-2153、CVE-2022-32296安全漏洞。 | [PR](https://gitcode.com/openharmony/kernel_linux_5.10/pulls/307) |
| I5FZT0 | 修复组件linux&nbsp;kernel&nbsp;5.10上的CVE-2022-1508、CVE-2022-1972、CVE-2022-1998、CVE-2022-21499、CVE-2022-32981安全漏洞。 | [PR](https://gitcode.com/openharmony/kernel_linux_5.10/pulls/301) |
| I5FZSH | 修复组件linux&nbsp;kernel&nbsp;5.10上的CVE-2022-1974、CVE-2022-1975、CVE-2022-20153、CVE-2022-20154、CVE-2022-20132安全漏洞。 | [PR](https://gitcode.com/openharmony/kernel_linux_5.10/pulls/302) |
| I5FZQS | 修复组件linux&nbsp;kernel&nbsp;5.10上的CVE-2022-1729、CVE-2022-29581安全漏洞。 | [PR](https://gitcode.com/openharmony/kernel_linux_5.10/pulls/299) |
| I5CQMC | 修复组件third_party_chromium上的CVE-2022-2158、CVE-2022-2161、CVE-2022-2163、CVE-2022-2164、CVE-2022-2157、CVE-2022-2165、CVE-2022-2160、CVE-2022-2156、CVE-2022-1501、CVE-2022-2008、CVE-2022-2010、CVE-2022-2011、CVE-2022-1857、CVE-2022-1874、CVE-2022-0311、CVE-2022-1314安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_chromium/pulls/29) |
| I5GG74 | 修复组件third_party_openssl上的CVE-2022-2097安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_openssl/pulls/64) |
| I5GQI2 | 修复组件third_party_curl上的CVE-2022-22576、CVE-2022-27775、CVE-2022-27774、CVE-2022-27776安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_curl/pulls/51) |
| I5H1HU | 修复组件third_party_flutter下libjpeg-turbo组件的CVE-2021-46822安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_flutter/pulls/117) |
| I5KI54 | 修复组件third_party_freetype的CVE-2022-27405安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_freetype/pulls/32) |
| I5J8V2 | 升级组件third_party_node到14.19.1版本，解决CVE-2022-32212、CVE-2022-32213、CVE-2022-2097、CVE-2022-32215安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_node/pulls/29) |
| I59ZPI | 升级组件third_party_ntfs-3g到2022.5.17版本，修复2021.8.22版本上的已知安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_ntfs-3g/pulls/18) |
| I5EEXE | 修复组件third_party_pcre2组件的CVE-2022-1586、CVE-2022-1587安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_pcre2/pulls/24) |
| I5I9YX | 修复组件third_party_selinux上的CVE-2021-36085CVE-2021-36084CVE-2021-36087安全漏洞。 | [PR](https://gitcode.com/openharmony/third_party_selinux/pulls/31) |
...
| -------- | -------- | -------- | -------- |
| [I5M0GH](https://gitcode.com/openharmony/applications_notes/issues/I5M0GH) | 备忘录—最近删除界面选中笔记点击恢复按钮无反应。 | 备忘录demo应用，影响开发者体验。 | 2022/9/30 |
