...
| RK3568标准系统解决方案（二进制）ROM包        | 6.1 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/6.1-Release/dayu200_standard_arm32_rom.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/6.1-Release/dayu200_standard_arm32_rom.tar.gz.sha256) | 4.1 GB |
