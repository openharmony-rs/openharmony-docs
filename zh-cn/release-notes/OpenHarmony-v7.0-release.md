...
#### [SIM 卡管理](https://gitcode.com/openharmony/applications_simcardmanagement)
...
#### [升级](https://gitcode.com/openharmony/update_update_app)

- 支持系统软件OTA更新。
- 支持手动触发更新、夜间自动更新、升级功能配置（自动下载、夜间升级等开关）。
- 支持全量升级、差分升级、断点续传、升级包压缩（zip模式）、AB方式升级。
- 支持OTA升级安全（升级包安全）。
- 支持升级可靠性（掉电后继续升级）。
- 支持可制造性，出货版本升级、产线 OTG/SD 卡升级。
- 支持本地更新（fastboot 刷写、SD 卡和 OTG 刷新）。
- 支持恢复出厂设置。
...
| Hi3861解决方案（二进制）        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus.tar.gz.sha256) | 28.9 MB |
| Hi3863解决方案（二进制）        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus_3863.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus_3863.tar.gz.sha256) | 8.1 MB |
| Hi3861 64K解决方案（二进制）        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus_64k.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_pegasus_64k.tar.gz.sha256) | 8.0 MB |
...
| Hi3516解决方案-LiteOS（二进制） | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_taurus_LiteOS.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_taurus_LiteOS.tar.gz.sha256) | 362.4 MB |
| Hi3516解决方案-Linux（二进制）  | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_taurus_Linux.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/hispark_taurus_Linux.tar.gz.sha256) | 239.7 MB |
| RK3568标准系统解决方案（二进制）ROM包        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu200_standard_arm32_rom.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu200_standard_arm32_rom.tar.gz.sha256) | 1.9 GB |
| RK3568标准系统解决方案（二进制）XTS包        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu200_standard_arm32_xts.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu200_standard_arm32_xts.tar.gz.sha256) | 4.9 GB |
| P7885标准系统解决方案（二进制）ROM包        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu600_standard_arm32_rom.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu600_standard_arm32_rom.tar.gz.sha256) | 5.2 GB |
| P7885标准系统解决方案（二进制）XTS包        | 7.0 Release    | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu600_standard_arm32_xts.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/dayu600_standard_arm32_xts.tar.gz.sha256) | 5.0 GB |
| 标准系统Public SDK包（Mac）             | 26.0.0.38 | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/ohos-sdk-mac-public.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/ohos-sdk-mac-public.tar.gz.sha256) | 1.3 GB |
| 标准系统Public SDK包（Mac-M1）             | 26.0.0.38  | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/L2-SDK-MAC-M1-PUBLIC.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/L2-SDK-MAC-M1-PUBLIC.tar.gz.sha256) | 1.2 GB |
| 标准系统Public SDK包（Windows/Linux）   | 26.0.0.38   | [站点](https://repo.huaweicloud.com/openharmony/os/7.0-Release/ohos-sdk-windows_linux-public.tar.gz) | [SHA256校验码](https://repo.huaweicloud.com/openharmony/os/7.0-Release/ohos-sdk-windows_linux-public.tar.gz.sha256) | 3.2 GB |
