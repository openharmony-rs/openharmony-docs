...
OpenHarmony芯片适配常见子系统列表如下（详见表1），需结合具体芯片再做增加、删减操作。
...
| updater | 升级子系统。用来支持OpenHarmony设备的OTA升级。 | 
| commonlibrary | 公共基础库子系统。提供了一些常用的C、C++开发增强API。 | 
| systemabilitymgr | 系统服务管理子系统。提供本地系统服务的注册、发现和管理功能。 | 
| security | 安全子系统。包括应用权限管理、IPC通信鉴权等一些轻量级功能。 | 
| testfwk | 测试子系统。OpenHarmony为开发者提供了一套全面的自测试框架，开发者可根据测试需求开发相关测试用例，开发阶段提前发现缺陷，大幅提高代码质量。 | 
