...
- 参考
  ...
  - HDI参考
    ...
    - Camera HDI 参考
      - camera
        - 模块
          - [Camera (V1_3)](reference/hdi-apis/camera/_camera_v13.md)
        ...
        - 头文件
          - Camera (V1_3)
            - [ICameraDevice.idl](reference/hdi-apis/camera/_i_camera_device_8idl_v13.md)
            - [ICameraHost.idl](reference/hdi-apis/camera/_i_camera_host_8idl_v13.md)
            - [IImageProcessService.idl](reference/hdi-apis/camera/_i_image_process_service_8idl_v13.md)
            - [IStreamOperator.idl](reference/hdi-apis/camera/_i_stream_operator_8idl_v13.md)
            - [IStreamOperatorCallback.idl](reference/hdi-apis/camera/_i_stream_operator_callback_8idl_v13.md)
            - [IVideoProcessCallback.idl](reference/hdi-apis/camera/_i_video_process_callback_8idl_v13.md)
            - [IVideoProcessService.idl](reference/hdi-apis/camera/_i_video_process_service_8idl_v13.md)
            - [IVideoProcessSession.idl](reference/hdi-apis/camera/_i_video_process_session_8idl_v13.md)
            - [Types.idl](reference/hdi-apis/camera/_types_8idl_v13.md)
          - Camera (V1_2)
        ...
        - 结构体
          - Camera (V1_3)
            - [CameraDeviceResourceCost](reference/hdi-apis/camera/_camera_device_resource_cost_v13.md)
            - [CaptureEndedInfoExt](reference/hdi-apis/camera/_capture_ended_info_ext_v13.md)
            - [ICameraDevice](reference/hdi-apis/camera/interface_i_camera_device_v13.md)
            - [ICameraHost](reference/hdi-apis/camera/interface_i_camera_host_v13.md)
            - [IImageProcessCallback](reference/hdi-apis/camera/interface_i_image_process_callback_v13.md)
            - [IImageProcessService](reference/hdi-apis/camera/interface_i_image_process_service_v13.md)
            - [ImageBufferInfoExt](reference/hdi-apis/camera/_image_buffer_info_ext_v13.md)
            - [IStreamOperator](reference/hdi-apis/camera/interface_i_stream_operator_v13.md)
            - [IStreamOperatorCallback](reference/hdi-apis/camera/interface_i_stream_operator_callback_v13.md)
            - [IVideoProcessCallback](reference/hdi-apis/camera/interface_i_video_process_callback_v13.md)
            - [IVideoProcessService](reference/hdi-apis/camera/interface_i_video_process_service_v13.md)
            - [IVideoProcessSession](reference/hdi-apis/camera/interface_i_video_process_session_v13.md)
            - [StreamDescription](reference/hdi-apis/camera/_stream_description_v13.md)
          - Camera (V1_2)
      ...
      - metadata
        - 模块
          - [Camera (V1_0)](reference/hdi-apis/camera/_metadata_camera_v10.md) 
        - 头文件
          - metadata（V1_0）
          - [ICameraVendorTag.idl](reference/hdi-apis/camera/_metadata_i_camera_vendor_tag_8idl_v10.md)
          - [VendorTagType.idl](reference/hdi-apis/camera/_metadata_vendor_tag_type_8idl_v10.md)
        - 结构体
          - metadata（V1_0）
          - [ICameraVendorTag](reference/hdi-apis/camera/metadata_interface_i_camera_vendor_tag_v10.md)
          - [VendorTag](reference/hdi-apis/camera/_metadata_vendor_tag_v10.md)
    - CodeC HDI 参考
      - 模块
    ...
    - Display HDI 参考
      - 模块
        - composer
          - [Display (V1_4)](reference/hdi-apis/display/_composer_display_v14.md)
          - [Display (V1_3)](reference/hdi-apis/display/_composer_display_v13.md)
        ...
        - buffer
          - [Display (V1_4)](reference/hdi-apis/display/_buffer_display_v14.md)
          - [Display (V1_3)](reference/hdi-apis/display/_buffer_display_v13.md)
      ...
      - 头文件
        - composer
          - Display (V1_4)
           - [DisplayComposerType.idl](reference/hdi-apis/display/_composer_display_composer_type_8idl_v14.md)
           - [IDisplayComposer.idl](reference/hdi-apis/display/_composer_i_display_composer_8idl_v14.md)
          - Display (V1_3)
            - [DisplayComposerType.idl](reference/hdi-apis/display/_composer_display_composer_type_8idl_v13.md)
            - [IDisplayComposer.idl](reference/hdi-apis/display/_composer_i_display_composer_8idl_v13.md)
            - [IHwcEventCallback.idl](reference/hdi-apis/display/_composer_i_hwc_event_callback_8idl_v13.md)
          - Display (V1_2)
        ...
        - buffer
          - Display (V1_4)
            - [IAllocator.idl](reference/hdi-apis/display/_buffer_i_allocator_8idl_v14.md)
          - Display (V1_3)
            - [IMapper.idl](reference/hdi-apis/display/_buffer_i_mapper_8idl_v13.md)
          - Display (V1_2)
      ...
      - 结构体
        - composer
          - Display (V1_4)
            - [IDisplayComposer](reference/hdi-apis/display/_composer_interface_i_display_composer_v14.md)
          - Display (V1_3)
            - [IDisplayComposer](reference/hdi-apis/display/_composer_interface_i_display_composer_v13.md)
            - [IHwcEventCallback](reference/hdi-apis/display/_composer_interface_i_hwc_event_callback_v13.md)
          - Display (V1_2)
        ...
        - buffer
          - Display (V1_4)
            - [IAllocator](reference/hdi-apis/display/_buffer_interface_i_allocator_v14.md)
          - Display (V1_3)
            - [IMapper](reference/hdi-apis/display/_buffer_interface_i_mapper_v13.md)
          - Display (V1_2)
    ...
    - Sensor HDI 参考
      - 模块
        - [HdiSensor](reference/hdi-apis/sensor/_sensor_convert_hdi_sensor_v10.md)
        - [HdiSensor](reference/hdi-apis/sensor/_sensor_hdi_sensor_v31.md)
        - [HdiSensor](reference/hdi-apis/sensor/_sensor_hdi_sensor_v30.md)
      ...
      - 头文件
        - Convert (V1_0)
          - [ISensorConvertInterfaces.idl](reference/hdi-apis/sensor/_sensor_i_sensor_convert_interfaces_8idl_v10.md)
          - [ISensorConvertTypes.idl](reference/hdi-apis/sensor/_sensor_i_sensor_convert_types_8idl_v10.md)
        - HdiSensor (V3_1)
          - [ISensorInterface.idl](reference/hdi-apis/sensor/_sensor_i_sensor_interface_8idl_v31.md)
          - [SensorTypes.idl](reference/hdi-apis/sensor/_sensor_sensor_types_8idl_v31.md)
        - HdiSensor (V3_0)
          - [ISensorCallback.idl](reference/hdi-apis/sensor/_sensor_i_sensor_callback_8idl_v30.md)
          - [ISensorInterface.idl](reference/hdi-apis/sensor/_sensor_i_sensor_interface_8idl_v30.md)
          - [ISensorPlugCallback.idl](reference/hdi-apis/sensor/_sensor_i_sensor_plug_callback_8idl_v30.md)
          - [SensorTypes.idl](reference/hdi-apis/sensor/_sensor_sensor_types_8idl_v30.md)
        - HdiSensor (V2_0)
      ...
      - 结构体
        - Convert (V1_0)
          - [HdfDeviceStatusPolicy](reference/hdi-apis/sensor/_sensor_hdf_device_status_policy_v10.md)
          - [HdfSensorData](reference/hdi-apis/sensor/_sensor_hdf_sensor_data_v10.md)
          - [ISensorConvertInterfaces](reference/hdi-apis/sensor/_sensor_interface_i_sensor_convert_interfaces_v10.md)
        - HdiSensor (V3_1)
          - [ISensorInterface](reference/hdi-apis/sensor/_sensor_interface_i_sensor_interface_v31.md)
        - HdiSensor (V3_0)
          - [DeviceSensorInfo](reference/hdi-apis/sensor/_sensor_device_sensor_info_v30.md)
          - [HdfSensorEvents](reference/hdi-apis/sensor/_sensor_hdf_sensor_events_v30.md)
          - [HdfSensorInformation](reference/hdi-apis/sensor/_sensor_hdf_sensor_information_v30.md)
          - [ISensorCallback](reference/hdi-apis/sensor/_sensor_interface_i_sensor_callback_v30.md)
          - [ISensorInterface](reference/hdi-apis/sensor/_sensor_interface_i_sensor_interface_v30.md)
          - [ISensorPlugCallback](reference/hdi-apis/sensor/_sensor_interface_i_sensor_plug_callback_v30.md)
          - [SdcSensorInfo](reference/hdi-apis/sensor/_sensor_sdc_sensor_info_v30.md)
          - [SensorPlugInfo](reference/hdi-apis/sensor/_sensor_sensor_plug_info_v30.md)
        - HdiSensor (V2_0)
    ...
    - USB HDI 参考
      - 模块
        ...
        - [HdiUsb（V1_2）](reference/hdi-apis/usb/_hdi_usb_v1_2.md)
        - [HdiUsb（V2_0）](reference/hdi-apis/usb/_hdi_usb_v2_0.md)
      ...
      - 头文件
        ...
        - HdiUsb模块头文件（V1_1）
          ...
          - [UsbTypes.idl](reference/hdi-apis/usb/_usb_types_8idl_v11.md)
        - HdiUsb模块头文件（V1_2）
          - [IUsbdTransferCallback.idl](reference/hdi-apis/usb/_i_usbd_transfer_callback_8idl_v1_2.md)
          - [IUsbInterface.idl](reference/hdi-apis/usb/_i_usb_interface_8idl.md)
          - [UsbTypes.idl](reference/hdi-apis/usb/_usb_types_8idl_v1_2.md)
        - HdiUsb模块头文件（V2_0）
          - [IUsbdBulkCallback.idl](reference/hdi-apis/usb/_i_usbd_bulk_callback_8idl.md)
          - [IUsbDeviceInterface.idl](reference/hdi-apis/usb/_i_usb_device_interface_8idl.md)
          - [IUsbdSubscriber.idl](reference/hdi-apis/usb/_i_usbd_subscriber_8idl.md)
          - [IUsbdTransferCallback.idl](reference/hdi-apis/usb/_i_usbd_transfer_callback_8idl.md)
          - [IUsbHostInterface.idl](reference/hdi-apis/usb/_i_usb_host_interface_8idl.md)
          - [IUsbPortInterface.idl](reference/hdi-apis/usb/_i_usb_port_interface_8idl.md)
          - [UsbTypes.idl](reference/hdi-apis/usb/_usb_types_8idl.md)
        - USB
      ...
      - 结构体
        ...
        - HdiUsb模块结构体（V1_1）
          ...
          - [UsbCtrlTransferParams](reference/hdi-apis/usb/_usb_ctrl_transfer_params_v11.md)
        - HdiUsb模块结构体（V1_2）
          - [IUsbdTransferCallback](reference/hdi-apis/usb/interface_i_usbd_transfer_callback_v1_2.md)
          - [IUsbInterface](reference/hdi-apis/usb/interface_i_usb_interface.md)
          - [UsbIsoPacketDescriptor](reference/hdi-apis/usb/_usb_iso_packet_descriptor.md)
          - [USBTransferInfo](reference/hdi-apis/usb/_u_s_b_transfer_info.md)
        - HdiUsb模块结构体（V2_0）
          - [IUsbdBulkCallback](reference/hdi-apis/usb/interface_i_usbd_bulk_callback.md)
          - [IUsbDeviceInterface](reference/hdi-apis/usb/interface_i_usb_device_interface.md)
          - [IUsbdSubscriber](reference/hdi-apis/usb/interface_i_usbd_subscriber.md)
          - [IUsbdTransferCallback](reference/hdi-apis/usb/interface_i_usbd_transfer_callback_v2_0.md)
          - [IUsbHostInterface](reference/hdi-apis/usb/interface_i_usb_host_interface.md)
          - [IUsbPortInterface](reference/hdi-apis/usb/interface_i_usb_port_interface.md)
          - [PortInfo](reference/hdi-apis/usb/_port_info.md)
          - [UsbCtrlTransfer](reference/hdi-apis/usb/_usb_ctrl_transfer.md)
          - [UsbCtrlTransferParams](reference/hdi-apis/usb/_usb_ctrl_transfer_params.md)
          - [UsbDev](reference/hdi-apis/usb/_usb_dev.md)
          - [USBDeviceInfo](reference/hdi-apis/usb/_u_s_b_device_info.md)
          - [UsbIsoPacketDescriptor](reference/hdi-apis/usb/_usb_iso_packet_descriptor_v2_0.md)
          - [UsbPipe](reference/hdi-apis/usb/_usb_pipe.md)
          - [UsbPort](reference/hdi-apis/usb/_usb_port.md)
          - [UsbPortStatus](reference/hdi-apis/usb/_usb_port_status.md)
          - [USBTransferInfo](reference/hdi-apis/usb/_u_s_b_transfer_info_v2_0.md)
        - USB
