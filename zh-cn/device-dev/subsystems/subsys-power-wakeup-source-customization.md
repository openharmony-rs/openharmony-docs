...
4. 参考[唤醒源的配置文件夹中的BUILD.gn](https://gitcode.com/openharmony/powermgr_power_manager/blob/master/services/native/profile/BUILD.gn)编写BUILD.gn文件，将power_wakeup.json打包到`/vendor/etc/power_config`目录下，配置如下：
