...
注：以下接口列举的为IDL接口描述生成的对应C++语言函数接口，接口声明见idl文件[/drivers/interface/motion/v1_0/](https://gitcode.com/openharmony/drivers_interface/tree/master/motion) 。
...
下面结合DEMO实例，介绍如何基于HDF驱动框架，进行手势识别用户态驱动开发。具体实现请参考[motion_if_driver.cpp](https://gitcode.com/openharmony/drivers_peripheral/blob/master/motion/hdi_service/motion_if_driver.cpp)。
