...
> 
> - 内核向用户态提供的系统调用接口清单详见[syscall_lookup.h](https://gitcode.com/openharmony/kernel_liteos_a/blob/master/syscall/syscall_lookup.h)，内核相应的系统调用对接函数清单详见[los_syscall.h](https://gitcode.com/openharmony/kernel_liteos_a/blob/master/syscall/los_syscall.h)。
