...
>
>  - 当前VDSO机制支持LibC库clock_gettime接口的CLOCK_REALTIME_COARSE与CLOCK_MONOTONIC_COARSE功能，clock_gettime接口的使用方法详见[POSIX标准](https://gitcode.com/openharmony/kernel_liteos_m/tree/master/kal/posix)。
>
