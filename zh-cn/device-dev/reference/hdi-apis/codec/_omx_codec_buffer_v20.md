...
| NativeBuffer  [bufferhandle](#bufferhandle) | 编码或者解码使用的bufferhandle，详见[NativeBuffer](https://gitcode.com/openharmony/drivers_hdf_core/blob/master/interfaces/inner_api/hdi/base/native_buffer.h)。  | 
...
编码或者解码使用的bufferhandle，详见[NativeBuffer](https://gitcode.com/openharmony/drivers_hdf_core/blob/master/interfaces/inner_api/hdi/base/native_buffer.h)。
