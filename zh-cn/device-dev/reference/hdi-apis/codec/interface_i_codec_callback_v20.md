...
- 创建组件时，通过[CreateComponent](https://gitcode.com/openharmony-sig/interface_native_header/blob/master/zh-cn/device_api/hdi/codec/codec_component_manager.h)方法。

- 当组件处于OMX_StateLoaded状态时，通过[SetCallbacks](https://gitcode.com/openharmony-sig/interface_native_header/blob/master/zh-cn/device_api/hdi/codec/codec_component_if.h)方法注册回调。
