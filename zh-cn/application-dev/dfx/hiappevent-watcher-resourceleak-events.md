...
| rss_detail | object | （resource_type为rss_memory）RSS内存详细分布信息，详见detail字段说明。<br>**说明**：从API版本26.0.0开始，支持该字段。 |
| pss_detail | object | （resource_type为pss_memory）PSS内存详细分布信息，详见detail字段说明。<br>**说明**：从API版本26.0.0开始，支持该字段。 |
