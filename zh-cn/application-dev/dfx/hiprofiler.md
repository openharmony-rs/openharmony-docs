...
从API version 23开始支持抓取指定进程创建[napi_ref](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/napi/use-napi-life-cycle.md#napi_ref)的调用栈，不会抓取弱引用。
