...
2. 工程配置界面中，**Model**选择“Stage”，若无Model选项，则无需配置，默认为“Stage”模型，**Language Version**选择“ArkTS 1.1”。
...
2. 工程配置界面中，**Model**选择“Stage”，若无Model选项，则无需配置，默认为“Stage”模型，**Language Version**选择“ArkTS 1.2”。
...
5. 在DevEco Studio的底部，切换到“Log”窗口，设置日志的过滤条件。
   ...
   点击HiLogArkTS Static按钮，查看HiLog日志。
...
6. 点击SandboxLog Static按钮，搜索内容设置为“testTag”，控制台current log dir打印的即为当前沙箱的路径。
