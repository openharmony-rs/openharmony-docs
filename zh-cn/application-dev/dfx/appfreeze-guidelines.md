...
Build info:OpenHarmony 7.0.0.28
DeviceDebuggable:No
...
从<!--RP2-->OpenHarmony 6.1<!--RP2End-->开始，系统默认将AppFreeze增强日志内容合并到APP_FREEZE事件的[external_log](hiappevent-watcher-freeze-events.md#事件字段说明)指向的日志结尾。
