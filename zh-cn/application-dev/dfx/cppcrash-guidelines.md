...
- 异步线程栈跟踪维测功能默认仅在ARM 64位系统中开启。从**API version 22**前，通过libuv或ffrt提交异步任务的**三方和系统应用**debug版本默认开启。从**API version 22**及以后，通过libuv提交异步任务的**三方应用**debug和release版本均默认开启，通过ffrt提交异步任务的**三方和系统应用**仅debug版本默认开启。崩溃日志规格请参见[异步线程栈跟踪故障场景日志规格](#异步线程栈跟踪故障场景日志规格)。
...
| SubmitterStacktrace | 提交者线程栈 | 12 | 否 | 异步线程栈跟踪维测功能默认仅在ARM 64位系统中开启。从**API version 22**前，通过libuv或ffrt提交异步任务的**三方和系统应用**debug版本默认开启。从**API version 22**及以后，通过libuv提交异步任务的**三方应用**debug和release版本均默认开启，通过ffrt提交异步任务的**三方和系统应用**仅debug版本默认开启。 |
...
>
> 从**API version 22**前，通过libuv或ffrt提交异步任务的**三方和系统应用**debug版本默认开启。从**API version 22**及以后，通过libuv提交异步任务的**三方应用**debug和release版本均默认开启，通过ffrt提交异步任务的**三方和系统应用**仅debug版本默认开启。
