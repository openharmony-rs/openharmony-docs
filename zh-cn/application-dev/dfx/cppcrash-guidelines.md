...
- 异步线程栈跟踪维测功能默认仅在ARM 64位系统且应用在debug模式下开启。从**API version 22**起，该功能在ARM 64位系统下已扩展支持：三方应用debug和release模式均默认开启。崩溃日志规格请参见[异步线程栈跟踪故障场景日志规格](#异步线程栈跟踪故障场景日志规格)。
...
| SubmitterStacktrace | 提交者线程栈 | 12 | 否 | 异步线程栈跟踪维测功能默认仅在ARM 64位系统且应用在debug模式下开启。从**API version 22**起，该功能在ARM 64位系统下已扩展支持：三方应用debug和release模式均默认开启。 |
...
> **注意：**
>
> 异步线程栈跟踪维测功能默认仅在ARM 64位系统且应用在debug模式下开启。
>
> 从**API version 22**起，该功能在ARM 64位系统下已扩展支持：三方应用debug和release模式均默认开启。
