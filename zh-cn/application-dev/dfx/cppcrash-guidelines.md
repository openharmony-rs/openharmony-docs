...
| Module name | 模块名 | 8 | 是 | - |
| ReleaseType | 标识应用打包时使用的SDK的发布类型 | 23 | 否 | 仅在应用进程提供，具体说明详见[ApplicationInfo](../reference/apis-ability-kit/js-apis-bundleManager-applicationInfo.md#applicationinfo-1)中的releaseType。 |
