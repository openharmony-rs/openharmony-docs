...
* HAP中包含UIAbility
  ...
  * 如果在module.json5配置文件了多个入口UIAbility，优先返回module.json5中mainElement对应的入口UIAbility配置的icon和label，如果mainElement未配置或者配置的UIAbility中skills标签不对，则取配置文件module.json5中配置的第一个入口UIAbility，返回对应的icon和label。
