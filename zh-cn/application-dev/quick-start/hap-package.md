...
- 多HAP场景下，在安装或更新时，存在一致性校验，详情参考[应用安装与更新一致性校验](install-and-update-consistency-verification.md)。使用打包工具进行打包成APP时，也会进行合法性校验，详情请参考[打包工具](../../application-dev/tools/packing-tool.md#app打包指令)。
