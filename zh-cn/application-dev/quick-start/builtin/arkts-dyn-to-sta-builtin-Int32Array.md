...
predicate函数参数说明：
  ...
  | array | Int32Array | 是 | 调用的原始Int32Array对象。 |

predicate函数返回值说明：
  | 类型 | 说明 |
  | -------- | -------- |
  | unknown | 返回值会被隐式转换为boolean。true表示通过检查，false表示不通过。 |
...
**示例：**
  ...
  class C {
    ...
    compare(value: number, index: number, arr: Int32Array) {
      return value < this.base
    }
  }

  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
  let b = new C(4);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  every(predicate: (value: number, index: int, array: Int32Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    callEvery(arr: Int32Array) {
      return arr.every((value: number, index: int, arr: Int32Array)=>{return value < this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
predicate函数参数说明：
  ...
  | index | number | 是 | 当前元素的索引。 |
  | array | Int32Array | 是 | 调用的原始Int32Array数组。 |
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  filter(predicate: (value: number, index: int, array: Int32Array) => boolean): Int32Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.filter((value: number, index: int, arr: Int32Array)=>{return value < this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
predicate函数参数说明：
  ...
  | value | number | 是 | 当前被遍历的数组元素的值。 |
  | index | number | 是 | 当前元素的索引。 |
  | obj | Int32Array | 是 | 调用的原始Int32Array数组。 |
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  find(predicate: (value: number, index: int, obj: Int32Array) => boolean): number | undefined
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.find((value: number, index: int, arr: Int32Array)=>{return value >= this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  findIndex(predicate: (value: number, index: int, obj: Int32Array) => boolean): int
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.findIndex((value: number, index: int, arr: Int32Array)=>{return value >= this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
**示例：**
  ...
  class C {
    ...
    foo(value: number, index: number, arr: Int32Array) {
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  forEach(callbackfn: (value: number, index: int, array: Int32Array) => void): void
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.forEach((value: number, index: int, arr: Int32Array)=>{console.info(value + this.base)})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  map(callbackfn: (value: number, index: int, array: Int32Array) => number): Int32Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.map((value: number, index: int, arr: Int32Array)=>{return value + this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
predicate函数返回值说明：
  | 类型 | 说明 |
  | -------- | -------- |
  | unknown | 返回值会被隐式转换为boolean。true表示满足条件，false表示不满足。 |
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  some(predicate: (value: number, index: int, array: Int32Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int32Array) {
      return arr.some((value: number, index: int, arr: Int32Array)=>{return value > this.base})
    }
  }
  let arr: Int32Array = new Int32Array([1, 2, 3]);
  let a = new C(2);
...
mapfn函数返回值说明：
  | 类型 | 说明 |
  | -------- | -------- |
  | number | 返回的一个number类型值，作为新Int32Array的元素 |
...
**示例：**
  ...
  let a = new C(2);
  let b = new C(3);
  let arr2 = Int32Array.from(arr, a.foo, a);
  let arr3 = Int32Array.from(arr, a.foo, b);
  ```

**ArkTS-Sta版本签名：**

  ```typescript
  static from(arrayLike: Iterable<number>, mapfn?: (v: number, k: int) => number): Int32Array
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: int) => number): Int32Array
  ```
