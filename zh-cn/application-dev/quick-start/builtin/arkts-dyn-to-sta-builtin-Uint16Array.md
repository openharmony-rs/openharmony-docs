...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  every(predicate: (value: number, index: int, array: Uint16Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    callEvery(arr: Uint16Array) {
      return arr.every((value: number, index: int, arr: Uint16Array)=>{return value < this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  filter(predicate: (value: number, index: int, array: Uint16Array) => boolean): Uint16Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.filter((value: number, index: int, arr: Uint16Array)=>{return value < this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  find(predicate: (value: number, index: int, obj: Uint16Array) => boolean): number | undefined
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.find((value: number, index: int, arr: Uint16Array)=>{return value >= this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  findIndex(predicate: (value: number, index: int, obj: Uint16Array) => boolean): int
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.findIndex((value: number, index: int, arr: Uint16Array)=>{return value >= this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  forEach(callbackfn: (value: number, index: int, array: Uint16Array) => void): void
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.forEach((value: number, index: int, arr: Uint16Array)=>{console.info(value + this.base)})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  map(callbackfn: (value: number, index: int, array: Uint16Array) => number): Uint16Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.map((value: number, index: int, arr: Uint16Array)=>{return value + this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  some(predicate: (value: number, index: int, array: Uint16Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Uint16Array) {
      return arr.some((value: number, index: int, arr: Uint16Array)=>{return value > this.base})
    }
  }
  let arr: Uint16Array = new Uint16Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from(arrayLike: Iterable<number>, mapfn?: (v: number, k: int) => number): Uint16Array
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: int) => number): Uint16Array
  ```
