...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  every(predicate: (value: number, index: int, array: Float64Array) => boolean): boolean
  ```
...
predicate函数返回值说明：
  | 类型 | 说明 |
  | -------- | -------- |
  | any | 返回值会被隐式转换为boolean，当返回值为true时保留当前元素，false时过滤当前元素。 |
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  filter(predicate: (value: number, index: int, array: Float64Array) => boolean): Float64Array
  ```
...
**示例：**
  ...
  class C {
      ...
      call(arr: Float64Array) {
          return arr.filter((value: number, index: int, arr: Float64Array)=>{return value < this.base})
      }
  }
  let arr: Float64Array = new Float64Array([1, 2, 3]);
  let a = new C(2)
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  find(predicate: (value: number, index: int, array: Float64Array) => boolean): number | undefined
  ```
...
**示例：**
  ...
  class C {
      ...
      call(arr: Float64Array) {
          return arr.find((value: number, index: int, arr: Float64Array)=>{return value >= this.base})
      }
  }
  let arr: Float64Array = new Float64Array([1, 2, 3]);
  let a = new C(2)
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  findIndex(predicate: (value: number, index: int, array: Float64Array) => boolean): int
  ```
...
**示例：**
  ...
  class C {
      ...
      call(arr: Float64Array) {
          return arr.findIndex((value: number, index: int, arr: Float64Array)=>{return value >= this.base})
      }
  }
  let arr: Float64Array = new Float64Array([1, 2, 3]);
  let a = new C(2)
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  forEach(callbackfn: (value: number, index: int, array: Float64Array) => void): void
  ```
...
**示例：**
  ...
  class C {
      ...
      call(arr: Float64Array) {
          return arr.forEach((value: number, index: int, arr: Float64Array)=>{console.info(value + this.base)})
      }
  }
  let arr: Float64Array = new Float64Array([1, 2, 3]);
  let a = new C(2)
...
**适配建议：**
  ...
  删除最后一个参数，不使用显式指定this的语义。若必须使用，可通过创建匿名函数来绑定this上下文。
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  map(callbackfn: (value: number, index: int, array: Float64Array) => number): Float64Array
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  some(predicate: (value: number, index: int, arr: Float64Array) => boolean): boolean
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: int) => number): Float64Array
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from(arrayLike: Iterable<number>, mapfn?: (v: number, k: int) => number): Float64Array
  ```
