...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  every(predicate: (value: number, index: int, array: Int8Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    callEvery(arr: Int8Array) {
      return arr.every((value: number, index: int, arr: Int8Array)=>{return value < this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  filter(predicate: (value: number, index: int, array: Int8Array) => boolean): Int8Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.filter((value: number, index: int, arr: Int8Array)=>{return value < this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  find(predicate: (value: number, index: int, obj: Int8Array) => boolean): number | undefined
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.find((value: number, index: int, arr: Int8Array)=>{return value >= this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  findIndex(predicate: (value: number, index: int, obj: Int8Array) => boolean): int
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.findIndex((value: number, index: int, arr: Int8Array)=>{return value >= this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  forEach(callbackfn: (value: number, index: int, array: Int8Array) => void): void
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.forEach((value: number, index: int, arr: Int8Array)=>{console.info(value + this.base)})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  map(callbackfn: (value: number, index: int, array: Int8Array) => number): Int8Array
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.map((value: number, index: int, arr: Int8Array)=>{return value + this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  some(predicate: (value: number, index: int, array: Int8Array) => boolean): boolean
  ```
...
**示例：**
  ...
  class C {
    ...
    call(arr: Int8Array) {
      return arr.some((value: number, index: int, arr: Int8Array)=>{return value > this.base})
    }
  }
  let arr: Int8Array = new Int8Array([1, 2, 3]);
  let a = new C(2);
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from(arrayLike: Iterable<number>, mapfn?: (v: number, k: int) => number): Int8Array
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: int) => number): Int8Array
  ```
