...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from(arrayLike: Iterable<number>, mapfn?: (v: number, k: int) => number): Uint8ClampedArray
  ```
...
**ArkTS-Sta版本签名：**
  ...
  ```typescript
  static from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: int) => number): Uint8ClampedArray
  ```
