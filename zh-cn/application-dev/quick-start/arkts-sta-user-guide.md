...
详细的规范文档请参考：[ArkTS-Sta规范](https://gitcode.com/openharmony/arkcompiler_runtime_core/releases)
...
- 了解新的并发特性和使用方法：[并发特性变更](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_20250702/zh-cn/application-dev/quick-start/arkts-dyn-to-sta-concurrency-rules.md)。
...
| ArkTS          | ArkTS静态类型                 |  [ArkTS动态类型到静态类型迁移工具使用指导](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_20250702/zh-cn/application-dev/quick-start/arkts-easytrans-userguide.md)      |已完成|
| ArkTS        |    ArkTS静态类型                 | [ArkTS动静态上下文互操作指导](../quick-start/arkts-dyn-to-sta-interop-rules.md)                |已完成|
| ArkTS       |      ArkTS静态类型              | [ArkTS-Sta语法迁移规则](arkts-dyn-to-sta-syntax-rules.md)                    |已完成|
| ArkTS          |     ArkTS静态类型                 | [ArkTS静态类型并发特性](https://gitcode.com/openharmony/docs/blob/OpenHarmony_feature_20250702/zh-cn/application-dev/quick-start/arkts-dyn-to-sta-concurrency-rules.md)                      |已完成|
...
| 应用框架       | ArkUI                         | [ArkUI](../reference/apis-arkui/Readme-CN.md)静态类型API相比动态差异                 |已完成|
|  应用框架    |    ArkUI                   | [ArkUI](../reference/apis-arkui/Readme-CN.md)静态类型状态管理相比动态差异         |已完成|
| 应用框架 | ArkUI | [ArkUI](../ui/Readme-CN.md)动态到静态迁移适配指导 |已完成|
| 应用框架 | ArkUI | [ArkUI](../ui/Readme-CN.md)动静态互操作指导 | 已完成|
| 应用框架 | ArkUI | ArkUI静态类型并发特性[ParallelizeUI](../reference/apis-arkui/js-apis-arkui-Parallelize.md#parallelizeui) |已完成|
