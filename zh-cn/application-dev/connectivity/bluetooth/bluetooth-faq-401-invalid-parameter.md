...
## 问题现象
在BLE蓝牙应用开发过程中，调用携带可选参数的接口时，如果将可选属性显式设置为undefined，比如startScan，（在对象字面量中写入manufactureId: undefined），接口会抛出错误码401（Invalid parameter），提示无效参数。
