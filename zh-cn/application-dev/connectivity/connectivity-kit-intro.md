...
- **融合测距模块**<br/>
  融合测距模块，提供了星闪HADM测距服务，在模块内可以使用星闪HADM主动测距以及被动测距的能力。详情请参考[ohos.FusionConnectivity.ranging](../reference/apis-connectivity-kit/js-apis-fusionConnectivity-ranging.md)文档。
