...
> **说明：**
>
> - 权限申请建议在Ability创建时一次性完成，并检查授权结果（authResults）；用户拒绝后，调用需要ohos.permission.ACCESS_NEARLINK权限的星闪接口将返回[201 权限校验失败](../../reference/errorcode-universal.md#201-权限校验失败)错误。
