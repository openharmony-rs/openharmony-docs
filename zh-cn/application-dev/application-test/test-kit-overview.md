...
- 单元测试能力：提供自动化测试的基础接口和运行机制，具体使用方法请参考<!--RP1-->[单元测试框架使用指导](unittest-guidelines.md)<!--RP1End-->，主要能力如下：
...
- UI测试能力：提供UI自动化测试能力，测试脚本需基于单元测试框架开发，具体使用方法请参考<!--RP2-->[UI测试框架使用指导](uitest-guidelines.md)<!--RP2End-->，主要能力如下：
...
- 性能测试能力：提供白盒性能自动化测试能力，测试脚本需基于单元测试框架开发，具体使用方法请参考<!--RP3-->[白盒性能测试框架使用指导](perftest-guideline.md)<!--RP3End-->，主要能力如下：
  - 提供针对指定代码段执行过程的基础性能数据采集能力，包括执行耗时、执行CPU和内存占用数据等。
  - 提供对应用场景化性能数据的采集，包括应用启动时延、页面切换时延、列表滑动帧率等。
- 辅助测试能力：提供命令行辅助测试工具，支持系统状态管理和环境模拟能力，搭载OpenHarmony 7.0.0及以上版本的设备支持此能力。具体使用方法请参考<!--RP5-->[辅助测试工具使用指导](testhelper-guidelines.md)<!--RP5End-->。
<!--Del-->
