...
1. 定义测试性能指标列表
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[metricsDefine_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
2. 定义被测代码段和环境复位代码段
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[callbackDefine_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[resetCodeDefine_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
3. 构造测试策略对象
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[strategyDefine_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
<!-- @[startTest_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
<!-- @[getResult_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
<!-- @[exit_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
...
1. 在 main > ets > utils 文件夹下新增 Utils.ets 文件，在文件中编写自定义的函数。
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[utils_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/main/ets/utils/Utils.ets) -->
...
2. 在 ohosTest > ets > test 文件夹下 CPUMetric.test.ets 文件中编写具体测试代码。
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[CPUMetric_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/CPUMetric.test.ets) -->
      ...
      describe('PerfTestTest2', (): void => {
        it('testExample1', 0, async (): Promise<void> => {
          ...
          try {
            ...
            let res2: PerfMeasureResult = perfTest.getMeasureResult(PerfMetric.CPU_USAGE);
            perfTest.destroy();
            expect(res1.average).assertLessOrEqual(1000);
            expect(res2.average).assertLessOrEqual(30);
          } catch (error) {
            expect(false).assertTrue();
          }
        })
...
1. 在 main > ets > pages 文件夹下编写 PageListPage.ets 页面代码，作为被测示例demo。
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[scroll_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/main/ets/pages/PageListPage.ets) -->
...
2. 在ohosTest > ets > test文件夹下 slideFps.test.ets 文件中编写具体测试代码。
    ...
    **ArkTS-Sta示例：**
    ...
    <!-- @[slideFps_sta_sample](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Test-Sta/perfTestStatic/entry/src/ohosTest/ets/test/SlideFps.test.ets) -->
