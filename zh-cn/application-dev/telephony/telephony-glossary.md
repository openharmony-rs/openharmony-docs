...
通过移动通信网络（如 4G/5G）提供的分组数据业务，区别于Wi-Fi，使设备在无无线局域网时仍可上网，是Telephony Kit的核心管理对象。
...
ITU-T 制定的国际公共电信编号标准，规定电话号码的国际通用表示形式，号码以“+”加国家码开头、最长15位，用于跨国家、跨网络场景下的统一标识与路由寻址。
...
表示联系人信息（姓名、电话、地址、URL、照片等）的文件格式标准，HarmonyOSVCard模块支持将其导入联系人数据库或反向导出，支持2.1/3.0/4.0版本。
