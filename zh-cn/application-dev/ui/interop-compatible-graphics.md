...
从API version 20开始，[Graphics](../reference/apis-arkui/js-apis-arkui-graphics.md)中LengthMetrics、ColorMetrics、shapeMask、shapeClip对象互操作适用于[ArkTS1.2互操作](../quick-start/arkts-interop-overview.md)中使用LengthMetrics、ColorMetrics、shapeMask、shapeClip对象的场景。
