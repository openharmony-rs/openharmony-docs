...
- 渐进式迁移：逐步将ArkTS1.1中的LengthMetrics、ColorMetrics、shapeMask、shapeClip对象迁移到新版本。

- 使用旧LengthMetrics、ColorMetrics、shapeMask、shapeClip对象：使用稳定的ArkTS1.1中的LengthMetrics、ColorMetrics、shapeMask、shapeClip对象。
