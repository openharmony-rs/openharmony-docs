# ArkTS1.2使用ArkTS1.1 Graphics

## 概述

[Graphics](../reference/apis-arkui/js-apis-arkui-graphics.md)中 LengthMetrics、ColorMetrics、shapeMask、shapeClip对象互操作适用于[ArkTS1.2互操作](../quick-start/arkts-interop-overview.md)中使用LengthMetrics、ColorMetrics、shapeMask、shapeClip对象的场景。


## 架构原理

在互操作场景下，支持在ArkTS1.1创建的LengthMetrics、ColorMetrics、shapeMask、shapeClip对象传递到ArkTS1.2。

## 设计理念

LengthMetrics、ColorMetrics、shapeMask、shapeClip对象互操作适用于主模块使用ArkTS1.2、子模块使用ArkTS1.1的场景。

- 渐进式迁移：逐步将ArkTS1.1LengthMetrics、ColorMetrics、shapeMask、shapeClip对象迁移到新版本。

- 使用旧LengthMetrics、ColorMetrics、shapeMask、shapeClip对象：使用稳定的ArkTS1.1 LengthMetrics、ColorMetrics、shapeMask、shapeClip对象。
...
### 在ArkTS1.2引用ArkTS1.1中创建的LengthMetrics、ColorMetrics、shapeMask、shapeClip对象。

通过在ArkTS1.2中引用ArkTS1.1创建的LengthMetrics、ColorMetrics、shapeMask、shapeClip对象用于属性设置。
...
import { ShapeClip, ColorMetrics, ShapeMask, LengthMetrics,RenderNode } from '@ohos.arkui.node'
...
```TypeScript
// library/Index.ets
export { shapeMaskTest, shapeClipTest, resourceTest, colorMetricsTest, lengthMetricsTest, renderNodeTest} from './src/main/ets/components/MainPage';
```
...
shapeClipTestNode.backgroundColor = 0xff00ff00;
