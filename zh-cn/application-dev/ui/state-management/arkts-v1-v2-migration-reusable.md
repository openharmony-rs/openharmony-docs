...
状态管理V2推荐使用[Repeat全量懒加载模式](../rendering-control/arkts-new-rendering-control-repeat.md#懒加载能力说明)替代[ForEach](../rendering-control/arkts-rendering-control-foreach.md)实现循环渲染。
