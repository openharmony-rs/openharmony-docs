...
| colorMode              | ColorMode                  | 色彩模式类型。<br>- ColorMode.LIGHT：浅色。<br>- ColorMode.DARK：深色。                 |
| fontScale              | number                  | 字体大小比例。开发者需要配置configuration，设置fontSizeScale为"followSystem"，具体配置步骤可参考configuration使fontScale跟随系统变化。<br>默认值跟随系统默认参数。                |
