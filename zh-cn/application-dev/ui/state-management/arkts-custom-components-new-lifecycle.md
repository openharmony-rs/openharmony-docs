...
懒创建场景包含Tabs和Navigation，以下示例展示Navigation和Tabs场景中，`@ComponentActive`和`@ComponentInactive`生命周期装饰器的触发时机。

<!-- @ComponentActiveLazyCreate -->
