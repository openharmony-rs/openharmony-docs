...
以下示例声明了3个Text组件，每个Text组件均设置了[fontStyleapis-arkui/arkui-ts/ts-appendix-enums.md#fontstyle)、[fontWeightapis-arkui/arkui-ts/ts-appendix-enums.md#fontweight) 和[backgroundColorapis-arkui/arkui-ts/ts-universal-attributes-background.md#backgroundcolor)样式。
