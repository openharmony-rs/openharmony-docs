...
| [\@StorageProp](./arkts-appstorage.md#storageprop)            | 与AppStorage中对应的属性建立双向数据同步。   |
| [\@LocalStorageLink](./arkts-localstorage.md#localstoragelink) | 与LocalStorage中对应的属性建立单向数据同步。 |
| [\@LocalStorageProp](./arkts-localstorage.md#localstorageprop) | 与LocalStorage中对应的属性建立双向数据同步。 |
