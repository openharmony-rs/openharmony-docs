...
从API version 20开始，开发者可以通过使用`UIUtils.makeBinding()`函数、`Binding`类和`MutableBinding`类实现\@Builder函数中状态变量的刷新。函数详情请参考状态管理API文档中的[makeBinding](../../reference/apis-arkui/js-apis-stateManagement.md#makebinding20)。
