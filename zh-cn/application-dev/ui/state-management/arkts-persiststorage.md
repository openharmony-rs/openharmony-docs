...
- 可以被[JSON.stringify()](../../reference/apis-arkts/js-apis-json.md#jsonstringify-1)和[JSON.parse()](../../reference/apis-arkts/js-apis-json.md#jsonparse)重构的对象（但是对象中的成员方法不支持持久化）。
