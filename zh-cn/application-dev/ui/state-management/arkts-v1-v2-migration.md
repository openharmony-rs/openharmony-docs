...
|[\@State](./arkts-state.md)                 | 无外部初始化：[\@Local](./arkts-new-local.md)<br/>外部初始化一次：[\@Param](./arkts-new-param.md)[\@Once](./arkts-new-once.md) | \@State和\@Local类似都是数据源的概念，在不需要外部传入初始化时，可直接迁移。如果需要外部传入初始化，则可以迁移为\@Param\@Once。详情见[@State迁移场景](./arkts-v1-v2-migration-inner-component.md#state-local)。如果使用滚动组件关联的[WaterFlowSections](../../reference/apis-arkui/arkui-ts/ts-container-waterflow.md#waterflowoptions对象说明)/[ChildrenMainSize](../../reference/apis-arkui/arkui-ts/ts-container-scrollable-common.md#childrenmainsize12对象说明)，需要使用[makeObserved](./arkts-new-makeObserved.md)，详情见[滚动组件迁移场景](./arkts-v1-v2-migration-application-and-others.md#滚动组件)。 |
...
| [\@Link](./arkts-link.md)                  | [\@Param](./arkts-new-param.md)[\@Event](./arkts-new-event.md)    | \@Link是框架自己封装实现的双向同步，对于V2开发者可以通过@Param结合@Event的方式自己实现双向同步。详情见[@Link迁移场景](./arkts-v1-v2-migration-inner-component.md#link---paramevent)。 |
...
| 滚动组件场景      | [makeObserved](./arkts-new-makeObserved.md)|详情见[滚动组件迁移场景](./arkts-v1-v2-migration-application-and-others.md#滚动组件)。|
