...
ContainerReader在实际开发中常用于Flex、Row或Column容器内部、Navigation以及自定义组件内部场景，提供实时尺寸获取、断点值获取和自定义断点阈值核心功能。
...
<!-- @GridComponentAdaptiveColumnSettings -->  
