...
通过[NODE_TEXT_CONTENT](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)属性设置Text组件的基本文本内容。
...
通过如下属性设置字体大小、粗细、样式等基本属性。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置文本的水平对齐方式和垂直对齐方式。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置文本装饰线、阴影等效果。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过[NODE_TEXT_WORD_BREAK](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)属性设置文本的断行规则。
...
通过如下属性设置文本的行高、行高倍数等属性。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置文本溢出时的省略模式。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置每行结尾空格是否优化。从API version 20开始，Text组件支持设置每行结尾空格是否优化处理。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置首行缩进和行首标点压缩。从API version 23开始，Text组件支持设置行首标点压缩。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
通过如下属性设置渐变颜色效果。从API version 20开始，Text组件支持设置渐变颜色效果。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
从API version 23开始，Text组件支持通过`NODE_TEXT_MARQUEE_OPTIONS`属性设置跑马灯效果。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
...
从API version 23开始，Text组件支持通过`NODE_TEXT_DIRECTION`属性设置文本方向。具体说明请参考[ArkUI_NodeAttributeType](../reference/apis-arkui/capi-native-node-h.md#arkui_nodeattributetype)中的枚举定义。
