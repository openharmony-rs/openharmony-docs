...
<!-- @[click_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/OnClickGesture.ets) -->

``` TypeScript
import { $r, Color, Column, Component, Entry, FlexAlign, BaseGestureEvent, GestureInfo, GestureControl, GestureJudgeResult, NavDestination, TapGesture } from '@kit.ArkUI';
@Entry
@Component
export struct OnClickGesture {
  private judgeCount: number = 0;
...
<!-- @[catch_click_twice_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/TapGesture.ets) -->

``` TypeScript
import { $r, Column, ColumnOptions, Component, Entry, GestureEvent, NavDestination, Padding, State, TapGesture, Text } from '@kit.ArkUI';
...
<!-- @[catch_long_press_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/LongPressGesture.ets) -->

``` TypeScript
import { $r, Column, ColumnOptions, Component, Entry, GestureEvent, LongPressGesture, NavDestination, Padding, State, Text } from '@kit.ArkUI';
...
<!-- @[sliding_gesture](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/PanCombinationGesture.ets) -->

``` TypeScript
import { $r, Column, Component, Entry, GestureEvent, NavDestination, PanGesture, Row, SourceTool, SourceType, State, Text } from '@kit.ArkUI';

@Entry
@Component
export struct VolumeControlDemo {
  @State currentVolume: double = 50;
  private readonly MAX_VOLUME: double = 100;
  private readonly MIN_VOLUME: double = 0;
  ...
  private handleVolumeChange(delta: double) {
    this.currentVolume = Math.min(
      this.MAX_VOLUME,
      Math.max(this.MIN_VOLUME, this.currentVolume + delta)
    );
...
>**说明：**
>
> - 大部分可滑动组件，如[List](../reference/apis-arkui/arkui-ts/ts-container-list.md)、[Grid](../reference/apis-arkui/arkui-ts/ts-container-grid.md)、[Scroll](../reference/apis-arkui/arkui-ts/ts-container-scroll.md)、[Tabs](../reference/apis-arkui/arkui-ts/ts-container-tabs.md)等组件是通过PanGesture实现滑动，在组件内部的子组件绑定[滑动手势（PanGesture）](#滑动手势pangesture)或者[快滑手势（SwipeGesture）](#快滑手势swipegesture)会导致手势竞争。
>
...
<!-- @[catch_pinch_gesture_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/PinchGesture.ets) -->

``` TypeScript
import { $r, Column, ColumnOptions, Component, Entry, GestureEvent, Margin, NavDestination, Padding, PinchGesture, State, Text } from '@kit.ArkUI';

@Entry
@Component
export struct Pinch {
  @State scaleValue: double = 1;
  @State pinchValue: double = 1;
...
<!-- @[catch_rotation_gesture_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/RotationGesture.ets) -->

``` TypeScript
import { $r, Column, ColumnOptions, Component, Entry, GestureEvent, NavDestination, Padding, RotationGesture, State, Text } from '@kit.ArkUI';
...
<!-- @[catch_swipe_gesture_event](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/EventProjectSta/entry/src/main/ets/pages/singlegesture/SwipeGesture.ets) -->

``` TypeScript
import { $r, Column, ColumnOptions, Component, Entry, GestureEvent, NavDestination, Padding, State, SwipeDirection, SwipeGesture, Text } from '@kit.ArkUI';
