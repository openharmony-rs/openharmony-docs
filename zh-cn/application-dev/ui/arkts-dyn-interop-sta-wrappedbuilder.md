...
从API version 23开始，支持在ArkTS-Dyn中使用ArkTS-Sta的[WrappedBuilder对象](./state-management/arkts-wrapBuilder.md)。适用于ArkTS-Sta互操作中封装全局[\@Builder](./state-management/arkts-builder.md)的场景。
...
\@Builder的参数传递包括[按值传递](#按值传递参数)与[按引用传递](#按引用传递参数)，详见[参数传递规则](./state-management/arkts-builder.md#参数传递规则)。
...
│           └── ets/
│               └── pages/
│                   └── StaWrappedBuilderByRef.ets      # 调用WrappedBuilder对象并按引用传递参数
│
...
└── static_module/                                       # ArkTS-Sta子模块
    └── src/
        └── main/
            └── ets/
                └── components/
                    └── StaWrappedBuilderByRef.ets       # 定义WrappedBuilder对象
```
...
<!-- @[DynInteropStaWrappedBuilderStaWrappedBuilderByRef](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/static_module/src/main/ets/components/StaWrappedBuilderByRef.ets) -->

``` TypeScript
// static_module/src/main/ets/components/StaWrappedBuilderByRef.ets
...
@Builder
function personInfo(person: Person): void { // 按引用传递参数，对象字面量包含状态变量时，其变化会触发UI刷新
  Column() {
...
<!-- @[DynInteropStaWrappedBuilderIndexByRef](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/static_module/Index.ets) -->

``` TypeScript
// static_module/Index.ets
export { globalBuilder } from './src/main/ets/components/StaWrappedBuilderByRef'; // 导出WrappedBuilder对象
```
...
<!-- @[DynInteropStaWrappedBuilderByRef](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/entry/src/main/ets/pages/WrappedBuilderByRef.ets) -->

``` TypeScript
// entry/src/main/ets/pages/WrappedBuilderByRef.ets
...
│           └── ets/
│               └── pages/
│                   └── WrappedBuilderByValue.ets     # 调用WrappedBuilder对象
│
└── static_module/                                    # ArkTS-Sta子模块
    └── src/
        └── main/
            └── ets/
                └── components/
                    └── StaWrappedBuilderByValue.ets  # 定义WrappedBuilder对象
...
<!-- @[DynInteropStaWrappedBuilderStaWrappedBuilderByValue](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/static_module/src/main/ets/components/StaWrappedBuilderByValue.ets) -->

``` TypeScript
// static_module/src/main/ets/components/StaWrappedBuilderByValue.ets
import { Builder, WrappedBuilder, wrapBuilder, Text } from '@ohos.arkui.component';

@Builder
function showTextBuilder(input: string): void { // 按值传递参数，状态变量变化不会触发UI刷新
  Text(input)
    .fontSize(20)
}

// 使用wrapBuilder封装全局@Builder并导出
export const globalBuilderByValue: WrappedBuilder<@Builder (input: string) => void> = wrapBuilder(showTextBuilder);
```

<!-- @[DynInteropStaWrappedBuilderIndexByValue](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/static_module/Index.ets) -->

``` TypeScript
// static_module/Index.ets
export { globalBuilderByValue } from './src/main/ets/components/StaWrappedBuilderByValue'; // 导出WrappedBuilder对象
```
...
<!-- @[DynInteropStaWrappedBuilderByValue](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/DynInteropStaUI/entry/src/main/ets/pages/WrappedBuilderByValue.ets) -->

``` TypeScript
// entry/src/main/ets/pages/WrappedBuilderByValue.ets
import { globalBuilderByValue } from 'static_module'; // 引入WrappedBuilder对象
...
struct Parent {
  ...
  build() {
    Column() {
      ...
      globalBuilderByValue.builder(this.inputText)
    }
    .width('100%')
    .height('100%')
  }
