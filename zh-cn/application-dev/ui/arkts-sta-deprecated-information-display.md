...
<!--Kit: ArkUI-->
<!--Subsystem: ArkUI-->
<!--Owner: @Hu_ZeQi; @Zhang-Dong-hui; @luoying_ace_admin-->
<!--Designer: @Hu_ZeQi; @xiangyuan6; @weixin_52725220-->
<!--Tester: @gouyuanyuan; @jiaoaozihao; @xiong0104-->
...
替代的ArkTS-Sta接口声明：[showDatePickerDialog(options: DatePickerDialogOptions): void](../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#showdatepickerdialog) 
...
替代的ArkTS-Sta接口声明：[showTimePickerDialog(options: TimePickerDialogOptions): void](../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#showtimepickerdialog)
...
替代的ArkTS-Sta接口声明：[showTextPickerDialog(options: TextPickerDialogOptions): void](../reference/apis-arkui/arkts-apis-uicontext-uicontext.md#showtextpickerdialog)
...
ArkTS-Dyn接口声明：[ProgressOptions\<Type>.style](../reference/apis-arkui/arkui-ts/ts-basic-components-progress.md#progressoptions对象说明)

替代的ArkTS-Sta接口声明：[ProgressOptions\<Type>.type](../reference/apis-arkui/arkui-ts/ts-basic-components-progress.md#progresstype8枚举说明)
