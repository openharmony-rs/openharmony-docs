...
PersistentStorage提供状态变量持久化的能力，但是需要注意，其持久化和读回UI的能力都需要依赖AppStorage。在阅读本文档前，建议提前阅读：[AppStorage](./arkts-static-appstorage.md)，[PersistentStorage API文档](../../reference/apis-arkui/arkui-ts/ts-state-management.md#persistentstorage)。
...
![zh-cn_image_0000001553348833](https:////wsl.localhost/Ubuntu/home/zzq/gitcode/docs/zh-cn/application-dev/ui/state-management/figures/zh-cn_image_0000001553348833.png)
