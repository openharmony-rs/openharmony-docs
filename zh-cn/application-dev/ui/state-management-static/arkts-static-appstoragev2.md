...
从API version 23开始AppStorageV2提供状态变量在应用级全局共享的能力。开发者可以通过[connect](../../reference/apis-arkui/js-apis-stateManagement-static.md#connect22)绑定同一个key，进行跨ability的数据共享。
