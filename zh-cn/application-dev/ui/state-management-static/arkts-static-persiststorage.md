...
PersistentStorage提供状态变量持久化的能力。需要注意，其持久化和读回UI的功能都需要依赖AppStorage。在阅读本文档前，建议提前阅读：[AppStorage](./arkts-static-appstorage.md) 和 [PersistentStorage API文档](../../reference/apis-arkui/arkui-ts/ts-state-management-Static.md#persistentstorage)。
