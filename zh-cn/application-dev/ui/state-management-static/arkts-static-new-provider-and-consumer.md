...
| 观察能力           | 仅能观察自身赋值变化，如果要观察嵌套场景，配合[\@Trace](./arkts-static-new-observedV2-and-trace.md)一起使用。 | 观察第一层变化，如果要观察嵌套场景，配合[\@Observed](./arkts-static-observed-and-objectlink.md)和[\@ObjectLink](./arkts-static-observed-and-objectlink.md)一起使用。 |
