...
4. 测量可视范围内的元素。
    ...
    - 获取子组件。
        ...
        通过[getChild](../reference/apis-arkui/js-apis-arkui-frameNode.md#getchild12)方法获取指定索引的子组件FrameNode。ArkTS-Dyn示例传入ExpandMode.LAZY_NOT_EXPAND，ArkTS-Sta示例传入ExpandMode.LAZY_EXPAND，避免全量加载导致懒加载失效。
...
6. 设置布局容器自身大小。
    ...
    **关键接口说明**
    ...
    | [getChild](../reference/apis-arkui/js-apis-arkui-frameNode.md#getchild12) | 获取指定索引的子组件。ArkTS-Dyn示例使用ExpandMode.LAZY_NOT_EXPAND，ArkTS-Sta示例使用ExpandMode.LAZY_EXPAND，避免获取子组件时全量加载导致懒加载失效。 |
