...
ArkTS1.1接口声明：[px2lpx(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
...
ArkTS1.1接口声明：[lpx2px(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
...
ArkTS1.1接口声明：[px2fp(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
...
ArkTS1.1接口声明：[fp2px(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
...
ArkTS1.1接口声明：[px2vp(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
...
ArkTS1.1接口声明：[vp2px(value: number): number](../reference/apis-arkui/arkui-ts/ts-pixel-units.md#像素单位转换)
