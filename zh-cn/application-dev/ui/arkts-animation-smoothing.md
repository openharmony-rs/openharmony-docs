...
```ts
import { Entry, Component, Column, Curve, Color, ClickEvent, Margin, Text, Button, FlexAlign, TextAlign, FontWeight } from '@ohos.arkui.component';
...
```ts
import { Entry, Component, Column, Color, Text, FlexAlign, Row, Circle, Flex, Position, FlexDirection, ItemAlign, TouchType, TouchEvent } from '@ohos.arkui.component';
