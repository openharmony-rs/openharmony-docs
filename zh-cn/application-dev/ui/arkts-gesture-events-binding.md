...
```ts
// xxx.ets
import { Entry, Column, Component, Text, GestureEvent, TapGesture } from '@ohos.arkui.component';
...
```ts
// xxx.ets
import { Entry, Column, Component, Text, GestureEvent, TapGesture, GestureMask } from '@ohos.arkui.component';
