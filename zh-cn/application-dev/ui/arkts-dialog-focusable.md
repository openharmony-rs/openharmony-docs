...
1. 初始化一个弹出框内容区域，内含一个Text组件。
   ...
   ```ts
   import { Builder, Text, Column, ClickEvent, ColumnOptions, FlexAlign } from '@ohos.arkui.component';
...
```ts
'use static'
import { Builder, Text, TextInput, Entry, Component, Column, ClickEvent, ColumnOptions, FlexAlign } from '@ohos.arkui.component';
import promptAction from '@ohos.promptAction';
