...
1. 引入相关依赖。
   ...
   <!-- @animator_template4_import_start -->
...
2. 定义要做动画的组件。
   ...
   <!-- @animator_template4_button_start -->
...
4. 定义动画播放，重置，暂停的按钮。
   ...
   <!-- @animator_template4_buttons_start -->
