...
<!-- @canvasRenderingContext2D_start -->
...
- 绘制基础形状。
  ...
  <!-- @CanvasComponentBasicShapes_start -->
...
<!-- @canvasComponentTextBorder_start -->
...
<!-- @canvasComponentCustomFontsDrawText_start -->
...
<!-- @CanvasComponentDrawingPictureAndImagePixel_start -->
...
<!-- @canvasComponentOtherMethods_start -->
...
<!-- @canvasContentSetOnVisibleAreaApproximateChange_start -->
...
```
  ...
  canvas_RenderingContext

- 从API version 17开始，使用onVisibleAreaApproximateChange接口监听Canvas组件可见性。

<!-- @canvasContentOnVisibleAreaApproximateChange_start -->
...
```
  ...
  canvas_onVisibleAreaApproximateChange
