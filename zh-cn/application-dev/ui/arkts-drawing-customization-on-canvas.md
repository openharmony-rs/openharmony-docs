...
ArkTS-Sta示例：
  ...
  import { Flex, FlexDirection, ItemAlign, FlexAlign, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Entry, Component } from '@ohos.arkui.component';
...
ArkTS-Sta示例：
  ...
  import { Flex, FlexDirection, ItemAlign, FlexAlign, OffscreenCanvas, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Entry, Component } from '@ohos.arkui.component';
  import { State } from '@ohos.arkui.stateManagement';
...
ArkTS-Sta示例：
  ...
  import { Flex, FlexDirection, ItemAlign, FlexAlign, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Entry, Component, $rawfile } from '@ohos.arkui.component';
  import { State } from '@ohos.arkui.stateManagement';
  import { text } from '@kit.ArkGraphics2D';
...
ArkTS-Sta示例：
  ...
  import { Flex, FlexDirection, ItemAlign, FlexAlign, ImageBitmap, OffscreenCanvas, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Entry, Component } from '@ohos.arkui.component';
  import { State } from '@ohos.arkui.stateManagement';
  import { text } from '@kit.ArkGraphics2D';
...
import { Column, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Entry, Component, TextInput, $$ } from '@ohos.arkui.component';
...
ArkTS-Sta示例：
  ...
  import { Row, Column, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Path2D, Entry, Component } from '@ohos.arkui.component';
  import { State } from '@ohos.arkui.stateManagement';
...
ArkTS-Sta示例：
  ...
  import { TouchObject, FlexAlign, TouchType, Row, Column, Canvas, CanvasRenderingContext2D, RenderingContextSettings, Path2D, Entry, Component } from '@ohos.arkui.component';
  import { State, Watch } from '@ohos.arkui.stateManagement';
