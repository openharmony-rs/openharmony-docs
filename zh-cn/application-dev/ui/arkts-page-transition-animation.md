...
```ts
PageTransitionEnter({ type?: RouteType, duration?: int, curve?: Curve | string, delay?: int })
```
...
```ts
PageTransitionExit({ type?: RouteType, duration?: int, curve?: Curve | string, delay?: int })
```
...
<!-- @[pageTransition_template5_pageA_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template5/PageTransitionSrc3.ets) -->
...
<!-- @[pageTransition_template5_pageB_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template5/PageTransitionDst3.ets) -->
...
<!-- @[pageTransition_template6_pageA_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template6/PageTransitionSrc4.ets) -->
...
<!-- @[pageTransition_template6_pageB_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template6/PageTransitionDst4.ets) -->
...
<!-- @[pageTransition_template3_pageTransitionSrc1_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template3/pageTransitionSrc1.ets) -->

``` TypeScript
// PageTransitionSrc1
import {
  $r, Entry, Component, Column, Row, Button, Image, ImageFit,
  HorizontalAlign, FlexAlign, SlideEffect, RouteType,
  PageTransitionEnter, PageTransitionExit, ClickEvent, RowOptions
} from '@kit.ArkUI';
...
<!-- @[pageTransition_template3_pageTransitionDst1_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template3/pageTransitionDst1.ets) -->
...
<!-- @[pageTransition_template4_pageTransitionSrc2_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template4/pageTransitionSrc2.ets) -->

``` TypeScript
// PageTransitionSrc2
import {
  $r, Entry, Component, Column, Row, Button, Image, ImageFit,
  HorizontalAlign, FlexAlign, SlideEffect, RowOptions,
  PageTransitionEnter, PageTransitionExit, ClickEvent, TranslateOptions
} from '@kit.ArkUI';
...
struct PageTransitionSrc2 {
  ...
  pageTransition(): void {
    ...
    // 定义页面退出时的效果，相对于正常页面位置x方向平移100vp，y方向平移100vp，透明度变为0，时长为1200ms，无论页面栈发生push还是pop操作均可生效
    PageTransitionExit({ duration: 1200 })
      .translate({ x: 100.0, y: 100.0 } as TranslateOptions)
      .opacity(0)
  }
}
```
...
<!-- @[pageTransition_template4_pageTransitionDst2_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/AnimationStatic/entry/src/main/ets/pages/pageTransition/template4/pageTransitionDst2.ets) -->
