...
此外，沉浸式系统材质还支持材质赋色、自动反色、阴影开关、交互形变与点光源等个性化配置，具体使用方法请参见沉浸式系统材质视效。
...
| 动效类型 | 说明 | 支持的组件 |
| --- | --- | --- |
| 非线性形变 | 实现光影形体的动态蜕变，打破规整边界带来柔和自然的空间过渡。 | Dialog、菜单控制 |
| 边缘流光 | 流光塑造视觉焦点与层级秩序，依靠光流走向引导用户的视线流转。 | Dialog、菜单控制 |
| 粒子动画 | 粒子承载信息具象表达，以粒子光点传递信息变化。 | Slider |
