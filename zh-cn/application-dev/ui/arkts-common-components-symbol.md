...
SymbolGlyph通过$r引用Resource资源来创建，目前仅支持系统预置的Symbol资源名。<!--RP1--><!--RP1End-->
  ...
  ArkTS1.2示例：
  ```ts
  import { SymbolGlyph, SymbolRenderingStrategy, Color } from '@ohos.arkui.component';
...
- 创建SymbolSpan。
  ...
  ArkTS1.2示例：
  ```ts
  import { Text, FontWeight, SymbolSpan } from '@ohos.arkui.component';
  import { $r, $rawfile } from 'arkui.component.common';
  Text() {
    SymbolSpan($r('sys.symbol.ohos_trash'))
      .fontWeight(FontWeight.Normal)
...
- 通过[fontSize](../reference/apis-arkui/arkui-ts/ts-basic-components-symbolSpan.md#fontsize)属性设置SymbolSpan的大小。
  ...
  ArkTS1.2示例：
  ```ts
  import { Row, Column, Text, SymbolSpan, SymbolRenderingStrategy, Color } from '@ohos.arkui.component';
  import { $r, $rawfile } from 'arkui.component.common';
  Row() {
    Column() {
      Text("48")
...
- 通过[fontWeight](../reference/apis-arkui/arkui-ts/ts-basic-components-symbolSpan.md#fontweight)属性设置SymbolSpan组件的粗细。
  ...
  ArkTS1.2示例：
  ```ts
  import { Row, Column, Text, SymbolSpan, FontWeight } from '@ohos.arkui.component';
  import { $r, $rawfile } from 'arkui.component.common';
  Row() {
    Column() {
      Text("Light")
...
- 通过[fontColor](../reference/apis-arkui/arkui-ts/ts-basic-components-symbolSpan.md#fontcolor)属性设置SymbolSpan的颜色。
  ...
  ArkTS1.2示例：
  ```ts
  import { Row, Column, Text, SymbolSpan, Color } from '@ohos.arkui.component';
  import { $r, $rawfile } from 'arkui.component.common';
  Row() {
    Column() {
      Text("Black")
...
- 通过[effectStrategy](../reference/apis-arkui/arkui-ts/ts-basic-components-symbolSpan.md#effectstrategy)属性设置SymbolSpan的动效策略。
  ...
  ArkTS1.2示例：
  ```ts
  import { Row, Column, Text, SymbolSpan, SymbolEffectStrategy } from '@ohos.arkui.component';
  import { $r, $rawfile } from 'arkui.component.common';
  Row() {
    Column() {
      Text("无动效")
...
- 通过设置SymbolEffect属性，可以同时配置SymbolGlyph的动效策略和播放状态。
  ...
  ArkTS1.2示例：
  ```ts
  import { Column, Text, SymbolGlyph, Button, EffectFillStyle, HierarchicalSymbolEffect, ClickEvent } from '@ohos.arkui.component';
  ...
  Column() {
    ...
    SymbolGlyph($r('sys.symbol.ohos_wifi'))
      .fontSize(96)
      .symbolEffect(new HierarchicalSymbolEffect(EffectFillStyle.ITERATIVE), this.isActive)
    Button(this.isActive ? '关闭' : '播放').onClick((click: ClickEvent) => {
      this.isActive = !this.isActive;
    })
  }
  ```
...
- 通过设置SymbolEffect属性，可以同时指定SymbolGlyph的动画效果策略及其播放触发条件。 
  ...
  ArkTS1.2示例：
  ```ts
  import { Column, Text, SymbolGlyph, Button, EffectScope, BounceSymbolEffect, ClickEvent, EffectDirection, Color } from '@ohos.arkui.component';
  import { State } from '@ohos.arkui.stateManagement';
  import { $r, $rawfile } from 'arkui.component.common';
  @State triggerValueReplace: number = 0;
  Column() {
...
ArkTS1.2示例：
```ts
import { SymbolGlyph, ClickEvent, Color } from '@ohos.arkui.component';
import { State } from '@ohos.arkui.stateManagement';
import { $r, $rawfile } from 'arkui.component.common';
...
ArkTS1.2示例：
```ts
import { Entry, Column, Scroll, Row, Component, Button, ClickEvent, ColumnOptions, RowOptions, Divider, Padding } from '@ohos.arkui.component';
import { State } from '@ohos.arkui.stateManagement';
import { Text, Span, FontWeight, SymbolGlyph, ReplaceSymbolEffect, EffectScope, SymbolSpan, HorizontalAlign, Resource, ResourceColor, Color } from '@ohos.arkui.component';
import { $r, $rawfile } from 'arkui.component.common';
// xxx.ets
@Entry
@Component
