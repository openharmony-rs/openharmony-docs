...
ArkTS-Sta示例：
```ts
import { RichEditor, RichEditorStyledStringController, RichEditorStyledStringOptions, TextStyle, MutableStyledString, Color, StyledStringKey } from '@ohos.arkui.component';
...
ArkTS-Sta示例：
```ts
import { Entry, Component, Column, RichEditor, RichEditorController, RichEditorOptions, Color } from '@ohos.arkui.component';
...
import { Entry, Component, Column, RichEditor, RichEditorController, RichEditorOptions, Color, Resource, ShadowStyle, $r, Builder, Menu, MenuItemGroup, MenuItem, MenuItemOptions, RichEditorSpanType, ResponseType } from '@ohos.arkui.component';
...
ArkTS-Sta示例：
```ts
import { RichEditor, RichEditorController, RichEditorOptions, Color } from '@ohos.arkui.component';
...
ArkTS-Sta示例：
```ts
import { RichEditor, RichEditorController, RichEditorOptions, Color, FontWeight, FontStyle } from '@ohos.arkui.component';
...
在ArkTS-Sta上暂不支持配置装饰线粗细比例。

  ```ts
  import { RichEditor, RichEditorController, RichEditorOptions, Color, TextDecorationType, DecorationStyleInterface } from '@ohos.arkui.component';
...
```ts
import { Text, RichEditor, RichEditorController, RichEditorOptions, Color, RichEditorRange } from '@ohos.arkui.component';
...
```ts
import { Text, RichEditor, RichEditorController, RichEditorOptions, Color, RichEditorChangeValue, TextRange } from '@ohos.arkui.component';
...
```ts
import { Text, RichEditor, RichEditorController, RichEditorOptions, Color, RichEditorInsertValue, TextRange } from '@ohos.arkui.component';
...
struct on_cut_copy_paste {
  ...
  PopDataFromPasteboard() {
    ...
    sysBoard.getData((err, data) => {
      ...
      let count = data ? data.getRecordCount() : 0;
      for (let i = 0; i < count; i++) {
        const element = data?.getRecord(i);
        if (element && element.plainText && element.mimeType === pasteboard.MIMETYPE_TEXT_PLAIN) {
          this.controller.addTextSpan(element.plainText,
...
```ts
import { RichEditor, RichEditorController, RichEditorOptions, Color, CutEvent } from '@ohos.arkui.component';
...
RichEditor(this.options)
  ...
  .onCut((event:CutEvent | undefined) : void => {
    this.infoShowController.addTextSpan('触发onCut回调\n', {
      style: {
        fontColor: Color.Gray,
        fontSize: 10
...
```ts
import { RichEditor, RichEditorController, RichEditorOptions, Color, CopyEvent } from '@ohos.arkui.component';
...
RichEditor(this.options)
  ...
  .onCopy((event: CopyEvent | undefined) : void => {
    this.infoShowController.addTextSpan('触发onCopy回调\n', {
      style: {
        fontColor: Color.Gray,
        fontSize: 10
...
ArkTS-Sta暂不支持屏蔽系统服务类菜单与默认菜单自定义功能。
...
ArkTS-Sta暂不支持触发[onPrepareMenu](../reference/apis-arkui/arkui-ts/ts-text-common.md#onpreparemenu20)回调。
...
ArkTS-Sta示例：
```ts
import { Entry, Component, Column, Color, $r, TextAlign } from '@kit.ArkUI';
import { RichEditorController, RichEditorOptions, ColumnOptions, RichEditor,
TextVerticalAlign } from '@ohos.arkui.component';
...
```ts
import { Button, ButtonStyleMode, RichEditor, RichEditorController, RichEditorOptions, Color, FontStyle, TextDecorationType, ClickEvent } from '@ohos.arkui.component';
...
```ts
import { Button, ButtonStyleMode, RichEditor, RichEditorController, RichEditorOptions, Color, ClickEvent } from '@ohos.arkui.component';
...
```ts
import { Button, ButtonStyleMode, RichEditor, RichEditorController, RichEditorOptions, Color, ClickEvent, $r } from '@ohos.arkui.component';
...
```ts
import { CustomBuilder, Builder, Row, Image, Column, Text, Button, ButtonStyleMode, RichEditor, RichEditorController, RichEditorOptions, Color, ClickEvent, FontWeight, HorizontalAlign, $r } from '@ohos.arkui.component';

private my_builder: CustomBuilder | undefined = undefined
...
Button('addBuilderSpan', {
  ...
  .onClick((e: ClickEvent) => {
    ...
    if (this.my_builder != undefined) {
      this.controller.addBuilderSpan(this.my_builder as CustomBuilder)
    }
  })
```
...
```ts
import { Button, ButtonStyleMode, Text, RichEditor, RichEditorController, RichEditorOptions, Color, ClickEvent } from '@ohos.arkui.component';
