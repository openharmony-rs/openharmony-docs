...
- 导航点使用默认样式
  ...
  ArkTS-Sta示例：
  <!-- @[styles_default](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperStyles.ets) -->
...
- 自定义导航点样式
  ...
  ArkTS-Sta示例：
  <!-- @[styles_customize](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperStyles.ets) -->
...
- 控制控制器翻页。
  ...
  ArkTS-Sta示例：
  <!-- @[toggle](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperToggle.ets) -->
  
  ``` TypeScript
  // 导入ArcButton和ArcSwiper模块
  import { ArcSwiper, ArcSwiperController } from '@ohos.arkui.ArcSwiper';
  import {
    ArcButton,
    ArcButtonOptions,
    ArcButtonStyleMode,
  ...
  import { Color, Component, $r, Column, ColumnOptions, Entry, Stack, Text, TextAlign, CrownSensitivity, Blank, NavDestination } from '@kit.ArkUI';
  // ...
...
- 旋转表冠翻页。
  ...
  ArkTS-Sta示例：
  <!-- @[toggle_focus](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperToggle.ets) -->
  ...
  ArkTS-Sta示例：
  <!-- @[toggle_sensitivity](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperToggle.ets) -->
...
- 设置水平方向上轮播。
  ...
  ArkTS-Sta示例：
  <!-- @[horizontal](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperHorizontal.ets) -->
...
- 设置垂直方向轮播，导航点设为3点钟方向。
  ...
  ArkTS-Sta示例：
  <!-- @[vertical](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperVertical.ets) -->
...
ArkTS-Sta示例：
<!-- @[action](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperAction.ets) -->
...
export struct ArcSwiperAction {
  private MIN_SCALE: number = 0.1;
  @State backgroundColors: Array<Color> = [Color.Green, Color.Blue, Color.Yellow, Color.Pink, Color.Gray, Color.Orange];
    ...
    // ...
      Column({ space: 12 } as ColumnOptions) {
        // ...
          ...
          .customContentTransition({
            timeout: 1000,
            transition: (proxy: ArcSwiperContentTransitionProxy) => {
              if (proxy.position <= -1 || proxy.position >= 1) {
                // 页面完全滑出视窗外时，重置属性值
                this.opacityList[proxy.index] = 1.0;
                this.scaleList[proxy.index] = 1.0;
...
ArkTS-Sta示例：
<!-- @[side_slip](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkUISample-Sta/ScrollableComponentStatic/entry/src/main/ets/pages/arcSwiper/ArcSwiperSideSlip.ets) -->
    ...
    // ...
      Column({ space: 12 } as ColumnOptions) {
        // ...
          ...
          .onAnimationStart((index: int, targetIndex: int) => {
            this.innerSelectedIndex = targetIndex;
          })
          .onGestureRecognizerJudgeBegin((event: BaseGestureEvent, current: GestureRecognizer,
            others: Array<GestureRecognizer>): GestureJudgeResult => { // 在识别器即将要成功时，根据当前组件状态，设置识别器使能状态
            if (current) {
              ...
              if (target && current.isBuiltIn() && current.getType() == GestureControl.GestureType.PAN_GESTURE) {
                let swiperTarget = target as ScrollableTargetInfo;
                if (swiperTarget instanceof ScrollableTargetInfo &&
                  (swiperTarget.isBegin() || this.innerSelectedIndex ===
                    0)) { // 此处判断swiperTarget.isBegin()或innerSelectedIndex === 0，表明ArcSwiper滑动到开头
                  let panEvent = event as PanGestureEvent;
                  if (panEvent && panEvent.offsetX > 0 && (swiperTarget.isBegin() || this.innerSelectedIndex === 0)) {
                    return GestureJudgeResult.REJECT;
                  }
