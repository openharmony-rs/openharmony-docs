...
```
ArkTS1.2示例：
ArkTS1.2不支持textVerticalAlign设置，此部分省略。
```ts
import { Entry, Column, Scroll, Row, Component, Button, ClickEvent, Color } from '@ohos.arkui.component';
import { State } from '@ohos.arkui.stateManagement';
import { Text, ImageSpan, Span, ImageSpanAlignment, Color, TextDecorationType, TextDecorationStyle, ImageSpanAlignment,
  ResourceImageAttachmentOptions, MutableStyledString, TextController, ParagraphStyle, LineHeightStyle, TextOverflow,
  FontWeight, TextStyle, StyledStringKey, CopyOptions, ImageAttachment, ImageFit, ColumnOptions } from '@ohos.arkui.component';
