...
从API version 22开始，在List&Grid中提供[ParallelizeUI](../reference/apis-arkui/js-apis-arkui-Parallelize.md#parallelizeui)的重载接口[ParallelizeUI<V, T>](../reference/apis-arkui/js-apis-arkui-Parallelize.md#parallelizeuiv-t22)用于UI并行化循环创建。
...
## 约束与限制
  * 不能在[ParallelizeUI](../reference/apis-arkui/js-apis-arkui-Parallelize.md#parallelizeui)中使用外部定义的状态变量，例如：[@Link](state-management-static/arkts-static-link.md)、[@PropRef](state-management-static/arkts-static-propref.md)、[@Consumer](state-management-static/arkts-static-new-provider-and-consumer.md)、[@StorageLink](state-management-static/arkts-static-appstorage.md#storagelink)、[@StoragePropRef](state-management-static/arkts-static-appstorage.md#storagepropref)、[@LocalStorageLink](state-management-static/arkts-static-localstorage.md#localstoragelink)、[@LocalStoragePropRef](state-management-static/arkts-static-localstorage.md#localstoragepropref)。需要依赖外部的状态变量更新UI，请使用[ParallelizeUI\<T\>](../reference/apis-arkui/js-apis-arkui-Parallelize.md#parallelizeuit)。
