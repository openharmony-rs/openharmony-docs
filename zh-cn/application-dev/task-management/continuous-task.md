...
| MODE_AV_PLAYBACK_AND_RECORD<sup>22+</sup> | 多媒体相关业务 | avPlaybackAndRecord  | 音视频播放，录制，音视频通话时退后台。|
| MODE_SPECIAL_SCENARIO_PROCESSING<sup>22+</sup> | 特殊场景类型 | specialScenarioProcessing  | 导出媒体文件业务，使用三方投播组件投播时退后台。|
