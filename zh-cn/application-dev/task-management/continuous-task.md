...
| MODE_SPECIAL_SCENARIO_PROCESSING<sup>22+</sup> | 特殊场景类型。（仅对Phone、Tablet、PC/2in1设备开放）<br/>**说明：** 从API version 22开始支持。 | specialScenarioProcessing  | 在后台进行导出媒体文件，使用三方投播组件在后台进行投播。|
