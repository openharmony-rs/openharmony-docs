...
### 使用 websocket 端口进行调试
除了使用上述Chrome inspect页面和打开 "devtoolsFrontendUrl" 字段url的方法通过网页端 Chrome DevTools调试代码之外，如果读者了解如何使用 CDP 协议代替网页端 devtools 功能，也可以通过连接 inspector 提供的 websocket 端口进行调试。
