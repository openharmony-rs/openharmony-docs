...
开发者可使用[napi_create_strong_sendable_reference/native-lib/napi.md#napi_create_strong_sendable_reference)接口创建指向Sendable ArkTS对象的Sendable强引用，使用[napi_get_strong_sendable_reference_value/native-lib/napi.md#napi_get_strong_sendable_reference_value)获取被引用的ArkTS对象，使用[napi_delete_strong_sendable_reference/native-lib/napi.md#napi_delete_strong_sendable_reference)删除Sendable强引用。这些操作既可以在同一ArkTS线程进行，也可在不同ArkTS线程进行。

## Sendable强引用对象关联接口

| 接口                                     | 描述                                       |
| ---------------------------------------- | ------------------------------------------ |
| [napi_create_strong_sendable_reference/native-lib/napi.md#napi_create_strong_sendable_reference)    | 创建指向Sendable ArkTS对象的Sendable强引用。 |
| [napi_delete_strong_sendable_reference/native-lib/napi.md#napi_delete_strong_sendable_reference)    | 删除Sendable强引用。                        |
