...
- **显式Want**：在启动目标应用组件时，调用方传入的[want](../reference/apis-ability-kit/js-apis-app-ability-want.md)参数中指定了abilityName和bundleName，称为显式Want。
  ...
  ArkTS-Sta示例：
  <!-- @[explicit_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/WantOverview-sta/entry/src/main/ets/pages/ExplicitPage.ets) -->
...
- **隐式Want**：在启动目标应用组件时，调用方传入的[want](../reference/apis-ability-kit/js-apis-app-ability-want.md)参数中未指定abilityName，称为隐式Want。
  ...
  ArkTS-Sta示例：
  <!-- @[implicit_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/WantOverview-sta/entry/src/main/ets/pages/ImplicitPage.ets) -->
