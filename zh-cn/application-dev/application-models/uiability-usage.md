...
拉起方（UIAbilityA）通过startAbility启动目标方（UIAbilityB）时，UIAbilityB可以通过[parameters](../reference/apis-ability-kit/js-apis-app-ability-want.md#want)参数获取UIAbilityA的Pid、BundleName和AbilityName等信息。
