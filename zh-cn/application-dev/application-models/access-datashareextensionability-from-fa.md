...
- FA模型中，客户端是由[DataAbilityHelper/apis-ability-kit/js-apis-inner-ability-dataAbilityHelper.md)提供对外接口，服务端是由[DataAbility](dataability-overview.md)提供数据库的读写服务。

- Stage模型中，客户端是由[DataShareHelper/apis-arkdata/js-apis-data-dataShare-sys.md#datasharehelper)提供对外接口，服务端是由[DataShareExtensionAbility/apis-arkdata/js-apis-application-dataShareExtensionAbility-sys.md)提供数据库的读写服务。
