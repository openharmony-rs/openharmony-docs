...
通过调用[`UIAbilityContext.setMissionIcon()`/apis-ability-kit/js-apis-inner-application-uiAbilityContext-sys.md#setmissionicon)方法修改任务快照的图标。
...
通过调用[`UIAbilityContext.setMissionLabel()`/apis-ability-kit/js-apis-inner-application-uiAbilityContext.md#setmissionlabel)方法修改任务快照的名称。
