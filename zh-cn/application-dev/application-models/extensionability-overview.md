...
| FileAccessExtensionAbility | 文件访问扩展能力，为文件管理器提供统一访问入口，支持其他应用访问由本应用存储和管理的文档和目录。 | 否 | 否 |
| AdsExtensionAbility | 广告扩展能力，对外提供后台自定义广告业务服务。 | 否 | 否 |
| [VoIPExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-voip-ability) | 网络音视频通话扩展能力，提供网络音视频通话服务。 | 是 | 否 |
| [RemoteLocationExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/remote-location-ability) | 远程定位扩展能力，与Push业务结合构建Location定位类场景化消息，支持应用在Extension中上报地理位置，弹出对话框和通知等。 | 是 | 否 |
| [RemoteNotificationExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-remote-notification-extension-ability) | 远程通知扩展能力，与Push业务结合构建IM场景化消息，支持Push在代理应用弹出通知栏之前拉起应用子进程进行通知内容替换。 | 是 | 否 |
| [PushExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/push-extension-ability) | 推送扩展能力，提供推送能力管理，包括查找定位、远程设备连接、配置参数更新、声纹更新等功能。 | 是 | 否 |
| [CallInfoQueryExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/callservicekit-callerinfoquery-extension-ability) | 来电信息查询扩展能力，来电时页面显示已安装企业应用的联系人信息，方便用户识别来电人信息，提升企业内部沟通效率。 | 是 | 否 |
| [InsightIntentUIExtensionAbility](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/intents-arkts-api-insightintent-uiextension) | 意图UI扩展能力，为开发者提供能被小艺意图调用，以窗口形态呈现内容的扩展能力。 | 是 | 否 |
...
| [AutoFillExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-autoFillExtensionAbility-sys.md) | 自动填充扩展能力，提供用户应用的免密登录功能。 | 否 | 否 |
...
| [UIServiceExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-uiServiceExtensionAbility-sys.md) | UI服务扩展能力，在PC上提供带前台窗口的服务。 | 否 | 否 |
<!--RP2--><!--RP2End-->
