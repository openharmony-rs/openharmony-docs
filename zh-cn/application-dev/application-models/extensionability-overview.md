...
| VoIPExtensionAbility | 网络音视频通话扩展能力，提供网络音视频通话服务。 | 是 | 否 |
| RemoteLocationExtensionAbility | 远程定位扩展能力，与Push业务结合构建Location定位类场景化消息，支持应用在Extension中上报地理位置，弹出对话框和通知等。 | 是 | 否 |
| RemoteNotificationExtensionAbility | 远程通知扩展能力，与Push业务结合构建IM场景化消息，支持Push在代理应用弹出通知栏之前拉起应用子进程进行通知内容替换。 | 是 | 否 |
| PushExtensionAbility | 推送扩展能力，提供推送能力管理，包括查找定位、远程设备连接、配置参数更新、声纹更新等功能。 | 是 | 否 |
| CallInfoQueryExtensionAbility | 来电信息查询扩展能力，来电时页面显示已安装企业应用的联系人信息，方便用户识别来电人信息，提升企业内部沟通效率。 | 是 | 否 |
| InsightIntentUIExtensionAbility | 意图UI扩展能力，为开发者提供能被小艺意图调用，以窗口形态呈现内容的扩展能力。 | 是 | 否 |
