...
4. 在工程Module对应的module.json5配置文件中注册AgentExtensionAbility，type标签需要设置为"agent"，srcEntry标签表示当前ExtensionAbility组件所对应的代码路径。
...
5. 在工程Module的`resources/base/profile/`目录下新建agent_config.json文件，然后在其中配置AgentCard信息，详细操作步骤请参考Agent配置文件说明。
