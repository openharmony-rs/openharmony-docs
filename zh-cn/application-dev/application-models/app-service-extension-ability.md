...
3. 在MyAppServiceExtAbility.ets文件中，增加导入[AppServiceExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)的依赖包，自定义类继承AppServiceExtensionAbility组件并实现生命周期回调。
    ...
    ArkTS-Sta示例：
    <!-- @[ability_app_service_one](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/myappserviceextability/MyAppServiceExtAbility.ets) -->
    ...
    class StubTest extends rpc.RemoteObject {
      ...
      onRemoteMessageRequest(code: int,
        data: rpc.MessageSequence,
        reply: rpc.MessageSequence,
        options: rpc.MessageOption): boolean | Promise<boolean> {
        // 处理客户端发送的消息
...
- 在应用中启动一个新的[AppServiceExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)组件。示例中的context的获取方式请参见[获取UIAbility的上下文信息](uiability-usage.md#获取uiability的上下文信息)。
  ...
  ArkTS-Sta示例：
  <!-- @[app_ext_service_one_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/pages/StartAppServiceExt.ets) -->
...
- 在应用中停止一个已启动的[AppServiceExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)组件。
  ...
  ArkTS-Sta示例：
  <!-- @[app_ext_service_two_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/pages/StopAppServiceExt.ets) -->
...
- 已启动的[AppServiceExtensionAbility](../reference/apis-ability-kit/js-apis-app-ability-appServiceExtensionAbility.md)组件停止自身。
  ...
  ArkTS-Sta示例：
  <!-- @[ability_app_service_two](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/myappserviceextability/MyAppServiceExtAbility.ets) -->
...
- 使用[connectAppServiceExtensionAbility()](../reference/apis-ability-kit/js-apis-inner-application-uiAbilityContext.md#connectappserviceextensionability20)建立与后台服务的连接。示例中的context的获取方式请参见[获取UIAbility的上下文信息](uiability-usage.md#获取uiability的上下文信息)。
  ...
  ArkTS-Sta示例：
  <!-- @[app_ext_service_three_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/pages/ConnectAppServiceExt.ets) -->
...
- 使用[disconnectAppServiceExtensionAbility()](../reference/apis-ability-kit/js-apis-inner-application-uiAbilityContext.md#disconnectappserviceextensionability20)断开与后台服务的连接。
  ...
  ArkTS-Sta示例：
  <!-- @[app_ext_service_four_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/pages/DisConnectAppServiceExt.ets) -->
...
ArkTS-Sta示例：
<!-- @[app_ext_service_five_start](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/pages/ClientServerExt.ets) -->
...
ArkTS-Sta示例：
<!-- @[ability_app_service_three](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/myappserviceextabilitytwo/MyAppServiceExtAbility.ets) -->
...
ArkTS-Sta示例：
<!-- @[ability_app_service_five](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/myappserviceextabilitythree/MyAppServiceExtAbility.ets) -->
...
ArkTS-Sta示例：
<!-- @[ability_app_service_four](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/Ability/AppServiceExtensionAbility-sta/entry/src/main/ets/myappserviceextabilityfour/MyAppServiceExtAbility.ets) -->
...
const TAG: string = '[AppServiceExtImpl]';
const DOMAIN_NUMBER: int = 0xFF00;
let permissionName: Permissions = 'ohos.permission.GET_BUNDLE_INFO_PRIVILEGED';
...
class Stub extends rpc.RemoteObject {
  ...
  onRemoteMessageRequest(
    ...
    let callerTokenId: int = rpc.IPCSkeleton.getCallingTokenId().toInt();
    let accessManager = abilityAccessCtrl.createAtManager();
    // 所校验的具体权限由开发者自行选择，此处ohos.permission.GET_BUNDLE_INFO_PRIVILEGED只作为示例
    let grantStatus = accessManager.verifyAccessTokenSync(callerTokenId, permissionName);
    if (grantStatus === abilityAccessCtrl.GrantStatus.PERMISSION_DENIED) {
      hilog.error(DOMAIN_NUMBER, TAG, 'PERMISSION_DENIED');
      return false;
    }
