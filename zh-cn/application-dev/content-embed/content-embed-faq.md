...
客户端基于[OH_ContentEmbed_CreateDocumentByFile](../reference/apis-content-embed-kit/capi-content-embed-document-h#OH_ContentEmbed_CreateDocumentByFile)创建文档时，可以通过isLinking参数指定是否以链接方式创建OE文档。
