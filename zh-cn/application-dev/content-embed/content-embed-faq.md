...
客户端基于[OH_ContentEmbed_CreateDocumentByFile](../reference/apis-content-embed-kit/capi-content-embed-document-h.md#oh_contentembed_createdocumentbyfile)创建OE文档时，可以通过isLinking参数指定是否以链接方式创建OE文档。
