...
| [12800019](../errorcode-inputmethod-framework.md#12800019-系统配置的默认输入法不支持此操作) | current operation cannot be applied to the preconfigured default inputmethod. |
...
| enabledState | EnabledState | 是 | 要修改的启用状态。 |
...
| [12800008](../errorcode-inputmethod-framework.md#12800008-输入法管理服务异常) | input method manager service error. Possible cause:a system error, such as null pointer, IPC exception. |
| [12800018](../errorcode-inputmethod-framework.md#12800018-输入法未找到) | input method is not found. |
| [12800019](../errorcode-inputmethod-framework.md#12800019-系统配置的默认输入法不支持此操作) | current operation cannot be applied to the preconfigureddefault input method. |
...
| 类型 | 说明 |
| --- | --- |
| InputMethodProperty | 默认输入法属性，仅保证`name`和`id`属性正确，其他属性可能为空。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| panelInfo | PanelInfo | 是 | 输入法面板的属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ImeChangeWithUserIdCallback | 否 | 回调函数，返回取消订阅的输入法属性对象、子类型对象及用户ID。参数不填写时，取消订阅所有的回调事件。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | ImeChangeWithUserIdCallback | 是 | 回调函数，返回输入法属性对象、子类型对象及用户ID。 |
