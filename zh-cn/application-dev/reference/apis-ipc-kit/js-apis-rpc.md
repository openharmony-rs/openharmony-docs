...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的字节值。<br/>取值范围：[-2<sup>7</sup>, 2<sup>7</sup>-1]。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明 |
  | ------ | ------ | ---  | ---  |
  | val    | number | 是   | 要写入的短整数值。<br/>取值范围：[-2<sup>15</sup>, 2<sup>15</sup>-1]。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的整数值。<br/>取值范围：[-2<sup>31</sup>, 2<sup>31</sup>-1]。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的长整数值。<br/>取值范围：[-2<sup>63</sup>, 2<sup>63</sup>-1]。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的双精度浮点值。<br/>取值范围：[-1.7976931348623157e+308, 1.7976931348623157e+308]。 |
...
**参数：**
  ...
  | 参数名 | 类型    | 必填 | 说明             |
  | ------ | ------- | ---- | ---------------- |
  | val    | boolean | 是   | 要写入的布尔值。<br/>取值范围：{true, false}。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                 |
  | ------ | ------ | ---- | -------------------- |
  | val    | number | 是   | 要写入的单个字符值。<br/>取值范围：[0, 2<sup>16</sup>-1]。 |
