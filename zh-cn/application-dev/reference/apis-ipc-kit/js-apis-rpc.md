...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的字节值。<br/>取值范围：8位有符号整数。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明 |
  | ------ | ------ | ---  | ---  |
  | val    | number | 是   | 要写入的短整数值。<br/>取值范围：16位有符号整数。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的整数值。<br/>取值范围：32位有符号整数。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的长整数值。<br/>取值范围：64位有符号整数。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的双精度浮点值。<br/>取值范围：64位双精度浮点数。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                 |
  | ------ | ------ | ---- | -------------------- |
  | val    | number | 是   | 要写入的单个字符值。<br/>取值范围：16位无符号整数。 |
