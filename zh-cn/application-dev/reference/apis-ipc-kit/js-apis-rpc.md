...
**返回值：**
  ...
  | 类型   | 说明                                            |
  | ------ | ----------------------------------------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 获取的MessageSequence实例的数据大小。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明  |
  | ------ | ----- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 获取的MessageSequence实例的容量大小。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明   |
  | ------ | ------ | ---- | ------ |
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | MessageSequence实例的数据大小。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: setCapacity(size: number): void

ArkTS-Sta: setCapacity(size: int): void
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                                          |
  | ------ | ------ | ---- | --------------------------------------------- |
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | MessageSequence实例的存储容量。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明   |
  | ------ | ------ |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 获取到的MessageSequence实例的可写字节空间。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明    |
  | ------ | ------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 获取到的MessageSequence实例的可读字节空间。以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明   |
  | ------ | ------ |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回MessageSequence实例中的当前读取位置。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明  |
  | ------ | ----- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回MessageSequence实例中的当前写入位置。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明    |
  | ------ | ------ | ---- | ------- |
  | pos    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 开始读取数据的目标位置。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | pos    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 开始写入数据的目标位置。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的字节值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明  |
  | ------ | ----- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回字节值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明 |
  | ------ | ------ | ---  | ---  |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的短整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明           |
  | ------ | -------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回短整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeInt(val: number): void

ArkTS-Sta: writeInt(val: int): void
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明         |
  | ------ | ------------ |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeLong(val: number): void

ArkTS-Sta: writeLong(val: long): void
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是   | 要写入的长整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readLong(): number

ArkTS-Sta: readLong(): long
...
**返回值：**
  ...
  | 类型   | 说明           |
  | ------ | -------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: long | 返回长整数值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: double | 是   | 要写入的双精度浮点值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明         |
  | ------ | ------------ |
  | ArkTS-Dyn: number<br>ArkTS-Sta: double | 返回双精度浮点值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                 |
  | ------ | ------ | ---- | -------------------- |
  | val    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的单个字符值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明 |
  | ------ | ---- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回单个字符值。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeByteArray(byteArray: number[]): void

ArkTS-Sta: writeByteArray(byteArray: int[]): void
...
**参数：**
  ...
  | 参数名    | 类型     | 必填 | 说明               |
  | --------- | -------- | ---- | ------------------ |
  | byteArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要写入的字节数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明               |
  | ------ | -------- | ---- | ------------------ |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要读取的字节数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型     | 说明           |
  | -------- | -------------- |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 返回字节数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名     | 类型     | 必填 | 说明                 |
  | ---------- | -------- | ---- | -------------------- |
  | shortArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要写入的短整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明                 |
  | ------ | -------- | ---- | -------------------- |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要读取的短整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型     | 说明             |
  | -------- | ---------------- |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 返回短整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeIntArray(intArray: number[]): void

ArkTS-Sta: writeIntArray(intArray: int[]): void
...
**参数：**
  ...
  | 参数名   | 类型     | 必填 | 说明               |
  | -------- | -------- | ---- | ------------------ |
  | intArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要写入的整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readIntArray(dataIn: number[]): void

ArkTS-Sta: readIntArray(dataIn: int[]): void
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明               |
  | ------ | -------- | ---- | ------------------ |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要读取的整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readIntArray(): number[]

ArkTS-Sta: readIntArray(): int[]
...
**返回值：**
  ...
  | 类型     | 说明           |
  | -------- | -------------- |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 返回整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名    | 类型     | 必填 | 说明                 |
  | --------- | -------- | ---- | -------------------- |
  | longArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: long[] | 是   | 要写入的长整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明                 |
  | ------ | -------- | ---- | -------------------- |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: long[] | 是   | 要读取的长整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型     | 说明             |
  | -------- | ---------------- |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: long[] | 返回长整数数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名     | 类型     | 必填 | 说明                                                                                                                    |
  | ---------- | -------- | ---- | ----------------------------------------------------------------------------------------------------------------------- |
  | floatArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: double[] | 是   | 要写入的双精度浮点数组。由于系统内部对float类型的数据是按照double处理的，使用时对于数组所占的总字节数应按照double类型来计算。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明                                                                                                                    |
  | ------ | -------- | ---- | ----------------------------------------------------------------------------------------------------------------------- |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: double[] | 是   | 要读取的双精度浮点数组。由于系统内部对float类型的数据是按照double处理的，使用时对于数组所占的总字节数应按照double类型来计算。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型     | 说明           |
  | -------- | -------------- |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: double[] | 返回双精度浮点数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeDoubleArray(doubleArray: number[]): void

ArkTS-Sta: writeDoubleArray(doubleArray: double[]): void
...
**参数：**
  ...
  | 参数名      | 类型     | 必填 | 说明                     |
  | ----------- | -------- | ---- | ------------------------ |
  | doubleArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: double[] | 是   | 要写入的双精度浮点数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readDoubleArray(dataIn: number[]): void

ArkTS-Sta: readDoubleArray(dataIn: double[]): void
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明                     |
  | ------ | -------- | ---- | ------------------------ |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: double[] | 是   | 要读取的双精度浮点数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readDoubleArray(): number[]

ArkTS-Sta: readDoubleArray(): double[]
...
**参数：**
  ...
  | 参数名    | 类型     | 必填 | 说明                   |
  | --------- | -------- | ---- | ---------------------- |
  | charArray | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要写入的单个字符数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型     | 必填 | 说明                   |
  | ------ | -------- | ---- | ---------------------- |
  | dataIn | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 是   | 要读取的单个字符数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型     | 说明               |
  | -------- | ------------------ |
  | ArkTS-Dyn: number[]<br>ArkTS-Sta: int[] | 返回单个字符数组。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: static closeFileDescriptor(fd: number): void

ArkTS-Sta: static closeFileDescriptor(fd: int): void
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                 |
  | ------ | ------ | ---- | -------------------- |
  | fd     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要关闭的文件描述符。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                     |
  | ------ | ------ | ---- | ------------------------ |
  | fd     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示已存在的文件描述符。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeFileDescriptor(fd: number): void

ArkTS-Sta: writeFileDescriptor(fd: int): void
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明         |
  | ------ | ------ | ---- | ------------ |
  | fd     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 文件描述符。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readFileDescriptor(): number

ArkTS-Sta: readFileDescriptor(): int
...
**返回值：**
  ...
  | 类型   | 说明             |
  | ------ | ---------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回文件描述符。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: writeRawDataBuffer(rawData: ArrayBuffer, size: number): void

ArkTS-Sta: writeRawDataBuffer(rawData: ArrayBuffer, size: int): void
...
**参数：**
  ...
  | size    | ArkTS-Dyn: number<br>ArkTS-Sta: int      | 是   | 发送的原始数据大小，以字节为单位。</br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: readRawDataBuffer(size: number): ArrayBuffer

ArkTS-Sta: readRawDataBuffer(size: int): ArrayBuffer
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                     |
  | ------ | ------ | ---- | ------------------------ |
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要读取的原始数据的大小。</br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
...
| 名称    | 类型            | 只读 | 可选 | 说明                                  |
| ------- | --------------- | ---- | ---- |-------------------------------------- |
| errCode | ArkTS-Dyn: number<br>ArkTS-Sta: int          | 否   | 否   | 错误码。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
| code    | ArkTS-Dyn: number<br>ArkTS-Sta: int          | 否   | 否   | 消息代码。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
| 名称    | 类型            | 只读 | 可选 | 说明                                  |
| ------- | --------------- | ---- | ---- |-------------------------------------- |
| callerPid | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 否   | 调用者的PID。</br> ArkTS-Dyn起始版本: 23 </br> ArkTS-Sta起始版本: 23 |
| callerUid | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 否   | 调用者的UID。</br> ArkTS-Dyn起始版本: 23 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: sendMessageRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption): Promise&lt;RequestResult&gt;

ArkTS-Sta: sendMessageRequest(code: int, data: MessageSequence, reply: MessageSequence, options: MessageOption): Promise&lt;RequestResult&gt;
...
**参数：**
  ...
  | 参数名  | 类型                                 | 必填 | 说明                                                                                   |
  | ------- | ------------------------------------ | ---- | -------------------------------------------------------------------------------------- |
  | code    | ArkTS-Dyn: number<br>ArkTS-Sta: int  | 是   | 本次请求调用的消息码[1-16777215]，由通信双方确定。如果接口由IDL工具生成，则消息代码由IDL自动生成。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: sendMessageRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption, callback: AsyncCallback&lt;RequestResult&gt;): void
...
ArkTS-Dyn: registerDeathRecipient(recipient: DeathRecipient, flags: number): void

ArkTS-Sta: registerDeathRecipient(recipient: DeathRecipient, flags: int): void
...
**参数：**
  ...
  | flags     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 死亡通知标志。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: unregisterDeathRecipient(recipient: DeathRecipient, flags: number): void

ArkTS-Sta: unregisterDeathRecipient(recipient: DeathRecipient, flags: int): void
...
**ArkTS-Sta起始版本**: 23
  ...
  | 名称                  | 类型   | 只读  | 可选 | 说明                                     |
  | --------------------- | -------| ------|------|------------------------------------------ |
  | PING_TRANSACTION      | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否   | 内部指令码，用于测试IPC服务是否正常。  |
  | DUMP_TRANSACTION      | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否   | 内部指令码，获取IPC服务相关的状态信息。|
  | INTERFACE_TRANSACTION | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否   | 内部指令码，获取对端接口描述符。       |
  | MIN_TRANSACTION_ID    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否   | 最小有效指令码。                     |
  | MAX_TRANSACTION_ID    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否   | 最大有效指令码。                     |
...
**系统能力：**以下各项对应的系统能力均为SystemCapability.Communication.IPC.Core。
  ...
  | 名称          | 类型   | 只读  | 可选  | 说明                                                                      |
  | ------------- | ------ | ----- | ----- | ------------------------------------------------------------------------ |
  | TF_SYNC       | ArkTS-Dyn:number</br> ArkTS-Sta:int | 是    | 否    | 同步调用标识。 </br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
  | TF_ASYNC      | ArkTS-Dyn:number</br> ArkTS-Sta:int | 是    | 否    | 异步调用标识。  </br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
  | TF_ACCEPT_FDS | ArkTS-Dyn:number</br> ArkTS-Sta:int | 是    | 否    | 指示sendMessageRequest<sup>9+</sup>接口可以传递文件描述符。 </br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
  | TF_WAIT_TIME  | ArkTS-Dyn:number</br> ArkTS-Sta:int | 是    | 否    | RPC等待时间(单位/秒)，IPC场景下无效。默认等待为8秒（不建议修改等待时间）。 </br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: constructor(syncFlags?: number, waitTime?: number)

ArkTS-Sta: constructor(syncFlags?: int, waitTime?: int)
...
**参数：**
  ...
  | 参数名    | 类型   | 必填 | 说明                                          |
  | --------- | ------ | ---- | --------------------------------------------- |
  | syncFlags | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 同步调用或异步调用标志，同步调用标志：0；异步调用标志：1。默认同步调用。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
  | waitTime  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 调用rpc最长等待时间。默认TF_WAIT_TIME。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明                                 |
  | ------ | ------------------------------------ |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 调用成功返回同步调用或异步调用标志。同步调用标志：0，异步调用标志：1。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                     |
  | ------ | ------ | ---- | ------------------------ |
  | flags  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 同步调用或异步调用标志。同步调用标志：0；异步调用标志：1 </br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明              |
  | ------ | ----------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | rpc最长等待时间。默认TF_WAIT_TIME。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名   | 类型   | 必填 | 说明                  |
  | -------- | ------ | ---- | --------------------- |
  | waitTime | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | rpc调用最长等待时间，上限为3000秒。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: static getCallingPid(): number
...
**返回值：**
  ...
  | 类型   | 说明              |
  | ------ | ----------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回调用者的PID。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: static getCallingUid(): number
...
**返回值：**
  ...
  | 类型   | 说明              |
  | ------ | ----------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回调用者的UID。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: static getCallingTokenId(): number

ArkTS-Sta: static getCallingTokenId(): long
...
**返回值：**
   ...
   | 类型   | 说明                  |
   | ------ | --------------------- |
   | ArkTS-Dyn: number<br>ArkTS-Sta: long | 返回调用者的TokenId。</br> ArkTS-Dyn起始版本: 8 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: onRemoteMessageRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption, callingInfo?: CallingInfo): boolean | Promise\<boolean>

ArkTS-Sta: onRemoteMessageRequest(code: int, data: MessageSequence, reply: MessageSequence, options: MessageOption, callingInfo: CallingInfo): boolean
...
> 开发者同时重载带有和不带CallingInfo参数的onRemoteMessageRequest方法时，仅前者生效。
> ArkTS-Dyn不支持函数重载，无法同时实现带有和不带CallingInfo参数的onRemoteMessageRequest方法。
...
**参数：**
  ...
  | 参数名 | 类型                                 | 必填 | 说明                                      |
  | ------ | ------------------------------------ | ---- | ----------------------------------------- |
  | code   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 对端发送的服务请求码。</br> ArkTS-Dyn起始版本: 23 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型              | 说明                                                                                            |
  | ----------------- | ----------------------------------------------------------------------------------------------- |
  | ArkTS-Dyn: boolean \| Promise\<boolean><br>ArkTS-Sta: boolean  | - 若在onRemoteMessageRequest中同步处理请求，则返回一个布尔值。返回true表示操作成功，返回false表示操作失败。</br>- 若在onRemoteMessageRequest中异步处理请求，则返回一个Promise对象。返回true表示操作成功，返回false表示操作失败。|
...
**同时重载带有CallingInfo和不带CallingInfo的onRemoteMessageRequest方法及onRemoteRequest方法同步处理请求示例：**
...
class TestRemoteObject extends rpc.RemoteObject {
  ...
  onRemoteMessageRequest(code: int, data: rpc.MessageParcel, reply: rpc.MessageParcel,
...
ArkTS-Dyn: onRemoteMessageRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption): boolean | Promise\<boolean>
...
**参数：**
  ...
  | 参数名 | 类型                                 | 必填 | 说明                                      |
  | ------ | ------------------------------------ | ---- | ----------------------------------------- |
  | code   | ArkTS-Dyn: number<br>ArkTS-Sta: int  | 是   | 对端发送的服务请求码。 </br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
  | data   | [MessageSequence](#messagesequence9) | 是   | 携带客户端调用参数的MessageSequence对象。 |
  | reply  | [MessageSequence](#messagesequence9) | 是   | 写入结果的MessageSequence对象。           |
  | options | [MessageOption](#messageoption)      | 是   | 指示操作是同步还是异步。                  |
...
ArkTS-Dyn: getCallingUid(): number

ArkTS-Sta: getCallingUid(): int
...
**返回值：**
  | 类型   | 说明                    |
  | ------ | ----------------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回通信对端的进程Uid。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
ArkTS-Dyn: getCallingPid(): number

ArkTS-Sta: getCallingPid(): int
...
**返回值：**
  ...
  | 类型   | 说明                    |
  | ------ | ----------------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回通信对端的进程Pid。</br> ArkTS-Dyn起始版本: 7 </br> ArkTS-Sta起始版本: 23 |
...
**ArkTS-Sta起始版本**: 23
  ...
  | 名称       | 类型   | 只读  | 可选  | 说明                                     |
  | ---------- | ------ | ----- | ----- |----------------------------------------- |
  | PROT_EXEC  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否    | 映射内存保护类型，代表映射的内存可执行。 |
  | PROT_NONE  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否    | 映射内存保护类型，代表映射的内存不可访问。|
  | PROT_READ  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否    | 映射内存保护类型，代表映射的内存可读。|
  | PROT_WRITE | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 否    | 映射内存保护类型，代表映射的内存可写。  |

### create<sup>9+</sup>

ArkTS-Dyn: static create(name: string, size: number): Ashmem

ArkTS-Sta: static create(name: string, size: int): Ashmem
...
**参数：**
  ...
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | Ashmem的大小，其大小应大于0，以字节为单位。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**返回值：**
  ...
  | 类型   | 说明                       |
  | ------ | -------------------------- |
  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回Ashmem对象的内存大小。</br> ArkTS-Dyn起始版本: 8 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名         | 类型   | 必填 | 说明               |
  | -------------- | ------ | ---- | ------------------ |
  | protectionType | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要设置的保护类型。</br> ArkTS-Dyn起始版本: 9 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的数据大小。 </br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
  | offset | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要写入的数据在此Ashmem对象关联的内存区间的起始位置。</br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                                               |
  | ------ | ------ | ---- | -------------------------------------------------- |
  | size   | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要读取的数据的大小。</br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23                               |
  | offset | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 要读取的数据在此Ashmem对象关联的内存区间的起始位置。</br> ArkTS-Dyn起始版本: 11 </br> ArkTS-Sta起始版本: 23 |
