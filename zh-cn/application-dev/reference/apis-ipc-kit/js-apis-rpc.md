...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的字节值。<br/>取值范围：int8类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明 |
  | ------ | ------ | ---  | ---  |
  | val    | number | 是   | 要写入的短整数值。<br/>取值范围：int16类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的整数值。<br/>取值范围：int32类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明             |
  | ------ | ------ | ---- | ---------------- |
  | val    | number | 是   | 要写入的长整数值。<br/>取值范围：int64类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明  |
  | ------ | ------ | ---- | ----- |
  | val    | number | 是   | 要写入的双精度浮点值。<br/>取值范围：double类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型    | 必填 | 说明             |
  | ------ | ------- | ---- | ---------------- |
  | val    | boolean | 是   | 要写入的布尔值。<br/>取值范围：boolean类型取值范围。 |
...
**参数：**
  ...
  | 参数名 | 类型   | 必填 | 说明                 |
  | ------ | ------ | ---- | -------------------- |
  | val    | number | 是   | 要写入的单个字符值。<br/>取值范围：char类型取值范围。 |
