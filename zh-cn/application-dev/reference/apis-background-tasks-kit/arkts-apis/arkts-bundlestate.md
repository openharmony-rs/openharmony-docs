...
| [queryBundleActiveStates](arkts-backgroundtasks-bundlestate-querybundleactivestates-f-sys.md#queryBundleActiveStates（系统接口）) | Queries state data of all bundles within a specified period identified by the start and end time. |
...
| [queryBundleStateInfoByInterval](arkts-backgroundtasks-bundlestate-querybundlestateinfobyinterval-f-sys.md#queryBundleStateInfoByInterval（系统接口）) | Queries usage information about each bundle within a specified period at a specified interval. |
...
| [queryBundleStateInfos](arkts-backgroundtasks-bundlestate-querybundlestateinfos-f-sys.md#queryBundleStateInfos（系统接口）) | Queries usage information about each bundle within a specified period. This method queries usage information at the BY_OPTIMIZED interval by default. |
<!--DelEnd-->
