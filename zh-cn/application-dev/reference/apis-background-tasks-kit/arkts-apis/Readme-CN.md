...
- [@ohos.bundleState](arkts-bundlestate.md)
  ...
  - [queryBundleStateInfos(系统接口)](arkts-backgroundtasks-bundlestate-querybundlestateinfos-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryBundleStateInfoByInterval(系统接口)](arkts-backgroundtasks-bundlestate-querybundlestateinfobyinterval-f-sys.md)<!--DelEnd--><!--Del-->
...
- [@ohos.reminderAgentManager](arkts-reminderagentmanager.md)
  ...
  - [ActionButton(系统接口)](arkts-backgroundtasks-reminderagentmanager-actionbutton-i-sys.md)
  - [DataShareUpdate(系统接口)](arkts-backgroundtasks-reminderagentmanager-datashareupdate-i-sys.md)
  ...
  - [ReminderRequest(系统接口)](arkts-backgroundtasks-reminderagentmanager-reminderrequest-i-sys.md)
  ...
  - [ReminderRequestCalendar(系统接口)](arkts-backgroundtasks-reminderagentmanager-reminderrequestcalendar-i-sys.md)
  ...
  - [ActionButtonType(系统接口)](arkts-backgroundtasks-reminderagentmanager-actionbuttontype-e-sys.md)
...
- [@ohos.resourceschedule.backgroundTaskManager](arkts-resourceschedule-backgroundtaskmanager.md)
  ...
  - [obtainAllContinuousTasks(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-obtainallcontinuoustasks-f-sys.md)<!--DelEnd--><!--Del-->
  - [setBackgroundTaskState(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-setbackgroundtaskstate-f-sys.md)<!--DelEnd--><!--Del-->
  - [getBackgroundTaskState(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-getbackgroundtaskstate-f-sys.md)<!--DelEnd--><!--Del-->
  - [subscribeContinuousTaskState(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-subscribecontinuoustaskstate-f-sys.md)<!--DelEnd--><!--Del-->
  - [unsubscribeContinuousTaskState(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-unsubscribecontinuoustaskstate-f-sys.md)<!--DelEnd--><!--Del-->
  - [applyEfficiencyResources(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-applyefficiencyresources-f-sys.md)<!--DelEnd--><!--Del-->
  - [resetAllEfficiencyResources(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-resetallefficiencyresources-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [BackgroundTaskStateInfo(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-backgroundtaskstateinfo-i-sys.md)
  - [BackgroundTaskSubscriber(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-backgroundtasksubscriber-i-sys.md)
  ...
  - [EfficiencyResourcesInfo(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-efficiencyresourcesinfo-i-sys.md)
  - [EfficiencyResourcesRequest(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-efficiencyresourcesrequest-i-sys.md)
  ...
  - [BackgroundMode(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-backgroundmode-e-sys.md)
  ...
  - [BackgroundTaskMode(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-backgroundtaskmode-e-sys.md)
  ...
  - [EfficiencyResourcesCpuLevel(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-efficiencyresourcescpulevel-e-sys.md)
  - [ResourceType(系统接口)](arkts-backgroundtasks-backgroundtaskmanager-resourcetype-e-sys.md)
...
- [@ohos.resourceschedule.usageStatistics](arkts-resourceschedule-usagestatistics.md)<!--Del-->
  - [isIdleState(系统接口)](arkts-backgroundtasks-usagestatistics-isidlestate-f-sys.md)<!--DelEnd--><!--Del-->
  - [isIdleStateSync(系统接口)](arkts-backgroundtasks-usagestatistics-isidlestatesync-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryAppGroup(系统接口)](arkts-backgroundtasks-usagestatistics-queryappgroup-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryAppGroupSync(系统接口)](arkts-backgroundtasks-usagestatistics-queryappgroupsync-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryBundleStatsInfos(系统接口)](arkts-backgroundtasks-usagestatistics-querybundlestatsinfos-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryAppStatsInfos(系统接口)](arkts-backgroundtasks-usagestatistics-queryappstatsinfos-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryLastUseTime(系统接口)](arkts-backgroundtasks-usagestatistics-querylastusetime-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryBundleStatsInfoByInterval(系统接口)](arkts-backgroundtasks-usagestatistics-querybundlestatsinfobyinterval-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryBundleEvents(系统接口)](arkts-backgroundtasks-usagestatistics-querybundleevents-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryCurrentBundleEvents(系统接口)](arkts-backgroundtasks-usagestatistics-querycurrentbundleevents-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryModuleUsageRecords(系统接口)](arkts-backgroundtasks-usagestatistics-querymoduleusagerecords-f-sys.md)<!--DelEnd--><!--Del-->
  - [setAppGroup(系统接口)](arkts-backgroundtasks-usagestatistics-setappgroup-f-sys.md)<!--DelEnd--><!--Del-->
  - [registerAppGroupCallBack(系统接口)](arkts-backgroundtasks-usagestatistics-registerappgroupcallback-f-sys.md)<!--DelEnd--><!--Del-->
  - [unregisterAppGroupCallBack(系统接口)](arkts-backgroundtasks-usagestatistics-unregisterappgroupcallback-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryDeviceEventStats(系统接口)](arkts-backgroundtasks-usagestatistics-querydeviceeventstats-f-sys.md)<!--DelEnd--><!--Del-->
  - [queryNotificationEventStats(系统接口)](arkts-backgroundtasks-usagestatistics-querynotificationeventstats-f-sys.md)<!--DelEnd-->
  - [AppGroupCallbackInfo(系统接口)](arkts-backgroundtasks-usagestatistics-appgroupcallbackinfo-i-sys.md)
  - [BundleEvents(系统接口)](arkts-backgroundtasks-usagestatistics-bundleevents-i-sys.md)
  - [BundleStatsInfo(系统接口)](arkts-backgroundtasks-usagestatistics-bundlestatsinfo-i-sys.md)
  - [DeviceEventStats(系统接口)](arkts-backgroundtasks-usagestatistics-deviceeventstats-i-sys.md)
  - [HapFormInfo(系统接口)](arkts-backgroundtasks-usagestatistics-hapforminfo-i-sys.md)
  - [HapModuleInfo(系统接口)](arkts-backgroundtasks-usagestatistics-hapmoduleinfo-i-sys.md)
  - [AppStatsMap(系统接口)](arkts-backgroundtasks-usagestatistics-appstatsmap-t-sys.md)
  - [BundleStatsMap(系统接口)](arkts-backgroundtasks-usagestatistics-bundlestatsmap-t-sys.md)
  - [GroupType(系统接口)](arkts-backgroundtasks-usagestatistics-grouptype-e-sys.md)
  - [IntervalType(系统接口)](arkts-backgroundtasks-usagestatistics-intervaltype-e-sys.md)
...
- [WorkSchedulerExtensionContext](arkts-workschedulerextensioncontext.md)
  - [WorkSchedulerExtensionContext(系统接口)](arkts-backgroundtasks-workschedulerextensioncontext-c-sys.md)