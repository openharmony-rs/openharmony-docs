...
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。<br/>当设置成功，err为undefined；否则为错误对象。 |
...
| [10100001](../../errorcode-universal.md#10100001-Repeated) | Repeated operation on the application group. |
