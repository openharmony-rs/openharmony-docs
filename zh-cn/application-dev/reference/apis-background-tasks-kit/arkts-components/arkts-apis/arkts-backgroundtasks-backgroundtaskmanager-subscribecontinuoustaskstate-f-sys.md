...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscriber | [BackgroundTaskSubscriber](arkts-backgroundtasks-backgroundtaskmanager-backgroundtasksubscriber-i-sys.md) | 是 | 长时任务状态变化监听对象，包含长时任务开始，长时任务更新，长时任务结束的回调接口。 |
