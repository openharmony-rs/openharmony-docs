...
| 名称 | 描述 | 
| -------- | -------- |
| typedef enum [GamePad_AxisSourceType](capi-game-controller.md#gamepad_axissourcetype)[GameController](capi-game-controller.md#gamepad_axissourcetype) | 此枚举定义手柄轴事件来源类型。 | 
