...
| [getDeviceAdsorbState](arkts-mechanic-mechanicmanager-getdeviceadsorbstate-f-sys.md) | 获取对应的设备吸附状态 |
...
| [offBatteryLevelChange](arkts-mechanic-mechanicmanager-offbatterylevelchange-f-sys.md) | 取消订阅电池电量变化信息 |
...
| [onBatteryLevelChange](arkts-mechanic-mechanicmanager-onbatterylevelchange-f-sys.md) | 订阅目标设备的电池电量变化信息 |
...
| [BatteryLevelInfo](arkts-mechanic-mechanicmanager-batterylevelinfo-i-sys.md) | 设备电池电量信息 |
...
| [AdsorbState](arkts-mechanic-mechanicmanager-adsorbstate-e-sys.md) | 手机吸附状态 |
