...
2.调用[request](./js-apis-http.md#request)接口下载超过大小限制（API version 23之前限制为5MB，API version 23及之后的版本，限制为50MB）的数据，且未在[HttpRequestOptions](./js-apis-http.md#httprequestoptions)中设置maxLimit参数。
