...
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[InterfaceSharingStateInfo](arkts-network-sharing-interfacesharingstateinfo-i-sys.md)&gt; | 是 | 回调函数。指定网卡共享状态变化时调用。<br>**适用版本：** 11 |
...
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[NetHandle](arkts-network-sharing-nethandle-t.md)&gt; | 是 | 回调函数，上行网络变化时调用。 |
