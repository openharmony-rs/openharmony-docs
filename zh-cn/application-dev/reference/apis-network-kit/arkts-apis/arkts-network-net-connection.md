...
| 名称 | 说明 |
| --- | --- |
| [addCustomDnsRule](arkts-network-connection-addcustomdnsrule-f.md#addcustomdnsrule) | 为当前应用程序添加自定义host和对应的IP地址的映射。使用callback异步回调。 |
...
| [clearCustomDnsRules](arkts-network-connection-clearcustomdnsrules-f.md#clearcustomdnsrules) | 删除当前应用程序的所有的自定义DNS规则。使用callback异步回调。 |
...
| [getAddressesByName](arkts-network-connection-getaddressesbyname-f.md#getaddressesbyname) | 使用当前默认网络解析主机名以获取所有IP地址。使用callback异步回调。 |
...
| [getAllNets](arkts-network-connection-getallnets-f.md#getallnets) | 获取所有处于连接状态的网络列表，使用callback异步回调。 |
...
| [getAppNet](arkts-network-connection-getappnet-f.md#getappnet) | 获取App绑定的网络句柄。使用callback异步回调。 |
...
| [getConnectionProperties](arkts-network-connection-getconnectionproperties-f.md#getconnectionproperties) | 获取netHandle对应的网络的连接信息，包含网卡名称、域名、链路信息、路由信息、网络地址及最大传输单元。使用callback异步回调。 |
...
| [getDefaultHttpProxy](arkts-network-connection-getdefaulthttpproxy-f.md#getdefaulthttpproxy) | 获取网络的默认代理配置信息。使用callback异步回调。 |
| [getDefaultHttpProxy](arkts-network-connection-getdefaulthttpproxy-f.md#getdefaulthttpproxy-1) | 获取网络默认的代理配置信息。使用Promise异步回调。 |
| [getDefaultNet](arkts-network-connection-getdefaultnet-f.md#getdefaultnet) | 获取系统默认使用的网络句柄，包含网络ID。使用callback异步回调。 |
...
| [getNetCapabilities](arkts-network-connection-getnetcapabilities-f.md#getnetcapabilities) | 获取netHandle对应网络的能力集，包含上/下行带宽、网络具体能力、网络类型。使用callback异步回调。 |
...
| [hasDefaultNet](arkts-network-connection-hasdefaultnet-f.md#hasdefaultnet) | 获取当前是否有可用网络，使用callback异步回调。如果有可用网络，可以使用[getDefaultNet](arkts-network-connection-getdefaultnet-f.md)获取默认网络句柄。 |
...
| [isDefaultNetMetered](arkts-network-connection-isdefaultnetmetered-f.md#isdefaultnetmetered) | 检查当前默认网络上的数据流量使用是否被计费（例如：WiFi网络不会被计费，蜂窝网络会被计费）。使用callback异步回调。 |
...
| [removeCustomDnsRule](arkts-network-connection-removecustomdnsrule-f.md#removecustomdnsrule) | 删除当前应用程序中对应host的自定义DNS规则。使用callback异步回调。 |
...
| [reportNetConnected](arkts-network-connection-reportnetconnected-f.md#reportnetconnected) | 向网络管理上报网络处于可用状态。使用callback方式异步回调。 |
| [reportNetConnected](arkts-network-connection-reportnetconnected-f.md#reportnetconnected-1) | 向网络管理报告网络处于可用状态。使用Promise异步回调。 |
| [reportNetDisconnected](arkts-network-connection-reportnetdisconnected-f.md#reportnetdisconnected) | 向网络管理上报网络处于不可用状态。使用callback异步回调。 |
...
| [setAppNet](arkts-network-connection-setappnet-f.md#setappnet) | 将App绑定到特定的网络，绑定后App只能通过netHandle对应的网络访问网络。使用callback异步回调。 |
...
| [disableAirplaneMode](arkts-network-connection-disableairplanemode-f-sys.md#disableairplanemode) | 关闭飞行模式，使用callback异步回调。 |
| [disableAirplaneMode](arkts-network-connection-disableairplanemode-f-sys.md#disableairplanemode-1) | 关闭飞行模式，使用Promise异步回调。 |
| [enableAirplaneMode](arkts-network-connection-enableairplanemode-f-sys.md#enableairplanemode) | 开启飞行模式，使用callback异步回调。 |
...
| [getGlobalHttpProxy](arkts-network-connection-getglobalhttpproxy-f-sys.md#getglobalhttpproxy) | 获取网络的全局代理配置信息，使用callback异步回调。 |
...
| [setGlobalHttpProxy](arkts-network-connection-setglobalhttpproxy-f-sys.md#setglobalhttpproxy) | 设置网络全局Http代理配置信息，使用callback异步回调。 |
