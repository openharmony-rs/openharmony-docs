...
|FUNC|u_errorName|
|FUNC|u_charAge|
|FUNC|u_getUnicodeVersion|
|FUNC|uldn_open|
|FUNC|uldn_close|
|FUNC|uldn_getLocale|
|FUNC|uldn_getDialectHandling|
|FUNC|uldn_localeDisplayName|
|FUNC|uldn_languageDisplayName|
|FUNC|uldn_scriptDisplayName|
|FUNC|uldn_scriptCodeDisplayName|
|FUNC|uldn_regionDisplayName|
|FUNC|uldn_variantDisplayName|
|FUNC|uldn_keyDisplayName|
|FUNC|uldn_keyValueDisplayName|
|FUNC|uldn_openForContext|
|FUNC|uldn_getContext|
|FUNC|ulocdata_getCLDRVersion|
|FUNC|u_versionFromString|
|FUNC|u_versionFromUString|
|FUNC|u_versionToString|
|FUNC|u_getVersion|
|FUNC|utf8_back1SafeBody|
|FUNC|utf8_prevCharSafeBody|