...
ArkTS-DT: getBytesNumberPerRow(): number

ArkTS-ST: getBytesNumberPerRow(): int
...
| 类型   | 说明                 |
| ------ | -------------------- |
| ArkTS-DT: number<br>ArkTS-ST: int | 图像像素的行字节数。 |
...
ArkTS-DT: getPixelBytesNumber(): number

ArkTS-ST: getPixelBytesNumber(): int
...
| 类型   | 说明                 |
| ------ | -------------------- |
| ArkTS-DT: number<br>ArkTS-ST: int | 图像像素的总字节数。 |
...
ArkTS-DT: getDensity(): number

ArkTS-ST: getDensity(): int
...
| 类型   | 说明            |
| ------ | --------------- |
| ArkTS-DT: number<br>ArkTS-ST: int | 图像像素的密度，单位为ppi。|
...
ArkTS-DT: opacity(rate: number, callback: AsyncCallback\<void>): void

ArkTS-ST: opacity(rate: double, callback: AsyncCallback\<void>): void
...
| 参数名   | 类型                 | 必填 | 说明                           |
| -------- | -------------------- | ---- | ------------------------------ |
| rate     | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 透明比率的值，取值范围是(0,1]。  |
...
ArkTS-DT: opacity(rate: number): Promise\<void>

ArkTS-ST: opacity(rate: double): Promise\<void>
...
ArkTS-DT: opacitySync(rate: number): void

ArkTS-ST: opacitySync(rate: double): void
...
ArkTS-DT: scale(x: number, y: number, callback: AsyncCallback\<void>): void

ArkTS-ST: scale(x: double, y: double, callback: AsyncCallback\<void>): void
...
| 参数名   | 类型                 | 必填 | 说明                            |
| -------- | -------------------- | ---- | ------------------------------- |
| x        | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 宽度的缩放倍数。|
| y        | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 高度的缩放倍数。|
...
ArkTS-DT: scale(x: number, y: number): Promise\<void>

ArkTS-ST: scale(x: double, y: double): Promise\<void>
...
ArkTS-DT: scaleSync(x: number, y: number): void

ArkTS-ST: scaleSync(x: double, y: double): void
...
ArkTS-DT: scale(x: number, y: number, level: AntiAliasingLevel): Promise\<void>

ArkTS-ST: scale(x: double, y: double, level: AntiAliasingLevel): Promise\<void>
...
ArkTS-DT: scaleSync(x: number, y: number, level: AntiAliasingLevel): void

ArkTS-ST: scaleSync(x: double, y: double, level: AntiAliasingLevel): void
...
ArkTS-DT: createScaledPixelMap(x: number, y: number, level?: AntiAliasingLevel): Promise\<PixelMap>

ArkTS-ST: createScaledPixelMap(x: double, y: double, level?: AntiAliasingLevel): Promise\<PixelMap>
...
ArkTS-DT: createScaledPixelMapSync(x: number, y: number, level?: AntiAliasingLevel): PixelMap

ArkTS-ST: createScaledPixelMapSync(x: double, y: double, level?: AntiAliasingLevel): PixelMap
...
ArkTS-DT: translate(x: number, y: number, callback: AsyncCallback\<void>): void

ArkTS-ST: translate(x: double, y: double, callback: AsyncCallback\<void>): void
...
| 参数名   | 类型                 | 必填 | 说明                          |
| -------- | -------------------- | ---- | ----------------------------- |
| x        | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 区域横坐标。单位：像素。 |
| y        | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 区域纵坐标。单位：像素。 |
...
ArkTS-DT: translate(x: number, y: number): Promise\<void>

ArkTS-ST: translate(x: double, y: double): Promise\<void>
...
ArkTS-DT: translateSync(x: number, y: number): void

ArkTS-ST: translateSync(x: double, y: double): void
...
ArkTS-DT: rotate(angle: number, callback: AsyncCallback\<void>): void

ArkTS-ST: rotate(angle: double, callback: AsyncCallback\<void>): void
...
| 参数名   | 类型                 | 必填 | 说明                          |
| -------- | -------------------- | ---- | ----------------------------- |
| angle    | ArkTS-DT: number<br>ArkTS-ST: double | 是   | 图片旋转的角度。 |
...
ArkTS-DT: rotate(angle: number): Promise\<void>

ArkTS-ST: rotate(angle: double): Promise\<void>
...
ArkTS-DT: rotateSync(angle: number): void

ArkTS-ST: rotateSync(angle: double): void
