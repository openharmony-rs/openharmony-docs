...
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* sourceImage | 指向输入图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* destinationImage | 指向输出图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
...
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* sourceImage | 指向输入图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* sourceGainmap | 指向输入Gainmap的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* destinationImage | 指向输出图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
...
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* sourceImage | 指向输入图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* destinationImage | 指向输出图片的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
| [OH_PixelmapNative](capi-image-nativemodule-oh-pixelmapnative.md)* destinationGainmap | 指向输出Gainmap的指针，指向的OH_PixelmapNative需为[DMA内存](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
