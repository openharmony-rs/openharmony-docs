...
- 头文件<!--imagekit-headerfile-->
    ...
    - [image_packer_native.h（系统接口）](capi-image-packer-native-h-sys.md)
    - [picture_native.h](capi-picture-native-h.md)
    - [picture_native.h（系统接口）](capi-picture-native-h-sys.md)
    - [image_native.h](capi-image-native-h.md)
    - [image_common.h](capi-image-common-h.md)
    - [image_common.h（系统接口）](capi-image-common-h-sys.md)
    - [image_source_native.h](capi-image-source-native-h.md)
    - [image_source_native.h（系统接口）](capi-image-source-native-h-sys.md)
...
- 结构体<!--imagekit-struct-->
    ...
    - [OH_DecomposeOptions（系统接口）](capi-image-nativemodule-oh-decomposeoptions-sys.md)
