...
| capacity<sup>9+</sup> | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 是   | 否   | 同时访问的图像数。该参数仅作为期望值，实际capacity由设备硬件决定。<br/>**ArkTS-Dyn起始版本：** 9<br/>**ArkTS-Sta起始版本：** 20 |
