...
目前，更推荐使用[image.createImageReceiver](arkts-apis-image-f.md#imagecreateimagereceiver23)，通过传入[ImageReceiverOptions](arkts-apis-image-i.md#imagereceiveroptions23)创建ImageReceiver实例。
