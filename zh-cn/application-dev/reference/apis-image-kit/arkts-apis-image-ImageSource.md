...
> 
> - 调用modifyImageProperty接口修改Exif字时，必须确保对应的图片文件有写的权限，否则会导致字段修改不成功。
...
> - 调用modifyImageProperties接口修改Exif字段时，必须确保对应的图片文件有写的权限，否则会导致字段修改不成功。
...
> - 调用modifyImagePropertiesEnhanced接口修改Exif字段时，必须确保对应的图片文件有写的权限，否则会导致字段修改不成功。
...
> - 调用writeImageMetadata接口修改Exif字段时，必须确保对应的图片文件有写的权限，否则会导致字段修改不成功。
