...
|  参数名 | 类型  | 必填  | 说明  |
| :------------ | :------------ | :------------ | :------------ |
|  sourceImage | [image.PixelMap](arkts-apis-image-PixelMap.md)  | 是  | 输入图像，内存类型需为DMA内存，具体情况请参考[PixelMap的内存类型介绍](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。 |
...
|  参数名 | 类型  | 必填  | 说明  |
| :------------ | :------------ | :------------ | :------------ |
|  sourceImage | [image.PixelMap](arkts-apis-image-PixelMap.md)  | 是  | 输入图像，内存类型需为[DMA](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/media/image/image-allocator-type.md#%E5%86%85%E5%AD%98%E7%B1%BB%E5%9E%8B%E4%BB%8B%E7%BB%8D)。  |
