...
| pixelXDimension                     | ArkTS-Dyn: number<br>ArkTS-Sta: int                                              | 否   | 是   | 图像在X轴上的（二维坐标系中的Horizontal Axis）尺寸。           |
| pixelYDimension                     | ArkTS-Dyn: number<br>ArkTS-Sta: int                                              | 否   | 是   | 图像在Y轴上的（二维坐标系中的Vertical Axis）尺寸。             |
...
| focalLengthIn35mmFilm               | ArkTS-Dyn: number<br>ArkTS-Sta: int                                              | 否   | 是   | 35mm胶片的焦距。                                             |
