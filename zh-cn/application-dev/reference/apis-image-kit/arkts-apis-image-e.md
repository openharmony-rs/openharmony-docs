...
| ALPHA_U8 | 15 | 颜色信息仅包含透明度（Alpha）。<br>每个像素占8位。所有像素紧密排列，不进行对齐。<br>**起始版本：** 26.0.0<br>**原子化服务API：** 从API版本26.0.0开始，该接口支持在原子化服务中使用。 <br>**卡片能力：** 从API版本26.0.0开始，该接口支持在ArkTS卡片中使用。  |
