...
| XTSTYLE_TEMPLATE_NAME | 'HwMnoteXtStyleTemplateName' | XTstyle模板名称。<br />**读写能力：** 只读。<br>**起始版本：** 26.0.0<br>**模型约束：** 此接口仅可在Stage模型下使用。 | _ |
| XTSTYLE_CUSTOM_LIGHT_AND_SHADOW | 'HwMnoteXtStyleCustomLightAndShadow' | XTstyle自定义光影。<br />**读写能力：** 只读。<br>**起始版本：** 26.0.0<br>**模型约束：** 此接口仅可在Stage模型下使用。 | _ |
| XTSTYLE_CUSTOM_SATURATION | 'HwMnoteXtStyleCustomSaturation' | XTstyle自定义饱和度。<br />**读写能力：** 只读。<br>**起始版本：** 26.0.0<br>**模型约束：** 此接口仅可在Stage模型下使用。 | _ |
| XTSTYLE_CUSTOM_HUE | 'HwMnoteXtStyleCustomHue' | XTstyle自定义色调。<br />**读写能力：** 只读。<br>**起始版本：** 26.0.0<br>**模型约束：** 此接口仅可在Stage模型下使用。 | _ |
| XTSTYLE_EXPOSURE_PARAM | 'HwMnoteXtStyleExposureParam' | XTstyle曝光参数。<br />**读写能力：** 只读。<br>**起始版本：** 26.0.0<br>**模型约束：** 此接口仅可在Stage模型下使用。 | _ |
