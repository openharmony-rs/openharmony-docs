...
true表示图片为高动态范围（HDR），false表示图片非高动态范围（SDR）。对于[ImageSource]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，代表源图片是否为HDR；对于 [PixelMap]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_，代表解码后的PixelMap是否为HDR。
...
图片真实格式（MIME type）。 图片解码和图片编码支持格式的范围不同，请避免直接将解码得到的图片真实格式作为图片编码时[PackingOption]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_的format。 可以使用ImageSource\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中的supportedFormats和 ImagePacker\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_中的supportedFormats查看解码和编码支持 的格式范围。
