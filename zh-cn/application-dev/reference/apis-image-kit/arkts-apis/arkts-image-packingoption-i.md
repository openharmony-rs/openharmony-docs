...
目标格式。</br>- 当[输入为ImageSource或PixelMap](../../../../media/image/image-encoding.md)时，支持"image/jpeg"、"image/webp"、"
...
[packToDataFromPixelmapSequence](arkts-image-imagepacker-i.md#packtodatafrompixelmapsequence-1)或
[packToFileFromPixelmapSequence](arkts-image-imagepacker-i.md#packtofilefrompixelmapsequence-1)接口进行编码。
