...
> **说明：**
>
> 从API version 8开始支持，从 API Version 9 开始废弃，建议使用[FaultLogger.query](#faultloggerquery9)替代。
...
> **说明：**
>
> 从API version 8开始支持，从 API Version 9 开始废弃，建议使用[FaultLogger.query](#faultloggerquery9-1)替代。
