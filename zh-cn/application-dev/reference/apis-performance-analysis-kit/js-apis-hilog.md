...
| PRIVATE_SANDBOX_ONLY | 1 | hilog落盘至仅自己可访问的沙箱内。 |
| SHARE_SANDBOX_ONLY | 2 | hilog落盘至沙箱，该沙箱可被自己和系统进程访问。 |
...
设置hilog的输出类型，可配置输出领域，以及领域的生效方式。
...
控制台输出。
```text
05-15 16:57:04.238  40518-40518  A00001/testTag  com.example.hilogDemo  I  last output type:3
```
