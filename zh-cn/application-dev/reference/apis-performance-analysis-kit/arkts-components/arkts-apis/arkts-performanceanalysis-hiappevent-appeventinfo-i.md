...
事件参数对象，包含每个事件参数的参数名和参数值。**系统事件中params包含的字段已由各系统事件定义，具体字段含义在各类系统事件指南的介绍中，例如[崩溃事件介绍](../../../dfx/hiappevent-watcher-crash-events.md)。** 针对应用事件，[Write](arkts-performanceanalysis-hiappevent-write-f.md)打点写入的参数由开发者定义，其规格如下：
