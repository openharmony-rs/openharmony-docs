...
> **注意**：
>
> 由于读取/proc/{pid}/smaps_rollup耗时较长，推荐使用异步接口[hidebug.getAppNativeMemInfoAsync](#hidebuggetappnativememinfoasync20)，以避免应用丢帧或卡顿。如果需要改接口获取应用的rss使用信息，推荐使用[hidebug.getRssInfo](#hidebuggetrssinfo)接口。
