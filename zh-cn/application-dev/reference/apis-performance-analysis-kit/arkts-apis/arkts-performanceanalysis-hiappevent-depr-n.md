...
| 名称 | 说明 |
| --- | --- |
| [ConfigOption(应用事件打点)](arkts-performanceanalysis-hiappevent-configoption-depr-i.md) | 此接口提供了应用打点的配置选项。 |

### 枚举

| 名称 | 说明 |
| --- | --- |
| [EventType(应用事件打点)](arkts-performanceanalysis-hiappevent-eventtype-depr-e.md) | 事件类型枚举。 |
