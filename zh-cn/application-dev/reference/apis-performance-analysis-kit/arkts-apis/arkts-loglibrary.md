...
| [copy](arkts-performanceanalysis-loglibrary-copy-f-sys.md#copy系统接口) | 拷贝指定日志类型的指定文件到目标应用目录下。使用callback回调。 |
...
| [move](arkts-performanceanalysis-loglibrary-move-f-sys.md#move系统接口) | 移动指定日志类型的指定文件到目标应用目录下。使用callback回调。 |
