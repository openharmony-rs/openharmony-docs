...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | ------ | -- | ---- | ------- |
| userType | string | 否 | 是 | 用户类型参数值由开发者自定义，无格式和字符类型限制，最长支持128个字符，超过将截断。 |
| deviceType | string | 否 | 是 | 设备类型参数值由开发者自定义，无格式和字符类型限制，最长支持128个字符，超过将截断。 |
| deviceModel | string | 否 | 是 | 设备型号参数值由开发者自定义，无格式和字符类型限制，最长支持128个字符，超过将截断。 |
