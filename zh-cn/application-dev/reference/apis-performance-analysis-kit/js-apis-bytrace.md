...
## bytrace.startTrace<sup>(deprecated)</sup>

从API version 7开始支持，从API version 8开始废弃。建议使用[@ohos.hiTraceMeter](js-apis-hitracemeter.md)替代。
...
## bytrace.finishTrace<sup>(deprecated)</sup>
...
## bytrace.traceByValue<sup>(deprecated)</sup>
