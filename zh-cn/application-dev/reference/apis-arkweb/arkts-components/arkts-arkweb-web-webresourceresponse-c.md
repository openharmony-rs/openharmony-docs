...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<Header> | 返回资源响应头。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| header | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<Header> | 是 | 要设置的资源响应头。 |
