...
| 类型 | 说明 |
| --- | --- |
| [MessageLevel](arkts-arkweb-web-comp-messagelevel-e.md) | 返回ConsoleMessage的信息级别。 |
...
| 类型 | 说明 |
| --- | --- |
| [ConsoleMessageSource](arkts-arkweb-web-comp-consolemessagesource-e.md) | 返回ConsoleMessage的日志来源。 |
