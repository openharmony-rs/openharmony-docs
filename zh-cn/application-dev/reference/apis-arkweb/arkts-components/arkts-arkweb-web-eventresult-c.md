...
通知Web组件同层事件消费结果，支持的事件：[触摸事件的类型](../../apis-arkui/arkts-apis/arkts-arkui-enums-touchtype-e.md)和[鼠标事件的类型](../../apis-arkui/arkts-apis/arkts-arkui-enums-mouseaction-e.md)，鼠标仅支持[左中右按键](../../apis-arkui/arkts-apis/arkts-arkui-enums-mousebutton-e.md)。
