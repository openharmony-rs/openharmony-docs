...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | @syscap SystemCapability.Web.Webview.Core@crossplatform |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resources | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | List of resources that can be requested by the web page with the permission to |
