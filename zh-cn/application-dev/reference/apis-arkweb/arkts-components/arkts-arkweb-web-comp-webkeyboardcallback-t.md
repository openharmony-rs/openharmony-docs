...
| 类型 | 说明 |
| --- | --- |
| [WebKeyboardOptions](arkts-arkweb-web-comp-webkeyboardoptions-i.md) | 回调函数通过返回[WebKeyboardOptions](arkts-arkweb-web-comp-webkeyboardoptions-i.md)来决定ArkWeb内核拉起不同类型的软键盘。 |
