...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuDataMediaType](arkts-arkweb-web-comp-contextmenudatamediatype-e.md) | 网页元素的媒体类型，包括图片、视频、音频等不同类型，用于区分用户点击的网页元素种类。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 获取网页元素可编辑标识，参照[ContextMenuEditStateFlags](arkts-arkweb-web-comp-contextmenueditstateflags-e.md)。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuInputFieldType](arkts-arkweb-web-comp-contextmenuinputfieldtype-e.md) | 网页元素输入框的类型，包括文本框、密码框、邮箱框等不同类型，用于识别当前焦点所在的输入元素种类。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuMediaType](arkts-arkweb-web-comp-contextmenumediatype-e.md) | 网页元素媒体类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuSourceType](arkts-arkweb-web-comp-contextmenusourcetype-e.md) | 菜单事件的触发来源类型，包括鼠标右键、长按等不同的触发方式。 |
