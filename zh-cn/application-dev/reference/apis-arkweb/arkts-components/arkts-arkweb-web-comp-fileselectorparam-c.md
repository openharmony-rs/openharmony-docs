...
| 类型 | 说明 |
| --- | --- |
| Array&lt;Array&lt;[AcceptableFileType](arkts-arkweb-web-comp-acceptablefiletype-i.md)&gt;&gt; | 返回文件类型信息，为二维数组结构，包含多组可选文件类型的详细信息。对应HTML option的types属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [FileSelectorMode](arkts-arkweb-web-comp-fileselectormode-e.md) | 返回文件选择器的模式。 |
