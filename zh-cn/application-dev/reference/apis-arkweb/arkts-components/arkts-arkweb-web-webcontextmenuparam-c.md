...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuDataMediaType](arkts-arkweb-web-contextmenudatamediatype-e.md) | 返回上下文节点的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuInputFieldType](arkts-arkweb-web-contextmenuinputfieldtype-e.md) | 输入框上触发菜单时返回输入框类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuMediaType](arkts-arkweb-web-contextmenumediatype-e.md) | 返回上下文节点的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [ContextMenuSourceType](arkts-arkweb-web-contextmenusourcetype-e.md) | @syscap SystemCapability.Web.Webview.Core@atomicservice |
