...
控制器，通过controller可以控制Web组件各种行为，包括页面导航、生命周期状态、JavaScript交互等。从API version 9开始，WebController不再维护，建议使用[WebviewController](arkts-arkweb-web-comp-webviewcontroller-t.md)替代。

**类型：** [WebController](arkts-arkweb-web-comp-webcontroller-c.md) &#124; [WebviewController](arkts-arkweb-web-comp-webviewcontroller-t.md)
...
**类型：** [RenderMode](arkts-arkweb-web-comp-rendermode-e.md)
