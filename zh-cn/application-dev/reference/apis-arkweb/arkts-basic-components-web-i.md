...
| 名称             | 类型      | 只读 | 可选 | 说明                                       |
| -------------- | ---- | ---- | ---- | ---------------------------------------- |
| xOffset | ArkTS-Dyn: number<br>ArkTS-Sta: double |  否   | 否   | 以网页最左端为基准，水平滚动条滚动所在位置。正值表示向右滚动，负值表示向左滚动。<br>单位：vp。 |
| yOffset | ArkTS-Dyn: number<br>ArkTS-Sta: double |  否   | 否   | 以网页最上端为基准，竖直滚动条滚动所在位置。正值表示向下滚动，负值表示向上滚动。<br>单位：vp。 |
