...
| 类型           | 说明          |
| --------------| ------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double \| long | 返回runJavaScriptExt接口脚本执行后得到的数值类型的数据。 |
...
| 类型           | 说明          |
| --------------| ------------- |
| ArkTS-Dyn: Array\<string \| number \| boolean\><br>ArkTS-Sta: Array\<string \| double \| long \| boolean\> | 返回runJavaScriptExt接口脚本执行后得到的数组类型的数据。 |
