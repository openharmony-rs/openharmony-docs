...
ArkTS-Dyn: constructor(message: string, sourceId: string, lineNumber: number, messageLevel: MessageLevel)

ArkTS-Sta: constructor(message: string, sourceId: string, lineNumber: int, messageLevel: MessageLevel)
