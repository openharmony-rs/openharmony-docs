...
| 名称        | 类型   | 只读 | 可选 |说明                 |
| ----------- | ------ | -----|------|------------------- |
| width                 | number  | 否 | 否   | 页面宽度。<br>取值范围：大于等于0。如果不在取值范围内，则设置为0。<br>单位：英寸。<br>推荐值：A4纸页面宽度8.27英寸。   |
| height                | number  | 否 | 否   | 页面高度。<br>取值范围：大于等于0。如果不在取值范围内，则设置为0。<br>单位：英寸。<br>推荐值：A4纸页面高度11.69英寸。  |
