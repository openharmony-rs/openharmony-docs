...
文件选择器的模式，用于控制文件选择器的打开方式和行为，帮助开发者实现单文件上传、多文件上传、文件夹选择和文件保存等多种文件操作场景。
...
| 名称       | 值 | 说明         |
| --------- | -- |------------ |
| ArkTS-Dyn: None<br/>ArkTS-Sta: NONE      | 0 | 其他事件来源，非鼠标或长按触发的上下文菜单事件来源。 |
...
| 名称    | 值 | 说明            |
| ----- | -- | ------------- |
| ArkTS-Dyn: None<br/>ArkTS-Sta: NONE  | 0 | 其他非图片媒体类型，包括视频、音频、canvas等其他网页元素类型。 |
...
| 名称        | 值 | 说明                          |
| --------- | -- | --------------------------- |
| ArkTS-Dyn: None<br/>ArkTS-Sta: NONE      | 0 | 非输入框，指不可编辑的网页元素，如按钮、div、span等普通HTML元素。                       |
...
| ArkTS-Dyn: Other<br/>ArkTS-Sta: OTHER     | 5 | 其他类型，包括日期选择器、颜色选择器、范围滑块等非纯文本、非密码、非数字、非电话号码类型的输入框。                       |
...
支持的AI会话类型，用于定义WebView集成的AI功能种类，帮助开发者在网页中提供翻译、语言检测、内容摘要、写作助手等智能服务，提升网页的智能化水平和用户体验。
...
AI会话操作的结果状态，用于标识AI功能的执行进度和结果，帮助开发者根据状态更新UI和进行错误处理，提供流畅的用户交互体验。
