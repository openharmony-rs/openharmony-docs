...
| [int32_t OH_ArkWebErrorInfo_SetCustomErrorCode(ArkWeb_ErrorInfo* errorInfo, int32_t errorCode)](#oh_arkweberrorinfo_setcustomerrorcode) | - | 设置自定义错误码。Web引擎将通过以下方式将自定义错误代码直接传递给应用程序onErrorReceive. |
...
设置自定义错误码。Web引擎将通过以下方式将自定义错误代码直接传递给应用程序onErrorReceive.
