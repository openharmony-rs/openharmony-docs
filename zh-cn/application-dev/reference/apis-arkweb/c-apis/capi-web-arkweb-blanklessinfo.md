...
| 名称 | 描述 |
| -- | -- |
| [ArkWeb_BlanklessErrorCode](capi-arkweb-error-code-h.md#arkweb_blanklesserrorcode) errCode | 无白屏加载的错误码，取值为0表示无错误，非0值表示错误类型，见[ArkWeb_BlanklessErrorCode](capi-arkweb-error-code-h.md#arkweb_blanklesserrorcode)定义。 |
