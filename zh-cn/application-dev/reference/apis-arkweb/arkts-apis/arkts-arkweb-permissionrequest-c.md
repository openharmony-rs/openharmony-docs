...
| 类型 | 说明 |
| --- | --- |
| Array&lt;string&gt; | @syscap SystemCapability.Web.Webview.Core<br/>@crossplatform [since 11]<br/>@atomicservice [since 11] |
...
| 类型 | 说明 |
| --- | --- |
| string | @syscap SystemCapability.Web.Webview.Core<br/>@crossplatform [since 11]<br/>@atomicservice [since 11] |
