...
| 类型 | 说明 |
| --- | --- |
| number | @syscap SystemCapability.Web.Webview.Core<br/>@atomicservice [since 11] |
...
| 类型 | 说明 |
| --- | --- |
| ContextMenuSourceType | @syscap SystemCapability.Web.Webview.Core<br/>@atomicservice [since 11] |
...
| 类型 | 说明 |
| --- | --- |
| boolean | @syscap SystemCapability.Web.Webview.Core<br/>@atomicservice [since 11] |
...
| 类型 | 说明 |
| --- | --- |
| number | 上下文菜单X坐标。<br/>正常情况下返回非负整数，否则返回 -1。<br/>单位：像素。 |
...
| 类型 | 说明 |
| --- | --- |
| number | 上下文菜单Y坐标。<br/>正常情况下返回非负整数，否则返回 -1。<br/>单位：像素。 |
