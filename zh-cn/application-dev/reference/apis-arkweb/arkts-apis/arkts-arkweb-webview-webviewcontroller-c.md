...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| hostList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | 绕过智能防跟踪功能的域名列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cacheKeyList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | 用于后续查询预获取资源缓存的key。仅支持字母和数字，未传入或传入空则取默认值url作为key。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebMessagePort> | web消息端口列表。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| schemes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebCustomScheme> | 是 | 自定义协议配置，最多支持同时配置10个自定义协议。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| resourceMaps | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<OfflineResourceMap> | 是 | 本地离线资源配置对象，单次调用最大支持注入30个资源，单个资源最大支持10Mb。 |
...
| headers | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。<br>默认值： []。 <br>传入undefined或null会抛出异常错误码401。 |
...
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-common-callback-i.md)<ControllerAttachState> | 否 | Callback used to return the controller attach state. |
...
| --- | --- | --- | --- |
| type | 'controllerAttachStateChange' | 是 | the event of controller attach state change. |
| callback | [Callback](../../apis-arkui/arkts-components/arkts-arkui-common-callback-i.md)<ControllerAttachState> | 是 | Callback used to return the controller attach state. |
...
| ports | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebMessagePort> | 是 | 要发送的消息端口。 |
...
| postData | [ArrayBuffer](../../apis-arkts/arkts-apis/arkts-arkts-collections-arraybuffer-c.md) | 是 | 使用"POST"方法传递数据。 |
...
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。 |
...
| --- | --- | --- | --- |
| url | string | 是 | 预加载的URL。 |
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebHeader> | 否 | URL的附加HTTP请求头。<br>默认值： [] |
...
| additionalHeaders | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<WebHeader> | 否 | 预获取请求的附加HTTP请求头。 <br>传入undefined或null会抛出异常错误码401。 |
...
| methodList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | The method of the application side JavaScript object participating in the registration. |
| asyncMethodList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 否 | The async method of the application side JavaScript object participating in the registration.<br>**起始版本：** 12 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-uint8array-c.md) | 是 | 页面状态历史记录序列化数据。 |
...
| 类型 | 说明 |
| --- | --- |
| [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-uint8array-c.md) | Web access stack after serialization. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathList | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | 路径列表 |
...
| --- | --- | --- | --- |
| userAgent | string | 是 | The User-Agent string. |
| hosts | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | The hosts to which the User-Agent apply. |
...
当没有指定端口port时，该接口等同于[setWebDebuggingAccess](arkts-arkweb-webview-webviewcontroller-c.md#setwebdebuggingaccess-1)接口，ArkWeb会启动一个本地domain socket监听。当指定了端口port时，ArkWeb会启动一个tcp socket监听。这时可以无线调试网页。
