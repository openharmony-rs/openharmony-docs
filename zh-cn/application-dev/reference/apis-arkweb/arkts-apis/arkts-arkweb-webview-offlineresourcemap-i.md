...
本地离线资源配置对象，用于配置将被[injectOfflineResources]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口注入到内存缓存的本地离线资源的相关信息，内核会根据此信息生成资源缓存，并据此控制缓存的有效期。
