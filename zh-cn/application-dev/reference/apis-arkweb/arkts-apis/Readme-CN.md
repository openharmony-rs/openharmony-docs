...
- [@ohos.web.netErrorList(网络协议栈错误列表)](arkts-arkweb-web-neterrorlist.md)
  - [WebNetErrorList](arkts-arkweb-web-neterrorlist-webneterrorlist-e.md)
- [@ohos.web.WebNativeMessagingExtensionAbility(Web原生消息扩展能力)](arkts-arkweb-web-webnativemessagingextensionability.md)
...
- [@ohos.web.WebNativeMessagingExtensionContext(Web原生消息扩展上下文)](arkts-arkweb-web-webnativemessagingextensioncontext.md)
...
- [@ohos.web.webNativeMessagingExtensionManager(Web原生消息扩展管理模块)](arkts-arkweb-web-webnativemessagingextensionmanager.md)
