...
| unsigned int operationMode | 授予或激活权限的URI访问模式。READ_MODE表示读取权限，WRITE_MODE表示写入权限。 示例：FileShare_OperationMode.READ_MODE、FileShare_OperationMode.WRITE_MODE。 或者FileShare_OperationMode.READ_MODE\|FileShare_OperationMode.WRITE_MODE。 |
