...
| bool canSwapIn | 该key是否可被换入。<br> 如果key的[OH_SwapfsKeyStatus](capi-oh-swapfs-h.md#oh_swapfskeystatus)状态处于OH_SWAPFS_KEY_STATUS_REMOVING则为false，若key活跃未被清理则为true。<br>**起始版本：** 26.0.0 |
