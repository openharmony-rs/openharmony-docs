...
**替代接口：** [@ohos.file.fs:access](arkts-corefile-file-file-depr-c.md#access)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 接口选项。 |
...
**替代接口：** [@ohos.file.fs:mkdir](arkts-corefile-file-file-depr-c.md#mkdir)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 文件过滤选项。默认不进行过滤。 |
...
**替代接口：** [@ohos.file.fs:readText](arkts-corefile-file-file-depr-c.md#readtext)
...
**替代接口：** [@ohos.file.fs:rmdir](arkts-corefile-file-file-depr-c.md#rmdir)
