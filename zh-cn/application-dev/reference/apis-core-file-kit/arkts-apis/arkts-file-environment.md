...
| [getStorageDataDir](arkts-corefile-environment-getstoragedatadir-f-sys.md#getStorageDataDir（系统接口）) | 异步方法获取内存存储根目录，使用callback异步回调。 |
| [getUserDataDir](arkts-corefile-environment-getuserdatadir-f-sys.md#getUserDataDir) | 异步方法获取公共文件根目录，使用promise异步回调。 |
| [getUserDataDir](arkts-corefile-environment-getuserdatadir-f-sys.md#getUserDataDir（系统接口）) | 异步方法获取公共文件根目录，使用callback异步回调。 |
