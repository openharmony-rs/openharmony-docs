...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| remoteCapabilitiesFd | ArkTS-Dyn: number  \_\_\_HTML\_TAG\_USD\_0\_\_\_ArkTS-Sta：int | 是 | 保存远端设备能力信息的已打开JSON文件描述符。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;FileData&gt; | Promise对象，返回包含APK文件描述符的FileData。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileMeta | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 待发送文件的元数据。所有文件都应来自 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileMeta | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 待发送文件的元数据。所有文件都应来自备份流程或getLocalCapabilities方法。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| fileMeta | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 待发送文件的元数据。应确保备份框架已持有 |
