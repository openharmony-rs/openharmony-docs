...
以同步方法从某个目录，基于过滤器，获取下一级符合条件的文件(夹)信息的迭代器对象FileIterator，然后通过[next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法返回 [FileInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。目前仅支持内置存储设备过滤，外置存储设备不支持过滤。
...
以同步方法从某设备根节点开始，基于过滤器，递归获取符合条件的文件信息的迭代器对象FileIterator，然后通过[next]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方法返回 [FileInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。目前仅支持内置存储设备。
