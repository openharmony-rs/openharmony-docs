...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [CloudDisk_PathInfo](capi-clouddisk-clouddisk-pathinfo.md) | CloudDisk_PathInfo/CloudDisk_FileIdInfo/CloudDisk_SyncFolderPath | <br> CloudDisk_PathInfo：文件路径信息。<br> CloudDisk_FileIdInfo：定义的文件ID。<br> CloudDisk_SyncFolderPath：定义的同步根路径。 |
