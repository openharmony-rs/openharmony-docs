...
> **说明：**
>
> 从API version 9开始支持，从API版本26.0.0开始废弃，建议使用[photoAccessHelper.MediaAssetChangeRequest.setFavorite](../apis-media-library-kit/arkts-apis-photoAccessHelper-MediaAssetChangeRequest.md#setfavorite)替代。
