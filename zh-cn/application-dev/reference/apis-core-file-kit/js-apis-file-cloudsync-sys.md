...
**相关接口**：该接口对应的ArkTS-Sta接口是[onProgress](./js-apis-file-cloudsync-sys.md#onprogress20)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[on](./js-apis-file-cloudsync-sys.md#on)。
...
| 参数名     | 类型   | 必填 | 说明 |
| ---------- | ------ | ---- | ---- |
| callback | Callback\<[SyncProgress](#syncprogress12)> | 是   | 回调函数。同步过程事件，入参为[SyncProgress](./js-apis-file-cloudsync.md#syncprogress12)，返回值为void。|
...
**相关接口**：该接口对应的ArkTS-Sta接口是[offProgress](./js-apis-file-cloudsync-sys.md#offprogress20)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[off](./js-apis-file-cloudsync-sys.md#off)。
...
**相关接口**：该接口对应的ArkTS-Sta接口是[offProgress](./js-apis-file-cloudsync-sys.md#offprogress20-1)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[off](./js-apis-file-cloudsync-sys.md#off-1)。
...
ArkTS-Sta示例：
  ...
  gallerySync.start().then<void>((): void => {
	  console.info("start sync successfully");
...
**相关接口**：该接口对应的ArkTS-Sta接口是[onProgress](./js-apis-file-cloudsync-sys.md#onprogress20-1)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[onProgress](./js-apis-file-cloudsync-sys.md#on-1)。
...
| 参数名     | 类型   | 必填 | 说明 |
| ---------- | ------ | ---- | ---- |
| callback | Callback\<[DownloadProgress](#downloadprogress11)> | 是   | 回调函数。云文件下载过程事件，入参为[DownloadProgress](js-apis-file-cloudsync.md#downloadprogress11)，返回值为void。|
...
**相关接口**：该接口对应的ArkTS-Sta接口是[offProgress](./js-apis-file-cloudsync-sys.md#offprogress20-2)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[off](./js-apis-file-cloudsync-sys.md#off-2)。
...
**相关接口**：该接口对应的ArkTS-Sta接口是[offProgress](./js-apis-file-cloudsync-sys.md#offprogress20-3)。
...
**相关接口**：该接口对应的ArkTS-Dyn接口是[off](./js-apis-file-cloudsync-sys.md#off-3)。
...
| 名称 |  值|  说明 |
| ----- |  ---- |  ---- |
| UPLOADING |  0 | 上行同步中。<br> **ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 20 |
| DOWNLOADING |  1 | 下行同步中。<br> **ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 20 |
| COMPLETED |  2 | 同步成功。<br> **ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 20 |
| STOPPED |  3 | 同步已停止。<br> **ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 20 |
| TO_BE_UPLOADED<sup>12+</sup> |  4 | 正在等待上行。<br> **ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 20 |
| UPLOAD_SUCCESS<sup>12+</sup> |  5 | 文件已成功上行。<br> **ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 20 |
| UPLOAD_FAILURE<sup>12+</sup> |  6 | 文件上行失败。<br> **ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 20 |
...
| progress | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 优化进度百分比，范围[0,100]。|
...
| 名称     | 类型   | 必填 | 说明 |
| ---------- | ------ | ---- | ---- |
| totalSize | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是   | 优化空间总大小。查询媒体库接口获得需要老化的所有文件总大小，由应用传入，单位byte。|
| agingDays | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 老化天数。系统会以当前时间为基准，优化老化天数前未访问、已同步云空间的本地图片/视频。|