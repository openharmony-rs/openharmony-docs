...
| allowsMulFolderSelection<sup>24+</sup>       | boolean                                      | 否   | 是 | 是否支持选择文件夹，仅支持2in1设备。默认为false，表示不支持选择文件夹。<br>**原子化服务API**：从API version 24开始，该接口支持在原子化服务中使用。<br> **系统能力**：SystemCapability.FileManagement.UserFileService.FolderSelection |
