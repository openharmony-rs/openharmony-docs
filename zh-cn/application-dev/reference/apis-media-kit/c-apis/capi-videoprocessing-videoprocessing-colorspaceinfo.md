...
| 名称 | 描述 |
| -- | -- |
| int32_t metadataType | 视频元数据类型，参考{@link OH_NativeBuffer_MetadataType}。 |
| int32_t colorSpace | 视频颜色空间类型，参考{@link OH_NativeBuffer_ColorSpace}。 |
| int32_t pixelFormat | 视频像素格式，参考{@link OH_NativeBuffer_Format}。 |
