...
获取实时的配置参数。使用callback异步回调。 只能在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口调用成功后调用。
...
获取实时的配置参数。使用Promise异步回调。 只能在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口调用成功后调用。
...
获取当前音频最大振幅。使用callback异步回调。 在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用此接 口。在[stop]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，调用此接口会报错。 调用接口时，获取到的返回值是上一次获取最大振幅的时刻到当前这段区间内的音频最大振幅。例如，在1s时获取了一次最大振幅，到2s时再获取到的最大振幅是1-2s这个区间里面的最大值。
...
获取当前音频最大振幅。使用Promise异步回调。 在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用此接 口。在[stop]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，调用此接口会报错。 调用接口时，获取到的返回值是上一次获取最大振幅的时刻到当前这段区间内的音频最大振幅。例如，在1s时获取了一次最大振幅，到2s时再获取到的最大振幅是1-2s这个区间里面的最大值。
...
获取当前音频采集参数。使用callback异步回调。 在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用此接 口。在[stop]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，调用此接口会报错。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.AudioCapturerChangeInfo&gt; | 是 | 回调函数。当获取音频采集参数成功时，err为undefined，data为获取到的audio.AudioCapturerChangeInfo，否则为错误对象。 |
...
获取当前音频采集参数。使用Promise异步回调。 在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用此接 口。在[stop]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，调用此接口会报错。
...
获取录制需要的surface。使用callback异步回调。 开发者从此surface中获取surfaceBuffer，填入相应的视频数据。 应当注意，填入的视频数据需要携带时间戳（单位ns）和buffersize。时间戳的起始时间请以系统启动时间为基准。 需在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用 getInputSurface接口。
...
获取录制需要的surface。使用Promise异步回调。 开发者从此surface中获取surfaceBuffer，填入相应的视频数据。 应当注意，填入的视频数据需要携带时间戳（单位ns）和buffersize。时间戳的起始时间请以系统启动时间为基准。 需在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用getInputSurface接口。
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | 回调函数，返回录制状态机切换事件。如果指定参数则取消对应callback（callback对象不能是匿名函数），否则取消所有callback。\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_从API version 12开始支持此参数。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 12 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;audio.AudioCapturerChangeInfo&gt; | 否 | 回调函数，返回变化后的录音配置全量信息。如果指定参数则取消对应callback（callback对象不能是匿名函数），否则取消所有callback。\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_HTML\_\_\_ESCAPED\_UNDERSCORE\_\_\_TAG\_\_\_ESCAPED\_UNDERSCORE\_\_\_DESC\_\_\_ESCAPED\_UNDERSCORE\_\_\_USD\_\_\_ESCAPED\_UNDERSCORE\_\_\_0\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_\_\_\_ESCAPED\_UNDERSCORE\_\_\_从API version 12开始支持此参数。\_\_\_HTML\_TAG\_USD\_0\_\_\_**起始版本：** 12 |
...
订阅媒体资源回调事件，当[FileGenerationMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_枚举设置为系统创建媒体文件时，会在 [stop]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_操作结束后把 [PhotoAsset]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_对象回调给应用。使用callback异步回调。 当用户重复订阅时，以最后一次订阅的回调接口为准。
...
订阅AVRecorder的错误事件，该事件仅用于错误提示，不需要用户停止播控动作。如果此时 [AVRecorderState]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_也切换至error状态，用户需要通过 [reset]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_或者 [release]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口退出录制操作。使用callback异步回调。 用户只能订阅一个错误事件的回调方法，当用户重复订阅时，以最后一次订阅的回调接口为准。
...
暂停视频录制。使用callback异步回调。 需要[start]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用pause接口，可以通过调用 [resume]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口来恢复录制。
...
暂停视频录制。使用Promise异步回调。 需要[start]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用pause接口，可以通过调用[resume]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口来恢复 录制。
...
重置音视频录制。使用callback异步回调。 纯音频录制时，需要重新调用[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口 才能重新录制。纯视频录制，音视频录制时，需要重新调用 [prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_和 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口才能重新录制。
...
重置音视频录制。使用Promise异步回调。 纯音频录制时，需要重新调用[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口才能重新录制。纯视频录制，音视频录制时，需要重新调用 [prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_和 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口才能重新录制。
...
恢复视频录制。使用callback异步回调。 需要在[pause]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用resume接口。
...
恢复视频录制。使用Promise异步回调。 需要在[pause]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用resume接口。
...
设置录制的元数据信息。如果这些信息的键相同，会覆盖config.metadata.customInfo（参考 [prepare()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和 [AVRecorderConfig]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_）中的值。 该方法只能在[prepare()]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_事件成功触发后，且必须在 [stop()]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_之前调用。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [202](../../errorcode-universal.md#202-系统api权限校验失败) | Not System App.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 19 - 24 |
...
开始视频录制。使用callback异步回调。 纯音频录制需在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后， 才能调用start接口。纯视频录制，音视频录制需在 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，才能调用start接口。
...
开始视频录制。使用Promise异步回调。 纯音频录制需在[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，才能调用start接口。纯视频录制，音视频录制需在 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，才能调用start接口。
...
停止视频录制。使用callback异步回调。 需要在[start]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_或 [pause]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，才能调用stop接口。 纯音频录制时，需要重新调用[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口 才能重新录制。纯视频录制，音视频录制时，需要重新调用 [prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_和 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_接口才能重新录制。
...
停止视频录制。使用Promise异步回调。 需要在[start]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_或[pause]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口成功调用后，才能调用stop接口。 纯音频录制时，需要重新调用[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接口才能重新录制。纯视频录制，音视频录制时，需要重新调用 [prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_和 [getInputSurface]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_接口才能重新录制。
...
更新视频旋转角度。使用Promise异步回调。 当且仅当[prepare]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口成功调用后，且在 [start]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口之前，才能调用updateRotation接口。
