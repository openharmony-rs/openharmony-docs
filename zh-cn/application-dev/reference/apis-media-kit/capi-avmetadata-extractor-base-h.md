...
| static const char * OH_AVMETADATA_EXTRACTOR_HAS_AUDIO = "hasAudio" | 获取媒体资源是否包含音频的关键字，对应值类型为int32_t。<br>取值原则：0表示不包含视频，1表示包含视频。<br>**起始版本：** 18<br>**系统能力：** SystemCapability.Multimedia.Media.AVMetadataExtractor |
| static const char * OH_AVMETADATA_EXTRACTOR_HAS_VIDEO = "hasVideo" | 获取媒体资源是否包含视频的关键字，对应值类型为int32_t。<br>取值原则：0表示不包含音频，1表示包含音频。<br>**起始版本：** 18<br>**系统能力：** SystemCapability.Multimedia.Media.AVMetadataExtractor |
