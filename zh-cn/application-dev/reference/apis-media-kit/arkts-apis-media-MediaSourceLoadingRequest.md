...
| 参数名   | 类型     | 必填 | 说明                 |
| -------- | -------- | ---- | -------------------- |
| uuid | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是  | 资源句柄的标识。来源是[SourceOpenCallback](arkts-apis-media-t.md#sourceopencallback18)。 |
| offset | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是  | 当前媒体数据相对于资源起始位置的偏移量。offset不能小于0。 |
