...
| start | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 否   | 定义该时间基元信息相对整个媒体起始时间的偏移值。<br>取值限定为整数。<br>单位：毫秒。 |
| duration | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 否   | 该时间基元信息的持续时长。<br>取值限定为整数。<br>单位：毫秒。 |
