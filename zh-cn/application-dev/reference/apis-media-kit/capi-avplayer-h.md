...
| 类型 | 说明 |
| -- | -- |
| [OH_AVFormat *](../apis-avcodec-kit/capi-core-oh-avformat.md) | 执行成功返回播放器的统计指标信息（键值详情请参考[avplayer_base.h](../apis-media-kit/capi-avplayer-base-h.md)），否则返回nullptr。<br> 可能的失败原因：传入player指针不合法。 |
