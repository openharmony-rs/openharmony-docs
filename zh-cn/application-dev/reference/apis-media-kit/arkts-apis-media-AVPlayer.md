...
调节当前播放的视频/音频的媒体播放音量，只能在prepared/playing/paused/completed状态调用，可以通过[on('volumeChange')](#onvolumechange9)事件确认是否生效。不对系统其他音量生效，如需修改其他音量（如系统音量、应用音量等）请参考[播放音量管理](../../media/audio/volume-management.md)。
