...
| loop<sup>9+</sup>                                   | boolean                                                      | 否   | 否   | 视频循环播放属性，动态属性。true表示循环播放，false表示不循环播放，默认值为false。<br/>只允许在**prepared**/**playing**/**paused**/**completed**状态下设置。<br/>直播场景不支持loop设置。 <br/>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。|
