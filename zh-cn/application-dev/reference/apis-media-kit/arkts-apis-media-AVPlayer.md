...
| 参数名   | 类型     | 必填 | 说明                                                         |
| -------- | -------- | ---- | ------------------------------------------------------------ |
| callback | Callback\<[AVTimedMetaData](arkts-apis-media-i.md#avtimedmetadata26)> | 是   | 上报的基于时间的元数据。|
...
| 参数名   | 类型     | 必填 | 说明                                                         |
| -------- | -------- | ---- | ------------------------------------------------------------ |
| callback | Callback\<[AVTimedMetaData](arkts-apis-media-i.md#avtimedmetadata26)> | 否   | 上报的基于时间的元数据，默认值为取消订阅该事件的所有回调函数。 |
