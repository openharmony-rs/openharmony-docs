...
| 类型             | 说明                             |
| ---------------- | -------------------------------- |
| ArkTS-Dyn: Promise\<string><br>ArkTS-Sta: Promise\<string \| undefined> | 异步获得surface的Promise返回值。 |
...
| 类型             | 说明                             |
| ---------------- | -------------------------------- |
| ArkTS-Dyn: Promise\<[AVRecorderConfig](arkts-apis-media-i.md#avrecorderconfig9)><br>ArkTS-Sta: Promise\<[AVRecorderConfig](arkts-apis-media-i.md#avrecorderconfig9) \| undefined> | 异步获得实时配置参数的回调方法。 |
