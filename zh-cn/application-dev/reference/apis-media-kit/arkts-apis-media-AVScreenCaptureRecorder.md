...
| 参数名 | 类型    | 必填 | 说明                                                      |
| ------ | ------- | ---- | --------------------------------------------------------- |
| pickerMode | [PickerMode](arkts-apis-media-e.md#pickermode22) | 是   | Picker显示模式。 |
...
| 参数名 | 类型    | 必填 | 说明                                                      |
| ------ | ------- | ---- | --------------------------------------------------------- |
| excludedWindows | Array\<int> | 是   | 需要在Picker中隐藏的窗口列表，包括主窗口id和子窗口id，窗口属性获取方法可以参考[窗口API引用](../apis-arkui/arkts-apis-window-Window.md#getwindowproperties9)。 |
