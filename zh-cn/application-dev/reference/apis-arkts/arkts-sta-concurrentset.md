...
向集合中添加一个元素，如果元素已经存在，则不会重复添加。返回this即调用该方法的[ConcurrentSet](./arkts-sta-concurrentset.md)对象，支持链式调用。
...
| 类型 | 说明                                                           |
| :--- | :------------------------------------------------------------- |
| this | 返回调用该方法的[ConcurrentSet](./arkts-sta-concurrentset.md)对象。 |
...
| set    | ConcurrentSet\<T> | 否   | 调用该方法的[ConcurrentSet](./arkts-sta-concurrentset.md)对象 |
