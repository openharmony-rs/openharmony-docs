...
ArkTS-Dyn和ArkTS-Sta交互过程中，存在系统对象的交互。本模块提供了系统对象转换能力：

- 从ArkTS-Sta系统对象转换为ArkTS-Dyn系统对象的能力。

- 从ArkTS-Dyn系统对象转换为ArkTS-Sta系统对象的能力。
...
从ArkTS-Dyn系统对象转换为ArkTS-Sta系统对象。
...
dyamic2Static(dynamic_obj); // 调用ArkTS-Sta环境中的dyamic2Static方法
...
从ArkTS-Sta系统对象转换为ArkTS-Dyn系统对象。
...
| 名称 | 类型   | 必填 | 说明                             |
| ---- | ------ | ---- | -------------------------------- |
| input | Object | 是   | 待转换的ArkTS-Sta对象。 |
| inputName | string | 是   | 转换对象的key值，取值参见[key值列表](#转换对象key值列表)。 |
...
| "AbilityKit.UIAbilityContext" | [UIAbilityContext](../apis-ability-kit/js-apis-inner-application-uiAbilityContext.md#uiabilitycontext-1)|
...
| "ArkUI.ClickEvent" | [ClickEvent](../apis-arkui/arkui-ts/ts-universal-events-click.md#clickevent)|
| "ArkUI.HoverEvent" | [HoverEvent](../apis-arkui/arkui-ts/ts-universal-events-hover.md#hoverevent10对象说明)|
| "ArkUI.TouchTestInfo" | [TouchTestInfo](../apis-arkui/arkui-ts/ts-universal-attributes-on-child-touch-test.md#touchtestinfo11)|
