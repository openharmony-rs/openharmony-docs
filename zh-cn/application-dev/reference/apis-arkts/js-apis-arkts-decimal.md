...
| 名称 | 类型     | 只读 | 可选 | 说明                                      |
| ---- | -------- | ---- | ---- | ----------------------------------------- |
| d    | ArkTS-Dyn: number[] <br> ArkTS-Sta: Array\<double\> \| null | 是   | 否   | digits：表示Decimal数整数部分和小数部分的数组。 |
| e    | ArkTS-Dyn: number <br> ArkTS-Sta: double   | 是   | 否   | exponent：表示Decimal数的十进制指数。 |
| s    | ArkTS-Dyn: number <br> ArkTS-Sta: double   | 是   | 否   | sign：表示Decimal数的符号位，0表示正数，1表示负数。|
