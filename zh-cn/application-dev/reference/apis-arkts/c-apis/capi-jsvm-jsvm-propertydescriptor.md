...
| [JSVM_Value](capi-jsvm-types-h.md#jsvm_value) name | 可选的JSVM_Value，指向用作属性键的JavaScript字符串或符号。必须为属性提供utf8name或name之一。 |
...
| [JSVM_Value](capi-jsvm-types-h.md#jsvm_value) value | 如果属性是数据属性，则通过属性的get访问检索到的值。 |
