...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| callbackFn | [LightWeightSetForEachCb\<T\>](#lightweightsetforeachcbt23) | 是 | 回调函数。 |
...
### LightWeightSetForEachCb\<T\><sup>23+</sup>
...
| set | [LightWeightSet&lt;T&gt;](#lightweightset) | 是 | 当前调用[forEach](#foreach23)方法的实例对象。 |
