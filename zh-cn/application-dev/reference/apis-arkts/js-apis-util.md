...
ArkTS-Dyn: errnoToString(errno: number): string

ArkTS-Sta: errnoToString(errno: int): string
...
| 参数名 | 类型   | 必填 | 说明                       |
| ------ | ------ | ---- | -------------------------- |
| errno  | ArkTS-Dyn: number <br> ArkTS-Sta: int | 是   | 系统发生错误产生的错误码。 |
...
ArkTS-Dyn: callbackWrapper(original: Function): (err: Object, value: Object )=&gt;void

ArkTS-Sta: callbackWrapper(original: Function): Function
...
ArkTS-Dyn: promisify(original: (err: Object, value: Object) =&gt; void): Function

ArkTS-Sta: promisify(original: Function): PromisifiedFunc
...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| original | ArkTS-Dyn: (err: Object, value: Object) => void <br> ArkTS-Sta: Function | 是 | 回调函数中第一个参数err是拒绝原因（如果&nbsp;Promise&nbsp;已解决，则为&nbsp;null），第二个参数value是已解决的值。  |

**返回值：**

| 类型 | 说明 |
| -------- | -------- |
| ArkTS-Dyn: Function <br> ArkTS-Sta: [PromisifiedFunc](#promisifiedfunc23) | 返回一个Promise函数，该Promise在原始回调函数成功执行时resolve为回调的value值，在原始回调函数执行出错时reject为错误对象。 |
...
ArkTS-Dyn: generateRandomBinaryUUID(entropyCache?: boolean): Uint8Array

ArkTS-Sta: generateRandomBinaryUUID(entropyCache?: boolean): Uint8Array | undefined
...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| ArkTS-Dyn: object <br> ArkTS-Sta: obj | ArkTS-Dyn: object <br> ArkTS-Sta: RecordData | 是 | 需要获取Hash值的非原始类型对象。 |

**返回值：**

| 类型 | 说明 |
| -------- | -------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 对象的Hash值，首次获取时返回随机值，同一对象多次获取返回值保持不变。 |
...
| options  | [MultithreadingDetectionOptions](#multithreadingdetectionoptions)  | 否       | 多线程安全检测的参数配置，此参数不填时，对应各属性取[MultithreadingDetectionOptions](#multithreadingdetectionoptions)的默认值。**ArkTS-Dyn起始版本：** 26.0.0|
...
## PromisifiedFunc<sup>23+</sup>

type PromisifiedFunc = (...args: FixedArray&lt;Any&gt;) => Promise&lt;Any&gt;

表示[promisify](#utilpromisify9)函数的返回值类型。
...
| 名称      | 类型 | 只读  |可选  | 说明               |
| --------- | -------- | -------- |-------- |------------------ |
| read     | ArkTS-Dyn: number<br>ArkTS-Sta: int  | 是 | 否 |已读取的字符数。 |
| written | ArkTS-Dyn: number<br>ArkTS-Sta: int   | 是 |否 |已写入的字节数。  |
...
ArkTS-Dyn: static parseRationalNumber(numerator: number,denominator: number): RationalNumber

ArkTS-Sta: static parseRationalNumber(numerator: long,denominator: long): RationalNumber
...
| 参数名      | 类型   | 必填 | 说明             |
| ----------- | ------ | ---- | ---------------- |
| numerator   | ArkTS-Dyn: number <br> ArkTS-Sta: long | 是   | 分子，整数类型。取值范围：-Number.MAX_VALUE <= numerator <= Number.MAX_VALUE。|
| denominator | ArkTS-Dyn: number <br> ArkTS-Sta: long | 是   | 分母，整数类型。取值范围：-Number.MAX_VALUE <= denominator <= Number.MAX_VALUE。|
...
ArkTS-Dyn: compare(another: RationalNumber): number​

ArkTS-Sta: compare(another: RationalNumber): int
...
ArkTS-Dyn: valueOf(): number

ArkTS-Sta: valueOf(): double
...
| 类型 | 说明 |
| -------- | -------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: double | 返回整数或者浮点数的值。 |
...
ArkTS-Dyn: static getCommonFactor(number1: number, number2: number): number

ArkTS-Sta: static getCommonFactor(number1: long, number2: long): long
...
| 参数名  | 类型   | 必填 | 说明       |
| ------- | ------ | ---- | ---------- |
| number1 | ArkTS-Dyn: number <br> ArkTS-Sta: long | 是   | 整数类型。-Number.MAX_VALUE <= number1 <= Number.MAX_VALUE。|
| number2 | ArkTS-Dyn: number <br> ArkTS-Sta: long | 是   | 整数类型。-Number.MAX_VALUE <= number2 <= Number.MAX_VALUE。|
...
ArkTS-Dyn: getNumerator(): number

ArkTS-Sta: getNumerator(): long
...
| 类型 | 说明 |
| -------- | -------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回RationalNumber对象的分子。 |
...
ArkTS-Dyn: getDenominator(): number

ArkTS-Sta: getDenominator(): long
...
| 类型 | 说明 |
| -------- | -------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回RationalNumber对象的分母。 |
...
| 名称   | 类型   | 只读 | 可选 | 说明                   |
| ------ | ------ | ---- | ---- | ---------------------- |
| length | ArkTS-Dyn: number <br> ArkTS-Sta: int | 是   | 否   | 当前缓存中值的总数。 |
...
ArkTS-Dyn: constructor(capacity?: number)

ArkTS-Sta: constructor(capacity?: int)
...
| 参数名   | 类型   | 必填 | 说明                         |
| -------- | ------ | ---- | ---------------------------- |
| capacity | ArkTS-Dyn: number <br> ArkTS-Sta: int | 否   | 指示要为缓冲区自定义的容量，取值范围为[0, 2147483647]，默认值为64。  |
...
ArkTS-Dyn: updateCapacity(newCapacity: number): void

ArkTS-Sta: updateCapacity(newCapacity: int): void
...
| 参数名      | 类型   | 必填 | 说明                         |
| ----------- | ------ | ---- | ---------------------------- |
| newCapacity | ArkTS-Dyn: number <br> ArkTS-Sta: int | 是   | 指示要为缓冲区自定义的容量，取值范围为[0, 2147483647]。 |
...
| 类型   | 说明                   |
| ------ | ---------------------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: int | 返回当前缓冲区的容量。 |
...
ArkTS-Dyn: getCreateCount(): number

ArkTS-Sta: getCreateCount(): long
...
| 类型   | 说明                |
| ------ | -------------------|
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回创建对象的次数。 |
...
ArkTS-Dyn: getMissCount(): number

ArkTS-Sta: getMissCount(): long
...
| 类型   | 说明                     |
| ------ | ------------------------ |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回查询值不匹配的次数。 |
...
ArkTS-Dyn: getRemovalCount(): number

ArkTS-Sta: getRemovalCount(): long
...
| 类型   | 说明                       |
| ------ | -------------------------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回缓冲区键值对回收的次数。 |
...
ArkTS-Dyn: getMatchCount(): number

ArkTS-Sta: getMatchCount(): long
...
| 类型   | 说明                       |
| ------ | -------------------------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回查询值匹配成功的次数。 |
...
ArkTS-Dyn: getPutCount(): number

ArkTS-Sta: getPutCount(): long
...
| 类型   | 说明                         |
| ------ | ---------------------------- |
| ArkTS-Dyn: number <br> ArkTS-Sta: long | 返回将值添加到缓冲区的次数。 |
...
ArkTS-Dyn: put(key: K,value: V): V

ArkTS-Sta: put(key: K, value: V): V | undefined
...
ArkTS-Dyn: createDefault(key: K): V

ArkTS-Sta: createDefault(key: K): V | undefined
...
| 类型 | 说明 |
| -------- | -------- |
| [ScopeComparable&lt;T&gt;](#scopecomparablet23) | 表示值的类型为ScopeComparable&lt;T&gt;。|
...
| 参数名 | 类型                            | 必填 | 说明           |
| ------ | ------------------------------- | ---- | -------------- |
| range  | [ScopeHelper&lt;T&gt;](#scopehelpert23) | 是   | 传入给定范围。 |

**返回值：**

| 类型                            | 说明                           |
| ------------------------------- | ------------------------------ |
| [ScopeHelper&lt;T&gt;](#scopehelpert23) | 返回给定范围和当前范围的交集。 |
...
| 类型                         | 说明                                     |
| ---------------------------- | ---------------------------------------- |
| [ScopeHelper&lt;T&gt;](#scopehelpert23) | 返回当前范围与给定下限和上限范围的交集。 |
...
| 类型                         | 说明                                 |
| ---------------------------- | ------------------------------------ |
| [ScopeHelper&lt;T&gt;](#scopehelpert23) | 返回当前范围和给定下限和上限的并集。 |
...
| 参数名 | 类型                            | 必填 | 说明               |
| ------ | ------------------------------- | ---- | ------------------ |
| range  | [ScopeHelper&lt;T&gt;](#scopehelpert23) | 是   | 传入一个给定范围。 |

**返回值：**

| 类型                            | 说明                               |
| ------------------------------- | ---------------------------------- |
| [ScopeHelper&lt;T&gt;](#scopehelpert23) | 返回包括当前范围和给定范围的并集。 |
...
| 类型                         | 说明                             |
| ---------------------------- | -------------------------------- |
| [ScopeHelper&lt;T&gt;](#scopehelpert23) | 返回包括当前范围和给定值的并集。 |
...
| 名称   |值| 说明               |
| ----- |---| ----------------- |
| BASIC | 0 | 表示BASIC编码格式。**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 10 <br> **ArkTS-Sta起始版本：** 23|
| MIME  | 1 | 表示MIME编码格式。**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 10 <br> **ArkTS-Sta起始版本：** 23|
| BASIC_URL_SAFE<sup>12+</sup> | 2 | 表示BASIC_URL_SAFE编码格式。<br/>从API version 12开始支持此枚举。**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12 <br> **ArkTS-Sta起始版本：** 23|
| MIME_URL_SAFE<sup>12+</sup> | 3 | 表示MIME_URL_SAFE编码格式。<br/>从API version 12开始支持此枚举。**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 12 <br> **ArkTS-Sta起始版本：** 23|
