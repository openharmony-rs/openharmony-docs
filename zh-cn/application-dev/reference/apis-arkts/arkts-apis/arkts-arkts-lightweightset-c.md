...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The addAll method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200012](../../errorcode-universal.md#10200012-The) | The LightWeightSet's constructor cannot be directly invoked. |
...
| 类型 | 说明 |
| --- | --- |
| number | 在lightWeightSet中指定数据的下标。若lightWeightSet中没有要查找的元素，则返回一个负值。<br/>表示目标哈希值应该插入的位置，插入位置是从1开始计数的，负号表示这是一个插入位置而不是索引。 |
...
| [10200001](../../errorcode-universal.md#10200001-The) | The value of minimumCapacity is out of range. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The toArray method cannot be bound. |
