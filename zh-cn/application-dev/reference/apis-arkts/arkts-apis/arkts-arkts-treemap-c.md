...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| comparator | (firstValue: K, secondValue: K) =&gt; boolean | 否 | 比较函数。<br/>comparator（可选）用户自定义的比较函数。<br/>firstValue（必填）前一项元素。<br/>secondValue（必填）后一项元素。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [10200012](../../errorcode-universal.md#10200012-The) | The TreeMap's constructor cannot be directly invoked. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callbackFn | (value?: V, key?: K, map?: TreeMap&lt;K, V&gt;) =&gt; void | 是 | 回调函数。<br/>callbackFn（必填）接受最多三个参数的函数。<br/>对每个元素调用的函数。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getFirstKey method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getHigherKey method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getLastKey method cannot be bound. |
| [10200010](../../errorcode-universal.md#10200010-Container) | Container is empty.&lt;br&gt;**适用版本：** 23+<br/><br/>**ArkTS模式：** 该错误码仅适用于ArkTS-Sta。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getLowerKey method cannot be bound. |
