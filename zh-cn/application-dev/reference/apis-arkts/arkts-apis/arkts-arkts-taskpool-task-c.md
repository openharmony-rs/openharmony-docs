...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200026](../../errorcode-universal.md#10200026-There) | There is a circular dependency. |
| [10200052](../../errorcode-universal.md#10200052-The) | The periodic task cannot have a dependency.&lt;br&gt;**适用版本：** 12+ |
| [10200056](../../errorcode-universal.md#10200056-The) | The task has been executed by the AsyncRunner.&lt;br&gt;**适用版本：** 18+ |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | Function | 是 | 执行的逻辑需要传入函数，该函数必须使用<br/>[@Concurrent装饰器](../../../../arkts-utils/taskpool-introduction.md#concurrent装饰器)装饰。支持的函数返回值类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。 |
| args | Object[] | 是 | 任务执行传入函数的入参，支持的参数类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。默认值为**undefined**。 |
...
| name | string | 是 | 任务名称。 |
| func | Function | 是 | 执行的逻辑需要传入函数，该函数必须使用<br/>[@Concurrent装饰器](../../../../arkts-utils/taskpool-introduction.md#concurrent装饰器)装饰。支持的函数返回值类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。 |
| args | Object[] | 是 | 任务执行传入函数的入参，支持的类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。默认值为**undefined**。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200034](../../errorcode-universal.md#10200034-The) | The executed task does not support the registration of listeners. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200027](../../errorcode-universal.md#10200027-The) | The dependency does not exist. |
| [10200052](../../errorcode-universal.md#10200052-The) | The periodic task cannot have a dependency.&lt;br&gt;**适用版本：** 12+ |
| [10200056](../../errorcode-universal.md#10200056-The) | The task has been executed by the AsyncRunner.&lt;br&gt;**适用版本：** 18+ |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| args | Object[] | 是 | 作为已注册回调函数入参的数据，支持的参数类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。默认值为**undefined**。 |
...
| [10200022](../../errorcode-universal.md#10200022-The) | The function is not called in the TaskPool thread. |
| [10200023](../../errorcode-universal.md#10200023-The) | The function is not called in the concurrent function. |
| [10200024](../../errorcode-universal.md#10200024-The) | The callback is not registered on the host side. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| cloneList | Object[] \| ArrayBuffer[] | 是 | - 传入数组的类型必须为<br/>[Sendable支持的数据类型](../../../../arkts-utils/arkts-sendable.md#sendable支持的数据类型)或ArrayBuffer。<br/>- 所有传入<br/>**cloneList**的[Sendable class](../../../../arkts-utils/arkts-sendable.md#sendable-class)实例或ArrayBuffer类型对象，<br/>在线程间传输的行为都会变成拷贝传递，即修改传输后的对象不会对原有对象产生任何影响。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [10200029](../../errorcode-universal.md#10200029-An) | An ArrayBuffer cannot be set as both a transfer list and a clone list. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200029](../../errorcode-universal.md#10200029-An) | An ArrayBuffer cannot be set as both a transfer list and a clone list.&lt;br&gt;**适用版本：** 11+ |
