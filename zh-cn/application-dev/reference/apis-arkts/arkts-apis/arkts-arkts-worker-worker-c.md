...
| transfer | ArrayBuffer[] | 是 | transfer 可转移的ArrayBuffer实例对象。<br/>transferList数组不可包含null。 |
...
| --- | --- | --- | --- |
| message | Object | 是 | 发送至Worker的数据。 |
| options | PostMessageOptions | 否 | 可为postMessage设置的选项。<br/>transferList数组不可包含null。 |
