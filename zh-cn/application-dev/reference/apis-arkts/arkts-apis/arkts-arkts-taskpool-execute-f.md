...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Object&gt; | [since 9 - 11]<br/>@returns { Promise } Promise对象，返回任务函数的执行结果。 [since 11] |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [10200003](../../errorcode-universal.md#10200003-Worker) | Worker initialization failed.&lt;br&gt;**适用版本：** 9 - 11 |
...
| priority | Priority | 否 | 该参数表示等待执行的任务的优先级，默认值为<br/>**taskpool.Priority.MEDIUM**。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;Object&gt; | [since 9 - 17]<br/>@returns { Promise } Promise对象，返回任务函数的执行结果。 [since 11] |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [10200003](../../errorcode-universal.md#10200003-Worker) | Worker initialization failed.&lt;br&gt;**适用版本：** 9 - 17 |
| [10200006](../../errorcode-universal.md#10200006-An) | An exception occurred during serialization. |
| [10200014](../../errorcode-universal.md#10200014-The) | The function is not marked as concurrent. |
...
| priority | Priority | 否 | 等待执行的任务的优先级，默认值为<br/>**taskpool.Priority.MEDIUM**。 |
...
| --- | --- |
| [10200006](../../errorcode-universal.md#10200006-An) | An exception occurred during serialization. |
| [10200059](../../errorcode-universal.md#10200059-TaskGroup) | TaskGroup cannot be re-executed.&lt;br&gt;**适用版本：** 24+ |
...
| [10200058](../../errorcode-universal.md#10200058-Task) | Task timed out. |
...
| --- | --- |
| [10200006](../../errorcode-universal.md#10200006-An) | An exception occurred during serialization. |
| [10200059](../../errorcode-universal.md#10200059-TaskGroup) | TaskGroup cannot be re-executed. |
| [10200070](../../errorcode-universal.md#10200070-TaskGroup) | TaskGroup timed out. |
