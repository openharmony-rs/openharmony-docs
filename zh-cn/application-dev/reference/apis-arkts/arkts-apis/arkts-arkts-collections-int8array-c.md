...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| buffer | [ArrayBuffer](arkts-arkts-collections-arraybuffer-c.md) | 是 | 用于构造ArkTS Int8Array的ArrayBuffer对象。buffer所占的字节数须是4的整数倍。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 修改后的Int8Array。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 填充后的ArkTS Int8Array。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 过滤后的ArkTS Int8Array。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 新创建的ArkTS Int8Array对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 新ArkTS Int8Array对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 新的ArkTS Int8Array实例。可能的错误原因：1.必填参数未指定；<br>2.参数类型不正确；3.参数校验失败。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 反转后的ArkTS Int8Array对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 新的ArkTS Int8Array对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [Int8Array](arkts-arkts-collections-int8array-c.md) | 排序后的ArkTS Int8Array对象。 |
