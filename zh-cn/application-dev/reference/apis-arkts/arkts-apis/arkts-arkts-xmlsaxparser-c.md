...
XmlSAXParser类用于以流式方式解析XML文本。适用于需要边读取边处理的场景，支持从[stream.Readable](arkts-arkts-readable-c.md) 流中读取XML数据并
进行解析。
...
> **说明：**
>
> - `inputStream`参数必须传入继承自[Readable](arkts-arkts-readable-c.md)且实现
> [Doread](arkts-arkts-readable-c.md#doread-1)的类。可以传入其他模块中满足该条件的类，如
> [ReadStream](../../apis-core-file-kit/arkts-apis/arkts-corefile-readstream-c.md)。
...
>
> - 可以配合自动控制数据的流使用，如[ReadStream](../../apis-core-file-kit/arkts-apis/arkts-corefile-readstream-c.md)，此时用户不再需要手动控制数据。
>
