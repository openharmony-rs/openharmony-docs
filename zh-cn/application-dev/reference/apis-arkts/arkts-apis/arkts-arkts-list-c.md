...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200012](../../errorcode-universal.md#10200012-The) | The List's constructor cannot be directly invoked. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The convertToArray method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The equal method cannot be bound. |
...
| [10200001](../../errorcode-universal.md#10200001-The) | The value of index is out of range.&lt;br&gt;**适用版本：** 23+<br/><br/>**ArkTS模式：** 该错误码仅适用于ArkTS-Sta。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getFirst method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getLast method cannot be bound. |
| [10200010](../../errorcode-universal.md#10200010-Container) | Container is empty.&lt;br&gt;**适用版本：** 23+<br/><br/>**ArkTS模式：** 该错误码仅适用于ArkTS-Sta。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The getSubList method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The insert method cannot be bound. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The removeByIndex method cannot be bound. |
| [10200001](../../errorcode-universal.md#10200001-The) | The value of index is out of range. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200011](../../errorcode-universal.md#10200011-The) | The replaceAllElements method cannot be bound. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| comparator | ListComparatorFn&lt;T&gt; | 是 | 回调函数。<br/>从API version 23起有兼容性变更。在API version 22及之前版本，类型为 `(firstValue: T, secondValue: T) =&gt; number`。 [since 23] |
