...
| 类型 | 说明 |
| --- | --- |
| IterableIterator&lt;[&lt;br/&gt;            number,&lt;br/&gt;            number&lt;br/&gt;        ]&gt; | @syscap SystemCapability.Utils.Lang<br/>@crossplatform<br/>@atomicservice |
...
| 类型 | 说明 |
| --- | --- |
| IterableIterator&lt;number&gt; | @syscap SystemCapability.Utils.Lang<br/>@crossplatform<br/>@atomicservice |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | number | 否 | 偏移量。默认值：0。取值范围：0 = 0 and &lt;= buf.length - 8. Received value is: [offset] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | number | 否 | 偏移量。默认值：0。取值范围：0 = 0 and &lt;= buf.length - 4. Received value is: [offset] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | number | 否 | 偏移量。默认值：0。取值范围：0 = 0 and &lt;= buf.length - 2. Received value is: [offset] |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offset | number | 否 | 偏移量。默认值：0。取值范围：0 = 0 and &lt;= buf.length - 1. Received value is: [offset] |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200009](../../errorcode-universal.md#10200009-The) | The fastbuffer size must be a multiple of 16-bits |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200009](../../errorcode-universal.md#10200009-The) | The fastbuffer size must be a multiple of 32-bits |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200009](../../errorcode-universal.md#10200009-The) | The fastbuffer size must be a multiple of 64-bits |
