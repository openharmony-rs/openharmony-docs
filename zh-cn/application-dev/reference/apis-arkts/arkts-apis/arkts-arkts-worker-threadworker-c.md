...
| transfer | [ArrayBuffer](arkts-arkts-collections-arraybuffer-c.md)[] | 是 | 表示可转移的ArrayBuffer实例对象数组，该数组中对象的所有权会被转移到Worker线程，转移后该对象仅在Worker线程中可用。该数组不可传入null。 |
...
| transfer | [ArrayBuffer](arkts-arkts-collections-arraybuffer-c.md)[] | 否 | 表示可转移的ArrayBuffer实例对象数组，该数组中对象的所有权会被转移到Worker线程，转移后该对象仅在Worker线程中可用。该数组不可传入null。默认值为空数组。 |
