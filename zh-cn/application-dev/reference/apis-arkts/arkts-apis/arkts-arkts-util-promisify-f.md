...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| original | (err: Object, value: Object) =&gt; void | 是 | 函数，其中第一个参数 **err** 表示拒绝的原因（如果 promise 已经 resolved，该值为<br/>**null**），第二个参数 **value** 表示 resolved 的值。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Function | 返回一个返回 promises 的函数。[since 9 - 11]<br/>@returns { Function } Promise 函数。[since 10] |
