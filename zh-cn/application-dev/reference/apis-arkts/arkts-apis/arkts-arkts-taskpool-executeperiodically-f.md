...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| period | number | 是 | 周期时长，单位为ms。period值必须要大于等于0。<br/>该值应为整数。<br/><br/>单位：毫秒。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [10200006](../../errorcode-universal.md#10200006-An) | An exception occurred during serialization. |
| [10200014](../../errorcode-universal.md#10200014-The) | The function is not marked as concurrent. |
| [10200028](../../errorcode-universal.md#10200028-The) | The period is less than zero. |
| [10200050](../../errorcode-universal.md#10200050-The) | The concurrent task has been executed and cannot be executed periodically. |
| [10200057](../../errorcode-universal.md#10200057-The) | The task cannot be executed by two APIs.&lt;br&gt;**适用版本：** 18+ |
