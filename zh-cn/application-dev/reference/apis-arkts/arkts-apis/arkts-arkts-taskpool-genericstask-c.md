...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| func | (...args: A) =&gt; R \| Promise&lt;R&gt; | 是 | 执行的逻辑需要传入函数，该函数必须使用<br/>[@Concurrent装饰器](../../../../arkts-utils/taskpool-introduction.md#concurrent装饰器)装饰。支持的函数返回值类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。 |
| args | A | 是 | 任务执行传入函数的入参，支持的参数类型请参考<br/>[序列化支持类型](../../../../reference/apis-arkts/js-apis-taskpool.md#序列化支持类型)。默认值为**undefined**。 |
