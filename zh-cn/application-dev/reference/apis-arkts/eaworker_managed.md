...
## WorkerPriority
表示EAWorker线程的优先级的枚举值，开发者可以通过调用[setPriority](#setpriority)为EAWorker设置线程QoS(quality-of-service)等级，对应关系参考[QoS等级定义](../../kernel-enhance/qos-guidelines.md#qos等级定义)。
...
## FAQ
### 如何进行异常处理
EAWorker中运行的任务如果出现未捕获的异常，可以通过[Await](./job.md#await)来选择合适的线程进行异常处理，具体请参考[迁移文档](../../quick-start/arkts-dyn-to-sta-worker-migration-guide.md)。