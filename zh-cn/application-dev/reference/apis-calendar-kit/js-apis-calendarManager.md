...
| 23900004 | Internal program errors. Possible causes: 1. dataShare database execution error; 2. null pointer error; 3. Data parsing error.<br>通用版本：23+ |
...
| 401      | Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types.  |
| 801      | Capability not supported.  |
| 23900003 | The specified account was not found.<br>通用版本：23+  |
| 23900004 | Internal program errors. Possible causes: 1. dataShare database execution error; 2. null pointer error; 3. Data parsing error.<br>通用版本：23+ |
...
| 错误码ID    | 错误信息                        |
|----------| ------------------------------ |
| 201      | Permission denied.<br>通用版本：23+  |
| 23900004 | Internal program errors. Possible causes: 1. dataShare database execution error; 2. null pointer error; 3. Data parsing error.<br>通用版本：23+ |
...
| 错误码ID    | 错误信息                   |
|----------|------------------------|
| 23900001 | Parameter value error.<br>通用版本：23+ |
