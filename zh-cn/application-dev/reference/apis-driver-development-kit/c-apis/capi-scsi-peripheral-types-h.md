...
| 名称 | 描述 |
| -- | -- |
| SCSIPERIPHERAL_MIN_DESCRIPTOR_FORMAT_SENSE 8 | 描述符格式感应数据的最小长度。<br>**起始版本：** 18 |
| SCSIPERIPHERAL_MIN_FIXED_FORMAT_SENSE 18 | 固定格式感应数据的最小长度。<br>**起始版本：** 18 |
| SCSIPERIPHERAL_MAX_CMD_DESC_BLOCK_LEN 16 | 命令描述块的最大长度。<br>**起始版本：** 18 |
| SCSIPERIPHERAL_MAX_SENSE_DATA_LEN 252 | 感应数据的最大长度。<br>**起始版本：** 18 |
