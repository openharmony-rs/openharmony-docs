...
| [DDK_Ashmem](capi-ddk-ddk-ashmem.md) **ashmem | 用于输出创建的共享内存对象的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| [DDK_Ashmem](capi-ddk-ddk-ashmem.md) *ashmem | 要映射的共享内存描述符指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| [DDK_Ashmem](capi-ddk-ddk-ashmem.md) *ashmem | 要取消映射的共享内存描述符指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| [DDK_Ashmem](capi-ddk-ddk-ashmem.md) *ashmem | 要销毁的共享内存描述符指针。 |
