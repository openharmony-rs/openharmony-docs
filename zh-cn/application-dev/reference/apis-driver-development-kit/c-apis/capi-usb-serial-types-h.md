...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [UsbSerial_Params](capi-usbserialddk-usbserial-params.md) | __attribute__((aligned(8))) UsbSerial_Params | 定义USB Serial DDK使用的USB串口参数。 |
| [UsbSerial_Device](capi-usbserialddk-usbserial-device.md) | UsbSerial_Device | USB串口设备数据结构（不透明）。 |
