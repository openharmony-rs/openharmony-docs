...
| 名称 | 描述 |
| -- | -- |
| [DRM_MediaKeyRequestType](capi-native-drm-common-h.md#drm_mediakeyrequesttype) type | 媒体密钥请求类型，指示请求的用途。常见类型包括MEDIA_KEY_REQUEST_TYPE_INITIAL（初始请求）、MEDIA_KEY_REQUEST_TYPE_RENEWAL（续期请求）等，具体类型由DRM解决方案决定。 |
