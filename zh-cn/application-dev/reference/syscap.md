...
> **注意**：
>
> API支持的设备类型和所属的SysCap可通过在[HarmonyOS API参考](https://developer.huawei.com/consumer/cn/doc/search?type=API&versionValue=all)中查询获取。
> ![Syscap-API](figures/Syscap-API.png) 
