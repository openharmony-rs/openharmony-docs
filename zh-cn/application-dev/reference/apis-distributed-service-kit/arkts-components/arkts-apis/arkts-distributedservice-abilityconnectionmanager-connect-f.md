...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[ConnectResult](arkts-distributedservice-abilityconnectionmanager-connectresult-i.md)&gt; | Promise对象，成功时resolve返回ConnectResult（包含isConnected和errorCode字段），失败时reject返回错误对象。 |
