...
| 名称                                     | typedef关键字  | 描述                                 |
| ---------------------------------------- | -------------- | ------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) | OH_Data_Values | 定义OH_Data_Values结构类型。 |

### 函数

| 名称                                                         | 描述                                                         |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [OH_Data_Values *OH_Values_Create(void)](#oh_values_create)  | 创建[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例，用于存储多个数据值。 |
| [int OH_Values_Destroy(OH_Data_Values *values)](#oh_values_destroy) | 销毁[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)对象。           |
...
创建[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例，用于存储多个数据值。
...
| 类型                                     | 说明                                                         |
| ---------------------------------------- | ------------------------------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) | 执行成功时返回指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针，否则返回nullptr。<br>使用完成后，必须通过[OH_Values_Destroy](capi-oh-data-values-h.md#oh_values_destroy)接口释放内存。 |
...
销毁[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)对象。
...
| 参数项                                           | 描述                                                         |
| ------------------------------------------------ | ------------------------------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
...
| ------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values  | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| const [OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value) *val | 表示指向[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)对象的指针。   |
...
| ------------------------------------------------ | ------------------------------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| const [Data_Asset](capi-rdb-data-asset.md#data_asset) *val      | 表示指向[Data_Asset](capi-rdb-data-asset.md#data_asset)对象的指针。         |
...
| ---------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values     | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| const [Data_Asset](capi-rdb-data-asset.md#data_asset) * const * val | 表示指向[Data_Asset](capi-rdb-data-asset.md#data_asset)对象的指针。         |
| size_t length                                        | 该参数为输入参数，表示开发者传入的[Data_Asset](capi-rdb-data-asset.md#data_asset)对象数组元素的个数。 |
...
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| int index                                        | 表示values中目标数据的从零开始的索引。                       |
| [OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value) **val     | 一个输出参数，表示指向[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)实例的指针。<br>无需申请内存和释放内存。 |
...
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| int index                                        | 表示values中目标数据的从零开始的索引。                       |
| [Data_Asset](capi-rdb-data-asset.md#data_asset) *val            | 表示指向[Data_Asset](capi-rdb-data-asset.md#data_asset)对象的指针。<br>需要申请数据内存。<br>此函数仅填充数据，否则执行失败。 |
...
| [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *values | 表示指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |
| int index                                        | 表示values中目标数据的从零开始的索引。                       |
| [Data_Asset](capi-rdb-data-asset.md#data_asset) **val           | 表示指向[Data_Asset](capi-rdb-data-asset.md#data_asset)对象的指针。<br>使用时需要申请数据内存。<br>此函数仅填充数据，否则执行失败。 |
