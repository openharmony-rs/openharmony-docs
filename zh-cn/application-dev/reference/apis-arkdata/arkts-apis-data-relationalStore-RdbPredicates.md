...
ArkTS-Dyn: limitAs(value: number): RdbPredicates
 	 
ArkTS-Sta: limitAs(value: int): RdbPredicates
...
ArkTS-Dyn: offsetAs(rowOffset: number): RdbPredicates
 	 
ArkTS-Sta: offsetAs(rowOffset: int): RdbPredicates
