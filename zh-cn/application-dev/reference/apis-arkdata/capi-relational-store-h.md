...
| 名称                                                      | typedef关键字 | 描述                                                                      |
|---------------------------------------------------------| -- |-------------------------------------------------------------------------|
| [OH_Rdb_Config](capi-rdb-oh-rdb-config.md#oh_rdb_config)              | OH_Rdb_Config | 管理关系数据库配置。                                                              |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)                | OH_Rdb_Store | 表示数据库实例。                                                                |
| [Rdb_DistributedConfig](capi-rdb-rdb-distributedconfig.md#rdb_distributedconfig) | Rdb_DistributedConfig | 记录表的分布式配置信息。                                                            |
| [Rdb_KeyInfo](capi-rdb-rdb-keyinfo.md#rdb_keyinfo)                      | Rdb_KeyInfo | 描述发生变化的行的主键或者行号。                                                        |
| [Rdb_KeyData](capi-rdb-rdb-keydata.md#rdb_keydata)                      | - | 存放变化的具体数据。                                                              |
| [Rdb_ChangeInfo](capi-rdb-rdb-changeinfo.md#rdb_changeinfo)                | Rdb_ChangeInfo | 记录端云同步过程详情。                                                             |
| [Rdb_SubscribeCallback](capi-rdb-rdb-subscribecallback.md#rdb_subscribecallback)  | Rdb_SubscribeCallback | 表示回调函数。                                                                 |
| [Rdb_DataObserver](capi-rdb-rdb-dataobserver.md#rdb_dataobserver)            | Rdb_DataObserver | 表示数据观察者。                                                                |
| [Rdb_Statistic](capi-rdb-rdb-statistic.md#rdb_statistic)                  | Rdb_Statistic | 描述数据库表的端云同步过程的统计信息。                                                     |
| [Rdb_TableDetails](capi-rdb-rdb-tabledetails.md#rdb_tabledetails)            | Rdb_TableDetails | 描述数据库表执行端云同步任务上传和下载的统计信息。                                               |
| [Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails)      | Rdb_ProgressDetails | 描述数据库整体执行端云同步任务上传和下载的统计信息。                                              |
| [Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver)    | Rdb_ProgressObserver | 端云同步进度观察者。                                                              |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)          | OH_Rdb_ConfigV2 | 管理关系数据库配置，与[OH_Rdb_Config](capi-rdb-oh-rdb-config.md#oh_rdb_config)的区别是该结构体成员变量不对外暴露，使用一系列方法配置该结构体的属性，支持向量数据库。 |
...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [OH_Rdb_ConfigV2 *OH_Rdb_CreateConfig()](#oh_rdb_createconfig) | - | 创建一个[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)实例，并返回指向该实例的指针。 |
| [int OH_Rdb_DestroyConfig(OH_Rdb_ConfigV2 *config)](#oh_rdb_destroyconfig) | - | 销毁由[OH_Rdb_CreateConfig](capi-relational-store-h.md#oh_rdb_createconfig)创建的[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)对象。 |
| [int OH_Rdb_SetDatabaseDir(OH_Rdb_ConfigV2 *config, const char *databaseDir)](#oh_rdb_setdatabasedir) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库文件路径。 |
| [int OH_Rdb_SetStoreName(OH_Rdb_ConfigV2 *config, const char *storeName)](#oh_rdb_setstorename) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库名称。 |
| [int OH_Rdb_SetBundleName(OH_Rdb_ConfigV2 *config, const char *bundleName)](#oh_rdb_setbundlename) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置应用包名。 |
| [int OH_Rdb_SetModuleName(OH_Rdb_ConfigV2 *config, const char *moduleName)](#oh_rdb_setmodulename) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置应用模块名。 |
| [int OH_Rdb_SetEncrypted(OH_Rdb_ConfigV2 *config, bool isEncrypted)](#oh_rdb_setencrypted) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库是否加密。 |
| [int OH_Rdb_SetSecurityLevel(OH_Rdb_ConfigV2 *config, int securityLevel)](#oh_rdb_setsecuritylevel) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库安全级别[OH_Rdb_SecurityLevel](capi-relational-store-h.md#oh_rdb_securitylevel)。 |
| [int OH_Rdb_SetArea(OH_Rdb_ConfigV2 *config, int area)](#oh_rdb_setarea) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库安全区域等级[Rdb_SecurityArea](capi-relational-store-h.md#rdb_securityarea)。 |
| [int OH_Rdb_SetDbType(OH_Rdb_ConfigV2 *config, int dbType)](#oh_rdb_setdbtype) | - | 给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库类型[Rdb_DBType](capi-relational-store-h.md#rdb_dbtype)。 |
...
| [OH_VObject *OH_Rdb_CreateValueObject()](#oh_rdb_createvalueobject) | - | 创建[OH_VObject](capi-rdb-oh-vobject.md#oh_vobject)实例。 |
| [OH_VBucket *OH_Rdb_CreateValuesBucket()](#oh_rdb_createvaluesbucket) | - | 创建[OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket)实例。 |
| [OH_Predicates *OH_Rdb_CreatePredicates(const char *table)](#oh_rdb_createpredicates) | - | 创建[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例。 |
| [OH_Rdb_Store *OH_Rdb_GetOrOpen(const OH_Rdb_Config *config, int *errCode)](#oh_rdb_getoropen) | - | 获得一个相关的[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例，操作关系型数据库。 |
| [OH_Rdb_Store *OH_Rdb_CreateOrOpen(const OH_Rdb_ConfigV2 *config, int *errCode)](#oh_rdb_createoropen) | - | 使用指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，获得一个对应的[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例，用来操作关系型数据库。 |
| [int OH_Rdb_CloseStore(OH_Rdb_Store *store)](#oh_rdb_closestore) | - | 销毁[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)对象，并回收该对象占用的内存。 |
| [int OH_Rdb_DeleteStore(const OH_Rdb_Config *config)](#oh_rdb_deletestore) | - | 使用指定的数据库文件配置删除数据库。 |
| [int OH_Rdb_DeleteStoreV2(const OH_Rdb_ConfigV2 *config)](#oh_rdb_deletestorev2) | - | 使用指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)删除数据库。<br>当使用向量数据库时，在调用接口前，应当确保向量数据库已经打开的OH_Rdb_Store和OH_Cursor均已成功关闭。 |
...
| 名称                            | 描述                             |
| ------------------------------ | --------------------------------- |
| DISTRIBUTED_CONFIG_VERSION 1  | 描述[Rdb_DistributedConfig](capi-rdb-rdb-distributedconfig.md#rdb_distributedconfig)的版本。<br>**起始版本：** 11 |
| DISTRIBUTED_CHANGE_INFO_VERSION 1  | 描述[Rdb_ChangeInfo](capi-rdb-rdb-changeinfo.md#rdb_changeinfo)的版本。<br>**起始版本：** 11 |
| DISTRIBUTED_PROGRESS_DETAIL_VERSION 1  | 描述[Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails)的版本。<br>**起始版本：** 11 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)实例的指针。 |
...
创建一个[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)实例，并返回指向该实例的指针。
...
销毁由[OH_Rdb_CreateConfig](capi-relational-store-h.md#oh_rdb_createconfig)创建的[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)对象。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)对象的指针，即与此RDB存储相关的数据库配置。 |
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库文件路径。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库名称。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置应用包名。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置应用模块名。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库是否加密。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库安全级别[OH_Rdb_SecurityLevel](capi-relational-store-h.md#oh_rdb_securitylevel)。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库安全区域等级[Rdb_SecurityArea](capi-relational-store-h.md#rdb_securityarea)。
...
给指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，设置数据库类型[Rdb_DBType](capi-relational-store-h.md#rdb_dbtype)。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)的指针。 |
...
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 表示此关系型数据库相关的数据库配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)的指针。 |
| const [OH_Rdb_CryptoParam](capi-rdb-oh-rdb-cryptoparam.md#oh_rdb_cryptoparam) *cryptoParam | 表示自定义加密参数。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向此RDB存储相关的数据库配置的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)实例的指针。<br>指示与此RDB存储相关的数据库的配置。 |
...
创建[OH_VObject](capi-rdb-oh-vobject.md#oh_vobject)实例。
...
| 类型 | 说明 |
| -- | -- |
| [OH_VObject](capi-rdb-oh-vobject.md#oh_vobject) * | 创建成功则返回一个指向[OH_VObject](capi-rdb-oh-vobject.md#oh_vobject)结构体实例的指针，否则返回NULL。 |
...
创建[OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket)实例。
...
创建[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例。
...
获得一个相关的[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例，操作关系型数据库。
...
| 参数项 | 描述 |
| -- | -- |
| const [OH_Rdb_Config](capi-rdb-oh-rdb-config.md#oh_rdb_config) *config | 指向[OH_Rdb_Config](capi-rdb-oh-rdb-config.md#oh_rdb_config)实例的指针，与此RDB存储相关的数据库配置。 |
...
使用指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)，获得一个对应的[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例，用来操作关系型数据库。
...
| 参数项 | 描述 |
| -- | -- |
| const [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)对象的指针，即与此RDB存储相关的数据库配置。 |
| int *errCode | 表示函数执行状态，作为出参使用。 |
...
销毁[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)对象，并回收该对象占用的内存。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| const [OH_Rdb_Config](capi-rdb-oh-rdb-config.md#oh_rdb_config) *config | 表示数据库的配置。 |
...
使用指定的数据库文件配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)删除数据库。<br>当使用向量数据库时，在调用接口前，应当确保向量数据库已经打开的OH_Rdb_Store和OH_Cursor均已成功关闭。
...
| 参数项 | 描述 |
| -- | -- |
| const [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 表示数据库的配置。 |
...
| [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *valuesBucket | 表示要插入到表中的数据行[OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket)。 |
...
| [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row                                              | 表示要插入到表中的数据。 |
...
| const [OH_Data_VBuckets](capi-rdb-oh-data-vbuckets.md#oh_data_vbuckets) *rows                        | 表示要插入到表中的一组数据。 |
| [Rdb_ConflictResolution](capi-oh-rdb-types-h.md#rdb_conflictresolution) resolution | 表示发生冲突时的解决策略。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *valuesBucket | 表示要更新到表中的数据行[OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket)。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定更新条件。 |
...
|------------------------------------------------------------------------------------| -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store                                        | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row                                              | 表示要更新到表中的数据行。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates                                 | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定更新条件。 |
| [Rdb_ConflictResolution](capi-oh-rdb-types-h.md#rdb_conflictresolution) resolution | 表示发生冲突时的解决策略。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定删除条件。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定查询条件。 |
...
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store          | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。                                                                                          |
| const char *sql                                      | 指定要执行的SQL语句。                                                                                                                            |
| const [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *args | 可选参数，指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。                                                                                                   |
| [OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value) **result                           | 执行成功时指向[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)实例的指针，作为出参使用。使用完成后，必须通过[OH_Value_Destroy](capi-oh-data-value-h.md#oh_value_destroy)接口释放内存。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 表示一个指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) 实例的指针。 |
...
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| const char *sql | 指定要执行的SQL语句。 |
| const OH_Data_Values *args | 可选参数，指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。 |

**返回：**

| 类型                             | 说明                                                         |
| -------------------------------- | ------------------------------------------------------------ |
| [OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor) * | 如果查询成功则返回一个指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)结构体实例的指针，使用完成后及时释放[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)。<br>如果SQL语句无效或内存分配失败，则返回NULL。 |
...
| const [Rdb_DistributedConfig](capi-rdb-rdb-distributedconfig.md#rdb_distributedconfig) *config | 表的分布式配置信息[Rdb_DistributedConfig](capi-rdb-rdb-distributedconfig.md#rdb_distributedconfig)。 |
...
| [OH_VObject](capi-rdb-oh-vobject.md#oh_vobject) *values | 指定要查询的行的主键。如果数据库表无主键，参数columnName需传入"rowid"，此时values为要查询的数据库表的行号。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor) * | 如果操作成功则返回一个指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)结构体实例的指针，否则返回NULL。 |
...
| -- | -- |
| void *context | 表示数据观察者的上下文。 |
|  const [Rdb_ChangeInfo](capi-rdb-rdb-changeinfo.md#rdb_changeinfo) **changeInfo | 表示已更改表的信息[Rdb_ChangeInfo](capi-rdb-rdb-changeinfo.md#rdb_changeinfo)。 |
...
| const [Rdb_DataObserver](capi-rdb-rdb-dataobserver.md#rdb_dataobserver) *observer | 数据库中更改事件的观察者[Rdb_DataObserver](capi-rdb-rdb-dataobserver.md#rdb_dataobserver)。 |
...
| const [Rdb_DataObserver](capi-rdb-rdb-dataobserver.md#rdb_dataobserver) *observer | 数据库中更改事件的观察者[Rdb_DataObserver](capi-rdb-rdb-dataobserver.md#rdb_dataobserver)。如果这是nullptr，表示删除该类型的所有观察者。 |
...
| 参数项 | 描述                                                         |
| -- |------------------------------------------------------------|
| [Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails) *progress | 指向[Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails)实例的指针。                           |
| int32_t version | 表示当前[Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails)的版本。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [Rdb_TableDetails](capi-rdb-rdb-tabledetails.md#rdb_tabledetails) | 如果操作成功，会返回一个[Rdb_TableDetails](capi-rdb-rdb-tabledetails.md#rdb_tabledetails)结构体的指针，否则返回NULL。 |
...
| [Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails) *progressDetails | 端云同步进度的详细信息。 |
...
| 参数项 | 描述 |
| -- | -- |
| [Rdb_ProgressDetails](capi-rdb-rdb-progressdetails.md#rdb_progressdetails) *progressDetails | 数据库端云同步的统计信息。 |
...
| const [Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver) *observer | 端云同步进度的观察者[Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver)。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向目标[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| const [Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver) *observer | 用于自动同步进度的观察者[Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver)。表示调用返回自动同步进度的回调。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向目标[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| const [Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver) *observer | 表示自动同步进度的观察者[Rdb_ProgressObserver](capi-rdb-rdb-progressobserver.md#rdb_progressobserver)。如果是空指针，则自动同步进程的所有回调都将被取消注册。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定锁定条件。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针，指定解锁条件。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| const [OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions) *options | 指向[OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions)实例的指针。 |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) **trans | 输出参数，表示执行成功时指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。否则返回nullptr。<br>使用完成后，必须通过[OH_RdbTrans_Destroy](capi-oh-rdb-transaction-h.md#oh_rdbtrans_destroy)接口释放内存。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| const [OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向与此RDB存储相关的数据库配置[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)的指针。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_Rdb_CryptoParam](capi-rdb-oh-rdb-cryptoparam.md#oh_rdb_cryptoparam) *param | 指向[OH_Rdb_CryptoParam](capi-rdb-oh-rdb-cryptoparam.md#oh_rdb_cryptoparam)实例的指针。 |
...
| [ OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2) *config | 指向[OH_Rdb_ConfigV2](capi-rdb-oh-rdb-configv2.md#oh_rdb_configv2)对象的指针，即与此RDB存储相关的数据库配置，不可在回调函数外部使用。 |
| [ OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针，该指针由系统产生，回调函数结束后即刻释放，不可在回调函数外部使用。 |
...
| 类型 | 说明 |
| -- | -- |
| [OH_Cursor *](capi-rdb-oh-cursor.md#oh_cursor) | 如果查询成功则返回一个指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)结构体实例的指针。如果获取store失败或结果集为空，则返回nullptr。 |
...
| [const OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *args | 指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)实例的指针。SQL语句完整时，args可填写为nullptr。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor) * | 如果查询成功则返回一个指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)结构体实例的指针。如果SQL语句无效或内存分配失败，则返回nullptr。 |
...
| [const OH_Data_VBuckets](capi-rdb-oh-data-vbuckets.md#oh_data_vbuckets) *rows | 要插入到表中的行数据。 |
...
| [OH_RDB_ReturningContext](capi-rdb-oh-rdb-returningcontext.md#oh_rdb_returningcontext) *context | 指向[OH_RDB_ReturningContext](capi-rdb-oh-rdb-returningcontext.md#oh_rdb_returningcontext)实例的指针。 |
...
| -- | -- |
| [OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store) *store | 指向[OH_Rdb_Store](capi-rdb-oh-rdb-store.md#oh_rdb_store)实例的指针。 |
| [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row | 要更新到表中的行数据。 |
| [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 指向[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)实例的指针。 |
| [Rdb_ConflictResolution](capi-oh-rdb-types-h.md#rdb_conflictresolution) resolution | 发生冲突时的解决策略Rdb_ConflictResolution，不建议使用RDB_CONFLICT_FAIL，因为失败时会抛异常，<br>无法正常获取实际的变更数据。 |
| [OH_RDB_ReturningContext](capi-rdb-oh-rdb-returningcontext.md#oh_rdb_returningcontext) *context | 指向[OH_RDB_ReturningContext](capi-rdb-oh-rdb-returningcontext.md#oh_rdb_returningcontext)实例的指针。 |
