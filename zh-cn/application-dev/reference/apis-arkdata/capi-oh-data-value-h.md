...
| 名称                                   | typedef关键字 | 描述                                                 |
| -------------------------------------- | ------------- | ---------------------------------------------------- |
| [OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value) | OH_Data_Value | 定义[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)结构类型。 |
...
销毁[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)对象。
...
| size_t length                                        | 该参数是输入参数，表示开发者传入的[Data_Asset](capi-rdb-data-asset.md#data_asset)对象数组元素的个数。 |
