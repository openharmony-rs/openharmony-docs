...
| fileType   | string | 否   | 否  | 文件类型（必须是预置或自定义UTD类型，详情参考[标准化数据类型](../../database/uniform-data-type-descriptors.md)）。fileType最大长度限制为1024个字节，超出限制时抛出异常。<br/>**ArkTS-Dyn起始版本**：15<br/>**ArkTS-Sta起始版本**：23<br/>|
