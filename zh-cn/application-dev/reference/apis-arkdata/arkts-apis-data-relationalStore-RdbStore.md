...
| callback   | ArkTS-Dyn: AsyncCallback&lt;Array&lt;[string, number]&gt;&gt;<br/>ArkTS-Sta: AsyncCallback&lt;Array&lt;[string, int]&gt;&gt; | 是   | 指定的callback回调函数，用于向调用者发送同步结果。string：设备ID；number或int：每个设备同步状态，0表示成功，1表示失败。 |
