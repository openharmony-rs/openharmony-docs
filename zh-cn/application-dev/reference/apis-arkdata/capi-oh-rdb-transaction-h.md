...
| 名称                                               | typedef关键字       | 描述                                                         |
| -------------------------------------------------- | ------------------- | ------------------------------------------------------------ |
| [OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions) | OH_RDB_TransOptions | 定义[OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions)结构类型。 |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)   | OH_Rdb_Transaction  | 定义[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)结构类型。 |
...
| 类型                                               | 说明                                                         |
| -------------------------------------------------- | ------------------------------------------------------------ |
| [OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions) | 执行成功时返回指向[OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions)实例的指针。否则返回nullptr。<br>使用完成后，必须通过[OH_RdbTrans_DestroyOptions](capi-oh-rdb-transaction-h.md#oh_rdbtrans_destroyoptions)接口释放内存。 |
...
| 参数项                                                      | 描述                                                         |
| ----------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions) *options | 指向[OH_RDB_TransOptions](capi-rdb-oh-rdb-transoptions.md#oh_rdb_transoptions)实例的指针。 |
...
| 参数项                                                  | 描述                                                         |
| ------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
...
| const [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row             | 要插入到表中的数据行。                                   |
...
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const char *table                                       |  要插入的目标表名。                                             |
| const [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row             | 表示要插入到表中的数据。                                     |
...
| -------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans  | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row              | 表示要更新到表中的数据行。                                   |
| const [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 表示[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)指定的更新条件。   |
...
| -------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans  | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const [OH_VBucket](capi-rdb-oh-vbucket.md#oh_vbucket) *row              | 表示要更新到表中的数据。                                     |
| const [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 表示[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)指定的更新条件。   |
| [Rdb_ConflictResolution](capi-oh-rdb-types-h.md#rdb_conflictresolution) resolution                        | 表示发生冲突时的解决策略。                                   |
...
| -------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans  | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 表示[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)指定的删除条件。   |
...
| -------------------------------------------------------- | ------------------------------------------------------------ |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans  | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | 表示[OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)指定的查询条件。   |
...
| 类型                           | 说明                                                         |
| ------------------------------ | ------------------------------------------------------------ |
| [OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor) | 如果执行成功，则返回指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)实例的指针。如果数据库已关闭或数据库没有响应，则返回空。 |
...
| const [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *args    | 指向[OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values)的指针。     |
...
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| const char *sql                                         | 表示要执行的SQL语句。                                        |
| const [OH_Data_Values](capi-rdb-oh-data-values.md#oh_data_values) *args    | SQL语句中包含的参数。                                        |
| OH_Data_Value **result                                  | 执行成功时指向[OH_Data_Value](capi-rdb-oh-data-value.md#oh_data_value)实例的指针。使用完成后，必须通过[OH_Value_Destroy](capi-oh-data-value-h.md#oh_value_destroy)接口释放内存。 |
...
| -- | -- |
| [OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction) *trans | 指向[OH_Rdb_Transaction](capi-rdb-oh-rdb-transaction.md#oh_rdb_transaction)实例的指针。 |
| [const OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates) *predicates | [OH_Predicates](capi-rdb-oh-predicates.md#oh_predicates)指定的查询条件。 |
...
| 类型 | 说明 |
| -- | -- |
| [OH_Cursor *](capi-rdb-oh-cursor.md#oh_cursor) | 如果执行成功，则返回指向[OH_Cursor](capi-rdb-oh-cursor.md#oh_cursor)实例的指针。如果数据库已关闭或数据库没有响应，则返回nullptr。 |
