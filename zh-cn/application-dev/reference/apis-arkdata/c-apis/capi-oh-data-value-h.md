...
| 名称 | typedef关键字 | 描述 |
| -- | -- | -- |
| [OH_Data_Value](capi-rdb-oh-data-value.md) | OH_Data_Value | OH_Data_Value结构类型，用于存储单条数据值。 |
...
| 名称 | 描述 |
| -- | -- |
| [OH_Data_Value *OH_Value_Create(void)](#oh_value_create) | 创建[OH_Data_Value](capi-rdb-oh-data-value.md)实例，用于存储单条键值对数据。 |
...
| 枚举项 | 描述 |
| -- | -- |
| TYPE_NULL = 0 | 表示NULL类型。<br>**起始版本：** 10 |
| TYPE_INT64 | 表示INT64数据类型。<br>**起始版本：** 10 |
| TYPE_REAL | 表示REAL数据类型。<br>**起始版本：** 10 |
| TYPE_TEXT | 表示TEXT数据类型。<br>**起始版本：** 10 |
| TYPE_BLOB | 表示BLOB数据类型。<br>**起始版本：** 10 |
