...
| UDMF_META_PPT "com.microsoft.powerpoint.ppt" | Microsoft PowerPoint演示文稿类型，归属类型为<br>**起始版本：** 12 |
...
| UDMF_META_OPENHARMONY_HINOTE "openharmony.hinote" | 系统定义的笔记数据类型，归属类型为COMPOSITE_OBJECT。<br>**起始版本：** 12 |
