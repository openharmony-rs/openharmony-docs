...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| values | [collections.Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)&lt;[ValueType](arkts-arkdata-sendablerelationalstore-valuetype-t.md)&gt; | 是 | 可跨线程传递的数组数据。 |
