...
| valueBuckets | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<ValuesBucket> | 是 | 指示要批量插入的数据。 |
...
| predicates | dataSharePredicates.DataSharePredicates | 是 | 指示筛选条件。 |
| columns | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | 指示要查询的列。如果此参数为空，则查询所有列。 |
