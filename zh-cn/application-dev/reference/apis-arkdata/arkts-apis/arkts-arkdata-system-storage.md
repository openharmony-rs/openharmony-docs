...
> **说明：**
 ...
 >
 > - 对于支持该模块的其他设备类型，该模块从API version 6开始不再维护，可以使用模块[`@ohos.data.storage`](arkts-arkdata-data-storage.md)。在API
 > version 9后，推荐使用新模块[`@ohos.data.preferences`](arkts-arkdata-data-preferences.md)。
 >
 > - 本模块接口仅可在FA模型下使用。
 >
