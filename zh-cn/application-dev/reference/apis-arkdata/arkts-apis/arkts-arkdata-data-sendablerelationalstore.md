...
| 名称 | 说明 |
| --- | --- |
| [Asset](arkts-arkdata-sendablerelationalstore-asset-i.md) | 记录资产附件（文件、图片、视频等类型文件）的相关信息。用于支持资产数据跨线程传递，继承自lang.ISendable。资产类型的相关接口暂不支持Datashare。使用[sendableRelationalStore.toSendableAsset](arkts-arkdata-sendablerelationalstore-tosendableasset-f.md)方法创建。 |
