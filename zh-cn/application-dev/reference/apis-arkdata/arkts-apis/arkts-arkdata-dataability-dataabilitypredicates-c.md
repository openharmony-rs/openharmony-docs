...
设置谓词查询结果的起始位置。需要同步调用[limitAs]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口指定查询数量，否则无查询结果。查询指定偏移位置后的所有行时， [limitAs]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口需传入参数-1。
