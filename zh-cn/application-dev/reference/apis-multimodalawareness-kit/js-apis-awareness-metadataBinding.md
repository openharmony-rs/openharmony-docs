...
**相关接口：** 该接口对应的ArkTS-Sta版本接口是[onOperationSubmitMetadata](#metadataBindingonOperationSubmitMetadata23)。
...
**相关接口：** 该接口对应的ArkTS-Sta版本接口是[offOperationSubmitMetadata](#metadataBindingoffOperationSubmitMetadata23)。
...
**相关接口：** 该接口对应的ArkTS-Dyn版本接口是[on('operationSubmitMetadata')](#metadatabindingonoperationsubmitmetadata)。
...
**相关接口：** 该接口对应的ArkTS-Dyn版本接口是[off('operationSubmitMetadata')](#metadatabindingoffoperationsubmitmetadata)。
