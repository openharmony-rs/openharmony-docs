...
| [incrementalVersion](arkts-basicservices-deviceinfo-con.md#incrementalversion) | 差异版本号，是编译时生成的ohos的版本号。  示例：default |
...
| [sdkMinorApiVersion](arkts-basicservices-deviceinfo-con.md#sdkminorapiversion) | 系统软件Minor API版本。从API 26 版本开始，系统API版本格式：sdkApiVersion.sdkMinorApiVersion.sdkPatchApiVersion。  26.0.0  示例：0 |
