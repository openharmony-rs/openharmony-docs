...
| [4900201](../../apis-basic-services-kit/errorcode-power.md#4900201-接口调用间隔过短) | The device activity is being refreshed too frequently; the minimum timeinterval is 100 ms. |
