...
为指定应用程序申请访问USB配件的访问权限。使用Promise异步回调。 需要调用[usbManager.getAccessoryList]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取配件列表，得到 [USBAccessory]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_作为参数。
