...
表示操作，隐式添加账号。 **说明：**从API version 8开始支持，从API version 9开始废弃，建议使用ACTION\_CREATE\_ACCOUNT\_IMPLICITLY替代。
...
表示操作，鉴权。 **说明：**从API version 8开始支持，从API version 9开始废弃，建议使用ACTION\_AUTH替代。
