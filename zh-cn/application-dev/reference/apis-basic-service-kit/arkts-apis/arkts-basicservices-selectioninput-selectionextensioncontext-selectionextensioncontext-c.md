...
SelectionExtensionContext是 [SelectionExtensionAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的上下文，继承自 [ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。 每个SelectionExtensionAbility组件实例化时，系统都会自动创建对应的SelectionExtensionContext。开发者可以通过SelectionExtensionContext拉起同应用内其他 Ability。 > **说明：** > - 本模块仅支持PC/2in1设备。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| want | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 想要被拉起的应用信息，包括Ability名称、Bundle名称等。 |
