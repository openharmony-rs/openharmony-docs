...
| [getDeviceFunctions](arkts-basicservices-usbmanager-getdevicefunctions-f-sys.md#getDeviceFunctions（系统接口）) | Obtains the numeric mask combination for the current USB function list in Device mode. |
...
| [getStringFromFunctions](arkts-basicservices-usbmanager-getstringfromfunctions-f-sys.md#getStringFromFunctions（系统接口）) | Converts the numeric mask combination of a given USB function list to a string descriptor. |
...
| [setDeviceFunctions](arkts-basicservices-usbmanager-setdevicefunctions-f-sys.md#setDeviceFunctions（系统接口）) | Sets the current USB function list in Device mode. |
