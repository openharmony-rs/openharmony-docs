...
- FA模型下使用
[Context.getCacheDir](../../../../reference/apis-ability-kit/js-apis-inner-app-context.md#contextgetcachedir)方法获取应用
存储路径。
...
设置允许下载的网络类型，通过
[网络类型常量](../../../../reference/apis-basic-services-kit/js-apis-request.md#constants)的位运算方式决定允许
的网络类型，支持如下几种设置方式:
