...
| callback | Callback&lt;SelectionInfo&gt; | 是 | 回调函数，返回当前划词信息。<br/>该回调仅在用户通过鼠标或触控板选中文本（鼠标左键双击/三击/按下滑动）后按下Ctrl键时触发。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [33600003](../../errorcode-universal.md#33600003-The) | The application calling the API does not match the application<br/>selected in the system settings. |
