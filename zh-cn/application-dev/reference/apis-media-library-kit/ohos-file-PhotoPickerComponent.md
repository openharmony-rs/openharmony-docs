...
| duration   | number                | 否 | 是   | 视频的持续时间（单位：毫秒）。<br>**注意：**<br>在API version 24之前动图duration返回0，异常情况返回-1。<br>API version 24开始新动图duration返回动图的对应时长，未处理旧动图返回0，异常场景仍然返回-1。<br>当[ItemType](#itemtype)为THUMBNAIL时支持，否则为空。<br>**原子化服务API**：从API version 12开始，该接口支持在原子化服务中使用。 |
