...
| [duration](./arkts-apis-photoAccessHelper-e.md#photokeys)   | number                | 否 | 是   | 持续时间（单位：毫秒）。<br>当[ItemType](#itemtype)为THUMBNAIL时支持，否则为空。<br>**原子化服务API**：从API version 12开始，该接口支持在原子化服务中使用。 |
