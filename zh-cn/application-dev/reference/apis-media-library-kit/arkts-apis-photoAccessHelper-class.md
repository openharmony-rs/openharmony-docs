...
| contextRecoveryInfo<sup>21+</sup>         | [ContextRecoveryInfo](#contextrecoveryinfo21)    | 是   | 返回图库选择后的媒体文件是否为原图。true为是原图，false为不是原图，默认值是false。<br>**原子化服务API：** 从API version 21开始，该接口支持在原子化服务中使用。 |
