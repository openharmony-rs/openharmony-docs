...
> - 如果需要重复拉起PhotoViewPicker，需要先销毁创建的前一个PhotoViewPicker。销毁能力支持： 跟随[NavDestination](../../../application-dev/reference/apis-arkui/arkui-ts/ts-basic-components-navdestination.md)销毁的能力和跟随进程销毁的能力。
