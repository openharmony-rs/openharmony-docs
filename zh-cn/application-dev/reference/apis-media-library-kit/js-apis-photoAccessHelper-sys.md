...
返回的文件描述符在使用完毕后需要调用[fileIo.close](../apis-core-file-kit/js-apis-file-fs.md#fileioclose)进行释放。
若涉及Pending文件场景可调用[close](arkts-apis-photoAccessHelper-PhotoAsset.md#closedeprecated-1)进行释放。
