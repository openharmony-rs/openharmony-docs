...
| :------- | :-------------------------------- |
| 201 | Permission verification failed. The application does not have the permission required to call the API. |
| 401 | Parameter error. Possible causes:<br>1.Parameter count mismatch or invalid PhotoAsset object;<br>2.Input title is invalid. |
...
| 错误码ID | 错误信息 |
| -------- | ---------------------------------------- |
| 401 | Parameter error. Possible causes:<br>1.Invalid number of parameters, expected 0 or 1 parameter;<br>2.System internal error, possible causes: 1. Database exception; 2. File system exception; 3. IPC timeout. Please retry and check logs;<br>3.The PhotoAsset is not a valid PhotoAsset object. |
| 201 | Permission verification failed. The application does not have the permission required to call the API. |
