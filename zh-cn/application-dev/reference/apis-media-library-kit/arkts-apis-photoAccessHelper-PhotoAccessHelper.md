...
| photoCreationConfigs | Array&lt;[PhotoCreationConfig](arkts-apis-photoAccessHelper-i.md#photocreationconfig12)&gt; | 是 | 其中[photoAccessHelper.PhotoCreationConfig.subtype](arkts-apis-photoAccessHelper-i.md#photocreationconfig12)当前仅支持DEFAULT，后续API版本中会提供优化该参数的接口。 |
...
| 参数名   | 类型                                                                   | 必填 | 说明                      |
| -------- |----------------------------------------------------------------------| ---- | ------------------------- |
| photoCreationConfig | [PhotoCreationConfig](arkts-apis-photoAccessHelper-i.md#photocreationconfig12); | 是 | 其中[photoAccessHelper.PhotoCreationConfig.subtype](arkts-apis-photoAccessHelper-i.md#photocreationconfig12)当前仅支持DEFAULT，后续API版本中会提供优化该参数的接口。 |
