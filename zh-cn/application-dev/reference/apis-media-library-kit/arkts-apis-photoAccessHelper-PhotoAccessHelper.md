...
type PhotoAssetParams = Record<string, [MemberType](arkts-apis-photoAccessHelper-t.md#membertype)>[]

定义PhotoKey与文件PhotoKey值的Record.

| 参数| 类型 | 说明 |
| ---- | ---- | ---- |
| 参数1 | string | 要获取的photoKey |
| 参数2 | MemberType |asset对应photoKey的值 |
...
| 参数名  | 类型    | 必填 | 说明                       |
| ------- | ------- | ---- | -------------------------- |
| assets | PhotoAsset[] | 是   | 指定的photoAsset数组 |
| members | string[] | 是   | 获取photoAsset对应的photoKeys|
...
| 类型                                    | 说明              |
| --------------------------------------- | ----------------- |
| [PhotoAssetParams](arkts-apis-photoAccessHelper-PhotoAccessHelper.md#photoassetparams21)| 所用assets对应keys的值。 |
