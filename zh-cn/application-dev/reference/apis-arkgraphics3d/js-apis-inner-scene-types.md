...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| x | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | x轴分量，取值范围是实数。 |
| y | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | y轴分量，取值范围是实数。|
...
| x | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | x轴分量，取值范围是实数。 |
| y | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | y轴分量，取值范围是实数。 |
| z | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | z轴分量，取值范围是实数。 |
...
| y | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | y轴分量，取值范围是实数。 |
| z | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | z轴分量，取值范围是实数。 |
| w | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | w轴分量，取值范围是实数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| r | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 红色分量，取值范围是[0, 1]。 |
| g | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 绿色分量，取值范围是[0, 1]。 |
| b | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 蓝色分量，取值范围是[0, 1]。 |
| a | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 透明度分量，取值范围是[0, 1]。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| ---- | ---- | ---- | ---- | ---- |
| x | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 矩形左下角x轴分量，单位为所属坐标系的单位长度，取值为任意实数，具体范围依赖场景坐标系设置。 |
| y | ArkTS1.1: number<br>ArkTS1.2: double | 否 | 否 | 矩形左下角y轴分量，单位为所属坐标系的单位长度，取值为任意实数，具体范围依赖场景坐标系设置。 |
