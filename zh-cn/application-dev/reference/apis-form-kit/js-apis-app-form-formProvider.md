...
try {
  formProvider.setFormNextRefreshTime(formId2, 3).then(() => {
    ...
    console.error('testTag', `XtsFormProvider promise error, code: ${error.code}, message: ${error.message}`);
  });
  console.info('testTag', 'XtsFormProvider setFormNextRefreshTime register success');
} catch (err) {
  let error = err as BusinessError;
  console.error('testTag', `XtsFormProvider catch error, code: ${error.code}, message: ${error.message}`);
}
```
...
try {
  formProvider.getPublishedFormInfoById(formId).then((data: formInfo.FormInfo) => {
    console.info(`formProvider getPublishedFormInfoById, bundleName: ${data.bundleName}`);
  }).catch((error: BusinessError) => {
    console.error(`promise error, code: ${error.code}, message: ${error.message})`);
  });
} catch (error) {
...
try {
  formProvider.getPublishedFormInfos().then((data: formInfo.FormInfo[]) => {
    console.info(`formProvider getPublishedFormInfos, item count: ${data.length}`);
  }).catch((error: BusinessError) => {
    console.error(`promise error, code: ${error.code}, message: ${error.message})`);
  });
} catch (error) {
...
try {
  ...
  console.info('testTag',
    `requestOverflow err: code is ${(error as BusinessError).code}, message ${(error as BusinessError).message}`);
}
```
...
try {
  ...
  console.error('testTag',
    `cancelOverflow err: code is ${(error as BusinessError).code}, message ${(error as BusinessError).message}`);
}
```
...
try {
  formProvider.getFormRect(formId).then((data: formInfo.Rect) => {
    console.info(`getFormRect succeed, width: ${data.width} height: ${data.height}`);
  });
} catch (error) {
  console.error(`catch error, code: ${(error as BusinessError).code}, message: ${(error as BusinessError).message})`);
}
...
try {
  ...
  console.error('testTag',
    `getFormRect err: code is ${(error as BusinessError).code}, message ${(error as BusinessError).message}`);
}
```
