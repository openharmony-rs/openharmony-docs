...
卡片配置信息。可通过[getFormsInfo](js-apis-app-form-formHost.md#getformsinfo)接口获取，用于查询和管理已安装的卡片信息。
...
> **说明：**
>
> 从 API version 9开始支持，从API version 20开始废弃。此接口已完全移除，无替代方案。
...
卡片状态信息。用于在卡片状态变化时获取卡片的当前状态和相关参数，常用于卡片生命周期管理。
