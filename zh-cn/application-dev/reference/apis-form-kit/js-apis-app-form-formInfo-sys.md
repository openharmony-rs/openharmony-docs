...
| FORM_FONT_SIZE_SCALE_KEY<sup>26+</sup>    | 'ohos.extra.param.key.form_font_size_scale'   | 卡片字体大小缩放键值。 <br>**系统接口：** 此接口为系统接口。  |
| FORM_FONT_WEIGHT_SCALE_KEY<sup>26+</sup>    | 'ohos.extra.param.key.form_font_weight_scale'   | 卡片字重缩放键值。 <br>**系统接口：** 此接口为系统接口。  |
