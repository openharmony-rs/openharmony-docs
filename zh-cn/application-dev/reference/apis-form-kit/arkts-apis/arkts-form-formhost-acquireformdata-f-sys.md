...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Record&lt;string, Object&gt;&gt; | 是 | 以callback方式返回接口运行结果及卡片提供方数据。<br>**适用版本：** 11 |
