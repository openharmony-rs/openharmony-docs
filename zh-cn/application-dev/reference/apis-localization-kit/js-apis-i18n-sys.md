...
| latitude        | ArkTS-Dyn:number<br> ArkTS-Sta:double          |   否    |   否    | 城市纬度坐标，单位为度（°）。<br>**ArkTS-Dyn起始版本**：26.0.1<br>**ArkTS-Sta起始版本**：26.0.1<br>**模型约束**：此接口仅可在Stage模型下使用。        |
| longitude       | ArkTS-Dyn:number<br> ArkTS-Sta:double          |   否    |   否    | 城市经度坐标，单位为度（°）。<br>**ArkTS-Dyn起始版本**：26.0.1<br>**ArkTS-Sta起始版本**：26.0.1<br>**模型约束**：此接口仅可在Stage模型下使用。        |
