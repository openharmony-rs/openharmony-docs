...
| 名称                        | 类型                            | 只读 | 可选 | 说明               |
| --------------------------- | ------------------------------- | ---- | ---- | ------------------ |
| direction                   | [Direction](#direction)         | 否   | 否   | 屏幕方向。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 6<br>**ArkTS-Sta起始版本：** 23         |
| locale                      | string                          | 否   | 否   | 语言文字国家地区。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 6<br>**ArkTS-Sta起始版本：** 23 |
| deviceType<sup>12+</sup>    | [DeviceType](#devicetype)       | 否   | 否   | 设备类型。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23         |
| screenDensity<sup>12+</sup> | [ScreenDensity](#screendensity) | 否   | 否   | 屏幕密度。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23         |
| colorMode<sup>12+</sup>     | [ColorMode](#colormode12)       | 否   | 否   | 颜色模式。 <br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23        |
| mcc<sup>12+</sup>           | ArkTS-Dyn: number </br> ArkTS-Sta: int | 否   | 否   | 移动国家码。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23       |
| mnc<sup>12+</sup>           | ArkTS-Dyn: number </br> ArkTS-Sta: int | 否   | 否   | 移动网络码。<br>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23       |
...
ArkTS-Dyn: getStringSync(resId: number, ...args: Array<string | number>): string

ArkTS-Sta: getStringSync(resId: long, ...args: (string | double)[]): string
...
| args | ArkTS-Dyn: Array<string \| number><br>ArkTS-Sta: (string \| double)[]| 否 | 格式化字符串资源参数。支持的参数类型包括`%d`、`%f`、`%s`、`%%`、`%数字$d`、`%数字$f`和`%数字$s`。<br>**说明：**<br>- `%%`转义为`%`，如`%%d`格式化后为`%d`。<br>- `%数字$d`中的数字表示参数索引，从`1`开始计数。如`%1$d`表示使用`args[0]`格式化，`%2$d`表示使用`args[1]`格式化，依此类推。|
...
| 错误码ID | 错误信息 |
| -------- | ---------------------------------------- |
| 401 | Parameter error. Possible causes: Incorrect parameter types.<br/>**ArkTS模式：** 该错误码仅适用于ArkTS-Dyn。  |
| 9001001  | Invalid resource ID.                               |
| 9001002  | No matching resource is found based on the resource ID.                 |
| 9001006  | The resource is referenced cyclically.                    |
...
ArkTS-Dyn: getStringByNameSync(resName: string, ...args: Array<string | number>): string

ArkTS-Sta: getStringByNameSync(resName: string, ...args: (string | double)[]): string
...
ArkTS-Dyn: getStringValue(resId: number, callback: _AsyncCallback&lt;string&gt;): void

ArkTS-Sta: getStringValue(resId: long, callback: _AsyncCallback&lt;string&gt;): void
...
ArkTS-Dyn: getStringValue(resId: number): Promise&lt;string&gt;

ArkTS-Sta: getStringValue(resId: long): Promise&lt;string&gt;
...
ArkTS-Dyn: getStringArrayValueSync(resId: number): Array&lt;string&gt;

ArkTS-Sta: getStringArrayValueSync(resId: long): Array&lt;string&gt;
...
ArkTS-Dyn: getStringArrayValue(resId: number, callback: _AsyncCallback&lt;Array&lt;string&gt;&gt;): void

ArkTS-Sta: getStringArrayValue(resId: long, callback: _AsyncCallback&lt;Array&lt;string&gt;&gt;): void
...
ArkTS-Dyn: getStringArrayValue(resId: number): Promise&lt;Array&lt;string&gt;&gt;

ArkTS-Sta: getStringArrayValue(resId: long): Promise&lt;Array&lt;string&gt;&gt;
...
ArkTS-Dyn: getIntPluralStringValueSync(resId: number, num: number, ...args: Array<string | number>): string

ArkTS-Sta: getIntPluralStringValueSync(resId: long, num: int, ...args: (string | double)[]): string
...
| ------- | ----------------------- | ---- | ------------------------------------------------------------ |
| resId   | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是   | 资源ID值。                                                   |
| num     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 数量值（整数）。根据当前语言的[单复数规则](https://www.unicode.org/cldr/charts/45/supplemental/language_plural_rules.html)获取该数量值对应的字符串。 |
| args | ArkTS-Dyn: Array<string \| number><br>ArkTS-Sta: (string \| double)[]| 否   | 格式化字符串资源参数。支持的参数类型包括`%d`、`%f`、`%s`、`%%`、`%数字$d`、`%数字$f`和`%数字$s`。<br>**说明：**<br>- `%%`转义为`%`，如`%%d`格式化后为`%d`。<br>- `%数字$d`中的数字表示参数索引，从`1`开始计数。如`%1$d`表示使用`args[0]`格式化，`%2$d`表示使用`args[1]`格式化，依此类推。 |
...
ArkTS-Dyn: getIntPluralStringByNameSync(resName: string, num: number, ...args: Array<string | number>): string

ArkTS-Sta: getIntPluralStringByNameSync(resName: string, num: int, ...args: (string | double)[]): string
...
ArkTS-Dyn: getDoublePluralStringValueSync(resId: number, num: number, ...args: Array<string | number>): string

ArkTS-Sta: getDoublePluralStringValueSync(resId: long, num: double, ...args: (string | double)[]): string
...
| ------- | ----------------------- | ---- | ------------------------------------------------------------ |
| resId   | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是   | 资源ID值。                                                   |
| num     | ArkTS-Dyn: number<br>ArkTS-Sta: double| 是   | 数量值（浮点数）。根据当前语言的[单复数规则](https://www.unicode.org/cldr/charts/45/supplemental/language_plural_rules.html)获取该数量值对应的字符串。 |
| args | ArkTS-Dyn: Array<string \| number><br>ArkTS-Sta: (string \| double)[] | 否   | 格式化字符串资源参数。支持的参数类型包括`%d`、`%f`、`%s`、`%%`、`%数字$d`、`%数字$f`和`%数字$s`。<br>**说明：**<br>- `%%`转义为`%`，如`%%d`格式化后为`%d`。<br>- `%数字$d`中的数字表示参数索引，从`1`开始计数。如`%1$d`表示使用`args[0]`格式化，`%2$d`表示使用`args[1]`格式化，依此类推。 |
...
ArkTS-Dyn: getDoublePluralStringByNameSync(resName: string, num: number, ...args: Array<string | number>): string

ArkTS-Sta: getDoublePluralStringByNameSync(resName: string, num: double, ...args: (string | double)[]): string
...
ArkTS-Dyn: getMediaContentSync(resId: number, density?: number): Uint8Array

ArkTS-Sta: getMediaContentSync(resId: long, density?: int): Uint8Array
...
| ----- | ------ | ---- | ----- |
| resId | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是    | 资源ID值。 |
| density | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否    | 资源获取需要的屏幕密度，0或缺省表示默认屏幕密度。取值具体请参考枚举[ScreenDensity](#screendensity)。 |
...
ArkTS-Dyn: getMediaByNameSync(resName: string, density?: number): Uint8Array

ArkTS-Sta: getMediaByNameSync(resName: string, density?: int): Uint8Array
...
ArkTS-Dyn: getMediaContent(resId: number, callback: _AsyncCallback&lt;Uint8Array&gt;): void

ArkTS-Sta: getMediaContent(resId: long, callback: _AsyncCallback&lt;Uint8Array&gt;): void
...
ArkTS-Dyn: getMediaContent(resId: number, density: number, callback: _AsyncCallback&lt;Uint8Array&gt;): void

ArkTS-Sta: getMediaContent(resId: long, density: int, callback: _AsyncCallback&lt;Uint8Array&gt;): void
...
| -------- | ------------------------------- | ---- | ------------------ |
| resId    | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是    | 资源ID值。              |
| density  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是    | 资源获取需要的屏幕密度，0表示默认屏幕密度。取值具体请参考枚举[ScreenDensity](#screendensity)。    |
| callback | [_AsyncCallback](../apis-basic-services-kit/js-apis-base.md#asynccallback)&lt;Uint8Array&gt; | 是    | 回调函数，返回资源ID对应的媒体文件内容。 |
...
ArkTS-Dyn: getMediaContent(resId: number): Promise&lt;Uint8Array&gt;

ArkTS-Sta: getMediaContent(resId: long): Promise&lt;Uint8Array&gt;
...
ArkTS-Dyn: getMediaContent(resId: number, density: number): Promise&lt;Uint8Array&gt;

ArkTS-Sta: getMediaContent(resId: long, density: int): Promise&lt;Uint8Array&gt;
...
ArkTS-Dyn: getMediaByName(resName: string, density: number, callback: _AsyncCallback&lt;Uint8Array&gt;): void

ArkTS-Sta: getMediaByName(resName: string, density: int, callback: _AsyncCallback&lt;Uint8Array&gt;): void
...
ArkTS-Dyn: getMediaByName(resName: string, density: number): Promise&lt;Uint8Array&gt;

ArkTS-Sta: getMediaByName(resName: string, density: int): Promise&lt;Uint8Array&gt;
...
ArkTS-Dyn: getMediaContentBase64Sync(resId: number, density?: number): string

ArkTS-Sta: getMediaContentBase64Sync(resId: long, density?: int): string
...
ArkTS-Dyn: getMediaBase64ByNameSync(resName: string, density?: number): string

ArkTS-Sta: getMediaBase64ByNameSync(resName: string, density?: int): string
...
ArkTS-Dyn: getMediaContentBase64(resId: number, callback: _AsyncCallback&lt;string&gt;): void

ArkTS-Sta: getMediaContentBase64(resId: long, callback: _AsyncCallback&lt;string&gt;): void
...
ArkTS-Dyn: getMediaContentBase64(resId: number, density: number, callback: _AsyncCallback&lt;string&gt;): void

ArkTS-Sta: getMediaContentBase64(resId: long, density: int, callback: _AsyncCallback&lt;string&gt;): void
...
ArkTS-Dyn: getMediaContentBase64(resId: number): Promise&lt;string&gt;

ArkTS-Sta: getMediaContentBase64(resId: long): Promise&lt;string&gt;
...
ArkTS-Dyn: getMediaContentBase64(resId: number, density: number): Promise&lt;string&gt;

ArkTS-Sta: getMediaContentBase64(resId: long, density: int): Promise&lt;string&gt;
...
ArkTS-Dyn: getMediaBase64ByName(resName: string, density: number, callback: _AsyncCallback&lt;string&gt;): void

ArkTS-Sta: getMediaBase64ByName(resName: string, density: int, callback: _AsyncCallback&lt;string&gt;): void
...
ArkTS-Dyn: getMediaBase64ByName(resName: string, density: number): Promise&lt;string&gt;

ArkTS-Sta: getMediaBase64ByName(resName: string, density: int): Promise&lt;string&gt;
...
| resId | ArkTS-Dyn: number<br>ArkTS-Sta: long | 是    | 资源ID值。 |
| density | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否    | 资源获取需要的屏幕密度，0或缺省表示默认屏幕密度。取值具体请参考枚举[ScreenDensity](#screendensity)。 |
| type<sup>11+</sup> | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否    | 图标类型。默认值为0。<br>0：表示获取应用自身图标资源。<br>1：表示获取主题资源包中应用的分层图标资源。 |
...
| 类型     | 说明         |
| ------ | ---------- | 
| int | 资源ID值对应的数值。<br>integer类型资源返回资源文件中定义的原始数值。<br>float类型资源不带单位时返回资源文件中定义的原始数值，带"vp"或"fp"单位时返回转换后的像素(px)值。转换公式：像素值 = 原始数值 × densityPixels。 |
...
| 类型     | 说明        |
| ------ | --------- |
| int | 资源名称对应的数值。<br>integer类型资源返回资源文件中定义的原始数值。<br>float类型资源不带单位时返回资源文件中定义的原始数值，带"vp"或"fp"单位时返回转换后的像素(px)值。转换公式：像素值 = 原始数值 × densityPixels。 |
...
ArkTS-Dyn: getResourceName(resId: number): string

ArkTS-Sta: getResourceName(resId: long): string
