...
>
>  - 当前页面仅包含本模块的系统接口，其他公开接口参见[字体管理](../js-apis-font-manager.md)。
...
| 参数名   | 类型     | 必填   | 说明    |
| ----- | ------ | ---- | ----- |
| fullName | string | 是    | 需要卸载的字体名称，可通过打开.ttf、.ttc或.otf字体文件获取。<br>字体名称区分大小写，请确保与实际字体名称完全一致。 |
