...
| 错误码ID | 错误信息 |
| --- | --- |
| [9001009](../../errorcode-universal.md#9001009-Failed) | Failed to access the system resource.<br/>which is not mapped to application sandbox, This error code will be thrown. |
