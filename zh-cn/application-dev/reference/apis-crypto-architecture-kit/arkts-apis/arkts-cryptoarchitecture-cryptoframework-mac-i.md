...
[createMac](arkts-cryptoarchitecture-cryptoframework-createmac-f.md#createMac-1)构造Mac实例。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | AsyncCallback&lt;DataBlob&gt; | 是 | 回调函数。当Mac计算成功时，err为undefined，data为获取到的Mac计算结果；否则为<br/>错误对象。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;DataBlob&gt; | Promise对象，返回Mac的计算结果。 |
