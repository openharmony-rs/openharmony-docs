...
[update()](arkts-cryptoarchitecture-cipher-i.md#update-1)、
[doFinal()](arkts-cryptoarchitecture-cipher-i.md#dofinal-2)方法，
...
结果就是authTag。解密时，authTag需要填入[GcmParamsSpec](arkts-cryptoarchitecture-gcmparamsspec-i.md)或
[CcmParamsSpec](arkts-cryptoarchitecture-ccmparamsspec-i.md)，密文作为解密时的data参数。
...
authTag需要填入解密时的[GcmParamsSpec](arkts-cryptoarchitecture-gcmparamsspec-i.md)或
[CcmParamsSpec](arkts-cryptoarchitecture-ccmparamsspec-i.md)；密文则作为解密时的入参data。
...
关于其他注意事项，请参见
[doFinal()](arkts-cryptoarchitecture-cipher-i.md#dofinal-2)中的
**说明：**。
...
必须在使用[createCipher](arkts-cryptoarchitecture-createcipher-f.md#createcipher-1)创建[Cipher](arkts-cryptoarchitecture-cipher-i.md)
实例后，才能使用本函数。
...
设置加解密参数。常用的加解密参数直接通过[createCipher](arkts-cryptoarchitecture-createcipher-f.md#createcipher-1) 来指定，剩余参数通过本接口指定。
当前只支持RSA算法。
...
必须在对[Cipher](arkts-cryptoarchitecture-cipher-i.md)实例使用
[init()](arkts-cryptoarchitecture-cipher-i.md#init-4)初始化后，才能
使用本函数。
...
必须在对[Cipher](arkts-cryptoarchitecture-cipher-i.md)实例使用[initSync()](arkts-cryptoarchitecture-cipher-i.md#initsync-1)
初始化后，才能使用本函数。
