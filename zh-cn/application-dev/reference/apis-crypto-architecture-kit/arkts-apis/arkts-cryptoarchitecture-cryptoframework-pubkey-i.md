...
公钥，是[Key]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的子类，在非对称加密、签名验证、密钥协商时需要将其对象作为输入使用。 \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_公钥可以通过非对称密钥生成器[AsyKeyGenerator]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_、 [AsyKeyGeneratorBySpec]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_来生成。
...
支持根据指定的密钥格式（如规范、压缩状态等），获取符合ASN.1语法和DER编码的公钥数据。 > **说明：** > > 本接口和[Key.getEncoded()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的区别是： > 1. 本接口可以指定获取密钥数据的格式。 > 2. [Key.getEncoded()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_不支持指定获取密钥数据的格式。
...
获取指定的密钥数据类型对应的公钥数据。此API以同步方式返回结果。 \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_\_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_**说明：** \_\_\_HTML\_TAG\_DESC\_USD\_3\_\_\_建议优先使用异步API，\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。同步API可能因系统繁忙、高负载等原因耗时较长而阻塞主线程。 因此建议在子线程中调用同步API，以避免阻塞主线程。
