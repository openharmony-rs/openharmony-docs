...
密钥参数[AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)的子类，用于指定DH算法中公私钥包含的全量参数。
...
**继承/实现关系：** DHKeyPairSpec extends [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)
