...
密钥参数[AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)的子类，用于指定DH算法中私钥包含的参数。
...
**继承/实现关系：** DHPriKeySpec extends [AsyKeySpec](arkts-cryptoarchitecture-asykeyspec-i.md)
