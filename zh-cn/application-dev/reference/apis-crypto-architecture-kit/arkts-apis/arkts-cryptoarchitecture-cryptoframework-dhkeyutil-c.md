...
| skLen | number | 否 | 用于指定生成DH私钥的最大长度，单位为bits，默认值为0。<br/>当参数值设置为0时，生成DH私钥的最大长度为：<br/><br/>ffdhe2048：255 bits。<br/>ffdhe3072：275 bits。<br/>ffdhe4096：325 bits。<br/>ffdhe6144：375 bits。<br/><br/>ffdhe8192：400 bits。 |
