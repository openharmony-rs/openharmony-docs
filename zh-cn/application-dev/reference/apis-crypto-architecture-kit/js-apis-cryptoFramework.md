...
| ERR_OUT_OF_MEMORY                     | 17620001 | 内存错误。<br>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 23                  |
| ERR_RUNTIME_ERROR                     | 17620002 | 运行时外部错误。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 23           |
...
| DH_L_NUM<sup>11+</sup> | 403 | DH算法中私钥长度，单位为bit。 <br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23|
...
async function generateAsyKey() {
  ...
  try {
    ...
    console.error('get pubkey from prikey failed, ' + e.code + ', errMsg: ' + e.message);
  }
}
```
