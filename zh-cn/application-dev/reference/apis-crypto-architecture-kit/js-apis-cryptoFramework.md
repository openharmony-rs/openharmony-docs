...
| 名称                                  |    值   |   说明                         |
| ------------------------------------- | -------- | ---------------------------- |
| INVALID_PARAMS                        | 401      | 非法入参。<br>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 22                |
| NOT_SUPPORT                           | 801      | 操作不支持。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 22                 |
| ERR_OUT_OF_MEMORY                     | 17620001 | 内存错误。<br>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 22                  |
| ERR_RUNTIME_ERROR                     | 17620002 | 运行时外部错误。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 22           |
| ERR_PARAMETER_CHECK_FAILED<sup>20+</sup>            | 17620003 | 表示参数检查失败。<br>**原子化服务API：** 从API version 20开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 20  <br>**ArkTS-Sta起始版本：** 22           |
| ERR_CRYPTO_OPERATION                  | 17630001 | 调用三方算法库API出错。<br>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 22    |
...
| 名称         | 值   | 说明             |
| ------------ | ---- | ---------------- |
| DSA_P_BN | 101 | DSA算法的素模数p。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| DSA_Q_BN | 102 | DSA算法中密钥参数q（p-1的素因子）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| DSA_G_BN | 103 | DSA算法的参数g。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| DSA_SK_BN | 104 | DSA算法的私钥sk。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| DSA_PK_BN | 105 | DSA算法的公钥pk。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_FP_P_BN | 201 | ECC算法中表示椭圆曲线Fp域的素数p。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_A_BN | 202 | ECC算法中椭圆曲线的第一个系数a。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_B_BN | 203 | ECC算法中椭圆曲线的第二个系数b。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_G_X_BN | 204 | ECC算法中基点g的x坐标。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_G_Y_BN | 205 | ECC算法中基点g的y坐标。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_N_BN | 206 | ECC算法中基点g的阶n。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_H_NUM | 207 | ECC算法中的余因子h。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_SK_BN | 208 | ECC算法中的私钥sk。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_PK_X_BN | 209 | ECC算法中，公钥pk（椭圆曲线上的一个点）的x坐标。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_PK_Y_BN | 210 | ECC算法中，公钥pk（椭圆曲线上的一个点）的y坐标。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_FIELD_TYPE_STR | 211 | ECC算法中，椭圆曲线的域类型（当前只支持Fp域）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_FIELD_SIZE_NUM | 212 | ECC算法中域的大小，单位为bits（注：对于Fp域，域的大小为素数p的bits长度）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| ECC_CURVE_NAME_STR | 213 | ECC算法中的SECG(Standards for Efficient Cryptography Group)曲线名称。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| RSA_N_BN | 301 | RSA算法中的模数n。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| RSA_SK_BN | 302 | RSA算法中的私钥sk（即私钥指数d）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| RSA_PK_BN | 303 | RSA算法中的公钥pk（即公钥指数e）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| DH_P_BN<sup>11+</sup> | 401 | DH算法中的素数p。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| DH_G_BN<sup>11+</sup> | 402 | DH算法中的参数g。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| DH_L_NUM<sup>11+</sup> | 403 | DH算法中私钥长度，单位为bit。 <br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22|
| DH_SK_BN<sup>11+</sup> | 404 | DH算法中的私钥sk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| DH_PK_BN<sup>11+</sup> | 405 | DH算法中的公钥pk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| ED25519_SK_BN<sup>11+</sup> | 501 | Ed25519算法中的私钥sk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| ED25519_PK_BN<sup>11+</sup> | 502 | Ed25519算法中的公钥pk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| X25519_SK_BN<sup>11+</sup> | 601 | X25519算法中的私钥sk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| X25519_PK_BN<sup>11+</sup> | 602 | X25519算法中的公钥pk。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称         | 值   | 说明             |
| ------------ | ---- | ---------------- |
| OAEP_MD_NAME_STR | 100 | 表示RSA算法中，使用PKCS1_OAEP模式时，消息摘要功能的算法名。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| OAEP_MGF_NAME_STR | 101 | 表示RSA算法中，使用PKCS1_OAEP模式时，掩码生成算法（目前仅支持MGF1）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| OAEP_MGF1_MD_STR | 102 | 表示RSA算法中，使用PKCS1_OAEP模式时，MGF1掩码生成功能的消息摘要算法。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| OAEP_MGF1_PSRC_UINT8ARR | 103 | 表示RSA算法中，使用PKCS1_OAEP模式时，pSource的字节流。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| SM2_MD_NAME_STR<sup>11+</sup> | 104 | 表示SM2算法中，使用的摘要算法名。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称         | 值   | 说明             |
| ------------ | ---- | ---------------- |
| PSS_MD_NAME_STR | 100 | 表示RSA算法中，使用PSS模式时，消息摘要功能的算法名。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| PSS_MGF_NAME_STR | 101 | 表示RSA算法中，使用PSS模式时，掩码生成算法（目前仅支持MGF1）。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| PSS_MGF1_MD_STR | 102 | 表示RSA算法中，使用PSS模式时，MGF1掩码生成功能的消息摘要参数。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| PSS_SALT_LEN_NUM | 103 | 表示RSA算法中，使用PSS模式时，盐值的长度，长度以字节为单位。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| PSS_TRAILER_FIELD_NUM | 104 | 表示RSA算法中，使用PSS模式时，用于编码操作的整数。<br>**ArkTS-Dyn起始版本：** 10 <br>**ArkTS-Sta起始版本：** 22 |
| SM2_USER_ID_UINT8ARR<sup>11+</sup> | 105 | 表示SM2算法中，用户身份标识字段。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
