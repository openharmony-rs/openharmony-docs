...
| LASER_CURSOR        | 49   | 悬浮光标  |![Laser_Cursor.png](./figures/Laser_Cursor.png)<br>手写笔进入空鼠模式时使用该光标，无法直接使用|
| LASER_CURSOR_DOT        | 50   | 点击光标  |![Laser_Cursor_Dot.png](./figures/Laser_Cursor_Dot.png)<br>手写笔进入空鼠模式时使用该光标，无法直接使用|
| LASER_CURSOR_DOT_RED        | 51   | 激光笔光标  |![Laser_Cursor_Dot_Red.png](./figures/Laser_Cursor_Dot_Red.png)<br>手写笔进入空鼠模式时使用该光标，无法直接使用|
