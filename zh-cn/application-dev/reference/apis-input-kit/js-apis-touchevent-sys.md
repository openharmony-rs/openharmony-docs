...
| 名称          | 类型   | 只读   | 可选   | 说明                                  |
| ----------- | ------ | ---- | ---- | ----------------------------------- |
| fixedDisplayX | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 否    | 是    | 适配单手模式下screenX坐标的修正值，单位为px。 <br>**ArkTS-Dyn起始版本**: 9 <br>**ArkTS-Sta起始版本**：23  |
| fixedDisplayY | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 否    | 是    | 适配单手模式下screenY坐标的修正值，单位为px。 <br>**ArkTS-Dyn起始版本**: 9 <br>**ArkTS-Sta起始版本**：23  |
