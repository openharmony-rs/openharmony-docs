...
| 参数名   | 类型                                                                                             | 必填 | 说明                   |
| -------- |------------------------------------------------------------------------------------------------| ---- |----------------------|
| callback | TwoParamCallback\<number, [CommandInfo](arkts-apis-avsession-i.md#commandinfo22)> | 是   | 用于处理'fastForward'操作。 |
...
| 参数名   | 类型                                                                                             | 必填 | 说明              |
| -------- |------------------------------------------------------------------------------------------------| ---- |-----------------|
| callback | TwoParamCallback\<number, [CommandInfo](arkts-apis-avsession-i.md#commandinfo22)> | 是   | 用于处理'rewind'操作。 |
