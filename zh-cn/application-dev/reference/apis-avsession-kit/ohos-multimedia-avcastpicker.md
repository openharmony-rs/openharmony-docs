...
| 名称 | 类型 | 必填 | 装饰器类型 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| normalColor<sup>11+</sup> | ArkTS-Dyn: Color &#124; number &#124; string<br>ArkTS-Sta: Color &#124; int &#124; string | 否 | ArkTS-Dyn: @Prop<br>ArkTS-Sta: @PropRef | 指正常状态下投播组件的颜色。<br>未设置将采用colorMode下的颜色设置。<br>**ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 23 |
| activeColor<sup>11+</sup> | ArkTS-Dyn: Color &#124; number &#124; string<br>ArkTS-Sta: Color &#124; int &#124; string | 否 | ArkTS-Dyn: @Prop<br>ArkTS-Sta: @PropRef | 指设备切换成功状态下投播组件的颜色。未设置系统将优先根据normalColor的颜色匹配；如果normalColor也未设置，将采用colorMode下的颜色设置。<br>**ArkTS-Dyn起始版本：** 11<br>**ArkTS-Sta起始版本：** 23 |
| pickerStyle<sup>12+</sup> | [AVCastPickerStyle](js-apis-avCastPickerParam.md#avcastpickerstyle12) | 否 | ArkTS-Dyn: @Prop<br>ArkTS-Sta: @PropRef | 投播样式。<br>- 当sessionType是audio或者video时，默认值为STYLE_PANEL；<br>- 当sessionType是voice_call或者video_call时，默认值为STYLE_MENU，且不可修改为STYLE_PANEL。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| colorMode<sup>12+</sup> | [AVCastPickerColorMode](js-apis-avCastPickerParam.md#avcastpickercolormode12) | 否 | ArkTS-Dyn: @Prop<br>ArkTS-Sta: @PropRef | 显示模式。默认值为AUTO。<br>- 当colorMode设置为AUTO时，跟随系统的深浅色模式的默认色值；<br>- 当colorMode设置为DARK、LIGHT时，使用对应模式的系统预定色值。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
