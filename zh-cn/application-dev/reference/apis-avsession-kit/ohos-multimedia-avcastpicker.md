...
| onStateChange<sup>11+</sup> | (state: [AVCastPickerState](js-apis-avCastPickerParam.md#avcastpickerstate11)) => void | 否 | - | 投播状态更改回调。投播组件状态变化时触发，state为STATE_APPEARING表示组件开始显示，STATE_DISAPPEARING表示组件结束显示。 |
## 事件
