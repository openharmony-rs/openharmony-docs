...
- 非DLNA投播场景不生效。  
- 非字符串类型不生效。  
- 非XML格式会触发[on('castControlIoError')](arkts-avsession-avsession-avcastcontroller-i.md#on-12)回调并返回错误码6612000。错误码的详细介绍请参见[媒体会话管理错误码](../../../../reference/apis-avsession-kit/errorcode-avsession.md)。  
