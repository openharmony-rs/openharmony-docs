...
- [@ohos.multimedia.avMusicTemplate](arkts-multimedia-avmusictemplate.md)
  ...
  <!--Del-->
  - [getAllAVMusicTemplateDescriptors(系统接口)](arkts-avsession-avmusictemplate-getallavmusictemplatedescriptors-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offAVMusicTemplateCreate(系统接口)](arkts-avsession-avmusictemplate-offavmusictemplatecreate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [offAVMusicTemplateDestroy(系统接口)](arkts-avsession-avmusictemplate-offavmusictemplatedestroy-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [onAVMusicTemplateCreate(系统接口)](arkts-avsession-avmusictemplate-onavmusictemplatecreate-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [onAVMusicTemplateDestroy(系统接口)](arkts-avsession-avmusictemplate-onavmusictemplatedestroy-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AVMusicTemplateDescriptor(系统接口)](arkts-avsession-avmusictemplate-avmusictemplatedescriptor-i-sys.md)<!--DelEnd-->
...
- [@ohos.multimedia.avsession](arkts-multimedia-avsession.md)
  ...
  <!--Del-->
  - [getAVCastController(系统接口)](arkts-avsession-avsession-getavcastcontroller-f-sys.md)<!--DelEnd-->
  - [getAVSession](arkts-avsession-avsession-getavsession-f.md)
  <!--Del-->
  - [getDistributedSessionController(系统接口)](arkts-avsession-avsession-getdistributedsessioncontroller-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getHistoricalAVQueueInfos(系统接口)](arkts-avsession-avsession-gethistoricalavqueueinfos-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getHistoricalSessionDescriptors(系统接口)](arkts-avsession-avsession-gethistoricalsessiondescriptors-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [getSessionDescriptors(系统接口)](arkts-avsession-avsession-getsessiondescriptors-f-sys.md)<!--DelEnd-->
  <!--Del-->
  ...
  <!--Del-->
  - [sendSystemAVKeyEvent(系统接口)](arkts-avsession-avsession-sendsystemavkeyevent-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [sendSystemCommonCommand(系统接口)](arkts-avsession-avsession-sendsystemcommoncommand-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [sendSystemControlCommand(系统接口)](arkts-avsession-avsession-sendsystemcontrolcommand-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [setDiscoverable(系统接口)](arkts-avsession-avsession-setdiscoverable-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startAVPlayback(系统接口)](arkts-avsession-avsession-startavplayback-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startCastDeviceDiscovery(系统接口)](arkts-avsession-avsession-startcastdevicediscovery-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startCasting(系统接口)](arkts-avsession-avsession-startcasting-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [startDeviceLogging(系统接口)](arkts-avsession-avsession-startdevicelogging-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopCastDeviceDiscovery(系统接口)](arkts-avsession-avsession-stopcastdevicediscovery-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopCasting(系统接口)](arkts-avsession-avsession-stopcasting-f-sys.md)<!--DelEnd-->
  <!--Del-->
  - [stopDeviceLogging(系统接口)](arkts-avsession-avsession-stopdevicelogging-f-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AVCastController(系统接口)](arkts-avsession-avsession-avcastcontroller-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [AVQueueInfo(系统接口)](arkts-avsession-avsession-avqueueinfo-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [DeviceInfo(系统接口)](arkts-avsession-avsession-deviceinfo-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [DeviceState(系统接口)](arkts-avsession-avsession-devicestate-i-sys.md)<!--DelEnd-->
  <!--Del-->
  - [HiPlayDeviceInfo(系统接口)](arkts-avsession-avsession-hiplaydeviceinfo-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [SessionToken(系统接口)](arkts-avsession-avsession-sessiontoken-i-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ConnectionState(系统接口)](arkts-avsession-avsession-connectionstate-e-sys.md)<!--DelEnd-->
  - [DecoderType](arkts-avsession-avsession-decodertype-e.md)
  <!--Del-->
  - [DeviceLogEventCode(系统接口)](arkts-avsession-avsession-devicelogeventcode-e-sys.md)<!--DelEnd-->
  - [DeviceType](arkts-avsession-avsession-devicetype-e.md)
  - [DisplayTag](arkts-avsession-avsession-displaytag-e.md)
  <!--Del-->
  - [DistributedSessionType(系统接口)](arkts-avsession-avsession-distributedsessiontype-e-sys.md)<!--DelEnd-->
  - [ExtraKey](arkts-avsession-avsession-extrakey-e.md)
  <!--Del-->
  - [ExtraKey(系统接口)](arkts-avsession-avsession-extrakey-e-sys.md)<!--DelEnd-->
  ...
  <!--Del-->
  - [ProtocolType(系统接口)](arkts-avsession-avsession-protocoltype-e-sys.md)<!--DelEnd-->
