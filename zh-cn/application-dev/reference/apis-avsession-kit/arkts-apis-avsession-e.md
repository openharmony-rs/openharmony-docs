...
| 名称                        | 值   | 说明           |
| --------------------------  | ---- | ------------ |
| RESOLUTION_480P             | 0    | 分辨率为480P（640×480）。     |
| RESOLUTION_720P             | 1    | 分辨率为720P（1280×720）。    |
| RESOLUTION_1080P            | 2    | 分辨率为1080P（1920×1080）。   |
| RESOLUTION_2K               | 3    | 分辨率为2K（2560×1440）。   |
| RESOLUTION_4K               | 4    | 分辨率为4K（3840×2160）。   |
