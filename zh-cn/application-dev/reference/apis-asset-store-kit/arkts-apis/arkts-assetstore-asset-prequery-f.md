...
查询的预处理，用于需要用户认证的关键资产。在用户认证成功后，应当随后调用[asset.query]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和[asset.postQuery]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口。使用 Promise异步回调。
