...
查询一条或多条符合条件的关键资产。若查询需要用户认证的关键资产，则需要在本函数前调用[asset.preQuerySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_，在本函数后调用 [asset.postQuerySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，开发步骤请参考 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。使用同步方式返回结果。 如果未查询到符合条件的关键资产，将抛出“未找到关键资产”的异常，而非返回空的查询结果列表。
