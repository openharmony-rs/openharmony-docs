...
查询的预处理，用于需要用户认证的关键资产。在用户认证成功后，应当随后调用[asset.querySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_、 [asset.postQuerySync]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。使用同步方式返回结果。
