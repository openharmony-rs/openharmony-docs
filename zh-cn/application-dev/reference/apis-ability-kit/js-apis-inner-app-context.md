...
> **说明：**
>
> 从API version 7开始支持，从API version 9开始废弃。此接口功能仅对系统应用生效。建议使用window.setShowOnLockScreen替代，新接口为系统接口。
...
> **说明：**
>
> 从API version 7开始支持，从API version 12开始废弃。此接口功能仅对系统应用生效。替代接口window.setWakeUpScreen替代，新接口为系统接口。
