...
ArkTS-Dyn: acquireAccess(dataType: DataType): AccessStatus

ArkTS-Sta: acquireAccess(dataType: DataType): AccessStatus
...
ArkTS-Dyn: releaseAccess(dataType: DataType): ReleaseStatus

ArkTS-Sta: releaseAccess(dataType: DataType): ReleaseStatus
...
ArkTS-Dyn: queryAppKeyState(dataType: DataType): KeyStatus

ArkTS-Sta: queryAppKeyState(dataType: DataType): KeyStatus
