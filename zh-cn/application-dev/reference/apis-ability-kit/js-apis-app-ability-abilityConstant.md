...
| WINDOW_MODE_SPLIT_PRIMARY   | 100 | 支持应用内拉起Ability时设置为分屏，左侧分屏。仅在支持横屏桌面的折叠机展开态设备、Tablet设备和PC/2in1设备中生效。   |
| WINDOW_MODE_SPLIT_SECONDARY | 101 | 支持应用内拉起Ability时设置为分屏，右侧分屏。仅在支持横屏桌面的折叠机展开态设备、Tablet设备和PC/2in1设备中生效。   |
