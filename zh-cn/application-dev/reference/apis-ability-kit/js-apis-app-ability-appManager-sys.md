...
on(type: 'applicationState', observer: ApplicationStateObserver, filter: AppStateFilter): int
...
| 类型 | 说明                                                         |
| ---- | ------------------------------------------------------------ |
| int  | 已注册监听器ID，可用于[off](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/reference/apis-ability-kit/js-apis-app-ability-appManager.md#appmanageroffapplicationstate14)接口注销监听器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| pids    | ArkTS-Dyn: Array\<number><br>ArkTS-Sta: Array\<int> | 是    | 要查杀的进程ID。 |
...
| 类型 | 说明 |
| --- | --- |
| [_AppForegroundStateObserver.default](js-apis-inner-application-appForegroundStateObserver-sys.md) | 应用启动和退出的状态监听。 |
...
| 类型 | 说明 |
| --- | --- |
| [_AbilityFirstFrameStateObserver.default](js-apis-inner-application-abilityFirstFrameStateData-sys.md) | UIAbility首帧绘制完成事件监听对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [_AbilityFirstFrameStateData.default](js-apis-inner-application-abilityFirstFrameStateData-sys.md) | UIAbility首帧绘制完成回调上报数据结构。 |
