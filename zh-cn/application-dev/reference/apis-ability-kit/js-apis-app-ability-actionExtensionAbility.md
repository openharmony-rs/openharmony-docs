# @ohos.app.ability.ActionExtensionAbility<sup>(deprecated)</sup> (支持业务操作自定义的ExtensionAbility组件)
...
> **说明：**
> 
> 本模块首批接口从API version 10 开始支持，从API version 26.0.0开始废弃。后续版本的新增接口，采用上角标单独标记接口的起始版本。
>
> 本模块接口仅可在Stage模型下使用。
