...
| [AbilityBase_ErrorCode OH_AbilityBase_GetWantUri(AbilityBase_Want* want, char* uri, size_t uriSize)](#oh_abilitybase_getwanturi) | 获取Want中URI字符串。URI可参考[Want中uri描述](js-apis-app-ability-want.md#want)。 |
...
设置Want中URI字符串，URI可参考[Want中uri描述](js-apis-app-ability-want.md#want)。
...
| -- | -- |
| [AbilityBase_Want](capi-abilitybase-want.md)* want | Want指针。 |
| const char* uri | 表示URI。如果在Want中指定了URI，则Want将匹配指定的URI信息。URI可参考[Want中uri描述](js-apis-app-ability-want.md#want)。 |
...
获取Want中URI字符串。URI可参考[Want中uri描述](js-apis-app-ability-want.md#want)。
...
| -- | -- |
| [AbilityBase_Want](capi-abilitybase-want.md)* want | Want指针。 |
| char* uri | 表示URI。如果在Want中指定了URI，则Want将匹配指定的URI信息。URI可参考[Want中uri描述](js-apis-app-ability-want.md#want)。 |
