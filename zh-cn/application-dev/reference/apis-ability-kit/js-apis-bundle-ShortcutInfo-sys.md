...
> 
> 从API version 9开始，该模块不再维护，建议使用[bundleManager-ShortcutWant](js-apis-bundleManager-shortcutInfo.md)替代。
> 
> 本模块为系统接口。
...
> **说明：**
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager-ShortcutWant](js-apis-bundleManager-shortcutInfo.md#shortcutwant)替代。
