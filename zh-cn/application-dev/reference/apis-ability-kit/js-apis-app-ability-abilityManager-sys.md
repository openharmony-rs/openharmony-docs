...
| 类型 | 说明 |
| --- | --- |
| [_AbilityForegroundStateObserver (前台状态监听器)](js-apis-inner-application-abilityForegroundStateObserver-sys.md).default | AbilityForegroundStateObserver二级模块，用于定义应用前后台状态监听。 |
