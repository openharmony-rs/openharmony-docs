...
- ArkTS API<!--ability-arkts-->
  ...
  - 接口依赖的元素及定义<!--ability-api-interface-depend-->
    ...
    - application<!--ability-arkts-application-->
      ...
      - [AbilityRunningInfo (Ability运行信息)](js-apis-inner-application-abilityRunningInfo.md)
      ...
      - [AbilityStateData (Ability状态数据)](js-apis-inner-application-abilityStateData.md)
      - [AgentCard (Agent卡片)](js-apis-inner-application-AgentCard.md)
      ...
      - [AutoFillRect (自动填充矩形区域)](js-apis-inner-application-autoFillRect.md)
      - [AutoFillRequest (自动填充请求)](js-apis-inner-application-autoFillRequest.md)
      - [AutoFillType (自动填充类型)](js-apis-inner-application-autoFillType.md)
      - [AutoFillTriggerType (自动填充拉起类型)](js-apis-inner-application-autoFillTriggerType.md)
      ...
      - [PageNodeInfo (页面节点信息)](js-apis-inner-application-pageNodeInfo.md)
      ...
      - [UIAbilityContext (UIAbility上下文)](js-apis-inner-application-uiAbilityContext.md)
      ...
      <!--Del-->
      - [AbilityFirstFrameStateData (首帧绘制状态数据)(系统接口)](js-apis-inner-application-abilityFirstFrameStateData-sys.md)
      - [AbilityFirstFrameStateObserver (首帧绘制状态监听器)(系统接口)](js-apis-inner-application-abilityFirstFrameStateObserver-sys.md)
      - [AbilityForegroundStateObserver (前台状态监听器)(系统接口)](js-apis-inner-application-abilityForegroundStateObserver-sys.md)
      ...
      - [AutoFillExtensionContext (自动填充扩展上下文)(系统接口)](js-apis-inner-application-autoFillExtensionContext-sys.md)
      - [AutoFillRequest (自动填充请求)(系统接口)](js-apis-inner-application-autoFillRequest-sys.md)
      ...
      - [MissionInfo (任务信息)(系统接口)](js-apis-inner-application-missionInfo-sys.md)
      - [MissionListener (任务监听器)(系统接口)](js-apis-inner-application-missionListener-sys.md)
      - [MissionSnapshot (任务快照)(系统接口)](js-apis-inner-application-missionSnapshot-sys.md)
      - [MultiAppMode (应用多开模式)(系统接口)](js-apis-inner-application-multiAppMode-sys.md)
      - [PageNodeInfo (页面节点信息)(系统接口)](js-apis-inner-application-pageNodeInfo-sys.md)
      - [RunningAppClone (分身应用运行信息)(系统接口)](js-apis-inner-application-runningAppClone-sys.md)
      - [RunningMultiAppInfo (多开应用运行信息)(系统接口)](js-apis-inner-application-runningMultiAppInfo-sys.md)
      - [RunningMultiInstanceInfo (多实例应用运行信息)(系统接口)](js-apis-inner-application-runningMultiInstanceInfo-sys.md)
      - [ServiceExtensionContext (系统接口)](js-apis-inner-application-serviceExtensionContext-sys.md)
      - [ToolEventCallback (CLI工具事件回调)(系统接口)](js-apis-inner-application-toolEventCallback-sys.md)
      - [ToolInfo (CLI工具信息)(系统接口)](js-apis-inner-application-ToolInfo-sys.md)
      ...
      - [UIAbilityContext (UIAbility上下文)(系统接口)](js-apis-inner-application-uiAbilityContext-sys.md)
      - [UIExtensionContext (系统接口)](js-apis-inner-application-uiExtensionContext-sys.md)
      - [ViewData (视图数据)(系统接口)](js-apis-inner-application-viewData-sys.md)
