...
- ArkTS API<!--ability-arkts-->
  ...
  - 接口依赖的元素及定义<!--ability-api-interface-depend-->
    ...
    - application<!--ability-arkts-application-->
      ...
      - [AbilityFirstFrameStateObserver (首帧绘制状态监听器)](js-apis-inner-application-abilityFirstFrameStateObserver-sys.md)
      - [AbilityForegroundStateObserver (前台状态监听器)](js-apis-inner-application-abilityForegroundStateObserver-sys.md)
      ...
      - [AutoFillExtensionContext (自动填充扩展上下文)](js-apis-inner-application-autoFillExtensionContext-sys.md)
      - [AutoFillRequest (自动填充请求)](js-apis-inner-application-autoFillRequest-sys.md)
      ...
      - [MissionInfo (任务信息)](js-apis-inner-application-missionInfo-sys.md)
      - [MissionListener (任务监听器)](js-apis-inner-application-missionListener-sys.md)
      - [MissionSnapshot (任务快照)](js-apis-inner-application-missionSnapshot-sys.md)
      - [MultiAppMode (应用多开模式)](js-apis-inner-application-multiAppMode-sys.md)
      - [PageNodeInfo (页面节点信息)](js-apis-inner-application-pageNodeInfo-sys.md)
      - [RunningAppClone (分身应用运行信息)](js-apis-inner-application-runningAppClone-sys.md)
      ...
      - [UIAbilityContext (UIAbility上下文)](js-apis-inner-application-uiAbilityContext-sys.md)
      - [UIExtensionContext (系统接口)](js-apis-inner-application-uiExtensionContext-sys.md)
      - [ViewData (视图数据)](js-apis-inner-application-viewData-sys.md)
