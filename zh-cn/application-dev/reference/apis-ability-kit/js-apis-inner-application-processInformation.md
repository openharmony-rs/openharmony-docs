...
| appCloneIndex<sup>12+</sup> | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 是   | 应用分身索引。<br>**原子化服务API（仅ArkTS-Dyn）**：从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br/>**ArkTS-Sta起始版本：** 23 |
