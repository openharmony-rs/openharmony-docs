...
| 名称       | 值   | 说明       |
| ---------- | ---- | ---------- |
| ALWAYS_RESTART<sup>9</sup>   | 0    | 总是重启应用。<br>**模型约束**：此接口仅可在Stage模型下使用。<br>原子化服务API：从API version 11开始，该接口支持在原子化服务中使用。 |
| RESTART_WHEN_JS_CRASH<sup>9</sup>  | 0x0001    | 发生JS_CRASH时重启应用。<br>**模型约束**：此接口仅可在Stage模型下使用。<br>原子化服务API：从API version 11开始，该接口支持在原子化服务中使用。 |
| RESTART_WHEN_APP_FREEZE<sup>9</sup>   | 0x0002    | 发生APP_FREEZE时重启应用。<br>**模型约束**：此接口仅可在Stage模型下使用。<br>原子化服务API：从API version 11开始，该接口支持在原子化服务中使用。 |
...
| NO_RESTART<sup>9</sup>           | 0xFFFF    | 总是不重启应用。<br>**模型约束**：此接口仅可在Stage模型下使用。<br>原子化服务API：从API version 11开始，该接口支持在原子化服务中使用。 |
