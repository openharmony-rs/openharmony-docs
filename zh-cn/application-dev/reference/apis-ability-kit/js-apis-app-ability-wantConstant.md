...
| FLAG_AUTH_PERSISTABLE_URI_PERMISSION<sup>12+</sup> | 0x00000040 | 表示该URI可被接收方持久化。与[fileShare.persistPermission](../apis-core-file-kit/js-apis-fileShare.md#filesharepersistpermission11)接口配合使用。|
