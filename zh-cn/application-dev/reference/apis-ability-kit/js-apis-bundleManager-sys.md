...
| 名称                                       | 值         | 说明                                                         |
| ------------------------------------------ | ---------- | ------------------------------------------------------------ |
| GET_BUNDLE_INFO_ONLY_WITH_LAUNCHER_ABILITY<sup>12+</sup> | 0x00001000 | 用于获取仅包含有桌面图标的应用的bundleInfo。它仅在[getAllBundleInfo](#bundlemanagergetallbundleinfo)接口中生效。 <br/>**系统API：** 该标记仅支持在系统API中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| GET_BUNDLE_INFO_OF_ANY_USER<sup>12+</sup>      | 0x00002000 | 用于获取任意用户安装的bundleInfo。它不能单独使用，需要与GET_BUNDLE_INFO_WITH_APPLICATION一起使用。它仅在[getBundleInfo](#bundlemanagergetbundleinfo14)、[getAllBundleInfo](#bundlemanagergetallbundleinfo)接口生效。<br/>**系统API：** 该标记仅支持在系统API中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| GET_BUNDLE_INFO_EXCLUDE_CLONE<sup>12+</sup> | 0x00004000 | 用于获取去除分身应用而仅包含主应用的bundleInfo。它仅在[getAllBundleInfo](#bundlemanagergetallbundleinfo)接口中生效。 <br/>**系统API：** 该标记仅支持在系统API中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
...
| 名称                              | 值         | 说明                                                         |
| --------------------------------- | ---------- | ------------------------------------------------------------ |
| GET_ABILITY_INFO_DEFAULT          | 0x00000000 | 用于获取默认abilityInfo，获取的abilityInfo不包含permission、metadata和禁用的abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_PERMISSION  | 0x00000001 | 用于获取包含permission的abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_APPLICATION | 0x00000002 | 用于获取包含applicationInfo的abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_METADATA    | 0x00000004 | 用于获取包含metadata的abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_DISABLE     | 0x00000008 | 用于获取包含禁用的abilityInfo的abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_ONLY_SYSTEM_APP  | 0x00000010 | 用于仅为系统应用程序获取abilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_APP_LINKING<sup>12+</sup>  | 0x00000040 | 用于获取通过域名校验筛选的abilityInfo。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| GET_ABILITY_INFO_WITH_SKILL<sup>12+</sup>   | 0x00000080 | 用于获取包含skills的abilityInfo。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
...
| 名称                                        | 值         | 说明                                                         |
| ------------------------------------------- | ---------- | ------------------------------------------------------------ |
| GET_EXTENSION_ABILITY_INFO_DEFAULT          | 0x00000000 | 用于获取默认extensionAbilityInfo。获取的extensionAbilityInfo不包含permission、metadata 和禁用的extensionAbilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_EXTENSION_ABILITY_INFO_WITH_PERMISSION  | 0x00000001 | 用于获取包含permission的extensionAbilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_EXTENSION_ABILITY_INFO_WITH_APPLICATION | 0x00000002 | 用于获取包含applicationInfo的extensionAbilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_EXTENSION_ABILITY_INFO_WITH_METADATA    | 0x00000004 | 用于获取包含metadata的extensionAbilityInfo。<br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23 |
| GET_EXTENSION_ABILITY_INFO_WITH_SKILL<sup>12+</sup>     | 0x00000010 | 用于获取包含skills的extensionAbilityInfo。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
...
| 名称 | 值 | 说明 |
|----------------|---|---|
| FLAG_INSTALLED |  0x00000001 | 表示指定用户安装应用的状态为已安装状态。 <br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
...
| ---------- | ------ | ---- | ---------------------------- |
| bundleName | string | 是   | 表示要查询的应用Bundle名称。 |
| [appFlags](#applicationflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 指定返回的ApplicationInfo所包含的信息。    |
| userId     | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。  |
...
| [abilityFlags](#abilityflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 指定返回的AbilityInfo所包含的信息。                       |
| userId       | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。                               |
...
| ------------ | ------ | ---- | ------------------------------------------------------- |
| want         | Want   | 是   | 表示包含要查询的应用Bundle名称的Want。                 |
| [abilityFlags](#abilityflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示指定返回的AbilityInfo所包含的信息。 |
| userId       | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取，默认值：调用方所在用户，取值范围：大于等于0。                       |
...
| [extensionAbilityFlags](#extensionabilityflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int  | 是   | 表示用于指定将返回的ExtensionInfo对象中包含的信息的标志。    |
| userId                | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。                                                 |
...
| [bundleFlags](js-apis-bundleManager.md#bundleflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用于指定要返回的BundleInfo对象中包含的信息的标志。       |
| callback | AsyncCallback\<[BundleInfo](js-apis-bundleManager-bundleInfo.md)> | 是 | [回调函数](../apis-basic-services-kit/js-apis-base.md#asynccallback)，当获取成功时，err为null，data为获取到的BundleInfo；否则为错误对象。 |
...
| ----------- | ------ | ---- | ----------------------------------------------------------|
| bundleName  | string | 是   | 表示应用程序的bundleName。                                  |
| [applicationFlags](#applicationflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用于指定将返回的ApplicationInfo对象中包含的信息。       |
| userId      | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。                                         |
...
| ----------- | ------ | ---- | -------------------------------------------------------- |
| bundleName  | string | 是   | 表示应用程序的bundleName。                                 |
| [bundleFlags](js-apis-bundleManager.md#bundleflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用于指定将返回的BundleInfo对象中包含的信息的标志。 |
| userId      | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。                                             |
...
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| bundleName | string | 是   | 指定应用的bundleName。 |
| userId | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是 | 指定用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。 |
| callback | AsyncCallback\<[AppProvisionInfo](js-apis-bundleManager-AppProvisionInfo-sys.md)\> | 是   | [回调函数](../apis-basic-services-kit/js-apis-base.md#asynccallback)，当获取成功时，err为null，data为指定bundleName的provision配置文件信息。 |
...
ArkTS-Dyn: getAllAppProvisionInfo(userId?: number): Promise\<Array\<AppProvisionInfo>>

ArkTS-Sta: getAllAppProvisionInfo(userId?: int): Promise\<Array\<AppProvisionInfo>>
...
| 参数名   | 类型         | 必填 | 说明          |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| userId | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取。<br>默认值：调用方所在用户ID。<br>取值范围：大于等于0。 |
...
ArkTS-Dyn: getAllBundleInstallInfo(): Promise\<Array\<Record\<string, Object\>\>\>

ArkTS-Sta: getAllBundleInstallInfo(): Promise\<Array\<Record\<string, RecordData\>\>\>
...
| [extensionAbilityFlags](#extensionabilityflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示返回的ExtensionInfo对象中需要包含的信息标志。 |
| userId                | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取，默认值：调用方所在用户，取值范围：大于等于0。 |
...
| userId<sup>12+</sup>  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取，默认值：调用方所在用户，取值范围：大于等于0。  |
...
| extensionAbilityType  | string                          | 是   | 表示自定义extensionAbility的类型。                        |
| [extensionAbilityFlags](#extensionabilityflag) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 表示返回的ExtensionInfo对象中需要包含的信息标志。 |
| userId                | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取，默认值：调用方所在用户ID。取值范围：大于等于0。 |
...
| 参数名                | 类型      | 必填 | 说明                     |
| --------------------- | ---------| ---- | --------------------- |
| [appDistributionType](#appdistributiontype12) | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否   | 表示应用的分发类型，当该参数缺省时，会返回所有应用的开发者ID列表。       |
...
import { BusinessError } from '@kit.BasicServicesKit';
import { hilog } from '@kit.PerformanceAnalysisKit';
// 代码中使用的hostBundleName、useId需为应用实际的包名、用户ID，hapFilePaths需替换为实际的插件安装路径。
let userId = 100;
let hostBundleName = "com.xxx.xxx.xxx";
let bundleInstaller = installer.getBundleInstallerSync();
let hapFilePaths: Array<string> =
  new Array<string>("/data/bms_app_install/hsp1-default-signed.hsp");
bundleInstaller.installPlugin(hostBundleName, hapFilePaths, { userId: 100 }).
then((): void => {
  hilog.info(0x0000, 'testTag', 'installPlugin succeed  promise');
  bundleManager.getAllPluginInfo(hostBundleName, userId)
    .then((data: Array<bundleManager.PluginBundleInfo>) => {
      hilog.info(0x0000, 'testTag', 'getAllPluginInfo successfully. Data: %{public}s', JSON.stringify(data));
    })
    .catch((err: Error) => {
      hilog.error(0x0000, 'testTag', 'getAllPluginInfo failed. Cause: %{public}s',
        (err as BusinessError).message);
    });
}, (err: BusinessError): void => {
  hilog.info(0x0000, 'testTag', 'installPlugin failed promise :' + JSON.stringify(err));
})
```
...
| appIndex | ArkTS-Dyn: number<br>ArkTS-Sta: int |  是  |   表示分身索引。取值范围0~5，取值为0表示主应用。   |
...
ArkTS-Sta: isApplicationDisableForbidden(bundleName: string, userId: int, appIndex: int): boolean
...
| userId      |  ArkTS-Dyn: number<br>ArkTS-Sta: int  | 是   | 表示用户ID，可以通过[getOsAccountLocalId接口](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountlocalid9)获取，取值范围：大于等于0。  |
...
try {
  let data = bundleManager.isApplicationDisableForbidden(bundleName, 100, 0);
  hilog.info(0x0000, 'testTag', 'isApplicationDisableForbidden successfully: ' + data);
} catch (err) {
  let message = (err as BusinessError).message;
