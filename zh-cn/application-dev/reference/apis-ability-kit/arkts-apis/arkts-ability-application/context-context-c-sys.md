...
根据Bundle名称创建安装包的上下文。 > **说明：** > > - stage模型多module的情况下可能发生资源id冲突的情况，建议使用 > [application.createModuleContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 安装包的上下文。 |
...
该接口用于OEM厂商预置的\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_创建自己的 [ResourceManager]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。
