...
查询指定敏感权限是否正在被使用，可用于权限管理界面展示权限实时使用状态场景。 判断依据为当前是否存在通过[startUsingPermission]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 标记开始使用且尚未通过[stopUsingPermission]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_标记停止使用的活跃调用。
