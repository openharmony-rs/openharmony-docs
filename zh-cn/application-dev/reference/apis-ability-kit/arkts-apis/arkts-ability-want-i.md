...
[action说明](../../apis-api10-less-deprecated-modules/arkts-apis/arkts-api10lessdeprecatedmodules-wantconstant-action-e.md#Action)。隐式Want定义及匹配规则参考：
...
表示处理Want的方式。默认传数字，具体参考：[flags说明](../../apis-api10-less-deprecated-modules/arkts-apis/arkts-api10lessdeprecatedmodules-wantconstant-flags-e.md#Flags)。
