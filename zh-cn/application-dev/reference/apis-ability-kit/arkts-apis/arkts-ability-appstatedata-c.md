...
定义应用状态信息，使用接口
[on](arkts-ability-appmanager-on-f.md#on-1)注
册应用状态变化监听后，当应用、进程或组件的状态变化时，系统通过[ApplicationStateObserver](arkts-ability-applicationstateobserver-c.md#ApplicationStateObserver)的
