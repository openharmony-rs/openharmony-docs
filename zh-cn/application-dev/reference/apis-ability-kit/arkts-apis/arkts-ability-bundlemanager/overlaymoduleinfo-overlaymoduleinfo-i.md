...
OverlayModuleInfo信息，可以通过 [overlay.getOverlayModuleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口获取当 前应用中具有overlay特征模块的OverlayModuleInfo信息。
...
overlay特征module的 [禁用使能状态]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。0代表禁用状态， 1代表使能状态。
