...
当前模块所有Ability的信息。通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE和GET\_BUNDLE\_INFO\_WITH\_ABILITY获取。
...
当前模块所有ExtensionAbility的信息。通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE和GET\_BUNDLE\_INFO\_WITH\_EXTENSION\_ABILITY获取。
...
模块的文件菜单配置。通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE和GET\_BUNDLE\_INFO\_WITH\_MENU获取。
...
当前模块入口Ability的\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_，取值为图标资源文件的索引，与模块配置文件中 \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_或 \_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_的icon字段值一致。若未配置入口 Ability，则为空。
...
当前模块入口Ability的名称，取值为字符串资源的索引，与模块配置文件中\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_或 \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_的label字段值一致。若未配置入口 Ability，则为空。
...
当前模块的元数据。通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE和GET\_BUNDLE\_INFO\_WITH\_METADATA获取。
...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE和GET\_BUNDLE\_INFO\_WITH\_ROUTER\_MAP获取。
