...
应用程序的配置信息\_\_\_MD\_COMMENT\_DESC\_USD\_4\_\_\_，可以通过调用 [queryAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口，abilityFlags参数传入GET\_ABILITY\_INFO\_WITH\_APPLICATION获取\_\_\_MD\_COMMENT\_DESC\_USD\_5\_\_\_。 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_或 者 [getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_ 接口获取AbilityInfo信息时不会返回该字段内容，可以通过获取[bundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_.appInfo对象来获取相关信息。
...
Ability的描述，对应\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中abilities下配置的description字段，用于描述当前 ability提供的页面内容和功能作用。
...
Ability是否可用，可用表示可以拉起或者查询，不可用时调用[getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 查询ability需要携带GET\_ABILITY\_INFO\_WITH\_DISABLE的AbilityFlag，取值为true表示Ability可用，取值为false表示Ability不可用。
...
Ability对用户显示的名称的资源描述符，对应\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中abilities下配置的label字段。 **说明：** 从API version 20开始，如果是通过 [bundleManager.getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_获取Ability信息，该字段为 Ability对用户显示的名称。
...
Ability的元信息。可以配置成系统定义的参数，使用系统提供的能力，例如\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_、 \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_等。也可以自定义配置参数，通过调用 [getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_接 口，bundleFlags参数传入GET\_BUNDLE\_INFO\_WITH\_HAP\_MODULE、GET\_BUNDLE\_INFO\_WITH\_ABILITY和GET\_BUNDLE\_INFO\_WITH\_METADATA获取。
...
Ability的显示模式。来源于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中abilities标签下配置的orientation字段，如果 module.json5配置文件中orientation配置枚举，orientation属性有值且非0，取值详情参考 [显示模式枚举]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_；如果配置文件中配置的是资源索引，orientation属性值为0。
...
Ability的显示模式资源id。来源于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_中abilities标签下的orientation字段，如 果module.json5配置文件中orientation配置枚举，orientationId属性值为0；如果配置文件中配置的是资源索引，orientationId属性值为非0，为编译构建时生成的资源id索引。当 orientationId不为0时表示当前显示模式为自定义配置，需要使用orientationId去资源管理获取对应的资源，当orientationId为0时表示未配置资源。
