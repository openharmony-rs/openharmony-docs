...
应用组件结构体，包含bundleName、moduleName和abilityName等。通常用于组件启动信息 [AbilityRunningInfo.ability]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和组件启动回调函数 [connectOptions.onConnect]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ 中。
