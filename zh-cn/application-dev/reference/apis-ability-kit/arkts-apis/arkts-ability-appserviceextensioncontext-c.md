...
**继承/实现关系：** AppServiceExtensionContext extends [ExtensionContext](arkts-ability-extensioncontext-c.md)
...
| [16000071](../errorcode-ability.md#16000071-不支持应用分身模式) | App clone is not supported. |
...
| [16000077](../errorcode-ability.md#16000077-应用的实例数量已达到上限) | The number of app instances reaches the limit. |
| [16000078](../errorcode-ability.md#16000078-不支持应用多实例) | The multi-instance is not supported. |
| [16000079](../errorcode-ability.md#16000079-不支持指定app_instance_key) | The APP_INSTANCE_KEY cannot be specified. |
