...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | 要设置的应用类型，支持取值包括：[ApplicationType](arkts-ability-applicationtype-e.md)中的值、[MIMEType](../../../../database/uniform-data-type-list.md#基础类型)类型、或[UniformDataType](@ohos.data.uniformTypeDescriptor:uniformTypeDescriptor.UniformDataType)类型。 |
