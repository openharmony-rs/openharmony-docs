...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;ContinuationResult&gt;&gt; | 是 | 当用户从设备选择模块中选择设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
| token | number | 是 | 注册后的token。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;Array&lt;ContinuationResult&gt;&gt; | 是 | 当用户从设备选择模块中断开设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;ContinuationResult&gt; | 是 | 当用户从设备选择模块中选择设备时调用，返回设备ID、设备类型和设备名称供开发者使用。 |
...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | 当用户从设备选择模块中断开设备时调用，返回设备ID供开发者使用。 |
