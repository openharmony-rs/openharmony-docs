...
| cancelBackgroundRunning | 向系统申请取消长时任务。使用callback异步回调。 |
...
| disconnectAbility | 断开当前ability与指定ServiceAbility的连接。使用callback异步回调。 |
...
| terminateSelf | 销毁当前particleAbility。使用callback异步回调。 |
