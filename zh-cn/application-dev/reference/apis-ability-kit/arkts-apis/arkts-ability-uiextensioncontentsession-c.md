...
为[UIExtensionAbility](arkts-ability-uiextensionability-c.md#UIExtensionAbility)组件加载页面，支持通过
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | 是 | 要加载的页面所在的路径，该路径通过[module.json5配置文件](../../../../quick-start/module-configuration-file.md)中的<br/>[pages标签](../../../../quick-start/module-configuration-file.md#pages标签)配置。 |
...
为[UIExtensionAbility](arkts-ability-uiextensionability-c.md#UIExtensionAbility)组件加载
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | string | 是 | UIExtensionAbility组件类型，取值详见<br/>[通过startAbilityByType接口拉起垂类面板](../../../../application-models/start-intent-panel.md#匹配规则)。 |
