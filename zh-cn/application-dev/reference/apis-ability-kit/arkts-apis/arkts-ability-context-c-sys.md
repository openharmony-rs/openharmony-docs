...
该接口用于OEM厂商预置的[系统级HSP](docroot://quick-start/application-package-glossary.md#系统级hsp)创建自己的[ResourceManager](../../apis-localization-kit/arkts-apis/arkts-resourcemanager.md)。
