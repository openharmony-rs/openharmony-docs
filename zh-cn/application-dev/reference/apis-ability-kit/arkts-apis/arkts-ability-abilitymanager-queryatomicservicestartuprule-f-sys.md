...
查询嵌入式拉起[EmbeddableUIAbility](arkts-ability-embeddableuiability-c.md#EmbeddableUIAbility)的规则。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| context | Context | 是 | 嵌入式拉起EmbeddableUIAbility的调用方Context。<br/>**说明**：目前仅支持<br/>[UIAbilityContext](arkts-ability-uiabilitycontext-c.md#UIAbilityContext)。 |
