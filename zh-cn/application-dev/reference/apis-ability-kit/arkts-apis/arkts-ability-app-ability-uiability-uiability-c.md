...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 是 | 表示dump命令参数。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<string> | 返回的dump信息。 |
...
UIAbility[冷启动](../../../../application-models/uiability-intra-device-interaction.md#目标uiability冷启动)时接收到的Want参数，取值为[onCreate](arkts-ability-app-ability-uiability-uiability-c.md#oncreate-1)接收到的Want参数。
