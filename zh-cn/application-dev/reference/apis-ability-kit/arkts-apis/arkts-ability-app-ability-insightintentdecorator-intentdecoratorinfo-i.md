...
表示意图垂域，用于将意图按垂直领域分类（例如：视频、音乐、游戏），取值范围参见 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ 中的垂域字段。
...
表示意图图标，用于在AI入口显示。 - 当取值为字符串类型时，表示图标读取网络资源。 - 当取值为\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时，表示图标读取本地资源。
...
表示意图参数的数据格式声明，用于意图调用时定义入参的数据格式。取值参见 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_
...
表示接入的标准意图的名称。开发者\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时，需要配置该字段， \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_时，无需配置该字段。标准意图列表参见 \_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_。
