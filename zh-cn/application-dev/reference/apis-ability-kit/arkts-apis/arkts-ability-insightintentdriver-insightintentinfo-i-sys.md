...
表示通过意图装饰器定义的意图类型。 **说明：** 对于使用配置文件开发的意图，该字段返回值默认为\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_类 型装饰器。
...
表示特定意图装饰器的意图信息。 **说明：** 对于使用配置文件开发的意图，该字段返回值默认为\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
