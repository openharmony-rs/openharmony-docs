...
AgentExtensionContext为开发者提供访问当前[AgentExtensionAbility](arkts-ability-app-agent-agentextensionability-agentextensionability-c.md)智能体所配置的[AgentCard](arkts-ability-agentcard-i.md)信息的能力。
