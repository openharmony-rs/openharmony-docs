...
安装包目录。不能拼接路径访问资源文件，请使用[资源管理接口](../../apis-localization-kit/arkts-apis/arkts-resourcemanager.md)访问资源，详情参考[应用沙箱目录](docroot://file-management/app-sandbox-directory.md)。
