...
| 类型 | 说明 |
| --- | --- |
| number | 已注册监听器ID，可用于<br/>[off](arkts-ability-appmanager-off-f.md#off-2)接口注销监听器。 |
...
| [16000050](../../errorcode-universal.md#16000050-Internal) | Internal error. Possible causes: 1. Failed to connect to the system service;<br/>2. The system service failed to communicate with dependency module. |
