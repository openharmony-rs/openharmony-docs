...
表示不触发[onNewWant](arkts-ability-app-ability-uiability-uiability-c.md#onnewwant-1)生命周期回调场景的枚举，用于[setOnNewWantSkipScenarios](arkts-ability-uiabilitycontext-c.md#setonnewwantskipscenarios-1)接口。
