...
本模块提供意图执行上下文，是[意图执行基类]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_和 [@InsightIntentEntry的意图执行基类]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的属性，为意图执行提 供基础能力，例如启动本应用内的[UIAbility组件]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。
...
意图实例唯一ID。用于通过 [insightIntentProvider.sendExecuteResult接口]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 和 [insightIntentProvider.sendIntentResult接口]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_返回指定意图的执行结果。
