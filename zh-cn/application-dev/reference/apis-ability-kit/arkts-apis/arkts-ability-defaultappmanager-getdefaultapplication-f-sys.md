...
根据系统已定义的应用类型或者符合媒体类型格式（type/subtype）的文件类型或者 [UniformDataType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_类型获取默认应用信息。使用 callback异步回调。
...
根据系统已定义的应用类型或者符合媒体类型格式（type/subtype）的文件类型或者 [UniformDataType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_类型获取默认应用信息。使用Promise 异步回调。
