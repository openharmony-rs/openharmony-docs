...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| filter | InsightIntentInfoFilter | 是 | Intent filter, which specifies the criteria for selecting a target<br/>intent. It is used to filter intents on the device that meet these criteria. |
