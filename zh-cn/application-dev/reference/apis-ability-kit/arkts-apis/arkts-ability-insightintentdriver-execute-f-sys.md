...
执行意图调用的接口。使用callback异步回调。 当调用方在后台时，需要申请\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_权限。 当意图调用执行模式[ExecuteMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_取值为UI\_ABILITY\_BACKGROUND时，需要 申请\_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_权限。
...
执行意图调用的接口。使用Promise异步回调。 当调用方在后台时，需要申请\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_权限。 当意图调用执行模式[ExecuteMode]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_取值为UI\_ABILITY\_BACKGROUND时，需要 申请\_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_权限。
