...
本模块提供overlay特征应用的[OverlayModuleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_信息查询以及禁用使能的能力。 overlay特征应用指应用中包含有overlay资源包，overlay资源包详见 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。 > **说明：** > > 本模块接口仅适用于stage模型，且仅适用于\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_。
...
| [getTargetOverlayModuleInfos](arkts-ability-overlay-gettargetoverlaymoduleinfos-f.md#gettargetoverlaymoduleinfos-1) | 获取指定的目标module所关联的OverlayModuleInfo。overlay特征的module一般是为设备上存在的非overlay特征的module提供覆盖的资源文件，其中非overlay特征的module被称作目标 module。使用Promise异步回调。 |
