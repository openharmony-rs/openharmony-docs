...
Ability信息，未做特殊说明的属性，均通过 [bundle.getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取。 > **说明：** > > 从API version 9开始，该模块不再维护，建议使用[bundleManager-AbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_替代。
...
应用程序的配置信息。 通过调用[bundle.getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_ABILITY\_INFO\_WITH\_APPLICATION获取。
...
Ability的元信息。 通过调用[bundle.getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_ABILITY\_INFO\_WITH\_METADATA获取。
...
被其他应用Ability调用时需要申请的权限集合。 通过调用[bundle.getAbilityInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_ABILITY\_INFO\_WITH\_PERMISSION获取。
