...
应用程序信息，未做特殊说明的属性，均通过 [bundle.getApplicationInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 获取。 > **说明：** > > 从API version 9开始，该模块不再维护，建议使用[bundleManager-ApplicationInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_替代。
...
应用程序的自定义元信息。 通过调用 [bundle.getApplicationInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_APPLICATION\_INFO\_WITH\_METADATA获取。
...
访问应用程序所需的权限。 通过调用 [bundle.getApplicationInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_APPLICATION\_INFO\_WITH\_PERMISSION获取。
