...
> **说明：** > > 从API version 7开始支持，从API version 9开始废弃，建议使用[bundleManager-BundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_替代。
...
Ability的配置信息 通过调用 [bundle.getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_BUNDLE\_WITH\_ABILITIES获取。
...
应用运行时需向系统申请的权限集合的详细信息 通过调用 [bundle.getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_BUNDLE\_WITH\_REQUESTED\_PERMISSION获取。
...
应用运行时需向系统申请的权限集合 通过调用 [bundle.getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 接口时，传入GET\_BUNDLE\_WITH\_REQUESTED\_PERMISSION获取。
