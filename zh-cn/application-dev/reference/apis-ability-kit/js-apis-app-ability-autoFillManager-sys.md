...
| 类型                                                                  | 说明             |
| --------------------------------------------------------------------- | ---------------- |
| [_CustomData (自定义数据)](js-apis-inner-application-customData-sys.md#customdata) | 表示自定义数据。 |
...
| 类型                                                                                             | 说明                                  |
| ------------------------------------------------------------------------------------------------ | ------------------------------------- |
| [_AutoFillPopupConfig](js-apis-inner-application-autoFillPopupConfig-sys.md#autofillpopupconfig) | 表示自动填充气泡弹窗的尺寸和位置信息。 |
