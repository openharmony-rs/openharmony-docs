...
| splitRatio | [window.SplitRatioPreference](../apis-arkui/arkts-apis-window-e.md#splitratiopreference) | 否 | 是 | 启动UIAbility时的窗口分配比例，详见[SplitRatioPreference](../apis-arkui/arkts-apis-window-e.md#splitratiopreference)。<br>**起始版本：** 26.0.0 |
