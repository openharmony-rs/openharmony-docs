...
| minWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最小的宽度，单位为vp，可以通过[getWindowLimitsVP](../apis-arkui/arkts-apis-window-Window.md#getwindowlimitsVP22)获得当前窗口的尺寸限制。<br>**约束：**<br/>仅在2in1和Tablet设备上生效。 |
| minWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最小的高度，单位为vp，可以通过[getWindowLimitsVP](../apis-arkui/arkts-apis-window-Window.md#getwindowlimitsVP22)获得当前窗口的尺寸限制。<br>**约束：**<br/>仅在2in1和Tablet设备上生效。 |
| maxWindowWidth<sup>17+</sup> | number | 否 | 是 | 窗口最大的宽度，单位为vp，可以通过[getWindowLimitsVP](../apis-arkui/arkts-apis-window-Window.md#getwindowlimitsVP22)获得当前窗口的尺寸限制。<br>**约束：**<br/>仅在2in1和Tablet设备上生效。 |
| maxWindowHeight<sup>17+</sup> | number | 否 | 是 | 窗口最大的高度，单位为vp，可以通过[getWindowLimitsVP](../apis-arkui/arkts-apis-window-Window.md#getwindowlimitsVP22)获得当前窗口的尺寸限制。<br>**约束：**<br/>仅在2in1和Tablet设备上生效。 |
