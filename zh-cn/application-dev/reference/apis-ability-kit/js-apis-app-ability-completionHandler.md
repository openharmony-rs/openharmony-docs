...
| 名称                           | 类型                                        | 只读 | 可选 | 说明                   |
| ------------------------------ | ------------------------------------------- | ---- | ---- | ---------------------- |
| onRequestSuccess<sup>23+</sup> | [OnRequestSuccessFn](#OnRequestSuccessFn23) | 否   | 否   | 拉端成功时的回调函数。 |
| onRequestFailure<sup>23+</sup> | [OnRequestFailureFn](#OnRequestFailureFn23) | 否   | 否   | 拉端失败时的回调函数。 |
