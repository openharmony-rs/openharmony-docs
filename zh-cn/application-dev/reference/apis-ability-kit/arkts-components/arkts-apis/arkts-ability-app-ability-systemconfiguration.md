...
该模块与[EnvironmentCallback](arkts-ability-app-ability-environmentcallback-environmentcallback-c.md)模块的区别在于：

- systemConfiguration模块：用于监听系统环境变量[Configuration](arkts-ability-app-ability-configuration-configuration-i.md)的变化。  
- [EnvironmentCallback](arkts-ability-app-ability-environmentcallback-environmentcallback-c.md)模块：用于监听某个应用环境变量[Configuration](arkts-ability-app-ability-configuration-configuration-i.md)的变化。
