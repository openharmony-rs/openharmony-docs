...
创建指定模块的上下文。创建出的模块上下文中[resourceManager.Configuration](../apis-localization-kit/js-apis-resource-manager.md#configuration)资源继承自入参上下文，便于开发者获取[访问跨HAP/HSP包资源](../../quick-start/resource-categories-and-access.md访问跨HAP/HSP包资源)。使用Promise异步回调。
