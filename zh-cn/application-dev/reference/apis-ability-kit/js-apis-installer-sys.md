...
- 从API version 23开始，降级安装应用需要同时申请ohos.permission.INSTALL_BUNDLE和ohos.permission.INSTALL_ALLOW_DOWNGRADE权限。仅三方普通应用支持降级安装，可以参考[InstallParam](#installparam)中parameters描述。
