...
| accountId | number | 是 | 系统账号的账号ID，详情参考[getOsAccountCount](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountcount9)。 |
...
| accountId | number | 是 | 系统账号的账号ID，-1表示当前活动用户，详情参考[getOsAccountCount](../apis-basic-services-kit/js-apis-osAccount.md#getosaccountcount9)。 |
