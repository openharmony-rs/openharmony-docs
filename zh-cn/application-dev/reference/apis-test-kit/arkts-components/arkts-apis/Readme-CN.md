...
- [@ohos.app.ability.abilityDelegatorRegistry(AbilityDelegatorRegistry)](arkts-test-app-ability-abilitydelegatorregistry.md)
...
- [@ohos.application.abilityDelegatorRegistry(AbilityDelegatorRegistry)](arkts-test-application-abilitydelegatorregistry.md)
...
- [@ohos.application.testRunner](arkts-test-application-testrunner.md)
  - [TestRunner](arkts-test-application-testrunner-testrunner-i.md)
  - [OnStopFn](arkts-test-onstopfn-t.md)
- [@ohos.test.PerfTest](arkts-test-test-perftest.md)
...
- [@ohos.UiTest](arkts-test-uitest.md)
