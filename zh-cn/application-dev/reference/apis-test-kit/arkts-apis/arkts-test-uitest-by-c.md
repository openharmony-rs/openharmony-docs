...
3、支持控件绝对定位，相对定位，可通过[By.isBefore<sup>(deprecated)</sup>](arkts-test-uitest-by-c.md#isbefore)和[By.isAfter<sup>(deprecated)</sup>](arkts-test-uitest-by-c.md#isafter)等API限定邻近控件特征进行辅助定位。
...
**替代接口：** [id(id:](arkts-test-uitest-on-c.md#id)
...
**替代接口：** [isAfter(on:](arkts-test-uitest-on-c.md#isafter)
...
**替代接口：** [isBefore(on:](arkts-test-uitest-on-c.md#isbefore)
...
**替代接口：** [type(tp:](arkts-test-uitest-on-c.md#type)
