...
**替代接口：** [id(id:](arkts-test-uitest-on-c.md#id-1)
...
**替代接口：** [isAfter(on:](arkts-test-uitest-on-c.md#isafter-1)
...
**替代接口：** [isBefore(on:](arkts-test-uitest-on-c.md#isbefore-1)
...
**替代接口：** [type(tp:](arkts-test-uitest-on-c.md#type-1)
