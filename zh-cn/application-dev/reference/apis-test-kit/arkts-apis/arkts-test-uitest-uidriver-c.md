...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[assertComponentExist<sup>9+</sup>](arkts-test-uitest-driver-c.md#assertcomponentexist-1)替  
> 代。
...
**替代接口：** [assertComponentExist](arkts-test-uitest-driver-c.md#assertcomponentexist-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[create<sup>9+</sup>](arkts-test-uitest-driver-c.md#create-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [create](arkts-test-uitest-driver-c.md#create-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[delayMs<sup>9+</sup>](arkts-test-uitest-driver-c.md#delayms-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [delayMs](arkts-test-uitest-driver-c.md#delayms-1)
...
**替代接口：** [findComponent(on:](arkts-test-uitest-driver-c.md#findcomponent-1)
...
**替代接口：** [findComponents(on:](arkts-test-uitest-driver-c.md#findcomponents-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[pressBack<sup>9+</sup>](arkts-test-uitest-driver-c.md#pressback-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [pressBack()](arkts-test-uitest-driver-c.md#pressback-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[screenCap<sup>9+</sup>](arkts-test-uitest-driver-c.md#screencap-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [screenCap(savePath:](arkts-test-uitest-driver-c.md#screencap-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[swipe<sup>9+</sup>](arkts-test-uitest-driver-c.md#swipe-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [swipe](arkts-test-uitest-driver-c.md#swipe-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[triggerKey<sup>9+</sup>](arkts-test-uitest-driver-c.md#triggerkey-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [triggerKey(keyCode:](arkts-test-uitest-driver-c.md#triggerkey-1)
