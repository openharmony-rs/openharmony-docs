...
> **说明：**  
>  
> 从API version 9开始支持，从API version 11开始废弃，建议使用[isActive<sup>11+</sup>](arkts-test-uitest-uiwindow-c.md#isactive-1)替代。

**起始版本：** 9

**废弃版本：** 11

**替代接口：** [isActive](arkts-test-uitest-uiwindow-c.md#isactive-1)
