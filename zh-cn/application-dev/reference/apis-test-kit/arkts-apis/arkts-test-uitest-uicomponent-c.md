...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[click<sup>9+</sup>](arkts-test-uitest-component-c.md#click-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [click](arkts-test-uitest-component-c.md#click-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[doubleClick<sup>9+</sup>](arkts-test-uitest-component-c.md#doubleclick-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [doubleClick](arkts-test-uitest-component-c.md#doubleclick-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[getId<sup>9+</sup>](arkts-test-uitest-component-c.md#getid-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [getId](arkts-test-uitest-component-c.md#getid-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[getText<sup>9+</sup>](arkts-test-uitest-component-c.md#gettext-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [getText](arkts-test-uitest-component-c.md#gettext-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[getType<sup>9+</sup>](arkts-test-uitest-component-c.md#gettype-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [getType](arkts-test-uitest-component-c.md#gettype-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[inputText<sup>9+</sup>](arkts-test-uitest-component-c.md#inputtext-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [inputText(text:](arkts-test-uitest-component-c.md#inputtext-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[isClickable<sup>9+</sup>](arkts-test-uitest-component-c.md#isclickable-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [isClickable](arkts-test-uitest-component-c.md#isclickable-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[isEnabled<sup>9+</sup>](arkts-test-uitest-component-c.md#isenabled-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [isEnabled](arkts-test-uitest-component-c.md#isenabled-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[isFocused<sup>9+</sup>](arkts-test-uitest-component-c.md#isfocused-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [isFocused](arkts-test-uitest-component-c.md#isfocused-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[isScrollable<sup>9+</sup>](arkts-test-uitest-component-c.md#isscrollable-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [isScrollable](arkts-test-uitest-component-c.md#isscrollable-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[isSelected<sup>9+</sup>](arkts-test-uitest-component-c.md#isselected-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [isSelected](arkts-test-uitest-component-c.md#isselected-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[longClick<sup>9+</sup>](arkts-test-uitest-component-c.md#longclick-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [longClick](arkts-test-uitest-component-c.md#longclick-1)
...
> **说明：**  
>  
> 从API version 8开始支持，从API version 9开始废弃，建议使用[scrollSearch<sup>9+</sup>](arkts-test-uitest-component-c.md#scrollsearch-1)替代。

**起始版本：** 8

**废弃版本：** 9

**替代接口：** [scrollSearch(on:](arkts-test-uitest-component-c.md#scrollsearch-1)
