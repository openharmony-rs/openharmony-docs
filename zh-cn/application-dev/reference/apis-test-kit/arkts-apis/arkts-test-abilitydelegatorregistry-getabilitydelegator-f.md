...
| 类型 | 说明 |
| --- | --- |
| [AbilityDelegator](arkts-test-abilitydelegatorregistry-abilitydelegator-t.md) | [AbilityDelegator](arkts-test-abilitydelegatorregistry-abilitydelegator-t.md)对象。可以用来调度测试框架相关功能。 |
