...
| SYSTEM_CANCEL_NOT_USE_USB                 | 16   | 申请USB类型长时任务，但是未检测到USB设备。<br/>**ArkTS-Dyn起始版本：** 26.2.0 <br/>**ArkTS-Sta起始版本：** 26.2.0<br/>**模型约束：** 此接口仅可在Stage模型下使用。  |
