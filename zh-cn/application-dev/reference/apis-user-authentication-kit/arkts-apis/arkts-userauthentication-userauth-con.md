...
[ReuseUnlockResult](arkts-userauthentication-reuseunlockresult-i.md)中reuseDuration参数的最大值。
...
[AuthLockState](arkts-userauthentication-authlockstate-i.md)的lockoutDuration字段返回。
