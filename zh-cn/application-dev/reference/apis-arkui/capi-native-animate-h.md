...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_SetCurve(OH_ArkUI_PropertyAnimationHandle animation, ArkUI_CurveHandle curve)](#oh_arkui_nativemodule_propertyanimation_setcurve) | 设置属性动画的动画曲线。<br>实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。支持弹簧曲线（springMotion、responsiveSpringMotion和interpolatingSpring）。设置弹簧曲线时，通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)设置的持续时间不生效，动画持续时间由弹簧曲线决定。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_GetCurve(OH_ArkUI_PropertyAnimationHandle animation, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_propertyanimation_getcurve) | 获取属性动画的动画曲线。<br>本接口仅返回在本动画上显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_PropertyAnimation_SetCurve](#oh_arkui_nativemodule_propertyanimation_setcurve)设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_GetDuration(OH_ArkUI_AnimationGroupHandle group, int32_t *duration)](#oh_arkui_nativemodule_animationgroup_getduration) | 获取动画组的持续时间。<br>本接口仅返回在本动画组上显式设置的持续时间，不受子动画的持续时间影响。如果本动画组未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时，未设置的动画组持续时间默认为1000毫秒。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_GetCurve(OH_ArkUI_AnimationGroupHandle group, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_animationgroup_getcurve) | 获取动画组的动画曲线。<br>本接口仅返回在本动画组上显式设置的曲线，不受子动画的曲线影响。如果本动画组未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时，未设置的动画组曲线默认为[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。 |
...
| -- | -- |
| [ArkUI_AnimateOption](capi-arkui-nativemodule-arkui-animateoption.md)* option | 动画效果参数。<br>option为NULL时，操作无效。 |
| float value | 动画播放速率，取值范围：[0, +∞)。<br/>**说明：**<br/>传入小于0的数值，会默认设置为1。 |
...
> **说明：**
>
> 当Animator动画为关键帧动画[ArkUI_KeyframeAnimateOption](./capi-arkui-nativemodule-arkui-keyframeanimateoption.md)时，此方法不生效。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [出参] 表示用于接收[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)起始值数组的指针。<br>value中元素的数量和类型取决于创建属性动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_propertyanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。值将写入该指针指向的内存。<br>该指针不能为NULL。如果value设置为NULL，则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode)。 |
| int32_t size | [入参] 表示输出数组的大小。必须等于[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)所需的元素个数，否则返回错误码[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-native-type-h.md#arkui_errorcode)。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode) 未设置起始值。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-native-type-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode) 未设置结束值。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-native-type-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode) 未设置持续时间。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常。 |
...
实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。支持弹簧曲线（springMotion、responsiveSpringMotion和interpolatingSpring）。设置弹簧曲线时，通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)设置的持续时间不生效，动画持续时间由弹簧曲线决定。
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode) 未设置曲线。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t iterations | [入参] 表示播放次数。该值必须为-1或大于等于1；值为0时返回[ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode)。值-1表示无限次播放。默认值为1。 |
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode) 关键帧的值未设置。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-native-type-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
本接口仅返回为关键帧显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果关键帧未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurve](#oh_arkui_nativemodule_keyframeanimation_setcurve)或[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurves](#oh_arkui_nativemodule_keyframeanimation_setcurves)为关键帧设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。
...
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示路径动画句柄。 |
| [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) curve | [入参] 表示控制沿路径运动速率的动画曲线。<br>本接口不接管曲线句柄的所有权；调用者必须确保在使用该动画句柄期间，曲线保持有效。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。 |
...
本接口仅返回在本动画组上显式设置的持续时间，不受子动画的持续时间影响。如果本动画组未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时，未设置的动画组持续时间默认为1000毫秒。
...
本接口仅返回在本动画组上显式设置的曲线，不受子动画的曲线影响。如果本动画组未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-native-type-h.md#arkui_errorcode)。运行时，未设置的动画组曲线默认为[ARKUI_CURVE_LINEAR](capi-native-type-h.md#arkui_animationcurve)。
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-native-type-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-native-type-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-native-type-h.md#arkui_errorcode) 函数参数异常，或解析后的目标节点不属于与context相同的UIContext。<br>         [ARKUI_ERROR_CODE_SUB_ANIMATION_INVALID](capi-native-type-h.md#arkui_errorcode) 子动画无可解析的目标节点或子动画参数非法。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-native-type-h.md#arkui_errorcode) 检测到同线程重入调用。 |
