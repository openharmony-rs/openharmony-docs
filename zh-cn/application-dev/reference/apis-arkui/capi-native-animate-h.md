...
| [OH_ArkUI_PropertyAnimation*](capi-arkui-nativemodule-arkui-propertyanimation8h.md) | OH_ArkUI_PropertyAnimationHandle | 定义属性动画的句柄。 |
| [OH_ArkUI_KeyframeAnimation*](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) | OH_ArkUI_KeyframeAnimationHandle | 定义关键帧动画的句柄。 |
| [OH_ArkUI_PathAnimation*](capi-arkui-nativemodule-arkui-pathanimation8h.md) | OH_ArkUI_PathAnimationHandle | 定义路径动画的句柄。 |
| [OH_ArkUI_AnimationGroup*](capi-arkui-nativemodule-arkui-animationgroup8h.md) | OH_ArkUI_AnimationGroupHandle | 定义动画组的句柄。 |
...
| [float OH_ArkUI_AnimateOption_GetTempo(ArkUI_AnimateOption* option)](#oh_arkui_animateoption_gettempo) | 获取动画播放速率。 |
...
| [void OH_ArkUI_AnimateOption_SetTempo(ArkUI_AnimateOption* option, float value)](#oh_arkui_animateoption_settempo) | 设置动画播放速率。 |
...
| [ArkUI_CurveHandle OH_ArkUI_Curve_CreateSpringMotion(float response, float dampingFraction, float overlapDuration)](#oh_arkui_curve_createspringmotion) | 构造弹性动画曲线对象。如果对同一对象的同一属性进行多个弹性动画，每个动画会替换前一个动画，并继承之前的速度。 |
| [ArkUI_CurveHandle OH_ArkUI_Curve_CreateResponsiveSpringMotion(float response, float dampingFraction, float overlapDuration)](#oh_arkui_curve_createresponsivespringmotion) | 构造弹性跟手动画曲线对象，是springMotion的一种特例，仅默认参数不同，可与springMotion混合使用。如果对同一对象的同一属性进行多个弹性动画，每个动画会替换前一个动画，并继承之前的速度。 |
...
| [OH_ArkUI_PropertyAnimationHandle OH_ArkUI_NativeModule_PropertyAnimation_Create(OH_ArkUI_AnimationPropertyType propertyType)](#oh_arkui_nativemodule_propertyanimation_create) | 为指定的可动画属性创建属性动画。<br>propertyType必须是有效的[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，否则本接口返回NULL。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_SetFromValue(OH_ArkUI_PropertyAnimationHandle animation, const ArkUI_NumberValue *value, int32_t size)](#oh_arkui_nativemodule_propertyanimation_setfromvalue) | 设置属性动画的起始值。<br>推荐设置起始值，若未设置则默认从当前属性值开始产生动画。如果未设置起始值且对应属性从未被赋值，由于缺少有效的起始状态，属性动画将无法产生。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_SetCurve(OH_ArkUI_PropertyAnimationHandle animation, ArkUI_CurveHandle curve)](#oh_arkui_nativemodule_propertyanimation_setcurve) | 设置属性动画的动画曲线。<br>实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。支持弹簧曲线（springMotion、responsiveSpringMotion和interpolatingSpring）。设置弹簧曲线时，通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)设置的持续时间不生效，动画持续时间由弹簧曲线决定。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_GetCurve(OH_ArkUI_PropertyAnimationHandle animation, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_propertyanimation_getcurve) | 获取属性动画的动画曲线。<br>本接口仅返回在本动画上显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_PropertyAnimation_SetCurve](#oh_arkui_nativemodule_propertyanimation_setcurve)设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_SetAutoReverse(OH_ArkUI_PropertyAnimationHandle animation, bool autoReverse)](#oh_arkui_nativemodule_propertyanimation_setautoreverse) | 设置属性动画是否自动反转。<br>启用自动反转后，动画在每轮播放中交替正向播放和反向播放。默认值为false。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PropertyAnimation_SetTargetNode(OH_ArkUI_PropertyAnimationHandle animation, ArkUI_RenderNodeHandle targetNode)](#oh_arkui_nativemodule_propertyanimation_settargetnode) | 设置属性动画的目标渲染节点。<br>目标节点是被该属性动画驱动的渲染节点。如果为NULL（默认值），则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。非NULL目标必须属于动画组注册的同一UIContext，该检查在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时执行。 |
...
| [OH_ArkUI_KeyframeAnimationHandle OH_ArkUI_NativeModule_KeyframeAnimation_Create(OH_ArkUI_AnimationPropertyType propertyType, int32_t size)](#oh_arkui_nativemodule_keyframeanimation_create) | 为指定的可动画属性创建关键帧动画。<br>每个关键帧的关键帧时间点默认按索引在[0, 1]区间均匀分布（例如，当有3个关键帧时，第一帧为0.0，第二帧为0.5，第三帧为1.0）。使用[OH_ArkUI_NativeModule_KeyframeAnimation_SetKeyTimes](#oh_arkui_nativemodule_keyframeanimation_setkeytimes)或[OH_ArkUI_NativeModule_KeyframeAnimation_SetKeyTime](#oh_arkui_nativemodule_keyframeanimation_setkeytime)自定义关键帧时间点。<br>propertyType必须是有效的[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，且size必须大于等于2；否则，本接口返回NULL。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_KeyframeAnimation_SetKeyTime(OH_ArkUI_KeyframeAnimationHandle animation, int32_t index, float keyTime)](#oh_arkui_nativemodule_keyframeanimation_setkeytime) | 设置指定索引处关键帧的关键帧时间点。<br>如果不调用本接口设置某个关键帧，其关键帧时间点默认按索引在[0, 1]区间均匀分布（例如，当有3个关键帧时，第一帧为0.0，第二帧为0.5，第三帧为1.0）。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_KeyframeAnimation_GetCurve(OH_ArkUI_KeyframeAnimationHandle animation, int32_t index, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_keyframeanimation_getcurve) | 获取指定索引处关键帧的动画曲线。<br>本接口仅返回为关键帧显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果关键帧未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurve](#oh_arkui_nativemodule_keyframeanimation_setcurve)或[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurves](#oh_arkui_nativemodule_keyframeanimation_setcurves)为关键帧设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_KeyframeAnimation_SetDuration(OH_ArkUI_KeyframeAnimationHandle animation, int32_t duration)](#oh_arkui_nativemodule_keyframeanimation_setduration) | 设置关键帧动画的持续时间。<br>实际生效的动画持续时间按以下优先级确定：如果通过本接口设置了持续时间，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetDuration](#oh_arkui_nativemodule_animationgroup_setduration)在动画组上设置的持续时间；如果两者都未设置，则使用默认值1000毫秒。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_KeyframeAnimation_GetDuration(OH_ArkUI_KeyframeAnimationHandle animation, int32_t *duration)](#oh_arkui_nativemodule_keyframeanimation_getduration) | 获取关键帧动画的持续时间。<br>本接口仅返回在本动画上显式设置的持续时间；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画持续时间按以下优先级确定：如果通过[OH_ArkUI_NativeModule_KeyframeAnimation_SetDuration](#oh_arkui_nativemodule_keyframeanimation_setduration)设置了持续时间，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetDuration](#oh_arkui_nativemodule_animationgroup_setduration)设置的动画组持续时间；如果两者都未设置，则使用默认值1000毫秒。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_KeyframeAnimation_SetAutoReverse(OH_ArkUI_KeyframeAnimationHandle animation, bool autoReverse)](#oh_arkui_nativemodule_keyframeanimation_setautoreverse) | 设置关键帧动画是否自动反转。<br>启用自动反转后，动画在每轮播放中交替正向播放和反向播放。默认值为false。 |
...
| [OH_ArkUI_PathAnimationHandle OH_ArkUI_NativeModule_PathAnimation_Create(const char *path)](#oh_arkui_nativemodule_pathanimation_create) | 创建路径动画，使组件沿几何路径移动。<br>路径动画作用于[OH_ARKUI_ANIMATION_PROPERTY_TRANSLATION](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)属性。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PathAnimation_GetCurve(OH_ArkUI_PathAnimationHandle animation, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_pathanimation_getcurve) | 获取路径动画的动画曲线。<br>本接口仅返回在本动画上显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_PathAnimation_SetCurve](#oh_arkui_nativemodule_pathanimation_setcurve)设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PathAnimation_SetAutoReverse(OH_ArkUI_PathAnimationHandle animation, bool autoReverse)](#oh_arkui_nativemodule_pathanimation_setautoreverse) | 设置路径动画是否自动反转。<br>启用自动反转后，动画在每轮播放中交替正向播放和反向播放。默认值为false。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_PathAnimation_SetAutoRotation(OH_ArkUI_PathAnimationHandle animation, bool autoRotation)](#oh_arkui_nativemodule_pathanimation_setautorotation) | 设置路径动画过程中组件是否沿路径切线方向自动旋转。<br>启用自动旋转后，组件将旋转使其朝向方向与当前位置的路径切线对齐。默认值为false。 |
...
| [OH_ArkUI_AnimationGroupHandle OH_ArkUI_NativeModule_AnimationGroup_Create()](#oh_arkui_nativemodule_animationgroup_create) | 创建动画组。 |
| [void OH_ArkUI_NativeModule_AnimationGroup_Destroy(OH_ArkUI_AnimationGroupHandle group)](#oh_arkui_nativemodule_animationgroup_destroy) | 销毁动画组的前端句柄。<br>本接口仅释放前端句柄。通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册的动画组的后端（运行时）对象将被单独释放——在finish回调触发时自动释放，或通过[OH_ArkUI_NativeModule_RemoveAnimationGroup](#oh_arkui_nativemodule_removeanimationgroup)释放。<br>添加到动画组的子动画不会被自动销毁。需要分别调用[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)、[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)或[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_SetDuration(OH_ArkUI_AnimationGroupHandle group, int32_t duration)](#oh_arkui_nativemodule_animationgroup_setduration) | 设置动画组的持续时间。<br>动画组的持续时间作为未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetDuration](#oh_arkui_nativemodule_keyframeanimation_setduration)或[OH_ArkUI_NativeModule_PathAnimation_SetDuration](#oh_arkui_nativemodule_pathanimation_setduration)设置自身持续时间的子动画的默认持续时间。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_GetDuration(OH_ArkUI_AnimationGroupHandle group, int32_t *duration)](#oh_arkui_nativemodule_animationgroup_getduration) | 获取动画组的持续时间。<br>本接口仅返回在本动画组上显式设置的持续时间，不受子动画的持续时间影响。如果本动画组未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时，未设置的动画组持续时间默认为1000毫秒。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_SetCurve(OH_ArkUI_AnimationGroupHandle group, ArkUI_CurveHandle curve)](#oh_arkui_nativemodule_animationgroup_setcurve) | 设置动画组的动画曲线。<br>动画组的曲线作为未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetCurve](#oh_arkui_nativemodule_propertyanimation_setcurve)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurve](#oh_arkui_nativemodule_keyframeanimation_setcurve)或[OH_ArkUI_NativeModule_PathAnimation_SetCurve](#oh_arkui_nativemodule_pathanimation_setcurve)设置自身曲线的子动画的默认曲线。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。 |
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_GetCurve(OH_ArkUI_AnimationGroupHandle group, ArkUI_CurveHandle *outBorrowedCurve)](#oh_arkui_nativemodule_animationgroup_getcurve) | 获取动画组的动画曲线。<br>本接口仅返回在本动画组上显式设置的曲线，不受子动画的曲线影响。如果本动画组未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时，未设置的动画组曲线默认为[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_SetAutoReverse(OH_ArkUI_AnimationGroupHandle group, bool autoReverse)](#oh_arkui_nativemodule_animationgroup_setautoreverse) | 设置动画组是否自动反转。<br>启用自动反转后，动画组在每轮播放中交替正向播放和反向播放。默认值为false。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode(OH_ArkUI_AnimationGroupHandle group, ArkUI_RenderNodeHandle targetNode)](#oh_arkui_nativemodule_animationgroup_settargetnode) | 设置动画组的默认目标渲染节点。<br>默认目标是被未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetTargetNode](#oh_arkui_nativemodule_propertyanimation_settargetnode)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetTargetNode](#oh_arkui_nativemodule_keyframeanimation_settargetnode)或[OH_ArkUI_NativeModule_PathAnimation_SetTargetNode](#oh_arkui_nativemodule_pathanimation_settargetnode)设置自身目标的子动画驱动的渲染节点。在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时，每个子动画必须解析为非NULL目标（自身的目标或动画组默认目标）；任何解析后的目标必须属于动画组注册的同一UIContext。默认值为NULL。 |
...
| [ArkUI_ErrorCode OH_ArkUI_NativeModule_AddAnimationGroup(ArkUI_ContextHandle context, OH_ArkUI_AnimationGroupHandle group, const char *key)](#oh_arkui_nativemodule_addanimationgroup) | 在UIContext上以指定key注册动画组并开始播放。<br>UIContext通过key拥有动画组：注册后，UIContext持有动画组的后端（运行时）对象，调用者可以在注册后销毁前端动画组句柄（及子动画句柄），因为后端通过(UIContext, key)独立运行。key按UIContext（实例）划分作用域：不同UIContext中的相同key不会冲突。在一个UIContext内，如果已用相同key注册了动画组，系统会先移除前一个动画组（释放其后端对象）再注册新动画组。动画组随后通过相同的(UIContext, key)对进行标识和管理。<br>通过[OH_ArkUI_NativeModule_AnimationGroup_AddPropertyAnimation](#oh_arkui_nativemodule_animationgroup_addpropertyanimation)、[OH_ArkUI_NativeModule_AnimationGroup_AddKeyframeAnimation](#oh_arkui_nativemodule_animationgroup_addkeyframeanimation)或[OH_ArkUI_NativeModule_AnimationGroup_AddPathAnimation](#oh_arkui_nativemodule_animationgroup_addpathanimation)添加的每个子动画，驱动其自身设置的目标节点；如果该目标未设置（或为NULL），则继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。注册时，每个子动画必须解析为非NULL目标节点（自身的或动画组默认的），且每个解析后的目标节点必须属于与context相同的UIContext；否则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。<br>播放控制和生命周期接口（[OH_ArkUI_NativeModule_RemoveAnimationGroup](#oh_arkui_nativemodule_removeanimationgroup)、[OH_ArkUI_NativeModule_GetAnimationGroupState](#oh_arkui_nativemodule_getanimationgroupstate)、[OH_ArkUI_NativeModule_HasAnimationGroup](#oh_arkui_nativemodule_hasanimationgroup)、[OH_ArkUI_NativeModule_PauseAnimationGroup](#oh_arkui_nativemodule_pauseanimationgroup)、[OH_ArkUI_NativeModule_ResumeAnimationGroup](#oh_arkui_nativemodule_resumeanimationgroup)、[OH_ArkUI_NativeModule_FinishAnimationGroup](#oh_arkui_nativemodule_finishanimationgroup)）均以(UIContext, key)对为键。<br>finish回调（见[OH_ArkUI_NativeModule_AnimationGroup_RegisterOnFinishCallback](#oh_arkui_nativemodule_animationgroup_registeronfinishcallback)）仅触发一次，由停止动画的事件触发——自然结束、[OH_ArkUI_NativeModule_FinishAnimationGroup](#oh_arkui_nativemodule_finishanimationgroup)或目标节点销毁。如果[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)返回错误，动画创建失败，finish回调不会被触发。回调返回后，系统自动从UIContext移除动画组并释放动画组及其子动画的后端（运行时）对象；前端句柄（动画组及其子动画）仍需由调用者通过[OH_ArkUI_NativeModule_AnimationGroup_Destroy](#oh_arkui_nativemodule_animationgroup_destroy)、[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)、[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)或[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)销毁。 |
...
| 类型 | 说明 |
| -- | -- |
| float | 动画播放速率。取值范围：[0, +∞)。option异常时返回0.0。 |
...
| -- | -- |
| [ArkUI_AnimateOption](capi-arkui-nativemodule-arkui-animateoption.md)* option | 动画效果参数。<br>option为NULL时，操作无效。 |
| float value | 动画播放速率，默认值1.0。取值范围：[0, +∞)。<br>**说明：**<br>传入小于0的数值，会默认设置为1。 |
...
构造弹性动画曲线对象。如果对同一对象的同一属性进行多个弹性动画，每个动画会替换前一个动画，并继承之前的速度。
...
propertyType必须是有效的[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，否则本接口返回NULL。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype) propertyType | [入参] 表示要动画的属性类型。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) | 返回属性动画的句柄。调用者拥有返回的句柄，不再使用时需要调用[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)释放该句柄。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示由[OH_ArkUI_NativeModule_PropertyAnimation_Create](#oh_arkui_nativemodule_propertyanimation_create)返回的属性动画句柄。传入NULL无效果。该函数对非NULL句柄返回后，句柄即失效，不得再次使用或销毁。 |
...
推荐设置起始值，若未设置则默认从当前属性值开始产生动画。如果属性动画未设置属性的起始值且对应属性从未被赋值，由于缺少有效的起始状态，属性动画将无法产生。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| const [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [入参] 表示起始值。value中元素的数量和类型取决于创建属性动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_propertyanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。 |
| int32_t size | [入参] 表示value数组中的元素个数。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [出参] 表示用于接收[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)起始值数组的指针。<br>value中元素的数量和类型取决于创建属性动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_propertyanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。值将写入该指针指向的内存。<br>该指针不能为NULL。如果value设置为NULL，则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
| int32_t size | [入参] 表示输出数组的大小。必须等于[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)所需的元素个数，否则返回错误码[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 未设置起始值。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| const [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [入参] 表示结束值。value中元素的数量和类型取决于创建属性动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_propertyanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。 |
| int32_t size | [入参] 表示value数组中的元素个数。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [出参] 表示用于接收[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)结束值数组的指针。<br>value中元素的数量和类型取决于创建属性动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_propertyanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。值将写入该指针指向的内存。<br>该指针不能为NULL。如果value设置为NULL，则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
| int32_t size | [入参] 表示输出数组的大小。必须等于[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)所需的元素个数；否则返回错误码[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 未设置结束值。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
实际生效的动画持续时间按以下优先级确定：如果通过本接口设置了子动画的持续时间，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetDuration](#oh_arkui_nativemodule_animationgroup_setduration)在动画组上设置的持续时间；如果两者都未设置，则使用默认值1000毫秒。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t duration | [入参] 表示持续时间，单位为毫秒。该值必须大于0。 |
...
本接口仅返回在本动画上显式设置的持续时间；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画持续时间按以下优先级确定：如果通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)设置了持续时间，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetDuration](#oh_arkui_nativemodule_animationgroup_setduration)设置的动画组持续时间；如果两者都未设置，则使用默认值1000毫秒。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t *duration | [出参] 表示用于接收持续时间值的指针，单位为毫秒。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 未设置持续时间。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t delay | [入参] 表示延迟时间，单位为毫秒。默认值为0。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t *delay | [出参] 表示用于接收延迟时间值的指针，单位为毫秒。 |
...
实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。支持弹簧曲线（springMotion、responsiveSpringMotion和interpolatingSpring）。设置弹簧曲线时，通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)设置的持续时间不生效，动画持续时间由弹簧曲线决定。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) curve | [入参] 表示动画曲线。本接口不接管曲线句柄的所有权；调用者必须确保在使用该动画句柄期间，曲线保持有效。 |
...
本接口仅返回在本动画上显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果本动画未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_PropertyAnimation_SetCurve](#oh_arkui_nativemodule_propertyanimation_setcurve)设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) *outBorrowedCurve | [出参] 表示用于接收动画曲线的指针；调用者不得销毁该句柄。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 未设置曲线。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| float tempo | [入参] 表示动画播放速率。取值范围：(0, +∞)。默认值为1。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| float *tempo | [出参] 表示用于接收动画播放速率的指针。 |
...
启用自动反转后，动画在每轮播放中交替正向播放和反向播放。默认值为false。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| bool autoReverse | [入参] 表示是否启用自动反转。true表示启用自动反转，动画在每轮播放中交替正向播放和反向播放；false表示不启用，动画仅正向播放。默认值为false。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| bool *autoReverse | [出参] 表示用于接收该值的指针。如果启用自动反转则为true；否则为false。默认值为false。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t iterations | [入参] 表示播放次数。该值必须为-1或大于等于1；值为0时返回[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。值-1表示无限次播放。默认值为1。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| int32_t *iterations | [出参] 表示用于接收播放次数的指针。 |
...
目标节点是被该属性动画驱动的渲染节点。如果为NULL（默认值），则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。非NULL目标必须属于动画组注册的同一UIContext，该检查在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时执行。
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_RenderNodeHandle](capi-arkui-nativemodule-arkui-rendernodehandle.md) targetNode | [入参] 表示要动画的渲染节点。NULL表示继承动画组的默认目标。默认值为NULL。 |
...
| -- | -- |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示属性动画句柄。 |
| [ArkUI_RenderNodeHandle](capi-arkui-nativemodule-arkui-rendernodehandle.md) *outBorrowedTargetNode | [出参] 表示用于接收目标渲染节点的指针；调用者不得销毁该句柄。NULL表示继承动画组的默认目标。 |
...
每个关键帧的关键帧时间点默认按索引在[0, 1]区间均匀分布（例如，当有3个关键帧时，第一帧为0.0，第二帧为0.5，第三帧为1.0）。使用[OH_ArkUI_NativeModule_KeyframeAnimation_SetKeyTimes](#oh_arkui_nativemodule_keyframeanimation_setkeytimes)或[OH_ArkUI_NativeModule_KeyframeAnimation_SetKeyTime](#oh_arkui_nativemodule_keyframeanimation_setkeytime)自定义关键帧时间点。

propertyType必须是有效的[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，且size必须大于等于2；否则，本接口返回NULL。
...
| -- | -- |
| [OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype) propertyType | [入参] 表示要动画的属性类型。 |
| int32_t size | [入参] 表示关键帧数量。该值必须大于等于2。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) | 返回关键帧动画的句柄。调用者拥有返回的句柄，不再使用时需要调用[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)释放该句柄。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示由[OH_ArkUI_NativeModule_KeyframeAnimation_Create](#oh_arkui_nativemodule_keyframeanimation_create)返回的关键帧动画句柄。<br>传入NULL无效果。该函数对非NULL句柄返回后，句柄即失效，不得再次使用或销毁。 |
...
如果不调用本接口，每个关键帧的关键帧时间点默认按索引在[0, 1]区间均匀分布（例如，当有3个关键帧时，第一帧为0.0，第二帧为0.5，第三帧为1.0）。

keyTimes中的元素必须非递减，且size必须等于关键帧动画的关键帧数量（即通过[OH_ArkUI_NativeModule_KeyframeAnimation_Create](#oh_arkui_nativemodule_keyframeanimation_create)创建动画时指定的size值）。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| const float *keyTimes | [入参] 表示关键帧时间点数组，为归一化时间比例，取值范围[0, 1]。 |
| int32_t size | [入参] 表示关键帧时间点的数量。 |
...
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| int32_t index | [入参] 表示关键帧索引。 |
| float *keyTime | [出参] 表示用于接收关键帧时间点的指针，为归一化时间比例，取值范围[0, 1]。 |
...
如果不调用本接口设置某个关键帧，其关键帧时间点默认按索引在[0, 1]区间均匀分布（例如，当有3个关键帧时，第一帧为0.0，第二帧为0.5，第三帧为1.0）。
...
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| int32_t index | [入参] 表示关键帧索引。 |
| float keyTime | [入参] 表示关键帧时间点，为归一化时间比例，取值范围[0, 1]。 |
...
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| int32_t index | [入参] 表示关键帧索引。 |
| const [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [入参] 表示[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)数组。<br>value中元素的数量和类型取决于创建关键帧动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_keyframeanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。 |
| int32_t size | [入参] 表示value数组中的元素个数。 |
...
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| const [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *values | [入参] 表示所有关键帧的[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)扁平数组。每个关键帧的元素数量取决于创建关键帧动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_keyframeanimation_create)的取值。例如，[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)每个关键帧需要1个值，[OH_ARKUI_ANIMATION_PROPERTY_TRANSLATION](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)每个关键帧需要2个值。元素总数必须等于关键帧数量乘以每个关键帧的值数量。 |
| int32_t size | [入参] 表示values数组中的元素总数。 |
...
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| int32_t index | [入参] 表示关键帧索引。 |
| [ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md) *value | [出参] 表示用于接收[ArkUI_NumberValue](capi-arkui-nativemodule-arkui-numbervalue.md)值数组的指针。<br>value中元素的数量和类型取决于创建关键帧动画时传入的[propertyType](capi-native-animate-h.md#oh_arkui_nativemodule_keyframeanimation_create)的取值，具体请参考[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)的枚举描述。例如，如果取值为[OH_ARKUI_ANIMATION_PROPERTY_OPACITY](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)，则value需要传入1个f32值。值将写入该指针指向的内存。<br>该指针不能为NULL。如果value设置为NULL，则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
| int32_t size | [入参] 表示输出数组的大小。必须等于[OH_ArkUI_AnimationPropertyType](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)所需的元素个数；否则返回错误码[ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 关键帧的值未设置。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 数组大小与所需大小不一致。 |
...
| -- | -- |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| const [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) *value | [入参] 表示曲线句柄数组。本接口不接管曲线句柄的所有权；调用者必须确保在使用该动画句柄期间，所有曲线保持有效。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。 |
| int32_t size | [入参] 表示曲线数量。 |
...
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示关键帧动画句柄。 |
| int32_t index | [入参] 表示关键帧索引。 |
| [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) curve | [入参] 表示动画曲线。本接口不接管曲线句柄的所有权；调用者必须确保在使用该动画句柄期间，曲线保持有效。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。实际生效的动画曲线按以下优先级确定：如果通过本接口或[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurves](#oh_arkui_nativemodule_keyframeanimation_setcurves)为关键帧设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
...
本接口仅返回为关键帧显式设置的曲线；从动画组继承的值或默认值在运行时解析，不存储在本对象上。如果关键帧未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时实际生效的动画曲线按以下优先级确定：如果通过[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurve](#oh_arkui_nativemodule_keyframeanimation_setcurve)或[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurves](#oh_arkui_nativemodule_keyframeanimation_setcurves)为关键帧设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)设置的动画组曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。
...
实际生效的动画持续时间按以下优先级确定：如果通过本接口设置了持续时间，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetDuration](#oh_arkui_nativemodule_animationgroup_setduration)在动画组上设置的持续时间；如果两者都未设置，则使用默认值1000毫秒。
...
目标节点是被该关键帧动画驱动的渲染节点。如果为NULL（默认值），则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。非NULL目标必须属于动画组注册的同一UIContext，该检查在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时执行。
...
路径动画作用于[OH_ARKUI_ANIMATION_PROPERTY_TRANSLATION](capi-native-type-visual-h.md#oh_arkui_animationpropertytype)属性。
...
| 参数项 | 描述 |
| -- | -- |
| const char *path | [入参] 表示SVG路径语法的路径字符串。不支持"start"和"end"关键字作为位置值。如果path为NULL、空字符串或包含不支持的值，则返回NULL。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) | 返回路径动画的句柄。输入无效时返回NULL。调用者拥有返回的句柄，不再使用时需要调用[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)释放该句柄。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示由[OH_ArkUI_NativeModule_PathAnimation_Create](#oh_arkui_nativemodule_pathanimation_create)返回的路径动画句柄。传入NULL无效果。该函数对非NULL句柄返回后，句柄即失效，不得再次使用或销毁。 |
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示路径动画句柄。 |
| int32_t duration | [入参] 表示持续时间，单位为毫秒。该值必须大于0。 |
...
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示路径动画句柄。 |
| [ArkUI_CurveHandle](capi-arkui-nativemodule-arkui-curve8h.md) curve | [入参] 表示控制沿路径运动速率的动画曲线。<br>本接口不接管曲线句柄的所有权；调用者必须确保在使用该动画句柄期间，曲线保持有效。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。实际生效的动画曲线按以下优先级确定：如果通过本接口设置了曲线，则使用该值；否则，使用通过[OH_ArkUI_NativeModule_AnimationGroup_SetCurve](#oh_arkui_nativemodule_animationgroup_setcurve)在动画组上设置的曲线；如果两者都未设置，则使用[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。 |
...
设置路径动画过程中组件是否沿路径切线方向自动旋转。

启用自动旋转后，组件将旋转使其朝向方向与当前位置的路径切线对齐。默认值为false。
...
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示路径动画句柄。 |
| bool autoRotation | [入参] 表示是否启用自动旋转。true表示启用自动旋转，组件将旋转使其朝向与当前位置的路径切线对齐；false表示不启用，组件不随路径切线旋转。默认值为false。 |
...
| -- | -- |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示路径动画句柄。 |
| bool *autoRotation | [出参] 表示用于接收该值的指针。如果启用自动旋转则为true；否则为false。默认值为false。 |
...
目标节点是被该路径动画驱动的渲染节点。如果为NULL（默认值），则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。非NULL目标必须属于动画组注册的同一UIContext，该检查在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时执行。
...
| 类型 | 说明 |
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) | 返回动画组的句柄。调用者拥有返回的句柄，不再使用时需要调用[OH_ArkUI_NativeModule_AnimationGroup_Destroy](#oh_arkui_nativemodule_animationgroup_destroy)释放该句柄。 |
...
本接口仅释放前端句柄。通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册的动画组的后端（运行时）对象将被单独释放——在finish回调触发时自动释放，或通过[OH_ArkUI_NativeModule_RemoveAnimationGroup](#oh_arkui_nativemodule_removeanimationgroup)释放。

添加到动画组的子动画不会被自动销毁。需要分别调用[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)、[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)或[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示由[OH_ArkUI_NativeModule_AnimationGroup_Create](#oh_arkui_nativemodule_animationgroup_create)返回的动画组句柄。<br>传入NULL无效果。该函数对非NULL句柄返回后，句柄即失效，不得再次使用或销毁。 |
...
动画组的持续时间作为未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetDuration](#oh_arkui_nativemodule_propertyanimation_setduration)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetDuration](#oh_arkui_nativemodule_keyframeanimation_setduration)或[OH_ArkUI_NativeModule_PathAnimation_SetDuration](#oh_arkui_nativemodule_pathanimation_setduration)设置自身持续时间的子动画的默认持续时间。
...
| 参数项 | 描述 |
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| int32_t duration | [入参] 表示持续时间，单位为毫秒。该值必须大于0。 |
...
本接口仅返回在本动画组上显式设置的持续时间，不受子动画的持续时间影响。如果本动画组未设置持续时间，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时，未设置的动画组持续时间默认为1000毫秒。
...
动画组的曲线作为未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetCurve](#oh_arkui_nativemodule_propertyanimation_setcurve)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetCurve](#oh_arkui_nativemodule_keyframeanimation_setcurve)或[OH_ArkUI_NativeModule_PathAnimation_SetCurve](#oh_arkui_nativemodule_pathanimation_setcurve)设置自身曲线的子动画的默认曲线。不支持springMotion、responsiveSpringMotion和interpolatingSpring曲线，因为这些曲线没有有效的持续时间设置。
...
本接口仅返回在本动画组上显式设置的曲线，不受子动画的曲线影响。如果本动画组未设置曲线，则返回[ARKUI_ERROR_CODE_NO_ATTRIBUTE_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。运行时，未设置的动画组曲线默认为[ARKUI_CURVE_LINEAR](capi-native-type-visual-h.md#arkui_animationcurve)。
...
启用自动反转后，动画组在每轮播放中交替正向播放和反向播放。默认值为false。
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| const [ArkUI_ExpectedFrameRateRange](capi-arkui-nativemodule-arkui-expectedframeraterange.md) *frameRate | [入参] 表示期望帧率范围。 |
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [ArkUI_ExpectedFrameRateRange](capi-arkui-nativemodule-arkui-expectedframeraterange.md) *frameRate | [出参] 表示用于接收期望帧率范围的指针。<br>[ArkUI_ExpectedFrameRateRange](capi-arkui-nativemodule-arkui-expectedframeraterange.md)对象的值将写入该指针指向的内存。<br>该指针不能为NULL。如果frameRate设置为NULL，则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。 |
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| void *userData | [入参] 表示调用者拥有的自定义数据，原样传递给回调。可以为NULL，必须保持有效直到回调返回，本接口不负责释放该数据。 |
| void (*callback)(void *userData) | [入参] 表示完成回调函数。不能为NULL，在UI主线程上串行调用一次。 |
...
默认目标是被未通过[OH_ArkUI_NativeModule_PropertyAnimation_SetTargetNode](#oh_arkui_nativemodule_propertyanimation_settargetnode)、[OH_ArkUI_NativeModule_KeyframeAnimation_SetTargetNode](#oh_arkui_nativemodule_keyframeanimation_settargetnode)或[OH_ArkUI_NativeModule_PathAnimation_SetTargetNode](#oh_arkui_nativemodule_pathanimation_settargetnode)设置自身目标的子动画驱动的渲染节点。在通过[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)注册动画组时，每个子动画必须解析为非NULL目标（自身的目标或动画组默认目标）；任何解析后的目标必须属于动画组注册的同一UIContext。默认值为NULL。
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [ArkUI_RenderNodeHandle](capi-arkui-nativemodule-arkui-rendernodehandle.md) targetNode | [入参] 表示默认的要动画的渲染节点。NULL表示没有动画组级别的默认值。默认值为NULL。 |
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [ArkUI_RenderNodeHandle](capi-arkui-nativemodule-arkui-rendernodehandle.md) *outBorrowedTargetNode | [出参] 表示用于接收默认目标节点的指针；调用者不得销毁该句柄。NULL表示未设置动画组级别的默认值。 |
...
动画的目标节点由[OH_ArkUI_NativeModule_PropertyAnimation_SetTargetNode](#oh_arkui_nativemodule_propertyanimation_settargetnode)确定；如果未设置，则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。在注册动画组时，每个子动画必须解析为非NULL目标。
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [OH_ArkUI_PropertyAnimationHandle](capi-arkui-nativemodule-arkui-propertyanimation8h.md) animation | [入参] 表示要添加的属性动画。本接口不接管该动画句柄的所有权；调用者必须确保在使用动画组句柄期间，该动画保持有效。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_SUB_ANIMATION_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) OH_ArkUI_PropertyAnimationHandle参数无效。 |
...
动画的目标节点由[OH_ArkUI_NativeModule_KeyframeAnimation_SetTargetNode](#oh_arkui_nativemodule_keyframeanimation_settargetnode)确定；如果未设置，则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。在注册动画组时，每个子动画必须解析为非NULL目标。
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [OH_ArkUI_KeyframeAnimationHandle](capi-arkui-nativemodule-arkui-keyframeanimation8h.md) animation | [入参] 表示要添加的关键帧动画。本接口不接管该动画句柄的所有权；调用者必须确保在使用动画组句柄期间，该动画保持有效。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_SUB_ANIMATION_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) OH_ArkUI_KeyframeAnimationHandle参数无效。 |
...
动画的目标节点由[OH_ArkUI_NativeModule_PathAnimation_SetTargetNode](#oh_arkui_nativemodule_pathanimation_settargetnode)确定；如果未设置，则动画继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。在注册动画组时，每个子动画必须解析为非NULL目标。
...
| -- | -- |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| [OH_ArkUI_PathAnimationHandle](capi-arkui-nativemodule-arkui-pathanimation8h.md) animation | [入参] 表示要添加的路径动画。本接口不接管该动画句柄的所有权；调用者必须确保在使用动画组句柄期间，该动画保持有效。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_SUB_ANIMATION_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) OH_ArkUI_PathAnimationHandle参数无效。 |
...
在UIContext上以指定key注册动画组并开始播放。

UIContext通过key拥有动画组：注册后，UIContext持有动画组的后端（运行时）对象，调用者可以在注册后销毁前端动画组句柄（及子动画句柄），因为后端通过(UIContext, key)独立运行。key按UIContext（实例）划分作用域：不同UIContext中的相同key不会冲突。在一个UIContext内，如果已用相同key注册了动画组，系统会先移除前一个动画组（释放其后端对象）再注册新动画组。动画组随后通过相同的(UIContext, key)对进行标识和管理。

通过[OH_ArkUI_NativeModule_AnimationGroup_AddPropertyAnimation](#oh_arkui_nativemodule_animationgroup_addpropertyanimation)、[OH_ArkUI_NativeModule_AnimationGroup_AddKeyframeAnimation](#oh_arkui_nativemodule_animationgroup_addkeyframeanimation)或[OH_ArkUI_NativeModule_AnimationGroup_AddPathAnimation](#oh_arkui_nativemodule_animationgroup_addpathanimation)添加的每个子动画，驱动其自身设置的目标节点；如果该目标未设置（或为NULL），则继承通过[OH_ArkUI_NativeModule_AnimationGroup_SetTargetNode](#oh_arkui_nativemodule_animationgroup_settargetnode)设置的动画组默认目标。注册时，每个子动画必须解析为非NULL目标节点（自身的或动画组默认的），且每个解析后的目标节点必须属于与context相同的UIContext；否则返回错误码[ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。

播放控制和生命周期接口（[OH_ArkUI_NativeModule_RemoveAnimationGroup](#oh_arkui_nativemodule_removeanimationgroup)、[OH_ArkUI_NativeModule_GetAnimationGroupState](#oh_arkui_nativemodule_getanimationgroupstate)、[OH_ArkUI_NativeModule_HasAnimationGroup](#oh_arkui_nativemodule_hasanimationgroup)、[OH_ArkUI_NativeModule_PauseAnimationGroup](#oh_arkui_nativemodule_pauseanimationgroup)、[OH_ArkUI_NativeModule_ResumeAnimationGroup](#oh_arkui_nativemodule_resumeanimationgroup)、[OH_ArkUI_NativeModule_FinishAnimationGroup](#oh_arkui_nativemodule_finishanimationgroup)）均以(UIContext, key)对为键。

finish回调（见[OH_ArkUI_NativeModule_AnimationGroup_RegisterOnFinishCallback](#oh_arkui_nativemodule_animationgroup_registeronfinishcallback)）仅触发一次，由停止动画的事件触发——自然结束、[OH_ArkUI_NativeModule_FinishAnimationGroup](#oh_arkui_nativemodule_finishanimationgroup)或目标节点销毁。如果[OH_ArkUI_NativeModule_AddAnimationGroup](#oh_arkui_nativemodule_addanimationgroup)返回错误，动画创建失败，finish回调不会被触发。回调返回后，系统自动从UIContext移除动画组并释放动画组及其子动画的后端（运行时）对象；前端句柄（动画组及其子动画）仍需由调用者通过[OH_ArkUI_NativeModule_AnimationGroup_Destroy](#oh_arkui_nativemodule_animationgroup_destroy)、[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)、[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)或[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)销毁。
...
| 参数项 | 描述 |
| -- | -- |
| [ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md) context | [入参] 表示注册并播放动画组的[ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md)（UIContext）。 |
| [OH_ArkUI_AnimationGroupHandle](capi-arkui-nativemodule-arkui-animationgroup8h.md) group | [入参] 表示动画组句柄。 |
| const char *key | [入参] 表示用于在UIContext上标识动画组的key。key为用户自定义的字符串，在同一UIContext内需唯一。如果已用相同key注册了动画组，系统会先移除前一个动画组再注册新动画组。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常，或解析后的目标节点不属于与context相同的UIContext。<br>         [ARKUI_ERROR_CODE_SUB_ANIMATION_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 子动画无可解析的目标节点或子动画参数非法。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
...
从UIContext中移除指定key标识的动画组。

停止动画组（如果仍在运行）并释放动画组及其子动画的后端（运行时）对象。被动画的目标节点将恢复到动画开始时的状态。前端句柄（动画组及其子动画）不会被本调用释放，需要由调用者通过[OH_ArkUI_NativeModule_AnimationGroup_Destroy](#oh_arkui_nativemodule_animationgroup_destroy)、[OH_ArkUI_NativeModule_PropertyAnimation_Destroy](#oh_arkui_nativemodule_propertyanimation_destroy)、[OH_ArkUI_NativeModule_KeyframeAnimation_Destroy](#oh_arkui_nativemodule_keyframeanimation_destroy)或[OH_ArkUI_NativeModule_PathAnimation_Destroy](#oh_arkui_nativemodule_pathanimation_destroy)销毁。
...
| 参数项 | 描述 |
| -- | -- |
| [ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md) context | [入参] 表示注册动画组的UIContext。 |
| const char *key | [入参] 表示要移除的动画组的key。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_NOT_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 在UIContext上未找到key标识的动画组。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
...
| 参数项 | 描述 |
| -- | -- |
| [ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md) context | [入参] 表示UIContext。 |
| const char *key | [入参] 表示动画组的key。 |
| [OH_ArkUI_AnimationGroupState](capi-native-type-visual-h.md#oh_arkui_animationgroupstate) *state | [出参] 表示用于接收状态值的指针。 |
...
| [ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md) context | [入参] 表示UIContext。 |
| const char *key | [入参] 表示动画组的key。 |
| bool *exists | [入参] 表示用于接收该值的指针。如果动画组存在则为true；否则为false。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
...
暂停UIContext上指定key标识的动画组。

调用此接口时动画组必须处于[OH_ARKUI_ANIMATION_GROUP_STATE_RUNNING](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)状态；否则返回[ARKUI_ERROR_CODE_ANIMATION_GROUP_INVALID_STATE](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。可通过[OH_ArkUI_NativeModule_GetAnimationGroupState](#oh_arkui_nativemodule_getanimationgroupstate)查询动画组的播放状态。
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_NOT_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 在UIContext上未找到key标识的动画组。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_INVALID_STATE](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 动画组不处于[OH_ARKUI_ANIMATION_GROUP_STATE_RUNNING](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)状态。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
...
恢复UIContext上指定key标识的动画组。

调用此接口时动画组必须处于[OH_ARKUI_ANIMATION_GROUP_STATE_PAUSED](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)状态；否则返回[ARKUI_ERROR_CODE_ANIMATION_GROUP_INVALID_STATE](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode)。可通过[OH_ArkUI_NativeModule_GetAnimationGroupState](#oh_arkui_nativemodule_getanimationgroupstate)查询动画组的播放状态。
...
| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_NOT_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 在UIContext上未找到key标识的动画组。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_INVALID_STATE](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 动画组不处于[OH_ARKUI_ANIMATION_GROUP_STATE_PAUSED](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)状态。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
...
| [ArkUI_ContextHandle](capi-arkui-nativemodule-arkui-context8h.md) context | [入参] 表示UIContext。 |
| const char *key | [入参] 表示动画组的key。 |
| [OH_ArkUI_AnimationFinishMode](capi-native-type-visual-h.md#oh_arkui_animationfinishmode) mode | [入参] 表示结束模式。该值为[OH_ArkUI_AnimationFinishMode](capi-native-type-visual-h.md#oh_arkui_animationfinishmode)的枚举值。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| [ArkUI_ErrorCode](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) | 错误码。<br>         [ARKUI_ERROR_CODE_NO_ERROR](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 成功。<br>         [ARKUI_ERROR_CODE_PARAM_INVALID](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 函数参数异常，例如context或key无效，或mode不是OH_ArkUI_AnimationFinishMode的有效值。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_NOT_FOUND](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 在UIContext上未找到key标识的动画组。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_INVALID_STATE](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 动画组不处于[OH_ARKUI_ANIMATION_GROUP_STATE_RUNNING](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)或[OH_ARKUI_ANIMATION_GROUP_STATE_PAUSED](capi-native-type-visual-h.md#oh_arkui_animationgroupstate)状态。<br>         [ARKUI_ERROR_CODE_ANIMATION_GROUP_REENTRANT_CALL](capi-arkui-nativemodule-arkui-error-code-h.md#arkui_errorcode) 检测到同线程重入调用。 |
