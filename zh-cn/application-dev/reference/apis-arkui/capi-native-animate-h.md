...
设置关键帧动画播放完成回调。当关键帧动画[ArkUI_KeyframeAnimateOption](./capi-arkui-nativemodule-arkui-keyframeanimateoption.md#arkui_keyframeanimateoption)所有次数播放完成后调用。
...
> **说明：**
>
> 当Animator动画为关键帧动画[ArkUI_KeyframeAnimateOption](./capi-arkui-nativemodule-arkui-keyframeanimateoption.md#arkui_keyframeanimateoption)时，此方法不生效。
