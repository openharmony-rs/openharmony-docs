...
| weight         | ArkTS-Dyn: number<br>ArkTS-Sta: int  | 否 | 否 | 系统字体的字重。<br>取值范围：[100,900]，取值间隔为100，分别对应[FontWeight](../apis-arkgraphics2d/js-apis-graphics-text.md#fontweight)枚举中的值。        |
