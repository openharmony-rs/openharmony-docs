...
try {
  ...
  let error = exception as BusinessError;
  console.error(`Failed to get the display capability. Code: ${error.code}, message: ${error.message}`);
}
```