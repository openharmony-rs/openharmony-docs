...
| lunar<sup>5+</sup> | boolean      | false      | 否    | 设置日期选择器界面是否为农历展示。<br/>默认值：false，表示设置日期选择器界面为公历展示。                     |
...
| lunar<sup>5+</sup> | boolean | false                               | 否    | 设置日期时间选择器界面是否为农历展示。<br/>默认值：false，表示设置日期选择器界面为公历展示。                     |
