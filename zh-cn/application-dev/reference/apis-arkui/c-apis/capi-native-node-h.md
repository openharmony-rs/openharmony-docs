...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。 \n          {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。 \n<br>        {@link ARKUI_ERROR_CODE_NODE_EVENT_PARAM_INDEX_OUT_OF_RANGE} 组件事件中参数长度超限。 \n<br>        {@link ARKUI_ERROR_CODE_NODE_EVENT_PARAM_INVALID} 组件事件中不存在该数据。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。 \n         {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。 \n<br>        {@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。 \n<br>        {@link ERROR_CODE_NATIVE_IMPL_NODE_ADAPTER_NO_LISTENER_ERROR} NodeAdapter需要添加监听器。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。 \n          {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。 \n<br>        {@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。 \n<br>        {@link ARKUI_ERROR_CODE_NODE_IS_ADOPTED} 子节点已经被接纳。从API version 22开始支持。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。<br>    <br>{@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} CAPI初始化错误。<br>    <br>{@link ARKUI_ERROR_CODE_NODE_NOT_ON_MAIN_TREE} 节点未挂载到节点树上。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。          {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>        {@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。<br>        {@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} CAPI初始化错误。<br>        {@link ARKUI_ERROR_CODE_NODE_IS_ADOPTED} 子节点已经被接纳。从API version 22开始支持。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | Error code.          {@link ARKUI_ERROR_CODE_NO_ERROR} success.<br>        {@link ARKUI_ERROR_CODE_PARAM_INVALID} Function parameter exception.<br>        {@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} if the CAPI init error. |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 方法参数错误。<br>    <br>{@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} CAPI初始化错误。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。 \n          {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。 \n<br>        {@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} CAPI初始化错误。 \n<br>        {@link ARKUI_ERROR_CODE_FORCE_DARK_CONFIG_INVALID} 反色能力入参错误。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。<br>    <br>{@link ARKUI_ERROR_CODE_NODE_UNSUPPORTED_EVENT_TYPE} 暂不支持该事件类型。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} context对象无效或asyncUITask为空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} context对象无效或task为空指针。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。 \n          {@link ARKUI_ERROR_CODE_NO_ERROR} 操作成功。 \n<br>        {@link ARKUI_ERROR_CODE_UI_CONTEXT_INVALID} 实例异常（uiContext为空指针、无法通过uiContext获取容器、uiContext不属于原子化服务）。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_CAPI_INIT_ERROR} CAPI初始化错误。<br>    <br>{@link ARKUI_ERROR_CODE_UI_CONTEXT_INVALID} 实例异常。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果。  <ul><li>{@link ARKUI_ERROR_CODE_NO_ERROR}成功。<br></li><li>{@link RKUI_ERROR_CODE_CAPI_INIT_ERROR}如果CAPI初始化错误。<br></li><li>{@link ARKUI_ERROR_CODE_PARAM_INVALID}函数参数异常。</li></ul> |
