...
| [void OH_ArkUI_SwiperIndicator_SetItemWidth(ArkUI_SwiperIndicator* indicator, float value)](#oh_arkui_swiperindicator_setitemwidth) | 设置点指示器的点的宽度。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 1表示显示圆点导航指示器的蒙版样式，0表示不显示。 |
