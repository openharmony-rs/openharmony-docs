...
```c
typedef struct ArkUI_PickerIndicatorDivider {...} ArkUI_PickerIndicatorDivider
```
...
| uint32_t dividerColor | 分割线的颜色。 <br>        默认值：0（表示全透明颜色，分割线不可见） <br>        格式要求：0xARGB格式，例如0xFF1122FF。未设置颜色时使用默认值。 |
