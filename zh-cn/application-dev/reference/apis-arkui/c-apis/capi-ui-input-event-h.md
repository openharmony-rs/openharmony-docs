...
| [ArkUI_TouchTestInfo](capi-arkui-eventmodule-arkui-touchtestinfo.md) | ArkUI_TouchTestInfo | 定义触摸测试信息，用于设置命中测试策略和结果作用的子组件，并获取各子组件的触摸测试结果。<br>当用户通过{@link registerNodeEvent}注册了<br>{@link NODE_ON_CHILD_TOUCH_TEST}事件时，开发者才能在事件回调中获取此触摸测试信息结构体。<br>该结构体支持设置触摸测试策略（取值原则参见[ArkUI_TouchTestStrategy](capi-ui-input-event-h.md#arkui_touchteststrategy)） 和命中测试过程中需要作用的子组件ID，并可获取包含各子组件详细测试结果的触摸测试信息项数组。 |
...
| [ArkUI_CoastingAxisEvent* OH_ArkUI_UIInputEvent_GetCoastingAxisEvent(ArkUI_UIInputEvent* event)](#oh_arkui_uiinputevent_getcoastingaxisevent) | 从组件事件中获取惯性滚动轴事件，仅当用户在触摸板上使用双指滑动一定距离并快速抬手，且指针位置下存在注册了{@link NODE_ON_COASTING_AXIS_EVENT}事件的组件时，才能获取到有效事件。在从<br>{@link ArkUI_NodeEvent}对象获取到[ArkUI_UIInputEvent](capi-arkui-eventmodule-arkui-uiinputevent.md)对象后调用此方法。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>Returns {@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>Returns {@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回结果。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果发生参数异常，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_BUFFER_SIZE_NOT_ENOUGH} 内存分配不足。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 函数参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 参数异常。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果传入的缓冲区大小异常，则返回{@link ARKUI_ERROR_CODE_BUFFER_SIZE_ERROR}。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果输入的事件指针不是克隆事件指针，则返回{@link ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT}。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果输入的事件指针不是克隆事件指针，则返回{@link ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT}。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果输入的事件指针不是克隆事件指针，则返回{@link ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT}。<br>    <br>如果事件类型不支持，则返回{@link ARKUI_ERROR_INPUT_EVENT_TYPE_NOT_SUPPORTED}。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果输入的事件指针不是克隆事件指针，则返回{@link ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT}。<br>    <br>如果组件状态异常，则返回{@link ARKUI_ERROR_CODE_POST_CLONED_COMPONENT_STATUS_ABNORMAL}。<br>    <br>如果未命中可响应事件的组件，则返回{@link ARKUI_ERROR_CODE_POST_CLONED_NO_COMPONENT_HIT_TO_RESPOND_TO_THE_EVENT}。 |
...
| 类型 | 说明 |
| -- | -- |
| int32_t | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果输入的事件指针不是克隆事件指针，则返回{@link ARKUI_ERROR_CODE_NOT_CLONED_POINTER_EVENT}。<br>    <br>如果组件状态异常，则返回{@link ARKUI_ERROR_CODE_POST_CLONED_COMPONENT_STATUS_ABNORMAL}。<br>    <br>如果未命中可响应事件的组件，则返回{@link ARKUI_ERROR_CODE_POST_CLONED_NO_COMPONENT_HIT_TO_RESPOND_TO_THE_EVENT}。 |
...
从组件事件中获取惯性滚动轴事件，仅当用户在触摸板上使用双指滑动一定距离并快速抬手，且指针位置下存在注册了{@link NODE_ON_COASTING_AXIS_EVENT}事件的组件时，才能获取到有效事件。在从<br>{@link ArkUI_NodeEvent}对象获取到[ArkUI_UIInputEvent](capi-arkui-eventmodule-arkui-uiinputevent.md)对象后调用此方法。
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 返回结果代码。      <br>如果操作成功，则返回{@link ARKUI_ERROR_CODE_NO_ERROR}。<br>    <br>如果入参错误，则返回{@link ARKUI_ERROR_CODE_PARAM_INVALID}。<br>    <br>如果缓冲区空间不足，则返回{@link ARKUI_ERROR_CODE_BUFFER_SIZE_NOT_ENOUGH}。 |
...
| 类型 | 说明 |
| -- | -- |
| ArkUI_ErrorCode | 错误码。      <br>{@link ARKUI_ERROR_CODE_NO_ERROR} 成功。<br>    <br>{@link ARKUI_ERROR_CODE_PARAM_INVALID} 参数异常。 |
