...
- **[PasteIconStyle](#pasteiconstyle)**：粘贴控件图标风格枚举，用于指定控件展示的图标样式。
- **[PasteDescription](#pastedescription)**：粘贴控件文本描述枚举，用于指定控件展示的文字内容。
...
| text | [PasteDescription](#pastedescription) | 否 | 是 | 设置粘贴控件的文本描述。<br/>不传入该参数表示不显示文字描述。 |
| buttonType | [ButtonType](ts-securitycomponent-attributes.md#buttontype) | 否 | 是 | 设置粘贴控件的背景样式。<br/>默认值：ButtonType.Capsule。 |
