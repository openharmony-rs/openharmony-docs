...
| 参数名  | 类型                                                         | 必填 | 说明                                                         |
| ------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| blurRadius  | [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number>    | 是   | 当前组件添加内容模糊效果，入参为模糊半径，模糊半径越大越模糊。<br/>取值范围：[0, 1000]，blurRadius值小于等于0时不模糊，超出范围取最大值1000。<br/>当blurRadius的值为undefined时，恢复为渐变模糊为0的效果。 |
