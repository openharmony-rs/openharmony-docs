...
![未设置沉浸光感时](figures/actionsheetwithoutmaterial.gif)

设置沉浸光感后：

![设置沉浸光感后](figures/actionsheetwithmaterial.gif)