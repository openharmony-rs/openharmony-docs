...
ArkTS-Dyn: attributeModifier(modifier: AttributeModifier\<GaugeAttribute>)

ArkTS-Sta: attributeModifier(modifier: AttributeModifier\<GaugeAttribute> | AttributeModifier\<CommonMethod> | undefined)
...
该示例通过设置[GaugeOptions](#gaugeoptions8对象说明)的min、max属性，实现了量规图的最大最小值设置的功能。
