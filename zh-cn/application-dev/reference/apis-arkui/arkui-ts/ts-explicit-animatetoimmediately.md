...
ArkTS-Dyn: animateToImmediately(value: AnimateParam , event: () => void): void
...
| ArkTS-Dyn: event<br/>ArkTS-Sta: processor | ArkTS-Dyn: () => void<br/>ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) | 是 | 指定显示动效的闭包函数，在闭包函数中导致的状态变化系统会自动插入过渡动画。 |
