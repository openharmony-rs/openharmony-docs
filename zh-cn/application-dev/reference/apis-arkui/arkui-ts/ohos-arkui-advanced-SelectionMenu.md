...
| onSelectAll | ArkTS-Dyn: (event?: [EditorEventInfo](#editoreventinfo))&nbsp;=&gt;&nbsp;void<br/>ArkTS-Sta: [SelectionMenuOnSelectAllCallback](#selectionmenuonselectallback23) | 否 | 是 | 替代内置系统菜单全选项的事件回调。<br/>生效前提是一定要有controller参数，有系统默认菜单才能替换内置全选功能。<br/>**说明：**<br/>event为返回信息。|
...
ArkTS-Sta: type SelectionMenuOnPasteCallback = (event?: EditorEventInfo) => void
...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| event | [EditorEventInfo](#editoreventinfo) | 否 | 事件信息。 |

## SelectionMenuOnCopyCallback<sup>23+</sup>

ArkTS-Sta: type SelectionMenuOnCopyCallback = (event?: EditorEventInfo) => void
...
## SelectionMenuOnCutCallback<sup>23+</sup>

ArkTS-Sta: type SelectionMenuOnCutCallback = (event?: EditorEventInfo) => void
...
## SelectionMenuOnSelectAllCallback<sup>23+</sup>

ArkTS-Sta: type SelectionMenuOnSelectAllCallback = (event?: EditorEventInfo) => void
