...
创建多选框群组，用于控制群组内[Checkbox](ts-basic-components-checkbox.md)的全选或取消全选状态，具有相同group值的Checkbox和CheckboxGroup属于同一群组。

在结合带缓存功能的组件使用时（如[List](ts-container-list.md)），未被创建的[Checkbox](ts-basic-components-checkbox.md)选中状态需要应用手动控制。详细示例请参考[示例4](#示例4设置全选)。
...
在与带有缓存功能的组件（如[List](ts-container-list.md)）配合使用时，未创建的[Checkbox](ts-basic-components-checkbox.md)选中状态需由开发者控制。
...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[selectAll<sup>23+</sup>](#selectall23)。
...
### selectAll<sup>23+</sup>

selectAll(isAllSelected: boolean | undefined | Bindable\<boolean\>)
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[selectAll](#selectall)和[selectAll<sup>18+</sup>](#selectall18)。
...
| 参数名 | 类型    | 必填 | 说明                                                         |
| ------ | ------- | ---- | ------------------------------------------------------------ |
| isAllSelected | boolean \| undefined \| Bindable\<boolean\>| 是   | 是否全选。<br/>默认值：false<br/>值为true时，多选框群组将全部被选中；值为false时，多选框群组将全部取消选中。 |
...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[selectedColor<sup>23+</sup>](#selectedcolor23)。
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| resColor | [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[ResourceColor](ts-types.md#resourcecolor)> | 是   | 被选中或部分选中状态的颜色。<br/>当resColor的值为undefined时，按照默认值处理。默认值：$r('sys.color.ohos_id_color_text_primary_activated')<br/>异常值按照默认值处理。 |
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | [ResourceColor](ts-types.md#resourcecolor) \| undefined| 是   | 被选中或部分选中状态的颜色。<br/>当resColor的值为undefined时，默认值：$r('sys.color.ohos_id_color_text_primary_activated')<br/>异常值按照默认值处理。 |
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| resColor | [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[ResourceColor](ts-types.md#resourcecolor)> | 是   | 非选中状态边框颜色。<br/>当resColor的值为undefined时，默认值：$r('sys.color.ohos_id_color_switch_outline_off')。 |
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | [ResourceColor](ts-types.md#resourcecolor) \| undefined| 是   | 非选中状态边框颜色。<br/>当value的值为undefined时，默认值：$r('sys.color.ohos_id_color_switch_outline_off')。 |
...
| 参数名 | 类型                                                         | 必填 | 说明                                                         |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| style  | [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[MarkStyle](ts-types.md#markstyle10对象说明)> | 是   | 多选框内部图标样式。<br/>当style的值为undefined时，维持上次取值。若上次取值不存在时，沿用默认样式。 |
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[mark<sup>10+</sup>](#mark10)和[mark<sup>18+</sup>](#mark18)。
...
| 参数名 | 类型                                                         | 必填 | 说明                                                         |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | [MarkStyle](ts-types.md#markstyle10对象说明) \| undefined| 是   | 多选框内部图标样式。<br/>当style的值为undefined时，维持上次取值。 |
...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[checkboxShape<sup>23+</sup>](#checkboxshape23)。
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[checkboxShape<sup>12+</sup>](#checkboxshape12)和[checkboxShape<sup>18+</sup>](#checkboxshape18)。
...
| 参数名 | 类型                                                         | 必填 | 说明                                                         |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | [CheckBoxShape](ts-appendix-enums.md#checkboxshape11) \| undefined| 是   | 设置CheckboxGroup组件形状，包括圆形和圆角方形。<br/>当shape的值为undefined时，默认值为CheckBoxShape.CIRCLE。<br />**说明：**<br/>CheckboxGroup组件将按照设置的形状显示。<br/>CheckboxGroup内所有未单独设置shape类型的Checkbox，其形状将与CheckboxGroup保持一致。<br/>CheckboxGroup内已单独设置shape类型的Checkbox，其形状将优先于CheckboxGroup的设置，按照自身设置显示。|
...
contentModifier(modifier: ContentModifier\<CheckBoxGroupConfiguration\> | undefined)
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[contentModifier<sup>21+</sup>](#contentmodifier21)。
...
| 参数名    | 类型                                                                    | 必填 | 说明                   |
| --------- | ---------------------------------------------------------------------- | ---- | ---------------------- |
| modifier | [ContentModifier](ts-universal-attributes-content-modifier.md#contentmodifiert)\<[CheckBoxGroupConfiguration](#checkboxgroupconfiguration21对象说明)\> \| undefined | 是   | CheckboxGroup的内容修饰器。 |

### attributeModifier<sup>23+</sup>

attributeModifier(modifier: AttributeModifier\<CheckboxGroupAttribute\> | AttributeModifier\<CommonMethod\> | undefined)
...
| 参数名    | 类型                                                                                                                                                                                     | 必填 | 说明                   |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ---------------------- |
| modifier | [AttributeModifier](ts-universal-attributes-attribute-modifier.md#attributemodifiert)\<CheckboxGroupAttribute\> \| [AttributeModifier](ts-universal-attributes-attribute-modifier.md#attributemodifiert)\<CommonMethod\> \| undefined | 是   | CheckboxGroup的属性修饰器。<br/>CheckboxGroupAttribute：当前组件的[属性](#属性)<br/>CommonMethod：[通用属性](./ts-component-general-attributes.md) |
...
CheckboxGroup的选中状态或群组内的[Checkbox](ts-basic-components-checkbox.md)的选中状态发生变化时，触发回调。
...
CheckboxGroup的选中状态或群组内的[Checkbox](ts-basic-components-checkbox.md)的选中状态发生变化时，触发回调。与[onChange](#onchange)相比，callback参数新增了对undefined类型的支持。
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| callback | [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[OnCheckboxGroupChangeCallback](#oncheckboxgroupchangecallback18)> | 是   | 多选框群组的信息。<br/>当callback的值为undefined时，不使用回调函数。 |

### onChange<sup>23+</sup>

onChange(callback: OnCheckboxGroupChangeCallback | undefined)
...
| 参数名   | 类型                                                         | 必填 | 说明               |
| -------- | ------------------------------------------------------------ | ---- | ------------------ |
| callback | [OnCheckboxGroupChangeCallback](#oncheckboxgroupchangecallback18) \| undefined | 是   | 多选框群组的信息。 |
...
| 名称          | 类型      | 只读 | 可选 | 说明                                                         |
| ------------- | --------- | ---- | ---- | ------------------------------------------------------------ |
| name          | string    | 否   | 否   | 当前CheckboxGroup的群组名称。                                |
| status        | [SelectStatus](#selectstatus枚举说明) | 否   | 否   | CheckboxGroup的选中状态。                                    |
| triggerChange | Callback\<boolean\> | 否   | 否   | 触发CheckboxGroup选中状态变化的回调函数。 |
  ...
  Column({ space: 10 } as ColumnOptions) {
    ...
    Shape() {
      ...
      Path()
        ...
        .commands('M50 0 L100 100 L0 100 Z')
        .visibility(config.status === SelectStatus.All ? Visibility.Visible : Visibility.Hidden)
        .fill(config.status === SelectStatus.All ? (config.contentModifier as MyCheckboxGroupStyle).selectedColor :
          Color.Black)
        .stroke((config.contentModifier as MyCheckboxGroupStyle).selectedColor)
        .margin({ left: 10, top: 10 })
        .opacity(config.enabled ? 1 : 0.1)
...
type CheckBoxGroupBuilder = @Builder
(config: CheckBoxGroupConfiguration) => void;
...
class MyCheckboxGroupStyle implements ContentModifier<CheckBoxGroupConfiguration> {
  ...
  applyContent(): WrappedBuilder<CheckBoxGroupBuilder> {
    return wrapBuilder(buildCheckboxgroup);
  }
}
...
该示例实现了在结合带缓存功能的组件使用时(如[List](ts-container-list.md))，未被创建的[Checkbox](ts-basic-components-checkbox.md)全选的功能。
...
class BasicDataSource implements IDataSource<CheckboxItemData> {
  private listeners: DataChangeListener[] = [];
  private originDataArray: CheckboxItemData[] = [];
  ...
  public getData(index: int): CheckboxItemData {
    return this.originDataArray[index];
  }
...
class MyDataSource extends BasicDataSource {
  ...
  public operateItem(isSelect: boolean, index: int): void {
    this.dataArray[index].isCheck = isSelect
    this.notifyDataChange(index)
  }
...
struct MyComponent {
  ...
  build() {
    Column() {
      ...
      List({ space: 3 }) {
        LazyForEach(this.data, (item: CheckboxItemData, index: int) => {
          ListItem() {
            Row() {
              Checkbox({ name: `checkbox-${item}` })
                .select(item.isCheck)
