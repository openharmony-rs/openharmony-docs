...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[selectedColor<sup>23+</sup>](#unselectedcolor23)。
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[selectedColor](#unselectedcolor)和[selectedColor<sup>18+</sup>](#unselectedcolor18)。
...
| 参数名   | 类型                                                         | 必填 | 说明                                                         |
| -------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| resColor\|value  | [ResourceColor](ts-types.md#resourcecolor) \| undefined| 是   | 非选中状态边框颜色。<br/>当resColor的值为undefined时，默认值：$r('sys.color.ohos_id_color_switch_outline_off')。 |
...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[mark<sup>10+</sup>](#mark18)和[mark<sup>18+</sup>](#mark18)。
...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[checkboxShape<sup>12+</sup>](#checkboxshape12)和[checkboxShape<sup>18+</sup>](#checkboxshape18)。
