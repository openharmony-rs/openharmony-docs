...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[selectAll<sup>8+</sup>](#selectall8)和[selectAll<sup>18+</sup>](#selectall18)。
...
| 参数名    | 类型                                                                    | 必填 | 说明                   |
| --------- | ---------------------------------------------------------------------- | ---- | ---------------------- |
| modifier | [Optional](ts-universal-attributes-custom-property.md#optional12)\<[ContentModifier](ts-universal-attributes-content-modifier.md#contentmodifier)\<[CheckBoxGroupConfiguration](#checkboxgroupconfiguration21对象说明)\> | 是   | CheckboxGroup的内容修饰器。 |
...
| 参数名    | 类型                                                                    | 必填 | 说明                   |
| --------- | ---------------------------------------------------------------------- | ---- | ---------------------- |
| modifier | [ContentModifier](ts-universal-attributes-content-modifier.md#contentmodifier)\<[CheckBoxGroupConfiguration](#checkboxgroupconfiguration21对象说明)\> \| undefined | 是   | CheckboxGroup的内容修饰器。 |
...
| 参数名   | 类型                                                         | 必填 | 说明               |
| -------- | ------------------------------------------------------------ | ---- | ------------------ |
| callback | [OnCheckboxGroupChangeCallback](#oncheckboxgroupchangecallback) | 是   | 多选框群组的信息。 |

### onChange<sup>18+</sup>

onChange(callback: Optional\<OnCheckboxGroupChangeCallback\>)

CheckboxGroup的选中状态或群组内的Checkbox的选中状态发生变化时，触发回调。与[onChange<sup>8+</sup>](#onchange8)相比，callback参数新增了对undefined类型的支持。
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[onChange<sup>8+</sup>](#onchange8)和[onChange<sup>18+</sup>](#onchange18)。
...
| triggerChange | Callback\<boolean\> (Dyn) / (isSelect: boolean) => void (Sta) | 否   | 否   | 触发CheckboxGroup选中状态变化的回调函数。<br/>**参数：**<br/>- isSelect: 是否选中。 |
