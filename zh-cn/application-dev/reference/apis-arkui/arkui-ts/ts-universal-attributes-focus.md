...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[focusScopeId](#focusscopeid14)。
...
| 参数名 | 类型    | 必填 | 说明                                                         |
| ------ | ------- | ---- | ------------------------------------------------------------ |
| nextStep  | ArkTS-Dyn: Optional\<[FocusMovement](#focusmovement18对象说明)> <br/>ArkTS-Sta: [FocusMovement](#focusmovement18对象说明) \|&nbsp;undefined | 是 | 设置当前容器组件的自定义走焦规则。<br/>**说明：** <br/>默认值为重置nextStep为空。<br/>没设置自定义走焦或者设置自定义组件容器不存在，仍进行默认走焦规则。 |
