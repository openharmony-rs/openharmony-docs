...
该示例通过调用[menuSystemMaterial](#menusystemmaterial)接口实现下拉菜单系统材质效果，通过[systemMaterial](ts-universal-attributes-image-effect.md#systemmaterial)接口实现select组件系统材质效果。
