...
onAcquired(callback:&nbsp;Callback[\<FormCallbackInfo>](#formcallbackinfo12对象说明))&nbsp;
...
| 参数名  | 类型 | 必填 | 说明                                                         |
|------| - | ---- | ------------------------------------------------------------ |
| callback | ArkTS-Dyn: Callback\<object\> <br> ArkTS-Sta: Callback<[RouterCallbackInfo](#routercallbackinfo22对象说明)>  | 是   | 获得[routerEvent](../js-service-widget-ui/js-service-widget-syntax-hml.md#事件绑定)对象。 |

### onUninstall

onUninstall(callback:&nbsp;Callback[\<FormCallbackInfo>](#formcallbackinfo12对象说明))&nbsp;
...
onUpdate(callback:&nbsp;Callback[\<FormCallbackInfo>](#formcallbackinfo12对象说明))&nbsp;
