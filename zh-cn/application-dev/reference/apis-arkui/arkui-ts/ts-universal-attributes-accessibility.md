...
>**说明：**
>
> 从API version 20开始，该接口支持在[attributeModifier](ts-universal-attributes-attribute-modifier.md#attributemodifier)中调用。该接口支持在所有设备类型上进行设置。然而，仅当运行在车机环境下时，其关联属性变化才会被车机系统的无障碍服务所监听并响应。因此，该功能实际仅在车机场景下生效。
