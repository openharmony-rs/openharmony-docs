...
| 参数名 | 类型                                       | 必填 | 说明                              |
| ------ | ------------------------------------------ | ---- | --------------------------------- |
| value  | ArkTS-Dyn: Array<[GuideLineStyle](#guidelinestyle12对象说明)><br/>ArkTS-Sta: Array<[GuideLineStyle](#guidelinestyle12对象说明)> \| undefined | 是   | RelativeContainer容器内的辅助线，定义guideLine的id、方向和位置，用于辅助定位子组件。<br/>取值为undefined时，与不设置表现一致。 |
...
| 参数名 | 类型                                   | 必填 | 说明                           |
| ------ | -------------------------------------- | ---- | ------------------------------ |
| barrierStyle  | ArkTS-Dyn: Array\<[LocalizedBarrierStyle](#localizedbarrierstyle12对象说明)\><br/>ArkTS-Sta: Array\<[BarrierStyle](#barrierstyle12对象说明)\> \| Array\<[LocalizedBarrierStyle](#localizedbarrierstyle12对象说明)\> \| undefined | 是   | RelativeContainer容器内的屏障，支持定义镜像模式的屏障线。<br/>取值为undefined时，与不设置表现一致。|
