...
| 参数名 | 类型                                       | 必填 | 说明                              |
| ------ | ------------------------------------------ | ---- | --------------------------------- |
| value  | ArkTS-Dyn: Array<[GuideLineStyle](#guidelinestyle12对象说明)><br/>ArkTS-Sta: Array<[GuideLineStyle](#guidelinestyle12对象说明)> \| undefined | 是   | RelativeContainer容器内的辅助线。<br/>取值为undefined时，与不设置表现一致。 |
