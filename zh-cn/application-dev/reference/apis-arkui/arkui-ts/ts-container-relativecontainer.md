...
| 名称     | 说明                          |
| ------ | ----------------------------- |
| LEFT<sup>12+</sup> | 屏障在其所有[referencedId](ts-container-relativecontainer.md#barrierstyle12对象说明)的最左侧。|
| RIGHT<sup>12+</sup> | 屏障在其所有[referencedId](ts-container-relativecontainer.md#barrierstyle12对象说明)的最右侧。|
| TOP<sup>12+</sup>  | 屏障在其所有[referencedId](ts-container-relativecontainer.md#barrierstyle12对象说明)的最上方。|
| BOTTOM<sup>12+</sup>  | 屏障在其所有[referencedId](ts-container-relativecontainer.md#barrierstyle12对象说明)的最下方。|
...
| ----- | ------- | ---- | --------------------- |
| id  | string  | 是    | barrier的id，必须是唯一的并且不可与容器内组件重名。|
| localizedDirection<sup>12+</sup> | [LocalizedBarrierDirection](#localizedbarrierdirection12枚举说明) | 是    | 指定barrier的方向。</br> 垂直方向（TOP，BOTTOM）的barrier仅能作为组件的水平方向锚点，作为垂直方向锚点时值为0。水平方向（START，END）的barrier仅能作为组件的垂直方向锚点，作为水平方向锚点时值为0。|
| referencedId<sup>12+</sup> | Array\<string\> | 是    | 指定生成barrier所依赖的组件。|
...
```ts
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer,
  AlignRuleOption, BorderOptions } from '@ohos.arkui.component';
...
```ts
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer, Axis,
  AlignRuleOption, BorderOptions } from '@ohos.arkui.component';
...
```ts
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer, BarrierDirection,
  AlignRuleOption, BorderOptions, BarrierStyle, FlexAlign } from '@ohos.arkui.component';
...
struct Index {
  build() {
    Row() {
      ...
      .margin({ left: 50 } as Margin)
      .border({ width: 2, color: "#6699FF" } as BorderOptions)
      .barrier([{ id: "barrier1", direction: BarrierDirection.RIGHT, referencedId: ["row1", "row2"] } as BarrierStyle,
        { id: "barrier2", direction: BarrierDirection.BOTTOM, referencedId: ["row1", "row2"] } as BarrierStyle])
    }
    .height('100%')
  }
}
...
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer,
  AlignRuleOption, BorderOptions, FlexAlign, Axis, ChainStyle } from '@ohos.arkui.component';
...
```ts
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer, LocalizedBarrierDirection,
  LocalizedAlignRuleOptions, BorderOptions, FlexAlign, LocalizedBarrierStyle, Direction } from '@ohos.arkui.component';
...
struct Index {
  build() {
    Row() {
      ...
      .margin({ left: 50 } as Margin)
      .border({ width: 2, color: "#6699FF" } as BorderOptions)
      .barrier([{ id: "barrier1", localizedDirection: LocalizedBarrierDirection.END, referencedId: ["row1", "row2"] } as LocalizedBarrierStyle,
        { id: "barrier2", localizedDirection: LocalizedBarrierDirection.BOTTOM, referencedId: ["row1", "row2"] } as LocalizedBarrierStyle])
    }
    .height('100%')
  }
}
...
// xxx.ets
import { Entry, Component, Margin, Row, Text, VerticalAlign, HorizontalAlign, RelativeContainer, Axis,
  AlignRuleOption, BorderOptions, FlexAlign, ChainStyle } from '@ohos.arkui.component';
