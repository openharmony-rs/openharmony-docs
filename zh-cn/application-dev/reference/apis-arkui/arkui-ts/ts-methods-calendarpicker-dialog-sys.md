...
日历选择器弹窗提供日期选择功能，用户可在弹窗中选择日期，适用于预约管理、任务安排等需要日期输入的场景。
