...
| 名称 | 值 | 说明 |
| -------- | ----- | -------- |
| OutSet | 0 | 滑块在滑轨上。<br/>**卡片能力（仅ArkTS-Dyn）：** 从API version 9开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br/>**ArkTS-Dyn起始版本：** 7<br/>**ArkTS-Sta起始版本：** 23 |
| InSet | 1 | 滑块在滑轨内。<br/>**卡片能力（仅ArkTS-Dyn）：** 从API version 9开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。<br/>**ArkTS-Dyn起始版本：** 7<br/>**ArkTS-Sta起始版本：** 23 |
| NONE<sup>12+</sup> | 2 | 无滑块 <br/>**卡片能力（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API（仅ArkTS-Dyn）：** 从API version 12开始，该接口支持在原子化服务中使用。<br/>**模型约束：** 此接口仅可在Stage模型下使用。<br/>**ArkTS-Dyn起始版本：** 12<br/>**ArkTS-Sta起始版本：** 23 |
...
| 参数名 | 类型                                       | 必填 | 说明                                |
| ------ | ------------------------------------------ | ---- | ----------------------------------- |
| value  | ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor)&nbsp;\|&nbsp;[LinearGradient](ts-basic-components-datapanel.md#lineargradient10)<sup>23+</sup> \| undefined | 是   | 滑块的颜色。 取值为undefined时，按默认值处理。<br/>默认值：`$r('sys.color.ohos_id_color_foreground_contrary')` |
...
| 参数名        | 类型                                                         | 必填 | 说明                                                         |
| ------------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| selectedColor | [ResourceColor](ts-types.md#resourcecolor)&nbsp;\|&nbsp;[LinearGradient](ts-basic-components-datapanel.md#lineargradient10) \| undefined | 是   | 滑轨的已滑动部分颜色。 取值为undefined时，按默认值处理。<br/>**说明：** <br/>设置渐变色时，若颜色断点颜色值为非法值或者渐变色断点为空时，渐变色不起效果。 <br/>默认值：`$r('sys.color.ohos_id_color_emphasize')` |
...
| 参数名 | 类型    | 必填 | 说明                                       |
| ------ | ------- | ---- | ------------------------------------------ |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 当前是否显示步长刻度值。取值为undefined时，按默认值处理。<br/>true：显示刻度值；false：不显示刻度值。<br/>默认值：false |
...
| 参数名                | 类型                                   | 必填 | 说明                                       |
| --------------------- | -------------------------------------- | ---- | ------------------------------------------ |
| value                 | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined                                | 是   | 滑动时是否显示气泡提示。取值为undefined时，按默认值处理。<br/>true：显示气泡；false：不显示气泡。<br/>默认值：false |
| content<sup>10+</sup> | ArkTS-Dyn: [ResourceStr](ts-types.md#resourcestr)<br/>ArkTS-Sta: [ResourceStr](ts-types.md#resourcestr) \| undefined | 否   | 气泡提示的文本内容，默认显示当前百分比。取值为undefined时，按默认处理。<br/>**模型约束：** 此接口仅可在Stage模型下使用。   |
...
| 参数名 | 类型                         | 必填 | 说明                                                         |
| ------ | ---------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [Length](ts-types.md#length)<br/>ArkTS-Sta: [Length](ts-types.md#length) \| undefined | 是   | 滑轨的粗细。取值为undefined时，按默认值处理。<br/>默认值：当参数style的值设置[SliderStyle](#sliderstyle枚举说明).OutSet 时为 4.0vp，[SliderStyle](#sliderstyle枚举说明).InSet时为20.0vp。 |
...
| 参数名 | 类型                                       | 必填 | 说明                                   |
| ------ | ------------------------------------------ | ---- | -------------------------------------- |
| value  | ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 滑块描边颜色。取值为undefined时，按默认值处理。<br/>默认值：'#00000000' |
...
| 参数名 | 类型                         | 必填 | 说明           |
| ------ | ---------------------------- | ---- | -------------- |
| value  | ArkTS-Dyn: [Length](ts-types.md#length)<br/>ArkTS-Sta: [Length](ts-types.md#length) \| undefined | 是   | 滑块描边粗细。取值为undefined时，按0值处理。<br/>**说明：** <br/>设置string类型时，不支持百分比。 |
...
| 参数名 | 类型                                       | 必填 | 说明                               |
| ------ | ------------------------------------------ | ---- | ---------------------------------- |
| value  | ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 刻度颜色。取值为undefined时，按默认值处理。<br/>默认值：<br/>`$r('sys.color.ohos_id_color_foreground')`混合<br/>`$r('sys.color.ohos_id_alpha_normal_bg')`透明度的颜色 |
...
| 参数名 | 类型                                            | 必填 | 说明                                                         |
| ------ | ----------------------------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [SliderBlockStyle](#sliderblockstyle10对象说明)<br/>ArkTS-Sta: [SliderBlockStyle](#sliderblockstyle10对象说明) \| undefined | 是   | 滑块形状参数。取值为undefined时，按默认值处理。<br/>默认值：SliderBlockType.DEFAULT，滑块形状为圆形。 |
...
| 参数名 | 类型                         | 必填 | 说明                                  |
| ------ | ---------------------------- | ---- | ------------------------------------- |
| value  | ArkTS-Dyn: [Length](ts-types.md#length)<br/>ArkTS-Sta: [Length](ts-types.md#length) \| undefined | 是   | 刻度大小（直径）。取值为undefined时，按默认值处理。 <br/>默认值：'4vp'<br/>取值范围：[0, [trackThickness](#trackthickness8)) |
...
| 参数名 | 类型                                              | 必填 | 说明                                                         |
| ------ | ------------------------------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [SliderInteraction](#sliderinteraction12枚举说明)<br/>ArkTS-Sta: [SliderInteraction](#sliderinteraction12枚举说明) \| undefined | 是   | 用户与滑动条组件交互方式。取值为undefined时，按默认值处理。 <br /> 默认值：SliderInteraction.SLIDE_AND_CLICK。 |
...
| 参数名 | 类型    | 必填 | 说明                                       |
| ------ | ------- | ---- | ------------------------------------------ |
| value  | ArkTS-Dyn: number<br/>ArkTS-Sta: double \| undefined | 是   | 设置滑动响应的最小距离，滑动超过此距离后滑块才开始滑动。取值为undefined时，按默认值处理。<br/>默认值：0<br/>**说明：** <br/>单位与[SliderOptions](#slideroptions对象说明)中的属性min以及属性max一致。<br/>当value小于0、大于max-min或非法值时，取默认值。  |
...
| 参数名 | 类型                                | 必填 | 说明             |
| ------ | ----------------------------------- | ---- | ---------------- |
| value  | ArkTS-Dyn: [SlideRange](#sliderange12对象说明)<br/>ArkTS-Sta: [SlideRange](#sliderange12对象说明) \| undefined | 是   | 设置有效滑动区间。取值为undefined时，不限制有效滑动区间。 |
...
| 参数名 | 类型                                          | 必填  | 说明                                                                                  |
| ------ | --------------------------------------------- |-----|-------------------------------------------------------------------------------------|
| enabled  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 设置是否开启触控反馈。取值为undefined时，按默认值处理。<br/>true：开启触控反馈；false：不开启触控反馈。<br/>默认值：true|
...
| ----------- | ------------------------------------------------------------ | ---- | ------------------------------------------------------- |
| value | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是 | 当前是否显示步长刻度值。取值为undefined时，按默认值处理。<br/>true：显示刻度值；false：不显示刻度值。<br />默认值：false |
| options | ArkTS-Dyn: [SliderShowStepOptions](#slidershowstepoptions20)<br/>ArkTS-Sta: [SliderShowStepOptions](#slidershowstepoptions20) \| undefined | 否 | 刻度点无障碍文本的配置选项，用于设置与无障碍功能相关的属性。取值为undefined时，默认使用当前刻度点的值作为无障碍文本信息。<br/>默认值：null |
