...
| min       | ArkTS-Dyn: number <br>ArkTS-Sta: int                 | 否  | 是  | 设置CounterV2的最小值。<br/>默认值：0<br>取值范围：(-∞, +∞)<br>值为undefined时，按默认值处理。 |
| max       | ArkTS-Dyn: number <br>ArkTS-Sta: int                 | 否  | 是  | 设置CounterV2的最大值。<br/>默认值：999<br>取值范围：(-∞, +∞)<br>值为undefined时，按默认值处理。 |
