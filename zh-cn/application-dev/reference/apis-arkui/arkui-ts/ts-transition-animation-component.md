...
transition(value: TransitionEffect | undefined,  onFinish: TransitionFinishCallback | undefined): this
...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- |  ---- | -------- |
| effect | [TransitionEffect](#transitioneffect10对象说明) \| undefined  | 是 | 设置组件插入显示和删除隐藏的过渡效果。 |
| onFinish | [TransitionFinishCallback](#transitionfinishcallback12) \| undefined | 是 | 转场动画结束回调。 |
...
上面提供的静态函数用于构造TransitionEffect对象，而非静态函数作用于构造好的TransitionEffect对象，以指定多种转场效果的组合效果和动画参数。
