...
ArkTS-Dyn: indicator(value: IndicatorStyle): SubTabBarStyle

ArkTS-Sta: indicator(value: SubTabBarIndicatorStyle): SubTabBarStyle
...
| 参数名 | 类型                                   | 必填 | 说明           |
| ------- | ------------------------------------- | ---- | ------------- |
| value | ArkTS-Dyn: [IndicatorStyle](#indicatorstyle10对象说明) <br/>  ArkTS-Sta: [SubTabBarIndicatorStyle](#subtabbarindicatorstyle23对象说明) | 是   | 选中子页签的下划线风格对象。 |
...
**[原子化服务API](../../../application-models/atomic-service-api.md)：** 从API version 12开始，该接口支持在原子化服务中使用。
