...
| 参数名       | 类型                                                         | 必填 | 说明                                                      |
| ------------ | ------------------------------------------------------------ | ---- | --------------------------------------------------------- |
| spanType     | ArkTS-Dyn: [RichEditorSpanType](#richeditorspantype) <br > ArkTS-Sta: [RichEditorSpanType](#richeditorspantype) \| undefined       | 是   | 菜单的类型。<br/>默认值：<br/>RichEditorSpanType.TEXT    |
| content      | ArkTS-Dyn: [CustomBuilder](ts-types.md#custombuilder8) <br > ArkTS-Sta: [CustomBuilder](ts-types.md#custombuilder8) \| undefined     | 是   |  菜单的内容。                                              |
| responseType | ArkTS-Dyn: [ResponseType](ts-appendix-enums.md#responsetype8)&nbsp; \| &nbsp;[RichEditorResponseType](#richeditorresponsetype11) <br > ArkTS-Sta: [ResponseType](ts-appendix-enums.md#responsetype8)&nbsp; \| &nbsp;[RichEditorResponseType](#richeditorresponsetype11) \| undefined | 是   | 菜单的响应类型。<br/> 默认值：<br/>ResponseType.LongPress |
| options      | ArkTS-Dyn: [SelectionMenuOptions](#selectionmenuoptions) <br > ArkTS-Sta: [SelectionMenuOptions](#selectionmenuoptions) \| undefined              | 否   | 菜单的选项。                                              |
...
| 参数名 | 类型                                             | 必填 | 说明                                                         |
| ------ | ------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  |  ArkTS-Dyn: [CopyOptions](ts-appendix-enums.md#copyoptions9) <br/>ArkTS-Sta: [CopyOptions](ts-appendix-enums.md#copyoptions9) \| undefined| 是   | 组件支持文本内容是否可复制粘贴。<br/>默认值：CopyOptions.LocalDevice |
...
| 参数名 | 类型    | 必填 | 说明                              |
| ------ | ------- | ---- | --------------------------------- |
| enable  | ArkTS-Dyn: boolean <br/>ArkTS-Sta: boolean \| undefined | 是   | 使能文本识别。<br/>true表示使能文本特殊实体识别，false表示不使能文本特殊实体识别。<br/>默认值： false |
...
| 参数名 | 类型    | 必填 | 说明                              |
| ------ | ------- | ---- | --------------------------------- |
| enable  | ArkTS-Dyn: boolean <br/>ArkTS-Sta: boolean \| undefined | 是   | 使能预上屏功能。<br/>true表示开启，false表示不开启。<br/>默认值： true |
...
| 参数名 | 类型                                    | 必填 | 说明                                                    |
| ------ | --------------------------------------- | ---- | ------------------------------------------------------- |
| value  | ArkTS-Dyn: [ResourceStr](ts-types.md#resourcestr) <br/>ArkTS-Sta: [ResourceStr](ts-types.md#resourcestr) \| undefined | 是   | 无输入时的提示文本。                                    |
| style  | ArkTS-Dyn: [PlaceholderStyle](#placeholderstyle12) <br/>ArkTS-Sta: [PlaceholderStyle](#placeholderstyle12)  \| undefined | 否   | 提示文本的字体样式。<br/>缺省时默认跟随主题。 |
...
| 参数名 | 类型                                       | 必填 | 说明                                   |
| ------ | ------------------------------------------ | ---- | -------------------------------------- |
| value  | ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor) <br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 输入框光标、手柄颜色。<br/>默认值：'#007DFF' |
...
| 参数名 | 类型                                       | 必填 | 说明                                       |
| ------ | ------------------------------------------ | ---- | ------------------------------------------ |
| value  | ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor) <br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined| 是   | 文本选中的底板颜色。<br/>默认为20%不透明度。 |
...
| 参数名 | 类型   | 必填 | 说明                                |
| ------ | ------ | ---- | ----------------------------------- |
| value  | ArkTS-Dyn: [EnterKeyType](ts-basic-components-textinput.md#enterkeytype枚举说明) <br/>ArkTS-Sta: [EnterKeyType](ts-basic-components-textinput.md#enterkeytype枚举说明) \| undefined| 是   | 软键盘输入法回车键类型。<br/>默认为EnterKeyType.NEW_LINE。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------- | ---- | ----------------------------------------------------------- |
| isEnabled  | ArkTS-Dyn: boolean <br/>ArkTS-Sta: boolean \| undefined | 是   | 通过点击以外的方式获焦时，是否主动拉起软键盘。<br/>true表示主动拉起软键盘，false表示不主动拉起软键盘。<br/>默认值： true |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ----------------------------------------- | ---- | ------------------------------------------------------ |
| state | ArkTS-Dyn: [BarState](ts-appendix-enums.md#barstate) <br/>ArkTS-Sta: [BarState](ts-appendix-enums.md#barstate) \| undefined| 是   | 输入框滚动条的显示模式。<br/>默认值：BarState.Auto |
...
| 参数名 | 类型   | 必填 | 说明                                                         |
| ------ | ------ | ---- | ------------------------------------------------------------ |
| maxLength  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number><br/>ArkTS-Sta: int \| undefined | 是   | 文本的最大输入字符数。<br/>默认值：Infinity，可以无限输入，支持undefined类型。<br/>**说明：** <br/>当不设置该属性或设置异常值时，取默认值，设置小数时，取整数部分。 |
...
| 参数名 | 类型                                      | 必填 | 说明                                                         |
| ------ | ----------------------------------------- | ---- | ------------------------------------------------------------ |
| maxLines  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number><br/>ArkTS-Sta: int \| undefined | 是   | 设置富文本可显示的最大行数。<br/>maxLines为可显示行数，当设置maxLines时，超出内容可滚动显示。<br/>同时设置组件高度和最大行数，组件高度优先生效。<br/>默认值：Infinity，可以无限输入，支持undefined类型。 <br/>取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ----------------------------------------- | ---- | ------------------------------------------------------ |
| appearance | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明)\><br/>ArkTS-Sta: [KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明) \| undefined | 是   | 键盘外观。<br/>默认值：KeyboardAppearance.NONE_IMMERSIVE |
...
| 参数名 | 类型                                          | 必填  | 说明                                                                                  |
| ------ | --------------------------------------------- |-----|-------------------------------------------------------------------------------------|
| isStopped  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;boolean&gt;<br/>ArkTS-Sta: boolean \| undefined | 是   | 是否阻止返回键。<br/>默认值：true，true表示阻止返回键，false表示不阻止返回键。<br/>**说明：** <br/>当不设置该属性或设置异常值时，取默认值。|
...
| 参数名 | 类型    | 必填 | 说明                               |
| ------ | ------- | ---- | ---------------------------------- |
| enable | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<boolean><br/>ArkTS-Sta: boolean \| undefined | 是   | 是否开启中文与西文的自动间距。<br/>true为开启自动间距，false为不开启。<br />默认值：false |
...
| 参数名 | 类型                                                         | 必填 | 说明                                     |
| ------ | ------------------------------------------------------------ | ---- | ---------------------------------------- |
| color  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<[ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12)><br/>ArkTS-Sta: [ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12) \| undefined | 是  | 设置组件滚动条颜色。<br />默认值：'#66182431'，显示为灰色。<br />**说明：** 设置异常值时按默认值处理。 |
...
| 参数名   | 类型                                    | 必填   | 说明        |
| ----- | --------------------------------------- | ---- | ----------- |
| callback | ArkTS-Dyn: Callback\<void\> <br/>ArkTS-Sta: [VoidCallback](./ts-types.md#voidcallback12) \| undefined | 是    | 订阅富文本组件初始化完成的回调。 |
...
| 参数名 | 类型                                        | 必填 | 说明                 |
| ------ | ------------------------------------------- | ---- | -------------------- |
| callback | ArkTS-Dyn: Callback\<[RichEditorSelection](#richeditorselection)\> <br/>ArkTS-Sta: Callback\<[RichEditorSelection](#richeditorselection)\> \| undefined| 是   | [RichEditorSelection](#richeditorselection)为选中的所有span信息。<br/>选择时触发的回调。 |
...
| 参数名 | 类型                                        | 必填 | 说明                 |
| ------ | ------------------------------------------- | ---- | -------------------- |
| callback | ArkTS-Dyn: Callback\<[RichEditorInsertValue](#richeditorinsertvalue), boolean\> <br/>ArkTS-Sta: Callback\<[RichEditorInsertValue](#richeditorinsertvalue), boolean\> \| undefined | 是   | [RichEditorInsertValue](#richeditorinsertvalue)为输入法将要输入内容信息。<br/>true:组件执行添加内容操作。<br/>false:组件不执行添加内容操作。<br/>输入法输入内容前的回调。|
...
| 参数名 | 类型                                        | 必填 | 说明                 |
| ------ | ------------------------------------------- | ---- | -------------------- |
| callback | ArkTS-Dyn: Callback\<[TextRange](ts-text-common.md#textrange12)\> <br/>ArkTS-Sta: Callback\<[TextRange](ts-text-common.md#textrange12)\> \| undefined | 是 | TextRange为输入法本次输入内容的范围。<br/>输入法完成输入时的回调。|
...
| 参数名 | 类型                                        | 必填 | 说明                 |
| ------ | ------------------------------------------- | ---- | -------------------- |
| callback | ArkTS-Dyn: Callback\<[RichEditorTextSpanResult](#richeditortextspanresult)\>  <br/>ArkTS-Sta: Callback\<[RichEditorTextSpanResult](#richeditortextspanresult)\> \| undefined | 是 | [RichEditorTextSpanResult](#richeditortextspanresult)为输入法完成输入后的文本Span信息。<br/>输入法完成输入后的回调。|
...
| 参数名   | 类型                                    | 必填   | 说明        |
| ----- | --------------------------------------- | ---- | ----------- |
| callback | ArkTS-Dyn: Callback\<void\> <br/>ArkTS-Sta: [VoidCallback](./ts-types.md#voidcallback12) \| undefined | 是    | 订阅输入法完成删除内容的回调。 |
...
| 参数名 | 类型    | 必填 | 说明                          |
| ------ | ------- | ---- | ----------------------------- |
| callback | ArkTS-Dyn: [PasteEventCallback](#pasteeventcallback12) <br/>ArkTS-Sta: [PasteEventCallback](#pasteeventcallback12) \| undefined | 是   | 订阅粘贴时的回调。 |
...
| 参数名   | 类型                                    | 必填   | 说明        |
| ----- | --------------------------------------- | ---- | ----------- |
| callback | ArkTS-Dyn: Callback\<[RichEditorRange](#richeditorrange)\> <br/>ArkTS-Sta: Callback\<[RichEditorRange](#richeditorrange)\> \| undefined| 是    | [RichEditorRange](#richeditorrange)为所有内容的选择区域起始和终止位置。<br/>订阅文本选择区域发生变化或编辑状态下光标位置发生变化时触发的回调。|
...
| 参数名   | 类型                                    | 必填   | 说明        |
| ----- | --------------------------------------- | ---- | ----------- |
| callback | ArkTS-Dyn: Callback\<boolean\> <br/>ArkTS-Sta: Callback\<boolean\> \| undefined | 是    | true表示编辑态，false表示非编辑态。 |
...
| 参数名 | 类型    | 必填 | 说明                          |
| ------ | ------- | ---- | ----------------------------- |
| callback | ArkTS-Dyn: [SubmitCallback](#submitcallback12) <br/>ArkTS-Sta: [SubmitCallback](#submitcallback12) \| undefined | 是   | 订阅事件的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| -- | -- | -- | -- |
| callback | ArkTS-Dyn: Callback\<[RichEditorChangeValue](#richeditorchangevalue12) , boolean\> <br/>ArkTS-Sta: Callback\<[RichEditorChangeValue](#richeditorchangevalue12) , boolean\> \| undefined| 是    | [RichEditorChangeValue](#richeditorchangevalue12)为图文变化信息；boolean表示当前图文是否允许被更改，true：允许图文被更改；false：不允许图文被更改。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| -- | -- | -- | -- |
| callback | ArkTS-Dyn: [OnDidChangeCallback](ts-text-common.md#ondidchangecallback12) <br/>ArkTS-Sta: [OnDidChangeCallback](ts-text-common.md#ondidchangecallback12) \| undefined | 是 | 图文变化前后的内容范围。 |
...
| 参数名   | 类型                                    | 必填   | 说明        |
| ----- | --------------------------------------- | ---- | ----------- |
| callback | ArkTS-Dyn: Callback\<[CutEvent](#cutevent12)\> <br/>ArkTS-Sta: Callback\<[CutEvent](#cutevent12)\> \| undefined | 是    | 定义用户剪切事件。 |
...
| strokeWidth<sup>23+</sup> | ArkTS-Dyn: number  <br/>ArkTS-Sta: double   | 否   | 是   | 文本描边宽度。<br/>单位为[vp](ts-pixel-units.md)。<br/>**模型约束：** 此接口仅可在Stage模型下使用。<br/>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br/>**ArkTS-Dyn起始版本：** 23<br/>**ArkTS-Sta起始版本：** 23 |
...
| 类型      | 说明        |
| ------- | --------- |
| ArkTS-Dyn: boolean <br/>ArkTS-Sta: boolean \| undefined | 光标是否设置成功。<br/>true表示光标位置设置成功，false表示未成功。 |
...
| 类型                                       | 说明      |
| ---------------------------------------- | ------- |
| ArkTS-Dyn: [RichEditorTextStyle](#richeditortextstyle) <br/>ArkTS-Sta: [RichEditorTextStyle](#richeditortextstyle) \| undefined | 用户预设样式。 |
...
| 类型                                       | 说明      |
| ---------------------------------------- | ------- |
| ArkTS-Dyn: [PreviewText](ts-text-common.md#previewtext12) <br/>ArkTS-Sta: [PreviewText](ts-text-common.md#previewtext12) \| undefined | 预上屏信息。 |
...
| 类型     | 说明                   |
| ------ | -------------------- |
| ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined| 添加完成的TextSpan所在的位置。 |
...
| 类型     | 说明                   |
| ------ | -------------------- |
| ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 添加完成的ImageSpan所在的位置。 |
...
| 类型                                       | 说明      |
| ---------------------------------------- | ------- |
| ArkTS-Dyn: [RichEditorSelection](#richeditorselection) <br/>ArkTS-Sta: [RichEditorSelection](#richeditorselection) \| undefined | 选中内容信息。 |
...
| 类型                                       | 说明      |
| ---------------------------------------- | ------- |
| ArkTS-Dyn: Array<[RichEditorSpan](#richeditorspan12)> <br/>ArkTS-Sta: Array<[RichEditorSpan](#richeditorspan12)> \| undefined | 文本和图片Span信息。 |
...
| 类型                                       | 说明       |
| ---------------------------------------- | -------- |
| ArkTS-Dyn: [StyledString](ts-universal-styled-string.md#styledstring) <br/>ArkTS-Sta: [StyledString](ts-universal-styled-string.md#styledstring) \| undefined | 转换后的属性字符串 |
...
| 类型                                       | 说明      |
| ---------------------------------------- | ------- |
| ArkTS-Dyn: [RichEditorRange](#richeditorrange) <br/>ArkTS-Sta: [RichEditorRange](#richeditorrange) \| undefined | 选中区域范围。 |
...
| shaderStyle  | [ShaderStyle](ts-text-common.md#shaderstyle20) |  是  |  是  | 设置文本着色器效果。<br/>该接口与[RichEditorTextStyle](#richeditortextstyle)的strokeWidth同时设置时，该接口不生效。<br/>**ArkTS-Dyn起始版本：** 26.0.0。 <br/>**ArkTS-Sta起始版本：** 26.0.0。<br/>**模型约束：** 此接口仅可在Stage模型下使用。<br/>**原子化服务API：** 从API版本26.0.0开始，该接口支持在原子化服务中使用。|
