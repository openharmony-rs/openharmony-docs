...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[RichEditor<sup>10+</sup>](#richeditor10)和[RichEditor<sup>12+</sup>](#richeditor12)。
...
ArkTS-Dyn: bindSelectionMenu(spanType: RichEditorSpanType, content: CustomBuilder, responseType: ResponseType | RichEditorResponseType,
    options?: SelectionMenuOptions)

ArkTS-Sta: bindSelectionMenu(spanType: RichEditorSpanType | undefined, content: CustomBuilder | undefined, responseType: ResponseType | RichEditorResponseType | undefined,
    options?: SelectionMenuOptions | undefined)
...
| options      | ArkTS-Dyn: [SelectionMenuOptions](#selectionmenuoptions10) <br > ArkTS-Sta: [SelectionMenuOptions](#selectionmenuoptions10) \| undefined              | 否   | 菜单的选项。                                              |
...
| 参数名 | 类型   | 必填 | 说明                                                         |
| ------ | ------ | ---- | ------------------------------------------------------------ |
| maxLength  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optional12)\<number><br/>ArkTS-Sta: int \| undefined | 是   | 文本的最大输入字符数。<br/>默认值：Infinity，可以无限输入，支持undefined类型。<br/>**说明：** <br/>当不设置该属性或设置异常值时，取默认值，设置小数时，取整数部分。 |
...
| 参数名 | 类型                                      | 必填 | 说明                                                         |
| ------ | ----------------------------------------- | ---- | ------------------------------------------------------------ |
| maxLines  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optional12)\<number><br/>ArkTS-Sta: int \| undefined | 是   | 设置富文本可显示的最大行数。<br/>maxLines为可显示行数，当设置maxLines时，超出内容可滚动显示。<br/>同时设置组件高度和最大行数，组件高度优先生效。<br/>默认值：Infinity，可以无限输入，支持undefined类型。 <br/>取值范围：(0, +∞) |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ----------------------------------------- | ---- | ------------------------------------------------------ |
| appearance | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optional12)\<[KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明)\><br/>ArkTS-Sta: [KeyboardAppearance](ts-text-common.md#keyboardappearance15枚举说明) \| undefined | 是   | 键盘外观。<br/>默认值：KeyboardAppearance.NONE_IMMERSIVE |
...
| 参数名 | 类型                                          | 必填  | 说明                                                                                  |
| ------ | --------------------------------------------- |-----|-------------------------------------------------------------------------------------|
| isStopped  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optional12)&lt;boolean&gt;<br/>ArkTS-Sta: boolean \| undefined | 是   | 是否阻止返回键。<br/>默认值：true，true表示阻止返回键，false表示不阻止返回键。<br/>**说明：** <br/>当不设置该属性或设置异常值时，取默认值。|
...
ArkTS-Dyn: onSelect(callback:Callback\<[RichEditorSelection](#richeditorselection)\>)

ArkTS-Sta: onSelect(callback:Callback\<[RichEditorSelection](#richeditorselection)\> | undefined)
...
ArkTS-Dyn: aboutToIMEInput(callback:Callback\<[RichEditorInsertValue](#richeditorinsertvalue), boolean\>)

ArkTS-Sta: aboutToIMEInput(callback:Callback\<[RichEditorInsertValue](#richeditorinsertvalue), boolean\> | undefined)
...
ArkTS-Dyn: onIMEInputComplete(callback:Callback\<[RichEditorTextSpanResult](#richeditortextspanresult)\>)

ArkTS-Sta: onIMEInputComplete(callback:Callback\<[RichEditorTextSpanResult](#richeditortextspanresult)\> | undefined)
...
ArkTS-Dyn: aboutToDelete(callback:Callback\<[RichEditorDeleteValue](#richeditordeletevalue), boolean\>)

ArkTS-Sta: aboutToDelete(callback:Callback\<[RichEditorDeleteValue](#richeditordeletevalue), boolean\> | undefined)
...
ArkTS-Dyn: onPaste(callback: [PasteEventCallback](#pasteeventcallback12) )

ArkTS-Sta: onPaste(callback: [PasteEventCallback](#pasteeventcallback12) | undefined)
...
ArkTS-Dyn: onSelectionChange(callback:Callback\<[RichEditorRange](#richeditorrange)\>)

ArkTS-Sta: onSelectionChange(callback:Callback\<[RichEditorRange](#richeditorrange)\> | undefined)
