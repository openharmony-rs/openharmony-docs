...
| 名称          | 类型                                                        | 只读  | 可选  | 说明                                                         |
| ------------- | ----------------------------------------------------------- | ----- | ----- | ------------------------------------------------------------ |
| x | ArkTS-Dyn: number<br/>ArkTS-Sta: double \| undefined      | 否    | 否    | 锚点坐标x值，取值范围[0.0, 1.0]。无单位，基于组件尺寸，代表横向尺寸相对占比。 |
| y | ArkTS-Dyn: number<br/>ArkTS-Sta: double \| undefined      | 否    | 否    | 锚点坐标y值，取值范围[0.0, 1.0]。无单位，基于组件尺寸，代表纵向尺寸相对占比。 |
