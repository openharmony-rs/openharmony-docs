...
ArkTS-Dyn: space(space: Optional\<LengthMetrics>)

ArkTS-Sta: space(space: LengthMetrics | undefined)
...
| 参数名 | 类型                                                 | 必填 | 说明                                     |
| ------ | ---------------------------------------------------- | ---- | ---------------------------------------- |
| status | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[BarState](ts-appendix-enums.md#barstate)&gt;<br/>ArkTS-Sta: [BarState](ts-appendix-enums.md#barstate) \| undefined | 是   | 滚动条状态。<br/>默认值：BarState.Auto |

### cachedCount

ArkTS-Dyn: cachedCount(count: Optional\<number>)

ArkTS-Sta: cachedCount(count: int | undefined)
...
| 参数名 | 类型              | 必填 | 说明                                       |
| ------ | ----------------- | ---- | ------------------------------------------ |
| count  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number><br/>ArkTS-Sta: int \| undefined | 是   | ArcListItem的预加载数量。<br/>默认值：根据屏幕内显示的节点个数设置，最大值为16。<br/>取值范围：[0, +∞) |

### chainAnimation

ArkTS-Dyn: chainAnimation(enable: Optional\<boolean>)

ArkTS-Sta: chainAnimation(enable: boolean | undefined)
...
| 参数名 | 类型               | 必填 | 说明                                                         |
| ------ | ------------------ | ---- | ------------------------------------------------------------ |
| enable | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<boolean><br/>ArkTS-Sta: boolean \| undefined | 是   | 是否启用链式联动动效。<br/>默认值：false，不启用链式联动。true，启用链式联动。 |

### enableScrollInteraction

ArkTS-Dyn: enableScrollInteraction(enable: Optional\<boolean>)

ArkTS-Sta: enableScrollInteraction(enable: boolean | undefined)
...
| 参数名 | 类型               | 必填 | 说明                                |
| ------ | ------------------ | ---- | ----------------------------------- |
| enable | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<boolean><br/>ArkTS-Sta: boolean \| undefined | 是   | 是否支持滚动手势。设置为true时可以通过手指或者鼠标滚动，设置为false时无法通过手指或者鼠标滚动，但不影响控制器[Scroller](ts-container-scroll.md#scroller)的滚动接口。<br/>默认值：true |

### fadingEdge

ArkTS-Dyn: fadingEdge(enable: Optional&lt;boolean&gt;)

ArkTS-Sta: fadingEdge(enable: boolean | undefined)
...
ArkTS-Dyn: friction(friction: Optional\<number>)

ArkTS-Sta: friction(friction: double | undefined)
...
| 参数名   | 类型              | 必填 | 说明                         |
| -------- | ----------------- | ---- | ---------------------------- |
| friction | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number><br/>ArkTS-Sta: double \| undefined | 是   | 摩擦系数。<br/>默认值：0.8<br/>取值范围：(0, +∞) |

### scrollBarWidth

ArkTS-Dyn: scrollBarWidth(width: Optional\<LengthMetrics>)

ArkTS-Sta: scrollBarWidth(width: LengthMetrics | undefined)
...
| 参数名 | 类型                                                         | 必填 | 说明                                                        |
| ------ | ------------------------------------------------------------ | ---- | ----------------------------------------------------------- |
| width  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12)&gt;<br/>ArkTS-Sta: [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) \| undefined | 是   | 滚动条的宽度。<br/>默认值：LengthMetrics.vp(24)<br/>最小值：LengthMetrics.vp(4)<br />单位：vp |
...
| 参数名 | 类型                                                         | 必填 | 说明                                     |
| ------ | ------------------------------------------------------------ | ---- | ---------------------------------------- |
| color  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12)&gt;<br/>ArkTS-Sta: [ColorMetrics](../js-apis-arkui-graphics.md#colormetrics12) \| undefined | 是   | 设置滚动条颜色。<br />默认值：ColorMetrics.numeric(0xA9FFFFFF) |

### flingSpeedLimit

ArkTS-Dyn: flingSpeedLimit(speed: Optional\<number>)

ArkTS-Sta: flingSpeedLimit(speed: double | undefined)
...
| 参数名 | 类型              | 必填 | 说明                            |
| ------ | ----------------- | ---- | ------------------------------- |
| speed  | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)\<number><br/>ArkTS-Sta: double \| undefined | 是   | 惯性滚动动效开始时的最大初始速度。<br/>默认值：9000<br/>单位：vp/s<br />取值范围：(0, +∞) |

### childrenMainSize

ArkTS-Dyn: childrenMainSize(size: Optional\<ChildrenMainSize>)

ArkTS-Sta: childrenMainSize(size: ChildrenMainSize | undefined)
...
ArkTS-Dyn: onScrollIndex(handler: Optional\<ArcScrollIndexHandler>)

ArkTS-Sta: onScrollIndex(handler: ArcScrollIndexHandler | undefined)
...
| 参数名  | 类型                                                         | 必填 | 说明                                            |
| ------- | ------------------------------------------------------------ | ---- | ----------------------------------------------- |
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[ArcScrollIndexHandler](#arcscrollindexhandler)&gt;<br/>ArkTS-Sta: [ArcScrollIndexHandler](#arcscrollindexhandler) \| undefined | 是   | 有子组件划入或划出ArcList显示区域时触发该回调。 |

### onReachStart

ArkTS-Dyn: onReachStart(handler: Optional\<VoidCallback>)

ArkTS-Sta: onReachStart(handler: VoidCallback | undefined)
...
| 参数名  | 类型                                             | 必填 | 说明                     |
| ------- | ------------------------------------------------ | ---- | ------------------------ |
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[VoidCallback](ts-types.md#voidcallback12)&gt;<br/>ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) \| undefined | 是   | 列表到达起始位置时触发。 |

### onReachEnd

ArkTS-Dyn: onReachEnd(handler: Optional\<VoidCallback>)

ArkTS-Sta: onReachEnd(handler: VoidCallback | undefined)
...
| 参数名  | 类型                                             | 必填 | 说明                     |
| ------- | ------------------------------------------------ | ---- | ------------------------ |
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[VoidCallback](ts-types.md#voidcallback12)&gt;<br/>ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) \| undefined | 是   | 列表到达末尾位置时触发。 |

### onScrollStart

ArkTS-Dyn: onScrollStart(handler: Optional\<VoidCallback>)

ArkTS-Sta: onScrollStart(handler: VoidCallback | undefined)
...
| 参数名  | 类型                                             | 必填 | 说明                 |
| ------- | ------------------------------------------------ | ---- | -------------------- |
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[VoidCallback](ts-types.md#voidcallback12)&gt;<br/>ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) \| undefined | 是   | 列表滑动开始时触发。 |

### onScrollStop

ArkTS-Dyn: onScrollStop(handler: Optional\<VoidCallback>)

ArkTS-Sta: onScrollStop(handler: VoidCallback | undefined)
...
| 参数名  | 类型                                             | 必填 | 说明                 |
| ------- | ------------------------------------------------ | ---- | -------------------- |
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[VoidCallback](ts-types.md#voidcallback12)&gt;<br/>ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) \| undefined | 是   | 列表滑动停止时触发。 |

### onWillScroll

ArkTS-Dyn: onWillScroll(handler: Optional\<OnWillScrollCallback>)

ArkTS-Sta: onWillScroll(handler: OnWillScrollCallback | undefined)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ------ | ------|
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[OnWillScrollCallback](ts-container-scrollable-common.md#onwillscrollcallback12)&gt;<br/>ArkTS-Sta: [OnWillScrollCallback](ts-container-scrollable-common.md#onwillscrollcallback12) \| undefined | 是 | 列表滑动时每帧开始前触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ------ | ------|
| handler | ArkTS-Dyn: [Optional](ts-universal-attributes-custom-property.md#optionalt)&lt;[OnScrollCallback](ts-container-scrollable-common.md#onscrollcallback12)&gt;<br/>ArkTS-Sta: [OnScrollCallback](ts-container-scrollable-common.md#onscrollcallback12) \| undefined | 是 | 列表滑动时触发的回调。 |
...
| 名称       | 类型                                    | 只读 | 可选 | 说明                                                     |
| ------------ | ------------------------------------------- | ---- | --- | ------------------------------------------------------------ |
| initialIndex | ArkTS-Dyn: number<br/>ArkTS-Sta: int                                      | 否   | 是 | 设置当前ArcList初次加载时视窗起始位置显示的item的索引值。<br/>默认值：0<br/>**说明：** <br/>设置为负数或超过了当前ArcList最后一个item的索引值时视为无效取值，无效取值按默认值显示。 |
...
| header       | ArkTS-Dyn: [ComponentContent](../js-apis-arkui-ComponentContent.md)<br/>ArkTS-Sta: [ComponentContentBase](../js-apis-arkui-ComponentContent.md)                            | 否   | 是 | 支持标题设置。                                               |

## ArcScrollIndexHandler

ArkTS-Dyn: type ArcScrollIndexHandler = (start: number, end: number, center: number) => void

ArkTS-Sta: type ArcScrollIndexHandler = (start: int, end: int, center: int) => void
...
| 参数名 | 类型   | 必填 | 说明                                      |
| ------ | ------ | ---- | ----------------------------------------- |
| start  | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 是   | ArcList显示区域内第一个子组件的索引值。   |
| end    | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 是   | ArcList显示区域内最后一个子组件的索引值。 |
| center | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 是   | ArcList显示区域内中间位置子组件的索引值。 |
