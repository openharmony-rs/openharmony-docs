...
| 名称                | 类型                                                         | 只读 | 可选 | 说明                                                         |
| ------------------- | ------------------------------------------------------------ | ---- | ---- | ------------------------------------------------------------ |
| value     | double                                     | 否  | 否   | 进度条当前进度值。<br/>取值范围：[0, total]，当设置小于0的值时，按0处理；当设置大于total的值时，按total处理。 |
| total     | double                                     | 否  | 是   | 进度条总进度值。<br/>默认值：100<br/>取值范围：[0, 2147483647] |
...
| color | [ResourceColor](ts-types.md#resourcecolor) | 否 | 设置进度条的前景颜色。 |
