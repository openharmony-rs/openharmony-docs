...
该示例通过配置[systemMaterial](#customdialogcontrolleroptions对象说明)，实现沉浸光感效果。
...
![未设置沉浸光感时](figures/customdialogwithoutmaterial.gif)

设置沉浸光感后：

![设置沉浸光感后](figures/customdialogwithmaterial.gif)