...
| controller                    | [TabsController](ts-container-tabs.md#tabscontroller)        | 是   | -           | 工具栏控制器，不支持控制工具栏子项。<br/>**说明：** <br/>该接口属于常规成员变量，可以传参进行初始化；也可以不传参数值，不传参数时，使用组件内预设值进行初始化，组件内预设值为：new TabsController()。<br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。                            |
