...
| navDestination |ArkTS-Dyn: [NavDestinationBuildFunction](#navdestinationbuildfunction) <br/>ArkTS-Sta: PageMapBuilder \| undefined | 是 | @BuilderParam | 设置加载目标页面的路由规则。 |
...
ArkTS-Dyn: moveIndexToToTop(index: number, animated?: boolean): void
