...
| 类型                                          | 说明        |
| --------------------------------------------- | ----------- |
| ArkTS-Dyn: [PositionWithAffinity](#positionwithaffinity12) <br> ArkTS-Sta: [PositionWithAffinity](#positionwithaffinity12) \| undefined | 字形位置信息。当[LayoutManager](#layoutmanager12)没有和组件绑定时，返回无效值。|
