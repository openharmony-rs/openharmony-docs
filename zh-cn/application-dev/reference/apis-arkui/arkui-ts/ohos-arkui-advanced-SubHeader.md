...
| titleAccessibilityText<sup>23+</sup>  | [ResourceStr](ts-types.md#resourcestr) | 否 | -             | 设置标题自定义朗读内容。<br/>默认值：undefined<br/>值为undefined时，系统遵循默认的无障碍朗读规则和顺序<br/>**模型约束：** 此接口仅可在Stage模型下使用。<br/>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。   |
