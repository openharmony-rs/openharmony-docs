...
ArkTS-Dyn: onRemoteReady(callback: [Callback](../../apis-basic-services-kit/js-apis-base.md#callback)\<UIExtensionProxy>)

ArkTS-Sta: onRemoteReady(callback: [Callback](../../apis-basic-services-kit/js-apis-base.md#callback)\<UIExtensionProxy> | undefined)
...
| 参数名                       | 类型   | 必填 | 说明                                                         |
| ---------------------------- | ------ | ------ | ------------------------------------------------------- |
| callback                        | ArkTS-Dyn: Callback\<UIExtensionProxy\> <br/>ArkTS-Sta: Callback\<UIExtensionProxy\> \| undefined| 否 | 用于向对端Ability发送数据。                          |

### onReceive

ArkTS-Dyn: onReceive(callback: ReceiveCallback)

ArkTS-Sta: onReceive(callback: ReceiveCallback | undefined)
...
| 参数名                       | 类型   | 必填 | 说明                                                         |
| ---------------------------- | ------ | ------ | ------------------------------------------------------- |
| callback                        | ArkTS-Dyn: [ReceiveCallback](#receivecallback18) <br/>ArkTS-Sta: [ReceiveCallback](#receivecallback18) \| undefined| 否 | 收到来自对端Ability的数据。                 |
...
| 参数名                       | 类型   | 必填 | 说明                                                         |
| ---------------------------- | ------ | ------ | ------------------------------------------------------------ |
| err                        | ArkTS-Dyn: [BusinessError](../../apis-basic-services-kit/js-apis-base.md#businesserror) <br/>ArkTS-Sta: [BusinessError](../../apis-basic-services-kit/js-apis-base.md#businesserror) \| undefined| 否 | 报错信息。    |
...
| 参数名   | 类型   | 必填 | 说明                                                                                     |
| -------  | ------ | ------ | ------------------------------------------------------------------------------------- |
| callback | ArkTS-Dyn: [Callback](../../apis-basic-services-kit/js-apis-base.md#callback)\<[TerminationInfo](#terminationinfo12)> <br/>ArkTS-Sta: [Callback](../../apis-basic-services-kit/js-apis-base.md#callback)\<[TerminationInfo](#terminationinfo12)> \| undefined| 否 | 回调函数，入参用于接收UIExtensionAbility的返回结果，类型为[TerminationInfo](#terminationinfo12)。 |
...
| 参数名                       | 类型   | 必填 | 说明                                                         |
| ---------------------------- | ------ | ------ | ------------------------------------------------------------ |
| callback                        | ArkTS-Dyn: [Callback](../../apis-basic-services-kit/js-apis-base.md#callback) \<void><br />ArkTS-Sta: [VoidCallback](ts-types.md#voidcallback12) \| undefined| 是 | 回调函数，UIExtensionAbility绘制第一帧时触发本回调，类型为void。    |
