...
| 参数名 | 类型                         | 必填 | 说明                         |
| ------ | ---------------------------- | ---- | ---------------------------- |
| value  |  [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) \| undefined | 是   | 列与列的间距。<br/>默认值：0vp<br/>取值范围：[0, +∞)<br/>设置为小于0的值时，按默认值显示。<br/>方法入参为undefined时，恢复为默认值（0vp）。 |
...
| 参数名 | 类型                         | 必填 | 说明                         |
| ------ | ---------------------------- | ---- | ---------------------------- |
| value  | [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) \| undefined | 是   | 行与行的间距。<br/>默认值：0vp<br/>取值范围：[0, +∞)<br/>设置为小于0的值时，按默认值显示。<br/>方法入参为undefined时，恢复为默认值（0vp）。 |
