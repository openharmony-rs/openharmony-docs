...
**相关接口：** 该接口对应的ArkTS-Sta的接口是[clickEffect<sup>23+</sup>](#clickeffect23)。
...
**相关接口：** 该接口对应的ArkTS-Dyn的接口是[clickEffect](#clickeffect)和[clickEffect<sup>18+</sup>](#clickeffect18)。
...
| 名称  | 类型                                                  | 只读    | 可选   |  说明                                                         |
| ----- | ----------------------------------------------------------- | ---- | --------- | --------------------------------------------------------- |
| level | [ClickEffectLevel](ts-appendix-enums.md#clickeffectlevel10) | 否   | 否  |点击回弹效果级别。<br/>默认值：ClickEffectLevel.LIGHT<br/>**说明：**<br/>当level为undefined或者null时， ClickEffect采用ClickEffectLevel.LIGHT对应的回弹效果，缩放比参照scale说明。 |
