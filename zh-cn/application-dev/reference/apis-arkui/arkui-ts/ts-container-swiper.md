...
| 参数名 | 类型   | 必填 | 说明                                             |
| ------ | ------ | ---- | ------------------------------------------------ |
| value  | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| Bindable\<int> \| undefined | 是   | 当前在容器中显示的子组件的索引值。<br/>默认值：0 <br/>**说明：** <br/>设置的值小于0或大于最大页面索引时，取0。<br/>取值为undefined时，按默认值处理。|
...
| 参数名 | 类型    | 必填 | 说明                                   |
| ------ | ------- | ---- | -------------------------------------- |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 子组件是否自动播放。<br/>true：自动播放；false：不自动播放。<br/>传入非法值时，按false处理。<br/>取值为undefined时，按默认值处理。 |

### autoPlay<sup>18+</sup>

ArkTS-Dyn: autoPlay(autoPlay: boolean, options: AutoPlayOptions)
...
| 参数名 | 类型    | 必填 | 说明                                   |
| ------ | ------- | ---- | -------------------------------------- |
| autoPlay  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 子组件是否自动播放。<br/>true：自动播放；false：不自动播放。<br/>传入非法值时，按false处理。<br/>取值为undefined时，按默认值处理。 |
| options  | ArkTS-Dyn: [AutoPlayOptions](#autoplayoptions18对象说明)&nbsp;<br/>ArkTS-Sta: [AutoPlayOptions](#autoplayoptions18对象说明)&nbsp;\| undefined | 是   | 配置手指或者鼠标等按下屏幕时子组件是否停止自动播放。当stopWhenTouched设置为true时，多指按下场景中任意一个手指抬起后，将自动继续播放。<br/>默认值：{ stopWhenTouched: true }，停止自动播放。<br/>取值为undefined时，按默认值处理。 |
...
| 参数名 | 类型                                                         | 必填 | 说明                                                         |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | [DotIndicator](#dotindicator10)<sup>10+</sup>&nbsp;\|&nbsp;[DigitIndicator](#digitindicator10)<sup>10+</sup>&nbsp;\|&nbsp;boolean | 是   | 可选导航点指示器样式。<br/> \- DotIndicator：圆点指示器样式。<br/> \- DigitIndicator：数字指示器样式。<br/> \- boolean：是否启用导航点指示器。设置为true启用，false不启用。<br/>默认值：true<br/>默认类型：DotIndicator。<br/>true：启用导航点指示器；false：不启用导航点指示器。 |
...
ArkTS-Dyn: nestedScroll(value: SwiperNestedScrollMode)
...
| 参数名 | 类型                                                        | 必填 | 说明                                                         |
| ------ | ----------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [SwiperNestedScrollMode](#swipernestedscrollmode11枚举说明)<br/>ArkTS-Sta: [SwiperNestedScrollMode](#swipernestedscrollmode11枚举说明) \| undefined | 是   | Swiper组件和父组件的嵌套滚动模式。<br/>默认值：SwiperNestedScrollMode.SELF_ONLY<br/>取值为undefined时，按默认值处理。 |
...
| 参数名 | 类型    | 必填 | 说明                            |
| ------ | ------- | ---- | ------------------------------- |
| value  |ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined| 是   | 是否开启循环。<br/>true：开启循环；false：不开启循环。<br/>传入参数非法时，按true处理。<br/>取值为undefined时，按默认值处理。 |

### effectMode<sup>8+</sup>

ArkTS-Dyn: effectMode(value: EdgeEffect)

ArkTS-Sta: effectMode(value: EdgeEffect | undefined)
...
| 参数名 | 类型                                          | 必填 | 说明                                         |
| ------ | --------------------------------------------- | ---- | -------------------------------------------- |
| value  | ArkTS-Dyn: [EdgeEffect](ts-appendix-enums.md#edgeeffect)<br/>ArkTS-Sta: [EdgeEffect](ts-appendix-enums.md#edgeeffect) \| undefined | 是   | 边缘滑动效果。<br/>默认值：EdgeEffect.Spring<br/>取值为undefined时，按默认值处理。 |

### interval

ArkTS-Dyn: interval(value: number)

ArkTS-Sta: interval(value: int | undefined)
...
| 参数名 | 类型   | 必填 | 说明                                                       |
| ------ | ------ | ---- | ---------------------------------------------------------- |
| value  | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 是   | 自动播放时播放的时间间隔。当小于[duration](#duration)属性值时，翻页完成后会立即开始下一次轮播。<br/>默认值：3000<br/>单位：毫秒<br/>取值范围：[0, +∞)，设置小于0的值时，按照默认值处理。<br/>取值为undefined时，按默认值处理。 |
...
| 参数名 | 类型   | 必填 | 说明                                                  |
| ------ | ------ | ---- | ----------------------------------------------------- |
| value  | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 是   | 子组件切换的动画时长。<br/>默认值：400<br/>单位：毫秒<br/>取值范围：[0, +∞)，设置小于0的值时，按照默认值处理。<br/>取值为undefined时，按默认值处理。 |

### curve<sup>8+</sup>

ArkTS-Dyn: curve(value: Curve | string | ICurve)

ArkTS-Sta: curve(value: Curve | string | ICurve | undefined)
...
| 参数名 | 类型                                                         | 必填 | 说明                                        |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------- |
| value  | ArkTS-Dyn: [Curve](ts-appendix-enums.md#curve)&nbsp;\|&nbsp;string&nbsp;\|&nbsp;[ICurve](../js-apis-curve.md#icurve9)<sup>10+</sup><br/>ArkTS-Sta: [Curve](ts-appendix-enums.md#curve)&nbsp;\|&nbsp;string&nbsp;\|&nbsp;[ICurve](../js-apis-curve.md#icurve9) \| undefined | 是   | Swiper的动画曲线。<br/>string类型来源[curves.init](../js-apis-curve.md#curvesinitdeprecated)，[curves.steps](../js-apis-curve.md#curvesstepsdeprecated)，[curves.cubicBezier](../js-apis-curve.md#curvescubicbezierdeprecated)，[curves.spring](../js-apis-curve.md#curvesspringdeprecated)函数从API version 9开始废弃，推荐使用Curve和ICurve类型。<br/>默认值：[interpolatingSpring](../js-apis-curve.md#curvesinterpolatingspring10)(-1, 1, 328, 34)<br/>取值为undefined时，按默认值处理。 |
...
| 参数名 | 类型    | 必填 | 说明                               |
| ------ | ------- | ---- | ---------------------------------- |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 是否为纵向滑动。<br/>true：纵向滑动；false：横向滑动。<br/>默认值：false<br/>取值为undefined时，按默认值处理。 |

### itemSpace

ArkTS-Dyn: itemSpace(value: number | string)

ArkTS-Sta: itemSpace(value: double | string | undefined)
...
| 参数名 | 类型                       | 必填 | 说明                                   |
| ------ | -------------------------- | ---- | -------------------------------------- |
| value  | ArkTS-Dyn: number&nbsp;\|&nbsp;string<br/>ArkTS-Sta: double&nbsp;\|&nbsp;string \| undefined | 是   | 子组件与子组件之间间隙。<br/>默认值：0<br/>取值范围：[0, +∞)，当设置数值小于0或超出Swiper组件宽度范围时，按照默认值处理。<br/>取值为undefined时，按默认值处理。 |
...
| 参数名 | 类型   | 必填 | 说明                             |
| ------ | ------ | ---- | -------------------------------- |
| value  | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 是   | 预加载子组件个数。<br/>默认值：1<br/>取值范围：[0, +∞)，设置小于0的值时，按照默认值处理。<br/>取值为undefined时，按默认值处理。 |

### cachedCount<sup>15+</sup>

ArkTS-Dyn: cachedCount(count: number, isShown: boolean)

ArkTS-Sta: cachedCount(count: int | undefined, isShown: boolean | undefined)
...
ArkTS-Dyn: cachedCount(count: number, options: CachedCountOptions)

ArkTS-Sta: cachedCount(count: int | undefined, options: CachedCountOptions | undefined)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ------ | ---- | ---- |
| count | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 是 | 预加载子组件个数。<br/>取值范围：[0, +∞)，设置小于0的值时，按照1处理。<br/>取值为undefined时，按照1处理。 |
| options  | ArkTS-Dyn: [CachedCountOptions](#cachedcountoptions24对象说明)<br/>ArkTS-Sta: CachedCountOptions \| undefined | 是 | 预加载子组件的配置选项。<br/>取值为undefined时，按CachedCountOptions中的默认值处理。 |

### disableSwipe<sup>8+</sup>

ArkTS-Dyn: disableSwipe(value: boolean)
...
| 参数名 | 类型    | 必填 | 说明                                     |
| ------ | ------- | ---- | ---------------------------------------- |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 禁用组件滑动切换功能。<br/>true：禁用；false：不禁用。<br/>默认值：false <br/>取值为undefined时，按默认值处理。|
...
| swipeByGroup | boolean                                                      | 否   | 是否按组进行翻页。<br/>true：在翻页时会按组进行翻页，每组内子元素的数量为displayCount的值；false：为默认翻页行为，即按照子元素进行翻页。<br/> 默认值：false |
...
| 参数名                     | 类型                                             | 必填 | 说明                                                         |
| -------------------------- | ------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value                      | ArkTS-Dyn: [ArrowStyle](#arrowstyle10对象说明)&nbsp;\|&nbsp;boolean<br/>ArkTS-Sta: [ArrowStyle](#arrowstyle10对象说明)&nbsp;\|&nbsp;boolean \| undefined | 是   | 支持设置箭头和底板样式，异常场景使用ArrowStyle对象中的默认值。<br/>true：显示默认的箭头和底板样式；false：不显示箭头和底板。<br/>默认值：false<br/>取值为undefined时，按默认值处理。 |
| isHoverShow     | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined  | 否   | 设置鼠标悬停时是否显示箭头。<br/>默认值：false<br/>true：有导航点时鼠标悬停在导航点和箭头范围内显示箭头，无导航点时鼠标悬停在Swiper显示范围内显示箭头；false：常驻显示箭头。<br/>取值为undefined时，按默认值处理。<br/>**说明：**<br/>箭头显示时，支持点击翻页。 |

### displayMode

ArkTS-Dyn: displayMode(value: SwiperDisplayMode)

ArkTS-Sta: displayMode(value: SwiperDisplayMode | undefined)
...
| 参数名 | 类型                                            | 必填 | 说明                                                         |
| ------ | ----------------------------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [SwiperDisplayMode](#swiperdisplaymode枚举说明)<br/>ArkTS-Sta: [SwiperDisplayMode](#swiperdisplaymode枚举说明) \| undefined | 是   | 主轴方向上元素排列的模式。<br/>默认值：SwiperDisplayMode.STRETCH<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: indicatorInteractive(value: boolean)
...
| 参数名 | 类型                                                        | 必填 | 说明                                                         |
| ------ | ----------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 导航点是否可交互。<br/>true：导航点可交互；false：导航点不可交互。<br/>传入参数非法时，按true处理。<br/>取值为undefined时，按true处理。 |
...
| 参数名 | 类型                                                        | 必填 | 说明                                                         |
| ------ | ----------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| enabled  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined | 是   | 设置显示区域上方或前方插入或删除数据时是否要保持可见内容位置不变。<br/>默认值：false，显示区域上方或前方插入或删除数据时可见内容位置会跟随变化。 <br/>true：显示区域上方或前方插入或删除数据时可见内容位置不变。如果改变数据源是在动画过程中，由于目标索引变化会导致动画停止。<br/>取值为undefined时，按默认值处理。 |

### attributeModifier<sup>23+</sup>

attributeModifier(modifier: AttributeModifier\<SwiperAttribute> | AttributeModifier\<CommonMethod> | undefined)
...
| 参数名   | 类型                                         | 必填 | 说明                                                                                                                             |
| -------- | -------------------------------------------- | ---- | -------------------------------------------------------------------------------------------------------------------------------- |
| modifier | [AttributeModifier\<SwiperAttribute>](./ts-universal-attributes-attribute-modifier.md#attributemodifiert) \| AttributeModifier\<CommonMethod> \| undefined | 是   | 在当前组件上，动态设置属性方法，支持使用if/else语法。<br/>CommonMethod：通用属性和事件。<br/>取值为undefined时，按当前组件的属性方法默认值处理。 |
...
| 名称                               |  值 |说明                                                         |
| ---------------------------------- | -- |------------------------------------------------------------ |
| Stretch<sup>(deprecated)</sup>     | 0 |Swiper滑动一页的宽度为Swiper组件自身的宽度。<br>**说明**：从API version 7开始支持，从API version 10开始废弃，建议使用STRETCH替代。<br/>**卡片能力：** 从API version 7开始，该接口支持在ArkTS卡片中使用。<br/>**ArkTS模式：** 该接口仅适用于ArkTS-Dyn。<br/>**ArkTS-Dyn起始版本：** 7 |
| AutoLinear<sup>(deprecated)</sup>  | 1 |Swiper滑动一页的宽度为子组件宽度中的最大值。此枚举表现形式与[displayCount](#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](#displaycount8)说明。<br>**说明**：从API version 7开始支持，从API version 10开始废弃，建议使用AUTO_LINEAR替代。<br/>**卡片能力：** 从API version 7开始，该接口支持在ArkTS卡片中使用。<br/>**ArkTS模式：** 该接口仅适用于ArkTS-Dyn。<br/>**ArkTS-Dyn起始版本：** 7 |
| STRETCH<sup>10+</sup>              | 0 |Swiper滑动一页的宽度为Swiper组件自身的宽度。<br/>**卡片能力：** 从API version 10开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。<br/>**ArkTS-Dyn起始版本：** 10<br/>**ArkTS-Sta起始版本：** 23 |
| AUTO_LINEAR<sup>(deprecated)</sup> | 0| Swiper滑动一页的宽度为视窗内最左侧子组件的宽度。此枚举表现形式与[displayCount](#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](#displaycount8)说明。<br/>**说明**：从API version 10开始支持，从API version 12开始废弃，建议使用[Scroller.scrollTo](ts-container-scroll.md#scrollto)替代。<br/>**卡片能力：** 从API version 10开始，该接口支持在ArkTS卡片中使用。<br/>**原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。<br/>**ArkTS模式：** 该接口仅适用于ArkTS-Dyn。<br/>**ArkTS-Dyn起始版本：** 10 |
...
ArkTS-Dyn: changeIndex(index: number, animationMode?: SwiperAnimationMode | boolean)

ArkTS-Sta: changeIndex(index: int | undefined, animationMode?: SwiperAnimationMode | boolean)
...
| 参数名      | 类型       | 必填  | 说明     |
| -------- | ---------- | ---- | -------- |
| index| ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined | 是    | 指定页面在Swiper中的索引值。<br/>取值为undefined时，按默认值处理。<br/>**说明：** <br/>设置的值小于0或大于最大页面索引时，取0。 |
| animationMode| [SwiperAnimationMode](#swiperanimationmode15枚举说明)&nbsp;\|&nbsp;boolean | 否    | 设置翻页至指定页面时的动效模式。<br/>默认值：SwiperAnimationMode.NO_ANIMATION<br/> **说明：** <br/>当传入true时有动效，等同于SwiperAnimationMode.DEFAULT_ANIMATION；当传入false时无动效，等同于SwiperAnimationMode.NO_ANIMATION。<br/>true：有动效翻页；false：无动效翻页。 |
...
| 参数名      | 类型       | 必填  | 说明     |
| -------- | ---------- | ---- | -------- |
| callback | [VoidCallback](./ts-types.md#voidcallback12) | 否    | 动画结束的回调。默认无回调。 |
...
ArkTS-Dyn: left(value: Length): T

ArkTS-Sta: left(value: Length | undefined): this
...
ArkTS-Dyn: top(value: Length): T

ArkTS-Sta: top(value: Length | undefined): this
...
ArkTS-Dyn: right(value: Length): T

ArkTS-Sta: right(value: Length | undefined): this
...
ArkTS-Dyn: bottom(value: Length): T

ArkTS-Sta: bottom(value: Length | undefined): this
...
| 参数名 | 类型                         | 必填 | 说明                                                         |
| ------ | ---------------------------- | ---- | ------------------------------------------------------------ |
| value  | [Length](ts-types.md#length) \| undefined | 是   | 设置导航点底部相对于Swiper的位置。<br/>未设置top和bottom时，进行自适应大小布局，按照指示器本身大小和Swiper的大小，在交叉轴方向上，位于底部，效果与设置bottom=0一致。<br/>设置为0时：按照0位置布局计算。<br/>优先级：低于top属性。<br/>取值范围：[0,Swiper高度-导航点区域高度]，超出该范围时，取最近的边界值。 |
...
ArkTS-Dyn: bottom(bottom: LengthMetrics | Length, ignoreSize: boolean): T

ArkTS-Sta: bottom(bottom: LengthMetrics | Length | undefined, ignoreSize: boolean): this
...
ArkTS-Dyn: start(value: LengthMetrics): T

ArkTS-Sta: start(value: LengthMetrics | undefined): this
...
| 参数名 | 类型                                                         | 必填 | 说明                                                         |
| ------ | ------------------------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12)<br/>ArkTS-Sta: [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) \| undefined | 是   | 设置在RTL模式下为导航点距离Swiper组件右边的距离，在LTR模式下为导航点距离Swiper组件左边的距离。<br/>默认值：0<br/>单位：vp<br/>取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: end(value: LengthMetrics): T

ArkTS-Sta: end(value: LengthMetrics | undefined): this
...
| 参数名 | 类型                         | 必填  | 说明                                     |
| ------ | ---------------------------- | ---- | ---------------------------------------- |
| value |ArkTS-Dyn: [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12)<br/>ArkTS-Sta: [LengthMetrics](../js-apis-arkui-graphics.md#lengthmetrics12) \| undefined | 是    | 设置在RTL模式下为导航点距离Swiper组件左边的距离，在LTR模式下为导航点距离Swiper组件右边的距离。<br/>默认值：0<br/>单位：vp<br/>取值范围：[0, Swiper宽度-导航点区域宽度]，超出该范围时，取最近的边界值。<br/>取值为undefined时，按默认值处理。  |
...
ArkTS-Dyn: itemWidth(value: Length): DotIndicator

ArkTS-Sta: itemWidth(value: Length | undefined): this
...
ArkTS-Dyn: itemHeight(value: Length): DotIndicator

ArkTS-Sta: itemHeight(value: Length | undefined): this
...
ArkTS-Dyn: selectedItemWidth(value: Length): DotIndicator

ArkTS-Sta: selectedItemWidth(value: Length | undefined): this
...
ArkTS-Dyn: selectedItemHeight(value: Length): DotIndicator

ArkTS-Sta: selectedItemHeight(value: Length | undefined): this
...
ArkTS-Dyn: mask(value: boolean): DotIndicator

ArkTS-Sta: mask(value: boolean | undefined): this
...
| 参数名 | 类型    | 必填 | 说明                                                         |
| ------ | ------- | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: boolean<br/>ArkTS-Sta: boolean \| undefined  | 是   | 设置是否显示Swiper组件圆点导航指示器的蒙版样式。<br/>true表示显示Swiper组件圆点导航指示器的蒙版样式；false表示不显示。<br/>默认值：false<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: color(value: ResourceColor): DotIndicator

ArkTS-Sta: color(value: ResourceColor | undefined): this
...
| 参数名 | 类型                                       | 必填 | 说明                                                         |
| ------ | ------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  |ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 设置Swiper组件圆点导航指示器的颜色。<br/>默认值：'#1A182431'，浅灰色。<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: selectedColor(value: ResourceColor): DotIndicator

ArkTS-Sta: selectedColor(value: ResourceColor | undefined): this
...
| 参数名 | 类型                                       | 必填 | 说明                                                         |
| ------ | ------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  |ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined  | 是   | 设置选中Swiper组件圆点导航指示器的颜色。<br/>默认值：'\#007DFF'，蓝色。<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: maxDisplayCount(maxDisplayCount: number): DotIndicator

ArkTS-Sta: maxDisplayCount(maxDisplayCount: int | undefined): this
...
ArkTS-Dyn: space(space: LengthMetrics): DotIndicator

ArkTS-Sta: space(space: LengthMetrics | undefined): this
...
ArkTS-Dyn: fontColor(value: ResourceColor): DigitIndicator
...
| 参数名 | 类型                                       | 必填 | 说明                                                         |
| ------ | ------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  |ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 设置Swiper组件数字导航点的字体颜色。<br/>默认值：'\#ff182431'，黑色。<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: selectedFontColor(value: ResourceColor): DigitIndicator

ArkTS-Sta: selectedFontColor(value: ResourceColor | undefined): this
...
| 参数名 | 类型                                       | 必填 | 说明                                                         |
| ------ | ------------------------------------------ | ---- | ------------------------------------------------------------ |
| value  |ArkTS-Dyn: [ResourceColor](ts-types.md#resourcecolor)<br/>ArkTS-Sta: [ResourceColor](ts-types.md#resourcecolor) \| undefined | 是   | 设置选中Swiper组件数字导航点的字体颜色。<br/>默认值：'\#ff182431'，黑色。<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: digitFont(value: Font): DigitIndicator

ArkTS-Sta: digitFont(value: Font | undefined): this
...
| 参数名 | 类型                     | 必填 | 说明                                                         |
| ------ | ------------------------ | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [Font](ts-types.md#font)<br/>ArkTS-Sta: [Font](ts-types.md#font) \| undefined | 是   | 设置Swiper组件数字导航点的字体样式。<br/>只支持Font中size和weight参数，family和style设置不生效。<br/>默认值：{&nbsp;size:&nbsp;14,&nbsp;weight:&nbsp;FontWeight.Normal&nbsp;}<br/>取值为undefined时，按默认值处理。 |
...
ArkTS-Dyn: selectedDigitFont(value: Font): DigitIndicator

ArkTS-Sta: selectedDigitFont(value: Font | undefined): this
...
| 参数名 | 类型                     | 必填 | 说明                                                         |
| ------ | ------------------------ | ---- | ------------------------------------------------------------ |
| value  | ArkTS-Dyn: [Font](ts-types.md#font)<br/>ArkTS-Sta: [Font](ts-types.md#font) \| undefined | 是   | 设置选中Swiper组件数字导航点的字体样式。<br/>默认值：{&nbsp;size:&nbsp;14,&nbsp;weight:&nbsp;FontWeight.Normal&nbsp;}<br/>取值为undefined时，按默认值处理。 |
...
| 名称              | 类型                                     | 只读  | 可选  | 说明                                     |
| ---------------- | ---------------------------------------- | ---- | ---- | ---------------------------------------- |
| showBackground   | boolean                                  | 否    | 是   | 设置箭头底板是否显示。<br/>true：箭头底板显示；false：箭头底板不显示。<br/>默认值：false                |
| isSidebarMiddle  | boolean                                  | 否    | 是   | 设置箭头显示位置。<br/>true：箭头居中显示在Swiper组件两侧；false：箭头显示在导航点指示器两侧。<br/>默认值：false |
| backgroundSize   | [Length](ts-types.md#length)             | 否    | 是   | 设置底板大小。<br/>在导航点两侧显示：<br/>默认值：24vp<br/>在组件两侧显示：<br/>默认值：32vp<br/>不支持设置百分比。 |
| backgroundColor  | [ResourceColor](ts-types.md#resourcecolor) | 否    | 是   | 设置底板颜色。<br/>在导航点两侧显示：<br/>默认值：'\#00000000'，透明色。<br/>在组件两侧显示：<br/>默认值：'\#19182431'，半透明深灰色。 |
...
| arrowColor       | [ResourceColor](ts-types.md#resourcecolor) | 否    | 是   | 设置箭头颜色。<br/>默认值：'\#182431'，深灰色。                 |
...
| 名称              | 类型                                 | 只读   | 可选  | 说明                                     |
| ---------------- | ---------------------------------------- | ---- | ---- | ---------------------------------------- |
| stopWhenTouched   | boolean                              | 否   | 否    | 在按下事件中配置子组件是否立即停止播放。<br/>true表示停止播放；false表示自动播放不中断。<br/>默认值：true |
...
| 参数名 | 类型   | 必填 | 说明                 |
| ------ | ------ | ---- | -------------------- |
| event  | ArkTS-Dyn: [Callback](./ts-types.md#callback12)\<number><br/>ArkTS-Sta: [Callback](./ts-types.md#callback12)\<int> \| undefined| 是   | 当前显示元素的索引。<br/>取值为undefined时，不使用回调函数。 |

### onAnimationStart<sup>9+</sup>

ArkTS-Dyn: onAnimationStart(event: OnSwiperAnimationStartCallback)

ArkTS-Sta: onAnimationStart(event: OnSwiperAnimationStartCallback | undefined)
...
| 参数名 | 类型   | 必填 | 说明                 |
| ------ | ------ | ---- | -------------------- |
| event  |ArkTS-Dyn: [OnSwiperAnimationStartCallback](#onswiperanimationstartcallback18)<br/>ArkTS-Sta: [OnSwiperAnimationStartCallback](#onswiperanimationstartcallback18) \| undefined  | 是   | 切换动画开始时触发的回调。<br/>取值为undefined时，不使用回调函数。 |

### onAnimationEnd<sup>9+</sup>

ArkTS-Dyn: onAnimationEnd(event: OnSwiperAnimationEndCallback)

ArkTS-Sta: onAnimationEnd(event: OnSwiperAnimationEndCallback | undefined)
...
| 参数名 | 类型   | 必填 | 说明                 |
| ------ | ------ | ---- | -------------------- |
| event  |ArkTS-Dyn: [OnSwiperAnimationEndCallback](#onswiperanimationendcallback18)<br/>ArkTS-Sta: [OnSwiperAnimationEndCallback](#onswiperanimationendcallback18) \| undefined| 是   | 切换动画结束时触发的回调。<br/>取值为undefined时，不使用回调函数。 |
...
ArkTS-Dyn: onGestureSwipe(event: OnSwiperGestureSwipeCallback)

ArkTS-Sta: onGestureSwipe(event: OnSwiperGestureSwipeCallback | undefined)
...
ArkTS-Dyn: customContentTransition(transition: SwiperContentAnimatedTransition)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ---- | ---- | ---- |
| transition |ArkTS-Dyn: [SwiperContentAnimatedTransition](#swipercontentanimatedtransition12)<br/>ArkTS-Sta: [SwiperContentAnimatedTransition](#swipercontentanimatedtransition12) \| undefined  | 是 | Swiper自定义切换动画相关信息。<br/>取值为undefined时，不使用回调函数。 |

### onContentDidScroll<sup>12+</sup>

ArkTS-Dyn: onContentDidScroll(handler: ContentDidScrollCallback)

ArkTS-Sta: onContentDidScroll(handler: ContentDidScrollCallback | undefined)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ---- | ---- | ---- |
| handler |ArkTS-Dyn: [ContentDidScrollCallback](#contentdidscrollcallback12)<br/>ArkTS-Sta: [ContentDidScrollCallback](#contentdidscrollcallback12) \| undefined  | 是 | Swiper滑动时触发的回调。<br/>取值为undefined时，不使用回调函数。 |
...
ArkTS-Dyn: onContentWillScroll(handler: ContentWillScrollCallback)

ArkTS-Sta: onContentWillScroll(handler: ContentWillScrollCallback | undefined)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ---- | ---- | ---- |
| handler | ArkTS-Dyn: [ContentWillScrollCallback](#contentwillscrollcallback15)<br/>ArkTS-Sta: [ContentWillScrollCallback](#contentwillscrollcallback15) \| undefined  | 是 | Swiper滑动时触发的回调。<br/>取值为undefined时，不使用回调函数。 |

### onScrollStateChanged<sup>20+</sup>

ArkTS-Dyn: onScrollStateChanged(event: Callback\<ScrollState>)

ArkTS-Sta: onScrollStateChanged(event: Callback\<ScrollState> | undefined)
...
| 参数名 | 类型 | 必填 | 说明 |
| ------ | ---- | ---- | ---- |
| event  | ArkTS-Dyn: [Callback](./ts-types.md#callback12)\<[ScrollState](ts-container-list.md#scrollstate枚举说明)> <br/>ArkTS-Sta: Callback\<ScrollState> \| undefined | 是   | 滑动状态变化的回调。<br/>取值为undefined时，不使用回调函数。 |

## OnSwiperAnimationStartCallback<sup>18+</sup>

ArkTS-Dyn: type OnSwiperAnimationStartCallback = (index: number, targetIndex: number, extraInfo: SwiperAnimationEvent) => void

ArkTS-Sta: type OnSwiperAnimationStartCallback = (index: int, targetIndex: int, extraInfo: SwiperAnimationEvent) => void
...
| 参数名                    | 类型                                                       | 必填 | 说明                                                         |
| ------------------------- | ---------------------------------------------------------- | ---- | ------------------------------------------------------------ |
| index                     | ArkTS-Dyn: number<br/>ArkTS-Sta: int         | 是   | 当前显示元素的索引。多列Swiper时，index为最左侧组件的索引。                                         |
| targetIndex<sup>10+</sup> | ArkTS-Dyn: number<br/>ArkTS-Sta: int       | 是   | 切换动画目标元素的索引。                                     |
...
ArkTS-Dyn: type OnSwiperAnimationEndCallback = (index: number, extraInfo: SwiperAnimationEvent) => void

ArkTS-Sta: type OnSwiperAnimationEndCallback = (index: int, extraInfo: SwiperAnimationEvent) => void
...
ArkTS-Dyn: type OnSwiperGestureSwipeCallback = (index: number, extraInfo: SwiperAnimationEvent) => void

ArkTS-Sta: type OnSwiperGestureSwipeCallback = (index: int, extraInfo: SwiperAnimationEvent) => void
...
ArkTS-Dyn: type ContentDidScrollCallback = (selectedIndex: number, index: number, position: number, mainAxisLength: number) => void

ArkTS-Sta: type ContentDidScrollCallback = (selectedIndex: int, index: int, position: double, mainAxisLength: double) => void
...
| index | ArkTS-Dyn: number<br/>ArkTS-Sta: int | 是 | 视窗内页面的索引。 |
| position | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 是 | index页面相对于Swiper主轴起始位置（selectedIndex对应页面的起始位置）的移动比例。 |
| mainAxisLength | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 是 | index对应页面在主轴方向上的长度。<br/>单位：vp |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| ------ | ---- | ---- | ---- | ---- |
| timeout | ArkTS-Dyn: number<br/>ArkTS-Sta: int \| undefined  | 否 | 是 | Swiper自定义切换动画超时时间。从页面执行默认动画（页面滑动）至移出视窗外的第一帧开始计时，如果到达该时间后，开发者仍未调用[SwiperContentTransitionProxy](#swipercontenttransitionproxy12)的finishTransition接口通知Swiper组件此页面的自定义动画已结束，那么组件就会认为此页面的自定义动画已结束，立即将该页面节点下渲染树。单位：ms<br/>默认值：0<br/>取值为undefined时，按默认值处理。 |
| transition | ArkTS-Dyn: Callback<[SwiperContentTransitionProxy](#swipercontenttransitionproxy12)><br/>ArkTS-Sta: Callback<[SwiperContentTransitionProxy](#swipercontenttransitionproxy12)> \| undefined | 否 | 否 | 自定义切换动画具体内容。 |
...
| position | ArkTS-Dyn: number<br/>ArkTS-Sta: double| 否 | 否 | index页面相对于Swiper主轴起始位置（selectedIndex对应页面的起始位置）的移动比例。 |
