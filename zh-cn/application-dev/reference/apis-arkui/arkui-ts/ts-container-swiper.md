...
从API version 24开始，新增[startFakeDrag](#startfakedrag24)接口、[fakeDragBy](#fakedragby24)接口、[stopFakeDrag](#stopfakedrag24)接口、[isFakeDragging](#isfakedragging24)接口，用于实现模拟拖拽。
