...
| 参数名 | 类型 | 必填  | 说明 |
| ------| -------- | --------------- | -------- |
| value | { index?: number }   | 否 | 设置步骤导航器当前显示StepperItem的索引值。<br/>默认值：0<br/>取值范围：[0, 子组件的数量-1]<br />从API version 10开始，该参数支持[$$](../../../ui/state-management/arkts-two-way-sync.md)双向绑定变量。 |
