...
| 参数名 | 类型   | 必填 | 说明                                          |
| ------ | ------ | ---- | --------------------------------------------- |
| offset  | ArkTS-Dyn: number&nbsp;\|&nbsp;[Resource](ts-types.md#resource)<br/>ArkTS-Sta: number&nbsp;\|&nbsp;[Resource](ts-types.md#resource)&nbsp;\|&nbsp;undefined | 是   | 内容区末尾偏移量。<br/>设置异常值如负数、非数字Resource与undefined时，按0vp处理。|
...
frameNode中[getEvent('List')](../js-apis-arkui-frameNode.md#geteventlist19)与[getListEvent](../js-apis-arkui-frameNode.md#getlistevent23)方法的返回值，可用于给List节点设置滚动事件。
