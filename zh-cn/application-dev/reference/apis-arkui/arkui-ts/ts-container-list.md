...
| 参数名 | 类型   | 必填 | 说明                                   |
| ------ | ------ | ---- | -------------------------------------- |
| count  | ArkTS-Dyn: number <br/>ArkTS-Sta: int&nbsp;\|&nbsp;undefined | 是   | 预加载的ListItem的数量。<br/>默认值：根据屏幕内显示的节点个数设置，最大值为16。 <br/>取值范围：[0, +∞) |
| show  | ArkTS-Dyn: boolean <br/>ArkTS-Sta: boolean&nbsp;\|&nbsp;undefined | 是   | 被预加载的ListItem是否需要显示。设置为true时显示预加载的ListItem，设置为false时不显示预加载的ListItem。 <br/>默认值：false |
...
| 参数名               | 类型                                                         | 必填 | 说明                                     |
| -------------------- | ------------------------------------------------------------ | ---- | ---------------------------------------- |
| value                | ArkTS-Dyn: number&nbsp;\|&nbsp;[LengthConstrain](ts-types.md#lengthconstrain) <br/>ArkTS-Sta: int&nbsp;\|&nbsp;[LengthConstrain](ts-types.md#lengthconstrain) \|&nbsp;undefined | 是   | List组件的布局列数或行数。<br/>默认值：1 <br/>取值范围：[1, +∞)<br/>**卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。 |
| gutter<sup>10+</sup> | ArkTS-Dyn: [Dimension](ts-types.md#dimension10) <br/>ArkTS-Sta: [Dimension](ts-types.md#dimension10) \|&nbsp;undefined                         | 否   | 列间距。<br />默认值：0 <br/>取值范围：[0, +∞)<br/>**卡片能力：** 从API version 10开始，该接口支持在ArkTS卡片中使用。 |
...
ArkTS-Dyn: contentStartOffset(value: number)

ArkTS-Sta: contentStartOffset(value: double | undefined)
...
| 参数名 | 类型   | 必填 | 说明                                            |
| ------ | ------ | ---- | ----------------------------------------------- |
| value  | ArkTS-Dyn: number <br/>ArkTS-Sta: double&nbsp;\|&nbsp;undefined | 是   | 内容区域起始偏移量。<br/>默认值：0<br/>单位：vp <br/>**说明：**<br/>设置为负数时，按默认值处理。|

### contentEndOffset<sup>11+</sup>

ArkTS-Dyn: contentEndOffset(value: number)

ArkTS-Sta: contentEndOffset(value: double | undefined)
...
| 参数名 | 类型   | 必填 | 说明                                          |
| ------ | ------ | ---- | --------------------------------------------- |
| value  | ArkTS-Dyn: number <br/>ArkTS-Sta: double&nbsp;\|&nbsp;undefined | 是   | 内容区末尾偏移量。<br/>默认值：0<br/>单位：vp <br/>**说明：**<br/>设置为负数时，按默认值处理。|
