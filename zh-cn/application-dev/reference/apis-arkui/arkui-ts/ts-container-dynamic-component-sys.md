...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| callback | ArkTS-Dyn: [ErrorCallback](#errorcallback)<br/>ArkTS-Sta: [ErrorCallback](#errorcallback)\<[BusinessError](../../apis-basic-services-kit/js-apis-base.md#businesserror)> \| undefined | 是 | 回调函数，入参用于接收异常信息。<br/>ArkTS-Sta模式下可不传。 |
