# ComponentContent（ArkTS1.2）

ComponentContent表示组件内容的实体封装，支持在非UI组件中创建与传递。底层使用BuilderNode，具体使用规格参见[BuilderNode（ArkTS1.2）](./js-apis-arkui-v1.2-builderNode.md)。ComponentContent继承自[ComponentContentBase（ArkTS1.2）](./js-apis-arkui-v1.2-ComponentContentBase.md)。
...
| builder  | [WrappedBuilder\<@Builder ()=>void>（ArkTS1.2）](../../ui/state-management/arkts-v1.2-wrapBuilder.md) | 是   |   封装不带参builder函数的WrappedBuilder对象。 |
...
| builder  | [WrappedBuilder\<@Builder (t: T)=>void>（ArkTS1.2）](../../ui/state-management/arkts-v1.2-wrapBuilder.md) | 是   |   封装带参builder函数的WrappedBuilder对象。 |
