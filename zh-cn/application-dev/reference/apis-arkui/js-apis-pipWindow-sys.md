...
| 名称            | 值   | 说明                                   |
|---------------|-----|--------------------------------------|
| VIDEO_DRIVE   | 4   | 表示车载影像画中画模板类型，系统依此加载车载影像模板。<br>**ArkTS-Dyn起始版本：** 26.0.0<br>**ArkTS-Sta起始版本：** 26.0.0<br>**原子化服务API（仅ArkTS-Dyn）：** 从API版本26.0.0 开始，该接口支持在原子化服务中使用。<br>**设备行为差异：** 该模板类型在Car设备中正常调用，在其他设备中返回401错误码。|
| VIDEO_NAVIGATION   | 5   | 表示车载导航画中画模板类型，系统依此加载车载导航模板。<br>**ArkTS-Dyn起始版本：** 26.1.0<br>**ArkTS-Sta起始版本：** 26.1.0<br>**原子化服务API（仅ArkTS-Dyn）：** 从API版本26.1.0 开始，该接口支持在原子化服务中使用。<br>**设备行为差异：** 该模板类型在Car设备中正常调用，在其他设备中返回401错误码。|
