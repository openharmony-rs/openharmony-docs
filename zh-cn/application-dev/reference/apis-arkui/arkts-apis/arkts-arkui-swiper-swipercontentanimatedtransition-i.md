...
[SwiperContentTransitionProxy](arkts-arkui-swiper-swipercontenttransitionproxy-i.md#SwiperContentTransitionProxy)的finishTransition接口通知Swiper组件此页面的自定义动画已结束，那么组件就会认
