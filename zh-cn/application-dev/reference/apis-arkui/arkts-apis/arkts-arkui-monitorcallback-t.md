...
参数为[IMonitor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_类型的监听回调函数。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| monitorValue | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 回调函数传入的变化信息，包含状态变量变化的路径（dirty）、变化前后的值（通过value方法获取）等详细信息。具体属性和方法详见IMonitor。  |
