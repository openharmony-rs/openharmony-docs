...
frameNode中[getEvent('List')](FrameNode:typeNode.getEvent(node: FrameNode, nodeType: 'List'))方法的返回值，可用于给List节点设置
滚动事件。

UIListEvent继承于[UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)。

**继承/实现关系：** UIListEvent extends [UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)
