...
> [backgroundColor](arkts-arkui-commonmethod-c.md#backgroundColor-1)、背景模糊
> [backgroundBlurStyle](arkts-arkui-commonmethod-c.md#backgroundBlurStyle-1)
> 、[尺寸设置](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md#common)等属性，通过属性绑定的状态变量来实现动态刷新的效果。
>
...
> [createPanel](@ohos.inputMethodEngine:inputMethodEngine.InputMethodAbility.createPanel(ctx: BaseContext, info: PanelInfo))
> 。
