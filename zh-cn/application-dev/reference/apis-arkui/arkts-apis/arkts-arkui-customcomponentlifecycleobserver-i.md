...
其功能与[aboutToAppear](arkts-arkui-basecustomcomponent-c.md#aboutToAppear-1)类似，但是在自定义组件状态机的约束下触发的。
...
其功能与[aboutToDisappear](arkts-arkui-basecustomcomponent-c.md#aboutToDisappear-1)类似，不同的是，
