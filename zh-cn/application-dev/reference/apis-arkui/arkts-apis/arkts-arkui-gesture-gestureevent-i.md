...
定义手势的事件信息。继承自[BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md)。

**继承/实现关系：** GestureEvent extends [BaseEvent](../arkts-components/arkts-arkui-common-baseevent-i.md)
