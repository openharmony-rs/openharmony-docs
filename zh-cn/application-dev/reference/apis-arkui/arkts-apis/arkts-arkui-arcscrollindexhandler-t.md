...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | int | 是 | ArcList显示区域内第一个子组件的索引值。 \_\_\_HTML\_TAG\_USD\_0\_\_\_取值限定为整数。  |
| end | int | 是 | ArcList显示区域内最后一个子组件的索引值。 \_\_\_HTML\_TAG\_USD\_0\_\_\_取值限定为整数。  |
| center | int | 是 | ArcList显示区域内中间位置子组件的索引值。 \_\_\_HTML\_TAG\_USD\_0\_\_\_取值限定为整数。  |
