...
当对象是V1对象时，值是对象关联的装饰器名称。 当V1对象使用\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时，值为：'@Track'。 当V2对象使用\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_时，值为：'@Trace'。 当V2对象使用[makeObserved]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_时，值为：'MakeObserved'。 当V2对象使用[enableV2Compatibility]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_时，值为：'EnableV2Compatible'。 当V2对象使用built-in类型数据时，值为：'ProxyObservedV2'。
...
V1对象返回被使用的组件id。 **当V1对象有属性使用\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_装饰器时，无组件id，返回-1；V2对象同样无组件id，返回-1。**
...
V1对象返回被使用的组件名称。 V1对象有属性使用\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_装饰器时返回对象名称。 V2对象返回对象名称。
