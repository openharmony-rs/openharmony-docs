...
继承自[AlertDialogParam](arkts-arkui-alert-dialog-alertdialogparam-i.md#AlertDialogParam)。

**继承/实现关系：** AlertDialogParamWithButtons extends [AlertDialogParam](arkts-arkui-alert-dialog-alertdialogparam-i.md#AlertDialogParam)
