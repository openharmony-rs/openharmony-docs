...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | ArcSliderOptions的构造信息。不传入时，ArcSliderOptions的各项子属性均取其默认值。 |
...
配置弧形Slider的样式信息。 默认值：[ArcSliderStyleOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_的各项子属性均取其默认值。
