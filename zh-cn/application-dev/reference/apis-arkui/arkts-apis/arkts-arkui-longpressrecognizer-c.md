...
长按手势识别器对象，继承于[GestureRecognizer](arkts-arkui-tapgesture-gesturerecognizer-c.md#GestureRecognizer)。

**继承/实现关系：** LongPressRecognizer extends [GestureRecognizer](arkts-arkui-tapgesture-gesturerecognizer-c.md#GestureRecognizer)
