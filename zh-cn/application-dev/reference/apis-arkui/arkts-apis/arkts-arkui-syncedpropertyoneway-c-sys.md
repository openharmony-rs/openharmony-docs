...
继承自[SubscribedAbstractProperty<T>](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md#SubscribedAbstractProperty)。用来定义父组件的状态值。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | SubscribedAbstractProperty&lt;T&gt; | 是 | 单向同步属性的数据源。 |
