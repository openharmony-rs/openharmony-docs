...
UIGridEvent继承于[UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)。

**继承/实现关系：** UIGridEvent extends [UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)
