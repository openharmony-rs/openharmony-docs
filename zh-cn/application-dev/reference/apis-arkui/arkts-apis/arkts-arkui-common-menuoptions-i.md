...
菜单项的信息，继承自[ContextMenuOptions](arkts-arkui-common-contextmenuoptions-i.md#ContextMenuOptions)。
...
仅在content设置为Array<[MenuElement](arkts-arkui-common-menuelement-i.md#MenuElement)> 时生效。
