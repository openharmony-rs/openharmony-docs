...
| 类型 | 说明 |
| --- | --- |
| PositionWithAffinity | Character position. Returns **undefined** when<br/>[LayoutManager](arkts-arkui-text-common-layoutmanager-i.md#LayoutManager) is not bound to a component. |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;TextRange&gt; | Contains two elements: the first is the character range, and the second<br/>is the actual glyph range. When the returned range is invalid, the element in the range is **-1**. Returns<br/>**undefined** when [LayoutManager](arkts-arkui-text-common-layoutmanager-i.md#LayoutManager) is not bound to a component. |
...
| 类型 | 说明 |
| --- | --- |
| Array&lt;TextRange&gt; | Contains two elements: the first is the glyph range, and the second is<br/>the actual character range. When the returned range is invalid, the element in the range is **-1**. Returns<br/>**undefined** when [LayoutManager](arkts-arkui-text-common-layoutmanager-i.md#LayoutManager) is not bound to a component. |
