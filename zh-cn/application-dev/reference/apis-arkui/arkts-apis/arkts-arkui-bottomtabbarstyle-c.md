...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Padding \| Dimension \| LocalizedPadding | 是 | �ײ�ҳǩ���ڱ߾ࡣ<br/>ȡֵ��Χ��[0, +��]<br/>Ĭ��ֵ��{left:4.0vp,right:4.0vp,top:0.0vp,bottom:<br/>0.0vp}<br/>ʹ��LocalizedPaddingʱ��֧�־���������<br/>Ĭ��ֵ��{start:LengthMetrics.vp(4),end:LengthMetrics.vp(4),<br/>top:<br/>LengthMetrics.vp(0),bottom:LengthMetrics.vp(0)} [since 10 - 11] |
