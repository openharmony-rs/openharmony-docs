...
| 类型 | 说明 |
| --- | --- |
| TextAttribute | Attributes of the **Text** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ColumnAttribute | Attributes of the **Column** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| StackAttribute | Attributes of the **Stack** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| SwiperAttribute | Properties of the **Swiper** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ProgressAttribute | Properties of the **Progress** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ScrollAttribute | Attributes of the **Scroll** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| RelativeContainerAttribute | Attributes of the **RelativeContainer** node, or **undefined**<br/>if they fail to be obtained. |
...
获取[LoadingProgress](arkts-arkui-loadingprogress.md)节点的属性。若该节点非ArkTS语言创建，则需要设置是否支持跨语言访问，如果不支持跨语言访问，则返回undefined。该接口不支持声明式方式创
建的节点。
...
| 类型 | 说明 |
| --- | --- |
| LoadingProgressAttribute | Properties of the **LoadingProgress** node, or **undefined** if<br/>they fail to be obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ImageAttribute | Properties of the **Image** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ListAttribute | Attributes of the **List** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ListItemAttribute | Attributes of the **ListItem** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| TextInputAttribute | Properties of the **TextInput** node, or **undefined** if they fail to<br/>be obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ButtonAttribute | Attributes of the **Button** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ListItemGroupAttribute | Attributes of the **ListItemGroup** node, or **undefined** if they<br/>fail to be obtained. |
...
| 类型 | 说明 |
| --- | --- |
| WaterFlowAttribute | Properties of the **WaterFlow** node, or **undefined** if they fail to<br/>be obtained. |
...
| 类型 | 说明 |
| --- | --- |
| FlowItemAttribute | Properties of the **FlowItem** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| XComponentAttribute | Properties of the **XComponent** node, or **undefined** if they fail<br/>to be obtained. |
...
| 类型 | 说明 |
| --- | --- |
| CheckboxAttribute | Attributes of the **Checkbox** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| RadioAttribute | Properties of the **Radio** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| SliderAttribute | Properties of the **Slider** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| ToggleAttribute | Properties of the **Toggle** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| TextAreaAttribute | Properties of the **TextArea** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| GridAttribute | Properties of the **Grid** node, or **undefined** if they fail to be<br/>obtained. |
...
| 类型 | 说明 |
| --- | --- |
| GridItemAttribute | Properties of the **GridItem** node, or **undefined** if they fail to be<br/>obtained. |
