...
WindowExtensionContext模块是WindowExtensionAbility的上下文环境，继承自[ExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。 WindowExtensionContext模块提供[WindowExtensionAbility]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_具有的能力，包括启动 Ability。 > **说明：** > > - 从API version 21开始废弃，推荐使用[UIExtensionContext]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_。 > > - 本模块接口为系统接口。 > > - 本模块接口仅可在Stage模型下使用。
...
启动Ability，使用callback异步回调。 > **说明：** > > - 从API version 9开始支持，从API version 21开始废弃，推荐使用 > [UIExtensionContext.startability]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > 。
...
启动Ability，使用Promise异步回调。 > **说明：** > > - 从API version 9开始支持，从API version 21开始废弃，推荐使用 > [UIExtensionContext.startability]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ > 。
