...
当文本类组件已经显示在子窗类型的[Popup](arkts-arkui-advanced-popup.md)、[Dialog](arkts-arkui-advanced-dialog.md)、[Toast](../../../ui/arkts-create-toast.md)、Menu中时，不支持将其对应的文本选择菜单显示在独立窗口中。
