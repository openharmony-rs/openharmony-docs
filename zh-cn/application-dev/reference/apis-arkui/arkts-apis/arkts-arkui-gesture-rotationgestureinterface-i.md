...
继承自[GestureInterface<T>](arkts-arkui-gesture-gestureinterface-i.md)，设置旋转手势事件。
...
Rotation手势识别成功，接收到触摸取消事件触发的回调。与[onActionCancel](arkts-arkui-gesture-rotationgestureinterface-i.md#onactioncancel-1)相比，该回调返回手势事件信息。
