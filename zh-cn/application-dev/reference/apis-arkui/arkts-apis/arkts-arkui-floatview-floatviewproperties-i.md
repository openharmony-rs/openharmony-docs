...
标准悬浮窗内容的避让区域。 **注意：** 通过[setUIContext()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_或 [setUIContextByName()]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_加载的页面中，位于避让区域的组件将不响应手势事件，添加需要手势响应事件 的组件时，请注意避让这些区域。
