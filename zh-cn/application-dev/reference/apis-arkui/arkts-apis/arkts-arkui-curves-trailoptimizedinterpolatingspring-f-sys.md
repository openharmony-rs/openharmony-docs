...
| 类型 | 说明 |
| --- | --- |
| [ICurve](arkts-arkui-curves-icurve-i.md) | 曲线对象。<br>**说明：** 弹性动画曲线为物理曲线，animation、animateTo、pageTransition等动画参数中的duration参数不生效，动画持续时间取决于trailOptimizedInterpolatingSpring动画曲线参数。时间不能归一，故不能通过该曲线的[interpolate](arkts-arkui-curves-icurve-i.md#interpolate)函数获得插值。 |
