...
滑动手势处理器配置参数。继承自[BaseHandlerOptions](arkts-arkui-tapgesture-basehandleroptions-i.md#BaseHandlerOptions)。

**继承/实现关系：** PanGestureHandlerOptions extends [BaseHandlerOptions](arkts-arkui-tapgesture-basehandleroptions-i.md#BaseHandlerOptions)
