...
获取当前应用配置文件中声明的信息。在Stage模型下接口返回值为null。 从API version9开始，推荐使用 [bundleManager.getBundleInfoForSelf]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | Transition time from non-full window to full window, in milliseconds. |
...
退出当前Ability。在Stage模型下接口功能不生效。 从API version 7开始，推荐使用[\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_。
