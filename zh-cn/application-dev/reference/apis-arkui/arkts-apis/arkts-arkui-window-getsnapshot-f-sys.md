...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 窗口Id。可通过[getWindowProperties](@link @ohos.window:window.Window.getWindowProperties)<br/>接口获取到相关窗口属性，其中属性id即对应为窗口ID。 |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: Internal task error. |
