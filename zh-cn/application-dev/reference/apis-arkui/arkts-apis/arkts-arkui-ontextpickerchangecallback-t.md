...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectItem | string \| string[] | 是 | 当前选中项的文本。多列数据选择器的selectItem为数组类型。\_\_\_HTML\_TAG\_USD\_0\_\_\_**说明：**\_\_\_HTML\_TAG\_USD\_1\_\_\_ 当选择器内容为文本或图文混排时，selectItem值为选中项中的文本值；当选择器内容为图片时，selectItem值为空。  |
