...
Search组件的控制器继承自[TextContentControllerBase](arkts-arkui-common-textcontentcontrollerbase-c.md#TextContentControllerBase)，涉及的接口有
...
**继承/实现关系：** SearchController extends [TextContentControllerBase](arkts-arkui-common-textcontentcontrollerbase-c.md#TextContentControllerBase)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectionStart | number | 是 | 文本选择区域起始位置，文本框中文字的起始位置为0。<br/>当selectionStart小于0时、按照0处理；当selectionStart大于文字最大长度时<br/>、按照文字最大长度处理。 |
