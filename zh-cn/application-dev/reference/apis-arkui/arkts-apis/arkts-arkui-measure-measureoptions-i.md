...
设置断行规则。 默认值：WordBreak.BREAK\_WORD **说明：** WordBreak.BREAK\_ALL与{overflow: TextOverflow.Ellipsis}，\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_组合使用可实现英文单词按字母截断，超出部分以省略号显示。
