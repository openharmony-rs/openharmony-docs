...
构造数字指示器的样式，继承自[Indicator](arkts-arkui-swiper-indicator-c.md#Indicator)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | Font | 是 | 设置Swiper组件数字导航点的字体样式。<br/>只支持Font中size和weight参数，family和style设置不生效。<br/>默认值：<br/>{ size: 14,<br/> weight: FontWeight.Normal } |
