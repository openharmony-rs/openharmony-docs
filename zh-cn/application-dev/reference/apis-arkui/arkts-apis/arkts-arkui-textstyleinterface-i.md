...
字体大小。 默认字体大小为16fp。 如果LengthMetrics的unit值是PERCENT，当前设置不生效，处理为16fp。 单位：\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_
...
文本描边拐角样式。具体枚举及说明请参考StrokeJoinStyle。 默认值：StrokeJoinStyle.MITER\_JOIN。
