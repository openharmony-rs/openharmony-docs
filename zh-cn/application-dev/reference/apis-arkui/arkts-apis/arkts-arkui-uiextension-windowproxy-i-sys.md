...
| [1300002](../../errorcode-universal.md#1300002-Abnormal) | Abnormal state. Possible causes:<br/>1. Permission denied. Interface caller does not have permission "ohos.permission.ALLOW_SHOW_NON_SECURE_WINDOWS".<br/>2. The UIExtension window proxy is abnormal. |
