...
UIWaterFlowEvent继承于[UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)。

**继承/实现关系：** UIWaterFlowEvent extends [UIScrollableCommonEvent](arkts-arkui-common-uiscrollablecommonevent-i.md#UIScrollableCommonEvent)
