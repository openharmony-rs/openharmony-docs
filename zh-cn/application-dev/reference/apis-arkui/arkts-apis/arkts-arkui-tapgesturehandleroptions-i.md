...
点击手势处理器配置参数。继承自[BaseHandlerOptions](arkts-arkui-tapgesture-basehandleroptions-i.md#BaseHandlerOptions)。

**继承/实现关系：** TapGestureHandlerOptions extends [BaseHandlerOptions](arkts-arkui-tapgesture-basehandleroptions-i.md#BaseHandlerOptions)
