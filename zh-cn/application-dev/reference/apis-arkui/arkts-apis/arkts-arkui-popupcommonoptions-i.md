...
配置弹出气泡的参数。使用[UIContext](arkts-arkui-uicontext.md)中的
...
气泡的颜色。如需去除模糊背景填充效果，需将backgroundBlurStyle设置为BlurStyle.NONE。默认值：透明色[TRANSPARENT](arkts-arkui-enums-color-e.md#Color)加模糊背景填充效果
[COMPONENT_ULTRA_THICK](arkts-arkui-common-blurstyle-e.md#BlurStyle)。
