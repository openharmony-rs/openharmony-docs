...
获取属性字符串的文本字体大小。 单位：\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_
...
获取属性字符串的文本描边拐角样式。 默认值：StrokeJoinStyle.MITER\_JOIN。
...
获取属性字符串的文本描边宽度。 默认返回0，单位为\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
