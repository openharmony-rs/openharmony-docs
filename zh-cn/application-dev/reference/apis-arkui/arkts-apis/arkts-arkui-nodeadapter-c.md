...
NodeAdapter提供FrameNode的数据懒加载能力，通过[LazyForEach](arkts-arkui-lazyforeach.md)实现接口功能。
...
重新加载全部数据操作。实际调用了LazyForEach中的[OnDataReloaded](arkts-arkui-datachangelistener-i.md#onDataReloaded-1)接口通知组件重新加载所有数据。
