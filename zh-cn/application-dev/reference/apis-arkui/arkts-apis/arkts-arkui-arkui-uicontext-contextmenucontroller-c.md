...
提供控制菜单关闭的能力。 > **说明：** > > - 本Class首批接口从API version 12开始支持。 > - 以下API需先使用UIContext中的[getContextMenuController()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_方 > 法获取ContextMenuController实例，再通过此实例调用对应方法。
