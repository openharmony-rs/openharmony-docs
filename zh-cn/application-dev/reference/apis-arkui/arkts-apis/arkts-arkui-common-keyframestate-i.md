...
由于[springMotion](arkts-arkui-curves-springmotion-f.md#springMotion-1)、
[responsiveSpringMotion](arkts-arkui-curves-responsivespringmotion-f.md#responsiveSpringMotion-1)、
[interpolatingSpring](arkts-arkui-curves-interpolatingspring-f.md#interpolatingSpring-1)曲线时长不生效，故不支持这三种曲线。
