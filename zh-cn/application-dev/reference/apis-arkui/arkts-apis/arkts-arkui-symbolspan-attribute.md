...
不支持[通用属性](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md#common)，支持以下属性：

不支持[通用事件](../../apis-ability-kit/arkts-apis/arkts-app-ability-common.md#common)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number \| string \| Resource | 是 | SymbolSpan组件大小。<br/>默认值：16fp<br/>单位：<br/>[fp](../../../../reference/apis-arkui/arkui-ts/ts-pixel-units.md#基本像素单位) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number \| FontWeight \| ResourceStr | 是 | SymbolSpan组件图标小符号的粗细。<br/>number类型取值[100, 900]，取值间隔为100，默认为40<br/>0，取值越大，字体越粗。<br/>ResourceStr类型仅支持number类型取值的字符串形式，例如“400"，以及“bold”、“bolder”、“lighter”、“regular”、“medium”分别对应<br/>FontWeight中相应的枚举值。<br/>默认值：FontWeight.Normal |
