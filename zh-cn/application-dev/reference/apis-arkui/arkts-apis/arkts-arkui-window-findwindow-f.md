...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| name | string | 是 | 窗口名称。查找子窗口或系统窗口时使用[Configuration](arkts-arkui-window-configuration-i.md)中的窗口名称；查找主窗口时使用[getWindowName](arkts-arkui-arkui-uicontext-uicontext-c.md#getwindowname)获取当前实例的窗口名称。 |
