...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childDefaultSize | number | 是 | default main size, in vp. If the main axis is vertical, it indicates height.<br/>If the main axis is horizontal, it indicates width. |
