...
[findWindow()](arkts-arkui-window-findwindow-f.md#findWindow-1)中的任一方法获取到Window实例（windowClass），再通过此实例调用对应方法。
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed.<br/>2. Internal task error.<br/>3. The window has not set window mask yet. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only subwindows and float windows are supported. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| winX | number | 是 | 表示以当前窗口左上角为原点的x轴方向偏移量，单位为px。值为正表示在原点右侧，<br/>值为负表示在原点左侧。该参数应为整数，非整数输入将向下取整。 |
| winY | number | 是 | 表示以当前窗口左上角为原点的y轴方向偏移量，单位为px。值为正表示在原点下方，<br/>值为负表示在原点上方。该参数应为整数，非整数输入将向下取整。 |
...
| [1300010](../../errorcode-universal.md#1300010-The) | The operation in the current window status is invalid. |
...
| value | number | 是 | 待转换的值。该参数为整数，浮点数输入将向下取整，取值范围为[0, 3]，范围外为非法参数（抛出错误码<br/>[401](../../../../reference/errorcode-universal.md#401-参数检查失败)）。 |
...
| options | SubWindowOptions | 是 | 子窗口参数。decorEnabled为true时，子窗口为非<br/>[沉浸式布局](../../../../windowmanager/window-terminology.md#沉浸式布局)；decorEnabled为false时，子窗口为沉浸式布局。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: Incorrect parameter types. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Internal task error;<br/>3. The subWindow has been created and can not be created again.<br/>4. It is not allowed to create non-secure window when secure extension exists. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>1. Invalid window type. Only main windows, subwindows, and floating windows are supported.<br/>2. When SubWindowOptions.zLevelAboveParentLoosened is true, only main windows are supported. |
...
> **说明：**
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用[destroyWindow()](arkts-arkui-window-window-i.md#destroyWindow-2)替代。

**起始版本：** 7

**废弃版本：** 9

**替代接口：** [destroyWindow()](arkts-arkui-window-window-i.md#destroyWindow-2)
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.&lt;br&gt;**适用版本：** 9 - 9 |
...
- 仅在调用[setSystemAvoidAreaEnabled](arkts-arkui-window-window-i.md#setSystemAvoidAreaEnabled-1)方法使能后，才能通过此接口获取计算后的避让区域，否则获取的避让区域
为空。
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed.<br/>2. Failed to convert result into JS value object. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
...
返回值与[setImmersiveModeEnabledState()](arkts-arkui-window-window-i.md#setImmersiveModeEnabledState-1)以及
[setWindowLayoutFullScreen()](arkts-arkui-window-window-i.md#setWindowLayoutFullScreen-2)设置结果一致，若
未调用上述两个接口则默认返回false。
...
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows and subwindows are supported. |
...
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows are supported. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function setSubWindowZLevel can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Convert avoid area failed. |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Convert avoid area failed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter error. |
...
该接口用于获取子窗或悬浮窗的圆角半径值，在未调用[setWindowCornerRadius()](arkts-arkui-window-window-i.md#setWindowCornerRadius-1)接口设置窗口圆角半径值时，调用此接口可获取
窗口默认圆角半径值。
...
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type. Only subwindows and float windows are supported. |
...
或[setUIContent()](arkts-arkui-window-window-i.md#setUIContent-1)调用生效后使用。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the api due to limited device<br/>capabilities. Possible cause: The device does not support the api itself. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed; |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.<br/>Possible cause: The internal services of the window are not started normally. |
...
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.<br/>Possible cause: Create js object failed. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows are supported. |
...
| 类型 | 说明 |
| --- | --- |
| TransitionAnimation | Transition animation configuration in the corresponding scene. If<br/>the [setWindowTransitionAnimation](arkts-arkui-window-window-i.md#setWindowTransitionAnimation-1) API is not used,<br/>undefined is returned. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| globalDisplayX | number | 是 | 表示以当前窗口左上角为原点的x轴方向偏移量，单位为px。值为正表示在原点右侧，<br/>值为负表示在原点左侧。该参数应为整数，非整数输入将向下取整。 |
| globalDisplayY | number | 是 | 表示以当前窗口左上角为原点的y轴方向偏移量，单位为px。<br/>值为正表示在原点下方，值为负表示在原点上方。该参数应为整数，非整数输入将向下取整。 |
...
| 类型 | 说明 |
| --- | --- |
| boolean | 是否支持获取三键导航类型的避让区域。<br/><br/>true表示支持，false表示不支持。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Create js value failed. |
...
可使用[on('windowEvent')](arkts-arkui-window-window-i.md#on-22)监听对应状态变更，
再执行对应具体业务。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>The window is not created or destroyed. |
...
获取当前窗口是否能接收[拖拽事件](arkts-arkui-common-dragevent-i.md#DragEvent)的状态。
...
>
> 从API version 8开始支持，从API version 9开始废弃，建议使用
> [isWindowSupportWideGamut()](arkts-arkui-window-window-i.md#isWindowSupportWideGamut-2)替代。
...
| 类型 | 说明 |
| --- | --- |
| boolean | 是否可以获取窗口内容的避让区。<br/><br/>true表示可以获取避让区；false表示不可以获取避让区。 |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Create js value failed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. |
...
可使用
[on('windowHighlightChange')](arkts-arkui-window-window-i.md#on-27)
监听对应状态变更，再执行对应具体业务。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause:<br/>1. Mandatory parameters are left unspecified;<br/>2. Incorrect parameter types;<br/>3. Invalid path parameter. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.&lt;br&gt;**适用版本：** 9 - 9 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | string | 是 | 要加载到窗口中的页面内容的路径，Stage模型下该路径需添加到工程的main_pages.json文件中，FA模型下该路径需添加到工程的config.json文件中。不支持相对<br/>路径写法，需与main_pages.json或config.json中的src取值保持一致。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
> **说明：**
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用[setUIContent()](arkts-arkui-window-window-i.md#setUIContent-2)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| presentation | MaximizePresentation | 否 | 主窗口或子窗口最大化时的布局枚举。<br/>默认值window.MaximizePresentation.ENTER_IMMERSIVE，即默认最大化时进入全屏模式。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Function maximize can not work correctly due to limited<br/>device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows and maximizable subwindows are supported. |
| [1300005](../../errorcode-universal.md#1300005-This) | This window stage is abnormal.&lt;br&gt;**适用版本：** 12 - 19 |
...
| --- | --- | --- | --- |
| presentation | MaximizePresentation | 否 | 主窗口或子窗口最大化时的布局枚举。<br/>默认值window.MaximizePresentation.ENTER_IMMERSIVE，即默认最大化时进入全屏模式。 |
| acrossDisplay | boolean | 否 | 控制悬停态下主窗口在最大化时的瀑布流模式行为。默认值为`undefined`。<br/><br/>仅主窗口可设置此参数，非主窗口调用时返回错误码`1300004`。<br/>取值为`true`时：<br/><br/>- 悬停态下，窗口将直接进入瀑布流模式；<br/>- 展开态下，窗口进入最大化，并在悬停态下保持瀑布流模式。<br/><br/>取值为`false`时：<br/>- 悬停态下，窗口将退出瀑布流模式，进入单面最大化（即窗口最大化时只在上半屏或下半屏显示）；<br/><br/>- 展开态下，窗口进入最大化，并在悬停态下退出瀑布流模式。<br/>取值为`undefined`时，不修改窗口瀑布流模式行为：<br/><br/>- 悬停态下，窗口进入单面最大化；<br/>- 展开态下，窗口进入最大化，并在悬停态下默认保持瀑布流模式。<br/><br/>**设备行为差异：** 仅在具备折叠功能的2in1设备可正常调用；在其他设备上调用不生效。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function maximize can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows and maximizable subwindows are supported. |
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>1. Invalid window type. Only main windows and maximizable subwindows are supported;<br/>2. The acrossDisplay parameter only supports main windows. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter error. Possible cause: Invalid parameter range. |
...
[showWindow()](arkts-arkui-window-window-i.md#showWindow-1)进行还原。
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Internal task error;<br/>3. Invalid window type. Only main windows, subwindows, and float windows are supported. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [moveWindowTo()](arkts-arkui-window-window-i.md#moveWindowTo-2)替代。
...
[moveWindowToAsync()](arkts-arkui-window-window-i.md#moveWindowToAsync-1)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 窗口在x轴方向移动到的坐标位置，单位为px，值为正表示在原点右侧，值为负表示在原点左侧。<br/>该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | number | 是 | 窗口在y轴方向移动到的坐标位置，单位为px，值为正表示在原点下方，值为负表示在原点上方。<br/>该参数仅支持整数输入，浮点数输入将向下取整。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
移动窗口位置，使用Promise异步回调。调用生效后返回，回调中可使用[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)（见示例）立即获取最终生效结
果。

该接口仅在窗口为自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING，窗口模式可通过
[getWindowStatus()](arkts-arkui-window-window-i.md#getWindowStatus-1)获取）时调用生效，在其他窗口模式下调用返回错误码1300010错误码。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 窗口在x轴方向移动到的坐标位置，单位为px，值为正表示位置在x轴右侧；值为负表示位置在x轴左侧；<br/>值为0表示位置在x轴坐标原点。该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | number | 是 | 窗口在y轴方向移动到的坐标位置，单位为px，值为正表示位置在y轴下侧；值为负表示位置在y轴上侧；<br/>值为0表示位置在y轴坐标原点。该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed.<br/>2. The window type is not supported for this operation. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300010](../../errorcode-universal.md#1300010-The) | The operation in the current window status is invalid.<br/>Possible cause: The window status is not FLOATING. |
...
[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)（见示例）立即获取最终生效结果。
...
基于屏幕坐标移动窗口位置，使用Promise异步回调。调用生效后返回，回调中可使用[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)（见示例）立即获
取最终生效结果。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 表示以屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。<br/>该参数仅支持整数输入，浮点数输入将向下取整。 |
| y | number | 是 | 表示以屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。<br/>该参数仅支持整数输入，浮点数输入将向下取整。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 表示以目标屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。<br/>该参数应该为整数，非整数输入将向下取整。 |
| y | number | 是 | 表示以目标屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。<br/>该参数应该为整数，非整数输入将向下取整。 |
| moveConfiguration | MoveConfiguration | 否 | 窗口移动选项，未设置将默认保持为当前屏幕。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| x | number | 是 | 表示以主屏幕左上角为起点，窗口在x轴方向移动的值，单位为px。值为正表示右移，值为负表示左移。<br/>该参数应该为整数，非整数输入将向下取整。 |
| y | number | 是 | 表示以主屏幕左上角为起点，窗口在y轴方向移动的值，单位为px。值为正表示下移，值为负表示上移。<br/>该参数应该为整数，非整数输入将向下取整。 |
...
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| void&gt; | 否 | 回调函数。如果传入参数，则关闭该监<br/>听。如果未传入参数，则关闭该窗口的所有监听。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| eventType | 'uiExtensionSecureLimitChange' | 是 | 监听事件，固定为'uiExtensionSecureLimitChange'，即窗口内uiExtension安全限制变<br/>化事件。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function off('uiExtensionSecureLimitChange') can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
...
| callback | Callback&lt;Size&gt; | 否 | 回调函数。返回当前的窗口尺寸。如果传入参数，则关闭该监听。<br/>如果未传入参数，则关闭窗口尺寸变化的监听。 |
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [off('avoidAreaChange')](arkts-arkui-window-window-i.md#off-7)
> 替代。
...
| callback | Callback&lt;AvoidAreaOptions&gt; | 否 | 回调函数。返回当前避让区以及避让区类型。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有系统避让区变化的监听<br/>。 [since 20] |
...
[输入法服务](@ohos.inputMethodEngine:inputMethodEngine.Panel.changeFlag)。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Function keyboardWillShow can not work correctly due to<br/>limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function keyboardDidShow can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function keyboardWillHide can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Function keyboardDidHide can not work correctly due to<br/>limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
| callback | Callback&lt;boolean&gt; | 否 | 回调函数。当本窗口可见状态发生变化时的回调。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有本窗口可见状态变化事件的回调<br/>。 [since 12] |
...
| callback | Callback&lt;number&gt; | 否 | 回调函数。当本窗口所处屏幕的系统显示大小缩放系数发生变化后的回调。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有本窗口所处屏幕的系统显示<br/>大小缩放系数变化事件的回调。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause:<br/>1. Incorrect parameter types;<br/>2. Parameter verification failed. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
| callback | Callback&lt;WindowStatusType&gt; | 否 | 回调函数。返回当前的窗口模式。如果传入参数，则关闭该监听。<br/>如果未传入参数，则关闭所有窗口模式变化的监听。 |
...
| callback | Callback&lt;void&gt; | 否 | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean<br/>类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有子窗口关闭的监听。 |
...
| callback | Callback&lt;void, Promise&lt;boolean&gt;&gt; | 否 | 回调函数。当点击窗口系统提供的右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑需要有<br/>Promise类型的返回值。在返回的Promise函数里，执行resolve(true) 方法表示不关闭当前窗口，执行resolve(false) 方法或者reject方法均表示关闭当前窗口。 |
...
| callback | Callback&lt;TitleButtonRect&gt; | 否 | 回调函数。返回当前标题栏上的最小化、最大化、关闭按钮矩形区域。如果传入参数，则关闭该监听。如果未传入参数，则关闭所有标题栏上的最小<br/>化、最大化、关闭按钮矩形区域变化的监听。 |
...
| callback | Callback&lt;RectChangeOptions&gt; | 否 | 回调函数。返回当前的窗口矩形及变化原因。<br/>如果传入参数，则关闭该监听。如果未传入参数，则关闭所有窗口矩形变化的监听。 |
...
| callback | Callback&lt;RectChangeOptions&gt; | 否 | 回调函数。返回当前的窗口矩形及变化原因。<br/>如果传入参数，则关闭该监听。如果未传入参数，则关闭所有全局坐标系下窗口矩形变化的监听。 |
...
| --- | --- | --- | --- |
| type | 'rotationChange' | 是 | 监听事件，固定为'rotationChange'，即窗口旋转变化事件。 |
| callback | RotationChangeCallback&lt;RotationChangeInfo, RotationChangeResult \| void&gt; | 是 | 回调函数。返回窗口旋转信息<br/>[RotationChangeInfo](arkts-arkui-window-rotationchangeinfo-i.md#RotationChangeInfo)，应用返回当前窗口变化结果<br/>[RotationChangeResult](arkts-arkui-window-rotationchangeresult-i.md#RotationChangeResult)。 |
...
| --- | --- | --- | --- |
| eventType | 'uiExtensionSecureLimitChange' | 是 | 监听事件，固定为'uiExtensionSecureLimitChange'，即窗口内uiExtension安全限制变<br/>化事件。 |
| callback | Callback&lt;boolean&gt; | 是 | 回调函数。当窗口内uiExtension安全限制变化时触发回调。当返回参数为true表示窗口内uiExtension开启了隐藏不安全窗口；当返回参<br/>数为false表示窗口内uiExtension关闭了隐藏不安全窗口。若窗口内存在多个uiExtension，当返回参数为true表示窗口内至少一个uiExtension开启了隐藏不安全窗口；当返回参数为false表示窗<br/>口内所有uiExtension关闭了隐藏不安全窗口。 |

**错误码：**

| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function on('uiExtensionSecureLimitChange') can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
...
、
[displaySync.on('frame')](@ohos.graphics.displaySync:displaySync.DisplaySync.on(type: 'frame', callback: Callback<IntervalInfo>))
...
| --- | --- | --- | --- |
| type | 'frameMetricsMeasured' | 是 | 监听事件类型，固定为'frameMetricsMeasured'，即窗口帧率指标变化事件。 |
| callback | Callback&lt;FrameMetrics&gt; | 是 | 窗口帧率指标变化时的回调函数。详情见帧率指标<br/>[FrameMetrics](arkts-arkui-window-framemetrics-i.md#FrameMetrics)。 |
...
- 非主窗口的阴影区域（可分别通过[setWindowShadowEnabled](arkts-arkui-window-window-i.md#setWindowShadowEnabled-1)和
[setWindowShadowRadius](arkts-arkui-window-window-i.md#setWindowShadowRadius-1)设置是否显示阴影以及对应的阴影半径）被挡住也算遮挡，此时肉眼所见虽是
完全可见，但实际返回的是部分可见。
...
| --- | --- | --- | --- |
| type | 'occlusionStateChanged' | 是 | 监听事件，固定为'occlusionStateChanged'，即窗口可见性变化事件。 |
| callback | Callback&lt;OcclusionState&gt; | 是 | 窗口可见性变化时的回调函数。详情见[可见性状态](arkts-arkui-window-occlusionstate-e.md#OcclusionState)<br/>。 |
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [on('avoidAreaChange')](arkts-arkui-window-window-i.md#on-7)替
> 代。
...
- 仅在调用[setSystemAvoidAreaEnabled](arkts-arkui-window-window-i.md#setSystemAvoidAreaEnabled-1)方法使能后，触发回调时才能返回计算后的避让区域，否则直接返回空的避
让区域。
...
改变软键盘为固定态或者悬浮态方法详细介绍请参见[输入法服务](@ohos.inputMethodEngine:inputMethodEngine.Panel.changeFlag)。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Function keyboardDidShow can not work correctly due to<br/>limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
...
[on('windowStatusDidChange')](arkts-arkui-window-window-i.md#on-24)
）。
...
[on('windowWillClose')](arkts-arkui-window-window-i.md#on-26)
方法。
...
| --- | --- | --- | --- |
| type | 'subWindowClose' | 是 | 监听事件，固定为'subWindowClose'，即子窗口关闭事件。 |
| callback | Callback&lt;void&gt; | 是 | 回调函数。当点击子窗口右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑的返回值决定当前子窗是否继续关闭，如果返回boolean<br/>类型的true表示不关闭子窗，返回false或者其他非boolean类型表示关闭子窗。 |
...
[on('subWindowClose')](arkts-arkui-window-window-i.md#on-25)方法。主窗口的同步关闭事件监听参考
...
| --- | --- | --- | --- |
| type | 'windowWillClose' | 是 | 监听事件，固定为'windowWillClose'，即窗口关闭事件。 |
| callback | Callback&lt;void, Promise&lt;boolean&gt;&gt; | 是 | 回调函数。当点击窗口系统提供的右上角关闭按钮事件发生时的回调。该回调函数不返回任何参数。回调函数内部逻辑需要有<br/>Promise类型的返回值。在返回的Promise函数里，执行resolve(true) 方法表示不关闭当前窗口，执行resolve(false) 方法或者reject方法均表示关闭当前窗口。 |
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300001](../../errorcode-universal.md#1300001-Repeated) | Repeated operation. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error.<br/>3. The window does not support floating mode. |
...
[getWindowLimits](arkts-arkui-window-window-i.md#getWindowLimits-1)接口进行查询。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | number | 是 | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码<br/>[401](../../../../reference/errorcode-universal.md#401-参数检查失败)）。 |
| height | number | 是 | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，负值为非法参数（抛出错误码<br/>[401](../../../../reference/errorcode-universal.md#401-参数检查失败)）。 |
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [resize()](arkts-arkui-window-window-i.md#resize-2)替代。
...
该接口仅在窗口为自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING，窗口模式可通过
[getWindowStatus()](arkts-arkui-window-window-i.md#getWindowStatus-1)获取）时调用生效，在其他窗口模式下调用返回1300002错误码。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| width | number | 是 | 当前窗口的目标宽度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，<br/>负值为非法参数（抛出错误码401）。 |
| height | number | 是 | 当前窗口的目标高度，单位为px，该参数仅支持整数输入，浮点数输入将向下取整，<br/>负值为非法参数（抛出错误码401）。 |
...
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: 1. Mandatory parameters are left unspecified;<br/>2. Incorrect parameter types;<br/>3. Parameter verification failed. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error;<br/>3. Invalid window status type. Only supports windows in floating window mode. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
...
该接口仅在窗口为自由悬浮窗口模式（即窗口模式为window.WindowStatusType.FLOATING，窗口模式可通过
[getWindowStatus()](arkts-arkui-window-window-i.md#getWindowStatus-1)获取）时调用生效，否则抛出错误码1300010。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: Invalid parameter range. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed.<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300010](../../errorcode-universal.md#1300010-The) | The operation in the current window status is invalid.<br/>Possible cause: The window status is not FLOATING. |
...
[DOWN](arkts-arkui-enums-touchtype-e.md#TouchType)事件后才能调用。使用Promise异步回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| wantParameters | Record&lt;string, Object&gt; | 否 | Want parameters.<br/>Custom want parameter delivered when restoring the main window.<br/>Want parameters are used for UIAbility onNewWant. |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed.<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>1. The window is not float window.<br/>2. The window is not at foreground or has never been clicked.<br/>3. The window cannot find main window. |
| [1300007](../../errorcode-universal.md#1300007-Restore) | Restore parent main window failed. Possible cause:<br/>1. The main window is in PAUSED lifecycle state.<br/>2. The main window is in background during recent. |
...
> **说明：**
>
> - 通过其他接口如[resize](arkts-arkui-window-window-i.md#resize-2)、
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| ratio | number | 是 | 窗口内容布局（不含边框和标题栏等装饰）的宽高比。该参数为浮点数，受窗口最大最小尺寸限制，比例值下限为最小宽度/最大高度，上限为最大宽度/最小高度。窗口最大最小尺寸由<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)和系统限制的交集决定，系统限制优先级高于<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)。ratio的有效范围会随<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)变化而变化。如果先设置了<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)，后设置的ratio与其冲突，会返回错误码；如果先设置了ratio，后设置的<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)与其冲突，窗口的宽高比可能会不跟随设置的宽高比（ratio）。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause:<br/>Invalid parameter range. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows are supported. |
...
>
> 从API version 8开始支持，从API version 9开始废弃，建议使用
> [setWindowColorSpace()](arkts-arkui-window-window-i.md#setWindowColorSpace-2)
> 替代。
...
| --- | --- | --- | --- |
| ratio | number | 是 | 窗口内容布局（不含边框和标题栏等装饰）的宽高比。该参数为浮点数，受窗口最大最小尺寸限制，比例值下限为最小宽度/最大高度，上限为最大宽度/最小高度。窗口最大最小尺寸由<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)和系统限制的交集决定，系统限制优先级高于<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)。ratio的有效范围会随<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)变化而变化。如果先设置了<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)，后设置的ratio与其冲突，会返回错误码；如果先设置了ratio，后设置的<br/>[WindowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)与其冲突，窗口的宽高比可能会不跟随设置的宽高比（ratio）。 |
| isPersistent | boolean | 否 | 是否持久化保存该比例参数。<br/>如为`true`，比例参数会持久化保存，销毁窗口、关闭应用或重启设备后，当再次切换到自由悬浮窗口模式时仍然生效。可通过<br/>[resetAspectRatio](arkts-arkui-window-window-i.md#resetAspectRatio-2)清除持久化保存的比例参数。<br/>如为`false`，比例参数仅对当前窗口生效，窗口销毁后清除该数据<br/>。<br/>默认值为`true`。 |
| needUpdateRect | boolean | 否 | 是否立即根据当前比例更新窗口大小。<br/>如为`true`，立即根据当前比例更新窗口大小。<br/>如为`false`，窗口将在拖拽缩放时根据当前比<br/>例更新，也可以使用[resize](arkts-arkui-window-window-i.md#resize-2)或<br/>[resizeAsync](arkts-arkui-window-window-i.md#resizeAsync-1)进行主动更新。<br/>默认值为`true`。 |
...
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows are supported. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter error. Possible cause:<br/>1. Invalid parameter range.<br/>2. Invalid parameter length. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 是否响应手势返回事件。<br/>true表示响应手势返回事件，触发onBackPress回调；false表示不响应手势返回事件，不触发onBackPress回调。 |
...
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter error. Possible cause:<br/>1. Invalid parameter range; 2. The parameter format is incorrect. |
...
调用该接口使能后才可以通过[getWindowAvoidArea()](arkts-arkui-window-window-i.md#getWindowAvoidArea-1)获取到
[TYPE_FLOAT_NAVIGATION](arkts-arkui-window-avoidareatype-e.md#AvoidAreaType)避让类型对应的避让区域或通过
[on('avoidAreaChange')](arkts-arkui-window-window-i.md#on-7)监听
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 是否支持获取三键导航类型的避让区域。<br/>true表示支持，false表示不支持。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isFocusable | boolean | 是 | 点击时是否支持切换焦点窗口。true表示支持；false表示不支持。设置为false时，该窗口不支持绑定输入法和接收键盘事件，如需处理输入逻辑，建议参考<br/>[不可获焦窗口中输入框与输入法交互指南](../../../../inputmethod/use-inputmethod-in-not-focusable-window.md)。 |
...
[moveWindowTo()](arkts-arkui-window-window-i.md#moveWindowTo-2)等接口实现子窗口跟随父窗口布局时
，此时子窗口默认不支持跨多个屏幕同时显示。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 设置子窗口在其父窗口处于拖拽移动或拖拽缩放过程时，该子窗口是否支持跨多个屏幕同时显示。<br/>true表示支持；false表示不支持。 |
...
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.Function setFollowParentMultiScreenPolicy can not work<br/>correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
...
该接口调用生效后，
[setRelativePositionToParentWindowEnabled()](arkts-arkui-window-window-i.md#setRelativePositionToParentWindowEnabled-1)接口调用不生效
。
...
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: 1. Mandatory parameters are left unspecified;<br/>2. Incorrect parameter types. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed.<br/>2. Internal task error.<br/>3. The subwindow level is more than one.<br/>4. The subwindow is following its parent window's position. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only subwindows and dialog windows are supported. |
...
> 和[setWindowLayoutFullScreen()](arkts-arkui-window-window-i.md#setWindowLayoutFullScreen-2)替代实现全
> 屏。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | 是否开启沉浸式布局。<br/>true表示开启，false表示关闭。 |
...
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: 1. Mandatory parameters are left unspecified;<br/>2. Incorrect parameter types. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.<br/>Possible cause: Internal IPC error. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only main windows and subwindows are supported. |
...
>
> 从API version 6开始支持，从API version 9开始废弃，建议使用
> [setWindowKeepScreenOn()](arkts-arkui-window-window-i.md#setWindowKeepScreenOn-2)
> 替代。
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [setWindowLayoutFullScreen()](arkts-arkui-window-window-i.md#setWindowLayoutFullScreen-2)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isLayoutFullScreen | boolean | 是 | 窗口的布局是否为沉浸式布局（该沉浸式布局不影响状态栏、三键导航栏显示）。true表示沉浸式布局；<br/>false表示非沉浸式布局。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowId | number | 是 | 父窗口id，该参数应为整数。推荐使用[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)方法获取父<br/>窗口id属性。 |
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type. Only subwindow are supported. |
| [1300009](../../errorcode-universal.md#1300009-The) | The parent window is invalid. Possible cause:<br/>The parent window does not exist or has been destroyed. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: Failed to convert parameter to Orientation. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error. |
...
设置当前窗口是否能接收[拖拽事件](arkts-arkui-common-dragevent-i.md#DragEvent)，使用Promise异步回调。
...
3. 当子窗调用该接口后，再调用[moveWindowTo()](arkts-arkui-window-window-i.md#moveWindowTo-2)、[maximize()](arkts-arkui-window-window-i.md#maximize-1)修改窗口位置或大小的接口将不生效。
...
| anchor | WindowAnchor | 否 | 一级子窗与主窗保持相对位置不变时的窗口锚点枚举。该参数仅在enabled为true时生效，<br/>默认值为window.WindowAnchor.TopStart，即默认锚点为窗口左上角。 |
| offsetX | number | 否 | 一级子窗锚点与主窗锚点位置的x轴偏移量，单位为px。该参数仅在enabled为true时生效，<br/>仅支持整数输入，浮点数向下取整，默认值为0。 |
| offsetY | number | 否 | 一级子窗锚点与主窗锚点位置的y轴偏移量，单位为px。该参数仅在enabled为true时生效，<br/>仅支持整数输入，浮点数向下取整，默认值为0。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function setRelativePositionToParentWindowEnabled can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only subwindows are supported. |
...
| enableAnimation | boolean | 否 | Whether using animation during this setting,<br/>using animation if true or not using animation if false. [since 12] |
...
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally.&lt;br&gt;**适用版本：** 20+ |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
...
[setSubWindowModal<sup>12+</sup>](arkts-arkui-window-window-i.md#setSubWindowModal-1)。
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type. Only non-modal subwindows are supported. |
| [1300009](../../errorcode-universal.md#1300009-The) | The parent window is invalid. |
...
创建全局悬浮窗、模态窗或WindowType窗口类型为系统窗口时，调用该接口使能后才可以通过[getWindowAvoidArea()](arkts-arkui-window-window-i.md#getWindowAvoidArea-1)获取窗口避
让区信息或通过
[on('avoidAreaChange')](arkts-arkui-window-window-i.md#on-7)监听窗
口避让区变化。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| enabled | boolean | 是 | If true, the system window type can obtain avoid area. If false, the avoid area<br/>obtained by the system window type will always be empty. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities.<br/>Possible cause: The device does not support the API itself. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only global floating windows, dialog windows,<br/>or Window Type as system windows are supported. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| names | Array&lt;'status' \| 'navigation'&gt; | 是 | 设置窗口全屏模式时状态栏和三键导航栏是否显示。<br/>例如，需全部显示，该参<br/>数设置为['status','navigation']；设置为[]，则不显示。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
>
> 从API version 6开始支持，从API version 9开始废弃，建议使用
> [setWindowSystemBarProperties()](arkts-arkui-window-window-i.md#setWindowSystemBarProperties-2)
> 替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isTitleHoverShown | boolean | 否 | 是否显示窗口标题栏。<br/>true表示显示窗口标题栏；false表示不显示窗口标题栏。默认值是true。 |
| isDockHoverShown | boolean | 否 | 是否显示dock栏。<br/>true表示显示dock栏；false表示不显示dock栏。默认值是true。 |
...
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用
> [setWindowTouchable()](arkts-arkui-window-window-i.md#setWindowTouchable-2)
> 替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| color | string \| ColorMetrics | 是 | 需要设置的背景色，为十六进制RGB或ARGB颜色，不区分大小写，例如'#00FF00'或'#FF00FF00'。<br/>从API version 18开始，此参数支持ColorMetrics类型。 [since 18] |
...
[loadContent()](arkts-arkui-window-window-i.md#loadContent-1)
或[setUIContent()](arkts-arkui-window-window-i.md#setUIContent-1)后使用。

窗口容器背景色覆盖整个窗口区域，包括标题栏和内容区域。内容区域背景色默认跟随系统深浅色，当同时使用该接口和
[setWindowBackgroundColor()](arkts-arkui-window-window-i.md#setWindowBackgroundColor-1)设置背景色时，内容区域显示窗口背景色，标题栏显示窗口容器背景色。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: The corner radius is less than zero. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. |
...
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.&lt;br&gt;**适用版本：** 11 - 19 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.function setWindowDelayRaiseOnDrag can not work<br/>correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>The window is not created or destroyed. |
...
从API version 22开始，调用[createVirtualScreen](arkts-arkui-display-createvirtualscreen-f.md#createVirtualScreen-1)接口创建虚拟屏，并设置
...
[loadContent()](arkts-arkui-window-window-i.md#loadContent-1)
或[setUIContent()](arkts-arkui-window-window-i.md#setUIContent-1)使窗口加载页面内容后调用。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isLayoutFullScreen | boolean | 是 | 窗口的布局是否为沉浸式布局（该沉浸式布局状态栏、三键导航栏仍然显示）。true表示沉浸式布局；<br/>false表示非沉浸式布局。 |
| callback | AsyncCallback&lt;void&gt; | 是 | 回调函数。 |
...
未调用setWindowLimits配置过WindowLimits时，使用[getWindowLimits](arkts-arkui-window-window-i.md#getWindowLimits-1)或
[getWindowLimitsVP](arkts-arkui-window-window-i.md#getWindowLimitsVP-1)可获取系统限制。
...
> 改变窗口大小（如调用[resize()](arkts-arkui-window-window-i.md#resize-2)）；系统调节窗
...
| --- | --- | --- | --- |
| windowLimits | WindowLimits | 是 | 目标窗口的尺寸限制，单位为px或vp。 |
| isForcible | boolean | 是 | 是否强制设置窗口的尺寸限制。<br/>入参[windowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)的单位为vp时<br/>：无论设置true还是false，都按照false处理，窗口宽高的最小值和最大值都取决于系统限制。<br/>入参[windowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)<br/>的单位为px时：设置为true，表示窗口宽高最小值以系统限制值和40vp两者中的低数值为准，窗口宽高的最大值仍取决于系统限制；设置为false，表示窗口宽高的最小值和最大值都取决于系统限制。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;WindowLimits&gt; | Promise对象。返回设置后的窗口尺寸限制。<br/><br/>入参[windowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)的单位为vp时，返回入参与系统默认窗口尺寸限制的交集。<br/><br/>入参[windowLimits](arkts-arkui-window-windowlimits-i.md#WindowLimits)的单位为px时，isForcible为false则返回入参与系统默认窗口尺寸限制的交集；isForcible为<br/>true则返回入参与[系统限制的最小值与40vp两者中的低数值，系统限制的最大值]的交集。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowMask | Array&lt;Array&lt;number&gt;&gt; | 是 | 异形窗口的掩码，该参数仅支持宽高为窗口宽高、取值为整数0和整数1的二维数组输入，整数0代表所在像素透明，整数1代表所在像素不透明，宽高不符合<br/>的二维数组或二维数组取值不为整数0和整数1的二维数组为非法参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowMask | Uint8Array | 是 | windowMask仅包含每像素alpha透明度值。<br/>有效范围：0（完全透明）到255（完全不透明），大小必须等于(maskWidth*mask Heights) |
| maskWidth | number | 是 | 掩码宽度（以像素为单位）。必须等于目标窗口宽度<br/><br/>取值范围为全体整数。 |
| maskHeight | number | 是 | 以像素为单位的遮罩高度。必须等于目标窗口高度<br/><br/>取值范围为全体整数。 |
...
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Only subwindows and float windows are supported. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter error. Possible cause:<br/>1. The maskWidth is not equal to the window width or the maskHeight is not equal to the window height.<br/>2. The length of windowMask is not equal to maskWidth multiplied by maskHeight. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [201](../../errorcode-universal.md#201-Permission) | Permission verification failed.<br/>The application does not have the permission required to call the API.<br/>Possible cause: Need ohos.permission.PRIVACY_WINDOW permission. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Internal task error. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible cause: The shadow radius is less than zero. |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Failed to call the API due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed;<br/>2. Internal task error. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type. Only subwindows and float windows are supported. |
...
禁止/使能主窗或子窗标题栏默认移动窗口和双击最大化的功能，当禁用标题栏默认移动窗口和双击最大化的功能时，可使用[startMoving()](arkts-arkui-window-window-i.md#startMoving-1)在应用热区中发起
拖拽移动，使用[maximize()](arkts-arkui-window-window-i.md#maximize-1)实现最大化功能。如果使用Stage模型，该接口需要在
[loadContent()](arkts-arkui-window-window-i.md#loadContent-1)
或[setUIContent()](arkts-arkui-window-window-i.md#setUIContent-1)调用生效后使用。
...
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>The window is not created or destroyed. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type. Only main windows are supported. |
...
> **说明：**
>
> 从API version 7开始支持，从API version 9开始废弃，建议使用[showWindow()](arkts-arkui-window-window-i.md#showWindow-2)替代。

**起始版本：** 7

**废弃版本：** 9

**替代接口：** [showWindow()](arkts-arkui-window-window-i.md#showWindow-2)
...
> [setUIContent](arkts-arkui-window-window-i.md#setUIContent-2)方法完成页面加载。如果应用主窗口没有完成页面加载，直接调用该接口，界面会
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Function showWindow can not work correctly due to<br/>limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: The window is not created or destroyed. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation.<br/>Possible cause: Invalid window type. Modal subwindow and dialog window can not set focusOnShow. |
| [1300016](../../errorcode-universal.md#1300016-Parameter) | Parameter validation error. Possible cause: 1. The value of the parameter is<br/>out of the allowed range;<br/>2. The length of the parameter exceeds the allowed length;<br/>3. The parameter format is incorrect. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Get pixelMap failed;<br/>3. Internal task error. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function snapshotIgnorePrivacy can not work correctly due to limited device capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Create pixelMap failed;<br/>3. Internal task error. |
...
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported. Failed to call the API due to limited device<br/>capabilities. |
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal.<br/>Possible cause: 1. The window is not created or destroyed;<br/>2. Create pixelMap failed. |
| [1300018](../../errorcode-universal.md#1300018-Timeout) | Timeout. |
...
在点击拖拽场景下，若不期望在按下时触发拖拽事件，则可以在事件类型为[TouchType.Move](arkts-arkui-enums-touchtype-e.md#TouchType)（需要保证当前行为已经触发
...
| [1300002](../../errorcode-universal.md#1300002-This) | This window state is abnormal. Possible cause:<br/>1. The window is not created or destroyed.<br/>2. Internal task error. |
| [1300003](../../errorcode-universal.md#1300003-This) | This window manager service works abnormally. |
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause:<br/>Invalid window type, main windows are not supported in non-free window mode. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| offsetX | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的x轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口宽度为非法参数，窗口宽度可以在窗口属性<br/>[WindowProperties](arkts-arkui-window-windowproperties-i.md#WindowProperties)中获取。 |
| offsetY | number | 是 | 窗口移动时预期鼠标位置相对窗口左上角的y轴偏移量，单位为px，该参数仅支持整数输入，浮点数向下取整。负值为非法参数，大于窗口高度为非法参数，窗口高度可以在窗口属性<br/>[WindowProperties](arkts-arkui-window-windowproperties-i.md#WindowProperties)中获取。 |
