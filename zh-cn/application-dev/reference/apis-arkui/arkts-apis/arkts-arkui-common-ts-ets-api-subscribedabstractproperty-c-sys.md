...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscribeMe | [IPropertySubscriber](arkts-arkui-common-ts-ets-api-ipropertysubscriber-i-sys.md) | 否 | Variable properties. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| subscribeMe | [IPropertySubscriber](arkts-arkui-common-ts-ets-api-ipropertysubscriber-i-sys.md) | 否 | 变量属性。 |
| info | string | 否 | 变量信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [SyncedPropertyOneWay](arkts-arkui-common-ts-ets-api-syncedpropertyoneway-c-sys.md)<T> | 返回单向同步属性。 |
...
| 类型 | 说明 |
| --- | --- |
| [SyncedPropertyTwoWay](arkts-arkui-common-ts-ets-api-syncedpropertytwoway-c-sys.md)<T> | 返回双向同步属性。 |
