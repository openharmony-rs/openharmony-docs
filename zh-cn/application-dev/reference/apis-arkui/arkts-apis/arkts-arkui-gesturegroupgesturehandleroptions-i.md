...
设置手势组中需要包含的手势集合。 **说明：** 当需要为一个组件同时添加单击和双击手势时，可在[GestureGroup]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中添加两个[TapGesture]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_，需要双击手势在前，单击手势在后，否则不生效。
