...
[PixelMap](@ohos.multimedia.image:image.PixelMap)和
[DrawableDescriptor](arkts-arkui-image-drawabledescriptor-t.md#DrawableDescriptor)类型的图片不包含头信息，调用该接口时图片显示效果不变化。
