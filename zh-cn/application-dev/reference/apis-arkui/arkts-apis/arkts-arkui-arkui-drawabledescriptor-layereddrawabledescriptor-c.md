...
当传入资源id或name为包含前景和背景资源的json文件时，生成LayeredDrawableDescriptor对象。继承自 [DrawableDescriptor]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。 drawable.json位于项目工程entry/src/main/resources/base/media目录下。定义请参考：
...
获取背景的DrawableDescriptor对象。 > **说明：** > > DrawableDescriptor对象通过[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_释放后，本接口返回undefined。
...
获取前景的DrawableDescriptor对象。 > **说明：** > > DrawableDescriptor对象通过[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_释放后，本接口返回undefined。
...
获取蒙版的DrawableDescriptor对象。 > **说明：** > > DrawableDescriptor对象通过[release]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_释放后，本接口返回undefined。
