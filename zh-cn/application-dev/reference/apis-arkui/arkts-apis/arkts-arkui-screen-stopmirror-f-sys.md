...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mirrorScreen | Array&lt;number&gt; | 是 | ������ĻID���ϣ�����IDӦΪ������ mirrorScreen�����С��Ӧ����1000�� |
| callback | AsyncCallback&lt;void&gt; | 是 | �ص���������ֹͣ��Ļ����ģʽ�ɹ���errΪundefined������Ϊ������� |
