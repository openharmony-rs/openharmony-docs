...
1. 仅上边缘生效：[EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).START。
2. 仅下边缘生效：[EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).END。
3. 双边生效：[EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).START | [EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).END（即数值3）。
4. 双边不生效：[EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).START & [EffectEdge](arkts-arkui-common-effectedge-e.md#EffectEdge).END（即数值0）。
...
当用户执行下拉关闭、侧拉关闭、点击遮罩层关闭、点击关闭按钮的交互操作时，若已注册回调函数，则不会立即关闭页面，而是由开发者通过回调函数[DismissSheetAction](arkts-arkui-common-dismisssheetaction-i.md#DismissSheetAction)中的
