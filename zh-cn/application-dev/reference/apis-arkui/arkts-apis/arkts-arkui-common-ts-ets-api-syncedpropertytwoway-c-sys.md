...
继承自[SubscribedAbstractProperty<T>](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md)。用来定义变量状态的值。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| source | [SubscribedAbstractProperty](arkts-arkui-common-ts-ets-api-subscribedabstractproperty-c-sys.md)<T> | 是 | 双向同步属性的数据源。 |
