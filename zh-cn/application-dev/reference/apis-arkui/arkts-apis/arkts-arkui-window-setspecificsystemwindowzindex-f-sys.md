...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| windowType | WindowType | 是 | 窗口类型。仅支持TYPE_WALLET_SWIPE_CARD、TYPE_VOICE_INTERACTION、TYPE_SCREENSHOT、<br/>TYPE_SCREEN_CONTROL、TYPE_FLOAT_NAVIGATION和TYPE_MUTISCREEN_COLLABORATION。 |
...
| [1300004](../../errorcode-universal.md#1300004-Unauthorized) | Unauthorized operation. Possible cause: Invalid window type. |
