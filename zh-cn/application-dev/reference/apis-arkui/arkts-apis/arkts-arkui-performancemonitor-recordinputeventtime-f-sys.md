...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [ActionType](arkts-arkui-performancemonitor-actiontype-e-sys.md) | 是 | 用户场景触发模式。 |
| sourceType | [SourceType](../arkts-components/arkts-arkui-common-comp-sourcetype-e.md) | 是 | 用户场景触发源。 |
