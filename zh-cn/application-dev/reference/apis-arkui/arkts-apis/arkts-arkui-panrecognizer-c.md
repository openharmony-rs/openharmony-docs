...
**继承/实现关系：** PanRecognizer extends [GestureRecognizer](arkts-arkui-tapgesture-gesturerecognizer-c.md#GestureRecognizer)
...
> **说明：**
>
> 仅支持对通过Pan手势初始化配置修改的设备类型进行阈值查询。对于默认滑动阈值，可通过查询[SourceTool](arkts-arkui-common-sourcetool-e.md#SourceTool).Unknown类型获取。其他未主动设置的类型则无法获取。
