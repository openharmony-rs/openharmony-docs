...
> > [XComponentNode](XComponentNode:XComponentNode)中设置生效。
> >
> > - 在[BuilderNode](arkts-arkui-buildernode-c.md#BuilderNode)的情况下，目前在作为根节点的自定义组件中支持纹理导出的有以下组件：
...
> > [NodeContainer](./../@internal/component/ets/node_container)下挂载的[FrameNode](arkts-arkui-framenode-c.md#FrameNode)和
