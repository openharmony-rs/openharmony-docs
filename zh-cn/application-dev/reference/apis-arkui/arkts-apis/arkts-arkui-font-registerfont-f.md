...
> 
> - 从API version 10开始，可以通过使用[UIContext](arkts-arkui-arkui-uicontext-uicontext-c.md)中的getFont方法获取当前UI上下文关联的[Font](arkts-arkui-arkui-uicontext-uicontext-c.md)对象。
