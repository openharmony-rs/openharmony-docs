...
基础手势事件类型。继承自[BaseEvent](arkts-arkui-common-baseevent-i.md#BaseEvent)。

**继承/实现关系：** BaseGestureEvent extends [BaseEvent](arkts-arkui-common-baseevent-i.md#BaseEvent)
