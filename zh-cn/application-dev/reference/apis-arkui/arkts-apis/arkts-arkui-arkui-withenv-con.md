...
>  
> - 支持通过[env](arkts-arkui-arkui-withenv-withenvattribute-c.md#env-1)设置的系统环境变量键，系统环境变量键存于[WritableEnvKey](../arkts-components/arkts-arkui-common-writableenvkey-c.md)。  
>  
