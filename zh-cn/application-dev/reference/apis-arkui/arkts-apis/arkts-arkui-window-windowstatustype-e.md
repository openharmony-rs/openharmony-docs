...
可通过[maximize()](arkts-arkui-window-window-i.md#maximize-1)和
[setTitleAndDockHoverShown()](arkts-arkui-window-window-i.md#setTitleAndDockHoverShown-1)配置，当hover到热区时是否显示标题栏和
dock栏。
...
[setSpecificSystemBarEnabled()](arkts-arkui-window-window-i.md#setSpecificSystemBarEnabled-1)配置是否显示状态栏。
