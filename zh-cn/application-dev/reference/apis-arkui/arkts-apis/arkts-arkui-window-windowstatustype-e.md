...
表示APP窗口最大化模式，自由窗口状态下，窗口铺满整个屏幕，不需要hover就可以显示dock栏、状态栏和标题栏。非 自由窗口状态下，不存在该状态。
