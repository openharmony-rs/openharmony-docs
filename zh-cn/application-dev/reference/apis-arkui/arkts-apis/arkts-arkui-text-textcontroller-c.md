...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| selectionStart | int \| undefined | 是 | 文本选择区域起始位置。&lt;br /&gt;取值范围：[0, +∞），值为负数或undefined时按0处理。 |
| selectionEnd | int \| undefined | 是 | 文本选择区域结束位置。&lt;br /&gt;取值范围：[0, +∞），值为负数或undefined时按0处理。 |
| options | [SelectionOptions](../arkts-components/arkts-arkui-selectionoptions-i.md) | 否 | 选中文字时的配置。&lt;br /&gt;默认值：SelectionOptions中MenuPolicy.DEFAULT |
