...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [GestureEvent](arkts-arkui-gesture-gestureevent-i.md) | 是 | 触发事件监听的手势事件的相关信息。 |
| current | [GestureRecognizer](arkts-arkui-gesture-gesturerecognizer-c.md) | 是 | 触发事件监听的手势识别器的相关信息。 |
