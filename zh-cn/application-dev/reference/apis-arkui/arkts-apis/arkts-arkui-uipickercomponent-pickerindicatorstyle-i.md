...
2. [LengthMetrics](arkts-arkui-lengthmetrics-c.md#LengthMetrics)：统一设置四个圆角半径的大小和单位。
3. [BorderRadiuses](arkts-arkui-borderradiuses-t.md#BorderRadiuses)：单独设置四个圆角半径的大小（单位为vp）。
4. [LocalizedBorderRadiuses](arkts-arkui-units-localizedborderradiuses-i.md#LocalizedBorderRadiuses)：单独设置四个圆角半径的大小和单位。
