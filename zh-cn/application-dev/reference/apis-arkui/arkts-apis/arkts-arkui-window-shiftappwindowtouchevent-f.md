...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sourceWindowId | number | 是 | 源窗口id。推荐使用<br/>[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)方法获取窗口id属性。该参数应为大于0的整数，小于等于0时会返回错误<br/>码1300016。 |
| targetWindowId | number | 是 | 目标窗口id。推荐使用<br/>[getWindowProperties()](arkts-arkui-window-window-i.md#getWindowProperties-1)方法获取窗口id属性。该参数应为大于0的整数，小于等于0时会返回错误<br/>码1300016。 |
| fingerId | number | 是 | 触屏事件的手指唯一标识符。推荐使用<br/>[TouchEvent](../../../../reference/apis-arkui/arkui-ts/ts-universal-events-touch.md#touchevent对象说明)对象中touches属性获取<br/>id。该参数应为大于等于0的整数，小于0时会返回错误码1300016。 |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [801](../../errorcode-universal.md#801-Capability) | Capability not supported.<br/>Function shiftAppWindowTouchEvent can not work correctly due to limited device capabilities. |
