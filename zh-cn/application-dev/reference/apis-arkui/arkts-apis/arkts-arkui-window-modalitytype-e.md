...
除其父级窗口外还需要该应用其他实例的窗口不响应用户操作时，可选此参数。 该枚举在支持并处于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_状态的设备上可正常调用；在支持但不处于 \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_状态的设备及不支持 \_\_\_MD\_LINK\_DESC\_USD\_2\_\_\_状态的设备上调用返回801错误码。
