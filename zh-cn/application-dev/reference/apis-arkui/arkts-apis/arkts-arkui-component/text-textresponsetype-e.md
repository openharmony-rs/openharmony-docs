...
注册此类型的菜单，但未注册RIGHT\_CLICK、LONG\_PRESS、SELECT时，右键、长按、鼠标、[selection]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_选中均会触发并显示此类型对应的菜单。 **原子化服务API（仅ArkTS-Dyn）：** 从API version 15开始，该接口支持在原子化服务中使用。
