...
日期选择器组件的参数说明。 **说明：** - Date的使用请参考[TimePickerOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。 - 在DatePicker组件滑动过程中修改DatePickerOptions中的属性，会导致这些属性无法生效。 **说明：** - 先处理起始日期与结束日期的异常情形，再处理选中日期的异常情形。
...
设置日期展示模式。 默认值：DatePickerMode.DATE，显示年、月、日三列。 在[DatePickerDialog]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中，当\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_的showTime设置 为true时，此参数不生效，默认显示年、月、日三列。
...
设置选中项的日期。 默认值：当前系统日期。 取值范围：[Date('1900-01-31'), Date('2100-12-31')] 从API version 23开始，该参数支持\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_双向绑定变量。
