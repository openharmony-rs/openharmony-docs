...
[cachedCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 是否按组计算。 true表示cachedCount按实际子组件个数计算，不按组计算；false表示如果displayCount.swipeByGroup=true，则cachedCount按组计算，否则按实际子组件个数计算。 默认值： false。 undefined 当设置为true时，cachedCount将根据实际的子组件计数来计算。 独立于displayCount分组计算。 \_\_\_HTML\_TAG\_DESC\_USD\_1\_\_\_如果启用了SwiftByGroup并且该值为false，则cachedCount将按组计算。 \_\_\_HTML\_TAG\_DESC\_USD\_2\_\_\_。
