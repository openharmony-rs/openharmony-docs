...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| arr | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 是 | The Data Source. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;RepeatAttribute&lt;T&gt;&gt; | 是 | 用于设置Repeat属性的回调。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | Repeat属性实例。 |
