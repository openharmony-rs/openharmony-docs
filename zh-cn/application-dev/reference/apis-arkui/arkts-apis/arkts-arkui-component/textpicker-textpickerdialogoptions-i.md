...
文本选择器弹窗的参数继承自[TextPickerOptions]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。 默认值： { color: \$r('sys.color.comp\_background\_tertiary'), borderRadius: \$r('sys.float.corner\_radius\_level12') }
