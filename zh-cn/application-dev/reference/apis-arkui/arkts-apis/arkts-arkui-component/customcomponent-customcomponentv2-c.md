...
```TypeScript
static _invokeImpl<S extends CustomComponentV2<S, S_Options>, S_Options>(factory: () => S,
...
<!--Device-CustomComponentV2-static _invokeImpl<S extends CustomComponentV2<S, S_Options>, S_Options>(factory: () => S,        initializers?: () => S_Options,        reuseId?: () => string,        content?: CustomBuilder    ): void--><!--Device-CustomComponentV2-static _invokeImpl<S extends CustomComponentV2<S, S_Options>, S_Options>(factory: () => S,        initializers?: () => S_Options,        reuseId?: () => string,        content?: CustomBuilder    ): void-End-->
...
<!--Device-CustomComponentV2-static _invokeImpl<S extends CustomComponentV2<S, S_Options>, S_Options>(factory: () => S,        initializers?: () => S_Options,        reuseId?: () => string,        content?: CustomBuilder,        options?: CustomComponentInvokeOptions    ): void--><!--Device-CustomComponentV2-static _invokeImpl<S extends CustomComponentV2<S, S_Options>, S_Options>(factory: () => S,        initializers?: () => S_Options,        reuseId?: () => string,        content?: CustomBuilder,        options?: CustomComponentInvokeOptions    ): void-End-->
