...
表示对应类型的配置。 config类型和type值有关联： 1. 如果type为ParticleType.POINT，则config类型为[PointParticleParameters]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_ 。 2. 如果type为ParticleType.IMAGE，则config类型为[ImageParticleParameters]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ 。 **原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。
