...
设置文本着色器效果。 该接口与[RichEditorTextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中的strokeWidth同时设置时，该接口不生效，shaderStyle的优先级高于 [RichEditorTextStyle]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_的fontColor。 **模型约束：** 此接口仅可在Stage模型下使用。
