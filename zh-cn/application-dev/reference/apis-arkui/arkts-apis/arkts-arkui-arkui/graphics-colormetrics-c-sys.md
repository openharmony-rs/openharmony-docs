...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| colorSpace | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 颜色的颜色空间。支持SRGB、Display\_\_\_ESCAPED\_UNDERSCORE\_\_\_P3、BT2020颜色空间。 |
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 带有HDR颜色的ColorMetrics类实例。 |
