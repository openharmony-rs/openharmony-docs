...
NodeAdapter提供FrameNode的数据懒加载能力，通过[LazyForEach]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_实现接口功能。 > **说明：** > > 入参不能为负数，入参为负数时不做处理。
...
获取所有有效数据。有效节点数据包括显示在屏幕上的节点以及预加载的节点。其中预加载节点的数量可依照LazyForEach的 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_，调整父容器的cachedCount属性进行设置。
