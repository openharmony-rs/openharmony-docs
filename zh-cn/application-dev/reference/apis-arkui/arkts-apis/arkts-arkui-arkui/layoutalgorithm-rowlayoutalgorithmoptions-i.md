...
子组件在水平方向上的排列是否反转。 取值为true表示子组件在水平方向上反转排列， 由于水平方向受通用属性 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_影响， 如果\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_属性生效， 再做一次反转。 取值为false表示子组件在水平方向上正序排列。 非法值：按默认值处理。
