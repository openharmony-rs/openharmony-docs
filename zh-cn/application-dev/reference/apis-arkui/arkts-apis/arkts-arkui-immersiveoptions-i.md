...
当该参数为true时，材质中的阴影效果固定生效，优先于[shadow](../arkts-components/arkts-arkui-commonmethod-c.md#shadow-1)通用属性。当该参数为false
...
[BottomTabBarStyle](../arkts-components/arkts-arkui-bottomtabbarstyle-c.md)样式时其中的文本和图标颜色。
