...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | Callback&lt;boolean&gt; | 否 | Callback used to return the result whether application process<br/>focused or not. If not provided, all callbacks for the given event type will be removed. |
