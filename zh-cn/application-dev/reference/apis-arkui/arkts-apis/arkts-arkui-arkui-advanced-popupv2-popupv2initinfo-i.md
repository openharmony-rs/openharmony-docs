...
设置PopupV2的布局方向，用于控制文本排列与对齐方式，适用于国际化场景下的RTL（从右到左）布局。具体枚举值含义见\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。 默认值：Direction.Auto
