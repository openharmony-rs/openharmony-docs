...
由于系统像素转换可能产生精度误差，设置后调用[getWindowDecorHeight()](#getwindowdecorheight11)获取到的值可能与设置的值存在1vp的差异。
...
由于系统像素转换可能产生精度误差，获取到的值与调用[setWindowDecorHeight()](#setwindowdecorheight11)设置的值可能存在1vp的差异。
