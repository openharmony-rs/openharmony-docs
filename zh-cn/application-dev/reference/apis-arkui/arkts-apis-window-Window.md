...
**设备行为差异：** 该接口在支持sensor旋转但不支持[自由窗口](../../windowmanager/window-terminology.md#自由窗口)状态的设备上可正常调用且立即生效； 在支持sensor旋转和[自由窗口](../../windowmanager/window-terminology.md#自由窗口)状态的设备上，不处于[自由窗口](../../windowmanager/window-terminology.md#自由窗口)状态时可正常调用且生效，在处于[自由窗口](../../windowmanager/window-terminology.md#自由窗口)状态的设备上调用后切换到非[自由窗口](../../windowmanager/window-terminology.md#自由窗口)状态下生效；在其他情况的设备上调用不生效也不报错。
