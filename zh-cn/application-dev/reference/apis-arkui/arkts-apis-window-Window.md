...
当接口入参为-1或当前窗口退至后台时，窗口亮度恢复为系统屏幕亮度（可以通过控制中心或快捷键调整）。

当窗口退至后台时，不建议同时调用此接口，否则可能引发时序问题。

> **说明：**
>- 针对非2in1设备：
> - 在OpenHarmony 6.1之前，窗口设置当前窗口亮度生效时，控制中心调整系统屏幕亮度不生效。
> - 从OpenHarmony 6.1开始，窗口设置当前窗口亮度生效时，控制中心可以调整系统屏幕亮度，同时会将当前设置屏幕亮度的窗口恢复默认系统屏幕亮度。
>- 针对2in1设备：
> - 在API version 14之前，窗口设置屏幕亮度生效时，控制中心或快捷键调整系统屏幕亮度不生效。
> - 从API version 14开始，窗口亮度与系统屏幕亮度保持一致，可以通过本接口、控制中心或者快捷键设置系统屏幕亮度。
...
> **说明：**
>- 针对非2in1设备，在<!--RP1-->OpenHarmony 6.1<!--RP1End-->之前，窗口设置当前窗口亮度生效时，控制中心不可以调整系统屏幕亮度。当接口入参为-1或当前窗口退至后台时，窗口亮度恢复为系统屏幕亮度，控制中心可以调整系统屏幕亮度。从<!--RP1-->OpenHarmony 6.1<!--RP1End-->开始，窗口设置当前窗口亮度生效时，控制中心可以调整系统屏幕亮度，同时会将当前设置屏幕亮度的窗口恢复默认系统亮度，控制中心可以调整系统屏幕亮度。当接口入参为-1或当前窗口退至后台时，窗口亮度恢复为系统屏幕亮度，控制中心可以调整系统屏幕亮度。
