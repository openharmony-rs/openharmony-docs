...
> **说明：**
>- 针对非2in1设备，在<!--RP1-->OpenHarmony 6.1<!--RP1End-->之前，窗口设置当前窗口亮度生效时，控制中心不可以调整系统屏幕亮度。当接口入参为-1或当前窗口退至后台时，窗口亮度恢复为系统屏幕亮度，控制中心可以调整系统屏幕亮度。从<!--RP1-->OpenHarmony 6.1<!--RP1End-->开始，窗口设置当前窗口亮度生效时，控制中心可以调整系统屏幕亮度，同时会将当前设置屏幕亮度的窗口恢复默认系统亮度。
