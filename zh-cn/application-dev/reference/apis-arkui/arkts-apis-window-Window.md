...
[独立子窗](../../windowmanager/window-terminology.md#应用窗口)调用该接口不生效也不报错。子窗之外的窗口调用该接口时会报错。
...
1、只支持主窗的一级子窗或模态窗口使用该接口。其中[独立子窗](../../windowmanager/window-terminology.md#应用窗口)调用此接口返回1300004错误码。
