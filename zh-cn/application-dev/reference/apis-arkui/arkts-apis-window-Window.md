...
设置主窗口状态栏、工具栏、<!--RP14-->三键导航栏的可见模式，状态栏通过status控制、三键导航栏或工具栏通过navigation控制。<!--RP14End-->当前工具栏的可见模式设置仅Car设备支持。使用Promise异步回调。
...
设置主窗口状态栏、工具栏、<!--RP19-->三键导航栏的属性。<!--RP19End-->当前工具栏的属性设置仅Car设备支持。使用Promise异步回调。
