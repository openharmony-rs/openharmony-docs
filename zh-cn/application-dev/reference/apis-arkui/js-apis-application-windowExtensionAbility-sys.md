...
> **说明：**
>
> - 从API version 21开始废弃，推荐使用[UIExtensionAbility](../apis-ability-kit/js-apis-app-ability-uiExtensionAbility.md)，针对设置一个嵌入式UIAbility的场景，请参见[UIExtensionAbility使用指南](../../application-models/uiextensionability-sys)。
> 
