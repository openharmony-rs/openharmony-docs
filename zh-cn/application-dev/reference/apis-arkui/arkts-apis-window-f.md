...
| callback | [AsyncCallback](../apis-basic-services-kit/js-apis-base.md#asynccallback)&lt;[Window](arkts-apis-window-Window.md)&gt; | 是 | 回调函数。当回调成功时，err为undefined，data为当前应用内层级最高的窗口对象；否则为错误对象。 |
