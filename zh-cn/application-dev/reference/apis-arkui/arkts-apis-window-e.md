...
| 名称       | 值     | 说明       |
| ---------- | ------ | ---------- |
| WINDOW_ORIENTATION  | 0      | 窗口显示方向。<br>开发者在使用时，需要注意该方向表示[RotationChangeInfo](arkts-apis-window-i.md#rotationchangeinfo19)中的orientation参数。 |
| DISPLAY_ORIENTATION | 1      | 屏幕显示方向。<br>开发者在使用时，需要注意该方向表示[display](js-apis-display.md#display)对象的orientation属性。 |
