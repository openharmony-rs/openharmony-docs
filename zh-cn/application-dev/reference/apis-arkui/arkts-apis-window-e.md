...
| TYPE_SYSTEM_ALERT<sup>(deprecated)</sup>               | 1     | 表示系统告警窗口。<br>- **说明：** 从API version 11开始废弃。<br>- 建议使用TYPE_APP、TYPE_FLOAT或TYPE_DIALOG来替代配置创建窗口类型。<br>- 从API version 7开始支持。<br>**ArkTS模式：** 该接口仅适用于ArkTS-Dyn。<br>**ArkTS-Dyn起始版本：** 7                          |
