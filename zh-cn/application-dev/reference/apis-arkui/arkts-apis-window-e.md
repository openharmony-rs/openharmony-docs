...
| TYPE_NAVIGATION_INDICATOR<sup>11+</sup> | 4    | 表示底部导航区域。<!--RP12-->OpenHarmony各设备不支持此能力。<br>**系统能力：** SystemCapability.WindowManager.WindowManager.Core<!--RP12End--> <br> **原子化服务API：** 从API version 11开始，该接口支持在原子化服务中使用。|
