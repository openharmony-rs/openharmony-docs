...
可以调用[getWindowAvoidArea](../arkts-apis-window-Window.md#getwindowavoidarea9)或者[on('avoidAreaChange')](../arkts-apis-window-Window.md#onavoidareachange9)获取对应避让区域的类型枚举值的避让区域[AvoidArea](../arkts-apis-window-i.md#avoidarea7)。
...
| TYPE_SYSTEM_GESTURE<sup>9+</sup> | 2    | 表示侧边返回手势区域。当前，各设备均无此类型避让区域。                                    |
