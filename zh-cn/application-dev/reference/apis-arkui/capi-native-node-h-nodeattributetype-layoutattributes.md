...
只传入一个参数，表示统一设置四条边的边框宽度。<br>
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 统一设置四条边的边框宽度。 |

传入四个参数，表示分别设置四条边的边框宽度。<br>
...
只传入一个参数，表示统一设置四条边的边框颜色。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].u32 | 统一设置四条边的边框颜色，使用0xargb表示，如`0xFFFF11FF`。 |

传入四个参数，表示分别设置四条边的边框颜色。<br>
...
只传入一个参数，表示统一设置四条边的内间距数值。<br>
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 上下左右四个位置的内间距值相等时的内间距数值，单位为百分比。 |

传入四个参数，表示分别设置四条边的内间距数值。<br>
