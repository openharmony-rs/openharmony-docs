...
定义ArkUI在Native侧可以设置的布局相关属性集合，包含尺寸、百分比尺寸、内外边距、边框、位置、对齐、方向、约束、Flex参数、布局规则、布局类组件相关属性及无障碍焦点属性设置。适用于需要在Native侧进行精细化的组件布局控制、响应式布局适配、复杂布局场景等。通过这些属性，开发者可以灵活控制组件的位置、尺寸、对齐方式等，解决组件布局定位、尺寸适配、对齐调整等布局问题，提升布局效率和灵活性。
...
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置宽度数值，单位为vp。取值范围：[0, +∞)。默认值：组件内容宽度。设置异常值时，按默认值显示。 |
...
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置高度数值，单位为vp。取值范围：[0, +∞)。默认值：组件内容高度。设置异常值时，按默认值显示。 |
...
1：只传入一个参数，表示统一设置上下左右四个位置的内边距值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 统一设置上下左右四个位置的内边距值，单位为vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |

2：传入四个参数，表示分别设置上下左右四个位置的内边距值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置上内边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[1].f32 | 设置右内边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[2].f32 | 设置下内边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[3].f32 | 设置左内边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| .value[0].f32 | 上内边距数值，单位为vp。 |
| .value[1].f32 | 右内边距数值，单位为vp。 |
| .value[2].f32 | 下内边距数值，单位为vp。 |
| .value[3].f32 | 左内边距数值，单位为vp。 |
...
1：只传入一个参数，表示统一设置上下左右四个位置的外边距值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 统一设置上下左右四个位置的外边距值，单位为vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |

2：传入四个参数，表示分别设置上下左右四个位置的外边距值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置上外边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[1].f32 | 设置右外边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[2].f32 | 设置下外边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |
| .value[3].f32 | 设置左外边距数值，单位为vp，默认值为0vp。取值范围：[0, +∞)。设置异常值时，按默认值0vp显示。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| .value[0].f32 | 上外边距数值，单位为vp。 |
| .value[1].f32 | 右外边距数值，单位为vp。 |
| .value[2].f32 | 下外边距数值，单位为vp。 |
| .value[3].f32 | 左外边距数值，单位为vp。 |
...
| 类型 | 说明 |
| -- | -- |
| .value[0].i32 | 对齐方式，类型为[ArkUI_Alignment](capi-native-type-h.md#arkui_alignment)。 |
...
| 参数项 | 描述 |
| -- | -- |
| .value[0].i32 | 主轴方向，设置容器内子组件的排列方向。参数类型[ArkUI_Direction](capi-native-type-h.md#arkui_direction)，默认值为ARKUI_DIRECTION_AUTO。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| .value[0].i32 | 主轴方向，类型为[ArkUI_Direction](capi-native-type-h.md#arkui_direction)。 |
...
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置宽度数值，单位为百分比。取值范围：[0%, 100%]。 |
...
| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置高度数值，单位为百分比。取值范围：[0%, 100%]。 |
...
1：只传入一个参数，表示统一设置上下左右四个位置的内边距百分比数值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 统一设置上下左右四个位置的内边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |

2：传入四个参数，表示分别设置上下左右四个位置的内边距百分比数值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置上内边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[1].f32 | 设置右内边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[2].f32 | 设置下内边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[3].f32 | 设置左内边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| .value[0].f32 | 上内边距数值，单位为百分比。 |
| .value[1].f32 | 右内边距数值，单位为百分比。 |
| .value[2].f32 | 下内边距数值，单位为百分比。 |
| .value[3].f32 | 左内边距数值，单位为百分比。 |
...
1：只传入一个参数，表示统一设置上下左右四个位置的外边距百分比数值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 统一设置上下左右四个位置的外边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |

2：传入四个参数，表示分别设置上下左右四个位置的外边距百分比数值。<br>

| 参数项 | 描述 |
| -- | -- |
| .value[0].f32 | 设置上外边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[1].f32 | 设置右外边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[2].f32 | 设置下外边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |
| .value[3].f32 | 设置左外边距数值，单位为百分比。默认值为0。取值范围：[0, +∞)。设置异常值时，按默认值显示。 |

**返回：**

| 类型 | 说明 |
| -- | -- |
| .value[0].f32 | 上外边距数值，单位为百分比。 |
| .value[1].f32 | 右外边距数值，单位为百分比。 |
| .value[2].f32 | 下外边距数值，单位为百分比。 |
| .value[3].f32 | 左外边距数值，单位为百分比。 |
...
| 类型 | 说明 |
| -- | -- |
| .value[0].u32 | 扩展安全区域的类型，类型为[ArkUI_LayoutSafeAreaType](capi-native-type-h.md#arkui_layoutsafeareatype)。 |
| .value[1].u32 | 扩展安全区域的方向，类型为[ArkUI_LayoutSafeAreaEdge](capi-native-type-h.md#arkui_layoutsafeareaedge)。 |
...
定义当前组件的无障碍下一个焦点组件的[NODE_ID](capi-native-node-h-nodeattributetype-base.md#node_id)。设置该组件NODE_ID后，无障碍会查找当前页面中NODE_ID与当前组件设置的无障碍下一个焦点组件的NODE_ID相同的组件，若不存在则设置无效。支持属性设置、属性重置和属性获取接口。<br>
作为属性设置方法参数、属性获取方法返回值[ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md)格式如下。<br>
...
设置无障碍默认焦点标志，用于无障碍服务查找默认焦点组件。支持属性设置、属性重置和属性获取接口。<br>
作为属性设置方法参数、属性获取方法返回值[ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md)格式如下。<br>
