...
## screen.offDisconnect<sup>23+</sup>
...
| 参数名 | 类型 | 必填 | 说明                                      |
| ------------ | --------------------------- | --- |-----------------------------------------|
| mirrorScreen | ArkTS-Dyn: Array&lt;number&gt; <br> ArkTS-Sta: Array&lt;long&gt; | 是   | 镜像屏幕ID集合，ID应为整数。 mirrorScreen数组大小不应超过1000。 |
...
| 类型                | 说明                      |
| ------------------- | ------------------------- |
| ArkTS-Dyn: Promise&lt;Array&lt;number&gt;&gt; <br> ArkTS-Sta: Promise&lt;Array&lt;long&gt;&gt; | Promise对象。返回异源屏幕的屏幕ID集合，其中ID为大于0的整数。|
...
| isInUse | boolean        | 是   | 是   | 标识屏幕的使用状态。true表示屏幕使用中；false表示屏幕未使用；默认值为true。<br>**系统能力：** SystemCapability.WindowManager.WindowManager.Core **模型约束：** 此接口仅可在Stage模型下使用。<br>**ArkTS-Dyn起始版本：** 26.0.0 <br>**ArkTS-Sta起始版本：** 26.0.0<br> |
