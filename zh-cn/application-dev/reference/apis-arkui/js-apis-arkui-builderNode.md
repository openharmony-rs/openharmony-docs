...
依照传入的对象创建组件树，并持有组件树的根节点。无状态的UI方法[@Builder](../../ui/state-management/arkts-builder.md)最多拥有一个根节点。支持传递多个参数。
...
请参考[示例6（ReactiveBuilderNode中鼠标事件）](#示例6reactivebuildernode中鼠标事件)、[示例7（ReactiveBuilderNode中触摸事件）](#示例7reactivebuildernode中触摸事件)、[示例8（ReactiveBuilderNode中轴事件）](#示例8reactivebuildernode中轴事件)。
