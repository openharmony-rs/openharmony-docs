...
> **说明：**
>
> 焦点错误码用于说明节点获取焦点失败时的常见问题及处理方向，帮助开发者定位焦点异常并采取相应措施。以下仅介绍本模块特有错误码，通用错误码请参考通用错误码说明文档。
...
节点默认无法获焦、开发者将节点的focusable属性设置为false等，具体获焦能力请参见组件获焦能力说明。
...
祖先节点默认无法获焦、开发者将节点的focusable属性设置为false等，具体获焦能力请参见组件获焦能力说明。
...
- 对不具有获得焦点能力的组件请求焦点。具体组件可查询组件获焦能力说明。
