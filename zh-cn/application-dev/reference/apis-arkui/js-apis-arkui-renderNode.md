...
| 参数名  | 类型    | 必填 | 说明               |
| ------- | ------- | ---- | ------------------ |
| index | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 需要查询的子节点的序列号，从0开始。取值范围：[0, 子节点数量-1]，超出范围时返回null。不支持负索引。 |
...
| 参数名 | 类型   | 必填 | 说明                                   |
| ------ | ------ | ---- | -------------------------------------- |
| value  | ArkTS-Dyn: number<br>ArkTS-Sta: double | 是   | 将要设置的不透明度，取值范围：[0, 1]，值越大透明度越低。 |
...
| 类型   | 说明                                      |
| ------ | ----------------------------------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double | 当前RenderNode的不透明度，默认值为1，不透明。<br>取值范围：[0, 1]。 |
...
| 参数名   | 类型                                             | 必填 | 说明                         |
| -------- | ------------------------------------------------ | ---- | ---------------------------- |
| position | ArkTS-Dyn: [Position](./js-apis-arkui-graphics.md#position)<br>ArkTS-Sta: [NodePosition](./js-apis-arkui-graphics.md#nodeposition23) | 是   | 将要设置的RenderNode的位置。 |
...
| 类型                                             | 说明                                                 |
| ------------------------------------------------ | ---------------------------------------------------- |
| ArkTS-Dyn: [Position](./js-apis-arkui-graphics.md#position)<br>ArkTS-Sta: [NodePosition](./js-apis-arkui-graphics.md#nodeposition23) | 获取当前RenderNode的位置，默认位置为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型   | 必填 | 说明                                       |
| ------ | ------ | ---- | ------------------------------------------ |
| color  | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 将要设置的RenderNode的阴影颜色，ARGB格式。<br>示例：0xFF00FF00。 |
...
| 参数名 | 类型                                         | 必填 | 说明                             |
| ------ | -------------------------------------------- | ---- | -------------------------------- |
| offset | ArkTS-Dyn: [Offset](./js-apis-arkui-graphics.md#offset)<br>ArkTS-Sta: [NodeOffset](./js-apis-arkui-graphics.md#nodeoffset23) | 是   | 将要设置的RenderNode的阴影偏移。 |
...
| 类型                                         | 说明                                               |
| -------------------------------------------- | -------------------------------------------------- |
| ArkTS-Dyn: [Offset](./js-apis-arkui-graphics.md#offset)<br>ArkTS-Sta: [NodeOffset](./js-apis-arkui-graphics.md#nodeoffset23) | 当前RenderNode的阴影偏移，默认值为{ x: 0, y: 0 }。 |
...
| 参数名 | 类型   | 必填 | 说明                                      |
| ------ | ------ | ---- | ----------------------------------------- |
| alpha  | ArkTS-Dyn: number<br>ArkTS-Sta: double | 是   | 将要设置的RenderNode的阴影颜色的Alpha值。<br> 取值范围：[0, 1]。超出范围的值会被钳位到[0, 1]。 |
...
| 类型   | 说明                                           |
| ------ | ---------------------------------------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double | 当前RenderNode的阴影颜色的Alpha值，默认值为0。<br>取值范围：[0, 1]。 |
...
| 参数名    | 类型   | 必填 | 说明                             |
| --------- | ------ | ---- | -------------------------------- |
| elevation | ArkTS-Dyn: number<br>ArkTS-Sta: double | 是   | 将要设置的RenderNode的阴影的光照高度，单位为vp。<br>取值范围：[0, +∞)。传入负数时不产生光照阴影。 |
...
| 类型   | 说明                                  |
| ------ | ------------------------------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double | 当前RenderNode的阴影的光照高度，默认值为0。 <br> 取值范围：[0, +∞)。 |
...
| 参数名 | 类型   | 必填 | 说明                                 |
| ------ | ------ | ---- | ------------------------------------ |
| radius | ArkTS-Dyn: number<br>ArkTS-Sta: double | 是   | 将要设置的RenderNode的阴影模糊半径，单位为vp。<br>取值范围：[0, +∞)。传入负数时不绘制阴影。 |
...
| 类型   | 说明                                      |
| ------ | ----------------------------------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double | 当前RenderNode的阴影模糊半径，默认值为0。<br> 取值范围：[0, +∞)。 |
...
| 参数名 | 类型                                                | 必填 | 说明                   |
| ------ | --------------------------------------------------- | ---- | ---------------------- |
| width  |ArkTS-Dyn: [Edges](./js-apis-arkui-graphics.md#edgest12)\<number> <br> ArkTS-Sta: [NodeEdges](./js-apis-arkui-graphics.md#nodeedgest20)\<double> | 是   | RenderNode的边框宽度，单位为vp。<br>取值范围：[0, +∞)。传入负数或0时不绘制边框。 |
...
| 参数名 | 类型                                                | 必填 | 说明                   |
| ------ | --------------------------------------------------- | ---- | ---------------------- |
| color  |ArkTS-Dyn: [Edges](./js-apis-arkui-graphics.md#edgest12)\<number> <br> ArkTS-Sta: [NodeEdges](./js-apis-arkui-graphics.md#nodeedgest20)\<int> | 是   | RenderNode的边框颜色，ARGB格式，示例：0XFF000000。 |
...
ArkTS-Sta中使用ArkTS-Dyn的RenderNode对象。
 ...
 - 创建ArkTS-Dyn子模块`library`，在`library/src/main/ets/components`目录创建ArkTS-DynRenderNode的方法。
