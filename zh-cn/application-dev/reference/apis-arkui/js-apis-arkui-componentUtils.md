...
| centerX | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否  |  否 | 变换中心点x轴坐标。<br />单位: px                  |
| centerY | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否  |  否 | 变换中心点y轴坐标。<br />单位: px                |
...
| angle   | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否  |  否 | 旋转角度。<br />单位: px                          |
| centerX | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否  |  否 | 变换中心点x轴坐标。<br />单位: px                 |
| centerY | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否  |  否 | 变换中心点y轴坐标。<br />单位: px                 |
