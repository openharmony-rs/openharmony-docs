...
| 名称      | 类型                                                         | 只读 | 可选 | 说明           |
| --------- | ------------------------------------------------------------ | ---- | ---- | -------------- |
| wordBreak | [WordBreak](arkui-ts/ts-appendix-enums.md#wordbreak11)       | 否   | 是   | 设置分词类型。 |
...
| icon   | [ResourceStr](arkui-ts/ts-types.md#resourcestr)     | 否   | 是   | 图标内容。                 |
...
| width                   | [Dimension](arkui-ts/ts-types.md#dimension10)                | 否   | 是   | 对话框的宽度。                                               |
| height                  | [Dimension](arkui-ts/ts-types.md#dimension10)                | 否   | 是   | 对话框的高度。                                               |
| backgroundColor         | [ResourceColor](arkui-ts/ts-types.md#resourcecolor)          | 否   | 是   | 对话框的背景颜色。<br/>默认值：Color.Transparent<br/>**说明：** 当backgroundColor设置为非透明色时，backgroundBlurStyle必须设置为BlurStyle.NONE。 |
| backgroundBlurStyle     | [BlurStyle](arkui-ts/ts-universal-attributes-background.md#blurstyle9) | 否   | 是   | 对话框的背景模糊样式。<br/>默认值：BlurStyle.COMPONENT_ULTRA_THICK<br/>**说明：** 设置为BlurStyle.NONE将禁用背景模糊。 |
...
| borderWidth             | [Dimension](arkui-ts/ts-types.md#dimension10)&nbsp;\|&nbsp;[EdgeWidths](arkui-ts/ts-types.md#edgewidths9)&nbsp;\|&nbsp;[LocalizedEdgeWidths](arkui-ts/ts-types.md#localizededgewidths12) | 否   | 是   | 对话框边框宽度。<br/>默认值：0                               |
| borderColor             | [ResourceColor](arkui-ts/ts-types.md#resourcecolor)&nbsp;\|&nbsp;[EdgeColors](arkui-ts/ts-types.md#edgecolors9)&nbsp;\|&nbsp;[LocalizedEdgeColors](arkui-ts/ts-types.md#localizededgecolors12) | 否   | 是   | 对话框的边框颜色。<br/>默认值：Color.Black                   |
| borderStyle             | [BorderStyle](arkui-ts/ts-appendix-enums.md#borderstyle)&nbsp;\|&nbsp;[EdgeStyles](arkui-ts/ts-types.md#edgestyles9) | 否   | 是   | 对话框边框样式。<br/>默认值：BorderStyle.Solid               |
| shadow                  | [ShadowOptions](arkui-ts/ts-universal-attributes-image-effect.md#shadowoptions对象说明)&nbsp;\|&nbsp;[ShadowStyle](arkui-ts/ts-universal-attributes-image-effect.md#shadowstyle10枚举说明) | 否   | 是   | 对话框的阴影。                                               |
| alignment               | [DialogBaseAlignment](#dialogbasealignment)                  | 否   | 是   | 对话框的对齐模式。                                           |
...
| keyboardAvoidDistance   | [LengthMetrics](js-apis-arkui-graphics.md#lengthmetrics12)   | 否   | 是   | 对话框与系统键盘之间的距离。                                 |
| onWillAppear            | [VoidCallback](arkui-ts/ts-types.md#voidcallback12)          | 否   | 是   | 对话框打开动画开始前的回调函数。                             |
| onDidAppear             | [VoidCallback](arkui-ts/ts-types.md#voidcallback12)          | 否   | 是   | 对话框出现时的回调函数。                                     |
...
| 名称    | 类型                                            | 只读 | 可选 | 说明             |
| ------- | ----------------------------------------------- | ---- | ---- | ---------------- |
| content | [ResourceStr](arkui-ts/ts-types.md#resourcestr) | 否   | 否   | 对话框消息内容。 |
...
| 名称           | 类型                                                         | 只读 | 可选 | 说明                                                         |
| -------------- | ------------------------------------------------------------ | ---- | ---- | ------------------------------------------------------------ |
| title          | [ResourceStr](arkui-ts/ts-types.md#resourcestr)              | 否   | 是   | 对话框标题。                                                 |
| subtitle       | [ResourceStr](arkui-ts/ts-types.md#resourcestr)              | 否   | 是   | 对话框的副标题。                                             |
| message        | [DialogMessage](#dialogmessage)                              | 否   | 是   | 对话框的消息内容和文字样式。                                 |
...
| 类型                             | 说明           |
| -------------------------------- | -------------- |
| [DialogState](#dialogstate) | 返回对话框状态。 |

**示例：**

该示例通过DialogBaseController与对话框绑定，展示了弹出对话框，并通过控制器关闭对话框以及获取对话框状态的功能。
...
| 名称    | 类型                                                         | 只读 | 可选 | 说明                                                         |
| ------- | ------------------------------------------------------------ | ---- | ---- | ------------------------------------------------------------ |
| dismiss | [VoidCallback](arkui-ts/ts-types.md#voidcallback12)          | 否   | 否   | 关闭对话框的回调。只有当需要退出对话框时，才会调用此接口。   |
| reason  | [DismissReason](arkui-ts/ts-universal-attributes-popup.md#dismissreason12枚举说明) | 否   | 否   | 无法关闭对话框的原因。                                       |
