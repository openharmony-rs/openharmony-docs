...
定义触摸测试信息项。触摸测试信息项包含触摸测试中子组件的信息，适用于触摸测试过程中获取和识别子组件相关信息的场景，可以通过[OH_ArkUI_TouchTestInfoItem_Get](./capi-ui-input-event-h.md#oh_arkui_touchtestinfoitem_getx)XXX系列接口获取子组件信息，帮助开发者处理触摸测试结果。
