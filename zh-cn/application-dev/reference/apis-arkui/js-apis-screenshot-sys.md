...
| displayIntent<sup>26+</sup> | [DisplayIntentType](#displayintenttype-26)        | 否 | 是   | 表示截取图像的渲染方式。CANONICAL表示截图以标准显示属性进行渲染。LOCAL表示截图以当前显示属性进行渲染。默认值为CANONICAL。 |

## DisplayIntentType <sup>26+</sup>
