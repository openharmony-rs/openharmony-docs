...
| ---- | ---- | ---- | ---- |
| self | [FrameNode](js-apis-arkui-frameNode.md#framenode-1) | 是 | 懒加载动态布局组件在组件树上的实体节点。|
| position | ArkTS-Dyn: [Position](js-apis-arkui-graphics.md#position)<br/>ArkTS-Sta: [NodePosition](js-apis-arkui-graphics.md#nodeposition23) | 是 | 懒加载动态布局组件进行布局时使用的位置信息。|
