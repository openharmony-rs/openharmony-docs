...
该接口用于创建Button类型组件的构造参数，用于设置或更新组件的初始值。
...
| 类型                                                   | 说明                                                         |
| ------------------------------------------------------ | ------------------------------------------------------------ |
| ButtonFrameNode | 提供Button类型FrameNode节点。|
...
该接口用于创建Checkbox类型组件的构造参数，用于设置或更新组件的初始值。
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| CheckboxFrameNode | 提供Checkbox类型FrameNode节点。|
...
该接口用于创建CheckboxGroup类型组件的构造参数，用于设置或更新组件的初始值。
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| CheckboxGroupFrameNode | 提供CheckboxGroup类型FrameNode节点。|
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| RadioFrameNode | 提供Radio类型FrameNode节点。|
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| RatingFrameNode | 提供Rating类型FrameNode节点。|
...
该接口用于创建Select类型组件的构造参数，用于设置或更新组件的初始值。
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| SelectFrameNode | 提供Select类型FrameNode节点。|
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| SliderFrameNode | 提供Slider类型FrameNode节点。|
...
| 类型                            | 说明                   |
| ----------------------------- | -------------------- |
| ToggleFrameNode | 提供Toggle类型FrameNode节点。|
