...
该接口用于创建可以包含单个子组件的按钮的构造参数，设置组件的初始值。
...
该接口用于使用文本内容创建相应的按钮组件的构造参数，设置组件的初始值。
...
该接口用于创建Checkbox类型组件的构造参数，设置组件的初始值。
...
该接口用于创建CheckboxGroup类型组件的构造参数，设置组件的初始值。
...
该接口用于创建Radio类型组件的构造参数，设置组件的初始值。
...
该接口用于创建Rating类型组件的构造参数，设置组件的初始值。
...
该接口用于创建Select类型组件的构造参数，设置组件的初始值。
...
该接口用于创建Slider类型组件的构造参数，设置组件的初始值。
...
该接口用于创建Toggle类型组件的构造参数，设置组件的初始值。
