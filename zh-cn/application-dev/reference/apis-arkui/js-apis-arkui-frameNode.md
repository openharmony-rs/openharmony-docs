...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createCheckboxGroupNode<sup>22+</sup>](#createCheckboxGroupNode22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createRatingNode<sup>22+</sup>](#createRatingNode22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createRadioNode<sup>22+</sup>](#createRadioNode22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createSliderNode<sup>22+</sup>](#createSliderNode22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createSelectNode<sup>22+</sup>](#createSelectNode22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[createToggleNode<sup>22+</sup>](#createToggleNode22)。
