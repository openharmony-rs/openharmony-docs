...
```ts
import { Entry, Component, Image, $r, RelativeContainer, State } from '@kit.ArkUI';
...
AnimatedDrawableDescriptor的构造函数，与[constructor](#constructor12-2)相比，首位入参新增支持ResourceStr类型，能够传入动图资源地址。
