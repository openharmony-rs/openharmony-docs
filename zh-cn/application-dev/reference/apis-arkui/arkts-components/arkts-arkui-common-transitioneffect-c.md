...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](arkts-arkui-common-animateparam-i.md) | 是 | 动画参数。&lt;/br&gt;该参数只用来指定动画参数，其入参AnimateParam的onFinish回调不生效。&lt;/br&gt;如果通过combine进行TransitionEffect的组合，前一TransitionEffect的动画参数也可用于后一TransitionEffect。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"asymmetric"> | 当前动画非对称的转场效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"move"> | 当前动画从屏幕边缘滑入和滑出的效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"opacity"> | 当前动画透明度效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"rotate"> | 当前动画旋转效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"scale"> | 当前动画缩放效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](arkts-arkui-common-transitioneffect-c.md)<"translate"> | 当前动画平移效果。 |
