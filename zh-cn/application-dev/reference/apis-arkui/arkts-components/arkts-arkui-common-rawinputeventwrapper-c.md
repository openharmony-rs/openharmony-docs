...
> **说明：**  
>  
> 由于监听器在事件派发给具体组件之前执行，事件中的一些字段将无法提供有效值：如触发对象[target](arkts-arkui-common-eventtarget-i.md)、相对于组件的坐标  
> [x](arkts-arkui-common-mouseevent-i.md#x)和[y](arkts-arkui-common-mouseevent-i.md#y)、[getCurrentLocalPosition](arkts-arkui-common-touchobject-i.md#getcurrentlocalposition-1)和  
> [stopPropagation](arkts-arkui-common-touchevent-i.md#stoppropagation)方法、TouchEvent的[preventDefault](arkts-arkui-common-touchevent-i.md#preventdefault)和  
> [getHistoricalPoints](arkts-arkui-common-touchevent-i.md#gethistoricalpoints-1)方法以及KeyEvent的[metaKey](arkts-arkui-common-keyevent-i.md#metakey)属性和  
> [getModifierKeyState](arkts-arkui-common-keyevent-i.md#getmodifierkeystate-1)方法。
