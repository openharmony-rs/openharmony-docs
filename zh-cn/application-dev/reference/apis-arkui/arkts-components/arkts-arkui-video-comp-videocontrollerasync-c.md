...
> **说明：** 
> 
> VideoControllerAsync提供命令执行结果。与VideoController相比，[start](arkts-arkui-video-comp-videocontroller-c.md#start)、
...
| seekMode | [SeekMode](arkts-arkui-video-comp-seekmode-e.md) | 否 | 跳转模式。<br>异常值undefined、null、NaN和Infinity按PreviousKeyframe处理。<br>默认值：PreviousKeyframe |
