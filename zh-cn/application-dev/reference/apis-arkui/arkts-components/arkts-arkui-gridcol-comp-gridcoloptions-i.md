...
API version 20之后，`span`的继承规则见[GridColColumnOption](arkts-arkui-gridcol-comp-gridcolcolumnoption-i.md)，`offset`和`order`的继承规则保持不变。
...
**类型：** number &#124; [GridColColumnOption](arkts-arkui-gridcol-comp-gridcolcolumnoption-i.md)
