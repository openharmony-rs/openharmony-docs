...
长按手势识别器对象，继承于[GestureRecognizer](arkts-arkui-tapgesture-comp-gesturerecognizer-c.md)。

**继承/实现关系：** LongPressRecognizer extends [GestureRecognizer](arkts-arkui-tapgesture-comp-gesturerecognizer-c.md)
