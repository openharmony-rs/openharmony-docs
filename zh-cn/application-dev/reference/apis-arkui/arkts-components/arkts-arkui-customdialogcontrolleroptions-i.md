...
[borderRadius](arkts-arkui-commonmethod-c.md#borderradius-1)属性一起使用。
...
设置页面级弹窗需要显示的层级下的节点UniqueID，UniqueID可以通过[getUniqueId](../arkts-apis/arkts-arkui-framenode-c.md#getuniqueid-1)获取。
