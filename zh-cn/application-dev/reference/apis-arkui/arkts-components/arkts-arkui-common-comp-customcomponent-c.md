...
**继承/实现关系：** CustomComponent extends [BaseCustomComponent](arkts-arkui-common-comp-basecustomcomponent-c.md)
...
**替代接口：** [onPlaceChildren](arkts-arkui-common-comp-basecustomcomponent-c.md#onplacechildren)
