...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| action | [AccessibilityAction](arkts-arkui-common-comp-accessibilityaction-e.md) | 是 | 当前触发的无障碍控制操作类型。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AccessibilityActionInterceptResult](arkts-arkui-common-comp-accessibilityactioninterceptresult-e.md) | 无障碍控制操作拦截结果，用于决定是否拦截当前组件的无障碍控制操作及后续处理方式。 |
