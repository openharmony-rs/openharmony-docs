...
继承自[ScanEffectOptions](arkts-arkui-progress-scaneffectoptions-i.md)和[CommonProgressStyleOptions](arkts-arkui-progress-commonprogressstyleoptions-i.md)。

**继承/实现关系：** CapsuleStyleOptions extends [ScanEffectOptions](arkts-arkui-progress-scaneffectoptions-i.md), [CommonProgressStyleOptions](arkts-arkui-progress-commonprogressstyleoptions-i.md)
