...
[PixelMap](../../apis-image-kit/arkts-apis/arkts-image-image-pixelmap-i.md)和[DrawableDescriptor](arkts-arkui-image-comp-drawabledescriptor-t.md)类型的图片不包含头信息，调用该接口时图片显示效果不变化。
