...
配置背景要扩展到的安全区，包括：状态栏，导航栏和[safeAreaPadding](arkts-arkui-common-comp-commonmethod-c.md#safeareapadding)。设置该属性后，背景的对齐布局区域将包含扩展安全区的范围。
...
**类型：** Array&lt;[LayoutSafeAreaEdge](arkts-arkui-common-comp-layoutsafeareaedge-e.md)&gt;
