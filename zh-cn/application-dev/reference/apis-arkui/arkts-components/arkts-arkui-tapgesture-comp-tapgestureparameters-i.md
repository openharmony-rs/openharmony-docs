...
点击手势参数。继承自[BaseHandlerOptions](arkts-arkui-tapgesture-comp-basehandleroptions-i.md)。

> **说明：** 
> 
> 为规范匿名对象的定义，API 12版本修改了此处的元素定义。其中，保留了历史匿名对象的起始版本信息，会出现外层元素@since版本号高于内层元素版本号的情况，但这不影响接口的使用。

**继承/实现关系：** TapGestureParameters extends [BaseHandlerOptions](arkts-arkui-tapgesture-comp-basehandleroptions-i.md)
