...
| 类型 | 说明 |
| --- | --- |
| [KeyEvent](arkts-arkui-keyevent-i.md) | 获取按键事件，如果是触摸事件则返回事件对象，否则返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| [MouseEvent](arkts-arkui-mouseevent-i.md) | 获取鼠标事件，如果是鼠标事件则返回事件对象，否则返回null。 |
...
| 类型 | 说明 |
| --- | --- |
| [TouchEvent](arkts-arkui-touchevent-i.md) | 获取触摸事件，如果是触摸事件则返回事件对象，否则返回null。 |
