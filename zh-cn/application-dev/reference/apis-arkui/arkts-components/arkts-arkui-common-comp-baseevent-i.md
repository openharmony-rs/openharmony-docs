...
**类型：** [SourceType](arkts-arkui-common-comp-sourcetype-e.md)
...
**类型：** [SourceTool](arkts-arkui-common-comp-sourcetool-e.md)
...
**类型：** [EventTarget](arkts-arkui-common-comp-eventtarget-i.md)
