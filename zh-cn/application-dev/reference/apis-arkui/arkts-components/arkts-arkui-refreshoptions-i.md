...
[示例3](../../../../reference/apis-arkui/arkui-ts/ts-container-refresh.md#示例3自定义刷新区域显示内容-builder)。
...
<br/>promptText设置有效时，
[refreshOffset](../../../../reference/apis-arkui/arkui-ts/ts-container-refresh.md#refreshoffset12)属性默认值为96vp。
<br/>自定义文本最大的字体缩放倍数
