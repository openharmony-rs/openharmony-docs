...
> [maxFontSize](arkts-arkui-text-comp-attribute.md#maxfontsize)属性。
...
> 规则请参考Text组件的[minFontSize](arkts-arkui-text-comp-attribute.md#minfontsize)属性。
...
文本截断方式。当设置为MARQUEE时，该属性不生效。详细规则请参考Text组件的[textOverflow](arkts-arkui-text-comp-attribute.md#textoverflow)属性。
