...
**类型：** [BreakPoints](arkts-arkui-gridrow-comp-breakpoints-i.md)
...
**类型：** number &#124; [GridRowColumnOption](arkts-arkui-gridrow-comp-gridrowcolumnoption-i.md)
...
**类型：** [GridRowDirection](arkts-arkui-gridrow-comp-gridrowdirection-e.md)
...
**类型：** [Length](../arkts-apis/arkts-arkui-length-t.md) &#124; [GutterOption](arkts-arkui-gridrow-comp-gutteroption-i.md)
