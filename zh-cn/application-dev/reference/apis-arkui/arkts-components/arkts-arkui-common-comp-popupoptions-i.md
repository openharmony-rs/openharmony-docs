...
**类型：** [AvoidanceMode](arkts-arkui-select-comp-avoidancemode-e.md)
...
**类型：** [PopupBorderLinearGradient](arkts-arkui-common-comp-popupborderlineargradient-i.md)
...
1. 仅当绑定组件使用了[WithTheme](arkts-arkui-withtheme-comp.md#withtheme)标签时，该属性才会生效。
2. 该属性仅影响组件的默认样式，以及开发者设置的涉及深浅色资源的属性。
3. 设置为AnchoredColorMode.FOLLOW_SYSTEM时，模糊材质可以跟随，文字颜色以及涉及深浅色资源的属性仍保持跟随绑定组件的深浅色配置。

**类型：** [AnchoredColorMode](arkts-arkui-common-comp-anchoredcolormode-e.md)
...
**类型：** [KeyboardAvoidMode](arkts-arkui-common-comp-keyboardavoidmode-e.md)
...
**类型：** [PopupMessageOptions](arkts-arkui-common-comp-popupmessageoptions-i.md)
...
**类型：** boolean &#124; [Callback](arkts-arkui-common-comp-callback-i.md)&lt;[DismissPopupAction](arkts-arkui-common-comp-dismisspopupaction-i.md)&gt;
...
默认值：透明色TRANSPARENT加模糊背景填充效果[COMPONENT_ULTRA_THICK](arkts-arkui-common-comp-blurstyle-e.md)。
...
**类型：** [TransitionEffect](arkts-arkui-common-comp-transitioneffect-c.md)
