...
**类型：** [AvailableLayoutArea](arkts-arkui-common-comp-availablelayoutarea-e.md)
...
**类型：** [MenuKeyboardAvoidMode](arkts-arkui-common-comp-menukeyboardavoidmode-e.md)
...
**类型：** boolean &#124; [MenuMaskType](arkts-arkui-common-comp-menumasktype-i.md)
...
**类型：** [ModalMode](arkts-arkui-common-comp-modalmode-e.md)
...
**类型：** [MenuPreviewMode](arkts-arkui-common-comp-menupreviewmode-e.md) &#124; [CustomBuilder](arkts-arkui-common-comp-custombuilder-t.md)
...
**类型：** [ContextMenuAnimationOptions](arkts-arkui-common-comp-contextmenuanimationoptions-i.md)
...
**类型：** [BorderRadiusType](arkts-arkui-common-comp-borderradiustype-t.md)
...
**类型：** [PreviewScaleMode](arkts-arkui-common-comp-previewscalemode-e.md)
