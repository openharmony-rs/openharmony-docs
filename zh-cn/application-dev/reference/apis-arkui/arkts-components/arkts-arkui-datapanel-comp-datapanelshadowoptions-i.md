...
DataPanelShadowOptions继承自[MultiShadowOptions](arkts-arkui-common-comp-multishadowoptions-i.md)，具有MultiShadowOptions的全部属性。

**继承/实现关系：** DataPanelShadowOptions extends [MultiShadowOptions](arkts-arkui-common-comp-multishadowoptions-i.md)
