...
| 类型 | 说明 |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-comp-dotindicator-c.md) | 返回当前圆点指示器，用于支持链式调用配置其他导航点属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| iconList | Array&lt;[IndicatorIconInfo](arkts-arkui-swiper-comp-indicatoriconinfo-i.md)&gt; | 是 | 需要设置的导航点索引。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-comp-dotindicator-c.md) | 返回DotIndicator。 |
