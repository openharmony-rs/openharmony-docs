...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| gesture | [GestureHandler](../arkts-apis/arkts-arkui-gesture-gesturehandler-c.md)<T> | 是 | 手势处理器对象。 |
| priority | [GesturePriority](../arkts-apis/arkts-arkui-gesture-gesturepriority-e.md) | 否 | 绑定手势的优先级。<br>默认值：GesturePriority.NORMAL |
| mask | [GestureMask](../arkts-apis/arkts-arkui-gesture-gesturemask-e.md) | 否 | 事件响应设置。<br>默认值：GestureMask.Normal |
