...
文本选择器弹窗的参数继承自[TextPickerOptions](arkts-arkui-text-picker-textpickeroptions-i.md)。

**继承/实现关系：** TextPickerDialogOptions extends [TextPickerOptions](arkts-arkui-text-picker-textpickeroptions-i.md)
