...
继承自[CommonProgressStyleOptions](arkts-arkui-progress-comp-commonprogressstyleoptions-i.md)。

**继承/实现关系：** ProgressStyleOptions extends [CommonProgressStyleOptions](arkts-arkui-progress-comp-commonprogressstyleoptions-i.md)
