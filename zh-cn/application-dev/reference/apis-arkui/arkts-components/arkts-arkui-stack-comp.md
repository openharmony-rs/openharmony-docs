...
> **说明：** > > - 该组件从API version 7开始支持。后续版本的新增接口，采用上角标单独标记接口的起始版本。 > > - 通用属性[align](arkts-arkui-common-comp-commonmethod-c.md#align)在该组件上支持镜像能力。
...
> 
> 该接口的alignContent参数与[align](arkts-arkui-common-comp-commonmethod-c.md#align)同时设置时，后设置的属性值会覆盖先设置的属性值。该接口的alignContent参数与
