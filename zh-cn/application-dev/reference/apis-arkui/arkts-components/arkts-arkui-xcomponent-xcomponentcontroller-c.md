...
| 类型 | 说明 |
| --- | --- |
| [SurfaceRect](arkts-arkui-xcomponent-surfacerect-i.md) | surface的矩形信息。 |
...
| rect | [SurfaceRect](arkts-arkui-xcomponent-surfacerect-i.md) | 是 | XComponent创建的surface的矩形信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [SurfaceConfig](arkts-arkui-xcomponent-surfaceconfig-i.md) | 是 | surface配置 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rect | [SurfaceRect](arkts-arkui-xcomponent-surfacerect-i.md) | 是 | surface的矩形信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rotationOptions | [SurfaceRotationOptions](arkts-arkui-xcomponent-surfacerotationoptions-i.md) | 是 | surface的旋转选项。 |
...
**替代接口：** [setXComponentSurfaceRect](arkts-arkui-xcomponent-xcomponentcontroller-c.md#setxcomponentsurfacerect-1)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| config | [ImageAnalyzerConfig](../arkts-apis/arkts-arkui-image-common-imageanalyzerconfig-i.md) | 是 | AI图像分析器的设置。 |
