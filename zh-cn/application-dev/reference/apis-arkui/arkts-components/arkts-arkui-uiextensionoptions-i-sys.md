...
设置UIExtensionComponent内容的DPI跟随策略。 默认值：**FOLLOW\_UI\_EXTENSION\_ABILITY\_DPI**
...
设置UIExtensionComponent内容的窗口模式跟随策略。 默认值：**FOLLOW\_UI\_EXTENSION\_ABILITY\_WINDOW\_MODE**
