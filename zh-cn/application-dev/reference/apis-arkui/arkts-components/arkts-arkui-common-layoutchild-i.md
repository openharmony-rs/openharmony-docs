...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childLayoutInfo | [LayoutInfo](arkts-arkui-common-layoutinfo-i.md) | 是 |  |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| childConstraint | [ConstraintSizeOptions](../arkts-apis/arkts-arkui-units-constraintsizeoptions-i.md) | 是 |  |
