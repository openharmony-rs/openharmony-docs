...
文本选择器弹窗的参数继承自[TextPickerOptions](arkts-arkui-textpicker-comp-textpickeroptions-i.md)。

**继承/实现关系：** TextPickerDialogOptions extends [TextPickerOptions](arkts-arkui-textpicker-comp-textpickeroptions-i.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextPickerResult](arkts-arkui-textpicker-comp-textpickerresult-i.md) | 是 |  |
...
**类型：** [PickerTextStyle](arkts-arkui-common-comp-pickertextstyle-i.md)
...
**类型：** [Rectangle](arkts-arkui-common-comp-rectangle-i.md)
...
**类型：** Callback&lt;[TextPickerResult](arkts-arkui-textpicker-comp-textpickerresult-i.md)&gt;
...
**类型：** [PickerBackgroundStyle](arkts-arkui-textpicker-comp-pickerbackgroundstyle-i.md)
