...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string &#124; [MonitorDecoratorOptions](arkts-arkui-common-comp-monitordecoratoroptions-i.md) | 是 | 从API版本26.0.0开始，该参数也可以为MonitorDecoratorOptions类型的对象，用于配置通配符能力。 |
