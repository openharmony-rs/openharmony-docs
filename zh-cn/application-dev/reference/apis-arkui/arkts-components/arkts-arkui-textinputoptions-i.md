...
设置输入框当前的文本内容。不设置时默认为空字符串。 建议通过onChange事件将状态变量与文本实时绑定， 避免组件刷新时TextInput中的文本内容异常。 从API version 10开始，该参数支持\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_双向绑定变量。 从API version 18开始，该参数支持\_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_双向绑定变量。
