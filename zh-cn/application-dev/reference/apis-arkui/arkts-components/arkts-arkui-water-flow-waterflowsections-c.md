...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| section | [SectionOptions](arkts-arkui-water-flow-sectionoptions-c.md) | 是 | 添加到瀑布流末尾的分组。 |
...
| sections | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<SectionOptions> | 否 | 表示要从start开始加入的分组。如果不指定，`splice()`将只从瀑布流中删除分组。 |
...
| section | [SectionOptions](arkts-arkui-water-flow-sectionoptions-c.md) | 是 | 新的分组信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<SectionOptions> | 瀑布流中所有分组配置信息。 |
