...
滑动手势处理器配置参数。继承自[BaseHandlerOptions](arkts-arkui-tapgesture-comp-basehandleroptions-i.md)。

**继承/实现关系：** PanGestureHandlerOptions extends [BaseHandlerOptions](arkts-arkui-tapgesture-comp-basehandleroptions-i.md)
...
**类型：** [PanDirection](arkts-arkui-tapgesture-comp-pandirection-e.md)
...
使用[gestureModifier](arkts-arkui-common-comp-commonmethod-c.md#gesturemodifier)配置该字段时，单位为px。
...
**类型：** Map&lt;[SourceTool](arkts-arkui-common-comp-sourcetool-e.md), number&gt;
