...
该参数对[backgroundImageResizable](arkts-arkui-common-comp-commonmethod-c.md#backgroundimageresizable)接口不生效。

传入数字时默认单位为px。

**类型：** [DrawingLattice](arkts-arkui-image-comp-drawinglattice-t.md)
