...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| modifier | [ContentModifier](arkts-arkui-common-contentmodifier-i.md)<DataPanelConfiguration> | 是 | 在DataPanel组件上，定制内容区的方法。<br/>modifier：内容修改器，开发者需要自定义class实现ContentModifier接口。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DataPanelShadowOptions](arkts-arkui-data-panel-datapanelshadowoptions-i.md) | 是 | 投影样式。<br/>**说明：** <br/>设置为null时，不开启投影。 |
