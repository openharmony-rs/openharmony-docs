...
| onPop | import('../api/@ohos.base').Callback<PopInfo> | 否 | NavDestination页面触发[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)时返回的回调。仅[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)中设置result参数后触发。<br>**起始版本：** 11 |
...
NavDestination页面唯一标识符，该id由系统默认生成且全局唯一，通过[getPathStack](arkts-arkui-navigation-navpathstack-c.md#getpathstack-1)接口可读取，但不可以主动赋新值。
...
NavDestination页面触发[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)时返回的回调。仅[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)中设置result参数后触发。
