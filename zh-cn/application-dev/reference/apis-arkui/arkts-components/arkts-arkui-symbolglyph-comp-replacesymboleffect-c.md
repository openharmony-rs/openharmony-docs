...
**继承/实现关系：** ReplaceSymbolEffect extends [SymbolEffect](arkts-arkui-symbolglyph-comp-symboleffect-c.md)
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scope | [EffectScope](arkts-arkui-symbolglyph-comp-effectscope-e.md) | 否 | 动效范围。<br>默认值：EffectScope.LAYER |
| replaceType | [ReplaceEffectType](arkts-arkui-symbolglyph-comp-replaceeffecttype-e.md) | 否 | 替换动效类型。<br>默认值：ReplaceEffectType.SEQUENTIAL |
...
**类型：** [ReplaceEffectType](arkts-arkui-symbolglyph-comp-replaceeffecttype-e.md)
