...
继承自[DatePickerOptions](arkts-arkui-date-picker-datepickeroptions-i.md)。

**继承/实现关系：** DatePickerDialogOptions extends [DatePickerOptions](arkts-arkui-date-picker-datepickeroptions-i.md)
