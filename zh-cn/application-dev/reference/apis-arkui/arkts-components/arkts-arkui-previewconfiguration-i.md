...
自定义配置的预览图是否仅用于浮起。 **说明：** 默认值为false。true表示自定义预览图仅用于浮起，false表示可用于浮起和拖拽。设置为true时，如果发起长按拖拽，浮起时的预览图为自定义配置的预览图，拖拽时的预览图不使用 [dragPreview]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_属性，优先使用开发者在 [onDragStart]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_中返回的预览图，如果[onDragStart]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_中没有返回预览图则使用组件自截 图。
