...
**类型：** [SwipeEdgeEffect](arkts-arkui-listitem-comp-swipeedgeeffect-e.md)
...
**类型：** [CustomBuilder](arkts-arkui-common-comp-custombuilder-t.md) &#124; [SwipeActionItem](arkts-arkui-listitem-comp-swipeactionitem-i.md)
