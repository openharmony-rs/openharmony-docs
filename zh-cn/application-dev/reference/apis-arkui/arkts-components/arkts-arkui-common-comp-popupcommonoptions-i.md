...
**类型：** boolean &#124; [PopupMaskType](arkts-arkui-common-comp-popupmasktype-i.md)
...
气泡的颜色。如需去除模糊背景填充效果，需将backgroundBlurStyle设置为BlurStyle.NONE。默认值：透明色TRANSPARENT加模糊背景填充效果[COMPONENT_ULTRA_THICK](arkts-arkui-common-comp-blurstyle-e.md)。
