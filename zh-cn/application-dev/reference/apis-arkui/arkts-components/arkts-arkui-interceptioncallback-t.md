...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| from | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| NavBar | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。  |
| to | \_\_\_MD\_LINK\_USD\_0\_\_\_ \| NavBar | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。  |
