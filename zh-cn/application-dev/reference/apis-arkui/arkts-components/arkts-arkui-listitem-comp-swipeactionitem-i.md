...
SwipeActionItem用于配置[SwipeActionOptions](arkts-arkui-listitem-comp-swipeactionoptions-i.md)中的start或end划出项，包括划出时显示的操作项、长距离操作区域的距离阈值，以及进入、退出长距离操作区域、抬手触发操作和状态变化时的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| state | [SwipeActionState](arkts-arkui-listitem-comp-swipeactionstate-e.md) | 是 |  |
