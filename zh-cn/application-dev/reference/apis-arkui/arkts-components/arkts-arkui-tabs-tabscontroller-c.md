...
> - Tabs的preloadItems需要在Tabs创建之后去调用，首次预加载推荐在Tabs的[onAppear](arkts-arkui-common-commonmethod-c.md#onappear-1)生命周期中去控制。  
>  
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| translate | [TranslateOptions](arkts-arkui-common-translateoptions-i.md) | 是 | 设置TabBar的平移距离。 |
