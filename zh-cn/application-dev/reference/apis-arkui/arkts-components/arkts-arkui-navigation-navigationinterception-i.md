...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| from | [NavDestinationContext](arkts-arkui-nav-destination-navdestinationcontext-i.md) \| [NavBar](arkts-arkui-navbar-t.md) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |  
| to | [NavDestinationContext](arkts-arkui-nav-destination-navdestinationcontext-i.md) \| [NavBar](arkts-arkui-navbar-t.md) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |  
...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| from | [NavPathInfo](arkts-arkui-navigation-navpathinfo-c.md) \|[NavBar](arkts-arkui-navbar-t.md) | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |  
| to | [NavPathInfo](arkts-arkui-navigation-navpathinfo-c.md) \|[NavBar](arkts-arkui-navbar-t.md) | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |  
