...
将[EXPANDED](arkts-arkui-list-item-swipeactionstate-e.md)状态的[ListItem](arkts-arkui-listitem.md)收起，并设置回调事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CloseSwipeActionOptions](arkts-arkui-list-closeswipeactionoptions-i.md) | 否 | 收起[EXPANDED](arkts-arkui-list-item-swipeactionstate-e.md)状态的[ListItem](arkts-arkui-listitem.md)的回调事件集合。 |
...
| 类型 | 说明 |
| --- | --- |
| [RectResult](arkts-arkui-common-rectresult-i.md) | ListItemGroup中的ListItem的大小和相对于List的位置。<br/>单位：vp。 |
...
| align | [ScrollAlign](arkts-arkui-scroll-scrollalign-e.md) | 否 | 指定滑动到的元素与当前容器的对齐方式。<br/>默认值：ScrollAlign.START。 |
