...
1、当type为ParticleUpdater.NONE，表示无变化，则config类型为[ParticleColorPropertyUpdaterConfigs](arkts-arkui-particle-particlecolorpropertyupdaterconfigs-i.md)[ParticleUpdater.NONE]。

2、type为ParticleUpdater.RANDOM，表示随机变化，则config类型为[ParticleColorPropertyUpdaterConfigs](arkts-arkui-particle-particlecolorpropertyupdaterconfigs-i.md)[ParticleUpdater.RANDOM]。

3、type为ParticleUpdater.CURVE,表示按动画曲线变化，则config类型为[ParticleColorPropertyUpdaterConfigs](arkts-arkui-particle-particlecolorpropertyupdaterconfigs-i.md)[ParticleUpdater.CURVE]。
