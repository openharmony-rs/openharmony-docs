...
| 类型 | 说明 |
| --- | --- |
| [EventTargetInfo](arkts-arkui-tapgesture-comp-eventtargetinfo-c.md) | 当前手势识别器对应组件的信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [GestureRecognizerState](arkts-arkui-tapgesture-comp-gesturerecognizerstate-e.md) | 当前手势识别器的状态。 |
