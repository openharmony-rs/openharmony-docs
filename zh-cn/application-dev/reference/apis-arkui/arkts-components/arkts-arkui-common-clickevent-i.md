...
**替代接口：** [windowX](arkts-arkui-common-clickevent-i.md#windowx)
...
**替代接口：** [windowY](arkts-arkui-common-clickevent-i.md#windowy)
...
点击位置在被点击元素为基准的[组件坐标系](../../../../ui/arkui-glossary.md#组件坐标系)中的X坐标。onClick的[distanceThreshold](arkts-arkui-common-commonmethod-c.md#onclick-2)设置后，点击位置为抬手点。触发事件的是键盘或手柄时，点击位置为被点击元素的中心点。
