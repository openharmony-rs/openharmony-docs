...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ImageCompleteCallback](arkts-arkui-imagespan-comp-imagecompletecallback-t.md) | 是 | 图片数据加载成功和解码成功时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [ImageErrorCallback](arkts-arkui-image-comp-imageerrorcallback-t.md) | 是 | 图片加载异常时触发的回调。 |
