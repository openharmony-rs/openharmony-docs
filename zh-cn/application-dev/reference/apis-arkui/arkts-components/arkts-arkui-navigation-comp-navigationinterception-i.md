...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| from | [NavDestinationContext](arkts-arkui-navdestination-comp-navdestinationcontext-i.md) \| [NavBar](arkts-arkui-navigation-comp-navbar-t.md) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavDestinationContext](arkts-arkui-navdestination-comp-navdestinationcontext-i.md) \| [NavBar](arkts-arkui-navigation-comp-navbar-t.md) | 是 | 页面跳转之后的栈顶页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| mode | [NavigationMode](arkts-arkui-navigation-comp-navigationmode-e.md) | 是 | 导航页的显示模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |  
| ------ | ------ | ---- | ---------------- |  
| from | [NavPathInfo](arkts-arkui-navigation-comp-navpathinfo-c.md) \|[NavBar](arkts-arkui-navigation-comp-navbar-t.md) | 是 | 退场页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
| to | [NavPathInfo](arkts-arkui-navigation-comp-navpathinfo-c.md) \|[NavBar](arkts-arkui-navigation-comp-navbar-t.md) | 是 | 进场页面信息。参数值为navBar，则表示跳转的目标页面为Navigation首页。 |
