...
描述XComponent所持有的surface的矩形。 > **说明：** > 如果未调用[setXComponentSurfaceRect]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_接口，且未设置 > \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_和 > [padding]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，则**surfaceWidth**和**surfaceHeight**属性默认为**XComponent**的尺寸。 > > 请确保**surfaceWidth**和**surfaceHeight**的值不超过8192 px。超过此限制可能导致渲染问题。 > > 在沉浸式场景中，**SurfaceRect**的默认布局不包含安全区域。要实现沉浸式效果，必须使用 > [setXComponentSurfaceRect]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_接口设置surface显示区域。
