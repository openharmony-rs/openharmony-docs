...
设置菜单的栅格样式。仅固定样式菜单生效，例如在[bindMenu](arkts-arkui-common-commonmethod-c.md#bindmenu-1)、[bindContextMenu](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-1)、[bindContextMenuByResponseType](arkts-arkui-common-commonmethod-c.md#bindcontextmenubyresponsetype-1)、[bindContextMenuByIsShow](arkts-arkui-common-commonmethod-c.md#bindcontextmenubyisshow-1)、[bindContextMenuWithResponse](arkts-arkui-common-commonmethod-c.md#bindcontextmenuwithresponse-1)中使用[MenuElement](arkts-arkui-common-menuelement-i.md)或在[MenuItem](arkts-arkui-menuitem.md)中使用MenuItemOptions。
...
1. 作为[bindMenu](arkts-arkui-common-commonmethod-c.md#bindmenu-2)入参时，默认值为Placement.BottomLeft。2. 作为[bindContextMenu<sup>8+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-1)或[bindContextMenuWithResponse<sup>23+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenuwithresponse-1)入参时，默认效果为菜单跟随点击位置弹出。3. 作为[bindContextMenu<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-2)入参时，默认值为Placement.BottomLeft。4. placement值设置为undefined、null或缺省时，按默认值处理。
...
长按悬浮菜单或使用[bindContextMenu<sup>12+</sup>](arkts-arkui-common-commonmethod-c.md#bindcontextmenu-2)显示菜单的预览内容样式，可以为目标组件的截图，也可以为用户自定义的内容。
...
详细描述见[TransitionEffect](arkts-arkui-common-transitioneffect-c.md)对象说明。
