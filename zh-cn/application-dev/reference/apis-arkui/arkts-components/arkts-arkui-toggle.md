...
| [ToggleConfiguration](arkts-arkui-toggleconfiguration-i.md) | 开发者需要自定义class实现ContentModifier接口。继承自CommonConfiguration。 |
| [ToggleOptions](arkts-arkui-toggleoptions-i.md) | Toggle组件的配置信息。 @since版本号高于内层元素版本号的情况，但这不影响接口的使用。 |
