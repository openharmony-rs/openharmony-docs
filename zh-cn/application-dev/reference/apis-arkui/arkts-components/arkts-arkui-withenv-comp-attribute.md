...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [CustomEnvKey](arkts-arkui-common-comp-customenvkey-c.md)&lt;T&gt; | 是 | 自定义环境变量的键。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| key | [WritableSystemEnvKey](arkts-arkui-common-comp-writablesystemenvkey-c.md)&lt;T&gt; | 是 | 系统环境变量键。当前正式支持WritableEnvKey.FONT_SCALE和WritableEnvKey.DIRECTION。 |
