...
| event | [AccessibilityHoverEvent](arkts-arkui-common-comp-accessibilityhoverevent-i.md) | 是 | 无障碍悬浮事件对象，用于获取触发无障碍悬浮事件时的详细信息，包括无障碍悬浮动作类型（type）、手指相对于组件/窗口/屏幕的坐标（x、y、windowX、windowY、displayX、displayY、globalDisplayX、globalDisplayY）等属性。 |
