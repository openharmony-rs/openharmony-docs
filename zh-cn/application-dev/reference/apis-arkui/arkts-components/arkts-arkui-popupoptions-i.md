...
设置Popup组件相对于宿主节点的显示位置，默认值为Placement.Bottom。 如果同时设置了\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_和\_\_\_INLINE\_CODE\_DESC\_USD\_1\_\_\_，则以\_\_\_INLINE\_CODE\_DESC\_USD\_2\_\_\_的设置为准。如果开发者设置的位置上无法完整显示气泡，气泡会自动避让至可以完整显示的位置
...
是否在组件上方显示，默认值为false。取值为true：气泡显示到绑定组件的上方，取值false：气泡显示到绑定组件的下方。 **说明：** 从API version 7开始支持，从API version 10开始废弃，建议使用\_\_\_INLINE\_CODE\_DESC\_USD\_0\_\_\_替代。
...
**替代接口：** [PopupOptions#placement](../../apis-na/arkts-apis/arkts-na-component/common-popupoptions-i.md#placement)
