...
不允许和其他滚动类组件，如：[List](arkts-arkui-list-comp.md#list)、[Grid](arkts-arkui-grid-comp.md#grid)、[Scroll](arkts-arkui-scroll-comp.md#scroll)和[WaterFlow](arkts-arkui-waterflow-comp.md#water_flow)绑定同一个滚动控制对象。
