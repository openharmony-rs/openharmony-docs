...
| to | [NavDestinationContext](arkts-arkui-navdestination-comp-navdestinationcontext-i.md) &#124; [NavBar](arkts-arkui-navigation-comp-navbar-t.md) | 是 | 页面跳转之前的栈顶页面信息。参数值为navBar，则表示跳转前的页面为Navigation首页。 |
