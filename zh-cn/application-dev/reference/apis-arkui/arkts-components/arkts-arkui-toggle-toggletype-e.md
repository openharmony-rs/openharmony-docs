...
> [borderRadius](arkts-arkui-common-commonmethod-c.md#borderradius-1)，此时使用  
...
[通用属性margin](arkts-arkui-common-commonmethod-c.md#margin-1)的默认值为：
...
[通用属性margin](arkts-arkui-common-commonmethod-c.md#margin-1)默认值为：
