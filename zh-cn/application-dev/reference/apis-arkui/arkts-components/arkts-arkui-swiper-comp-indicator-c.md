...
| 类型 | 说明 |
| --- | --- |
| [DigitIndicator](arkts-arkui-swiper-comp-digitindicator-c.md) | 数字指示器对象，用于设置Swiper组件的数字导航样式。 |
...
| 类型 | 说明 |
| --- | --- |
| [DotIndicator](arkts-arkui-swiper-comp-dotindicator-c.md) | 圆点指示器对象，用于设置Swiper组件的圆点导航样式。 |
