...
设置该类型时，需要结合[useUnionEffect](arkts-arkui-common-commonmethod-c-sys.md#useunioneffect-2)并设置[GravityCenterOptions](arkts-arkui-common-gravitycenteroptions-i-sys.md)的gravityCenter为true才能生效。
