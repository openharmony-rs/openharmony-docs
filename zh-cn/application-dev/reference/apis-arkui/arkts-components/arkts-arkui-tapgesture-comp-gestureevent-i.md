...
定义手势的事件信息。继承自[BaseEvent](arkts-arkui-common-comp-baseevent-i.md)。

**继承/实现关系：** GestureEvent extends [BaseEvent](arkts-arkui-common-comp-baseevent-i.md)
...
**类型：** [FingerInfo](arkts-arkui-tapgesture-comp-fingerinfo-i.md)[]
...
**类型：** [EventLocationInfo](arkts-arkui-tapgesture-comp-eventlocationinfo-i.md)
