...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<number> | 返回全部名为name的NavDestination页面的位置索引。 当路由栈中不存在此name，返回空数组。索引取值范围为[0, 路由栈大小-1] |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<unknown> | 返回全部名为name的NavDestination页面的参数信息，unknown可以是用户自定义的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<NavPathInfo> | 当前路由栈中的路由页面信息数组。 |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | import('../api/@ohos.base').Callback<PopInfo> | 是 | Callback回调，用于页面出栈时处理返回结果。仅[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)中设置result参数后触发。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
| name | string | 是 | NavDestination页面名称。 |
| param | Object | 是 | 开发者设置的NavDestination页面详细参数。 |
| onPop | import('../api/@ohos.base').Callback<PopInfo> | 是 | Callback回调，用于页面出栈时触发该回调处理返回结果。仅[pop](NavPathStack#pop(result: Object, animated?: boolean))、[popToName](arkts-arkui-navigation-navpathstack-c.md#poptoname-2)、[popToIndex](arkts-arkui-navigation-navpathstack-c.md#poptoindex-2)中设置result参数后触发。 |
| animated | boolean | 否 | 是否支持转场动画。<br/>true：支持转场动画；false：不支持转场动画。<br/>默认值：true |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indexes | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<number> | 是 | 待删除NavDestination页面的索引值数组。索引值从0开始。 |
...
>  
> 3. 开发者可以通过[NavPathInfo](arkts-arkui-navigation-navpathinfo-c.md)中的页面唯一标识符navDestinationId来操作已有页面，该id由系统默认生成且全局唯一（可以通过  
> [getPathStack](arkts-arkui-navigation-navpathstack-c.md#getpathstack-1)接口获取，不可主动赋新值）。若该id在当前路由栈中不存在，则表示新增页面，若在当前路由栈中存在，同时对应的name相同，则表示复用已  
> 有页面。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| pathStack | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<NavPathInfo> | 是 | 设置当前路由栈中的路由页面信息数组。<br/>**说明：**<br/>数组长度无限制。 |
