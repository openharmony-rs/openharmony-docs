...
> **说明：**  
>  
> 1. 该接口仅在[dragAnimationType](arkts-arkui-common-dragevent-i-sys.md#draganimationtype)设置为DragAnimationType.FOLLOW_HAND_MORPH时生效。  
>  
...
设置拖拽动画类型。该属性仅支持在[onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1)阶段设置，可在[onDragStart](arkts-arkui-common-commonmethod-c.md#ondragstart-1)、[onDragEnter](arkts-arkui-common-commonmethod-c.md#ondragenter-1)、[onDragMove](arkts-arkui-common-commonmethod-c.md#ondragmove-1)、[onDragLeave](arkts-arkui-common-commonmethod-c.md#ondragleave-1)、[onDrop](arkts-arkui-common-commonmethod-c.md#ondrop-1)、[onDragEnd](arkts-arkui-common-commonmethod-c.md#ondragend-1)回调中获取。
