...
3. 该构造器的builder仅支持定义在UI组件中，例如可以定义在Builder函数、方法或者[build](arkts-arkui-common-comp-basecustomcomponent-c.md#build)方法里。
...
API version 11及以后，默认值：透明色TRANSPARENT加模糊背景填充效果[COMPONENT_ULTRA_THICK](arkts-arkui-common-comp-blurstyle-e.md)
