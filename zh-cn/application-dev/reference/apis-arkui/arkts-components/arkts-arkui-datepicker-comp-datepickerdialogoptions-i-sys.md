...
继承自[DatePickerOptions](arkts-arkui-datepicker-comp-datepickeroptions-i.md)。

**继承/实现关系：** DatePickerDialogOptions extends [DatePickerOptions](arkts-arkui-datepicker-comp-datepickeroptions-i.md)
...
> 各枚举取值含义请参见[DistortionMode](arkts-arkui-common-comp-distortionmode-e-sys.md)。
...
> 各枚举取值含义请参见[EdgeLightMode](arkts-arkui-common-comp-edgelightmode-e-sys.md)。
