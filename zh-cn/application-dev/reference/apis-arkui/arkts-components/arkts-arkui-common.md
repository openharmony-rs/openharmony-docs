...
| [BackgroundOptions](arkts-arkui-backgroundoptions-i.md) | 指定背景选项@interface BackgroundOptions |
| [BaseEvent](arkts-arkui-baseevent-i.md) | 基础事件类型。 |
| [BindOptions](arkts-arkui-bindoptions-i.md) | 半模态、全模态的公共配置接口。 |
| [BlurOptions](arkts-arkui-bluroptions-i.md) | 灰阶模糊参数。@interface BlurOptions |
| [BlurStyleOptions](arkts-arkui-blurstyleoptions-i.md) | 内容模糊选项。@interface BlurStyleOptions |
| [BorderImageOption](arkts-arkui-borderimageoption-i.md) | Border image option@interface BorderImageOption |
| [Callback](arkts-arkui-callback-i.md) | 定义基础的回调函数。 |
| [CaretOffset](arkts-arkui-caretoffset-i.md) | CaretOffset info.@interface CaretOffset |
...
| [Configuration](arkts-arkui-configuration-i.md) | Defines the data type of the interface restriction.@interface Configuration |
...
| [ForegroundBlurStyleOptions](arkts-arkui-foregroundblurstyleoptions-i.md) | 继承自[BlurStyleOptions](arkts-arkui-blurstyleoptions-i.md)，设置内容模糊选项。@extends BlurStyleOptions @interface ForegroundBlurStyleOptions |
| [ForegroundEffectOptions](arkts-arkui-foregroundeffectoptions-i.md) | 前景效果参数。@interface ForegroundEffectOptions |
...
| [InputCounterOptions](arkts-arkui-inputcounteroptions-i.md) | Define the ratio of characters entered by the the percentage of InputCounterOptions.@interface InputCounterOptions |
...
| [InvertOptions](arkts-arkui-invertoptions-i.md) | 前景智能取反色。@interface InvertOptions |
| [ItemDragEventHandler](arkts-arkui-itemdrageventhandler-i.md) | 定义拖拽事件@interface ItemDragEventHandler |
| [ItemDragInfo](arkts-arkui-itemdraginfo-i.md) | 拖拽点信息对象。@interface ItemDragInfo |
...
| [LocalizedAlignRuleOptions](arkts-arkui-localizedalignruleoptions-i.md) | Defines the Localized align rule options of relative container.@interface LocalizedAlignRuleOptions |
| [LocalizedHorizontalAlignParam](arkts-arkui-localizedhorizontalalignparam-i.md) | Defines the localized horizontal align param of relative container.@interface LocalizedHorizontalAlignParam |
| [LocalizedVerticalAlignParam](arkts-arkui-localizedverticalalignparam-i.md) | Defines the localized vertical align param of relative container.@interface LocalizedVerticalAlignParam |
...
| [MotionBlurAnchor](arkts-arkui-motionbluranchor-i.md) | Define motion blur anchor coordinates.@interface MotionBlurAnchor |
| [MotionBlurOptions](arkts-arkui-motionbluroptions-i.md) | 运动模糊选项。@interface MotionBlurOptions |
...
| [MouseHistoricalPoint](arkts-arkui-mousehistoricalpoint-i.md) | 鼠标事件历史点信息。历史点按时间顺序排列，获取到的第一个历史点是最早发生的事件的信息，最后一个是最新发生事件的信息。历史点的数量取决于系统事件队列的配置和硬件性能。历史点主要用于如下场景：
...
| [NestedScrollOptions](arkts-arkui-nestedscrolloptions-i.md) | nestedScroll属性参数对象。@interface NestedScrollOptions |
...
| [PopupMessageOptions](arkts-arkui-popupmessageoptions-i.md) | 气泡文本的样式。@interface PopupMessageOptions |
| [PopupOptions](arkts-arkui-popupoptions-i.md) | 基础气泡的信息。 |
| [PopupStateChangeParam](arkts-arkui-popupstatechangeparam-i.md) | 气泡的显示状态。@interface PopupStateChangeParam |
...
| [ReusableOptions](arkts-arkui-reusableoptions-i.md) | 可复用自定义组件的参数，用于配置内存优化策略，适用于需要降低可复用自定义组件内存使用量的场景。@interface ReusableOptions |
...
| [SelectionOptions](arkts-arkui-selectionoptions-i.md) | Defines the selection options.@interface SelectionOptions |
| [ShadowOptions](arkts-arkui-shadowoptions-i.md) | 阴影属性集合，用于设置阴影的模糊半径、阴影的颜色、X轴和Y轴的偏移量。@interface ShadowOptions |
...
| [TextContentControllerOptions](arkts-arkui-textcontentcontrolleroptions-i.md) | Defines the span options of TextContentController.@interface TextContentControllerOptions |
| [TextDecorationOptions](arkts-arkui-textdecorationoptions-i.md) | Defines the options of decoration.@interface TextDecorationOptions |
| [TipsOptions](arkts-arkui-tipsoptions-i.md) | 悬浮气泡自定义参数。@interface TipsOptions |
...
| [TranslateOptions](arkts-arkui-translateoptions-i.md) | Defines the options of translate.@interface TranslateOptions |
...
| [UIScrollableCommonEvent](arkts-arkui-uiscrollablecommonevent-i.md) | 用于设置滚动事件回调。@extends UICommonEvent @interface UIScrollableCommonEvent |
| [VerticalAlignParam](arkts-arkui-verticalalignparam-i.md) | 定义相对容器的垂直对齐规则。@interface VerticalAlignParam |
...
| [AdaptiveColor](arkts-arkui-adaptivecolor-e.md) | 取色模式。@enum { number } |
...
| [BlendApplyType](arkts-arkui-blendapplytype-e.md) | 指示如何将指定的混合模式应用于视图的内容。@enum { number } |
...
**效果模板：** 
| 设备类型 | 模糊半径(单位: px) | 饱和度 | 亮度 | 颜色 | | -------- | ---- | ---------------------- | -------- | -------- | | 移动设备 | 0 | 0 | 0 | '#ffffffff'，显示为白色。 | | 2in1设备：深色模式 | 80 | 1.5 | 1.0 | '#e52e3033'，显示为淡红色的半透明效果。 | | 2in1设备：浅色模式 | 80 | 1.9 | 1.0 | '#e5ffffff'，显示为半透明的深红色。 | | Tablet设备 | 0 | 0 | 0 | '#ffffffff'，显示为白色。 |@enum { number } |
...
| [LayoutSafeAreaEdge](arkts-arkui-layoutsafeareaedge-e.md) | 扩展安全区域的边缘。@enum { number } |
...
| [MenuPolicy](arkts-arkui-menupolicy-e.md) | Define the menu pop-up policy@enum { number } |
...
| [OutlineStyle](arkts-arkui-outlinestyle-e.md) | 外描边样式。@enum { number } |
| [PreDragStatus](arkts-arkui-predragstatus-e.md) | 定义拖拽手势触发前的各阶段状态。 |
| [PreviewScaleMode](arkts-arkui-previewscalemode-e.md) | 预览图的缩放方式。 |
| [RepeatMode](arkts-arkui-repeatmode-e.md) | 用于设置被切割的图片在边框上的重复方式。@enum { number } |
| [ReusableMemOptStrategy](arkts-arkui-reusablememoptstrategy-e.md) | 可复用自定义组件内存优化策略枚举。@enum { number } |
...
| [ShadowStyle](arkts-arkui-shadowstyle-e.md) | 组件阴影效果。@enum { number } |
| [ShadowType](arkts-arkui-shadowtype-e.md) | 阴影类型。@enum { number } |
...
| [SystemProperties](arkts-arkui-systemproperties-e.md) | 定义系统环境变量枚举值@enum { string } |
