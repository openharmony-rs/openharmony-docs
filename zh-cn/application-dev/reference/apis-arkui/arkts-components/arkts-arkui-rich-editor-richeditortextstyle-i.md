...
默认值：$r('sys.color.font_primary')。当[shaderStyle](arkts-arkui-rich-editor-richeditorparagraphstyle-i.md)同时设置时，shaderStyle优先级高于fontColor。
...
与[shaderStyle](arkts-arkui-rich-editor-richeditorparagraphstyle-i.md)同时设置时，shaderStyle不生效。
