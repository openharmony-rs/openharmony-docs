...
默认为[AUTO](arkts-arkui-lazyforeach-comp-lazyforeachcustomcomponentfreezemode-e.md)。

**类型：** [LazyForEachCustomComponentFreezeMode](arkts-arkui-lazyforeach-comp-lazyforeachcustomcomponentfreezemode-e.md)
...
默认值：[DEFAULT](arkts-arkui-lazyforeach-comp-lazyforeachmemoptstrategy-e.md)

**类型：** [LazyForEachMemOptStrategy](arkts-arkui-lazyforeach-comp-lazyforeachmemoptstrategy-e.md)
...
默认使用[BATCH](arkts-arkui-lazyforeach-comp-lazyforeachreleasestrategy-e.md)，批量释放节点。

**类型：** [LazyForEachReleaseStrategy](arkts-arkui-lazyforeach-comp-lazyforeachreleasestrategy-e.md)
