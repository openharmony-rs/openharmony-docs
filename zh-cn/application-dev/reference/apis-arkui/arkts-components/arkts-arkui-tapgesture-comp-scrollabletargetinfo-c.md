...
手势识别器对应的滚动类容器组件的信息，继承于[EventTargetInfo](arkts-arkui-tapgesture-comp-eventtargetinfo-c.md)。

**继承/实现关系：** ScrollableTargetInfo extends [EventTargetInfo](arkts-arkui-tapgesture-comp-eventtargetinfo-c.md)
