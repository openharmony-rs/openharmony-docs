...
设置半模态popup样式弹窗避让软键盘。该避让方式仅在[preferType](arkts-arkui-common-comp-sheetoptions-i.md)设置为[SheetType.POPUP](arkts-arkui-common-comp-sheettype-e.md)（跟手弹窗样式）时生效，其他弹窗样式不支持此避让方式。
