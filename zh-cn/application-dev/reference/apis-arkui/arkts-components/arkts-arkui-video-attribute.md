...
不能和[overlay](arkts-arkui-commonmethod-c.md#overlay)属性同时使用，两者同时设置时[overlay](arkts-arkui-commonmethod-c.md#overlay)中[CustomBuilder](../../../reference/apis-arkui/arkui-ts/ts-types.md#custombuilder8)属性将失效。
> **说明：**  
>  
> 从API version 20开始，该接口支持在[attributeModifier](arkts-arkui-commonmethod-c.md#attributemodifier)中调用。
...
播放时触发该事件，支持[attributeModifier](arkts-arkui-commonmethod-c.md#attributemodifier)动态设置属性方法。
