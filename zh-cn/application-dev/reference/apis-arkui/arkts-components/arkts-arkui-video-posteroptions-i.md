...
当前视频的预览图内容变化时的转场动效。配置showFirstFrame为true（即配置开启首帧送显时），或未配置有效的[VideoOptions对象](arkts-arkui-video-videooptions-i.md)的previewUri时，该字段不生效。
...
当前视频是否配置首帧送显，当开启首帧送显时，[VideoOptions对象](arkts-arkui-video-videooptions-i.md)中的previewUri字段不生效。
