...
[cachedCount]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_是否按实际子组件个数计算。 设置为true时，cachedCount按实际子组件个数计算，不按组计算。 设置为false时，如果displayCount.swipeByGroup=true，则cachedCount按组计算，否则按实际子组件个数计算。 默认值：false
