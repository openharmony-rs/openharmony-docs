...
| 名称 | 说明 |
| --- | --- |
| [OnContentScrollCallback](arkts-arkui-oncontentscrollcallback-t-1.md) | 文本内容滚动回调。 |
| [OnPasteCallback](arkts-arkui-onpastecallback-t-1.md) | 粘贴回调。 |
| [OnSubmitCallback](arkts-arkui-onsubmitcallback-t.md) | 提交回调。 |
| [OnTextSelectionChangeCallback](arkts-arkui-ontextselectionchangecallback-t-1.md) | 文本选择变化回调或光标位置变化回调。 |
