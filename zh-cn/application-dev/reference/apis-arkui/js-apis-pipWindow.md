...
| cornerAdsorptionEnabled<sup>22+</sup>| boolean                                                                     | 否   | 是  |  是否开启画中画四角吸附功能。<br/>true：表示开启画中画四角吸附功能；<br/>false：表示关闭画中画四角吸附功能；<br/>不传值则为默认值true。<br/>**设备行为差异：** 支持在Phone、Tablet设备开启四角吸附功能，其他设备不生效。<br/>**原子化服务API：** 从API version 22开始，该接口支持在原子化服务中使用。                                                                 |
