...
| 名称   | 类型 | 只读 | 可选 | 说明       |
| ------ | -------- | ---- | ---- | ---------- |
| width  | number   | 否   | 否   | 窗口宽度，单位为px，该参数应为正整数，不大于屏幕宽。 |
| height | number   | 否   | 否   | 窗口高度，单位为px，该参数应为正整数，不大于屏幕高。 |
