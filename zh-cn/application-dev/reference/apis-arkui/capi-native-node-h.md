...
| NODE_SCROLL_BY = 1002013 | 滑动指定距离。<br>属性设置方法参数[ArkUI_AttributeItem](capi-arkui-nativemodule-arkui-attributeitem.md)格式：<br> .value[0].f32：水平方向滚动距离，默认单位为vp; <br> .value[1].f32：竖直方向滚动距离，默认单位为vp。  |
