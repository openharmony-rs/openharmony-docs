...
| bundleName  | string   | 否   | 否   | 应用Bundle的名称。 <br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 22 |
| abilityName | string   | 否   | 否   | Ability的名称。 <br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 22 |
| windowId | ArkTS-Dyn: number<br>ArkTS-Sta: long | 否   | 否   | 窗口ID。 <br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 22 |
| windowStatusType | [WindowStatusType](arkts-apis-window-e.md#windowstatustype11) | 否   | 否   | 窗口模式枚举。 <br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 22  |
| isFocused | boolean | 否   | 是   | 窗口是否获焦。true表示窗口获焦；false表示窗口未获焦。 <br>**ArkTS-Dyn起始版本：** 14<br>**ArkTS-Sta起始版本：** 22  |
