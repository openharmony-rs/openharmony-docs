...
| 名称 | 描述 |
| -- | -- |
| float x | 点击触点相对于当前组件左上角的x轴坐标。单位为像素。 |
| float y | 点击触点相对于当前组件左上角的y轴坐标。单位为像素。 |
| float screenX | 点击触点相对于XComponent所在应用屏幕左上角的x轴坐标。单位为像素。 |
| float screenY | 点击触点相对于XComponent所在应用屏幕左上角的y轴坐标。单位为像素。 |
