...
| 类型          | 说明             |
| ------------- | ---------------- |
| number | 颜色的R分量（红色）。<br>取值范围：<br>对于SDR颜色，取值范围为 [0, 1]。<br>对于HDR颜色，该值可以大于1.0，以表示扩展亮度。|
...
| 类型          | 说明             |
| ------------- | ---------------- |
| number | 颜色的G分量（绿色）。<br>取值范围：<br>对于SDR颜色，取值范围是[0, 1]。<br>对于HDR颜色，其值可大于1.0，用于表示更高的/扩展的亮度范围。|
...
| 类型          | 说明             |
| ------------- | ---------------- |
| number | 颜色的B分量（蓝色）。<br>取值范围：<br>对于SDR颜色，取值范围是[0, 1]。<br>对于HDR颜色，该值可以大于1.0，以表示扩展亮度。 |