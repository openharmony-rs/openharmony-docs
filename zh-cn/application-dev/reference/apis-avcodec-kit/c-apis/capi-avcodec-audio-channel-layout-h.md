...
| 名称 | 描述 |
| -- | -- |
| [typedef  AudioChannelSet : uint64_t](#typedef  audiochannelset  uint64_t) | 音频声道数集合，将每一个声道数映射为int64的变量。(API11废弃) |
| [typedef  AudioChannelLayout : uint64_t](#typedef  audiochannellayout  uint64_t) | 音频声道数类型，将用户申请的解码器输出格式表示为编解码器的声道类型。(API11废弃) |

## 枚举类型说明

### typedef  AudioChannelSet : uint64_t

```c
enum typedef  AudioChannelSet : uint64_t
```
...
### typedef  AudioChannelLayout : uint64_t

```c
enum typedef  AudioChannelLayout : uint64_t
```
...
**替代接口：** {@link OH_AudioChannelLayout}
...
| CH_5POINT1POINT4 = (CH_5POINT1 \| AudioChannelSet::TOP_FRONT_LEFT \| AudioChannelSet::TOP_FRONT_RIGHT \| | 5.1.4布局 |
| CH_7POINT1POINT2 = (CH_7POINT1 \| AudioChannelSet::TOP_SIDE_LEFT \| AudioChannelSet::TOP_SIDE_RIGHT) | 7.1.2布局 |
| CH_7POINT1POINT4 = (CH_7POINT1 \| AudioChannelSet::TOP_FRONT_LEFT \| AudioChannelSet::TOP_FRONT_RIGHT \| | 7.1.4布局 |
...
| CH_10POINT2 = (AudioChannelSet::FRONT_LEFT \| AudioChannelSet::FRONT_RIGHT \| AudioChannelSet::FRONT_CENTER \| | 10.2布局 |
| CH_22POINT2 = (CH_7POINT1POINT4 \| AudioChannelSet::FRONT_LEFT_OF_CENTER \| AudioChannelSet::FRONT_RIGHT_OF_CENTER \| | 22.2布局 |
...
| HOA_FIRST = AudioChannelSet::AMBISONICS_ACN0 \| AudioChannelSet::AMBISONICS_ACN1 \| AudioChannelSet::AMBISONICS_ACN2 \| | 高阶立体声一阶布局 |
| HOA_SECOND = HOA_FIRST \| AudioChannelSet::AMBISONICS_ACN4 \| AudioChannelSet::AMBISONICS_ACN5 \| | 高阶立体声二阶布局 |
| HOA_THIRD = HOA_SECOND \| AudioChannelSet::AMBISONICS_ACN9 \| AudioChannelSet::AMBISONICS_ACN10 \| | 高阶立体声三阶布局 |
