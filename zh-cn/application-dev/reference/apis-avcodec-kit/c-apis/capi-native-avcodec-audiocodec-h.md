...
| [OH_AVFormat *OH_AudioCodec_GetOutputDescription(OH_AVCodec *codec)](#oh_audiocodec_getoutputdescription) | 获取编解码器输出数据的OH_AVFormat信息。<br> 需要注意的是，返回值所指向的OH_AVFormat实例需要开发者调用[OH_AVFormat_Destroy](capi-native-avformat-h.md#oh_avformat_destroy)接口手动释放。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：OH_AVCodec实例为nullptr或无效。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。      <br>[AV_ERR_NO_MEMORY](capi-native-averrors-h.md#oh_averrcode)：内部资源已经释放。      <br>[AV_ERR_UNKNOWN](capi-native-averrors-h.md#oh_averrcode)：发生内部错误，建议检查日志。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：输入参数为nullptr或无效。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：输入参数为nullptr或无效。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。      <br>[AV_ERR_OPERATE_NOT_PERMIT](capi-native-averrors-h.md#oh_averrcode)：不允许操作，这可能是由于状态不正确或不支持的操作。      <br>[AV_ERR_UNKNOWN](capi-native-averrors-h.md#oh_averrcode)：发生内部错误，建议检查日志。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：OH_AVCodec实例为nullptr或无效。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：输入的index已使用或无效，需使用其他[OH_AVCodecOnNeedInputBuffer](capi-native-avcodec-base-h.md#oh_avcodeconneedinputbuffer)回调返回的index。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器状态错误，调用OH_AudioCodec_PushInputBuffer前需确保按顺序成功调用[OH_AudioCodec_Configure](capi-native-avcodec-audiocodec-h.md#oh_audiocodec_configure)、      [OH_AudioCodec_Prepare](capi-native-avcodec-audiocodec-h.md#oh_audiocodec_prepare)、[OH_AudioCodec_Start](capi-native-avcodec-audiocodec-h.md#oh_audiocodec_start)。      <br>[AV_ERR_UNKNOWN](capi-native-averrors-h.md#oh_averrcode)：输入buffer size无效，需确保buffer设置了正确的buffer size和flags。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：输入参数为nullptr或无效。缓冲区索引应该由[OH_AVCodecOnNewOutputBuffer](capi-native-avcodec-base-h.md#oh_avcodeconnewoutputbuffer)给出。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。      <br>[AV_ERR_OPERATE_NOT_PERMIT](capi-native-averrors-h.md#oh_averrcode)：不允许操作，这可能是由于状态不正确或不支持的操作。      <br>[AV_ERR_UNKNOWN](capi-native-averrors-h.md#oh_averrcode)：发生内部错误，建议检查日志。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：输入参数为nullptr或无效。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：OH_AVCodec实例为nullptr或无效，mediaKeySystemInfo实例为nullptr或无效。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：编解码器服务不可用。      <br>[AV_ERR_NO_MEMORY](capi-native-averrors-h.md#oh_averrcode)：请求内存失败。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：执行失败，输入参数错误。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：执行失败，状态非法，没有启动编解码器等。      <br>[AV_ERR_OPERATE_NOT_PERMIT](capi-native-averrors-h.md#oh_averrcode)：执行失败，不允许非同步模式下调用。      <br>[AV_ERR_TRY_AGAIN_LATER](capi-native-averrors-h.md#oh_averrcode)：执行失败，超时时间内获取不到可用的缓冲区。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AVErrCode | [AV_ERR_OK](capi-native-averrors-h.md#oh_averrcode)：执行成功。      <br>[AV_ERR_INVALID_VAL](capi-native-averrors-h.md#oh_averrcode)：执行失败，输入参数错误。      <br>[AV_ERR_INVALID_STATE](capi-native-averrors-h.md#oh_averrcode)：执行失败，状态非法，没有启动编解码器等。      <br>[AV_ERR_OPERATE_NOT_PERMIT](capi-native-averrors-h.md#oh_averrcode)：执行失败，不允许非同步模式下调用。      <br>[AV_ERR_STREAM_CHANGED](capi-native-averrors-h.md#oh_averrcode)：解码输出流格式发生变化, 可以通过调用[OH_AudioCodec_GetOutputDescription](capi-native-avcodec-audiocodec-h.md#oh_audiocodec_getoutputdescription)接口获取新的流信息。      <br>[AV_ERR_TRY_AGAIN_LATER](capi-native-averrors-h.md#oh_averrcode)：执行失败，超时时间内获取不到可用的缓冲区。 |
