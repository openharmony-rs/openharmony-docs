...
| const char * OH_MD_KEY_LATITUDE                | 纬度的键，值类型为float，范围为[-90.0, 90.0]。<br>**起始版本：** 24 |
| const char * OH_MD_KEY_LONGITUDE               | 经度的键，值类型为float，范围为[-180.0, 180.0]。<br>**起始版本：** 24 |
| const char * OH_MD_KEY_ALTITUDE                | 海拔的键，值类型为float，该键是可选的。<br>**起始版本：** 24 |
