...
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<huksExternalCrypto.HuksExternalCryptoParam> \| HuksCryptoExtensionParam[] | 是 | 操作属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| params | [Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-array-c.md)<huksExternalCrypto.HuksExternalCryptoParam> \| HuksCryptoExtensionParam[] | 否 | 操作属性 |
...
| wrappedKey | [Uint8Array](../../apis-arkts/arkts-apis/arkts-arkts-collections-uint8array-c.md) | 是 | 封装密钥数据，格式由密钥扩展定义。 |
