...
| attestKeyItem | 获取密钥证书。使用callback异步回调。 |
...
| importWrappedKeyItem | Imports a wrapped key. This API uses an asynchronous callback to return the result. |
