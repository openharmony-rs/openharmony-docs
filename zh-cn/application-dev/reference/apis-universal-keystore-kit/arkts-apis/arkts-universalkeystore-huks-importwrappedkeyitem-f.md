...
Imports a wrapped key. This API uses an asynchronous callback to return the result. > **说明：** > > 导入[HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中定义的SE安全级别加密密钥需要ohos.permission.ACCESS\_SE\_KEY权限。
...
Imports a wrapped key. This API uses a promise to return the result. > **说明：** > > 导入[HuksKeySecurityLevel]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_中定义的SE安全级别加密密钥需要ohos.permission.ACCESS\_SE\_KEY权限。
