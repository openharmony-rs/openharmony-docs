...
| huksOptions | HuksOptions | 是 | ���ڲ�ѯʱָ����Կ������TAG����ʹ��<br/>[HuksAuthStorageLevel](arkts-universalkeystore-huks-huksauthstoragelevel-e.md#HuksAuthStorageLevel)ָ�����ѯ��Կ�İ�ȫ����<br/>�ɴ��գ���API version ��<br/>12ʱ������Ĭ��ΪCE����API version �� 12ʱ������Ĭ��ΪDE�� |
