...
| [bool OH_AudioStreamManager_IsDirectPlaybackSupported(OH_AudioStreamManager *streamManager, OH_AudioStreamInfo *streamInfo, OH_AudioStream_Usage usage)](#oh_audiostreammanager_isdirectplaybacksupported) | 查询当前设备在特定音频流信息和使用场景下是否支持透传通路播放。 |
| [bool OH_AudioStreamManager_IsOffloadPlaybackSupported(OH_AudioStreamManager *streamManager, OH_AudioStreamInfo *streamInfo, OH_AudioStream_Usage usage)](#oh_audiostreammanager_isoffloadplaybacksupported) | 查询当前设备在特定音频流信息和使用场景下是否支持低功耗通路播放。 |
...
查询当前设备在特定音频流信息和使用场景下是否支持透传通路播放。
...
| 类型 | 说明 |
| -- | -- |
| bool | 返回true时表示支持透传通路播放，返回false时表示不支持。 |
...
查询当前设备在特定音频流信息和使用场景下是否支持低功耗通路播放。
...
| 类型 | 说明 |
| -- | -- |
| bool | 返回true时表示支持低功耗通路播放，返回false时表示不支持。 |
