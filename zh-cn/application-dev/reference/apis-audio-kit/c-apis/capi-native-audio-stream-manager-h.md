...
| 类型 | 说明 |
| -- | -- |
| OH_AudioCommon_Result | AUDIOCOMMON_RESULT_SUCCESS = 0：函数执行成功。<br>     <br>AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM = 6800101：<br>     <br>1. 参数audioStreamManager为nullptr；<br>     <br>2. 参数streamInfo为nullptr；<br>     <br>3. 参数usage无效；<br>     <br>4. 参数directPlaybackMode为nullptr。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_AudioCommon_Result | AUDIOCOMMON_RESULT_SUCCESS = 0 ：函数执行成功。<br>     <br>AUDIOCOMMON_RESULT_ERROR_INVALID_PARAM = 6800101 ：<br>     <br>1.参数audioStreamManager为nullptr；<br>     <br>2.参数sourceType无效；<br>     <br>3.参数supported为nullptr。 |
