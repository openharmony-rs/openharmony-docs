...
| AUDIOCOMMON_RESULT_ERROR_PERMISSION_DENIED = 201 | 调用方没有所需权限。<br>**起始版本：** 26.0.0 |
...
| AUDIOCOMMON_RESULT_ERROR_FRAME_LENGTH_MISMATCH = 6800106 | 输入音频数据与所需帧长不匹配。<br>**起始版本：** 26.0.0 |
