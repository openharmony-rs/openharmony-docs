...
audioCapturer.getBufferSize((err: BusinessError | null, bufferSize: long | undefined) => {
  if (err) {
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off('periodReach')](#offaudiointerrupt10)。
...
**相关接口：** 该接口对应的ArkTS-sta接口是[onInputDeviceChange](#onInputDeviceChange22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offInputDeviceChange](#offInputDeviceChange22)。
