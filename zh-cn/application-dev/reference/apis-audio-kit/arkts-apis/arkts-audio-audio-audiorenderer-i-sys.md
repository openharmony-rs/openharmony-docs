...
> 
> - 将渲染目标更改为非[RenderTarget](arkts-audio-audio-rendertarget-e-sys.md).PLAYBACK模式后：
> 
...
| --- | --- | --- | --- |
| target | [RenderTarget](arkts-audio-audio-rendertarget-e-sys.md) | 是 | 设置音频渲染目标。 |
| targetParams | [AudioRendererTargetParams](arkts-audio-audio-audiorenderertargetparams-i-sys.md) | 否 | 设置音频渲染器渲染目标的选项。<br>此参数仅在渲染目标为非[RenderTarget](arkts-audio-audio-rendertarget-e-sys.md).PLAYBACK模式时生效，若未指定此参数，渲染流将默认注入所有VoIP采集流。 |
