...
| 类型 | 说明 |
| --- | --- |
| Array&lt;[NoiseReductionMode](arkts-audio-audio-noisereductionmode-e.md)&gt; | 支持的录音降噪模式数组，默认支持[NoiseReductionMode.FIDELITY](arkts-audio-audio-noisereductionmode-e.md)。 |
