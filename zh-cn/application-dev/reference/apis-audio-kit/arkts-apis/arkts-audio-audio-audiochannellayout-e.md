...
声道排序为ACN\_N3D（根据ITU标准）的一阶FOA文件。
...
声道排序为ACN\_SN3D（根据ITU标准）的一阶FOA文件。
...
声道排序为ACN\_N3D（根据ITU标准）的二阶HOA文件。
...
声道排序为ACN\_SN3D（根据ITU标准）的二阶HOA文件。
...
声道排序为ACN\_N3D（根据ITU标准）的三阶HOA文件。
...
声道排序为ACN\_SN3D（根据ITU标准）的三阶HOA文件。
