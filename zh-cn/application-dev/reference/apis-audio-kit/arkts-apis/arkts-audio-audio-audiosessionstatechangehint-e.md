...
枚举用于音频会话状态变更提示。 当用户监听到音频会话状态变化事件（即收到[AudioSessionStateChangedEvent]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_事件）时，获取相关信息。 此类型表示根据焦点策略对音频会话执行的操作，包括暂停、调整音量等。 详情请参阅文档\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
提示音频会话躲避开始，降低音量播放。 如果已启用 [enableMuteSuggestionWhenMixWithOthers]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，此时 可以选择执行静音操作。
...
提示音频会话躲避结束，恢复音量播放。 如果已启用 [enableMuteSuggestionWhenMixWithOthers]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，此时 可取消静音。
...
提示音频会话静音。 该提示仅在以下条件满足后才会收到：通过接口[setAudioSessionBehavior]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置参数 [AudioSessionBehaviorFlags]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.MUTE\_WHEN\_INTERRUPTED，并已调用 [setAudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，且音频会话已激活。
...
提示音频会话解除静音，恢复播放。 该提示仅在以下条件满足后才会收到：通过接口[setAudioSessionBehavior]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_设置参数 [AudioSessionBehaviorFlags]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_.MUTE\_WHEN\_INTERRUPTED，并已调用 [setAudioSessionScene]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_，且音频会话已激活。
