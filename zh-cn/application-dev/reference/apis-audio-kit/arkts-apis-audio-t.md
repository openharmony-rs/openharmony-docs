...
**相关接口：** 该接口对应的ArkTS-Sta接口是[AudioRendererWriteDataCallback](#audiorendererwritedatacallback23)。
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[AudioRendererWriteDataCallback](#audiorendererwritedatacallback12)。
