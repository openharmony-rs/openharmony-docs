...
| hapticUri | string                                  | 是   | 振动资源的Uri。<br>振动资源格式支持可参考[HapticFileDescripto](../apis-sensor-service-kit/js-apis-vibrator.md#hapticfiledescriptor10)，路径格式需满足[fileIo.open](../apis-core-file-kit/js-apis-file-fs.md#fileioopen)的要求。<br>建议传入文件的绝对路径。         |
