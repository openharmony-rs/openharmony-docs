...
| hapticUri | string                                  | 是   | 振动资源的Uri。<br>振动资源格式支持可参考[HapticFileDescriptor](../apis-sensor-service-kit/js-apis-vibrator.md#hapticfiledescriptor10)，路径格式需满足[fs.open](../apis-core-file-kit/js-apis-file-fs.md#fsopen)的要求。<br>建议传入文件的绝对路径。         |
