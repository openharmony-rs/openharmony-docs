...
| VOIP_PRIVACY_TYPE_PUBLIC = 0x00000001 | 非隐私VoIP，允许被录音。允许VoIP录音流与其他应用的录音流共同录音。<br>**起始版本：** 26 |
