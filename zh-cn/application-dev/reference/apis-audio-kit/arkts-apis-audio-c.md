...
| 名称                                    | 类型      | 只读 | 说明               |
| --------------------------------------- | ----------|---| ------------------ |
| DEFAULT_VOLUME_GROUP_ID<sup>9+</sup>    | ArkTS-Dyn: number<br>ArkTS-Sta: int    | 是 | 默认音量组id。<br> **系统能力：** SystemCapability.Multimedia.Audio.Volume<br> **ArkTS-Dyn起始版本：** 12<br> **ArkTS-Sta起始版本：** 20       |
