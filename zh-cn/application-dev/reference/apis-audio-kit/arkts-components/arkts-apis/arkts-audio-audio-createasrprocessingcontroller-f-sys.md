...
获取自动语音识别（ASR）处理控制器。用于系统语音助手应用。支持SourceType为[SOURCE_TYPE_VOICE_RECOGNITION](arkts-audio-audio-sourcetype-e.md)或[SOURCE_TYPE_WAKEUP](arkts-audio-audio-sourcetype-e.md)的音频采集器。
