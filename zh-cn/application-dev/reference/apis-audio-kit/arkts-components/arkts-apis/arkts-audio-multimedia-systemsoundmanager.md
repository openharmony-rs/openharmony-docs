...
| 名称 | 说明 |
| --- | --- |
| [createSystemSoundPlayer](arkts-audio-systemsoundmanager-createsystemsoundplayer-f.md) | 创建系统音效播放器对象。使用Promise异步回调。 |
...
| 名称 | 说明 |
| --- | --- |
| [createCustomizedToneAttrs](arkts-audio-systemsoundmanager-createcustomizedtoneattrs-f-sys.md) | 创建自定义铃声属性。 |
| [getSystemSoundManager](arkts-audio-systemsoundmanager-getsystemsoundmanager-f-sys.md) | 获取系统声音管理器。 |
<!--DelEnd-->
