...
- [@ohos.multimedia.audio(音频渲染、采集和管理)](arkts-audio-multimedia-audio.md)
  <!--Del-->
...
- [@ohos.multimedia.audioHaptic(音振协同)](arkts-audio-multimedia-audiohaptic.md)
...
- [@ohos.multimedia.systemSoundManager(系统声音管理)](arkts-audio-multimedia-systemsoundmanager.md)
  <!--Del-->
...
- multimedia<!--arkts-audiokit-multimedia-->
  <!--Del-->
  - [ringtonePlayer(铃声播放器)](arkts-audio-ringtoneplayer.md)<!--DelEnd-->
    <!--Del-->
  ...
  <!--Del-->
  - [systemTonePlayer(系统提示音播放器)](arkts-audio-systemtoneplayer.md)<!--DelEnd-->
    <!--Del-->
