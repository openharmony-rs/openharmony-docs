...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onOutputDeviceChange](#onOutputDeviceChange22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offOutputDeviceChange](#offOutputDeviceChange22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onOutputDeviceChangeWithInfo](#onOutputDeviceChangeWithInfo22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offOutputDeviceChangeWithInfo](#offOutputDeviceChangeWithInfo22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onWriteData](#onWriteData22)。
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offWriteData](#offWriteData22)。
