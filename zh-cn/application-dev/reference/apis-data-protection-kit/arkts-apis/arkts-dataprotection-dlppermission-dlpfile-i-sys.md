...
/[openDLPFile](arkts-dataprotection-dlppermission-opendlpfile-f-sys.md#openDLPFile-1)获取DLPFile的实例。DLPFile对象代表一个已打开
...
| [401](../../errorcode-universal.md#401-Parameter) | Parameter error. Possible causes: 1. Mandatory parameters are left<br/>unspecified.<br/>2. Incorrect parameter types. |
...
| [19100009](../../errorcode-universal.md#19100009-Failed) | Failed to operate the DLP file. |
| [19100010](../../errorcode-universal.md#19100010-The) | The DLP file is read only. |
| [19100011](../../errorcode-universal.md#19100011-The) | The system ability works abnormally. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| plaintextFd | number | 是 | 目标明文文件的fd。取值范围为[0, 231-1]。超出范围时该数值会被截断。 |
