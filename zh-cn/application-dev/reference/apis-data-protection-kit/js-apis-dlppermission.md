...
| 参数名 | 类型 | 必填 | 说明 |
| -------- | -------- | -------- | -------- |
| appLists | Array&lt;string&gt; | 是 | 被管控的应用的appIdentifier列表。|
...
| 19100001 | Invalid parameter value. |
| 19100011 | The system ability works abnormally. |
| 19110005 | The specified userId is inconsistent with the current userId. |
| 19110006 | The specified userId belongs to a personal space user and cannot be controlled. |
