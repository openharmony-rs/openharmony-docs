...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| seaPressure | double | 是 | 海平面气压值，单位为hPa。 |
| currentPressure | double | 是 | 指定的气压值，单位为hPa。 |
| callback | [AsyncCallback](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;double&gt; | 是 | 回调函数，异步返回指定的气压值对应的海拔高度，单位为米。 |
