...
| options | [Options](arkts-sensorservice-sensor-options-i.md) | 否 | 可选参数列表，当霍尔事件被触发得很频繁时，用于设置传感器上报频率，默认值为200000000ns（即200ms）。 |
...
| options | [Options](arkts-sensorservice-sensor-options-i.md) | 否 | 可选参数列表，用于设置传感器上报频率，默认值为200000000ns（即200ms）。当接近光事件被触发得很频繁时，该参数用于限定事件上报的频率。 |
...
| options | [Options](arkts-sensorservice-sensor-options-i.md) | 否 | 可选参数列表，当接近光事件被触发得很频繁时，用于设置传感器上报频率，默认值为200000000ns（即200ms）。 |
