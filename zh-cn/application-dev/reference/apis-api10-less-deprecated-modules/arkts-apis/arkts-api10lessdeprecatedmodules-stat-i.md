...
文件具体信息，在调用Stat的方法前，需要先通过[stat()](arkts-api10lessdeprecatedmodules-fileio-stat-f.md#stat-1)方法（同步或异步）来构建一个Stat实例。

**起始版本：** 6

**废弃版本：** 9

**替代接口：** [fs:Stat](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#Stat)
...
**替代接口：** [isBlockDevice](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isBlockDevice-1)
...
**替代接口：** [isCharacterDevice](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isCharacterDevice-1)
...
**替代接口：** [isDirectory](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isDirectory-1)
...
**替代接口：** [isFIFO](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isFIFO-1)
...
**替代接口：** [isFile](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isFile-1)
...
**替代接口：** [isSocket](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isSocket-1)
...
**替代接口：** [isSymbolicLink](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#isSymbolicLink-1)
...
**替代接口：** [atime](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#atime)
...
**替代接口：** [ctime](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#ctime)
...
**替代接口：** [gid](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#gid)
...
**替代接口：** [mode](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#mode)
...
**替代接口：** [mtime](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#mtime)
...
**替代接口：** [size](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#size)
...
**替代接口：** [uid](../../apis-core-file-kit/arkts-apis/arkts-corefile-stat-i.md#uid)
