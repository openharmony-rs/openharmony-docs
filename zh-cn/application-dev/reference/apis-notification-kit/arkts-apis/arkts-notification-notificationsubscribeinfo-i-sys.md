...
[userInput](arkts-notification-notificationactionbutton-i.md#NotificationActionButton)为空的通知过滤掉。
- 2：将渠道类型为[SOCIAL_COMMUNICATION](arkts-notification-notificationmanager-slottype-e.md#SlotType)且
[userInput](arkts-notification-notificationactionbutton-i.md#NotificationActionButton)不为空的通知过滤掉。
