...
按钮图标列表，与names一一对应，每个图标显示在对应按钮上。最多支持3个。 图标像素的总字节数不超过192KB（图标像素的总字节数通过 [getPixelBytesNumber]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取）， 建议图标像素长宽为128*128。默认为空。该属性与iconsResource互斥，只使用其中一个即可。
