...
是否启用横幅功能。默认值为TYPE\_NONE。设置时仅[TYPE\_CLOSE]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_会生效。
...
是否启用锁屏功能。默认值为TYPE\_NONE。设置时仅[TYPE\_CLOSE]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_会生效。
...
是否启用声音提示功能。默认值为TYPE\_NONE。从API version 23开始成为可写参数，设置时仅[TYPE\_CLOSE]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_会生效。
...
是否启用振动提醒功能。默认值为TYPE\_NONE。从API version 23开始成为可写参数，设置时仅[TYPE\_CLOSE]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_会生效。
