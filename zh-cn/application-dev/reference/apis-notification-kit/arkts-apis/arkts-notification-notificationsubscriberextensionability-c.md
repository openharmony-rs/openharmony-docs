...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| notificationInfo | NotificationInfo | 是 | 通知订阅扩展能力中<br/>[onReceiveMessage](arkts-notification-notificationsubscriberextensionability-c.md#onReceiveMessage-1)<br/>回调的通知信息。 |
