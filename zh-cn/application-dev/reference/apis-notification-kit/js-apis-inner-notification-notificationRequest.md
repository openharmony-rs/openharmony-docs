...
| priorityNotificationType<sup>23+</sup>  | [PriorityNotificationType](js-apis-notificationManager-sys.md#prioritynotificationtype23) | 否 | 是 | 通知优先级类型，用于判断是否高亮通知背景并置顶。 |
