...
| notificationFlags<sup>8+</sup> | [NotificationFlags](js-apis-inner-notification-notificationFlags.md)                   |   否  | 是  | 设置或获取NotificationFlags。从API version 23开始成为可写参数。                                                  |
...
| priorityNotificationType<sup>23+</sup>  | [notificationManager.PriorityNotificationType](js-apis-notificationManager.md#prioritynotificationtype23) | 否 | 是 | 通知优先级类型，用于判断此通知是否需要优先显示。<!--RP2--><!--RP2End--><br>**模型约束：** 此接口仅可在Stage模型下使用。 |
