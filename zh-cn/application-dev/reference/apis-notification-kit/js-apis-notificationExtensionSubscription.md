...
打开应用的通知扩展订阅设置页面，以半模态弹窗显示。用户可在该页面设置通知的启用状态及模式。
...
| 参数名     | 类型                                        | 必填 | 说明                                        |
| -------- | ------------------------------------------- | ---- | ------------------------------------------- |
| info  | [NotificationExtensionSubscriptionInfo[]](js-apis-inner-notificationExtensionSubscriptionInfo.md#NotificationExtensionSubscriptionInfo) | 是   | 订阅的信息列表（数组）。 |
...
| 类型     | 说明        | 
| ------- |-----------|
| Promise\<[NotificationExtensionSubscriptionInfo[]](js-apis-inner-notificationExtensionSubscriptionInfo.md)\> | Promise 对象，其中包含一个NotificationExtensionSubscriptionInfo对象数组，表示应用的订阅信息。 |
...
| 类型     | 说明        | 
| ------- |-----------|
| Promise\<boolean\> | Promise对象。表示功能是否被启用。 | 
...
| 类型     | 说明        | 
| ------- |-----------|
| Promise\<String[]\>   | Promise对象，其中包含被授权可接收哪些应用通知消息的应用名。        |
