...
| 名称                 | 类型                 | 只读 | 可选 | 说明                   |
| -------------------- | ---------------------|---- | --- |----------------------|
| notificationType<sup>11+</sup>                 | [notificationManager.SlotType](js-apis-notificationManager.md#slottype) | 否 | 是  | 渠道类型。<br/> **ArkTS-Dyn起始版本**：11<br/>**ArkTS-Sta起始版本**：23 |
| enabled<sup>9+</sup> | boolean               | 是 | 是  | 表示是否允许发布此通知渠道的通知。<br> - true：允许发布通知。<br> - false：禁止发布通知。<br/> **ArkTS-Dyn起始版本**：9<br/>**ArkTS-Sta起始版本**：23   |
