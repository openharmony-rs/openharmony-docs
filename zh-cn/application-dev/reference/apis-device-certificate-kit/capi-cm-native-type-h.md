...
| [OH_CM_Credential](capi-certmanagertype-oh-cm-credential.md) | 定义证书凭据详情的结构体类型。 |
| [OH_CM_CredentialDetailList](capi-hukstypeapi-oh-huks-param.md) | 定义证书凭据详情列表的结构体类型。 |
...
| OH_CM_INNER_FAILURE = 17500001 | 内部错误。 |
