...
| 名称                                  | 值   | 说明                          |
| --------------------------------------| -------- | -----------------------------|
| INVALID_PARAMS                        | 401      | 非法入参。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22                    |
| NOT_SUPPORT                           | 801      | 操作不支持。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。  <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22               |
| ERR_OUT_OF_MEMORY                     | 19020001 | 内存错误。   <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。  <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22               |
| ERR_RUNTIME_ERROR                     | 19020002 | 运行时外部错误。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。  <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22            |
| ERR_PARAMETER_CHECK_FAILED<sup>20+</sup>             | 19020003 | 参数检查失败。 <br> **原子化服务API：** 从API version 20开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 20 <br>**ArkTS-Sta起始版本：** 22              |
| ERR_CRYPTO_OPERATION                  | 19030001 | 调用三方算法库API出错。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22      |
| ERR_CERT_SIGNATURE_FAILURE            | 19030002 | 证书签名验证错误。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22          |
| ERR_CERT_NOT_YET_VALID                | 19030003 | 证书尚未生效。  <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。    <br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22          |
| ERR_CERT_HAS_EXPIRED                  | 19030004 | 证书过期。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22                  |
| ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY | 19030005 | 无法获取证书的颁发者。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22       |
| ERR_KEYUSAGE_NO_CERTSIGN              | 19030006 | 证书的密钥用途不含证书签名。 <br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22  |
| ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE     | 19030007 |  证书的密钥用途不含数字签名。<br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22  |
| ERR_MAYBE_WRONG_PASSWORD<sup>18+</sup>              | 19030008 | 私钥密码错误。 <br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22       |
...
| 名称       | 值 |  说明      |
| ---------- | ------ | --------- |
| FORMAT_DER | 0      | DER格式。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22 |
| FORMAT_PEM | 1      | PEM格式。<br>**ArkTS-Dyn起始版本：** 9 <br>**ArkTS-Sta起始版本：** 22 |
| FORMAT_PKCS7<sup>11+</sup> | 2 | PKCS7格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称           | 类型                              | 只读 | 可选 | 说明               |
| -------------- | --------------------------------- | ---- | ---- |------------------ |
| x509Cert | [X509Cert](#x509cert)    | 否 | 是 | 指定具体的证书对象。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22  |
| validDate | string    | 否  |  是 |指定证书有效期。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22  |
| issuer | Uint8Array | 否  | 是 |指定证书颁发者，为DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| keyUsage | Array\<boolean> | 否  | 是 |指定是否需要匹配密钥用途。true为需要，false为不需要。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| serialNumber | bigint    | 否  |  是 |指定证书的序列号。 <br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| subject | Uint8Array | 否  | 是 |指定证书主题，DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| publicKey | [DataBlob](#datablob) | 否  | 是 |指定证书公钥，DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| publicKeyAlgID | string | 否  | 是 |指定证书公钥的算法。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| subjectAlternativeNames<sup>12+</sup> | Array\<[GeneralName](#generalname12)> | 否  | 是 |指定证书主体名称。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| matchAllSubjectAltNames<sup>12+</sup> | boolean | 否  | 是 |指定是否需要匹配证书主体名称。true为需要，false为不需要。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| authorityKeyIdentifier<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书颁发机构密钥。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| minPathLenConstraint<sup>12+</sup> | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否  | 是 |指定证书CA路径长度。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| extendedKeyUsage<sup>12+</sup> | Array\<string> | 否  | 是 |指定证书扩展用途。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| nameConstraints<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书的使用者名称。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| certPolicy<sup>12+</sup> | Array\<string> | 否  | 是 |指定证书策略。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| privateKeyValid<sup>12+</sup> | string | 否  | 是 |指定证书私钥有效期。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22|
| subjectKeyIdentifier<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书公钥。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22|
...
| 名称           | 类型                              | 只读 | 可选 |说明               |
| -------------- | --------------------------------- | ---- | ---- | ------------------ |
| issuer | Array\<Uint8Array> | 否  | 是  |指定颁发者作为过滤条件, 至少要匹配到其中一个issuer。 <br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22|
| x509Cert | [X509Cert](#x509cert) | 否  | 是  |指定具体的证书对象作为过滤条件, 判断该证书是否在CRL列表中。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| updateDateTime<sup>12+</sup> | string | 否  | 是  |指定证书更新时间。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22|
| maxCRL<sup>12+</sup> | bigint | 否  | 是  |指定CRL个数最大值。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
| minCRL<sup>12+</sup> | bigint | 否  | 是  |指定CRL个数最小值。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称      | 类型                  | 只读 | 可选 | 说明                        |
| --------- | --------------------- | ---- | ---- | --------------------------- |
| CACert    | [X509Cert](#x509cert) | 否   | 是   | 信任的CA证书。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22              |
| CAPubKey  | Uint8Array            | 否   | 是   | 信任的CA证书公钥，DER格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| CASubject | Uint8Array            | 否   | 是   | 信任的CA证书主题，DER格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 22 |
| nameConstraints<sup>12+</sup> | Uint8Array      | 否   | 是   | 名称约束，DER格式。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称                                  | 值   | 说明                          |
| --------------------------------------| -------- | -----------------------------|
| SIGNED_DATA | 0 | 签名数据。<br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22 |
...
| 名称         | 类型                                                  |  只读  |  可选  |说明                                   |
| ------------ | ------------------------------------------------- | ---- | ---- |-------------------------------------- |
| mdName                | string             | 否  | 否  |消息摘要算法的名称，例如 "SHA384", 当前支持"SHA1"、"SHA256"、"SHA384"、"SHA512"。 <br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22                |
...
| addCert               | boolean            | 否   | 是  |是否添加证书。默认为true。true为需要，false为不需要。 <br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22                            |
| addAttr               | boolean            | 否   | 是 |是否添加签名属性。默认为true。true为需要，false为不需要。<br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22           |
| addSmimeCapAttr       | boolean            | 否   | 是  |是否将SMIME能力添加到Cms对象。默认为true。true为需要，false为不需要。<br> **原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 18 <br>**ArkTS-Sta起始版本：** 22           |
