...
| 名称           | 类型                              | 只读 | 可选 | 说明               |
| -------------- | --------------------------------- | ---- | ---- |------------------ |
| x509Cert | [X509Cert](#x509cert)    | 否 | 是 | 指定具体的证书对象。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23  |
| validDate | string    | 否  |  是 |指定证书有效期。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23  |
| issuer | Uint8Array | 否  | 是 |指定证书颁发者，为DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| keyUsage | Array\<boolean> | 否  | 是 |指定是否需要匹配密钥用途。true为需要，false为不需要。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| serialNumber | bigint    | 否  |  是 |指定证书的序列号。 <br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| subject | Uint8Array | 否  | 是 |指定证书主题，DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| publicKey | [DataBlob](#datablob) | 否  | 是 |指定证书公钥，DER编码格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| publicKeyAlgID | string | 否  | 是 |指定证书公钥的算法。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| subjectAlternativeNames<sup>12+</sup> | Array\<[GeneralName](#generalname12)> | 否  | 是 |指定证书主体名称。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| matchAllSubjectAltNames<sup>12+</sup> | boolean | 否  | 是 |指定是否需要匹配证书主体名称。true为需要，false为不需要。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| authorityKeyIdentifier<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书颁发机构密钥。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| minPathLenConstraint<sup>12+</sup> | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否  | 是 |指定证书CA路径长度。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| extendedKeyUsage<sup>12+</sup> | Array\<string> | 否  | 是 |指定证书扩展用途。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| nameConstraints<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书的使用者名称。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| certPolicy<sup>12+</sup> | Array\<string> | 否  | 是 |指定证书策略。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
| privateKeyValid<sup>12+</sup> | string | 否  | 是 |指定证书私钥有效期。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23|
| subjectKeyIdentifier<sup>12+</sup> | Uint8Array | 否  | 是 |指定证书公钥。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23|
...
| 名称      | 类型                  | 只读 | 可选 | 说明                        |
| --------- | --------------------- | ---- | ---- | --------------------------- |
| CACert    | [X509Cert](#x509cert) | 否   | 是   | 信任的CA证书。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23              |
| CAPubKey  | Uint8Array            | 否   | 是   | 信任的CA证书公钥，DER格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| CASubject | Uint8Array            | 否   | 是   | 信任的CA证书主题，DER格式。<br>**ArkTS-Dyn起始版本：** 11 <br>**ArkTS-Sta起始版本：** 23 |
| nameConstraints<sup>12+</sup> | Uint8Array      | 否   | 是   | 名称约束，DER格式。<br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23 |
...
| REVOCATION_CHECK_OPTION_ACCESS_NETWORK | 1 | 支持通过访问网络获取CRL或OCSP响应进行吊销状态的校验，默认为关闭。仅支持从证书CDP扩展中获取第一个CRL分发点地址检查证书吊销状态，或从证书AIA扩展中获取第一个OCSP服务器地址检查证书吊销状态。必须声明ohos.permission.INTERNET权限。<br> **原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 12 <br>**ArkTS-Sta起始版本：** 23|
...
| REVOCATION_CHECK_OPTION_CHECK_INTERMEDIATE_CA_ONLINE<sup>22+</sup> | 4 | 当ACCESS_NETWORK选项打开时有效。如果开启了该能力，对终端实体证书OCSP或CRL校验失败，则会继续校验中间证书的吊销情况。默认关闭。<br> **原子化服务API：** 从API version 22开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 22 <br>**ArkTS-Sta起始版本：** 23 |
| REVOCATION_CHECK_OPTION_LOCAL_CRL_ONLY_CHECK_END_ENTITY_CERT<sup>22+</sup> | 5 | 如果开启了该能力，则会拿本地吊销列表校验终端实体证书的吊销情况。默认关闭。<br> **原子化服务API：** 从API version 22开始，该接口支持在原子化服务中使用。  <br>**ArkTS-Dyn起始版本：** 22 <br>**ArkTS-Sta起始版本：** 23|
...
| allowDownloadIntermediateCa<sup>23+</sup>| boolean | 否   | 是  |表示是否允许尝试从网络下载缺失的中间CA证书。<br>true表示允许；false表示不允许。默认值为false。<br>下载地址将从证书AIA扩展中获取，如需使用网络下载，需申请ohos.permission.INTERNET权限。<br> **原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。 <br>**ArkTS-Dyn起始版本：** 23 <br>**ArkTS-Sta起始版本：** 23|
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let pubKey = x509Cert.getPublicKey();
          console.info('getPublicKey success');
        } catch (error) {
          let e: BusinessError = error as BusinessError;
          console.error('getPublicKey failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
...
function TestGetVersion() {
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        let version = x509Cert.getVersion();
        console.info('getVersion success');
      }
    }
  });
}
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let serialNumber = x509Cert.getCertSerialNumber();
          console.info('getCertSerialNumber success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getCertSerialNumber failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let issuerName = x509Cert.getIssuerName();
          console.info('getIssuerName success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getIssuerName failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let subjectName = x509Cert.getSubjectName();
          console.info('getSubjectName success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSubjectName failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let notBefore = x509Cert.getNotBeforeTime();
          console.info('getNotBeforeTime success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getNotBeforeTime failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let notAfter = x509Cert.getNotAfterTime();
          console.info('getNotAfterTime success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getNotAfterTime failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let signature = x509Cert.getSignature();
          console.info('getSignature success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSignature failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let sigAlgName = x509Cert.getSignatureAlgName();
          console.info('getSignatureAlgName success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSignatureAlgName failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let sigAlgOid = x509Cert.getSignatureAlgOid();
          console.info('getSignatureAlgOid success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSignatureAlgOid failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let sigAlgParams = x509Cert.getSignatureAlgParams();
          console.info('getSignatureAlgParams success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSignatureAlgParams failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let keyUsage = x509Cert.getKeyUsage();
          console.info('getKeyUsage success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getKeyUsage failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let extKeyUsage = x509Cert.getExtKeyUsage();
          console.info('getExtKeyUsage success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getExtKeyUsage failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let basicConstraints = x509Cert.getBasicConstraints();
          console.info('getBasicConstraints success.');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let subjectAltNames = x509Cert.getSubjectAltNames();
          console.info('getSubjectAltNames success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getSubjectAltNames failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509Cert(encodingBlob, (error, x509Cert) => {
    if (error) {
      ...
      if (x509Cert != undefined) {
        try {
          let issuerAltNames = x509Cert.getIssuerAltNames();
          console.info('getIssuerAltNames success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getIssuerAltNames failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
...
async function certGetCRLDistributionPoint() {
  ...
  try {
    ...
    console.info('createX509Cert success');
    let point = x509Cert.getCRLDistributionPoint();
    console.info('getCRLDistributionPoint success');
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error('createX509Cert failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
...
async function certGetIssuerX500DistinguishedName() {
  ...
  try {
    ...
    console.info('createX509Cert success');
    let name = x509Cert.getIssuerX500DistinguishedName();
    console.info('getIssuerX500DistinguishedName success');
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error('createX509Cert failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
...
async function certGetSubjectX500DistinguishedName() {
  ...
  try {
    ...
    console.info('createX509Cert success');
    let name = x509Cert.getSubjectX500DistinguishedName();
    console.info('getSubjectX500DistinguishedName success');
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error('createX509Cert failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
...
async function certGetExtensionsObject() {
  ...
  try {
    ...
    console.info('getExtensionsObject success');
  } catch (err) {
    let e: BusinessError = err as BusinessError;
    console.error('createX509Cert failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
...
function TestCreateCertExtension() {
  // 证书扩展域段二进制数据，需业务自行赋值。
  let extData = new Uint8Array([
    0x30, 0x40, 0x30, 0x0F, 0x06, 0x03, 0x55, 0x1D,
    0x13, 0x01, 0x01, 0xFF, 0x04, 0x05, 0x30, 0x03,
  ...
  cert.createCertExtension(encodingBlob, (error, certExt) => {
    if (error) {
      ...
      if (certExt != undefined) {
        try {
          let oidList = certExt.getOidList(cert.ExtensionOidType.EXTENSION_OID_TYPE_ALL);
          console.info('getOidList success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('ext getOidList failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
...
function TestCreateX509CRL() {
  ...
  try {
    let X509CRL = cert.createX509CRL(encodingBlob);
    console.info('createX509CRL success');
  } catch (err) {
    let e: BusinessError = err as BusinessError;
      ...
      cert.createX509Cert(certEncodingBlob, (error, x509Cert) => {
        if (error) {
          ...
          if (x509CRL != undefined && x509Cert != undefined) {
            try {
              let revokedFlag = x509CRL.isRevoked(x509Cert);
              console.info('isRevoked success');
            } catch (error) {
              let e: BusinessError = error as BusinessError;
              console.error('isRevoked failed, errCode: ' + e.code + ', errMsg: ' + e.message);
            }
  ...
  cert.createX509CRL(encodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      if (x509CRL != undefined) {
        try {
          let lastUpdate  = x509CRL.getLastUpdate();
          console.info('getLastUpdate success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getLastUpdate failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509CRL(encodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      if (x509CRL != undefined) {
        try {
          let nextUpdate = x509CRL.getNextUpdate();
          console.info('getNextUpdate success');
        } catch (err) {
          let e: BusinessError = err as BusinessError;
          console.error('getNextUpdate failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509CRL(encodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      if (x509CRL != undefined) {
        try {
          let entry = x509CRL.getRevokedCert(serialNumber);
          console.info('getRevokedCert success');
        } catch (error) {
          let e: BusinessError = error as BusinessError;
          console.error('getRevokedCert failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509CRL(encodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      if (x509CRL != undefined) {
        try {
          let tbsInfo = x509CRL.getTBSInfo();
          console.info('getTBSInfo success');
        } catch (error) {
          let e: BusinessError = error as BusinessError;
          console.error('getTBSInfo failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
  ...
  cert.createX509CRL(encodingBlob, (error, x509CRL) => {
    if (error) {
      ...
      if (x509CRL != undefined) {
        try {
          let extensions = x509CRL.getExtensions();
          console.info('getExtensions success');
        } catch (error) {
          let e: BusinessError = error as BusinessError;
          console.error('getExtensions failed, errCode: ' + e.code + ', errMsg: ' + e.message);
        }
...
function TestGetExtensionsObject() {
  let x509Crl: cert.X509CRL;
  try {
    x509Crl = await cert.createX509CRL(crlEncodingBlob);
    console.info('createX509CRL success');
...
function TestCreateCertChainValidator() {
  try {
    let validator = cert.createCertChainValidator('PKIX');
    console.info("createCertChainValidator success ");
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error('createCertChainValidator failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
    ...
    if (err) {
      ...
      try {
        ...
        if (x509CRL != undefined) {
          let crlEntry = x509CRL.getRevokedCert(serialNumber);
          serialNumber = crlEntry.getSerialNumber();
          console.info('getSerialNumber success');
        }
      } catch (error) {
        let e: BusinessError = error as BusinessError;
        console.error('getRevokedCert or getSerialNumber failed, errCode: ' + e.code + ', errMsg: ' + e.message);
    ...
    if (err) {
      ...
      try {
        ...
        if (x509CRL != undefined) {
          let crlEntry = x509CRL.getRevokedCert(serialNumber);
          let issuer = crlEntry.getCertIssuer();
          console.info('getCertIssuer success');
        }
      } catch (error) {
        let e: BusinessError = error as BusinessError;
        console.error('getRevokedCert or getCertIssuer failed, errCode: ' + e.code + ', errMsg: ' + e.message);
    ...
    if (err) {
      ...
      try {
        ...
        if (x509CRL != undefined) {
          let crlEntry = x509CRL.getRevokedCert(serialNumber);
          let date = crlEntry.getRevocationDate();
          console.info('getRevocationDate success');
        }
      } catch (error) {
        let e: BusinessError = error as BusinessError;
        console.error('getRevokedCert or getRevocationDate failed, errCode: ' + e.code + ', errMsg: ' + e.message);
    ...
    if (err) {
      ...
      try {
        ...
        if (x509CRL != undefined) {
          let crlEntry = x509CRL.getRevokedCert(serialNumber);
          let hasExtensions = crlEntry.hasExtensions();
          console.info('hasExtensions success');
        }
      } catch (error) {
        let e: BusinessError = error as BusinessError;
        console.error('getRevokedCert or hasExtensions failed, errCode: ' + e.code + ', errMsg: ' + e.message);
...
async function certGetCertIssuerX500DistinguishedName() {
  ...
  try {
    ...
    console.info('createX509CRL success');
    let name = x509Crl.getRevokedCert(BigInt(1000)).getCertIssuerX500DistinguishedName();
    console.info('getCertIssuerX500DistinguishedName success');
  } catch (error) {
    let e: BusinessError = error as BusinessError;
    console.error('createX509CRL failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
...
function doTestCreateTrustAnchorsWithKeyStore() {
  try {
    ...
    if (err) {
      ...
      try {
        if (certChain != undefined) {
          let certList = certChain.getCertList();
          console.info('getCertList success');
        }
      } catch (err) {
        let e: BusinessError = err as BusinessError;
        console.error('X509CertChain getCertList failed, errCode: ' + e.code + ', errMsg: ' + e.message);
...
function testSetRecipientEncryptionAlgorithm() {
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error('testSetRecipientEncryptionAlgorithm failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
}
```
...
async function testAddRecipientInfo() {
  ...
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error('testAddRecipientInfo failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
}
```
...
async function testGetEncryptedContentData() {
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error('testGetEncryptedContentData failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
}
```
...
async function testCmsVerifyTest() {
  try {
    ...
    let e: BusinessError = error as BusinessError;
    console.error('verifySignedData failed, errCode: ' + e.code + ', errMsg: ' + e.message);
  }
}
```
