...
| 名称       | 值 |  说明      |
| ---------- | ------ | --------- |
| CM_DIGEST_NONE | 0      | 选用此项时，需要应用程序传入已经计算过摘要的数据进行签名、验签。<br/>**ArkTS-Dyn起始版本**：11<br/>**ArkTS-Sta起始版本**：23 |
...
| certAlg<sup>20+</sup>   | [CertAlgorithm](#certalgorithm20) | 否   | 是  | 表示证书算法类型。仅当certType为CA_CERT_SYSTEM时有效，默认值为INTERNATIONAL。海外设备不支持SM算法。<br/>**ArkTS-Dyn起始版本**：20<br/>**ArkTS-Sta起始版本**：23 |
