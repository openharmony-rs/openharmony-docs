...
| [getAllAppPrivateCertificates](arkts-devicecertificate-certificatemanager-getallappprivatecertificates-f-sys.md#getAllAppPrivateCertificates（系统接口）) | 表示获取所有私有凭据列表。使用Promise异步回调。 |
