...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inStream | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示序列化的证书扩展数据。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;CertExtension&gt; | 是 | 回调函数。当创建证书扩展对象成功时，err为undefined，data为获取到的CertExtension实例；否则为错误对象。 |
