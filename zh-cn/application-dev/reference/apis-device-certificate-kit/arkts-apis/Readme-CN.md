...
- [@ohos.security.certManager](arkts-security-certmanager.md)
  ...
  - [getUkeyCertificate](arkts-devicecertificate-certificatemanager-getukeycertificate-f.md)<!--Del-->
  - [getSystemTrustedCertificateList(系统接口)](arkts-devicecertificate-certificatemanager-getsystemtrustedcertificatelist-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [installUserTrustedCertificate](arkts-devicecertificate-certificatemanager-installusertrustedcertificate-f.md)<!--Del-->
  - [uninstallAllUserTrustedCertificate(系统接口)](arkts-devicecertificate-certificatemanager-uninstallallusertrustedcertificate-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [grantPublicCertificate(系统接口)](arkts-devicecertificate-certificatemanager-grantpubliccertificate-f-sys.md)<!--DelEnd--><!--Del-->
  - [getAuthorizedAppList(系统接口)](arkts-devicecertificate-certificatemanager-getauthorizedapplist-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [installSystemAppCertificate(系统接口)](arkts-devicecertificate-certificatemanager-installsystemappcertificate-f-sys.md)<!--DelEnd--><!--Del-->
  ...
  - [getUkeyCertificateList](arkts-devicecertificate-certificatemanager-getukeycertificatelist-f.md)<!--Del-->
  ...
  - [CMErrorCode(系统接口)](arkts-devicecertificate-certificatemanager-cmerrorcode-e-sys.md)
