...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md)&gt; | Promise对象，返回获取系统应用凭据详细信息的结果，返回值为[CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md)对象中的credential属性。 |
...
| [401](../../errorcode-universal.md#401-函数参数数量或参数类型不匹配) | Parameter verification failed.<br> Possible causes: the URI is null or the URI format is wrong. |
