...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md)&gt; | Promise对象，返回安装用户CA证书的结果，返回值为[CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md)对象中的uri属性。 |
...
| [401](../../errorcode-universal.md#401-函数参数数量或参数类型不匹配) | Parameter verification failed. Possible causes:<br>the certData parameter is empty or exceeds the maximum length . |
