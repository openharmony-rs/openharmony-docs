...
| certScope | CertScope | 是 | 表示CA证书安装的位置。 |
...
| [17500007](../errorcode-certManager.md#17500007-设备进入坚盾守护模式) | Indicates that the device enters advanced security mode. In this mode, theuser CA certificate cannot be installed. |
