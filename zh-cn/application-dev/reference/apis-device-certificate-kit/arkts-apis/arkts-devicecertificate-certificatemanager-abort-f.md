...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handle | Uint8Array | 是 | ��ʾ��ʼ���������صľ����<br/><br/>��󳤶�Ϊ8�ֽڡ� |
| callback | AsyncCallback&lt;void&gt; | 是 | �ص�����������ֹǩ������ǩ�ɹ�ʱ��errΪnull������Ϊ������� |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handle | Uint8Array | 是 | ��ʾ��ʼ���������صľ������󳤶�Ϊ8�ֽڡ� |
