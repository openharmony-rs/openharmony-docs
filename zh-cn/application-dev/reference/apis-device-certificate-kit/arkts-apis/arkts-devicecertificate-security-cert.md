...
| createCertExtension | 创建一个证书扩展对象。使用Callback异步回调。 |
...
| createX500DistinguishedName | 表示使用字符串格式的名称创建X500DistinguishedName对象。使用Promise方式返回结果。 |
