...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| inStream | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 表示证书吊销列表序列化数据。当前支持的数据长度不超过8192字节。 |
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;X509CRL&gt; | 是 | 回调函数。当创建X.509证书吊销列表对象成功时，err为undefined，data为获取到的X509CRL实例；否则为错误对象。 |
