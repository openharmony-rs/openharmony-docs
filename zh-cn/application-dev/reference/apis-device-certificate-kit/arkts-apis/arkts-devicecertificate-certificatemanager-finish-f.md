...
| callback | AsyncCallback&lt;CMResult&gt; | 是 | 回调函数。当签名成功时，err为null，data为[CMResult](arkts-devicecertificate-certificatemanager-cmresult-i.md)对象中的outData属性，表示签名数据；否则为错误对象。 |
