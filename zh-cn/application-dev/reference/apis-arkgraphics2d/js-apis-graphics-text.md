...
| 名称 | 值 | 说明 |
| - | - | - |
| ALL | 1 << 0 | 所有字体类型，包括系统字体类型、风格字体类型和用户已安装字体类型。<br>**ArkTS-Dyn起始版本：** 14<br>**ArkTS-Sta起始版本：** 20 |
| GENERIC  | 1 << 1 | 系统字体类型。<br>**ArkTS-Dyn起始版本：** 14<br>**ArkTS-Sta起始版本：** 20 |
| STYLISH  | 1 << 2 | 风格字体类型。风格字体类型是专为2in1设备设计的字体类型。<br>**ArkTS-Dyn起始版本：** 14<br>**ArkTS-Sta起始版本：** 20 |
| INSTALLED  | 1 << 3 | 用户已安装的字体类型。<br>**ArkTS-Dyn起始版本：** 14<br>**ArkTS-Sta起始版本：** 20 |
| CUSTOMIZED<sup>18+</sup>  | 1 << 4 | 自定义字体类型。<br>**ArkTS-Dyn起始版本：** 18<br>**ArkTS-Sta起始版本：** 20 |
