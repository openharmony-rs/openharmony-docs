...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Path* path | 指向需要拷贝的源路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |

**返回值：**

| 类型 | 说明 |
| -- | -- |
| OH_Drawing_Path* | 函数返回一个指针，指针指向创建的路径对象副本[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Path* other | 指向源路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，其内容将被设置到当前路径对象中。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Rect* rect | 指向矩形对象[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针，作为出参使用，可以为空。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Rect* rect | 指向矩形对象[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针。 |
| [OH_Drawing_PathDirection](capi-drawing-path-h.md#oh_drawing_pathdirection) pathDirection | 路径添加方向[OH_Drawing_PathDirection](capi-drawing-path-h.md#oh_drawing_pathdirection)，用于指定矩形轮廓的绘制方向。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_RoundRect* roundRect | 指向圆角矩形对象[OH_Drawing_RoundRect](capi-drawing-oh-drawing-roundrect.md)的指针。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Rect* rect | 指向矩形对象[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针，该矩形作为椭圆的外切矩形区域，用于定义椭圆的形状和大小。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Rect* rect | 指向矩形对象[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针，该矩形作为弧线的包围矩形，其内切椭圆用于截取弧线。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Path* path | 指向当前路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Path* src | 指向源路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Matrix* matrix | 指向矩阵对象[OH_Drawing_Matrix](capi-drawing-oh-drawing-matrix.md)的指针，为NULL时表示单位矩阵。 |
...
| OH_Drawing_Path* path | 指向当前路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Path* src | 指向源路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Matrix* matrix | 指向矩阵对象[OH_Drawing_Matrix](capi-drawing-oh-drawing-matrix.md)的指针，为NULL表示单位矩阵。 |
...
| 参数项 | 描述 |
| -- | -- |
| const OH_Drawing_Path* path | 指向[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)对象的指针。 |
...
判断指定坐标点是否被路径包含，判定规则参考[OH_Drawing_PathFillType](capi-drawing-path-h.md#oh_drawing_pathfilltype)。 <br>本接口会产生错误码，可以通过[OH_Drawing_ErrorCodeGet](capi-drawing-error-code-h.md#oh_drawing_errorcodeget)查看错误码的取值。 <br>path为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Matrix* matrix | 指向矩阵对象[OH_Drawing_Matrix](capi-drawing-oh-drawing-matrix.md)的指针，用于指定对路径进行变换的矩阵， 为NULL时表示单位矩阵（不对路径进行变换）。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Path* src | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| const OH_Drawing_Matrix* matrix | 指向矩阵对象[OH_Drawing_Matrix](capi-drawing-oh-drawing-matrix.md)的指针，用于指定对路径进行矩阵变换的变换矩阵。 |
| OH_Drawing_Path* dst | 指向目标路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Rect* rect | 指向矩形对象[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针，存储路径边界框结果，作为出参使用。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向当前路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Path* dst | 指向目标路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，为NULL时会将结果存储到当前路径对象中。 |
...
| OH_Drawing_Path* dst | 指向目标路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，截取成功时会将得到的路径片段追加到目标路径上，截取失败时不做改变。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，操作完成后的路径结果将会保存在此路径对象中。 |
| const OH_Drawing_Path* other | 指向参与路径操作的路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，与当前路径一起按指定操作类型进行运算。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Path* other | 指向用于插值的另一条路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| float weight | 表示插值权重，范围为[0, 1]。 |
| bool* success | 表示插值是否成功。true表示插值成功，false表示插值失败。作为出参使用。 |
| OH_Drawing_Path* interpolatedPath | 指向用于存储插值结果的路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针，作为出参使用。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Path* other | 指向另一条路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Point2D* point | 指向坐标点对象[OH_Drawing_Point2D](capi-drawing-oh-drawing-point2d.md)的指针，用于存储最后一个点，作为出参使用。 |
...
| -- | -- |
| OH_Drawing_Path* path | 指向路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
| OH_Drawing_Path* other | 指向另一个路径对象[OH_Drawing_Path](capi-drawing-oh-drawing-path.md)的指针。 |
