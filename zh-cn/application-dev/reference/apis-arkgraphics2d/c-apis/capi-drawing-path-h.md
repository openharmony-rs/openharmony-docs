...
| [OH_Drawing_Path* OH_Drawing_PathCopy(OH_Drawing_Path* path)](#oh_drawing_pathcopy) | 用于拷贝已有路径对象，返回路径对象副本{@link OH_Drawing_Path}。<br><br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。 <br>path为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。 |
...
用于拷贝已有路径对象，返回路径对象副本{@link OH_Drawing_Path}。<br><br>本接口会产生错误码，可以通过{@link OH_Drawing_ErrorCodeGet}查看错误码的取值。 <br>path为NULL时返回OH_DRAWING_ERROR_INVALID_PARAMETER。
