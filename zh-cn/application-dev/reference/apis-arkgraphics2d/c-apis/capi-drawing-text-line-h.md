...
| 类型 | 说明 |
| -- | -- |
| [OH_Drawing_Rect*](capi-drawing-oh-drawing-rect.md) | 指向文本行对象的图像边界[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)的指针，不再需要[OH_Drawing_Rect](capi-drawing-oh-drawing-rect.md)时，请使用{@link OH_Drawing_RectDestroy}<br>     接口释放该对象的指针。 |
