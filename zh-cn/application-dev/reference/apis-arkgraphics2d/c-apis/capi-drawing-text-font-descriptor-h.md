...
| 参数项 | 描述 |
| -- | -- |
| const OH_Drawing_String* fullName | 表示指向字体名称字符串[OH_Drawing_String](capi-drawing-oh-drawing-string.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* fullNameArray | 表示字体名称数组[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针。 |
| size_t index | 数组的索引。 |
...
| 类型 | 说明 |
| -- | -- |
| const OH_Drawing_String* | 返回对应索引的字体名称[OH_Drawing_String](capi-drawing-oh-drawing-string.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* descriptorArray | 表示指向字体描述符数组[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* array | 指向字体可变轴数组[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针，通过[OH_Drawing_GetFontFullDescriptorAttributeArray](capi-drawing-text-font-descriptor-h.md#oh_drawing_getfontfulldescriptorattributearray)获取。 |
| size_t index | 数组的索引，索引值从0开始。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* fontVariaAxisArray | 指向字体可变轴数组对象[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* array | 指向字体可变实例数组[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针。通过[OH_Drawing_GetFontFullDescriptorAttributeArray](capi-drawing-text-font-descriptor-h.md#oh_drawing_getfontfulldescriptorattributearray)获取。 |
| size_t index | 数组的索引，索引值从0开始。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Array* fontVariaAxisInstance | 指向字体可变实例数组对象[OH_Drawing_Array](capi-drawing-oh-drawing-array.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| const OH_Drawing_String* fullName | 指向字体名称对象[OH_Drawing_String](capi-drawing-oh-drawing-string.md)的指针。 |
