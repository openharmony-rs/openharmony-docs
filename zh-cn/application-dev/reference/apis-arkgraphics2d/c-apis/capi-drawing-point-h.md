...
| 参数项 | 描述 |
| -- | -- |
| const OH_Drawing_Point* point | 指向坐标点对象[OH_Drawing_Point](capi-drawing-oh-drawing-point.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_Point* point | 指向坐标点对象[OH_Drawing_Point](capi-drawing-oh-drawing-point.md)的指针。 |
| float x | 表示坐标点的x轴坐标，单位为物理像素px。 |
| float y | 表示坐标点的y轴坐标，单位为物理像素px。 |
