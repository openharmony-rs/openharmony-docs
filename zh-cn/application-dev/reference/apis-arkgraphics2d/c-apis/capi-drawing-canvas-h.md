...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_PixelMap* pixelMap | 指向像素图{@link OH_Drawing_PixelMap}的指针。<br>像素图对象应该在销毁画布对象之后调用{@link drawing_pixel_map.h#OH_Drawing_PixelMapDissolve}解除绑定。 |
...
| -- | -- |
| OH_Drawing_Canvas* canvas | 指向画布对象{@link OH_Drawing_Canvas}的指针。 |
| OH_Drawing_Matrix* matrix | 指向矩阵对象{@link OH_Drawing_Matrix}的指针，<br>开发者可调用{@link drawing_matrix.h#OH_Drawing_MatrixCreate}接口创建。 |
