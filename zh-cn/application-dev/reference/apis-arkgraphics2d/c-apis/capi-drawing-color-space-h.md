...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_ColorSpace* | 返回一个指向创建的颜色空间对象[OH_Drawing_ColorSpace](capi-drawing-oh-drawing-colorspace.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_ColorSpace* colorSpace | 指向待销毁的颜色空间对象[OH_Drawing_ColorSpace](capi-drawing-oh-drawing-colorspace.md)的指针。 |
