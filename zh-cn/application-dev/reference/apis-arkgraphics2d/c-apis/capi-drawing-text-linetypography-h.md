...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_LineTypography* | 返回一个指向排版行对象[OH_Drawing_LineTypography](capi-drawing-oh-drawing-linetypography.md)的指针。 |
...
| 参数项 | 描述 |
| -- | -- |
| OH_Drawing_LineTypography* lineTypography | 指向排版行对象[OH_Drawing_LineTypography](capi-drawing-oh-drawing-linetypography.md)的指针，由[OH_Drawing_CreateLineTypography](capi-drawing-text-linetypography-h.md#oh_drawing_createlinetypography)获取。 |
...
| 类型 | 说明 |
| -- | -- |
| OH_Drawing_TextLine* | 返回一个指向文本行对象[OH_Drawing_TextLine](capi-drawing-oh-drawing-textline.md)的指针。 |
