...
| 名称  | 类型   | 只读 | 可选 | 说明                                     |
| ----- | ------ | ---- | ---- | ---------------------------------------- |
| alpha | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否   | 否   | 颜色的A分量（透明度），值是0.0~1.0的浮点数。 |
| red   | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否   | 否   | 颜色的R分量（红色），值是0.0~1.0的浮点数。 |
| green | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否   | 否   | 颜色的G分量（绿色），值是0.0~1.0的浮点数。 |
| blue  | ArkTS-Dyn: number<br/>ArkTS-Sta: double | 否   | 否   | 颜色的B分量（蓝色），值是0.0~1.0的浮点数。 |
