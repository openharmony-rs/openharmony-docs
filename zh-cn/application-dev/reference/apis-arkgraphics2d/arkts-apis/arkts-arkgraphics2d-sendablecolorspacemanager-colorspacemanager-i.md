...
当前可共享的色彩管理实例。 下列API示例中都需先使用[create()]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_获取到 ColorSpaceManager实例，再通过此实例调用对应方法。
...
| 错误码ID | 错误信息 |
| --- | --- |
| [18600001](../errorcode-colorspace-manager.md#18600001-参数值异常) | The parameter value is abnormal.\_\_\_HTML\_TAG\_USD\_0\_\_\_**适用版本：** 12 - 22 |
