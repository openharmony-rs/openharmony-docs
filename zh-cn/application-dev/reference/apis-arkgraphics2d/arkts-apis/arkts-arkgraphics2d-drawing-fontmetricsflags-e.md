...
表示[FontMetrics](arkts-arkgraphics2d-drawing-fontmetrics-i.md#FontMetrics)结构中strikethroughThickness（删除线厚度）是有效的。
...
表示[FontMetrics](arkts-arkgraphics2d-drawing-fontmetrics-i.md#FontMetrics)结构中strikethroughPosition（删除线位置）字段有效。
