...
**替代接口：** [getRemoteDeviceClass](arkts-connectivity-connection-getremotedeviceclass-f.md)
...
| 类型 | 说明 |
| --- | --- |
| [DeviceClass](arkts-connectivity-bluetoothmanager-deviceclass-i.md) | 远程设备的类别。 |
