...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;[GattService](arkts-connectivity-bluetoothmanager-gattservice-i.md)&gt;&gt; | 是 | client进行服务发现，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;[GattService](arkts-connectivity-bluetoothmanager-gattservice-i.md)&gt;&gt; | client进行服务发现，通过promise形式获取。 |
...
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md)&gt; | 否 | 表示取消订阅蓝牙低功耗设备的特征值变化事件。不填该参数则取消订阅该type对应的所有回调。 |
...
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[BLEConnectChangedState](arkts-connectivity-bluetoothmanager-bleconnectchangedstate-i.md)&gt; | 否 | 表示取消订阅蓝牙低功耗设备的连接状态变化事件。不填该参数则取消订阅该type对应的所有回调。 |
...
| --- | --- | --- | --- |
| type | 'BLECharacteristicChange' | 是 | 填写"BLECharacteristicChange"字符串，表示特征值变化事件。 |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md)&gt; | 是 | 表示蓝牙低功耗设备的特征值变化事件的回调函数。 |
...
| --- | --- | --- | --- |
| type | 'BLEConnectionStateChange' | 是 | 填写"BLEConnectionStateChange"字符串，表示连接状态变化事件。 |
| callback | [Callback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-callback-i.md)&lt;[BLEConnectChangedState](arkts-connectivity-bluetoothmanager-bleconnectchangedstate-i.md)&gt; | 是 | 表示连接状态，已连接或断开。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md) | 是 | 待读取的特征值。 |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md)&gt; | 是 | client读取特征值，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md)&gt; | client读取特征值，通过promise形式获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| descriptor | [BLEDescriptor](arkts-connectivity-bluetoothmanager-bledescriptor-i.md) | 是 | 待读取的描述符。 |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;[BLEDescriptor](arkts-connectivity-bluetoothmanager-bledescriptor-i.md)&gt; | 是 | client读取描述符，通过注册回调函数获取。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;[BLEDescriptor](arkts-connectivity-bluetoothmanager-bledescriptor-i.md)&gt; | client读取描述符，通过promise形式获取。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md) | 是 | 蓝牙低功耗特征。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| characteristic | [BLECharacteristic](arkts-connectivity-bluetoothmanager-blecharacteristic-i.md) | 是 | 蓝牙设备特征对应的二进制值及其它参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| descriptor | [BLEDescriptor](arkts-connectivity-bluetoothmanager-bledescriptor-i.md) | 是 | 蓝牙设备描述符的二进制值及其它参数。 |
