...
| getP2pLocalDevice | 获取P2P本端设备信息，使用Promise异步回调。 |
...
| getScanResults | 获取扫描结果，使用Promise异步回调。 |
...
| removeCandidateConfig | 移除候选网络配置，使用Promise异步回调。 |
