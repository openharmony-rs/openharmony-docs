...
| [createNdefMessage](arkts-connectivity-ndef-createndefmessage-f.md#createndefmessage) | 使用原始字节数据创建NDEF标签的Message。该数据必须符合NDEF Record数据格式，如果不符合格式，则返回的NdefMessage数据对象，所包含的NDEF Record列表会为空。 |
