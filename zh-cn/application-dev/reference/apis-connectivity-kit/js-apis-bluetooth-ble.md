...
| 名称                | 类型                             | 只读 | 可选  | 说明                      |
| ------------------- | ------------------------------- | ----- | ----- | ------------------------ |
| advertisingSettings | [AdvertiseSetting](#advertisesetting) | 否 | 否    | 广播的发送参数。 |
| advertisingData    | [AdvertiseData](#advertisedata) | 否 | 否    | 需要发送的广播报文数据内容。 |
| advertisingResponse | [AdvertiseData](#advertisedata) | 否 | 是    | 回复扫描请求的广播报文数据内容。 |
