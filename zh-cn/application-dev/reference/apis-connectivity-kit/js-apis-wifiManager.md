...
以下错误码的详细介绍请参见[通用错误码说明文档](../errorcode-universal.md)和以下错误码的详细介绍请参见[Wi-Fi错误码](errorcode-wifi.md)和[通用错误码](../errorcode-universal.md)。
...
| isHiddenSsid | boolean | 否 | 是 | 是否是隐藏网络。true表示是隐藏网络，false表示不是隐藏网络。 <br />**ArkTS-Dyn起始版本：** 9<br />**ArkTS-Sta起始版本：** 23|
...
| netId<sup>22+</sup> | number | 否 | 是 | 分配的网络ID。 <br />**ArkTS-Dyn起始版本：** 22<br />**ArkTS-Sta起始版本：** 23|
...
| ipAddress | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 否 | Wi-Fi连接的IP地址。<br>1.IP地址在WiFi连接信息和"设置 > 关于本机 > 状态信息"中可以查看。<br>2.ipAddress值为number类型，需要转换为点分十进制格式的IP地址（如192.168.1.1），具体请参考[IP格式转换](https://developer.huawei.com/consumer/cn/doc/harmonyos-faqs/faqs-connectivity-4)。**ArkTS-Dyn起始版本：** 9<br />**ArkTS-Sta起始版本：** 23|
...
| WIFI7_MLSR | 2 | Wi-Fi7 MLSR（multi-link single-radio，多链路单射频）连接。 |
...
以下错误码的详细介绍请参见以下错误码的详细介绍请参见[Wi-Fi错误码](errorcode-wifi.md)和[通用错误码](../errorcode-universal.md)。。
