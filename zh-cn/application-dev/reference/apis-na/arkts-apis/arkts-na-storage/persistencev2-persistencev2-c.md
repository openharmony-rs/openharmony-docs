...
PersistenceV2具体UI使用说明，详见 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_。
...
将键值对数据储存在应用磁盘中。如果给定的key已经存在于\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ 中，返回对应的值；否则，会通过获取默认值的构造器构造默认值，并返回。
