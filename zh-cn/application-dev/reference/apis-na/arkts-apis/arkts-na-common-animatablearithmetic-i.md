...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 是 | 和自身比较相等的另一个数据对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 乘法运算的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 是 | 加法运算的对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 加法运算的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| rhs | [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 是 | 减法运算的对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [AnimatableArithmetic](arkts-na-common-animatablearithmetic-i.md)&lt;T&gt; | 减法运算的结果。 |
