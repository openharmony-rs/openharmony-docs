...
| 名称 | 说明 |
| --- | --- |
| [NodeRenderType](arkts-na-buildernode-noderendertype-e.md) | 节点渲染类型枚举。 @Component](../../../ui/state-management/arkts-create-custom-components.md#component)修饰的自定义组件、 > NodeContainer以及NodeContainer下挂载的FrameNode和 > [RenderNode](arkts-na-rendernode-c.md#rendernode)。 > > - 使用方式可参考[同层渲染绘制](../../../web/web-same-layer.md)。 |

### 类型

| 名称 | 说明 |
| --- | --- |
| [InputEventType](arkts-na-inputeventtype-t.md) | [postInputEvent](arkts-na-buildernode-c.md#postinputevent)的参数，定义要发送的输入事件类型。 |
