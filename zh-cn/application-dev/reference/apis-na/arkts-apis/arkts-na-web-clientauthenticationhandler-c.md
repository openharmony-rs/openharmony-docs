...
| credentialTypeOrCertChainFile | [CredentialType](arkts-na-web-credentialtype-e.md) \| string | 是 | The type of the credential or the file that store client certificate chain. |
