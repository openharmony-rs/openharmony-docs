...
**继承/实现关系：** IConsumeDecoratedVariable extends [IDecoratedMutableVariable<T>](IDecoratedMutableVariable<T>), [IDecoratedV1Variable<T>](IDecoratedV1Variable<T>)
...
| watchFunc | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 否 | watch函数类型 |
| consumeOptions | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;T&gt; | 否 | 具有默认值的选项 |
