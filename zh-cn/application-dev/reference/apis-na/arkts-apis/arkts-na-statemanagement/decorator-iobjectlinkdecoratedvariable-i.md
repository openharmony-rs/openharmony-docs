...
**继承/实现关系：** IObjectLinkDecoratedVariable extends [IDecoratedImmutableVariable<T>](IDecoratedImmutableVariable<T>), [IDecoratedUpdatableVariable<T>](IDecoratedUpdatableVariable<T>), [IDecoratedV1Variable<T>](IDecoratedV1Variable<T>)
