...
**继承/实现关系：** IPropRefDecoratedVariable extends [IDecoratedMutableVariable<T>](IDecoratedMutableVariable<T>), [IDecoratedUpdatableVariable<T>](IDecoratedUpdatableVariable<T>), [IDecoratedV1Variable<T>](IDecoratedV1Variable<T>)
