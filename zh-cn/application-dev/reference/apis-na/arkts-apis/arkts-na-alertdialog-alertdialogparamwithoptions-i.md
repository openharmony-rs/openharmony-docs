...
**继承/实现关系：** AlertDialogParamWithOptions extends [AlertDialogParam](arkts-na-alertdialog-alertdialogparam-i.md)
...
**类型：** [DialogButtonDirection](arkts-na-alertdialog-dialogbuttondirection-e.md)
...
**类型：** Array&lt;[AlertDialogButtonOptions](arkts-na-alertdialog-alertdialogbuttonoptions-i.md)&gt;
