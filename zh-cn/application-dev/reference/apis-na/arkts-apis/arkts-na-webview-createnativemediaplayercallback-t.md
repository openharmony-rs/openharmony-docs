...
\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_ 方法的参数。一个回调函数，创建一个播放器，用于接管网页中的媒体播放。
...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | 接管网页媒体的播放器和 ArkWeb 内核之间的一个接口类。\_\_\_HTML\_TAG\_USD\_0\_\_\_应用需要实现该接口类。\_\_\_HTML\_TAG\_USD\_1\_\_\_ ArkWeb 内核通过该接口类的对象来控制应用创 |
