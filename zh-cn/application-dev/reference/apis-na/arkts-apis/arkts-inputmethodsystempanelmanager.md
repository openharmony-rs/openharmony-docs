...
| 名称 | 说明 |
| --- | --- |
| [SystemPanelStatus](arkts-na-inputmethodsystempanelmanager-systempanelstatus-i-sys.md) | 系统面板状态。 |
<!--DelEnd-->
...
| 名称 | 说明 |
| --- | --- |
| [InputMethodInputType](arkts-na-inputmethodsystempanelmanager-inputmethodinputtype-e-sys.md) | 定义输入类型。 |
<!--DelEnd-->
...
| 名称 | 说明 |
| --- | --- |
| [CommandDataType](arkts-na-inputmethodsystempanelmanager-commanddatatype-t-sys.md) | 表示命令的数据类型。 |
<!--DelEnd-->
