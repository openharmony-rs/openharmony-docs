...
If the drag is successful, return DragResult.DRAG\_SUCCESSFUL.
...
If drag fail, return DragResult.DRAG\_FAILED.
...
If drag action cancel, return DragResult.DRAG\_CANCELED.
...
If node allow drop in, return DragResult.DROP\_ENABLED.
...
If node don't allow drop in, return DragResult.DROP\_DISABLED.
