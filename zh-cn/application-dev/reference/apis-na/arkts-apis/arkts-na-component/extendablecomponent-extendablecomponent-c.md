...
**继承/实现关系：** ExtendableComponent implements [LifeCycle](extendablecomponent-lifecycle-i.md), [IVariableOwner](../arkts-na-statemanagement/decorator-ivariableowner-i.md)
