...
控制条是否悬浮显示，true为悬浮显示，false为不悬浮显示。 默认值：false **说明：** 悬浮效果只在控制条显示的场景生效，且控制条不占位。 title传入\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_时enableFloatingDragBar始 终为false。
...
设置组件的系统材质。 默认值：undefined，会清除由该接口设置的材质效果。 **说明**: 不同系统材质对应不同的属性影响效果，该接口影响背景色 \_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_、 边框颜色[borderColor]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_、边框宽度[borderWidth]\_\_\_JSDOC\_LINK\_DESC\_USD\_3\_\_\_、阴影 [shadow]\_\_\_JSDOC\_LINK\_DESC\_USD\_4\_\_\_，不建议与上述接口一起使用。使用示例请参考 \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_。
...
在UIContext实例对应的窗口中显示半模态。 **说明：** 使用\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_启动的半模态页面，不支持设置 、更新该属性。
