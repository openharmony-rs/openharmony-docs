...
设置并接收评分值。取值为undefined时，按默认值处理。 默认值：0 取值范围： [0, stars] 小于0取0，大于[stars]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_取最大值stars。 该参数支持\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_双向绑定变量。 **卡片能力（仅ArkTS-Dyn）：** 从API version 9开始，该接口支持在ArkTS卡片中使用。 **原子化服务API（仅ArkTS-Dyn）：** 从API version 11开始，该接口支持在原子化服务中使用。
