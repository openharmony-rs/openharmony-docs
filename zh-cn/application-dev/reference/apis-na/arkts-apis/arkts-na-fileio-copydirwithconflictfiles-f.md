...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-asynccallback-t.md)&lt;void, Array&lt;[ConflictFiles](arkts-na-file-fs-conflictfiles-i.md)&gt;&gt; | 是 | 回调函数。当复制目录成功，err为undefined；否则为错误对象。 |
