...
<!--Device-unnamed-export declare class Path2D--><!--Device-unnamed-export declare class Path2D-End-->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-na-canvas-path2d-c.md) | 是 | Indicates the path object to be added. |
| transform | [Matrix2D](../../apis-arkui/arkts-apis/arkts-arkui-matrix2d-c.md) | 否 | Transformation matrix of the new trail. The default value is null. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unit | [LengthMetricsUnit](../../apis-arkui/arkts-apis/arkts-arkui-lengthmetricsunit-t.md) | 是 | the unit mode |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| path | [Path2D](arkts-na-canvas-path2d-c.md) | 是 | Path object to be copied |
