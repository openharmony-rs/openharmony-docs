...
基于文件描述符打开文件流。使用Promise异步回调。需要配合[Stream](arkts-na-fileio-stream-i.md)中的close()函数关闭文件流。
...
基于文件描述符打开文件流，需要配合[Stream](arkts-na-fileio-stream-i.md)中的close()函数关闭文件流。使用callback异步回调。
