...
关闭即时反馈。 > **说明：** > > 直接使用closeToast可能导致\_\_\_MD\_LINK\_DESC\_USD\_0\_\_\_的问题，建议使用UIContext中的getPromptAction > 方法获取到PromptAction对象，再通过该对象调用 > \_\_\_MD\_LINK\_DESC\_USD\_1\_\_\_实现。
