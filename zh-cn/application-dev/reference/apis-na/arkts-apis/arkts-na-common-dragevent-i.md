...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| customDropAnimation | [VoidCallback](../../apis-arkui/arkts-apis/arkts-arkui-voidcallback-t.md) | 是 | the custom drop animation function. |
...
| 错误码ID | 错误信息 |
| --- | --- |
| [190002](../../apis-arkui/errorcode-drag-event.md#190002-获取数据错误) | Data error. |
| [190001](../../apis-arkui/errorcode-drag-event.md#190001-数据未找到) | Data not found. |
...
| 类型 | 说明 |
| --- | --- |
| [Rectangle](arkts-na-common-rectangle-i.md) | getPreview rectangle. |
...
| 类型 | 说明 |
| --- | --- |
| [DragResult](arkts-na-common-dragresult-e.md) | dragResult Data. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| unifiedData | [UnifiedData](arkts-na-unifieddata-t.md) | 是 | dragData. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dataLoadParams | [DataLoadParams](arkts-na-dataloadparams-t.md) | 是 | The data backend representation. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| dragResult | [DragResult](arkts-na-common-dragresult-e.md) | 是 | the return of dragEvent. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DataSyncOptions](arkts-na-datasyncoptions-t.md) | 是 | the data sync options. |
...
**类型：** [DragBehavior](arkts-na-common-dragbehavior-e.md)
