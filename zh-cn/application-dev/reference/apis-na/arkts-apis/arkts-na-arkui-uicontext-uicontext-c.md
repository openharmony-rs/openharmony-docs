...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [AnimateParam](arkts-na-common-animateparam-i.md) | 是 | parameters for animation. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [AnimateParam](arkts-na-common-animateparam-i.md) | 是 | 设置动画效果相关参数 |
| processor | [VoidCallback](arkts-na-voidcallback-t.md) | 是 | 指定显示动画的处理函数，在该函数中导致的状态变化系统会自动插入过渡动画。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| tabsController | [TabsController](arkts-na-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| parentScroller | [Scroller](arkts-na-scroll-scroller-c.md) | 是 | The controller of the parent scrollable container component. |
| childScroller | [Scroller](arkts-na-scroll-scroller-c.md) | 是 | The controller of the child scrollable container component. |
...
| --- | --- | --- | --- |
| tabsController | [TabsController](arkts-na-tabs-tabscontroller-c.md) | 是 | The controller of the tabs. |
| scroller | [Scroller](arkts-na-scroll-scroller-c.md) | 是 | The controller of the scrollable container component. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| bindSheetContent | [ComponentContentBase](arkts-na-componentcontent-componentcontentbase-c.md) | 是 | BindSheet半模态的内容 |
...
| event | [KeyEvent](arkts-na-common-keyevent-i.md) | 是 | The keyboard event. |
...
| eventType | [RawInputEventType](arkts-na-enums-rawinputeventtype-e.md) | 是 | 原始输入事件的类型。 |
...
| 类型 | 说明 |
| --- | --- |
| [PixelRoundMode](arkts-na-enums-pixelroundmode-e.md) | the mode of pixel round. |
...
| 类型 | 说明 |
| --- | --- |
| [HeightBreakpoint](arkts-na-enums-heightbreakpoint-e.md) | The height breakpoint of current window. |
...
| 类型 | 说明 |
| --- | --- |
| [WidthBreakpoint](arkts-na-enums-widthbreakpoint-e.md) | The width breakpoint of current window. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [KeyframeAnimateParam](arkts-na-common-keyframeanimateparam-i.md) | 是 | overall animation parameters |
| keyframes | Array&lt;[KeyframeState](arkts-na-common-keyframestate-i.md)&gt; | 是 | all keyframe states |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| mode | [PixelRoundMode](arkts-na-enums-pixelroundmode-e.md) | 是 | The mode of pixel round. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [VoidCallback](arkts-na-voidcallback-t.md) | 是 | 在UI线程中执行的回调函数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ActionSheetOptions](arkts-na-actionsheet-actionsheetoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [AlertDialogParamWithConfirm](arkts-na-alertdialog-alertdialogparamwithconfirm-i.md) \| [AlertDialogParamWithButtons](arkts-na-alertdialog-alertdialogparamwithbuttons-i.md) \| [AlertDialogParamWithOptions](arkts-na-alertdialog-alertdialogparamwithoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [DatePickerDialogOptions](arkts-na-datepicker-datepickerdialogoptions-i.md) | 是 | Options. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | [TextPickerDialogOptions](arkts-na-textpicker-textpickerdialogoptions-i.md) \| TextPickerDialogOptionsExt | 是 | Dialog style. |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [TimePickerDialogOptions](arkts-na-timepicker-timepickerdialogoptions-i.md) | 是 | Options. |
...
| --- | --- | --- | --- |
| bindSheetContent | [ComponentContentBase](arkts-na-componentcontent-componentcontentbase-c.md) | 是 | The content of BindSheet. |
| sheetOptions | [SheetOptions](arkts-na-common-sheetoptions-i.md) | 是 | The update options of sheet. |
