...
Extension生命周期回调，如果是connectAbility拉起的服务，会在onCreate之后回调。返回一个[RemoteObject](../apis-ipc-kit/js-apis-rpc.md#remoteobject)对象，用于客户端和服务端进行通信。
...
| 类型 | 说明 |
| -------- | -------- |
| rpc.RemoteObject | 一个[RemoteObject](../apis-ipc-kit/js-apis-rpc.md#remoteobject)对象，用于客户端和服务端进行通信。|
...
onConnect(want: Want): Promise<rpc.RemoteObject>

异步的Extension生命周期回调，如果是connectAbility拉起的服务，会在onCreate之后回调。返回一个[RemoteObject](../apis-ipc-kit/js-apis-rpc.md#remoteobject)对象，用于客户端和服务端进行通信。
...
| 类型 | 说明 |
| -------- | -------- |
| Promise<rpc.RemoteObject> | Promise对象，返回用于客户端和服务端进行通信的[RemoteObject](../apis-ipc-kit/js-apis-rpc.md#remoteobject)对象。|
...
异步的Extension生命周期回调，客户端执行断开连接服务时回调。
