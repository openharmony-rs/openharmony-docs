...
| 类型 | 说明 |
| -------- | -------- |
| _DriverExtensionContext | DriverExtensionAbility的上下文环境，继承自ExtensionContext，其具体使用方法可参考[DriverExtensionContext (定义驱动扩展的上下文)](js-apis-inner-application-driverExtensionContext.md)。|
