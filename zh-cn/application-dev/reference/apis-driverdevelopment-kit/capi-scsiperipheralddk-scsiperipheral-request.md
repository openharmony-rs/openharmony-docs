...
| 名称 | 描述 |
| -- | -- |
| uint8_t commandDescriptorBlock[[SCSIPERIPHERAL_MAX_CMD_DESC_BLOCK_LEN](capi-scsi-peripheral-types-h.md#宏定义)] | 命令描述符块，应遵循SCSI命令规范，填充对应命令的标准描述符格式。 |
| uint8_t cdbLength | 命令描述符块的长度，应确保长度和实际命令匹配，最大不超过[SCSIPERIPHERAL_MAX_CMD_DESC_BLOCK_LEN](capi-scsi-peripheral-types-h.md#宏定义)。 |
