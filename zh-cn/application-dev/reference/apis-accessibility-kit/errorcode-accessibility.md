...
> **说明**：
>
> 无障碍子系统错误码用于标识无障碍服务相关操作中的异常情况，帮助开发者快速定位和解决无障碍功能开发与调试过程中的问题。以下仅介绍本模块特有错误码，通用错误码请参考[通用错误码说明文档](../errorcode-universal.md)。
...
该错误码表示应用不具备该操作的无障碍权限，可能原因如下：
1. 应用执行了用户在启用无障碍扩展应用时未开启的辅助操作。
