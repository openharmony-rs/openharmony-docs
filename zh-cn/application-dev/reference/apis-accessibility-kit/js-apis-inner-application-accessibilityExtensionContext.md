...
| 类型                  | 说明               |
| ------------------- | ---------------- |
| Promise&lt;void&gt; | Promise对象，设置关注应用的包名成功时无返回结果，失败时返回错误信息。 |
...
| ----------- | ------------------------- | ---- | ---------------------------------------- |
| targetNames | Array&lt;string&gt;       | 是    | 设置关注应用的包名。设置后，服务仅接收关注应用的无障碍事件；未设置时默认接收所有应用的无障碍事件；取消关注应用时传空数组。                                 |
| callback    | AsyncCallback&lt;void&gt; | 是    | 回调函数。设置关注的目标包名成功时，err为undefined；失败时，err为错误对象，包含错误码和错误信息。 |
...
| 类型                                  | 说明                     |
| ----------------------------------- | ---------------------- |
| Promise&lt;[AccessibilityElement](#accessibilityelement)&gt; | Promise对象，成功时返回当前对应的焦点元素，失败时返回错误信息。 |
...
| 参数名      | 类型                                       | 必填   | 说明                |
| -------- | ---------------------------------------- | ---- | ----------------- |
| callback | AsyncCallback&lt;[AccessibilityElement](#accessibilityelement)&gt; | 是    | 回调函数，返回当前对应的焦点元素。成功时err为undefined，data为当前对应的焦点元素；失败时err为错误对象，包含错误码和错误信息。 |
...
| 类型                                  | 说明                     |
| ----------------------------------- | ---------------------- |
| Promise&lt;[AccessibilityElement](#accessibilityelement)&gt; | Promise对象，成功时返回指定窗口的根节点元素，失败时返回错误信息。 |
...
| 参数名      | 类型                                       | 必填   | 说明                 |
| -------- | ---------------------------------------- | ---- | ------------------ |
| callback | AsyncCallback&lt;[AccessibilityElement](#accessibilityelement)&gt; | 是    | 回调函数，返回当前活跃窗口的根节点元素。成功时err为undefined，data为当前活跃窗口的根节点元素；失败时err为错误对象，包含错误码和错误信息。 |
...
| callback | AsyncCallback&lt;[AccessibilityElement](#accessibilityelement)&gt; | 是    | 回调函数，返回指定窗口的根节点元素。成功时err为undefined，data为指定窗口的根节点元素；失败时err为错误对象，包含错误码和错误信息。     |
...
| 类型                                       | 说明                     |
| ---------------------------------------- | ---------------------- |
| Promise&lt;Array&lt;[AccessibilityElement](#accessibilityelement)&gt;&gt; | Promise对象，成功时返回指定屏幕的所有窗口，失败时返回错误信息。 |
...
| 参数名      | 类型                                       | 必填   | 说明                |
| -------- | ---------------------------------------- | ---- | ----------------- |
| callback | AsyncCallback&lt;Array&lt;[AccessibilityElement](#accessibilityelement)&gt;&gt; | 是    | 回调函数，返回默认主屏幕的所有窗口。成功时err为undefined，data为默认主屏幕的所有窗口；失败时err为错误对象，包含错误码和错误信息。 |
...
| callback  | AsyncCallback&lt;Array&lt;[AccessibilityElement](#accessibilityelement)&gt;&gt; | 是    | 回调函数，返回指定屏幕的所有窗口。成功时err为undefined，data为指定屏幕的所有窗口；失败时err为错误对象，包含错误码和错误信息。     |
...
> **说明**：
>
> 从 API version 9 开始支持，从 API version 10 开始废弃。建议使用[injectGestureSync](#injectgesturesyncdeprecated)替代，但该替代接口从 API version 12 开始也已废弃并完全移除，无后续替代方案。
...
| 类型                  | 说明               |
| ------------------- | ---------------- |
| Promise&lt;void&gt; | Promise对象，注入手势成功时resolve无返回结果，失败时reject返回错误信息。 |
...
| ----------- |--------------------------------------------------------------------| ---- | ------------------- |
| gesturePath | [GesturePath](js-apis-accessibility-GesturePath.md#gesturepath) | 是    | 表示手势的路径信息。          |
| callback    | AsyncCallback&lt;void&gt;                                          | 是    | 回调函数。注入手势成功时，err为undefined；失败时，err为错误对象，包含错误码和错误信息。 |
...
> **说明**：
>
> 从 API version 10 开始支持，从 API version 12 开始废弃。此接口已完全移除，无替代方案。
...
| 类型                            | 说明                       |
| ----------------------------- | ------------------------ |
| Promise&lt;Array&lt;T&gt;&gt; | Promise对象，成功时返回节点元素的所有属性名称，失败时返回错误信息。 |
...
| 参数名      | 类型                                  | 必填   | 说明                  |
| -------- | ----------------------------------- | ---- | ------------------- |
| callback | AsyncCallback&lt;Array&lt;T&gt;&gt; | 是    | 回调函数，返回节点元素的所有属性名称。成功时err为undefined，data为节点元素的所有属性名称数组；失败时err为错误对象，包含错误码和错误信息。 |
...
| 类型                                       | 说明                          |
| ---------------------------------------- | --------------------------- |
| Promise&lt;ElementAttributeValues[T]&gt; | Promise对象，成功时返回根据节点属性名称获取的属性值，失败时返回错误信息。 |
...
| ------------- | ---------------------------------------- | ---- | ---------------------- |
| attributeName | ElementAttributeKeys                         | 是    | 表示属性的名称。               |
| callback      | AsyncCallback&lt;[ElementAttributeValues](#elementattributevalues)[T]&gt; | 是    | 回调函数，返回根据节点属性名称获取的属性值。成功时err为undefined，data为对应属性的值；失败时err为错误对象，包含错误码和错误信息。 |
...
| 类型                                 | 说明                         |
| ---------------------------------- | -------------------------- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise对象，成功时返回节点元素支持的所有操作名称，失败时返回错误信息。 |
...
| 参数名      | 类型                                       | 必填   | 说明                    |
| -------- | ---------------------------------------- | ---- | --------------------- |
| callback | AsyncCallback&lt;Array&lt;string&gt;&gt; | 是    | 回调函数，返回节点元素支持的所有操作名称。成功时err为undefined，data为节点元素支持的所有操作名称数组；失败时err为错误对象，包含错误码和错误信息。 |
...
| 类型                  | 说明               |
| ------------------- | ---------------- |
| Promise&lt;void&gt; | Promise对象，执行操作成功时resolve无返回结果，失败时reject返回错误信息。 |
...
| ----------- | ---------------------------------------- | ---- | -------------- |
| actionName | string | 是    | 表示操作的名称，取值参考[Action](js-apis-accessibility.md#action)。|
| callback | AsyncCallback&lt;void&gt; | 是    | 回调函数。执行操作成功时，err为undefined；失败时，err为错误对象，包含错误码和错误信息。|
...
| 类型                                       | 说明                            |
| ---------------------------------------- | ----------------------------- |
| Promise&lt;Array&lt;[AccessibilityElement](#accessibilityelement)&gt;&gt; | Promise对象，成功时返回满足指定查询关键字的所有节点元素，失败时返回错误信息。 |
...
| type      | string                                   | 是    | 固定为'content'，表示查找的类型为节点元素内容。 |
| condition | string                                   | 是    | 表示查找的关键字条件，用于匹配节点元素的文本内容。                     |
| callback  | AsyncCallback&lt;Array&lt;[AccessibilityElement](#accessibilityelement)&gt;&gt; | 是    | 回调函数，返回满足指定查询关键字的所有节点元素。成功时err为undefined，data为满足条件的节点元素数组；失败时err为错误对象，包含错误码和错误信息。     |
...
| 类型                                  | 说明                             |
| ----------------------------------- | ------------------------------ |
| Promise&lt;[AccessibilityElement](#accessibilityelement)&gt; | Promise对象，成功时返回满足指定查询焦点元素类型的节点元素，失败时返回错误信息。 |
...
| type      | string                                   | 是    | 固定为'focusType'，表示查询的类型为节点的焦点元素类型。 |
| condition | [FocusType](#focustype)                  | 是    | 表示查询焦点元素的类型。                       |
| callback  | AsyncCallback&lt;[AccessibilityElement](#accessibilityelement)&gt; | 是    | 回调函数，返回满足指定查询焦点元素类型的节点元素。成功时err为undefined，data为满足条件的节点元素；失败时err为错误对象，包含错误码和错误信息。          |
...
| 类型                                  | 说明                               |
| ----------------------------------- | -------------------------------- |
| Promise&lt;[AccessibilityElement](#accessibilityelement)&gt; | Promise对象，成功时返回满足指定查询下一焦点元素方向的节点元素，失败时返回错误信息。 |
...
| type      | string                                   | 是    | 固定为'focusDirection'，表示查询的类型为节点的下一焦点元素方向。 |
| condition | [FocusDirection](#focusdirection)        | 是    | 表示查询下一焦点元素的方向。                           |
| callback  | AsyncCallback&lt;[AccessibilityElement](#accessibilityelement)&gt; | 是    | 回调函数，返回满足指定查询下一焦点元素方向的节点元素。成功时err为undefined，data为满足条件的节点元素；失败时err为错误对象，包含错误码和错误信息。              |
