...
| customComponentType<sup>18+</sup>             | string                                                             | 否   | 是   | 自定义组件类型。与元素的[AccessibilityRoleType](../apis-arkui/arkui-ts/ts-universal-attributes-accessibility.md#accessibilityroletype18枚举说明)类型所对应。<br>**ArkTS-Dyn起始版本**：18|
