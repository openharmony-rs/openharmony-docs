...
| brightnessDiscount                 | ArkTS-Dyn: [Config](#config)\<number><br>ArkTS-Sta: [Config](#config)\<double>             | 否 | 否 | 表示亮度折扣系统配置。取值范围为0~1.0。默认值为0.0。<br>**ArkTS-Dyn起始版本**：9<br>**ArkTS-Sta起始版本**：20          |
