...
| [Parameter](arkts-accessibility-accessibilityextensioncontext-parameter-c-sys.md) | 无障碍节点元素执行特定操作时，为操作提供具体设置的参数值。详见[AccessibilityAction](../../apis-arkui/arkts-components/arkts-arkui-accessibilityaction-e.md)（无障碍节点元素可执行的操作）。 |
<!--DelEnd-->
