...
| sdkMinorApiVersion | number  | 系统软件Minor API版本。**从** API 26.0.0 版本开始，系统API版本格式：apiVersion.sdkMinorApiVersion.sdkPatchApiVersion。该值获取失败时填充 -1，且不影响 getInfo 接口的整体返回状态。<br/>**起始版本**：26.0.0<br/>示例：0 |
  | sdkPatchApiVersion  | number  | 系统软件Patch API版本。**从** API 26.0.0 版本开始，系统API版本格式：apiVersion.sdkMinorApiVersion.sdkPatchApiVersion。该值获取失败时填充 -1，且不影响 getInfo 接口的整体返回状态。<br/>**起始版本**：26.0.0<br/>示例：0 |