...
| 参数名     | 类型                 | 必填 | 说明                   |
| -------- | -------------------- | ---- | ---------------------- |
| event    | string               | 是   | 表示要发送的公共事件。详见[系统定义的公共事件定义](./common_event/commonEventManager-definitions.md)。 |
...
| 参数名     | 类型                   | 必填 | 说明                   |
| -------- | ---------------------- | ---- | ---------------------- |
| event    | string                 | 是   | 表示要发布的公共事件。详见[系统定义的公共事件定义](./common_event/commonEventManager-definitions.md)。  |
