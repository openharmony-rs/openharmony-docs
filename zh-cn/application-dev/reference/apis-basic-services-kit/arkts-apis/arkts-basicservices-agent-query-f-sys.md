...
| callback | [AsyncCallback](arkts-basicservices-base-asynccallback-i.md)&lt;[TaskInfo](arkts-basicservices-agent-taskinfo-i.md)&gt; | 是 | callback function with a `TaskInfo` argument for informations of the current task. |
