...
| [sdkMinorApiVersion](arkts-basicservices-deviceinfo-con.md#sdkminorapiversion) | 从API版本26.0.0起，为配合语义化版本号，新增次版本号的定义，即中间字段的值，值为整型数。完整版本号由sdkApiVersion.sdkMinorApiVersion.sdkPatchApiVersion共同构成。示例： 例如系统软件的API版本为26.0.1，则sdkMinorApiVersion为0。 例如系统软件的API版本为26.1.0，则sdkMinorApiVersion为1。 |
| [sdkPatchApiVersion](arkts-basicservices-deviceinfo-con.md#sdkpatchapiversion) | 从API版本26.0.0起，为配合语义化版本号，新增修订版本号的定义，即第三个字段的值，值为整型数。完整版本号由sdkApiVersion.sdkMinorApiVersion.sdkPatchApiVersion共同构成。示例： 例如系统软件的API版本为26.0.1，则sdkPatchApiVersion为1。 例如系统软件的API版本为26.1.0，则sdkPatchApiVersion为0。 |
