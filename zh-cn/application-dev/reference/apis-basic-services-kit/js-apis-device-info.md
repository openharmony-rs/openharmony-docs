...
| distributionOSApiName<sup>13+</sup> | string | 是 | 发行版系统API版本名称<!--Del-->，由发行方定义<!--DelEnd-->。<br/>**说明**：不建议用于版本号判断。<!--RP16--><br>示例：5.0.1<!--RP16End--><br/>**ArkTS-Dyn起始版本：** 13<br/>**ArkTS-Sta起始版本：** 24 |
