...
| displayVersion | string | 是 | 产品版本。<!--RP13--><!--RP13End--><br/>示例：<!--RP8-->XXX X.X.X.X<!--RP8End--> |
...
| sdkApiVersion | number | 是 | 系统软件API版本。<br/>**原子化服务API（仅ArkTS-Dyn）**：从API version 14开始，该接口支持在原子化服务中使用。<br/>示例：12 |
