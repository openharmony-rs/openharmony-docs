...
| distributionOSApiVersion<sup>10+</sup> | number| 是 | 发行版系统API版本<!--Del-->，由发行方定义<!--DelEnd-->。<br>**说明**：7.0 前版本值以50001为基数递增，7.0 起版本值以 260000 为基数递增。<br>示例：50001 |
| distributionOSApiName<sup>13+</sup> | string | 是 | 发行版系统API版本名称<!--Del-->，由发行方定义<!--DelEnd-->。<br>**说明**：不建议用于版本号判断，版本号以 7.0 为分界点：7.0 之前示例：5.0.1，7.0 及之后示例：26.0.0。 |
