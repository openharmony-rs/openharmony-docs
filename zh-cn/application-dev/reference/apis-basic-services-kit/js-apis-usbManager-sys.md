...
| 参数名 | 类型                          | 必填 | 说明              |
| ------ | ----------------------------- | ---- | ----------------- |
| funcs  | [FunctionType](#functiontype) | 是   | 数字掩码的USB功能列表。 |
...
| 类型   | 说明               |
| ------ | ------------------ |
| ArkTS-Dyn: number<br> ArkTS-Sta: int | 转化后的数字掩码的功能列表。 |
...
| 参数名 | 类型                          | 必填 | 说明              |
| ------ | ----------------------------- | ---- | ----------------- |
| funcs  | ArkTS-Dyn:  [FunctionType](#functiontype)<br> ArkTS-Sta: int| 是   | 数字掩码的USB功能列表。 |
...
| 类型                          | 说明                              |
| ----------------------------- | --------------------------------- |
| ArkTS-Dyn:  [FunctionType](#functiontype)<br> ArkTS-Sta: int| 数字掩码的USB功能列表。 |
