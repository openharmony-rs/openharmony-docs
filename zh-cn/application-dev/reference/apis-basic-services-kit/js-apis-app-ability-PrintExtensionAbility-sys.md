...
该模块提供调用打印扩展能力的接口。PrintExtensionAbility 是打印扩展的基类，由系统打印服务在需要打印预览等场景时回调开发者实现的扩展方法，开发者需继承该类并实现相关回调方法以提供自定义的打印扩展能力。本模块为系统接口，仅可在 Stage 模型下使用。相关打印框架信息请参见 [@ohos.print (打印)](js-apis-print.md)。
