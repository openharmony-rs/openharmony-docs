...
| nickname<sup>9+</sup> | string | 否 | 是  | 分布式账号的昵称，当需要显示用户昵称时设置。不设置时默认为空，不影响账号功能使用。 <br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23|
| avatar<sup>9+</sup> | string | 否 | 是  | 分布式账号的头像，当需要显示用户头像时设置。不设置时默认为空，不影响账号功能使用。 <br>**ArkTS-Dyn起始版本：** 9<br>**ArkTS-Sta起始版本：** 23|
