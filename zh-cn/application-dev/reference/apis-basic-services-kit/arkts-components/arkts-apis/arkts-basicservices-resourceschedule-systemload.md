...
| [off](arkts-basicservices-systemload-off-f.md#offsystemloadchange) | 取消注册系统负载回调，使用callback异步回调。 |
| [on](arkts-basicservices-systemload-on-f.md#onsystemloadchange) | 注册系统负载回调，感知系统负载融合档位变化，使用callback异步回调。 |
