...
ArkTS-Dyn: getOriginalSize(compressedFile: string): Promise\<number>
...
ArkTS-Dyn: adler32(adler: number, buf: ArrayBuffer): Promise\<number>
...
ArkTS-Dyn: adler32Combine(adler1: number, adler2: number, len2: number): Promise\<number>
...
ArkTS-Dyn: crc32(crc: number, buf: ArrayBuffer): Promise\<number>
...
ArkTS-Dyn: crc32Combine(crc1: number, crc2: number, len2: number): Promise\<number>
...
ArkTS-Dyn: crc64(crc: number, buf: ArrayBuffer): Promise\<number>
...
ArkTS-Dyn: getCrcTable(): Promise\<Array\<number>>
...
ArkTS-Dyn: getCrc64Table(): Promise\<Array\<number>>
...
ArkTS-Dyn: getZStream(): Promise\<ZStream>
...
ArkTS-Dyn: zlibCompileFlags(): Promise\<number>
...
ArkTS-Dyn: compress(dest: ArrayBuffer, source: ArrayBuffer, sourceLen?: number): Promise\<ZipOutputInfo>
...
ArkTS-Dyn: compress2(dest: ArrayBuffer, source: ArrayBuffer, level: CompressLevel, sourceLen?: number): Promise\<ZipOutputInfo>
...
ArkTS-Dyn: uncompress(dest:ArrayBuffer, source: ArrayBuffer, sourceLen?: number): Promise\<ZipOutputInfo>
...
ArkTS-Dyn: uncompress2(dest: ArrayBuffer, source: ArrayBuffer, sourceLen?: number): Promise\<DecompressionOutputInfo>
...
ArkTS-Dyn: compressBound(sourceLen: number): Promise\<number>
...
ArkTS-Dyn: inflateValidate(strm: ZStream, check: number): Promise\<ReturnStatus>
...
ArkTS-Dyn: inflateReset2(strm: ZStream, windowBits: number): Promise\<ReturnStatus>
...
ArkTS-Dyn: inflatePrime(strm: ZStream, bits: number, value: number): Promise\<ReturnStatus>
...
ArkTS-Dyn: inflateMark(strm: ZStream): Promise\<number>
...
ArkTS-Dyn: inflateInit2(strm: ZStream, windowBits: number): Promise\<ReturnStatus>
...
ArkTS-Dyn: inflateCodesUsed(strm: ZStream): Promise\<number>
...
ArkTS-Dyn: inflateBackInit(strm: ZStream, windowBits: number, window: ArrayBuffer): Promise\<ReturnStatus>
...
ArkTS-Dyn: inflateBack(strm: ZStream, backIn: InflateBackInputCallback, inDesc: object, backOut: InflateBackOutputCallback, outDesc: object): Promise\<ReturnStatus>
...
| 错误码ID | 错误信息                                                     |
| -------- | ------------------------------------------------------------ |
| 401      | The parameter check failed. Possible causes: <br />1. Mandatory parameters are left unspecified. <br />2. Incorrect parameter types. <br />3. Parameter verification failed. <br>**ArkTS模式：** 该接口仅适用于ArkTS-Dyn。<br>**ArkTS-Dyn起始版本：** 12|
| 17800004 | Compression or decompression stream error, which may be caused by an initialization error in the zlib stream structure or a modified structure. |
...
ArkTS-Dyn: type InflateBackInputCallback = (inDesc: object) => ArrayBuffer
...
ArkTS-Dyn: type InflateBackOutputCallback = (outDesc: object, buf: ArrayBuffer, length: number) => number
...
ArkTS-Dyn: deflateInit2(strm: ZStream, level: CompressLevel, method: CompressMethod, windowBits: number, memLevel: MemLevel, strategy: CompressStrategy): Promise\<ReturnStatus>
...
ArkTS-Dyn: deflateBound(strm: ZStream, sourceLength: number): Promise\<number>
...
ArkTS-Dyn: deflateTune(strm: ZStream, goodLength: number, maxLazy: number, niceLength: number, maxChain: number): Promise\<ReturnStatus>
...
ArkTS-Dyn: deflatePrime(strm: ZStream, bits: number, value: number): Promise\<ReturnStatus>
...
| 名称       | 值   | 说明                                           |
| ---------- | ---- | ---------------------------------------------- |
| OK         | 0    | 函数调用成功。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| STREAM_END | 1    | 函数调用成功，表示已处理了整个数据。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| NEED_DICT  | 2    | 函数调用成功，表示需要预设字典才能继续解压缩。<br>**原子化服务API：** 从API version 12开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 12<br>**ArkTS-Sta起始版本：** 23 |
| ERRNO<sup>23+</sup>        | -1 | 函数调用失败，表示文件操作错误。<br>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 23<br>**ArkTS-Sta起始版本：** 23 |
| STREAM_ERROR<sup>23+</sup> | -2 | 函数调用失败，表示压缩或解压缩流错误。<br>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 23<br>**ArkTS-Sta起始版本：** 23 |
| DATA_ERROR<sup>23+</sup>   | -3 | 函数调用失败，表示输入数据不正确。<br>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 23<br>**ArkTS-Sta起始版本：** 23 |
| MEM_ERROR<sup>23+</sup>    | -4 | 函数调用失败，表示内存分配失败。<br>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 23<br>**ArkTS-Sta起始版本：** 23 |
| BUF_ERROR<sup>23+</sup>    | -5 | 函数调用失败，表示输入缓冲区不正确。<br>**原子化服务API：** 从API version 23开始，该接口支持在原子化服务中使用。<br>**ArkTS-Dyn起始版本：** 23<br>**ArkTS-Sta起始版本：** 23 |
...
ArkTS-Dyn: gzdopen(fd: number, mode: string): Promise\<void>
...
ArkTS-Dyn: gzbuffer(size: number):Promise\<number>
...
ArkTS-Dyn: gzeof(): Promise\<number>
...
ArkTS-Dyn: gzdirect(): Promise\<number>
...
ArkTS-Dyn: gzgetc(): Promise\<number>
...
ArkTS-Dyn: gzfwrite(buf: ArrayBuffer, size: number, nitems: number): Promise\<number>
...
ArkTS-Dyn: gzfread(buf: ArrayBuffer, size: number, nitems: number): Promise\<number>
...
ArkTS-Dyn: gzwrite(buf: ArrayBuffer, len: number): Promise\<number>
...
ArkTS-Dyn: gzungetc(c: number): Promise\<number>
...
ArkTS-Dyn: gztell(): Promise\<number>
...
ArkTS-Dyn: gzseek(offset: number, whence: OffsetReferencePoint): Promise\<number>
...
ArkTS-Dyn: gzread(buf: ArrayBuffer): Promise\<number>
...
ArkTS-Dyn: gzputs(str: string): Promise\<number>
...
ArkTS-Dyn: gzputc(ch: number): Promise\<number>
...
ArkTS-Dyn: gzprintf(format: string, ...args: Array\<string | number>): Promise\<number>

ArkTS-Sta: gzprintf(format: string, ...args: Array\<string | double>): Promise\<int>
...
| ...args   | ArkTS-Dyn: Array\<string \| number><br>ArkTS-Sta: Array\<string \| double>  | 否   | 可变参数列表。         |
...
ArkTS-Dyn: gzoffset(): Promise\<number>
