...
实际预览流的宽高指的是相机输出流的分辨率，请参考[profile](arkts-apis-camera-i.md#profile)中的[size](arkts-apis-camera-i.md#size)，预览流的数据获取请参考[预览流二次处理](../../media/camera/native-camera-preview-imageReceiver.md)。
...
| int32_t width | 矩形宽度，相对值，范围[0, 1]。 |
| int32_t height | 矩形高度，相对值，范围[0, 1]。 |
