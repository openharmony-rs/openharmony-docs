...
| 类型 | 说明 |
| --- | --- |
| boolean | Check result for the support of the focus assist. **true** if supported, **false** |
...
| 类型 | 说明 |
| --- | --- |
| boolean | Check result for the support of the focus drive type. **true** if supported, **false** |
...
| 类型 | 说明 |
| --- | --- |
| boolean | Check result for the support of the focus range type. **true** if supported, **false** |
