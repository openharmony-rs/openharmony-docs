...
- ArkTS API<!--camera-arkts-->
  - @ohos.multimedia.camera (相机管理)<!--js-apis-camera-->
    ...
    - [Interface (Notification)](arkts-apis-camera-Notification.md)
...
- C API<!--camera-c-->
  ...
  - 头文件<!--camera-headerfile-->
    ...
    - [camera_notification_info.h](capi-camera-notification-info.md)
  ...
  - 结构体<!--camera-struct-->
    ...
    - [Camera_NotificationInfo](capi-oh-camera-oh-camera-notificationinfo.md)
