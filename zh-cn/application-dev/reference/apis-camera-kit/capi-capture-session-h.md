...
| [OH_Camera_NotificationInfo](capi-camera-notification-info.md#oh_cameranotificationinfo_getnotificationname)* notificationInfo | 指向OH_Camera_NotificationInfo实例的指针。 |
