...
| [Camera_ErrorCode OH_MetadataOutput_RegisterErrorExtCallback(Camera_MetadataOutput* metadataOutput, void* context, OH_MetadataOutput_OnErrorExt* callback)](#oh_metadataoutput_registererrorextcallback) | - | 注册监听错误事件的回调。该回调可通过{@OH_MetadataOutput_UnregisterErrorExtCallback}注销。 |
...
注册监听错误事件的回调。该回调可通过{@OH_MetadataOutput_UnregisterErrorExtCallback}注销。
