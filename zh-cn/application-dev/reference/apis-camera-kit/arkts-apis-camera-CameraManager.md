...
| 类型        | 说明                          |
| ---------- | ----------------------------- |
| boolean    | 表示设备是否支持手电筒，true表示设备支持手电筒，false表示设备不支持手电。<br>如果返回false，则[isTorchModeSupported](#istorchmodesupported11)，[getTorchMode](#gettorchmode11)，[setTorchMode](#settorchmode11)，[isTorchLevelControlSupported](#istorchlevelcontrolsupported)，[setTorchModeOnWithLevel](#settorchmodeonwithlevel)都不会生效。<br>若接口调用失败，返回undefined。 |
