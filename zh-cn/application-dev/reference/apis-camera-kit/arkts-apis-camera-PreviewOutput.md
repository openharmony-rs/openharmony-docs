...
|      类型      |     说明     |
| -------------  | ------------ |
| Array<[FrameRateRange](arkts-apis-camera-i.md#frameraterange)> | 支持的帧率范围列表，若接口异常，返回undefined。 |
...
|      类型      | 说明        |
| -------------  |-----------|
| [ImageRotation](arkts-apis-camera-e.md#imagerotation) | 获取预览旋转角度。若接口异常，返回undefined。 |
