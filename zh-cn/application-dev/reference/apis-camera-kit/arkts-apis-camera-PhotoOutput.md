...
| 类型            | 说明                     |
| -------------- | ----------------------- |
| boolean | 返回是否支持动态照片拍照。true表示支持，false表示不支持。若接口异常，返回undefined。 |
...
| 类型            | 说明                |
| -------------- |-------------------|
| Array\<[VideoCodecType](arkts-apis-camera-e.md#videocodectype13)\> | 支持的动态照片短视频编码类型列表。若接口异常，返回undefined。 |
...
|      类型      | 说明        |
| -------------  |-----------|
| [ImageRotation](arkts-apis-camera-e.md#imagerotation) | 获取拍照旋转角度。若接口异常，返回undefined。 |
