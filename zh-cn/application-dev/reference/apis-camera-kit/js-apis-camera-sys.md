...
ArkTS-Dyn: setFocusDistance(distance: number): void

ArkTS-Sta: setFocusDistance(distance: double): void
...
ArkTS-Dyn: getFocusDistance(): number

ArkTS-Sta: getFocusDistance(): double
...
| 类型                                   | 说明                         |
| -------------------------------------- | ---------------------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: double | 返回当前对焦距离的归一化值。 |
...
function getFocusDistance(professionalPhotoSession: camera.ProfessionalPhotoSession): double {
...
ArkTS-Dyn: getIsoRange(): Array\<number\>

ArkTS-Sta: getIsoRange(): Array\<int\>
...
| 类型                                                  | 说明                                                         |
| ----------------------------------------------------- | ------------------------------------------------------------ |
| ArkTS-Dyn: Array\<number\><br>ArkTS-Sta: Array\<int\> | 用于获取ISO范围，范围为[50,100,...,6400]，实际根据底层能力返回为准，接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](arkts-apis-camera-e.md#cameraerrorcode)。 |
...
function getIsoRange(professionalPhotoSession: camera.ProfessionalPhotoSession): Array<int> {
  let isoRange: Array<int> = [];
  try {
    isoRange = professionalPhotoSession.getIsoRange();
  } catch (error) {
    // 失败返回错误码error.code并处理。
...
ArkTS-Dyn: setIso(iso: number): void

ArkTS-Sta: setIso(iso: int): void
...
| 参数名 | 类型                                | 必填 | 说明        |
| ------ | ----------------------------------- | ---- | ----------- |
| iso    | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 设置ISO值。 |
...
ArkTS-Dyn: getIso(): number

ArkTS-Sta: getIso(): int
...
| 类型                                | 说明            |
| ----------------------------------- | --------------- |
| ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回当前ISO值。 |
...
function getIso(professionalPhotoSession: camera.ProfessionalPhotoSession): int {
  let iso: int = 0;
  try {
    iso = professionalPhotoSession.getIso();
  } catch (error) {
...
function registerSessionError(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onError(callback);
}
```
...
```ts
function unregisterSessionError(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offError();
}
```
...
function registerFocusStateChange(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offFocusStateChange();
}
```
...
function registerSmoothZoomInfo(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onSmoothZoomInfoAvailable(callback);
}
```
...
```ts
function unregisterSmoothZoomInfo(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offSmoothZoomInfoAvailable();
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onIsoInfoChange](#onisoinfochange22)。
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[on("isoInfoChange")](#onisoinfochange12)。
...
function isoInfoCallback(err: BusinessError | null, info: camera.IsoInfo | undefined): void {
  if (err !== undefined && err!.code !== 0) {
    console.error(`Callback Error, errorCode: ${err!.code}`);
    return;
  }
...
function registerIsoInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onIsoInfoChange(isoInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offIsoInfoChange](#offisoinfochange22)。
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("isoInfoChange")](#offisoinfochange12)。
...
```ts
function unregisterIsoInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offIsoInfoChange();
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onExposureInfoChange](#onexposureinfochange22)。
...
### onExposureInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[on("exposureInfoChange")](#onexposureinfochange12)。
...
function exposureInfoCallback(err: BusinessError | null, info: camera.ExposureInfo | undefined): void {
  if (err !== undefined && err!.code !== 0) {
    console.error(`Callback Error, errorCode: ${err!.code}`);
    return;
  }
...
function registerExposureInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onExposureInfoChange(exposureInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offExposureInfoChange](#offexposureinfochange22)。
...
### offExposureInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("exposureInfoChange")](#offexposureinfochange12)。
...
```ts
function unregisterExposureInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offExposureInfoChange();
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onApertureInfoChange](#onapertureinfochange22)。
...
### onApertureInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[on("apertureInfoChange")](#onapertureinfochange12)。
...
function apertureInfoCallback(err: BusinessError | null, info: camera.ApertureInfo | undefined): void {
  if (err !== undefined && err!.code !== 0) {
    console.error(`Callback Error, errorCode: ${err!.code}`);
    return;
  }
...
function registerApertureInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onApertureInfoChange(apertureInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offApertureInfoChange](#offapertureinfochange22)。
...
### offApertureInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("apertureInfoChange")](#offapertureinfochange12)。
...
```ts
function unregisterApertureInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offApertureInfoChange();
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onLuminationInfoChange](#onluminationinfochange22)。
...
### onLuminationInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[on("luminationInfoChange")](#onluminationinfochange12)。
...
function luminationInfoCallback(err: BusinessError | null, info: camera.LuminationInfo | undefined): void {
  if (err !== undefined && err!.code !== 0) {
    console.error(`Callback Error, errorCode: ${err!.code}`);
    return;
  }
...
function registerLuminationInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.onLuminationInfoChange(luminationInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offLuminationInfoChange](#offluminationinfochange22)。
...
### offLuminationInfoChange<sup>22+</sup>
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("luminationInfoChange")](#offluminationinfochange12)。
...
```ts
function unregisterLuminationInfoEvent(professionalPhotoSession: camera.ProfessionalPhotoSession): void {
  professionalPhotoSession.offLuminationInfoChange();
}
```
...
function registerSessionError(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onError(callback);
}
```
...
```ts
function unregisterSessionError(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offError();
}
```
...
function registerFocusStateChange(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offFocusStateChange();
}
```
...
function registerSmoothZoomInfo(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onSmoothZoomInfoAvailable(callback);
}
```
...
```ts
function unregisterSmoothZoomInfo(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offSmoothZoomInfoAvailable();
}
```
...
function registerIsoInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onIsoInfoChange(isoInfoCallback);
}
```
...
```ts
function unregisterIsoInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offIsoInfoChange();
}
```
...
function registerExposureInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onExposureInfoChange(exposureInfoCallback);
}
```
...
```ts
function unregisterExposureInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offExposureInfoChange();
}
```
...
function registerApertureInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onApertureInfoChange(apertureInfoCallback);
}
```
...
```ts
function unregisterApertureInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offApertureInfoChange();
}
```
...
function registerLuminationInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.onLuminationInfoChange(luminationInfoCallback);
}
```
...
```ts
function unregisterLuminationInfoEvent(professionalVideoSession: camera.ProfessionalVideoSession): void {
  professionalVideoSession.offLuminationInfoChange();
}
```
...
function registerSessionError(macroPhotoSession: camera.MacroPhotoSession): void {
  macroPhotoSession.onError(callback);
}
```
...
function registerFocusStateChange(macroPhotoSession: camera.MacroPhotoSession): void {
  macroPhotoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(macroPhotoSession: camera.MacroPhotoSession): void {
  macroPhotoSession.offFocusStateChange();
}
```
...
function registerSmoothZoomInfo(macroPhotoSession: camera.MacroPhotoSession): void {
  macroPhotoSession.onSmoothZoomInfoAvailable(callback);
}
```
...
```ts
function unregisterSmoothZoomInfo(macroPhotoSession: camera.MacroPhotoSession): void {
  macroPhotoSession.offSmoothZoomInfoAvailable();
}
```
...
function registerSessionError(macroVideoSession: camera.MacroVideoSession): void {
  macroVideoSession.onError(callback);
}
```
...
function registerFocusStateChange(macroVideoSession: camera.MacroVideoSession): void {
  macroVideoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(macroVideoSession: camera.MacroVideoSession): void {
  macroVideoSession.offFocusStateChange();
}
```
...
function registerSmoothZoomInfo(macroVideoSession: camera.MacroVideoSession): void {
  macroVideoSession.onSmoothZoomInfoAvailable(callback);
}
```
...
```ts
function unregisterSmoothZoomInfo(macroVideoSession: camera.MacroVideoSession): void {
  macroVideoSession.offSmoothZoomInfoAvailable();
}
```
...
| 参数名  | 类型    | 必填 | 说明                                                         |
| ------- | ------- | ---- | ------------------------------------------------------------ |
| enabled | boolean | 是   | ArkTS-Dyn: 使能或去使能LCD闪光灯，true为使能，false为去使能。传参为null或者undefined，作为0处理，去使能LCD闪光灯。<br/>ArkTS-Sta: 使能或去使能LCD闪光灯，true为使能，false为去使能。目前不支持传参为null或者undefined。 |
...
function registerSessionError(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onError(callback);
}
```
...
```ts
function unregisterSessionError(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offError();
}
```
...
function registerFocusStateChange(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offFocusStateChange();
}
```
...
function registerIsoInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onIsoInfoChange(isoInfoCallback);
}
```
...
```ts
function unregisterIsoInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offIsoInfoChange();
}
```
...
function registerExposureInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onExposureInfoChange(exposureInfoCallback);
}
```
...
```ts
function unregisterExposureInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offExposureInfoChange();
}
```
...
function registerLuminationInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onLuminationInfoChange(luminationInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("luminationInfoChange")](#offsluminationinfochange12)。
...
```ts
function unregisterLuminationInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offLuminationInfoChange();
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[onTryAEInfoChange](#ontryaeinfochange22)。
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[on("tryAEInfoChange")](#ontryaeinfochange12)。
...
function tryAEInfoCallback(err: BusinessError | null, info: camera.TryAEInfo | undefined): void {
  if (err !== undefined && err!.code !== 0) {
    console.error(`Callback Error, errorCode: ${err!.code}`);
    return;
  }
...
function registerTryAEInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.onTryAEInfoChange(tryAEInfoCallback);
}
```
...
**相关接口：** 该接口对应的ArkTS-Sta接口是[offTryAEInfoChange](#offtryaeinfochange22)。
...
**相关接口：** 该接口对应的ArkTS-Dyn接口是[off("tryAEInfoChange")](#offtryaeinfochange12)。
...
```ts
function unregisterTryAEInfoEvent(timeLapsePhotoSession: camera.TimeLapsePhotoSession): void {
  timeLapsePhotoSession.offTryAEInfoChange();
}
```
...
ArkTS-Dyn: getSupportedTimeLapseIntervalRange(): Array\<number\>

ArkTS-Sta: getSupportedTimeLapseIntervalRange(): Array\<int\>
...
| 类型                                                  | 说明                                                         |
| ----------------------------------------------------- | ------------------------------------------------------------ |
| ArkTS-Dyn: Array\<number\><br>ArkTS-Sta: Array\<int\> | 用于获取拍摄间隔范围，单位毫秒（ms），根据底层能力返回为准，接口调用失败会返回相应错误码，错误码类型[CameraErrorCode](arkts-apis-camera-e.md#cameraerrorcode)。 |
...
function getSupportedTimeLapseIntervalRange(timeLapsePhotoSession: camera.TimeLapsePhotoSession): Array<int> {
  let intervalRange: Array<int> = [];
  try {
    intervalRange = timeLapsePhotoSession.getSupportedTimeLapseIntervalRange();
  } catch (error) {
    // 失败返回错误码error.code并处理。
...
ArkTS-Dyn: getTimeLapseInterval(): number

ArkTS-Sta: getTimeLapseInterval(): int
...
| 类型                                | 说明                                 |
| ----------------------------------- | ------------------------------------ |
| ArkTS-Dyn: number<br>ArkTS-Sta: int | 返回当前拍摄间隔值，单位毫秒（ms）。 |
...
function getTimeLapseInterval(timeLapsePhotoSession: camera.TimeLapsePhotoSession): int {
  let interval: int = 0;
  try {
    interval = timeLapsePhotoSession.getTimeLapseInterval();
  } catch (error) {
...
ArkTS-Dyn: setTimeLapseInterval(interval: number): void

ArkTS-Sta: setTimeLapseInterval(interval: int): void
...
| 参数名   | 类型                                | 必填 | 说明                             |
| -------- | ----------------------------------- | ---- | -------------------------------- |
| interval | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是   | 设置拍摄间隔值，单位毫秒（ms）。 |
...
function registerSessionError(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.onError(callback);
}
```
...
```ts
function unregisterSessionError(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.offError();
}
```
...
function registerFocusStateChange(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.onFocusStateChange(callback);
}
```
...
```ts
function unregisterFocusStateChange(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.offFocusStateChange();
}
```
...
function registerSmoothZoomInfo(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.onSmoothZoomInfoAvailable(callback);
}
```
...
```ts
function unregisterSmoothZoomInfo(lightPaintingPhotoSession: camera.LightPaintingPhotoSession): void {
  lightPaintingPhotoSession.offSmoothZoomInfoAvailable();
}
```
