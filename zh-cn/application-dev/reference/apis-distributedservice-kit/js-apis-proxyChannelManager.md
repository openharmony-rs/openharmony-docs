...
**设备行为差异**：该接口在Phone/Tablet设备中可正常调用，其他支持分布式业务的设备中会返回错误码32390101，不支持分布式业务的Wearable设备中会返回错误码801。开发者可通过`canIUse('SystemCapability.DistributedSched.AppCollaboration')`判断当前设备是否支持该功能。
