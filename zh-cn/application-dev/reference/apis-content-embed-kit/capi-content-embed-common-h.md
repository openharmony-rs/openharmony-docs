...
| [ContentEmbed_CapabilityCode](#contentembed_capabilitycode) | ContentEmbed_CapabilityCode | 嵌入文档对象支持能力的枚举，可通过位掩码组合多个能力值。 |
...
| CE_ERR_PARAM_INVALID = 401 | 参数不合法，请检查参数类型和取值范围是否正确。<br>**起始版本：** 24 |
| CE_ERR_DEVICE_NOT_SUPPORTED = 801 | 当前设备不支持此功能。<br>**起始版本：** 24 |
| CE_ERR_NULL_POINTER = 35300001 | 空指针错误，可能是内存分配失败或内部错误。<br>**起始版本：** 24 |
...
| CE_ERR_INVALID_LINKING_PATH = 35300012 | 链接了不允许链接目录中的文件，如应用沙箱目录内的文件。<br>**起始版本：** 24 |
