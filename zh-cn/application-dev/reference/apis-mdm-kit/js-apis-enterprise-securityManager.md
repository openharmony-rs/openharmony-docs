...
设置除应用市场外，受信任开发者的扩展程序的运行开关管控策略。设置为DEFAULT时，表示无管控策略，受信任开发者的扩展程序开关保持设备当前
设置状态，用户可操作开关打开或关闭。开关打开，扩展程序可正常运行。开关关闭，扩展程序不可运行。设置为DISALLOW时，表示禁用策略，
受信任开发者的扩展程序开关强制关闭，扩展程序不可运行。设置为FORCE_OPEN时，表示强制打开策略，受信任开发者的扩展程序开关强制打开，
扩展程序可正常运行。
