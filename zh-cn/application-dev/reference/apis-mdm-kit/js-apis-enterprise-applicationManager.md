...
| ------------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| admin         | [Want](../apis-ability-kit/js-apis-app-ability-want.md)      | 是   | 企业设备管理扩展组件。                         |
| applicationInstances | Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 是   | 不可关停应用名单数组。不可关停应用名单最多支持包含10个应用，该数量限制不区分用户，即所有用户下添加应用的总和的最大限制为10个。例如：若当前名单中已有3个应用，则最多还能通过本接口为指定用户添加7个应用。 |
...
| ------------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| admin         | [Want](../apis-ability-kit/js-apis-app-ability-want.md)      | 是   | 企业设备管理扩展组件。                         |
| applicationInstances | Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 是   | 不可关停应用名单数组。 |
...
| 类型                                                         | 说明                 |
| ------------------------------------------------------------ | -------------------- |
| Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 不可关停应用名单数组。|
...
| ------------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| admin         | [Want](../apis-ability-kit/js-apis-app-ability-want.md)      | 是   | 企业设备管理扩展组件。                         |
| applicationInstances | Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 是   | 后台防冻结应用名单数组，后台防冻结应用名单最多支持包含10个应用，该数量限制不区分用户，即所有用户下添加应用的总和的最大限制为10个。例如：若当前名单中已有3个应用，则最多还能通过本接口为指定用户添加7个应用。 |
...
| ------------- | ------------------------------------------------------------ | ---- | -------------------------------------- |
| admin         | [Want](../apis-ability-kit/js-apis-app-ability-want.md)      | 是   | 企业设备管理扩展组件。                         |
| applicationInstances | Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 是   | 后台防冻结应用名单数组。 |
...
| 类型                                                         | 说明                 |
| ------------------------------------------------------------ | -------------------- |
| Array&lt;[ApplicationInstance](./js-apis-enterprise-common.md#applicationinstance22)&gt; | 后台防冻结应用名单数组。|
