...
**替代接口：** [addDisallowedUninstallBundlesSync](arkts-mdm-bundlemanager-adddisalloweduninstallbundlessync-f.md)
...
参见 [addDisallowedUninstallBundles](#adddisalloweduninstallbundles)
