...
删除本MDM应用在当前用户下收集到的设备日志。 > **说明：** > > 在应用调用[startCollectLog]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_开始收集日志后，收到 > [EnterpriseAdminExtensionAbility.onLogCollected]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_ > 回调时，建议立即拷贝或者处理日志，并调用此接口删除收集到的日志。 > > 若不调本接口，设备日志会占用系统存储空间，不影响下一次调用[startCollectLog]\_\_\_JSDOC\_LINK\_DESC\_USD\_2\_\_\_启动日志收集任务。
