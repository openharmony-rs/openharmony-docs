...
**替代接口：** [@ohos.enterprise.securityManager:securityManager.installUserCertificate](arkts-mdm-securitymanager-installusercertificate-f.md#installusercertificate)
