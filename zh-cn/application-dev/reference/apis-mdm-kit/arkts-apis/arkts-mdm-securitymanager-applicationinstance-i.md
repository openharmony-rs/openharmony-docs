...
用户ID，指定具体用户，取值范围：大于等于0。accountId可以通过@ohos.account.osAccount中的 [getOsAccountLocalId]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_等接口来获取。
...
应用[唯一标识符]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_，如果应用没有appIdentifier可使用appId代替，可以通过接口 [bundleManager.getBundleInfo]\_\_\_JSDOC\_LINK\_DESC\_USD\_1\_\_\_获取 bundleInfo.signatureInfo.appIdentifier和bundleInfo.signatureInfo.appId。
