...
| callback | AsyncCallback&lt;boolean&gt; | 是 | �ص�������callback��ʽ����HDC�Ƿ񱻽��ã�true��ʾHDC�����ã�false��ʾHDCδ�����á� |
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;boolean&gt; | Promise����Promise��ʽ����HDC�Ƿ񱻽��ã�true��ʾHDC�����ã�false��ʾHDCδ�����á� |
