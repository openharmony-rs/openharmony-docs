...
| usbDevices | Array&lt;UsbDeviceType&gt; | 是 | Ҫ�Ƴ���USB�豸���͵����飬UsbDeviceType��Ϣ����ͨ��<br/>[getDevices](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-usbmanager-getdevices-f.md#getDevices-1)�ӿڻ�ȡ�� |
