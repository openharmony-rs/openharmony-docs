...
| [getScreenOffTime](arkts-mdm-devicesettings-getscreenofftime-f-sys.md#getScreenOffTime（系统接口）) | 获取设备息屏时间，使用Promise异步回调。 |
...
| [installUserCertificate](arkts-mdm-devicesettings-installusercertificate-f-sys.md#installUserCertificate（系统接口）) | 安装用户证书，使用Promise异步回调。 |
...
| [uninstallUserCertificate](arkts-mdm-devicesettings-uninstallusercertificate-f-sys.md#uninstallUserCertificate（系统接口）) | 卸载用户证书，使用Promise异步回调。 |
<!--DelEnd-->
