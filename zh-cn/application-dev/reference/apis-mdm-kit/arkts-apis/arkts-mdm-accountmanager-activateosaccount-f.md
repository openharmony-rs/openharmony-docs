...
| --- | --- | --- | --- |
| admin | Want | 是 | ��ҵ�豸������չ����� |
| accountId | number | 是 | ϵͳ�˺�ID��<br/><br/>ȡֵӦΪ��100�������� |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Promise&lt;void&gt; | promise�ص� |
...
| [9201041](../../errorcode-universal.md#9201041-Restricted) | Restricted account. |
| [9201046](../../errorcode-universal.md#9201046-The) | The number of signed-in accounts reaches the upper limit. |
