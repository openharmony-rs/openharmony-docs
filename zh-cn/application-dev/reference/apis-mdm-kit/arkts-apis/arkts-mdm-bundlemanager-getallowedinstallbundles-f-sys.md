...
��ȡ��ǰ�û��µ�Ӧ�ó������װ����������ʹ��callback�첽�ص���

**起始版本：** 10

**废弃版本：** 26.0.0

**替代接口：** [getAllowedInstallBundlesSync](arkts-mdm-bundlemanager-getallowedinstallbundlessync-f.md#getAllowedInstallBundlesSync-1)
...
��ȡָ���û���ͨ��userIdָ�����µ�Ӧ�ó������װ����������ʹ��callback�첽�ص���
...
| 类型 | 说明 |
| --- | --- |
| Promise&lt;Array&lt;string&gt;&gt; | Promise���󣬷��ص�ǰ/ָ���û��µ�Ӧ�ó������װ���������� |
