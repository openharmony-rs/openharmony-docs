...
设置升级策略。设置成功后，系统将按照指定的策略类型进行OTA升级处理，不同策略类型对应不同的升级行为。内网升级场景下，需要先调用 [systemManager.notifyUpdatePackages]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_接口通知系统更新包，再调用该接口设置升级策略。
...
| policy | \_\_\_MD\_LINK\_USD\_0\_\_\_ | 是 | 升级策略。 |
