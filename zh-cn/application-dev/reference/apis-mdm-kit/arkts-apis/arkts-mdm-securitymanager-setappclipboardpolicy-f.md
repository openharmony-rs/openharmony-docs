...
| tokenId | number | 是 | Ŀ��Ӧ�õ����ݱ�ʶ����ͨ��[bundleManager.getApplicationInfo](../../apis-ability-kit/arkts-apis/arkts-ability-applicationinfo-i.md#ApplicationInfo)��<br/>ȡaccessTokenId�� |
| policy | ClipboardPolicy | 是 | ��������ԡ� |
