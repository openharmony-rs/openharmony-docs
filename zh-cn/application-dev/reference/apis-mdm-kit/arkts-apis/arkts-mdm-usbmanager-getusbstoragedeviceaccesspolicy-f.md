...
| 类型 | 说明 |
| --- | --- |
| \_\_\_MD\_LINK\_USD\_0\_\_\_ | USB存储设备访问策略。设置为READ\_\_\_ESCAPED\_UNDERSCORE\_\_\_WRITE表示允许读写USB存储设备；设置为READ\_\_\_ESCAPED\_UNDERSCORE\_\_\_ONLY表示仅允许读取USB存储设备，禁止写入；设置为DISABLED表示完全禁止访问 |
