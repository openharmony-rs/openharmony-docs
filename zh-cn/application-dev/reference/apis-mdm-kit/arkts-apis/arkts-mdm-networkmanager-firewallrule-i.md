...
防火墙过滤规则。 API version 21及之前版本，仅支持IPv4。从API version 22开始，支持IPv4和IPv6。 从API version 23开始，支持[LogType]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_。
...
接收或者丢弃数据包。 添加防火墙过滤规则时必填； 移除防火墙时非必填，当值为空时，表示清空所有的匹配[Action]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_规则的链，且srcAddr，destAddr，srcPort，destPort，appUid也必须传入 空值。
...
规则链。 添加防火墙过滤规则时必填； 移除防火墙时非必填，当值为空时，表示清空所有的[Direction]\_\_\_JSDOC\_LINK\_DESC\_USD\_0\_\_\_链，且srcAddr，destAddr，srcPort，destPort，appUid也必须传 入空值。
