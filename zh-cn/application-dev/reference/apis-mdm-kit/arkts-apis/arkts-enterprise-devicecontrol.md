...
| [operateDevice](arkts-mdm-devicecontrol-operatedevice-f.md#operateDevice) | 允许管理员操作设备，例如在企业设备管理场景下，管理员可远程控制员工设备执行磁盘擦除、恢复出厂设置、重启、关机、锁屏、锁定设备或解锁设备等操作。 |
...
| [resetFactory](arkts-mdm-devicecontrol-resetfactory-f-sys.md#resetFactory（系统接口）) | 使设备恢复出厂设置。使用Promise异步回调。 |
