...
| usbDeviceIds | Array&lt;UsbDeviceId&gt; | 是 | USB�豸ID���飬UsbDeviceId��Ϣ����ͨ��<br/>[getDevices](../../apis-basic-service-kit/arkts-apis/arkts-basicservices-usbmanager-getdevices-f.md#getDevices-1)�ӿڻ�ȡ�� |
