...
| parameters  | Record\<string, string> | 是 | 自定义参数信息，其中Key值必须包含："activateId"，可以包含"customizedInfo"、"localDeactivationPolicy"。<br/>- activatedId：项目激活ID。<br/>- customizedInfo：企业自定义信息<!--RP1--><!--RP1End-->。 |
