...
添加蓝牙设备可用名单。添加蓝牙设备可用名单后当前设备仅允许连接该名单下的蓝牙设备。建议添加到数组中的MAC地址符合蓝牙MAC规范（例如：00:1A:2B:3C:4D:5E）。
...
添加蓝牙设备禁用名单。添加禁用名单后当前设备不允许连接该名单下的蓝牙设备。建议添加到数组中的MAC地址符合蓝牙MAC规范（例如：00:1A:2B:3C:4D:5E）。
