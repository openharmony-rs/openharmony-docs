...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| isFromMock | Boolean | 否 | 是 | true：地名信息来自于逆地理编码模拟功能。<br/>false：地名信息不是来自于逆地理编码模拟功能。<br/>**系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| isFromMock | Boolean | 否 | 是 | true：位置信息来自于位置模拟功能。<br/>false：位置信息不是来自于位置模拟功能。<br/>**系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| location |  [ReverseGeoCodeRequest](js-apis-geoLocationManager.md#reversegeocoderequest) | 否 | 否 | 表示经纬度信息。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20|
| geoAddress |  [GeoAddress](#geoaddress) | 否 | 否 |表示地名信息。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| timeInterval | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 否 | 表示模拟位置上报的时间间隔，单位是秒。 **系统API**：此接口为系统接口。|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| type | [LocatingRequiredDataType](#locatingrequireddatatype10) | 否 | 否 | 表示请求获取数据的类型。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| needStartScan |  boolean | 否 | 否 | true：需要发起扫描。<br/>false：不需要发起扫描。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| scanInterval |  ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 是 | 表示扫描的时间间隔。单位是毫秒，默认值是10000毫秒，取值范围为大于0。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| scanTimeout |  ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 是 | 表示单次扫描的超时时间。单位是毫秒，默认值是10000毫秒，取值范围为大于0小于600000。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| sportsType<sup>18+</sup> | [SportsType](#sportstype18) | 否 | 是 | 表示运动类型。<br/>**原子化服务API：** 从API version 18开始，该接口支持在原子化服务中使用。**系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| wifiData | [WifiScanInfo](#wifiscaninfo10) | 否 | 是 | 表示WiFi扫描结果。 **系统API**：此接口为系统接口。**系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| bluetoothData |  [BluetoothScanInfo](#bluetoothscaninfo10) | 否 | 是 | 表示蓝牙扫描结果。 **系统API**：此接口为系统接口。**系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| ssid | string | 否 | 否 | WiFi热点的SSID，编码格式为UTF-8。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| bssid | string | 否 | 否 | WiFi热点的BSSID。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| rssi | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 否 | WiFi热点的信号强度(dBm)。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| frequency | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 否 | WiFi热点的频率。单位是赫兹。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| timestamp | ArkTS-Dyn: number<br>ArkTS-Sta: long | 否 | 否 | 时间戳。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| -------- | -------- | -------- | -------- | -------- |
| deviceName | string | 否 | 否 | 蓝牙设备名称。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| macAddress | string | 否 | 否 | 蓝牙设备的MAC地址。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| rssi | ArkTS-Dyn: number<br>ArkTS-Sta: int | 否 | 否 | 蓝牙设备的信号强度(dBm)。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| timestamp | ArkTS-Dyn: number<br>ArkTS-Sta: long | 否 | 否 | 时间戳。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 值 | 说明 |
| -------- | -------- | -------- |
| OTHERS | 0 | 其他场景。预留字段。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20|
| STARTUP | 1 | 开机向导场景下的隐私协议。在开机时弹出协议，提醒用户阅读并选择是否授权。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20|
| CORE_LOCATION | 2 | 开启网络定位时弹出的隐私协议。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 9  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 值 | 说明 |
| -------- | -------- | -------- |
| WIFI  | 1 | 表示WiFi扫描信息。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
| BLUETOOTH | 2 | 表示蓝牙扫描信息。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 10  <br>**ArkTS-Sta起始版本：** 20|
...
| 名称 | 值 | 说明 |
| -------- | -------- | -------- |
| LOCATING_NOT_STARTED  | 0 | 表示当前无定位业务，无需显示定位图标。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 12  <br>**ArkTS-Sta起始版本：** 20|
| LOCATING_STARTED | 1 | 表示当前在进行普通定位业务，需要显示普通定位图标。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 12  <br>**ArkTS-Sta起始版本：** 20|
| HD_LOCATING_STARTED | 2 | 表示当前正在进行高精度定位业务，需要显示高精度定位图标。 **系统API**：此接口为系统接口。<br>**ArkTS-Dyn起始版本：** 12  <br>**ArkTS-Sta起始版本：** 20|
...
**参数**：
  ...
  | 参数名 | 类型 | 必填 | 说明 |
  | -------- | -------- | -------- | -------- |
  | userId | ArkTS-Dyn: number<br>ArkTS-Sta: int | 是 | 系统账号ID，获取系统账号ID可参考[查询所有已创建的系统账号](../../basic-services/account/manage-os-account.md#查询所有已创建的系统账号)|
