...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;boolean&gt; | 是 | Indicates the callback for hasSimCard.Returns {@code true} if a SIM card is inserted; return {@code false} otherwise. |
