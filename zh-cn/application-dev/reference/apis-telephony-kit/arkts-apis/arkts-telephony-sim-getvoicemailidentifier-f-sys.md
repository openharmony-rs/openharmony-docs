...
| callback | \_\_\_MD\_LINK\_USD\_0\_\_\_&lt;string&gt; | 是 | Indicates the callback for getting the voice mailbox alpha identifier;returns an empty string if no voice mailbox alpha identifier is written into the SIM card. |
