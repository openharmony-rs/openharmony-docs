...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;number&gt; | 是 | 以callback形式异步返回结果。<br>- 0：卡槽1。 <br>- 1：卡槽2。<br>- 2：esim和天际通场景下，默认移动数据的slotId为2。 |
