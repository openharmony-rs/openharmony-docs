...
| callback | [AsyncCallback](../../apis-basic-services-kit/arkts-apis/arkts-basicservices-base-asynccallback-i.md)&lt;Array&lt;string&gt;&gt; | 是 | 回调函数。返回会议的呼叫Id列表。 |
...
| 类型 | 说明 |
| --- | --- |
| Promise & lt;Array & lt;string & gt; & gt; | 以Promise形式异步返回会议的呼叫Id列表。 |
