...
| surfaceId | string | 是 | 预览窗口Id。surfaceId获取方式可参考[getXComponentSurfaceId](../../apis-arkui/arkts-components/arkts-arkui-xcomponent-comp-xcomponentcontroller-c.md#getxcomponentsurfaceid)。 |
