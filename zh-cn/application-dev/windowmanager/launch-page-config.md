...
> 
> - 启动页中的图片资源支持的文件格式同[Image组件/apis-arkui/arkui-ts/ts-basic-components-image.md)，考虑到解码性能和显示效果，建议启动页中使用jpg或png格式的图片资源。
