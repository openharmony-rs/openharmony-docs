...
| `-user {userId}` | 查看指定用户的窗口信息 | `hidumper -s WindowManagerService -a '-user 100 -a'` | 多用户场景下，已知用户ID，需要查看特定用户名下的窗口信息。<br><!--PR2-->针对搭载OpenHarmony 7.1及以上版本的设备，新增支持-user参数。<!--PR2End--> |
