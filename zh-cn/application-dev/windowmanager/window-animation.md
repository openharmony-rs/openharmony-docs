...
<!--Del-->
- [设置系统窗口动效（仅对系统应用开放）](#设置系统窗口动效（仅对系统应用开放）)
<!--DelEnd-->
...
在Stage模型下，允许系统应用创建和管理系统窗口，包括音量条、壁纸、通知栏、导航栏、设置窗口层级的系统窗口等。具体支持的系统窗口类型可见[WindowType](../reference/apis-arkui/js-apis-window-sys.md#windowtype7)。
