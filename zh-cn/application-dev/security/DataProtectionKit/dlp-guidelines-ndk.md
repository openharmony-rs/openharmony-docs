...
数据防泄露（Data Loss Prevention，DLP）是系统提供的系统级的数据防泄露解决方案，提供跨设备的文件的权限管理、加密存储、授权访问等能力。
...
## 接口说明
数据防泄露服务关键接口如下表所示。具体API说明详见[API参考](../../reference/apis-data-protection-kit/capi-dlp-permission-api-h.md)
| 名称 | 描述 |
| -------- | -------- |
