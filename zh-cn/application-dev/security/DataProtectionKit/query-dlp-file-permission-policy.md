...
Data Protection Kit为应用提供了获取 DLP 文件权限策略信息的能力，应用可查询某个 DLP 文件的具体策略，包括授权用户列表、授予权限、是否允许离线打开、企业自定义策略等。
...
2. 获取 DLP 文件的权限策略信息。
    ...
    <!-- @[dlp_queryDlpPolicy](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/SystemFeature/Security/DLP/entry/src/main/ets/pages/Index.ets) -->
