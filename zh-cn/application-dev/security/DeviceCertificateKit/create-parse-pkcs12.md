...
从API version 18开始，支持解析PKCS12证书。

从API version 21开始，支持创建PKCS12证书。
...
1. 导入[证书模块/apis-device-certificate-kit/js-apis-cert.md)。
   ...
   ```
2. 调用[cert.createPkcs12/apis-device-certificate-kit/js-apis-cert.md#certcreatepkcs1221)创建PKCS12文件。

3. 调用[cert.parsePkcs12/apis-device-certificate-kit/js-apis-cert.md#certparsepkcs1218)解析PKCS12文件。
