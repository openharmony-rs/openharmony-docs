...
2. 基于已有的证书数据，调用[cert.createX509CertChain/apis-device-certificate-kit/js-apis-cert.md#certcreatex509certchain11)创建X509证书链对象，并返回结果。

3. 调用[x509CertChain.getCertList/apis-device-certificate-kit/js-apis-cert.md#getcertlist11)获取证书链中的X509证书列表。

4. 调用[x509CertChain.validate/apis-device-certificate-kit/js-apis-cert.md#validate11)使用校验参数校验证书链并返回结果。
