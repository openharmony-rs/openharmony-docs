...
- 保存控件仅支持在应用主窗口和子窗口[WindowType](../../reference/apis-arkui/arkts-apis-window-e.md#windowtype7)中使用，且不支持在[UIExtension](../../reference/apis-arkui/js-apis-arkui-uiExtension.md)中使用。
