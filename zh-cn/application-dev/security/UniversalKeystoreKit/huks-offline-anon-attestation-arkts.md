...
2. 初始化参数集。
   ...
   HuksParam[]中的HuksParam字段参数必须包含HUKS_TAG_ATTESTATION_CHALLENGE属性，可选参数包含HUKS_TAG_ATTESTATION_ID_VERSION_INFO、HUKS_TAG_ATTESTATION_ID_ALIAS属性。

3. 生成非对称密钥，具体请参考密钥生成。

4. 将密钥别名与参数集作为参数传入anonAttestKeyItemOffline方法中，即可进行离线匿名密钥证明。
