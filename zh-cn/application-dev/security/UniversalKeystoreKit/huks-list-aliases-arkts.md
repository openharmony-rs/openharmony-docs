...
1. 初始化密钥属性集，用于查询指定密钥别名集TAG。TAG仅支持[HUKS_TAG_AUTH_STORAGE_LEVEL/apis-universal-keystore-kit/js-apis-huks.md#hukstag)。

2. 调用接口[listAliases/apis-universal-keystore-kit/js-apis-huks.md#hukslistaliases12)，查询密钥别名集。
