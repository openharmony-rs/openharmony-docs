...
- **清除认证状态**：通过[clearUkeyPinAuthState](../../reference/apis-universal-keystore-kit/js-apis-huksExternalCrypto.md#huksexternalcryptoclearukeypinauthstate26)清除指定资源的PIN码认证状态。
