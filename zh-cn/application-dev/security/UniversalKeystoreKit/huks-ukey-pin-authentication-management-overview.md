...
- **查询认证状态**：通过[getUkeyPinAuthState/apis-universal-keystore-kit/js-apis-huksExternalCrypto.md#huksexternalcryptogetukeypinauthstate)查询当前PIN码认证状态。
- **清除认证状态**：从API版本26.0.0开始，可通过[clearUkeyPinAuthState/apis-universal-keystore-kit/js-apis-huksExternalCrypto.md#huksexternalcryptoclearukeypinauthstate)清除指定资源的PIN码认证状态。
