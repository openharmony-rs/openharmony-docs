...
1. 调用cryptoFramework.createAsyKeyGenerator、AsyKeyGenerator.generateKeyPair，生成非对称密钥算法为ECC、密钥长度为256位的密钥对（KeyPair）。
...
- 异步方法示例：
  ...
  <!-- @signature_verification_with_ecdsa_key_pair_ark_async -->
...
- 同步方法示例：
  ...
  <!-- @signature_verification_with_ecdsa_key_pair_ark_sync -->
