...
2. 调用cryptoFramework.enableHardwareEntropy，开启硬件熵源。

3. （可选）设置DataBlob数据，调用Random.setSeed，为随机数生成器设置种子。

4. 设置指定字节长度，调用Random.generateRandom或Random.generateRandomSync，生成安全随机数。
