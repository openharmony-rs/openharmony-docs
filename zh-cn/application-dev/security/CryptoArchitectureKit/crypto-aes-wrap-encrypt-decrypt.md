...
2. 调用[cryptoFramework.createCipher](../../reference/apis-crypto-architecture-kit/js-apis-cryptoFramework.md#cryptoframeworkcreatecipher)，指定字符串参数'AES-128-WRAP'，创建类型为AES-128-WRAP的Cipher实例，用于完成加密操作。
...
1. 调用[cryptoFramework.createCipher](../../reference/apis-crypto-architecture-kit/js-apis-cryptoFramework.md#cryptoframeworkcreatecipher)，指定字符串参数'AES-128-WRAP'，创建类型为AES-128-WRAP的Cipher实例，用于完成解密操作。
