...
3. 调用[OH_CryptoSymCipher_Final](../../reference/apis-crypto-architecture-kit/capi-crypto-sym-cipher-h.md#oh_cryptosymcipher_final)，传入加密后得到的完整密文数据（cipherBlob），获取解密后的数据。
