...
开发者可以查阅API文档，获取关键资产更新接口的详细说明：异步接口update(query: AssetMap, attributesToUpdate: AssetMap)、同步接口updateSync(query: AssetMap, attributesToUpdate: AssetMap)。
...
>
> 在指定群组中更新一条关键资产的使用示例详见更新群组关键资产。
>
> 在更新前，需确保已有关键资产，可参考指南文档新增关键资产，否则将抛出NOT_FOUND错误（错误码24000002）。
