...
开发者可以查阅API文档，获取关键资产更新接口的详细说明：异步接口[update(query: AssetMap, attributesToUpdate: AssetMap)/apis-asset-store-kit/js-apis-asset.md#assetupdate)、同步接口[updateSync(query: AssetMap, attributesToUpdate: AssetMap)/apis-asset-store-kit/js-apis-asset.md#assetupdatesync12)。
