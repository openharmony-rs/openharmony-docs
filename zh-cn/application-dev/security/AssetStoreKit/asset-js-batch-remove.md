...
从版本26.0.0开始，系统提供异步接口[batchRemove/apis-asset-store-kit/js-apis-asset.md#assetbatchremove)以便开发者批量删除关键资产。
...
批量删除的关键资产必须具有相同的[GROUP_ID/apis-asset-store-kit/js-apis-asset.md#tag)和[REQUIRE_ATTR_ENCRYPTED/apis-asset-store-kit/js-apis-asset.md#tag)属性。
