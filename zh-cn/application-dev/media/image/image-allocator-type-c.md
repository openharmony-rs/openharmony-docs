...
- 解码其他格式图片。要求[OH_DecodingOptions]里的desiredSize(../../reference/apis-image-kit/capi-image-nativemodule-oh-decodingoptions.md)大于等于512像素 * 512像素（未设置desiredSize时按原图尺寸考虑），并且宽度为64的倍数。
