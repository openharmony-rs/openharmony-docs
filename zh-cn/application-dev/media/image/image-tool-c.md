...
OpenHarmony目前仅支持对部分Exif信息的查看和修改，具体支持的范围请参见：[变量]里的OHOS_IMAGE_PROPERTY_XXX(../../reference/apis-image-kit/capi-image-common-h.md#变量)。需要注意的是，DNG格式图片仅支持读取Exif信息，不支持修改。
