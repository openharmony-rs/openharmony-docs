...
位图操作相关API的详细介绍请参见Interface (PixelMap)。
...
> **说明：**
>
> - 该方法仅可实现PixelMap基本内容的复制，不支持复制色域和HDR元数据。如果不需要改变新PixelMap的像素格式，请使用clone或cloneSync。
...
1. 完成图片解码，获取两张宽度相同且像素格式相同的PixelMap位图对象。
