...
将所支持格式的图片文件解码成PixelMap，以便在应用或系统中进行图片显示或图片处理。

当前支持的图片文件格式包括JPEG、PNG、GIF、WebP、BMP、SVG、ICO、DNG、HEIC、WBMP<sup>23+</sup>、HEIFS<sup>23+</sup>、TIFF<sup>23+</sup>。
...
图片解码相关API的详细介绍请参见：图片解码接口文档image_source_mdk.h。
