...
系统目前仅支持对部分Exif信息的查看和修改，具体支持的范围请参见：[Exif信息](../../reference/apis-image-kit/arkts-apis-image-e.md#propertykey7)。需要注意的是，DNG格式图片仅支持读取Exif信息，不支持修改。

## 开发步骤

Exif信息的读取与编辑相关的API详细介绍请参考[getImageProperty](../../reference/apis-image-kit/arkts-apis-image-ImageSource.md#getimageproperty11)等接口。
