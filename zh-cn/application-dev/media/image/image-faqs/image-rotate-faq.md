...
ArkTS场景下读取和编辑图片的旋转角度信息，可参考：读取和编辑图片Exif信息，对应的propertyKey需要设置为：ORIENTATION。

C/C++场景下读取和编辑图片的旋转角度信息，可参考：使用Image_NativeModule读取和编辑图片Exif信息，对应的key需要设置为：OHOS_IMAGE_PROPERTY_ORIENTATION。
