...
| [降噪](audio-suite-effects.md#降噪) | EFFECT_NODE_TYPE_NOISE_REDUCTION | API版本22 | 降低背景噪声，提升语音清晰度。 | - |
...
| [HOA空间音频](audio-suite-effects.md#hoa空间音频) | EFFECT_NODE_TYPE_HOA_SPACE_RENDER | API版本26.0.0 | HOA高阶 Ambisonics 转双耳渲染。 | - |
