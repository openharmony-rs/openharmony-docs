...
|前置节点类型\后置节点类型   | INPUT_NODE_TYPE_DEFAULT（输入节点） | EFFECT_NODE（效果类节点的统称） | OUTPUT_NODE_TYPE_DEFAULT（输出节点） |
|----------|----------|----------|----------|
| INPUT_NODE_TYPE_DEFAULT（输入节点）  | N  | Y  |    Y   |
| EFFECT_NODE（效果类节点的统称） | N  | Y  |  Y  |
| OUTPUT_NODE_TYPE_DEFAULT（输出节点） | N  | N  |  N  |
