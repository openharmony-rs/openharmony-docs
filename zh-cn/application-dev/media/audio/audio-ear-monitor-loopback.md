...
2. 从API版本26.0.0开始，支持调用getSupportedDevicePairs方法，查询当前支持返听的音频输入输出设备组合。
...
3. 从API版本26.0.0开始，支持调用getPreferredDevicePair方法，查询当前系统推荐的返听输入输出设备组合。
...
6. 从API版本26.0.0开始，支持调用getVolume方法，查询当前返听音量。
...
7. 从API version 21开始，支持调用setReverbPreset方法，设置音频返听的混响模式。
...
8. 从API version 21开始，支持调用getReverbPreset方法，查询当前的音频返听的混响模式。
...
9. 从API version 21开始，支持调用setEqualizerPreset方法，设置音频返听的均衡器类型。
...
10. 从API version 21开始，支持调用getEqualizerPreset方法，查询当前的音频返听的均衡器类型。
