   ...
   // ...
     ...
     if (isSupported) {
       try {
         ...
         // ...
         audioLoopback = loopback as audio.AudioLoopback;
       } catch (err) {
         let e = err as BusinessError;
         console.error(`Failed to create audio loopback. Code: ${e.code}, message: ${e.message}`);
         // ...
       }
     } else {
       console.error('Audio loopback is unsupported.');
