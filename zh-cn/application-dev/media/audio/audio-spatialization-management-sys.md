...
系统应用开发者可以通过[setSpatializationEnabled](../../reference/apis-audio-kit/js-apis-audio-sys.md#setspatializationenabled12)接口开启/关闭指定设备的头动跟踪效果，该接口需要传递两个参数：AudioDeviceDescriptor和enabled。
