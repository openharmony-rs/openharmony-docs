...
- 不同的录音流类型对应着不同的系统优化处理策略，建议开发者根据需求选择合适的[SourceType](../../reference/apis-audio-kit/arkts-apis-audio-e.md#sourcetype8)，具体可参考指南[选择合适的录制流类型](using-right-sourcetype-for-recording.md)。
