...
为使用低时延模式，开发者需要使用OHAudio进行音频开发，可参考推荐使用OHAudio开发音频播放功能(C/C++)和推荐使用OHAudio开发音频录制功能(C/C++)。设置低时延模式开发示例：
...
应用可以通过OH_AudioRenderer_GetLatencyMode查询当前时延模式，开发示例：

<!-- @Render_CheckLatencyMode -->  
