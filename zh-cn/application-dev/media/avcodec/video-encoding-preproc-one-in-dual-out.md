...
|------|---------------------|----------------------|----------|
| 多码率直播（ABR） | 高码率主码流 | 降采样 + 丢帧的低码流/低码率 | 无需云端进行多码率转码，在主播端编码两种码流，就可以适配不同消费者设备和带宽，减少云端转码时延和转码成本。 |
| ROI 区域关注 | 全帧编码归档 | 裁剪感兴趣区域编码 | 监控全帧存储 + 局部区域分析 |
| 多人视频通话 | 高分辨率/高帧率/高码率码流 | 降采样/丢帧/低码率码流 | 发送端可发送两路码流，服务端无需转码，根据接收端网络质量选择码流转发。 |
