...
AVCodec Kit（Audio & Video Codec Kit，音视频编解码，封装，解封装）是媒体系统中的音视频的编解码、媒体文件的解封装、封装、媒体数据输入等原子能力。
...
- 文件解封装与封装
  ...
  具体开发指导请参考[媒体数据解封装](audio-video-demuxer.md)、[媒体数据封装](audio-video-muxer.md)。
