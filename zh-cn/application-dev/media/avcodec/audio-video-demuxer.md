...
> - 如果使用ResourceManager.getRawFd打开HAP资源文件描述符，使用方法请参考接口[getRawFd](../../reference/apis-localization-kit/js-apis-resource-manager.md#getrawfd9)
...
3. 创建解封装器实例。
   ...
   ```
4. 注册DRM信息监听函数，接口参考[Demuxer_MediaKeySystemInfoCallback](../../reference/apis-avcodec-kit/capi-native-avdemuxer-h.md#demuxer_mediakeysysteminfocallback)（可选，若非DRM码流或已获得，可跳过此步，DRM信息内容参考[DRM_MediaKeySystemInfo](../../reference/apis-drm-kit/capi-drm-drm-mediakeysysteminfo.md)）。
