...
当相机输出视频帧时，如果检测到ROI区域（如人脸），会将ROI信息写入帧的[NativeBuffer元数据](../../reference/apis-arkgraphics2d/capi-buffer-common-h.md#ohnativebuffermetadatakey)中，开发者可直接从每帧中提取，无需额外的回调接口和时间戳匹配。
