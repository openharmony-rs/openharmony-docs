...
| 媒体格式  | 封装格式                      | 轨道格式                      |
| -------- | :----------------------------| :----------------------------|
| 音视频     | mp4                        |<!--RP4-->视频轨：AVC(H.264)、MPEG4<br>音频轨：AAC、MPEG(MP3)、ALAC<sup>22+</sup><br>字幕轨：WEBVTT<br>辅助轨：AUXL(音频RAW信息、视频深度信息等)<br>timed metadata轨：有时间属性的描述信息，如帧级的维测信息、传感器信息等<!--RP4End-->|
