...
更多API说明请参考文档：[模块描述/apis-avsession-kit/arkts-apis-avsession.md)。
...
3. 设置用于被媒体会话控制方拉起的UIAbility。当用户操作媒体会话控制方的界面时，例如点击播控中心的卡片，可以拉起此处配置的UIAbility。
   ...
   设置UIAbility时通过WantAgent接口实现，更多关于WantAgent的信息请参考[WantAgent/apis-ability-kit/js-apis-app-ability-wantAgent.md)。
...
6. 注册播控命令事件监听，便于响应用户通过媒体会话控制方，例如播控中心，下发的播控命令。
   ...
   Session侧的固定播控命令主要包括播放、暂停、上一首、下一首等基础操作命令，详细介绍请参见[AVControlCommand/apis-avsession-kit/arkts-apis-avsession-i.md#avcontrolcommand10)。
