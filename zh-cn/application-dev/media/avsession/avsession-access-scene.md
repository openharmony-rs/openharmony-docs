...
对于其他使用到音频播放的应用，比如游戏，直播等场景，接入AVSession不是必选项，取决于应用是否有后台播放的使用诉求。若应用需要后台播放，那么接入AVSession仍然是必须的，否则业务的正常功能会受到限制。
...
对于长音频，播控中心提供了媒体资源金标的展示，目前暂时只支持展示Audio Vivid标识。
