...
本Kit支持模拟器，但与真机存在部分差异，具体差异如下：
  - 通用差异：请参见[模拟器与真机的差异](http://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-emulator-specification#section18112195514315).
  - 不支持跨设备投播。
