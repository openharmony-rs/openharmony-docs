...
> **说明：** 
> 
> 若通过弹窗向用户申请授权时，用户拒绝授权，可通过[isCameraMuted](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-cameramanager#iscameramuted)查询当前相机是否被禁用。
>
