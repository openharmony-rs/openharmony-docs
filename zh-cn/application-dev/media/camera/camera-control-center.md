...
2. 通过isControlCenterSupported接口，查询当前设备及当前场景是否支持相机控制器。
...
3. 通过getSupportedEffectTypes接口，查询当前设备及当前场景下，相机控制器支持的效果类型。
...
4. 若设备及场景支持相机控制器，使用enableControlCenter接口可启用或关闭控制器。
