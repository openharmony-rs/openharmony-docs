...
以下是常见不合理用法，以媒体库虚拟路径/data/storage/el2/media/Photo/111/IMG_1234567890_123/A.jpg为例：  
 	 
1. 将生成的媒体路径截断。如删除路径的displayName，即删除/A.jpg，得到的路径/data/storage/el2/media/Photo/111/IMG_1234567890_123为非法的媒体库路径。
2. 修改生成的媒体路径。如修改路径的displayName，将/A.jpg修改为/B.xxx，得到的路径/data/storage/el2/media/Photo/111/IMG_1234567890_123/B.xxx为非法的媒体库路径。
