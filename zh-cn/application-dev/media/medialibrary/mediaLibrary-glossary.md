...
用于组织和存储图片、视频等媒体资源的容器。媒体库中的相册分为系统相册（如收藏夹、视频相册）和用户相册（用户自定义创建的相册），支持查询、重命名、添加和移除媒体资源等操作。
...
提供了管理相册和媒体文件的能力，包括照片和视频，帮助你的应用快速构建图片视频展示和播放能力。
...
用于标识媒体库中媒体资源或相册的唯一地址字符串。包括媒体文件URI（如file://media/Photo/...）和相册URI，用于定位和访问特定的媒体资源，是媒体库操作中资源定位的关键标识。
