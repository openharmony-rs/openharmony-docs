...
5. 创建图片资源并绑定到材质。
   ...
   ArkTS-Sta示例：
   <!-- @[create_image_promise](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkGraphics3D/ArkGraphics3DSta/entry/src/main/ets/arkgraphic/resource.ets) -->
...
6. 应用图片材质到模型节点。
   ...
   ```
   ArkTS-Sta示例：
   <!-- @[replace_with_image_material](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkGraphics3D/ArkGraphics3DSta/entry/src/main/ets/arkgraphic/resource.ets) -->
