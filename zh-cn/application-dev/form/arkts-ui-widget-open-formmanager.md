...
```ts
<!-- @[CustomLayout](https://gitcode.com/openharmony/applications_app_samples/tree/master/code/DocsSample/Form/FormManagerDemo/entry/src/main/ets/pages/Index.ets) -->
```
资源文件如下：
```json
