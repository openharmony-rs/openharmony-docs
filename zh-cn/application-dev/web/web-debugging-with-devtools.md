...
2. 使用hdc命令连接上设备。  
   ...
   hdc_list_targets_success
   - 如果命令返回 `[Empty]`，则说明hdc还没有发现设备。<br/>
   hdc_list_targets_empty
