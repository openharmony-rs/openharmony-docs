...
2. 参考[Native访问应用沙箱](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-file-native-side)实现访问应用沙箱dmp文件。还有另一种获取dmp文件的方法，因为存放dmp文件的沙箱路径无法在DevEco Studio的设备文件浏览器直接查看，可以考虑将其复制到可以查看的路径，demo如下
