...
2. 参考[Native访问应用沙箱](https://developer.huawei.com/consumer/cn/doc/best-practices/bpta-file-native-side)实现访问应用沙箱dmp文件。还有另一种获取dmp文件的方法，将存放dmp文件的沙箱路径的文件复制到可以查看的路径，demo如下
