...
通过[pdfconfiguration](../reference/apis-arkweb/arkts-apis-webview-i.md#pdfconfiguration14)配置可调整保存的PDF每页大小、前端页面缩放比例等；推荐使用前端页面适配策略，通过CSS媒体查询(@media print)优化保存的PDF排版。
