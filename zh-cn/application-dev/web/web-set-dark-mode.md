...
ArkTS-Sta示例：
<!-- @[force_the_page_to_be_configured_to_dark_mode](https://gitcode.com/openharmony/applications_app_samples/tree/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/DarkMode/entry/src/main/ets/pages/DarkMode_two.ets) -->

``` TypeScript
'use static'

import { $rawfile, Entry, Component, Web, Column, State, WebDarkMode } from '@kit.ArkUI';
import { webview } from '@kit.ArkWeb';
...
- 应用侧设置[WebDarkMode.On](../reference/apis-arkweb/arkts-basic-components-web-e.md#webdarkmode9)和[WebDarkMode.Off](../reference/apis-arkweb/arkts-basic-components-web-e.md#webdarkmode9)控制深色模式开启和关闭时，背景色跟随深色模式开启和关闭状态改变。
  ...
  ArkTS-Sta示例：
  <!-- @[set_web_background_color](https://gitcode.com/openharmony/applications_app_samples/tree/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/DarkMode/entry/src/main/ets/pages/DarkMode_three.ets) -->
  
  ``` TypeScript
  'use static'
  
  import { $rawfile, Entry, Component, Web, Column, State, WebDarkMode, Color } from '@kit.ArkUI';
  import { webview } from '@kit.ArkWeb';
...
- 应用侧设置[WebDarkMode.Auto](../reference/apis-arkweb/arkts-basic-components-web-e.md#webdarkmode9)跟随系统深色模式时，监听系统设置，背景色跟随系统改变。
  ...
  ArkTS-Sta示例：
  <!-- @[set_web_darkmode_auto](https://gitcode.com/openharmony/applications_app_samples/tree/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/DarkMode/entry/src/main/ets/entryability/EntryAbility.ets) -->

  ```TypeScript
  'use static'
  import { AppStorage, window, BusinessError } from '@kit.ArkUI';
  import { AbilityConstant, ConfigurationConstant, UIAbility, Want, Configuration } from '@kit.AbilityKit';
  import { hilog } from '@kit.PerformanceAnalysisKit';
  ...
  class EntryAbility extends UIAbility {
    ...
    onConfigurationUpdate(newConfig: Configuration): void {
      // 动态更新深浅色状态。
      const currentColorMode: ConfigurationConstant.ColorMode | undefined = AppStorage.get<ConfigurationConstant.ColorMode>('currentColorMode');
      if (currentColorMode !== newConfig.colorMode) {
  ...
  ArkTS-Sta示例：
  <!-- @[set_web_darkmode_auto](https://gitcode.com/openharmony/applications_app_samples/tree/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/DarkMode/entry/src/main/ets/pages/DarkMode_Four.ets) -->

  ``` TypeScript
  'use static'

  import { $rawfile, Entry, Component, Web, Column, State, WebDarkMode, Color, Watch, StoragePropRef } from '@kit.ArkUI';
  import { webview } from '@kit.ArkWeb';
  import { ConfigurationConstant } from '@kit.AbilityKit';
  ...
  struct WebComponent {
    controller: webview.WebviewController = new webview.WebviewController();
    @State bgColor: Color = Color.White;
    @StoragePropRef('currentColorMode') @Watch('onCurrentColorModeChange')
    currentColorMode: ConfigurationConstant.ColorMode = ConfigurationConstant.ColorMode.COLOR_MODE_NOT_SET;
    ...
    onCurrentColorModeChange(propName?: string): void {
      // 根据系统设置切换背景色。
      if (this.currentColorMode === ConfigurationConstant.ColorMode.COLOR_MODE_DARK) {
        this.bgColor = Color.Black;
      } else {
