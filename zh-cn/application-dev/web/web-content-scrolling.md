...
当网页处于非顶部状态或向下抛滑时，此时若需返回网页顶部，可以使用[backToTop](../reference/apis-arkweb/arkts-basic-components-web-attributes.md#backtotop22)方法，开启后通过点击状态栏，打断抛滑并将网页滚动到网页顶部。点击状态栏回顶仅在聚焦网页中生效，因此在使用前，需确认目标网页是否处于聚焦状态，若处于失焦状态则网页无法进行回顶。
