...
ArkTS-Sta示例：
<!-- @[download_delegate](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/ManageWebPageFileIO/entry/src/main/ets/pages/ListenForPageDown.ets) -->

``` TypeScript
import { $rawfile, Button, Column, Component, Entry, State, Text, Web } from '@kit.ArkUI';
import { webview } from '@kit.ArkWeb';
...
ArkTS-Sta示例：
<!-- @[init_download_task](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/ManageWebPageFileIO/entry/src/main/ets/pages/InitiatingADownloadTask.ets) -->

``` TypeScript
import { Button, Column, Component, Entry, State, Text, Web } from '@kit.ArkUI';
import { webview } from '@kit.ArkWeb';
import { BusinessError } from '@ohos.base';
...
> **说明：**
>
>Web组件的下载功能要求应用通过调用[WebDownloadItem.start](../reference/apis-arkweb/arkts-apis-webview-WebDownloadItem.md#start11)来指定下载文件的保存路径。
>
...
ArkTS-Sta示例：
<!-- @[recovery_download_task](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/ManageWebPageFileIO/entry/src/main/ets/pages/ResumeDownload.ets) -->
...
ArkTS-Sta示例：
<!-- @[task_info_persistence_util](https://gitcode.com/openharmony/applications_app_samples/blob/OpenHarmony_feature_sta_20260331/code/DocsSample/ArkWeb-Sta/ManageWebPageFileIO/entry/src/main/ets/pages/downloadUtil.ets) -->
...
export let filePath : string;
export const fileName: string = 'demoFile.txt';
export namespace  DownloadUtil {
