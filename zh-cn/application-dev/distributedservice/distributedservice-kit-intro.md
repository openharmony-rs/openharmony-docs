...
应用开发者可以通过[跨设备连接UIAbility开发指南](abilityconnectmanager-guidelines.md)实现应用间协同。设备间登录同账号并组网成功后，应用可以跨设备拉起同应用的一个[UIAbility/apis-ability-kit/js-apis-app-ability-uiAbility.md)，从而实现信息、字节流、图片和传输流的交互。
