...
3. 分布式数据同步权限的授权方式为user_grant，因此需要调用[requestPermissionsFromUser()](../application/reference/apis-ability-kit/js-apis-abilityAccessCtrl.md#requestpermissionsfromuser9)接口，以动态弹窗的方式向用户申请授权。
