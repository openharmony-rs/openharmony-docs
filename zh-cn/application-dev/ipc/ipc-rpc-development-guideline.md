...
> **说明：**
>
> - 以下完整样例涉及到ServiceExtensionAbility，需要使用FULL_SDK。参考样例前，请先阅读对应样例的ReadMe进行相应的配置后，再进行编译。
