...
## 接入指导
1. 前台应用设置编辑框沉浸模式[keyboardappearance/apis-arkui/arkui-ts/ts-basic-components-textarea.md#keyboardappearance15)。示例代码如下。
...
2. 输入法应用订阅编辑框属性变化事件[editorattributechanged/apis-ime-kit/js-apis-inputmethodengine.md#oneditorattributechanged10)，通过回调参数EditorAttribute中的immersiveMode字段感知前台应用期望的沉浸模式。示例代码如下。
...
3. 输入法应用设置沉浸模式[setimmersivemode/apis-ime-kit/js-apis-inputmethodengine.md#setimmersivemode15)。 
   ...
   设置沉浸模式，示例代码如下。setImmersiveMode接口需使用[createPanel/apis-ime-kit/js-apis-inputmethodengine.md#createpanel10)获取到Panel实例后，通过实例调用。
