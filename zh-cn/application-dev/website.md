  ...
  - 应用框架<!--app-framework-->
    ...
    - ArkUI（方舟UI框架）<!--arkui-->
      ...
      - [UI高性能开发](ui/ui-performance-overview.md)
        ...
        - [UI并行化创建组件树（ArkTS-Sta）](ui/ui-parallel-components.md)
...
- API参考<!--api-reference-->
  ...
  - 标准库<!--standard-library-->
    ...
    - [Mutex (互斥锁)](reference/native-lib/arkts-sta-mutex.md)
    - [RWLock (读写锁)](reference/native-lib/arkts-sta-rwlock.md)
    - [ConcurrentSet (并发集合)](reference/native-lib/arkts-sta-concurrentset.md)
    - Builtin文档<!--Builtin-->
        - [Array](reference/native-lib/arkts-sta-array.md)
        - [jsonx](reference/native-lib/arkts-sta-jsonx.md)
        - [JSON](reference/native-lib/arkts-sta-json.md)
        - [Mutex (互斥锁)](reference/native-lib/arkts-sta-mutex.md)
        - [RWLock (读写锁)](reference/native-lib/arkts-sta-rwlock.md)
        - [Map](reference/native-lib/arkts-sta-map.md)
        - [Set](reference/native-lib/arkts-sta-set.md)
        - [Boolean](reference/native-lib/arkts-sta-boolean.md)
        - [Byte](reference/native-lib/arkts-sta-byte.md)
        - [Char](reference/native-lib/arkts-sta-char.md)
        - [Int](reference/native-lib/arkts-sta-int.md)
        - [ConcurrentSet (并发集合)](reference/native-lib/arkts-sta-concurrentset.md)
        - [ConcurrentHashMap](reference/native-lib/arkts-sta-concurrenthashmap.md)
    - Vulkan<!--vulkan-guide-->
