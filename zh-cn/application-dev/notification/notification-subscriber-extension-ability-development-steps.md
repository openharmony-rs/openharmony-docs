...
| 接口名     | 描述 | 说明|
| ----- |---------|----------|
| onDestroy(): void| 分布式协同扩展被销毁时的回调。 |具体使用方法详见[NotificationSubscriberExtensionAbility](../reference/apis-notification-kit/js-apis-notificationSubscriberExtensionAbility.md#ondestroy)中该接口说明。|
| onReceiveMessage(): void| 分布式协同扩展被销毁时的回调。 |具体使用方法详见[NotificationSubscriberExtensionAbility](../reference/apis-notification-kit/js-apis-notificationSubscriberExtensionAbility.md#onreceivemessage)中该接口说明。|
| onCancelMessages(): void| 分布式协同扩展被销毁时的回调。 |具体使用方法详见[NotificationSubscriberExtensionAbility](../reference/apis-notification-kit/js-apis-notificationSubscriberExtensionAbility.md#oncancelmessages)中该接口说明。|

## 前提条件
实现[NotificationSubscriberExtensionAbility](../reference/apis-notification-kit/js-apis-notificationSubscriberExtensionAbility.md)需要先进行蓝牙配对，申请ohos.permission.SUBSCRIBE_NOTIFICATION权限。
...
2. 在entry/src/main/ets/notificationsubscriberextability创建NotificationSubscriberExtAbility.ets配置内容如下。
```ts
