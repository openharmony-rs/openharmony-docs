...
1. 导入notificationManager模块。
   ...
   <!-- @[manage_notification_ways_header](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ManageNotificationWays.ets) -->
...
2. 创建指定类型的通知渠道。
   ...
   <!-- @[create_type_channel](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ManageNotificationWays.ets) -->
...
3. 查询指定类型的通知渠道。
   ...
   <!-- @[get_type_channel](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ManageNotificationWays.ets) -->
...
4. 删除指定类型的通知渠道。
   ...
   <!-- @[delete_type_channel](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ManageNotificationWays.ets) -->
