...
4. 三方穿戴应用需申请[ohos.permission.SUBSCRIBE_NOTIFICATION](https://gitcode.com/openharmony/docs/blob/master/zh-cn/application-dev/security/AccessToken/restricted-permissions.md#ohospermissionsubscribe_notification)权限，权限为system_core级别，需要配置高权限签名；
