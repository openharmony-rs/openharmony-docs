...
应用向Ability Kit申请[WantAgent/apis-ability-kit/js-apis-app-ability-wantAgent.md)，并将WantAgent封装至通知中。当发布通知时，用户便可以通过点击通知栏中的消息或按钮，拉起目标应用组件或发布公共事件。
...
| **接口名** | **描述** |
| -------- | -------- |
| [publish/apis-notification-kit/js-apis-notificationManager.md#notificationmanagerpublish-1)(request: NotificationRequest): Promise\<void\>       | 发布通知。  |
| [getWantAgent/apis-ability-kit/js-apis-app-ability-wantAgent.md#wantagentgetwantagent)(info:&nbsp;WantAgentInfo,&nbsp;callback:&nbsp;AsyncCallback&lt;WantAgent&gt;):&nbsp;void | 创建WantAgent。 |
...
2. 创建WantAgentInfo信息。
   ...
   场景一：创建拉起UIAbility的WantAgent的[WantAgentInfo/apis-ability-kit/js-apis-inner-wantAgent-wantAgentInfo.md)信息。
   ...
   场景二：创建发布[公共事件](../basic-services/common-event/common-event-overview.md)的WantAgent的[WantAgentInfo/apis-ability-kit/js-apis-inner-wantAgent-wantAgentInfo.md)信息。
...
3. 调用[getWantAgent()/apis-ability-kit/js-apis-app-ability-wantAgent.md#wantagentgetwantagent)方法进行创建WantAgent。
