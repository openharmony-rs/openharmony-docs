...
1. 导入模块。
   ...
   <!-- @[clear_duplicate_notifications_header](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ClearDuplicateNotifications.ets) -->
...
2. 发布通知消息，通知消息中包含`appMessageId`字段。
   ...
   <!-- @[pub_appmsgid_notify](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/ClearDuplicateNotifications.ets) -->
