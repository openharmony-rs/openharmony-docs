...
1. 导入NotificationManager模块。
   ...
   <!-- @[request_enable_notification_header](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/RequestEnableNotification.ets) -->
...
2. 拉起通知弹窗，向用户请求通知授权。
   ...
   <!-- @[request_enable_notification_permission](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/RequestEnableNotification.ets) -->
...
3. （可选）拉起通知管理半模态弹窗，向用户再次申请通知授权。
   ...
   <!-- @[reapply_notify_auth_halfmodal](https://gitcode.com/openharmony/applications_app_samples/blob/master/code/DocsSample/Notification-Kit/Notification/entry/src/main/ets/filemanger/RequestEnableNotification.ets) -->
