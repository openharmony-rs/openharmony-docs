...
从API version 20开始，ArkGuard针对ArkTS-Dyn、TS、JS等类型提供了字节码混淆能力，将代码中的函数名、类名、文件名等名字变成简短无意义的名字。

从API version 23开始，ArkGuard针对ArkTS-Sta类型提供了字节码混淆能力，将代码中的类名，方法名，属性名，目录，文件名等变成简短无意义的名字。
