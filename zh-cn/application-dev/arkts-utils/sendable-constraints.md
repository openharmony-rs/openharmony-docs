...
NAPI相关接口请参考Sendable相关的NAPI接口，具体使用请参考Native与Sendable ArkTS对象绑定。
...
Sendable数据需要与makeObserved配合使用，才可以观察Sendable对象的数据变化，具体使用请参考makeObserved和@Sendable装饰的class配合文档。
