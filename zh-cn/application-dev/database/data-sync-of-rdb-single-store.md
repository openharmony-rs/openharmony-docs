...
3. 创建关系型数据库，创建数据表，并将需要进行跨设备同步的数据表设置为分布式表。需要将[DistributedConfig](../reference/apis-arkdata/arkts-apis-data-relationalStore-i.md#distributedconfig10)中[DistributedTableType](../reference/apis-arkdata/arkts-apis-data-relationalStore-e.md#distributedtabletype23)配置为SINGLE_VERSION。
