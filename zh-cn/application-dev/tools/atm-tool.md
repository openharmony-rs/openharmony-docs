...
| <!--DelRow-->-r                        |  必选参数，查询系统内的所有PermissionUsedResponse。                           | 
| <!--DelRow-->-r&nbsp;-i \<token-id\>        | 可选参数，通过应用进程的tokenId，查询该应用的PermissionUsedResponse。        | 
| <!--DelRow-->-r&nbsp;-p \<permission-name\> | 可选参数，通过权限名，查询该权限的PermissionUsedResponse。                        |
