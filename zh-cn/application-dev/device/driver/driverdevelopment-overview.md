...
- 在DriverExtensionAbility中仅支持访问DDK（[docs/zh-cn/application-dev/reference/apis-driverdevelopment-kit · OpenHarmony/docs - AtomGit | GitCode](../../reference/apis-driverdevelopment-kit/Readme-CN.md)）API，实现对非标外设进行访问控制和数据通信。
