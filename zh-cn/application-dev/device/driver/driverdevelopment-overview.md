...
- DriverExtensionAbility具体受限ArkTS API名单，请参考frameworks/native/ability/native/etc/extension_blocklist_config.json · OpenHarmony/ability_ability_runtime - AtomGit | GitCode中DriverExtension配置。
