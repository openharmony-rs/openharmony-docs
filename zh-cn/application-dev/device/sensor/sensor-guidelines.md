...
3. 导入模块。
   ...
   <!-- @sensor_js_development_dependency_import_example --> 
...
4. 定义常量。
   ...
   <!-- @sensor_js_define_variables_example --> 
...
5. 查询设备支持的所有传感器的参数，如果获取不到某个传感器则代表该传感器在此设备上不存在或不可用，如果订阅没查到的传感器时需要处理异常。
   ...
   <!-- @sensor_js_get_sensor_list_example --> 
   ...
   <!-- @sensor_js_get_sensor_list_by_device_example --> 
   ...
   <!-- @sensor_js_get_single_sensor_by_device_sync_example -->
...
6. 注册监听。可以通过on()和once()两种接口监听传感器的调用结果。
   ...
   <!-- @sensor_js_on_accelerometer_example --> 
   ...
   <!-- @sensor_js_on_accelerometer_use_sensor_info_param_example --> 
   ...
   <!-- @sensor_js_once_accelerometer_example --> 
...
7. 取消持续监听。
   ...
   <!-- @sensor_js_off_accelerometer_example --> 
   ...
   <!-- @sensor_js_off_accelerometer_use_sensor_info_param_example --> 
...
8. 动态传感器状态的监听，在收到设备下线事件通知时，用户应主动调用off关闭该设备上的传感器。 
   ...
   <!-- @sensor_js_on_sensor_status_change_example --> 
   ...
   <!-- @sensor_js_off_sensor_status_change_example --> 
...
9. 获取某时刻地球上特定位置的地磁场信息
   ...
   <!-- @sensor_js_get_geomagnetic_info_callback_example -->
   ...
   <!-- @sensor_js_get_geomagnetic_info_promise_example --> 
...
10. 根据气压值获取海拔高度
    ...
    <!-- @sensor_js_get_device_altitude_callback_example --> 
    ...
    <!-- @sensor_js_get_device_altitude_promise_example --> 
...
11. 根据倾斜矩阵计算地磁倾角
    ...
    <!-- @sensor_js_get_inclination_callback_example --> 
    ...
    <!-- @sensor_js_get_inclination_promise_example -->
...
12. 计算两个旋转矩阵之间的角度变化
    ...
    <!-- @sensor_js_get_angle_variation_callback_example --> 
    ...
    <!-- @sensor_js_get_angle_variation_promise_example -->
...
13. 根据旋转矢量获取旋转矩阵
    ...
    <!-- @sensor_js_get_rotation_matrix_callback_example --> 
    ...
    <!-- @sensor_js_get_rotation_matrix_promise_example -->
...
14. 根据指定坐标系映射旋转矩阵
    ...
    <!-- @sensor_js_transform_rotation_matrix_callback_example --> 
    ...
    <!-- @sensor_js_transform_rotation_matrix_promise_example -->
...
15. 根据旋转向量计算归一化四元数
    ...
    <!-- @sensor_js_get_quaternion_callback_example --> 
    ...
    <!-- @sensor_js_get_quaternion_promise_example -->
...
16. 根据旋转矩阵计算设备方向
    ...
    <!-- @sensor_js_get_orientation_callback_example -->
    ...
    <!-- @sensor_js_get_orientation_promise_example --> 
...
17. 根据重力矢量和地磁矢量计算旋转矩阵
    ...
    <!-- @sensor_js_get_rotation_matrix_two_param_callback_example --> 
    ...
    <!-- @sensor_js_get_rotation_matrix_two_param_promise_example -->
...
18. 获取指定传感器类型的属性信息
    ...
    <!-- @sensor_js_get_single_sensor_callback_example -->
    ...
    <!-- @sensor_js_get_single_sensor_promise_example --> 
    ...
    <!-- @sensor_js_get_single_sensor_sync_example -->
