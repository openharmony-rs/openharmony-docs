...
2. [组合按键](inputconsumer-guidelines-sys.md)、[事件注入](inputeventclient-guidelines-sys.md)、[输入监听](inputmonitor-guidelines-sys.md)、[快捷键](shortkey-guidelines-sys.md)模块接口为系统接口，其中[输入监听](inputmonitor-guidelines-sys.md)模块接口需要 ohos.permission.INPUT_MONITORING权限。
