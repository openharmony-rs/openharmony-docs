...
输入事件模拟提供键盘和鼠标操作模拟功能。使用场景例如：自动化测试、远程控制、辅助功能等需要程序化模拟输入的场景。
...
## 使用KeyboardController模拟按键操作

KeyboardController接口提供了一种简化的方式来模拟按键操作。它自动管理按键状态，确保按键按下和抬起事件的正确顺序。
