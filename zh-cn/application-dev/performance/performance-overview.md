...
- **在对象上谨慎使用状态变量关联（[合理进行状态管理](proper-state-management.md)）：**
...
- **使用缓存：**
  ...
  选择合适的[缓存策略](list-perf-improvement.md#缓存列表项)可以提高应用程序的性能和响应速度，从而提升应用响应速度。
...
- **[ArkUI Inspector](./arkUI-inspector.md)：**
