...
| OH_NativeVSync_GetPeriod(OH_NativeVSync\* nativeVsync, long long\* period) | 获取当前Vsync信号周期。 | 

详细的接口说明请参考[NativeVsync](../reference/apis-arkgraphics2d/capi-nativevsync.md)。
