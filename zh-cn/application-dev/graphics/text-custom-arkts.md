...
### 接口说明
文本塑形中常用接口如下表所示，详细接口说明参考[@ohos.graphics.text (文本模块)/apis-arkgraphics2d/js-apis-graphics-text.md#paragraph)和[@ohos.graphics.drawing (drawing TextBlob)/apis-arkgraphics2d/arkts-apis-graphics-drawing-TextBlob.md)。
