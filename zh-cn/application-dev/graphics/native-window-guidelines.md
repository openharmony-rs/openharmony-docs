...
详细的接口说明请参考[native_window/apis-arkgraphics2d/capi-nativewindow.md)。
...
1. 获取OHNativeWindow实例。
    ...
    可通过[`OH_NativeXComponent_Callback`/apis-arkui/capi-oh-nativexcomponent-native-xcomponent-oh-nativexcomponent-callback.md)接口获取OHNativeWindow。代码示例如下。关于XComponent模块的使用方法，详见[XComponent开发指导](../ui/napi-xcomponent-guidelines.md)。
