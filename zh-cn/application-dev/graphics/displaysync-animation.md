...
在应用开发中，[属性动画/apis-arkui/arkui-ts/ts-animatorproperty.md)和[显式动画/apis-arkui/arkui-ts/ts-explicit-animation.md)能够使用可选参数[ExpectedFrameRateRange/apis-arkui/arkui-ts/ts-explicit-animation.md#expectedframeraterange11)，为不同的动画配置不同的期望绘制帧率。
