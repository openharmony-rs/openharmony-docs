...
1. 导入模块。
   <!-- @display_sync_by_ui_import_module -->
...
3. 定义两个文本组件。
   <!-- @display_sync_create_text_component -->
...
4. 通过DisplaySync实例设置帧率和注册订阅函数。
   ...
   <!-- @display_sync_frame_rate_setting_and_subscription_function_registration -->
...
5. 开始每帧回调。
   <!-- @display_sync_start_per_frame_callback -->
...
6. 结束每帧回调。
   <!-- @display_sync_stop_per_frame_callback -->
