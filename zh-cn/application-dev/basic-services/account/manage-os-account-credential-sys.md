...
2. 调用[registerInputer/apis-basic-services-kit/js-apis-osAccount-sys.md#registerinputer8)注册PIN码输入器。
...
在进行凭据管理前，请先打开一个新的会话。开发者可以使用[openSession/apis-basic-services-kit/js-apis-osAccount-sys.md#opensession8)接口完成此操作。

具体开发实例如下：

调用[openSession/apis-basic-services-kit/js-apis-osAccount-sys.md#opensession8)接口一个新的凭据管理会话。
...
前述操作完成后，可以进行PIN码录入。开发者可以使用[addCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#addcredential8)接口完成此操作。
...
2. 调用[addCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#addcredential8)接口添加指定的凭据信息，执行结果通过回调获取。
...
录入完PIN码，用户可以进行PIN码认证。开发者可以使用[auth/apis-basic-services-kit/js-apis-osAccount-sys.md#auth8)接口完成此操作。
...
2. 调用[auth/apis-basic-services-kit/js-apis-osAccount-sys.md#auth8)接口进行认证。
...
3. 调用[addCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#addcredential8)录入人脸凭据。
...
5. 调用[addCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#addcredential8)录入指纹凭据。
...
录入生物识别凭据后，用户可以进行生物识别认证。类似PIN码认证，开发者可以使用[auth/apis-basic-services-kit/js-apis-osAccount-sys.md#auth8)接口完成此操作。
...
用户可以修改系统账号的凭据。开发者可以使用[updateCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#updatecredential8)接口完成此操作。
...
3. 调用[updateCredential/apis-basic-services-kit/js-apis-osAccount-sys.md#updatecredential8)更新凭据。
...
凭据管理界面需要向用户展示已录入的凭据信息；锁屏界面需要展示可认证的凭据类型。开发者可以使用[getAuthInfo/apis-basic-services-kit/js-apis-osAccount-sys.md#getauthinfo8)接口查询已录入的凭据信息，实现前述业务场景功能。
...
2. 调用[getAuthInfo/apis-basic-services-kit/js-apis-osAccount-sys.md#getauthinfo8)接口，获取指定类型的凭据信息（以指纹凭据为例）。
...
3. 调用[delCred/apis-basic-services-kit/js-apis-osAccount-sys.md#delcred8)接口，删除指定凭据。
...
不再使用输入器时，可以调用[unregisterInputer/apis-basic-services-kit/js-apis-osAccount-sys.md#unregisterinputer8)注销PIN码输入器。
...
调用[closeSession/apis-basic-services-kit/js-apis-osAccount-sys.md#closesession8)关闭会话，结束凭据管理。
