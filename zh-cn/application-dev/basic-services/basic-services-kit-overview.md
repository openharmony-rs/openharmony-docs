...
- 进程间/线程间通信：
  ...
  - [Emitter](../reference/apis-basic-services-kit/js-apis-emitter.md)：提供线程间通信的能力，包括订阅、发布、退订自定义事件等，相关开发指南请参考[使用Emitter进行线程间通信](common-event/itc-with-emitter.md)。
...
- 其他：
  - [应用账号管理](../reference/apis-basic-services-kit/js-apis-appAccount.md)：提供应用账号的周期管理以及数据管理的能力，相关开发指南请参考[管理应用账号](account/manage-application-account.md)。
