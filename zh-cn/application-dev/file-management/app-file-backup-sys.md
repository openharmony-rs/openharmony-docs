...
备份过程中，备份恢复服务会将应用的数据打包成文件，打包后的文件会以打开的文件句柄形式，通过创建实例时所注册的回调[generalcallbacks](../reference/apis-core-file-kit/js-apis-file-backup-sys.md#generalcallbacks)接口返回。
